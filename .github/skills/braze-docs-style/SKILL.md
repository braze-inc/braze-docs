...
description: Apply Braze Docs writing and style standards when drafting, editing, or reviewing documentation. Use when working on markdown files in _docs/ or _includes/, creating or updating pull requests for docs content, reviewing documentation changes, or when the user asks about Braze documentation style.
---
