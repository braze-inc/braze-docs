...
You can either use the [Swift Package Manager (SwiftPM)](https://swift.org/package-manager/) or [CocoaPods](http://cocoapods.org/) to automate most of the installation process. Alternatively, you can install the SDK manually.
