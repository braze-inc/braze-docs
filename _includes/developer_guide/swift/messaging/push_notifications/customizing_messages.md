...
When you create a push campaign through the Braze dashboard, select the **Settings** tab on the **Compose** step to view the advanced settings available.
