...
- Some browsers, such as Firefox, do not display images in push notifications. For details on browser support, see the [MDN documentation for Notification images](https://developer.mozilla.org/en-US/docs/Web/API/Notification/image).
