...
{% alert important %}
Looking for the basic Content Card developer integration guide? Find it [here]({{site.baseurl}}/developer_guide/content_cards/?sdktab=android).<br><br>More information on customizing Content Cards can be found in the [Customization Guide.]({{site.baseurl}}/developer_guide/content_cards/)
{% endalert %}
