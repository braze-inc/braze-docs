...
To help troubleshoot issues in your app, or reduce turnaround times with Braze Support, you can enable verbose logs for the SDK. When you send verbose logs to Braze Support, ensure they begin as soon as you launch your application and end far after your issue occurs. For a centralized overview, see [Verbose logging]({{site.baseurl}}/developer_guide/verbose_logging). To learn how to interpret log output, see [Reading verbose logs]({{site.baseurl}}/developer_guide/verbose_log_reading).
