...
- This metric is not retroactively calculated for past campaigns.

{% alert note %}
This metric is being gradually rolled out and may not appear in your campaign analytics just yet.
{% endalert %}
