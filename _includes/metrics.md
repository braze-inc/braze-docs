...
<i>Spam</i> is the total number of emails delivered that were marked as “spam.” Braze automatically unsubscribes users that marked an email as spam, and those users won’t be targeted by future emails. Users will still receive transactional emails that are configured to "send to all users including unsubscribe"
{% endif %}
