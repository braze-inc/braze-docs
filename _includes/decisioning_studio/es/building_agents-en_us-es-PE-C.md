...
- Elige una métrica de éxito para que BrazeAI™ la optimice, como ingresos, conversiones o ARPU.
- Define qué dimensiones probar, como la oferta, la línea del asunto, la creatividad, el canal o la hora de envío.
- Selecciona las opciones para cada dimensión, como correo electrónico frente a SMS, o frecuencia diaria frente a semanal.

\![Diagrama de ejemplo de un agente de estudio de decisiones para correos electrónicos de referidos.]({% image_buster /assets/img/offerfit/example_use_cases_referral_email.png %})
...
Completaréis juntos los siguientes pasos para crear un agente personalizado adecuado para ti.
...
- cualquier dato de clientes propios que el agente deba aprovechar para impulsar tus resultados empresariales. 
...
A continuación, el equipo del Servicio Experto en IA te ayudará a configurar tu plataforma de automatización del marketing. Aunque el estudio de toma de decisiones funciona mejor con Braze, es compatible con otras plataformas: ponte en contacto con tu equipo del Servicio Experto en IA para obtener más recursos.
...
2. Asegúrate de no incluir un [grupo de]({{site.baseurl}}/user_guide/engagement_tools/testing/multivariant_testing/create_multivariate_campaign#including-a-control-group) control Braze, para que BrazeAI™ pueda ser el grupo de control dedicado en su lugar.
