...
Because this metric is recalculated on an ongoing cadence, the EROR value can change over time as new engagement signals (such as opens and clicks) are received and incorporated into the model. In practice, EROR can continue to update daily while a campaign remains active.
