...
!["SMS/RCS and Messaging Apps Domains" page with several domains listed.]({% image_buster /assets/img/main_page.png %}){: style="max-width:70%;"}
...
Campaigns sent with link shortening turned on will use the assigned domain associated with your WhatsApp or SMS and RCS subscription group.
