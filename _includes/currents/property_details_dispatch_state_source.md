...
<li><code>state_change_source</code> will return a string of the full source name. For example, the source CSV import will return the string <code>CSV Import</code>. Available sources are listed below:</li>
</ul>
