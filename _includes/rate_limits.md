...
For customers who onboarded with Braze on or after August 22, 2024, we apply a rate limit of 250 requests per minute to this endpoint, as documented in [API rate limits]({{site.baseurl}}/api/api_limits/).
