class SWHelper
    ...
    def write_sw_register()
        ...
        if ('serviceWorker' in navigator) {
            navigator.serviceWorker.register('#{@site.baseurl}/#{@sw_filename}?v=#{@site.time.to_i.to_s}').then(function(reg) {
    ...
    def write_sw()
        ...
        import_scripts_str =
        <<-SCRIPT
            importScripts("https://storage.googleapis.com/workbox-cdn/releases/#{SWHelper::WORKBOX_VERSION}/workbox-sw.js");
        SCRIPT
