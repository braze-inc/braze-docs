  ...
  module SdkMinVersions
    class SdkMinVersionsTag < Liquid::Tag
      ...
      def render(context)
        ...
        if !@original_web.nil?
          render_html += "<a href='/developer_guide/platform_integration_guides/web/changelog/##{@web_changelog_ref}' class='sdk-versions--chip web-sdk'>Web: #{@original_web}+</a>"
        end
        if !@ios_changelog_ref.nil?
          render_html += "<a href='/developer_guide/platform_integration_guides/ios/changelog/##{@ios_changelog_ref}' class='sdk-versions--chip ios-sdk'>iOS: #{@original_ios}+</a>"
        end
        if !@android_changelog_ref.nil?
          render_html += "<a href='/developer_guide/platform_integration_guides/android/changelog/##{@android_changelog_ref}' class='sdk-versions--chip android-sdk'>Android: #{@original_android}+</a>"
        end
