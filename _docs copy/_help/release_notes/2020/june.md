...
The [`users/track` endpoint][3] now has a default rate of 50,000 API requests per minute for dashboard companies created after June 2, 2020. Existing companies created before this date and their workspaces will still be allowed unlimited API requests to the `users/track` endpoint.
