...
Vous pouvez désormais afficher tous les alias de lien que vous suivez dans vos e-mails depuis **Gérer les paramètres** > **Paramètres des e-mails** > **Paramètres d’aliasage de lien**. Consultez les [Liens de suivi]({{site.baseurl}}/user_guide/message_building_by_channel/email/templates/link_aliasing/#tracking-links) pour plus d’informations.
