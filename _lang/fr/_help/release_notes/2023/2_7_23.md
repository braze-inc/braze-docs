...
noindex: true
page_type: update
description: "Cet article contient les notes de version du 7/02/2023."
---
...
- Tenez compte des variations de fuseaux horaires, de paramètres d’entrée, etc.
- Passez en revue et ajustez votre Canvas en cas de divergences après le lancement en fonction de ces scénarios
...
- [SDK AppboyKit iOS 4.5.3](https://github.com/Appboy/appboy-ios-sdk/releases/tag/4.5.3)
