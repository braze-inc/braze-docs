...
L'intégration de Braze et Nexla permet aux clients qui utilisent Currents de tirer parti de Nexla [pour]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/setting_up_currents/) extraire, transformer et charger les données des lacs de données vers d'autres emplacements dans un format personnalisé, rendant ainsi les données facilement accessibles dans l'ensemble de votre écosystème.
