...
1. Dans Hightouch, allez dans [**Modals overview (Vue d’ensemble des Modaux)**](https://app.hightouch.com/models) > **Add model (Ajouter un modèle)** et sélectionnez la source que vous venez de connecter. <br><br>
