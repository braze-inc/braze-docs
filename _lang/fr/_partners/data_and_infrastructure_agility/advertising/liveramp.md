...
Pour une procédure pas à pas complète, consultez le guide d'[intégration de Snowflake]({{site.baseurl}}/partners/data_and_infrastructure_agility/data_warehouses/snowflake/) avec Braze.
...
Les journaux d'événements de Braze contiennent des identifiants que vous pouvez utiliser dans l'application native LiveRamp. Pour obtenir la liste complète des identifiants disponibles pour chaque type d'événement, téléchargez les [schémas et identificateurs d'événements Braze](https://www.braze.com/docs/assets/download_file/data-sharing-raw-table-schemas.txt).
