...
&#42; L’attribut mParticle [`$mobile` ](https://docs.mparticle.com/developers/server/json-reference/#user_attributes) est utilisé en tant que numéro de téléphone destinataire  (`to_phone_number`) dans mParticle.
{% endtab %}
{% endtabs %}
