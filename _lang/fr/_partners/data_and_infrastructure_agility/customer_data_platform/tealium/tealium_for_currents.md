...
Braze prend en charge l'exportation vers Tealium de toutes les données répertoriées dans les [glossaires d'événements de Braze Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents) (y compris toutes les propriétés des événements d'[engagement d'un message]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/message_engagement_events/) et de [comportement des clients]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/customer_behavior_events/) ).
