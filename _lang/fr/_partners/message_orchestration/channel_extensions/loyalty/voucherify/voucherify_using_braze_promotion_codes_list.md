...
- Si votre campagne Voucherify utilise la fonction  _Inscription unique_, vous devez supprimer `source_id` du corps du contenu connecté comme décrit dans l'onglet "Inscription unique" ci-dessus.
