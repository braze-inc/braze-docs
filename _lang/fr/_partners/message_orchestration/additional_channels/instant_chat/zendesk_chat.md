...
Sélectionnez **API Triggered réception/distribution**, et copiez l'ID de la campagne.
...
Mettez en place une campagne webhook pour transmettre les messages SMS restants de l'utilisateur à Zendesk :
