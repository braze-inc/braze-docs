...
Si vous n'utilisez pas actuellement d'identifiants d'appareil - tels que l'IDFV ou le GAID - dans vos liens de suivi des clics, ou si vous ne prévoyez pas de le faire à l'avenir, Adjust sera toujours en mesure d'attribuer ces clics par le biais de sa modélisation probabiliste.
{% endalert %}
