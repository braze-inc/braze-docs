...
| -----------|----------| --------|------- |
| `aliases_to_identify` | Requis | Array d’alias pour identifier l’objet | Voir [alias pour identifier l’objet]({{site.baseurl}}/api/objects_filters/aliases_to_identify/) et [objet Alias utilisateur]({{site.baseurl}}/api/objects_filters/user_alias_object/). |
