...
Les principaux endpoints d’API Braze sont des endpoints spécifiques dans l’API REST de Braze qui ont un temps d’arrêt autorisé conforme au contrat de niveau de service (CNS) d’un compte Braze. Pour plus d’informations, consultez votre documentation relative à l’accord de niveau de service, ou contactez votre gestionnaire de compte. 

Les principaux endpoints comprennent :
- [`/users/track`][1]
- [`/users/delete`][2]
- [`/email/status`][3]
- [`/email/blocklist`][4]
