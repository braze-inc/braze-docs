...
<div id="firefox_warning" style="display:none;">Si vous utilisez Mozilla Firefox, autorisez ce site ou vérifiez vos <a href="https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Privacy/Tracking_Protection?utm_source=mozilla&utm_medium=firefox-console-errors&utm_campaign=default" target="_blank">Paramètres de protection contre le pistage</a>, sinon votre ticket ne sera pas envoyé.</div>
                    ...
                    <div id="ticket_submit_option">
                      ...
                      <div class="form-group" id="ticket_priority_div">
                        ...
                        <select id="ticket_priority" name="priority"  class="form-control" >
                          ...
                          <option value="Medium">Intermédiaire : Performances réduites ou problèmes entraînant un impact commercial significatif</option>
                          <option value="Low" selected="selected">Faible : Question sur la fonctionnalité ou l’analyse de Braze</option>
                        </select>
                      </div>
