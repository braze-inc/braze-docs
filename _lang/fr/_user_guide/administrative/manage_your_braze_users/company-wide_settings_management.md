...
La page **Paramètres de l’entreprise** vous permet de modifier le nom de votre entreprise, de définir votre fuseau horaire et de demander à supprimer votre entreprise.
...
- Bien que les campagnes prévues pour des horaires spécifiques dans des endroits spécifiques (c.-à-d. 21 h, heure de l’Est) fonctionnent correctement sur le calendrier jusqu’à ce qu’elles soient modifiées, l’analyse de campagne et les futures planifications de campagne seront affectées par le changement.
...
| Erreurs de contenu connecté | Informe les destinataires lorsqu’une URL de contenu connecté expire plus de 300 fois en 5 minutes. Cette notification ne peut pas être envoyée plus d’une fois toutes les deux heures. | E-mail, Webhook |
...
1. Sélectionnez le canal Slack vers lequel vous souhaitez que les notifications soient envoyées et cliquez sur **Ajouter une intégration de Webhooks entrants**.<br><br>
...
3. Naviguez jusqu’à l’onglet **Préférences de notification** dans **Paramètres de l’entreprise**.<br><br>
4. Sélectionnez la notification que vous souhaitez activer pour Slack. Ou, si vous avez plusieurs notifications à envoyer à ce canal Slack, utilisez **Ajout groupé** pour ajouter le Webhook à plusieurs notifications.<br><br>
    ![Sélectionnez Notifications Slack à activer][65]{: style="max-width:60%;"}<br><br>
...
![Section Paramètres des e-mails sortants de l’onglet Paramètres d’e-mail][7]

## Paramètres de liste-désabonnement

![Lien de désinscription de la liste d’adresses dans un en-tête d’e-mail][57]{: style="float:right;max-width:60%;margin-left:15px;"}
...
Pour plus d’informations sur le désabonnement d’une liste, consultez les [Paramètres d’e-mail][2]
...
![Paramètres de sécurité de la page Paramètres de l’entreprise][50]
...
![Section Règles d’authentification de l’onglet Paramètres de sécurité][51]
...
![Section Whiteliste des adresses IP du tableau de bord dans l’onglet Paramètres de sécurité][52]
...
2. Naviguer vers **Authentification à deux facteurs** sous **Paramètres du compte** et saisissez votre numéro de téléphone.
...
Sous l’onglet **Gérer les utilisateurs**, une colonne supplémentaire indique les utilisateurs du compte qui ont activé l’authentification à deux facteurs.

![Section Utilisateurs de compte sur la page Gérer les utilisateurs][55]
