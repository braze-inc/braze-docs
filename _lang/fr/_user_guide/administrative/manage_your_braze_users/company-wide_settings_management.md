...
La page de paramètres de sécurité permet de configurer les règles d’authentification, la whiteliste IP du tableau de bord et l’authentification à deux facteurs. Ces paramètres sont situés dans l’onglet **Paramètres de sécurité** de la page **Paramètres de l’entreprise**.
