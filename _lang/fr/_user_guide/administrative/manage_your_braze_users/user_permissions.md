...
|Afficher les Informations personnellement identifiables | Permet à l’utilisateur d’afficher les champs des informations personnellement identifiables telles que définies par votre entreprise dans le tableau de bord. Cela vous permet également de modifier le statut d’abonnement d’un utilisateur et les règles d’inscription/de désinscription de son groupe d’abonnement.|
