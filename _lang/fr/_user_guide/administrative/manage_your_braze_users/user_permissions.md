...
|Campagnes d’accès, Canvas, cartes, segments, bibliothèque multimédia| L’utilisateur peut consulter les mesures de performance de la campagne et des Canvas, créer et dupliquer des projets de campagnes et de Canvas, afficher des projets de fil d’actualités, des segments, des modèles et des médias, créer des modèles, télécharger des médias et afficher des rapports d’engagement. Cependant, les utilisateurs avec cette autorisation ne peuvent pas afficher le contenu en direct existant. |
