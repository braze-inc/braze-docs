...
Pour envoyer un message MMS, au moins un numéro au sein de votre groupe d’abonnement doit être habilité à envoyer des MMS. Cela est indiqué par un tag à côté du groupe d’abonnement. 
