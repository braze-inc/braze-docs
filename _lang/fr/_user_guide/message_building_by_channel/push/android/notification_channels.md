...
|La **Société XYZ** met à jour vers un SDK qui pend en charge Android O <br>La **Société XYZ** n’ajoute pas de canaux au tableau de bord de Braze<br>La **Société ABC** renomme son canal SDK par défaut pour « Marketing »| Les notifications push envoyées aux appareils Android O créeront un canal appelé « Marketing » et les notifications seront envoyées via ce canal
