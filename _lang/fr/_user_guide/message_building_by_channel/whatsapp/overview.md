...
| Numéro de téléphone WhatsApp | Un numéro de téléphone WhatsApp Business est nécessaire pour exploiter ce canal de communication. | 
...
Dans Braze, accédez à **Technology Partners** puis recherchez **WhatsApp**. Sur la page partenaire WhatsApp, sélectionnez **Se connecter avec Facebook** pour débuter le processus d’intégration.
...
L’approbation de WhatsApp peut prendre jusqu’à 24 heures. Vous pouvez vérifier le statut d’approbation de votre message sur la page **Modèle de message** dans le gestionnaire Meta Business.
