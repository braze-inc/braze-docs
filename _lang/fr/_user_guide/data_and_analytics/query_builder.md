...
| --- | --- | --- | --- |
| Engagement du canal et chiffre d’affaires | Pour chaque canal, vous verrez tous ses indicateurs d’engagement (ouverture, clics, etc.), le chiffre d’affaires, le nombre de transactions et le prix moyen. | - **Nombre de transactions :** nombre d’événements d’achat<br> - **Prix moyen :** chiffre d’affaires divisé par les transactions | ![]({% image_buster /assets/img_archive/query_builder_q1.png %}) |
| Rebonds d’e-mail par domaine | Nombre de rebonds par domaine d’e-mail | | ![]({% image_buster /assets/img_archive/query_builder_q2.png %}) |
| Performance e-mail par pays | Pour chaque pays, vous verrez les indicateurs suivants : envoi, taux d’ouverture indirect et direct. Le pays est le pays de l’utilisateur au moment de l’envoi de la notification push. | | ![]({% image_buster /assets/img_archive/query_builder_q3.png %}) |
