...
Une fois que vous avez sélectionné un événement de rétention, cliquez sur **Run Report (Rapport d'exécution)** pour démarrer la requête.
...
- **All Users Row (Ligne « Tous les utilisateurs »)**: Également appelé Ligne récapitulative du rapport, elle résume les données de rétention sur toute la période. Notez que si un utilisateur a reçu la campagne ou le Canvas dans plusieurs cohortes, ses résultats seront comptabilisés deux fois ici. 
