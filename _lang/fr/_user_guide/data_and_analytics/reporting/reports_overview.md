...
Utilisez la page [Vue d’ensemble]({{site.baseurl}}/user_guide/data_and_analytics/reporting/understanding_your_app_usage_data/) pour voir un résumé de haut niveau des indicateurs clés sur les performances de votre application ainsi que des informations sur la base utilisateurs de votre application.
...
**Engagement Reports (Rapports de mission)**
...
- Nombre total de :
  ...
  - Utilisateurs pouvant être contactés par e-mail qui ont explicitement consenti à recevoir des e-mails
