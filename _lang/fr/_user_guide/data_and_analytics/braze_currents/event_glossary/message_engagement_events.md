...

{
  ...
  "app_group_id": (string) BSON id of the workspace this user belongs to,
  "app_group_api_id": (string) API ID of the workspace this user belongs to,
...
// SMS Inbound Received: users.messages.sms.InboundReceive
{
  ...
  "user_id": (string) Braze user id of the user,
  "external_user_id": (string) External ID of the user,
  "app_group_id": (string) API ID of the workspace associated with the inbound phone number,
  "time": (int) 10-digit UTC time of the event in seconds since the epoch,
