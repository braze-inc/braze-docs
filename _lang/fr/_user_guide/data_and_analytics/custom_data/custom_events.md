...
Vous pouvez également utiliser les propriétés de l’événement personnalisées pour la personnalisation du modèle d’envoi de message. Toute campagne utilisant la [Livraison par événement][19] avec un événement déclencheur peut utiliser des propriétés de l’événement personnalisées de cet événement pour la personnaliser les messages.
...
Les propriétés de l’événement personnalisé sont conçues pour vous aider à améliorer le ciblage et à personnaliser davantage vos messages. Les propriétés de l’événement personnalisé peuvent être stockées dans Braze à court et à long terme.
