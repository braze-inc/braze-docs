...
Ce processus garantit que Braze fournit des statistiques précises sur les audiences accessibles à la campagne. Il permet aussi de se conformer à deux concepts clés du [RGPD][1] :
...
Dans ce cas, ces utilisateurs ne peuvent pas être recevoir de communications et ne s’engagent pas avec votre marque. Dans les faits, ces utilisateurs sont perdus.
...
Si nécessaire, vous pouvez supprimer les utilisateurs via l’endpoint de l’API[Users Delete]({{site.baseurl}}/api/endpoints/user_data/post_user_delete/).
...
- Vous conformer au RGPD et aux bonnes pratiques en matière de confidentialité en supprimant les profils utilisateur qui ne sont plus importants.
- Conserver tous les profils utilisateur dont vous avez vraiment besoin pour vos affaires.
...
3. Configurez l’étape de mise à jour de l’utilisateur pour ajouter un attribut à chaque profil.<br><br>
