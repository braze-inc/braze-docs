L’installation du SDK Braze vous fournira des fonctionnalités d’analyse de base,{% if include.platform == 'iOS' %} ainsi que des messages in-app actifs avec lesquels vous pouvez engager vos utilisateurs{% endif %}.
