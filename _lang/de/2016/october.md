...
Unternehmensbenutzer können nun CSV-Dateien der kürzlich importierten Nutzer:innen herunterladen. Dadurch erhalten Sie mehr Einblick in die Daten, die von Ihren Systemen synchronisiert werden. Erfahren Sie mehr über den [CSV-Import]({{site.baseurl}}/user_guide/data/user_data_collection/user_import/).
