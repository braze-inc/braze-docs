...
## Stile für In-App-Nachrichten &zurücksetzen Drag-and-Drop-Editor

Im &Drag-and-Drop-Editor für In-App-Nachrichten können Sie nun nach Änderungen die Stile schnell auf ihre Standardgestaltung zurücksetzen. Weitere Informationen finden Sie unter [Stile auf den Standard zurücksetzen]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop/create/#resetting-styles-to-default).
