...
![Eine Reihe von Breadcrumbs navigiert von Benutzerhandbuch > Nachrichtenerstellung nach Kanal > In-App-Nachrichten > Vorlagen > Einfache Umfrage]({% image_buster /assets/img/doc-breadcrumbs.png %}){: style="max-width:55%"}
...
{% alert important %}
Der SQL-Editor befindet sich im Early Access. Wenn Sie an einer Teilnahme am Early Access interessiert sind, wenden Sie sich bitte an Ihren Customer-Success-Manager.
{% endalert %}
...
## Veranstaltungen von New users_campaigns_abortCurrents: users_canvas_abort
...
[Shopify Historical Backfill]({{site.baseurl}}/partners/ecommerce/shopify_legacy/shopify_features/shopify_backfill) ermöglicht es Braze, alle Kunden, Bestellungen und Kauf-Events aus den letzten 90 Tagen vor Ihrer Integration in Shopify zu importieren.
