...
Um Ihnen die Suche nach den gewünschten Informationen zu erleichtern, haben wir die Artikel, die zuvor unter &„Analytics” zusammengefasst waren, in [„DATEN”]({{site.baseurl}}/user_guide/data) und [„ANALYSEN”]({{site.baseurl}}/user_guide/analytics) unterteilt. 
