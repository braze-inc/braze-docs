...
![Die vorherige Swift-Dokumentation finden Sie im Abschnitt „Plattformintegrationshandbücher“.]({% image_buster /assets/img/before_swift.png %})
...
![Die aktualisierte Swift-Dokumentation hat ihren Standort im Artikel „Integration des SDK“ auf dem Tab „Swift“.]({% image_buster /assets/img/after_swift.png %})

![Die aktualisierte Android-Dokumentation befindet sich auf der Registerkarte „Android“ im Artikel „Integration des SDK“.]({% image_buster /assets/img/after_android.png %})
...
Banner unterstützen jetzt Flutter. Außerdem wurde die gesamte Dokumentation von Banner Card überarbeitet, um die Benutzerfreundlichkeit zu erhöhen. Lesen Sie die folgenden Artikel, um loszulegen:

- [Über Banner]({{site.baseurl}}/developer_guide/banners/)
- [Erstellen von Banner-Kampagnen]({{site.baseurl}}/user_guide/message_building_by_channel/banners/create/)
