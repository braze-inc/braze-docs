...
Nutzen Sie [die SAML-Just-in-Time-Bereitstellung,]({{site.baseurl}}/user_guide/administrative/access_braze/single_sign_on/saml_jit) um neuen Unternehmensnutzer:innen zu ermöglichen, bei ihrer ersten Anmeldung ein Braze-Konto zu erstellen. Dadurch entfällt für Administratoren die Notwendigkeit, manuell ein Konto für einen neuen Nutzer:in zu erstellen, dessen Berechtigungen auszuwählen, ihn einem Workspace zuzuweisen und darauf zu warten, dass er sein Konto aktiviert.
