...
> [Grouparoo](https://www.grouparoo.com/) ist ein Open-Source-Reverse-ETL-Tool, das Daten aus Ihrem Data Warehouse mit Marketing-, Vertriebs- und Support-Tools synchronisiert. Die modellorientierte UI ermöglicht es auch nicht-technischen Teammitgliedern, Zeitpläne für Datensynchronisierungen zu erstellen und zu konfigurieren.

Die Integration von Braze und Grouparoo synchronisiert Lagerdaten mit Braze. Automatische Zeitpläne für die Synchronisierung gewährleisten, dass die Kommunikation mit den Kund:innen stets mit aktuellen Informationen auf dem neuesten Stand ist.
...
- **Sync**: Fügen Sie nach Bedarf Unternehmensnutzer:innen hinzu, führen Sie Updates durch oder entfernen Sie sie. Diese Option sucht nach neuen Datensätzen, Änderungen an bestehenden Datensätzen und Löschungen.
- **Zusatzstoff**: Bitte fügen Sie nach Bedarf Unternehmensnutzer:innen hinzu und führen Sie Updates durch, jedoch entfernen Sie bitte niemanden. Diese Option sucht nach neuen Nutzern, die zu Braze hinzugefügt werden sollen, sowie nach Änderungen an bestehenden Unternehmensnutzern, verfolgt jedoch keine Löschungen.
...
![Beispielfelder für die Abbildung von Eigenschaften. Die Grouparoo-Benutzer-ID wird so konfiguriert, dass sie mitexternal_id.der E-Mail-Adresse abgebildet wird. Der Vorname und der Nachname werden als gleichwertige „E-Mail”-"first_name",und"last_name"„grouparoo”-Felder festgelegt.]({% image_buster /assets/img/grouparoo/mapping.png %}){: style="max-width:80%;"}
