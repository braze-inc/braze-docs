...
|US-10| `https://dashboard-10.braze.com` | `https://rest.iad-10.braze.com` | `sdk.iad-10.braze.com` |
...
Für die Instanz `US-08` sind dies die entsprechenden IP-Adressen:
- `52.151.246.51`
- `52.170.163.182`
- `40.76.166.157`
- `40.76.166.170`
...
Für die Instanz `US-10` sind dies die entsprechenden IP-Adressen:
- `100.25.232.164`
- `35.168.86.179`
- `52.7.44.117`
- `3.92.153.18`
