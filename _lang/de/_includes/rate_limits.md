...
{% elsif include.endpoint == "Dashboard-Nutzer:in aktualisieren" %}
...
{% elsif include.endpoint == "Dashboard-Nutzer:in nachschlagen" %}
...
{% elsif include.endpoint == "Dashboard-Nutzer:in löschen" %}
...
<!---POST /scim/v2/Users--->
{% elsif include.endpoint == "Dashboard-Nutzer:in erstellen" %}
...
<!---GET /scim/v2/Users--->
{% elsif include.endpoint == "E-Mail des:der Dashboard-Nutzer:in nachschlagen" %}
Dieser Endpunkt hat ein Rate-Limit von 5.000 Anfragen pro Tag und Unternehmen. Dieses Rate-Limit gilt auch für die Endpunkte `/scim/v2/Users/` PUT, GET, DELETE und POST, wie unter [API-Rate-Limits]({{site.baseurl}}/api/api_limits/) beschrieben.

<!---/users/external_id/rename-->
<!---/users/external_id/remove-->

{% elsif include.endpoint == "externe ID-Migration" %}
...
{% elsif include.endpoint == "Nutzer:innen verfolgen" %}
...
{% elsif include.endpoint == "Nutzer:innen exportieren IDs" %}
...
{% elsif include.endpoint == "Nutzer:innen löschen" %}
...
{% elsif include.endpoint == "Nutzer-Alias neu" %}
...
{% elsif include.endpoint == "Nutzer-Alias aktualisieren" %}
...
{% elsif include.endpoint == "Nutzer:innen identifizieren" %}
...
{% elsif include.endpoint == "Nutzer:innen zusammenführen" %}
...
{% elsif include.endpoint == "Ereignisse" %}
...
{% elsif include.endpoint == "Endpunkte senden" %}
...
{% elsif include.endpoint == "Transaktions-E-Mail" %}
...
{% elsif include.endpoint == "sendet id erstellen" %}
...
{% elsif include.endpoint == "Abostatus eingestellt" %}
...
{% elsif include.endpoint == "cdi-Liste Integrationen" %}
...
{% if include.endpoint == "asynchroner Katalogartikel" %}
...
{% if include.endpoint == "synchroner Katalogartikel" %}
...
{% if include.endpoint == "Synchroner Katalog" %}
...
{% if include.endpoint == "asynchrone Katalogfelder" oder include.endpoint == "asynchrone Katalogauswahlen" %}
...
{% if include.endpoint == "Kampagnenanalysen exportieren" %}
