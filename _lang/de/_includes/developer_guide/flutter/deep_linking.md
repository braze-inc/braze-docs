...
Bevor Sie Deeplinks in Ihre Flutter App implementieren können, müssen Sie Deeplinks in der nativen [Android-]({{site.baseurl}}/developer_guide/push_notifications/deep_linking/?sdktab=android) oder [iOS-Schicht]({{site.baseurl}}/developer_guide/push_notifications/deep_linking/?sdktab=swift) einrichten.
...
5. Setzen Sie den Wert auf `YES`.
    ![Ein Beispiel für die Datei "Info.plist" mit dem hinzugefügten Schlüssel-Wert-Paar.]({% image_buster /assets/img/flutter/flutter-ios-deep-link-info-plist.png %} "Xcode Project Info.plist File")
{% endtab %}
