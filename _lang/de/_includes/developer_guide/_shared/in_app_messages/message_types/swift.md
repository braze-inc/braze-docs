...
![Eine In-App-Nachricht mit Slideup am unteren und oberen Rand des Telefondisplays.]({% image_buster /assets/img/slideup-spec.png %}){: style="max-width:35%;border:none;"}
...
![Eine modale In-App-Nachricht in der Mitte des Telefondisplays.]({% image_buster /assets/img/modal-header-text.png %}){: style="max-width:35%;border:none;"}
...
![Eine modale In-App-Nachricht in der Mitte des Telefondisplays.]({% image_buster /assets/img/modal-full-image.png %}){: style="max-width:35%;border:none;"}
...
![Eine In-App-Nachricht im Vollbildmodus, die auf dem gesamten Telefonbildschirm angezeigt wird.]({% image_buster /assets/img/full-screen-header-text.png %}){: style="max-width:35%;border:none;"}
...
![Eine bildschirmfüllende In-App-Nachricht, die auf dem gesamten Telefondisplay angezeigt wird.]({% image_buster /assets/img/full-screen-image.png %}){: style="max-width:35%;border:none;"}
