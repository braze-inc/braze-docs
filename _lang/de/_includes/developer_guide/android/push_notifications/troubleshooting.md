...
Wenn eine Push-Benachrichtigung nicht zugestellt wurde, überprüfen Sie in der [Entwicklungskonsole]({{site.baseurl}}/developer_guide/platforms/android/push_notifications/troubleshooting/#utilizing-the-push-error-logs), ob ein Bounce-Fehler vorliegt. Im Folgenden finden Sie Beschreibungen häufiger Fehler, die in der Entwicklungskonsole protokolliert werden können:
