...
Besuchen Sie unseren Artikel [SDK Datenerfassung]({{site.baseurl}}/user_guide/data/user_data_collection/sdk_data_collection/), um mehr über die automatisch erfassten Eigenschaften des Geräts zu erfahren.
