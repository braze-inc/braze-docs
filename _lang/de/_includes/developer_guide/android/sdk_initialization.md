...
Die [Laufzeitkonfiguration](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze/-braze/-companion/configure.html) ist eine optionale Möglichkeit, Ihre App zur Laufzeit zu konfigurieren, anstatt die `braze.xml`.
...
Sie können den [Google Tag Manager](https://tagmanager.google.com/) initialisieren, konfigurieren und in Ihre Android oder FireOS App implementieren.
