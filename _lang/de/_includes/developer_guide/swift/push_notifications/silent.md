...
Wenn Sie stille Push-Benachrichtigungen verwenden möchten, um Aufgaben im Hintergrund zu triggern, müssen Sie Ihre App so konfigurieren, dass sie auch dann Benachrichtigungen erhält, wenn sie sich im Hintergrund befindet. Fügen Sie dazu die Funktion Background Modes über den Bereich **Signing & Capabilities** zum Haupt-Targeting der App in Xcode hinzu. Aktivieren Sie das Kontrollkästchen **Fernbenachrichtigungen**.
