...
Standardmäßig verarbeitet das Braze Cordova SDK Deeplinks aus Push-Benachrichtigungen nicht automatisch. Um Push-Deeplinking zu aktivieren, befolgen Sie bitte die Konfigurationsschritte unter [Deep Linking]({{site.baseurl}}/developer_guide/cordova/deep_linking/).
