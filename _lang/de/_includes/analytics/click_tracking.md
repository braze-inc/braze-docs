...
Während Sie mit Linkverkürzungen Ihre URLs automatisch verfolgen können, können Sie auch UTM-Parameter zu Ihren URLs hinzufügen, um die Performance von Kampagnen in Analytics-Tools von Drittanbietern wie Google Analytics zu verfolgen.
...
Wenn die Kampagne vor dem Testversand als Entwurf gespeichert wurde, ja. Andernfalls handelt es sich um einen Platzhalter-Link. Beachten Sie, dass sich die bei einer gestarteten Kampagne gesendete URL von der im Testversand gesendeten unterscheiden kann.
