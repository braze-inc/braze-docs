...
Wenn Sie feststellen, dass Ihre Benutzer-IDs Namen, E-Mail-Adressen, Zeitstempel oder Inkrementoren enthalten, empfehlen wir Ihnen, eine neue, sicherere Benennungsmethode zu verwenden, damit Ihre Benutzer-IDs nicht so leicht zu erraten oder nachzuahmen sind. Wenn Sie sich dafür entscheiden, dies in Ihre Benutzer-IDs aufzunehmen, **empfehlen wir dringend,** unser [SDK-Authentifizierungsfeature]({{site.baseurl}}/developer_guide/platform_wide/sdk_authentication/) hinzuzufügen, um Identitätswechsel von Nutzer:innen zu verhindern.
