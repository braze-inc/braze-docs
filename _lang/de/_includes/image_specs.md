...
Modale In-App-Nachrichten sind so gestaltet, dass sie sich dem Gerät in den bestmöglichen und füllendsten Verhältnissen anpassen, wobei die Größe und die Verhältnisse des von Ihnen gewählten Bildes oder Textes für Ihre Nachricht beibehalten werden.

Es gibt zwar keine Beschränkungen für die Anzahl der Textzeichen, die Sie in einer In-App-Nachricht (sowie in Schaltflächen, in der Überschrift, im Hauptteil und in anderen Teilen) verwenden können, aber wir begrenzen die Anzahl der Textzeichen, die Sie verwenden. Zu viel Text führt dazu, dass die Nutzer die Nachricht erweitern und scrollen müssen.
...
| --- | --- | 
| Größe | 5 MB |
| Breite | Überschrift: 600 px<br>Körper: 480 px |
