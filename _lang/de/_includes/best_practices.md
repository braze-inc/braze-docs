...
- Wenn Ihre App von mehreren Personen genutzt wird, können Sie jedem Benutzer eine eindeutige Kennung zuweisen, um ihn zu verfolgen.
...
{% alert tip %}
Wenn Sie sich dafür entscheiden, einen Hash einer eindeutigen Kennung als Ihre Benutzer-ID zu verwenden, stellen Sie sicher, dass Sie die Eingabe für Ihre Hash-Funktion normalisieren. Wenn Sie z.B. einen Hash einer E-Mail-Adresse verwenden, sollten Sie sicherstellen, dass Sie führende und abschließende Leerzeichen aus der Eingabe entfernen und die Lokalisierung berücksichtigen.
{% endalert %}