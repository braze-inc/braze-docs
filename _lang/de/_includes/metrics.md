...
<i>Ausblendungen insgesamt</i> ist die Anzahl der Ablehnungen von Content-Cards aus einer Kampagne. Wenn ein Benutzer eine Nachricht zweimal ausblendet, wird sie nur einmal gezählt.
{% endif %}
...
<i>Eindeutige Ausblendungen</i> ist die Anzahl der Benutzer, die Content Cards aus einer Kampagne ausgeblendet haben. Ein Benutzer, der eine Content-Card aus einer Kampagne mehrmals ausblendet, stellt eine eindeutige Ausblendung dar.
{% endif %}
