...
## Veranstaltungen&von New Currents

Zusätzlich zu einigen Korrekturen in diesem Abschnitt wurde ein neues []({{ site.baseurl}}/user_guide/data_and_analytics/braze_currents/message_engagement_events/#subscription-events)Abo-Ereignis zur Seite „Nachrichten-Engagement-Ereignisse“ hinzugefügt. 
...
{% alert important %}
Um von diesen Updates zu profitieren, müssen Sie die Einstellungen Ihres Currents Konnektors bearbeiten und die Ereignisse, die Sie verwenden möchten, aktivieren. Bei Fragen wenden Sie sich bitte an Ihren Account Manager.
{% endalert %}
