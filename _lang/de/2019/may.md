...
![Feed mit Content-Cards]({% image_buster /assets/img/cc-feed.png %}){: height="50%" width="50%"}
...
![Plattform Picker]({% image_buster /assets/img/iam_platforms.gif %})
...
Bitte sehen Sie sich diesen neuen Filter in unserer [Bibliothek für ]({{site.baseurl }}/user_guide/engagement_tools/segments/segmentation_filters/)Segmentierungsfilter an.
