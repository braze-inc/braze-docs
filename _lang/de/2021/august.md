...
Nutzer:innen, die Probleme bei der Anmeldung über die Zwei-Faktor-Authentifizierung haben, können sich an ihre Unternehmensadministratoren wenden, um [die Zwei-Faktor-Authentifizierung zurückzusetzen]({{site.baseurl}}/user_guide/administrative/app_settings/company_settings/security_settings/#user-authetication-reset).
...
### Transcend – Datenschutz und& Compliance
