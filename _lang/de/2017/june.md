...
Wir haben die externe API aktualisiert, um dascollapse_idFeld für Apple Push zu unterstützen, sodass Sie Ihren Kunden präzise Nachrichten senden können. Erfahren Sie mehr über die [Braze Messaging API]({{site.baseurl}}/api/endpoints/messaging/).
