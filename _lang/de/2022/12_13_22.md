...
## HTML-Attribut für Links im &Drag-and-Drop-Editor für E-Mails
Sie können nun [HTML-Attribute]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/overview/#creative-details/) zu jeder URL innerhalb der `Image`Editor-Blöcke `Text`„“,`Button` „“ oder „“ im &Drag-and-Drop-Editor für E-Mails [hinzufügen]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/overview/#creative-details/). Mit angepassten Attributen können Sie problemlos zusätzliche Informationen an HTML Tags in E-Mails anhängen. Dies kann insbesondere für die Personalisierung, Segmentierung und Aufmachung Ihrer Nachrichten nützlich sein. 
...
## Neuer Video-Block
Dem &Drag-and-Drop-Editor für E-Mails wurde ein neuer Content-Block für [Videos]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/dnd_editor_blocks/#video) hinzugefügt.
...
Für weitere Informationen wenden Sie sich bitte an Ihren Customer-Success-Manager.
...
Die Integration von [ThoughtSpot]({{site.baseurl}}/partners/data_and_analytics/business_intelligence/thoughtspot/) und Braze nutzt ThoughtSpot TML Blocks, die es Unternehmensnutzern ermöglichen, ihre Verhaltensanalysen mit vorgefertigten Templates für Arbeitsblätter und Modelle zu beschleunigen. Diese Integration ermöglicht es Nutzern:innen, ihre Braze Interaktionsdaten grenzenlos zu durchsuchen und umsetzbare Insights zu entdecken. 
