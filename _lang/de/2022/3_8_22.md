...
Braze unterstützt jetzt das Senden von In-App-Nachrichten an Ihre Nutzer:innen auf ihren Roku Geräten! Bitte beachten Sie, dass hierfür eine zusätzliche SDK-Konfiguration erforderlich ist und diese Funktion im Standard nicht verfügbar ist. Weitere Informationen zur Integration von In-App-Nachrichten für Roku finden Sie unter [Roku In-App-Nachrichten]({{site.baseurl}}/developer_guide/in_app_messages/?sdktab=roku).
...
Die Integration von Braze und [Grouparoo]({{site.baseurl}}/help/release_notes/deprecations/grouparoo) synchronisiert Lagerdaten mit Braze. Automatische Zeitpläne für die Synchronisierung gewährleisten, dass die Kommunikation mit den Kund:innen stets mit aktuellen Informationen auf dem neuesten Stand ist.
