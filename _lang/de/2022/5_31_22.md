...
Mit Inbox Vision können Sie vor dem Versand überprüfen, ob Ihre Kampagnen per&Drag-and-Drop auf allen Ihren E-Mail-Clients und mobilen Plattformen korrekt angezeigt werden. Wenn Sie mehr erfahren möchten, besuchen Sie [Inbox Vision]({{site.baseurl}}/user_guide/message_building_by_channel/email/inbox_vision/).

## Update der HTML-Engine

Die zugrunde liegende Engine, die HTML aus dem &Drag-and-Drop-Editor generiert, wurde optimiert und mit einem Update versehen, was zu Vorteilen bei der Komprimierung und Darstellung von HTML-Dateien führt. Weitere Einzelheiten zu den Updates finden Sie unter [Aktualisierte HTML-Engine]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/overview/#updated-html-engine/).
