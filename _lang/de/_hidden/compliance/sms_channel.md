---
nav_title: Dokumentation zur Einhaltung der Vorschriften für mobile Nachrichten Dienste
article_title: Compliance-Dokumentation für mobile Nachrichten; Dienste
...
**"Aggregatoren",** **"Netzbetreiber"** oder **"Vermittler von mobilen Nachrichten"** sind Drittanbieter, die (i) mobile Nachrichten zwischen Anbietern von mobilen Nachrichten und Netzbetreibern übertragen; (ii) die Anbieter von drahtlosen Diensten sind (e.g., T-Mobile, AT&T, usw.); und/oder (iii) die an der Übertragung von RCS Nachrichten von Anbietern von mobilen Nachrichten an Nutzer:innen beteiligt sind.
