...
{% alert important %}
Die Braze-Empfehlungen auf dieser Seite gelten nicht für BrazeAI Decisioning Studio™. Um Anfragen zu Datenschutzrechten in Bezug auf persönliche Daten in BrazeAI Decisioning Studio™ zu verwalten, wenden Sie sich an Ihren Account Manager:in.
{% endalert %}
...
- Für Endnutzer:innen, die eine external_id innerhalb der Braze Dienste; Dienste haben, können Sie diese ID verwenden, um die Daten dieser Nutzer:innen zu löschen.
- Bei anonymen Endnutzern, die keine external_id innerhalb der Braze Serviceleistungen; Dienste; Dienste haben, können Sie den Bezeichner des Geräts dieses Endnutzers mit dem Braze SDK abrufen und den Bezeichner des Geräts verwenden, um das mit diesem Gerät verbundene Endnutzerprofil zu finden. Mit der User Deletion API können Sie das jeweilige Profil löschen.
...
<tbody>
  <tr>
    ...
    <ul>
        <li>EIGENSCHAFTEN für USERS_BEHAVIORS_CUSTOMEVENT</li>
        <li>EIGENSCHAFTEN für USERS_BEHAVIORS_PURCHASE</li>
