...
<div>
    <div class="container-fluid" id="main-container">
      <div class="row main-form">
        ...
        <div class="steps">
            <div class="step active">Grundlegende Details</div>
...
<div class='gpt-text'>Wird erstellt … </div>
<div class='gpt-text1'>Generierte Antwort für Sie </div>
                 </div>
...
<div id="ticket_mainform" class="container">
    <form  id="ticket_form">
      <div id="step3">
        <h2>Sie finden nicht, was Sie brauchen? Kontaktieren Sie unser Support Team.</h2>
        <!-- Row 1 -->
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="ticket_topic" class="required">Womit können wir Ihnen helfen? </label>
              <select id="ticket_topic" name="00N0V000009G0MG" class="form-control"></select>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="ticket_category" class="required">Kategorie </label>
