...
![Beispiel eines Segmenttrichters mit den folgenden Filtern: "Diese Apps wurden zuletzt vor weniger als 30 Tagen genutzt", "Artikel wurde zuletzt vor weniger als 30 Tagen auf die Warteliste gesetzt" und "Der letzte Kauf liegt weniger als 30 Tage zurück", um 4.302 Nutzer:innen zu erreichen.]({% image_buster /assets/img_archive/Wish_List_2.png %})
...
Dieser Anwendungsfall nutzt den Filter "Foreground Push Enablement for App", um Nutzer:innen von iOS oder Android zu targetieren, die sich für Push entschieden haben.
...
Dieser Anwendungsfall nutzt den Filter "Foreground Push Enabled", um Nutzer:innen zu targetieren, die sich für Push entschieden haben.

![]({% image_buster /assets/img/seg_filter_examples/both.png %})

### Globale Kontrollgruppe der Push-aktivierten Zielgruppe

Dieser Anwendungsfall nutzt die Filter "Foreground Push Enabled" und "Random Bucket #", um Nutzer:innen der globalen Kontrollgruppe, die sich für Push entschieden haben, zu targetieren.
