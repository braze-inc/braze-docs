...
<br>
{% alert important %}
Suchen Sie nach dem Leitfaden für die Integration von Push-Benachrichtigungen für Entwickler? Bitte finden Sie es. [here]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/integration/).
{% endalert %}
...
![Die Optionen für den Benachrichtigungs-Button finden Sie in den Einstellungen des Push-Nachrichten-Editors.]({% image_buster /assets/img/push_implementation_guide/push16.png %}){: style="max-width:75%;border:0;margin-top:10px"}
...
![Ein Diagramm, wie die Phasen einer interaktiven Push-Benachrichtigung aussehen könnten. Die Bilder zeigen einen Nutzer:in, der auf eine Push-Benachrichtigung drückt, die ein interaktives Memory-Spiel anzeigt.]({% image_buster /assets/img/push_implementation_guide/push12.png %}){: style="border:0"}
...
![Die Optionen für den Benachrichtigungs-Button finden Sie in den Einstellungen des Push-Nachrichten-Editors.]({% image_buster /assets/img/push_implementation_guide/push14.png %}){: style="max-width:50%;"}
...
![Vier Sätze von Schlüssel-Wert-Paaren, wobei"next_session_name"  und  als API-Trigger-Eigenschaft"next_session_complete_date" mit Liquid festgelegt sind und"completed_session  count" und  als benutzerdefiniertes "total_session_count"Attribut mit Liquid festgelegt sind.]({% image_buster /assets/img/push_implementation_guide/push5.png %}){: style="max-width:60%;"}
...
![Eine Push-Nachricht mit drei Gruppen von Schlüssel-Wert-Paaren. 1\. Als Liquid-Aufruf zum "Braze_id"Abrufen der Braze-ID festlegen. 2\.  Als „Braze "cert_title"Marketer-Zertifizierung“ festlegen. 3\. Als „Zertifizierte "Cert_description"Braze-Marketer fördern ...” festlegen.]({% image_buster /assets/img/push_implementation_guide/push9.png %})
