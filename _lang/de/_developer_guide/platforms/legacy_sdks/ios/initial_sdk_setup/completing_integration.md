...
Braze sollte nun Daten von Ihrer Anwendung erfassen und die grundlegende Integration sollte abgeschlossen sein. Lesen Sie die folgenden Artikel, um die [benutzerdefinierte Ereignisverfolgung]({{site.baseurl}}/developer_guide/analytics/logging_events/?tab=swift), [Push-Nachrichten]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/integration/) und die gesamte Palette der Braze-Funktionen zu aktivieren.
