...
Mehr über die automatisch erfassten Geräteeigenschaften zu erfahren Sie unter [SDK-Datenerfassung]({{site.baseurl}}/user_guide/data/user_data_collection/sdk_data_collection/). 
