...
Wenn Sie die Braze-UI-Bibliothek nicht in Ihr Projekt einbinden und getriggerte In-App-Nachricht-Payloads zur Weiterverarbeitung oder angepassten Anzeige in Ihrer App empfangen möchten, implementieren Sie das Protokoll [`ABKInAppMessageControllerDelegate`]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/in-app_messaging/customization/setting_delegates/).
