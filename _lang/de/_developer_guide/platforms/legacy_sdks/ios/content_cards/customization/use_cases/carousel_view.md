...
![Beispiel für eine Nachrichten-App, die eine Karussellansicht von Content-Cards in einem Artikel anzeigt.]({% image_buster/assets/img_archive/cc_politer_carousel.png %}){: style="max-width:35%;float:right;margin-left:15px;border:none;"}
