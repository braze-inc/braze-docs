---
nav_title: Anpassen des Kartenverhaltens
article_title: Anpassen des Inhaltskartenverhaltens
page_order: 2
...
# Verhalten der Inhaltskarte anpassen

> In diesem Implementierungsleitfaden werden Änderungen am Verhalten von Content-Cards, das Hinzufügen von Extras wie Schlüssel-Wert-Paaren zur Nutzlast und Vorgehensweisen für gängige Anpassungen erläutert. Einen grundlegenden Überblick über die Arten von Anpassungsmöglichkeiten, die Sie mit Content Cards haben, finden Sie unter [Übersicht über die Anpassung]({{site.baseurl}}/developer_guide/customization_guides/customization_overview). 
