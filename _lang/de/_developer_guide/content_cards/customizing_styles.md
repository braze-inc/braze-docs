...
> Braze Content Cards werden mit einem Standard-Look and Feel geliefert. Dieser Artikel befasst sich mit den Styling-Optionen für Ihre Content Cards, die Sie an Ihre Markenidentität anpassen können. Einen grundlegenden Überblick über die Arten von Anpassungsmöglichkeiten, die Sie mit Content Cards haben, finden Sie unter [Übersicht über die Anpassung]({{site.baseurl}}/developer_guide/customization_guides/customization_overview). 
