...
### Kann ich ein Segment aller Nutzer erstellen, die sich gerade in einem Feature-Flag befinden? {#feature-flag-filter}

Das ist in unserer Produkt-Roadmap geplant. Wenn Sie beitragen möchten, dass diese Möglichkeiten priorisiert wird, sprechen Sie darüber mit Ihrem Account-Team bei Braze oder senden Sie eine E-Mail an [feature-flags-feedback@braze.com](mailto:feature-flags-feedback@braze.com).
