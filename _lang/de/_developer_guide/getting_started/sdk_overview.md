...
Sind Sie ein Marketer, der einen grundlegenden Überblick über das SDK benötigt? Sehen Sie sich stattdessen unsere [Übersicht für Marketer]({{site.baseurl}}/user_guide/onboarding_with_braze/web_sdk/) an.
...
Weitere Einzelheiten zur Verwendung dieser Methode finden Sie unter [Speicherung]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/storage) in der Dokumentation zum Swift SDK.
...
{% alert tip %}
Wenn Sie eine iOS App haben, können Sie sich vergewissern, dass Sie das [Swift SDK]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/initial_sdk_setup/overview) anstelle des alten [Objective-C iOS SDK]({{site.baseurl}}/developer_guide/platform_integration_guides/ios/initial_sdk_setup/overview) verwenden, wenn Ihre **Live SDK Version** gleich oder höher als 5.0.0 ist, was die erste veröffentlichte Version des Swift SDK war.
{% endalert %}
