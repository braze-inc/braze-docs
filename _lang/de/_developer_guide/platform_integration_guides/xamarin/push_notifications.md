...
article_title: Push-Benachrichtigungen für Xamarin
platform: 
  - Xamarin
  - iOS
  - Android
page_order: 1
description: "Dieser Artikel beschreibt die Integration von Android-, FireOS- und iOS-Push-Benachrichtigungen für die Xamarin-Plattform."
channel: push
toc_headers: h2
---
...
> Erfahren Sie, wie Sie Android-, FireOS- und iOS-Push-Benachrichtigungen für Xamarin einrichten.
...
Um Push-Benachrichtigungen für Xamarin zu integrieren, müssen Sie die Schritte für native Android-Push-Benachrichtigungen ausführen. Die folgenden Schritte sind nur eine Zusammenfassung. Eine vollständige Anleitung finden Sie in der [Anleitung für native Push-Benachrichtigungen]({{site.baseurl}}/developer_guide/platform_integration_guides/android/push_notifications/integration/standard_integration/).
...
In den [Anleitungen zur Swift-Integration]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/push_notifications/integration) finden Sie Informationen zum Einrichten Ihrer Anwendung mit Push und zum Speichern Ihrer Anmeldedaten auf unserem Server. Weitere Einzelheiten finden Sie in der [iOS MAUI](https://github.com/braze-inc/braze-xamarin-sdk/tree/master/appboy-component/samples/ios-net-maui/BrazeiOSMauiSampleApp) Beispielanwendung.
