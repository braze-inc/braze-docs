...
article_title: Integration von Push Stories für iOS
platform: Swift
page_order: 27
description: "Dieser Artikel beschreibt, wie Sie iOS Push-Storys für das Swift SDK einrichten."
channel:
  - push
...
> Mit [Push Stories]({{site.baseurl}}/user_guide/message_building_by_channel/push/advanced_push_options/push_stories/) können Marketingexperten die Foto-Karussell-Funktion nutzen, um eine Abfolge von Seiten innerhalb einer Push-Benachrichtigung zu erstellen. Diese Seiten bestehen aus einem Bild, einer Klickaktion, einem Titel und einer Beschreibung. 

Die Einrichtung von Push Stories für Ihre iOS-App erfordert zusätzliche Schritte, die über die Integration von Standard-Push-Benachrichtigungen hinausgehen und die in diesem Artikel beschrieben werden.
...
Stellen Sie sicher, dass Sie die [Anleitung zur Integration von Push-Benachrichtigungen]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/push_notifications/integration/) befolgt haben, um Push in Ihrer App zu aktivieren. Im Zusammenhang mit dieser Aufgabe sollten Sie das Framework `UNNotification` implementiert haben, das für dieses Feature erforderlich ist.
...
Nachdem Sie den [Leitfaden für die Integration von Swift-Paketmanager]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/initial_sdk_setup/installation_methods/swift_package_manager/) befolgt haben, fügen Sie `BrazePushStory` zur `Notification Content Extension` hinzu:
