...
Push-Benachrichtigungen für die iOS-Testanwendung erfordern eine zusätzliche Konfiguration. Einzelheiten finden Sie in unserer [iOS Push Integration]({{site.baseurl}}/developer_guide/platform_integration_guides/ios/push_notifications/integration/).
