...
article_title: Anleitung zur Implementierung von In-App-Nachrichten für Android (optional)
platform: Android
page_order: 6
description: "Dieser Leitfaden für fortgeschrittene Implementierungen enthält Hinweise zur Code-Anpassung für In-App-Nachrichten für Android und FireOS, drei von unserem Team erstellte Anwendungsfälle und begleitende Code-Snippets."
channel:
  - in-app messages
---
<br>
{% alert important %}
Suchen Sie den Entwicklerleitfaden zur grundlegenden Integration von In-App-Nachrichten? Sie finden es [hier]({{site.baseurl}}/developer_guide/platform_integration_guides/android/in-app_messaging/integration/#in-app-messaging-integration).
{% endalert %}

# Leitfaden zur fortgeschrittenen Implementierung
...
- [Angepasste Slideup In-App-Nachricht](#custom-slideup-in-app-message)
