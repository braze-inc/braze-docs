...
- **Braze ID**: `braze_id` dient als eindeutiger Bezeichner für Nutzer:innen, der von Braze festgelegt wird. Dieser Bezeichner kann verwendet werden, um Nutzer:innen über die REST API zusätzlich zu external_ids.
