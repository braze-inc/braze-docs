...
Mit BrazeAI<sup>TM</sup> können Sie jetzt die beliebtesten Produkte berechnen oder personalisierte KI-Empfehlungen für einen bestimmten Katalog erstellen. Weitere Informationen finden Sie unter [Über Artikelempfehlungen]({{site.baseurl}}/user_guide/brazeai/recommendations/about_item_recommendations/).

### QA-In-App-Nachricht Inhalt

{% multi_lang_include release_type.md release="General availability" %}

Bisher konnten Sie mit BrazeAI<sup>TM</sup> im Braze-Dashboard eine Qualitätssicherung Ihrer SMS- und Push-Benachrichtigungsinhalte durchführen. Jetzt können Sie auch [den Inhalt von In-App-Nachrichten überprüfen]({{site.baseurl}}/user_guide/brazeai/generative_ai/ai_content_qa/).
