...
Seit [Version 4.0.0](https://github.com/braze-inc/braze-xamarin-sdk/releases/tag/4.0.0) verwendet das Braze Xamarin SDK die Swift SDK-Bindung, daher haben wir die Code-Snippets und das Referenzmaterial aktualisiert. Außerdem haben wir den Abschnitt umstrukturiert, damit er leichter zu lesen und zu verstehen ist. Sehen Sie sich [die Xamarin-Dokumente]({{site.baseurl}}/developer_guide/sdk_integration/?sdktab=.net%20maui%20(xamarin)) an, um dies zu überprüfen.
