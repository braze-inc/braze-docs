...
- [Twilio (Twilio) Webhook Integration]({{site.baseurl}}/releases/deprecations/twilio/)
- [Apptimize Partnerschaft]({{site.baseurl}}/releases/deprecations/apptimize/)
- [Grouparoo Partnerschaft]({{site.baseurl}}/releases/deprecations/grouparoo)
- [Shopify `checkout.liquid` Verwerfung]({{site.baseurl}}/releases/deprecations/shopify_checkout/)
...
Wenn Sie derzeit [Apptimize mit Braze]({{site.baseurl}}/releases/deprecations/apptimize) verwenden, wird der Dienst nicht unterbrochen. Sie können die angepassten Attribute von Apptimize immer noch an Nutzerprofile von Braze anpassen. Es wird jedoch keine formale Eskalationsunterstützung mit dem Partner angeboten.
