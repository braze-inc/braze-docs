...
Sie können jetzt [E-Mail Templates über API]({{site.baseurl}}/developer_guide/rest_api/email_templates/#email-templates) erstellen und aktualisieren. Jedes Template hat ein **email_template_id** die in anderen API-Aufrufen referenziert werden kann.
