...
Nutzer:innen, die Probleme bei der Anmeldung über die Zwei-Faktor-Authentifizierung haben, können sich an die Administratoren ihres Unternehmens wenden, um [die Zwei-Faktor-Authentifizierung zurückzusetzen]({{site.baseurl}}/user_guide/administrative/app_settings/company_settings/security_settings/#user-authetication-reset).
