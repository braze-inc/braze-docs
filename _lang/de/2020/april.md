...
Der neue Braze Facebook Audience Export-Prozess ist für alle Cluster verfügbar und optimiert den Arbeitsablauf durch klare Schritte der Integration. Es ist nicht mehr erforderlich, OAuth-Weiterleitungs-URIs auf die Whitelist zu setzen, um benutzerdefinierte Zielgruppen zu senden oder die Facebook-App-Einstellungen für die Integration anzupassen.
...
Das [Template/die E-Mail/Liste]({{site.baseurl}}/api/endpoints/templates/email_templates/get_list_email_templates/) und[content_block/list]({{site.baseurl}}/api/endpoints/templates/content_blocks_templates/get_list_email_content_blocks/)die API-Endpunkte wurden mit einem Update aktualisiert und enthalten nun ein neues`tags`Feld. Dieses Feld listet als Array alle Tags auf, die auf den aktuellen Block oder das E-Mail Template zutreffen.
