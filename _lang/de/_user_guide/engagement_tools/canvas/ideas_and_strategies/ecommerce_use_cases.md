...
4. Wählen Sie **Vorlage anwenden** für die Vorlage, die Sie verwenden möchten.<br><br>]({% image_buster /assets/img_archive/apply_template.png %})Die Seite "Canvas-Vorlagen" wurde auf dem Tab "Braze-Vorlagen" geöffnet und zeigt eine Liste der kürzlich verwendeten Templates und der auswählbaren Braze-Vorlagen.{: style="max-width:80%;"}()
...
]({% image_buster /assets/img_archive/abandoned_browse.png %})Ein angewandtes "Abandoned Browse" Canvas Template mit erweiterten "Eingangsregeln".()
...
- Entry-Zeitplan 
    ...
    - Startzeitpunkt ist der Zeitpunkt, an dem Sie die Canvas-Vorlage erstellen<br><br>]({% image_buster /assets/img/ecommerce/abandoned_browse_entry.png %})"Aktionsbasierte Optionen" für den Canvas.()<br><br> 
- Zielgruppen 
    - Entry-Zielgruppe 
    ...
    - Ausstiegskriterien 
        - Führt `ecommerce.cart_updated`, `ecommerce.checkout_started`, oder `ecommerce.order_placed`<br><br>]({% image_buster /assets/img/ecommerce/abandoned_browse_entry_exit.png %})Eingangskontrollen und Ausgangskriterien für den Canvas.()<br><br> 
...
]({% image_buster /assets/img_archive/abandoned_cart.png %})Ein angewandtes "Warenkorb-Abbruch" Canvas Template mit erweiterten "Eingangsregeln".()
...
- Entry-Zeitplan 
    ...
    - Startzeitpunkt ist der Zeitpunkt, an dem Sie die Canvas-Vorlage erstellen<br><br>]({% image_buster /assets/img/ecommerce/abandoned_cart_entry.png %})"Aktionsbasierte Optionen" für den Canvas.()<br><br> 
- Zielgruppe 
    - Entry-Zielgruppe 
    ...
    - Ausstiegskriterien 
        - Führt `ecommerce.cart_updated`, `ecommerce.checkout_started`, oder `ecommerce.order_placed`<br><br>]({% image_buster /assets/img/ecommerce/abandoned_cart_entry_exit.png %})Eingangskontrollen und Ausgangskriterien für den Canvas.()<br><br> 
- Einstellungen senden 
    - Nutzer:innen, die Abonnent:in sind oder ein Opt-in haben 
- Verzögerungsstufe
...
]({% image_buster /assets/img_archive/abandoned_checkout.png %})Ein angewandtes "Abgebrochener Checkout" Canvas Template mit erweiterten "Eingangsregeln".()
...
- Entry-Zeitplan 
    ...
    - Startzeitpunkt ist der Zeitpunkt, an dem Sie die Canvas-Vorlage erstellen<br><br>]({% image_buster /assets/img/ecommerce/abandoned_checkout_entry.png %})"Aktionsbasierte Optionen" für den Canvas.()
- Zielgruppen 
    - Entry-Zielgruppe 
        - Hat diese Apps **mehr als 0** Mal benutzt 
        - E-Mail **ist nicht leer**
    - Eingangskontrollen
        - Nutzer:innen sind sofort wieder für den Eingang in Canvas zugelassen.
        - Ausstiegskriterien 
            - Führt die Ereignisse `ecommerce.order_placed` aus.<br><br>]({% image_buster /assets/img/ecommerce/abandoned_checkout_entry_exit.png %})Eingangskontrollen und Ausgangskriterien für den Canvas.()<br><br>
- Einstellungen senden 
    - Nutzer:innen, die Abonnent:in sind oder ein Opt-in haben 
- Verzögerungsstufe
    - 4 Stunden Verzögerung
...
]({% image_buster /assets/img_archive/order_confirmation_feedback.png %})Ein angewandtes "Bestellbestätigung" Canvas Template mit erweiterten "Eingangsregeln".()
...
- Entry-Zeitplan 
    ...
    - Startzeitpunkt ist der Zeitpunkt, an dem Sie die Canvas-Vorlage erstellen<br><br>]({% image_buster /assets/img/ecommerce/feedback_entry.png %})"Aktionsbasierte Optionen" für den Canvas.()<br><br>
- Zielgruppen 
    - Entry-Zielgruppe 
        - Hat diese Apps **mehr als 0** Mal benutzt 
        - E-Mail **ist nicht leer**
    - Eingangskontrollen
        - Nutzer:innen sind sofort wieder für den Eingang in Canvas zugelassen.
    - Ausstiegskriterien 
        - --<br><br>]({% image_buster /assets/img/ecommerce/feedback_entry_exit.png %})Zusätzliche Filter und Eingangskontrollen für den Canvas.()<br><br>
- Einstellungen senden 
    - Nutzer:innen, die Abonnent:in sind oder ein Opt-in haben 
- Nachrichtenschritt 
    - Sehen Sie sich die E-Mail-Vorlage und den HTML-Block mit einem Liquid-Templating-Beispiel an, um Ihrer Nachricht in der vorgefertigten Vorlage Produkte hinzuzufügen. Wenn Sie Ihr eigenes Template für E-Mails verwenden, können Sie auch [Liquid-Variablen](#message-personalization) referenzieren, wie im folgenden Abschnitt gezeigt wird.
...
]({% image_buster /assets/img_archive/ecommerce_filters.png %})Segmente Filter Dropdown mit "E-Commerce" Filtern.{: style="max-width:80%"}()
