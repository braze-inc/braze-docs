...
]({% image_buster /assets/img/canvas_actionpath.png %})Ein Aktions-Pfad-Schritt in einer Canvas-Nutzer:in.{: style="float:right;max-width:40%;margin-left:15px;"}()
...
]({% image_buster /assets/img/actionpath_settings.png %})Die Aktionseinstellungen mit einem Bewertungsfenster von 1 Tag.()
...
]({% image_buster /assets/img/actionpath_group.png %})Eine Aktionsgruppe namens "Gruppe 1" für Nutzer:innen, die einen Kauf tätigen.()
