...
]({% image_buster /assets/img/canvas_components/message_step1.png %})Ein Nachrichten-Schritt mit dem Namen "Mittags-Promo" unter Verwendung des Push-Kanals.{: style="float:right;max-width:25%;margin-left:15px;"}()
...
]({% image_buster /assets/img/canvas_components/message_step2.png %})Eine Liste der verfügbaren Messaging-Kanäle zum Auswählen für den Schritt Nachricht.()
