...
]({% image_buster /assets/img_archive/canvas_user_update_step.png %})Ein Nutzer:in Update-Schritt namens "Loyalität aktualisieren", der ein Attribut "Ist Premium-Mitglied" auf "wahr" aktualisiert.{: style="float:right;max-width:30%;margin-left:15px;"}()
...
]({% image_buster /assets/img_archive/canvas_user_update_update.png %})Nutzer:in Update-Schritt, der die beiden Attribute "Loyalitätsmitglied" und "Loyalitätsprogramm" auf "wahr" aktualisiert.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img_archive/canvas_user_update_remove.png %})Nutzer:in Update-Schritt, der ein Attribut "Loyalitätsmitglied" entfernt.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img_archive/canvas_user_update_composer.png %}){: style="max-width:90%;"}]({% image_buster /assets/img_archive/canvas_user_update_composer.png %})
...
]({% image_buster /assets/img_archive/canvas_user_update_test_preview.png %}){: style="max-width:90%;"}]({% image_buster /assets/img_archive/canvas_user_update_test_preview.png %})
