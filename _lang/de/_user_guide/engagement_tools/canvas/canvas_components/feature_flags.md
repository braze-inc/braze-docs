...
]({% image_buster /assets/img/feature_flags/feature_flag_canvas_step.png %})Ein Beispiel für einen Feature-Flag Schritt für das Feature Live Chat Button.{: style="float:right;max-width:40%;margin-left:15px;"}()
...
]({% image_buster /assets/img/feature_flags/feature_flags_canvas_details.png %})Ein Feature-Flag "Preference Center" mit "String" als Eigenschaft, "url" als Schlüssel der Eigenschaft und einem Wert.{: style="max-width:90%"}()
