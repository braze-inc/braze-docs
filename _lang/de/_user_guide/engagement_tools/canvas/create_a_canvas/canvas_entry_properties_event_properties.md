...
]({% image_buster /assets/img_archive/canvas_entry_properties1.png %})Ein Aktions-Pfad-Schritt, gefolgt von einem Verzögerungsschritt und einem Nachrichten-Schritt für Nutzer:innen, die einen Artikel zu ihrer Wunschliste hinzugefügt haben, und ein Pfad für alle anderen.{: style="float:right;max-width:30%;margin-left:15px;"}()
