...
]({% image_buster /assets/img/save_canvas_as_template.png %})]({% image_buster /assets/img/save_canvas_as_template.png %})
...
]({% image_buster /assets/img/canvas_template_example.png %})Ein Beispiel für eine Canvas-Vorlage mit dem Namen "Annual sale Canvas template" mit der Beschreibung "Use for annual spring promotion".()
...
]({% image_buster /assets/img/braze_canvas_templates.png %})Braze-Vorlagen im Bereich Canvas-Vorlagen mit sechs verfügbaren Templates.()
