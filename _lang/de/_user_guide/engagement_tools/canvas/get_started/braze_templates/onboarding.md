...
![Primäres Konversions-Event – A mit dem Konversions-Typ „Führt nutzerdefiniertes Event aus“ und dem Namen des nutzerdefinierten Events „E-Mail-Klick“. Es gibt eine Frist von 4 Tagen für die Konversion.]({% image_buster /assets/img/canvas_templates/onboarding1.png %})
...
![Ein Eingabefenster mit der Startzeit 28\. Oktober 2024 um 8 Uhr. Nutzer:innen werden diese Nachricht in ihrer Ortszeit eingeben.]({% image_buster /assets/img/canvas_templates/onboarding4.png %})
