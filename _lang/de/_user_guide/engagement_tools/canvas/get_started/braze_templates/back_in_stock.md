...
]({% image_buster /assets/img/canvas_templates/back_in_stock_old_name_description.png %})Der aktuelle Titel und die Beschreibung des Canvas.{: style="max-width:45%;"}()
...
]({% image_buster /assets/img/canvas_templates/back_in_stock_1.png %})Schritt "Canvas-Details einrichten" mit dem Canvas-Namen "Wieder auf Lager - Klassisches gerades Bein" und einer kurzen Canvas-Beschreibung.()
...
]({% image_buster /assets/img/canvas_templates/back_in_stock_2.png %})"Konversions-Events zuordnen" für den Konversions-Event-Typ des Kaufs des Produkts Classic Straight Leg mit einer Konversionsfrist von 7 Tagen.()
...
]({% image_buster /assets/img/canvas_templates/back_in_stock_3.png %})"Zeitplan für den Eingang" für ein aktionsbasiertes Canvas.()

{: start="2"}
2\. Setzen Sie die **Startzeit (erforderlich)** auf das gewünschte Startdatum und die Uhrzeit.

]({% image_buster /assets/img/canvas_templates/back_in_stock_4.png %})Abschnitt "Eingangsfenster" mit einer Startzeit von 2\. Januar 2025 um 12 Uhr.()
...
]({% image_buster /assets/img/canvas_templates/back_in_stock_5.png %})Schritt "Zielgruppen" mit dem Segment "Favorited - Classic Straight Leg Jeans".()
...
]({% image_buster /assets/img/canvas_templates/back_in_stock_6.png %})"Eingangskontrollen" mit einem Kontrollkästchen, das es Nutzern:innen erlaubt, diesen Canvas mit einer maximalen Dauer des Canvas erneut zu betreten.()
...
]({% image_buster /assets/img/canvas_templates/back_in_stock_7.png %})"Exit Criteria" Abschnitt mit einer Ausnahme für Nutzer:innen, die das angepasste Event "Unfavorited" ausführen.()
...
]({% image_buster /assets/img/canvas_templates/back_in_stock_8.png %})"Sendeeinstellungen" Schritt Targeting für Nutzer:in, die Abonnent:in oder Opt-in sind.()
...
]({% image_buster /assets/img/canvas_templates/back_in_stock_9.png %})Mobiler Push Canvas-Schritt mit einer Nachricht, die Nutzer:innen darüber informiert, dass ein Produkt wieder auf Lager ist.()
