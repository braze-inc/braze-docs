...
![Schritt "Canvas-Details einrichten" mit dem Canvas-Namen "Wieder auf Lager - Klassisches gerades Bein" und einer kurzen Canvas-Beschreibung.]({% image_buster /assets/img/canvas_templates/back_in_stock_1.png %})
...
![„Konversions-Events zuweisen“ für den Konversions-Event-Typ des Kaufs des Produkts Classic Straight Leg mit einer Konversionsfrist von 7 Tagen.]({% image_buster /assets/img/canvas_templates/back_in_stock_2.png %})
...
![„Entry-Zeitplan“ für ein aktionsbasiertes Canvas.]({% image_buster /assets/img/canvas_templates/back_in_stock_3.png %})

{: start="2"}
2\. Setzen Sie die **Startzeit (erforderlich)** auf das gewünschte Startdatum und die Uhrzeit.

![Abschnitt „Entry-Fenster“ mit einer Startzeit von 2\. Januar 2025 um 12 Uhr.]({% image_buster /assets/img/canvas_templates/back_in_stock_4.png %})
...
![Schritt „Zielgruppe“ mit dem Segment „Zu Favoriten hinzugefügt – Classic Straight Leg Jeans“.]({% image_buster /assets/img/canvas_templates/back_in_stock_5.png %})
...
!["Eingangskontrollen" mit einem Kontrollkästchen, das es Nutzern:innen erlaubt, diesen Canvas mit einer maximalen Dauer des Canvas erneut zu betreten.]({% image_buster /assets/img/canvas_templates/back_in_stock_6.png %})
...
![Abschnitt „Exit-Kriterien“ mit einer Ausnahme für Nutzer:innen, die das angepasste Event „Aus der Favoritenliste entfernt“ ausführen.]({% image_buster /assets/img/canvas_templates/back_in_stock_7.png %})
...
![Der Schritt „Sendeeinstellungen“ stellt das Targeting von Nutzern:in zusammen, die Abonnent:in sind oder sich angemeldet haben.]({% image_buster /assets/img/canvas_templates/back_in_stock_8.png %})
...
![Mobile Push Canvas Schritt mit einer Nachricht, die den Benutzer darüber informiert, dass ein Produkt wieder auf Lager ist.]({% image_buster /assets/img/canvas_templates/back_in_stock_9.png %})
