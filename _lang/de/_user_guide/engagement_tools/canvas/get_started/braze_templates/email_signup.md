...
]({% image_buster /assets/img/canvas_templates/email_signup1.png %})Der aktuelle Titel und die Beschreibung des Canvas.{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/canvas_templates/email_signup2.png %})Der neue Name, die Beschreibung und der Tag für das Canvas.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/canvas_templates/email_signup3.png %})"Konversions-Ereignisse zuweisen" für den Konversions-Ereignistyp des Opt-in für E-Mail.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/canvas_templates/email_signup4.png %})Ein aktionsbasierter Zeitplan für den Eingang von Nutzern:innen, die eine beliebige Sitzung im Canvas beginnen.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/canvas_templates/email_signup6.png %})Eingang Zielgruppe mit dem Filter "E-Mail verfügbar ist falsch".{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/canvas_templates/email_signup7.png %})Standard-Sendeoptionen, um nur an Nutzer:in zu senden, die Abonnent:in oder Opt-in sind.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/canvas_templates/email_signup8.png %})Zwei Seiten einer In-App-Nachricht, um die E-Mails der Nutzer:innen zu erfassen und eine Erfolgsmeldung anzuzeigen.{: style="max-width:90%;"}()
