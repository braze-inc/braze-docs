...
]({% image_buster /assets/img/canvas_templates/abandoned_intent_old_name_description.png %})Der aktuelle Titel und die Beschreibung des Canvas.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/canvas_templates/abandoned_intent_new_name_description.png %})Der neue Name, die Beschreibung und der Tag für das Canvas.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/canvas_templates/abandoned_intent2.png %})Ein aktionsbasiertes Canvas, das auf Nutzer:innen abzielt, die ihren Warenkorb abgebrochen haben, mit dem Eingangsfenster 15\. Oktober 2024 15:20 Uhr in der Ortszeit der Nutzer:innen.()
...
]({% image_buster /assets/img/canvas_templates/abandoned_intent3.png %})"Online Shopper Segment - 90 Tage" als Segment der Nutzer:innen für dieses Canvas.()
...
]({% image_buster /assets/img/canvas_templates/abandoned_intent4.png %})Exit-Kriterium, das festlegt, dass Nutzer:innen, die einen bestimmten Kauf für den riesigen Pappteller tätigen, den Canvas verlassen.()
...
]({% image_buster /assets/img/canvas_templates/abandoned_intent5.png %})Aktionsgruppe "Kauf getätigt", die den Canvas verlässt, wenn der Nutzer:in den riesigen Pappteller kauft.()
