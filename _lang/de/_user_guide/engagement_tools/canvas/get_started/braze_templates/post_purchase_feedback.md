...
]({% image_buster /assets/img/canvas_templates/post_purchase_feedback/select_edit_details.png %})Der aktuelle Titel und die Beschreibung des Canvas.{: style="max-width:50%;"}()
...
Der neue Name und die Beschreibung für das Canvas. In der neuen Beschreibung heißt es: ]({% image_buster /assets/img/canvas_templates/post_purchase_feedback/enter_new_canvas_name.png %})({: style="max-width:50%;"}) 'Ein Feedback-Kanal nach dem Kauf, um das Interesse an der kommenden Erweiterung für PWD3, Liquid Mirage, zu ermitteln.
...
]({% image_buster /assets/img/canvas_templates/post_purchase_feedback/select_conversion_event.png %})Abschnitt „Konversions-Events zuweisen“ für den Konversions-Event-Typ des Proxy-War-Spielprodukts.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/canvas_templates/post_purchase_feedback/entry_window_segment.png %})Ein Segment namens "Gekaufter Proxy War 3", das Nutzer:innen segmentiert, die das Spiel gekauft haben.{: style="max-width:90%;"}()
...
"Sendeeinstellungen" Schritt Targeting für Nutzer:in, die Abonnent:in oder Opt-in sind.() Stille Stunden sind eingeschaltet.]({% image_buster /assets/img/canvas_templates/post_purchase_feedback/send_settings_with_quiet_hours.png %})({: style="max-width:90%;"})
...
]({% image_buster /assets/img/canvas_templates/post_purchase_feedback/action_path_good_example.png %})Die Gruppe "Gutes Feedback" für den Schritt "Aktionspfad", die Benutzer umfasst, die in unserer Umfrage mit "Gefällt mir" geantwortet haben.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/canvas_templates/post_purchase_feedback/webhook_example.png %})Ein Webhook, der Support-Fälle für Kund:innen erstellt, die eine negative Stimmung haben und eine Rückerstattung für ihren Kauf von Proxy War 3 wünschen.{: style="max-width:90%;"}()
