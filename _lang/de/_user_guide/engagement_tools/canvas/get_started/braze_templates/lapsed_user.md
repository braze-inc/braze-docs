...
]({% image_buster /assets/img/canvas_templates/lapsed_user_old_name_description.png %})Der aktuelle Titel und die Beschreibung des Canvas.{: style="max-width:45%;"}()
...
]({% image_buster /assets/img/canvas_templates/lapsing_user_1.png %})"Canvas-Details einrichten"-Schritt mit dem Canvas-Namen "Verfallene Nutzer:innen - App besuchen" und einer kurzen Canvas-Beschreibung()
...
]({% image_buster /assets/img/canvas_templates/lapsing_user_2.png %})Abschnitt "Konversions-Events zuordnen" mit einem primären Konversions-Event eines Nutzers:in, der eine Sitzung in einer bestimmten App startet.()
...
]({% image_buster /assets/img/canvas_templates/lapsing_user_3.png %})"Zeitplan für den Eingang" für einen geplanten Canvas, der Nutzer:innen zu einer bestimmten Zeit einlässt.()
...
]({% image_buster /assets/img/canvas_templates/lapsing_user_4.png %})Der Schritt "Zielgruppe" stellt die Nutzer:innen zusammen, die die Apps zuletzt vor 30 Tagen genutzt haben.()
...
]({% image_buster /assets/img/canvas_templates/lapsing_user_5.png %})Abschnitt "Ruhezeiten" mit einer Startzeit von 12 Uhr und einer Endzeit von 8 Uhr.()
...
]({% image_buster /assets/img/canvas_templates/lapsing_user_6.png %})Canvas-Schritt für eine E-Mail, die Nutzer:innen darauf hinweist, neue Vergünstigungen freizuschalten, wenn sie heute zu Besuch kommen.()
...
]({% image_buster /assets/img/canvas_templates/lapsing_user_7.png %})Aktions-Pfad für Sitzungen, die in einer bestimmten App gestartet werden.()
...
]({% image_buster /assets/img/canvas_templates/lapsing_user_8.png %})Canvas-Schritte mit Verzweigungspfaden basierend darauf, wie viele Sitzungen ein Nutzer:in hatte.{: style="max-width:70%;"}()
