...
]({% image_buster /assets/img/canvas_templates/feature_adoption/select_edit_details.png %})Der aktuelle Titel und die Beschreibung des Canvas.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/canvas_templates/feature_adoption/assign_conversion_event_cruise_control.png %})Das Konversions-Event-Fenster im Canvas.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/canvas_templates/feature_adoption/cruise_control_segment.png %})Das Segment für alle Nutzer:innen, die den Tempomat nicht benutzt haben.{: style="max-width:90%;"}()
