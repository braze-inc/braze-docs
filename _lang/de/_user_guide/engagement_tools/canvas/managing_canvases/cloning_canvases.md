...
]({% image_buster /assets/img_archive/clone_to_v2_workflow.png %}){: style="max-width:25%;"}]({% image_buster /assets/img_archive/clone_to_v2_workflow.png %})

{: start="4"}
4\. Geben Sie den Namen Ihres neuen Canvas ein und klicken Sie auf **In Canvas Flow klonen**. 

]({% image_buster /assets/img_archive/clone_to_v2_modal.png %}){: style="max-width:70%;"}]({% image_buster /assets/img_archive/clone_to_v2_modal.png %})
