...
![Beispiel für eine Canvas-Benutzerreise mit einem Decision-Split-Schritt, gefolgt von Verzögerungsschritten und Nachrichtenschritten.]({% image_buster /assets/img/canvas_intro/canvas_intro.gif %}){: style="float:right;max-width:55%;margin-left:15px;"}
