---
nav_title: Grundlagen des Messaging
article_title: Grundlagen des Messaging
layout: dev_guide
page_order: 0
guide_top_header: "Grundlagen des Messaging"
guide_top_text: "> In Braze können Sie Ihre Nachrichten mithilfe <a href='/docs/user_guide/getting_started/campaigns_canvases'>einer Kampagne oder eines Canvas</a> verfassen, versenden und verwalten. Für diese beiden Messaging-Methoden gibt es einige gemeinsame Messaging-Grundlagen für das Verfassen (Einrichten Ihrer Nachricht) und das Verwalten (administratives Bearbeiten Ihrer Nachricht)."
page_type: landing
tool: 
    - Campaigns
    - Canvas
description: "Auf dieser Landing Page finden Sie Artikel über die Grundlagen des Messagings mit Kampagnen und Canvase. Hier finden Sie Ressourcen zum strategischen Einsatz von Konversions-Events und zur Bestimmung der Zustellungsart beim Verfassen Ihrer Nachrichten sowie zur Verwendung des Genehmigungs-Workflows und zum Verständnis von Zustellungen bei der Verwaltung Ihrer Nachrichten."

guide_featured_title: "Zusammensetzung"
