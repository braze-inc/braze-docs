...
![Eine Liste der Canvases im Braze-Dashboard, wobei die Öffnung des Menüs für einen der Canvases erfolgt ist.]({% image_buster /assets/img/messaging_fundamentals/change-status.png %})
...
| Angehalten | Angehaltene Kampagnen und Canvase werden pausiert, können aber weiterhin bearbeitet werden. Um eine Canvas fortzusetzen, navigieren Sie bitte zum Schritt **„Zusammenfassung**“ des Canvas-Generators und wählen Sie **„Canvas fortsetzen**“. Für Kampagnen wählen Sie bitte das<i class="fas fa-ellipsis-vertical"></i>Menü und anschließend **„Fortsetzen**“. Weitere Informationen finden Sie unter [Gestopptes Canvas-Verhalten](#stopped-canvas-behavior). |
...
- **Änderungsentwürfe:** Alle Entwürfe für Änderungen an der Canvas werden verworfen, wenn die Canvas angehalten wird.

Um die Leinwand fortzusetzen, gehen Sie zum Schritt **„Zusammenfassung“** des Canvas-Builders und wählen Sie **„Leinwand fortsetzen**“. Wenn Sie die Funktion reaktivieren, werden alle zuvor gestoppten Nachrichten wie geplant gesendet - sofern der Zeitplan nicht bereits abgelaufen ist.
