...
| Braze Katalog | Sie müssen einen Braze-Katalog erstellen, der die folgenden Felder enthält, die in Ihrer Produktblockkonfiguration verwendet werden sollen:{::nomarkdown}<ul><li>product_title</li><li>product_url</li><li>variant_image_url</li></ul></code>{:/} |
...
]({% image_buster /assets/img/product_blocks/dynamic_fields.png %})Produktfelder für einen dynamischen Produktblock, die in Katalogdaten und Ereignisdaten unterteilt sind{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/product_blocks/static_fields.png %})Produktfelder für einen statischen Produktblock, die alle als Katalogdaten kategorisiert sind.{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/product_blocks/layout_options.png %})Layout-Optionen für die Produktausrichtung, die Ausrichtung, die maximale Anzahl von Produkten pro Zeile und den Produktabstand.{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/ecommerce/sample_product_catalog.png %})Eine Beispiel-CSV-Datei, die neben den erforderlichen Feldern auch andere enthält.()
...
]({% image_buster /assets/img/product_blocks/product_block.png %})Der Tab "Inhalt" mit Editor-Blöcken, wie z.B. Produkt-Blöcken.{: style="max-width:40%;"}()
...
]({% image_buster /assets/img/product_blocks/liquid.png %})Produktblock mit einem dem Preis des Artikels vorangestellten Dollarbetrag.{: style="max-width:45%;"}()
...
]({% image_buster /assets/img/product_blocks/preview_as_a_user.png %})Tab "Vorschau als Nutzer:innen" mit einem Dropdown-Bereich "Dynamischer Produktblock", der angibt, dass 4 Artikel angezeigt werden sollen.{: style="max-width:40%;"}()
...
]({% image_buster /assets/img/product_blocks/static_block_preview.png %})E-Mail Drag-and-Drop Composer, der einen Produktblock mit verschiedenen Artikelkacheln erzeugt.()
