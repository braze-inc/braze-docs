...
glossary_top_text: "Das Braze SDK bietet Ihnen ein leistungsstarkes Arsenal an Filtern, mit denen Sie Ihre Nutzer:innen auf der Grundlage bestimmter Features und Attribute segmentieren und targetieren können. Sie können diese Filter nach Filterkategorien durchsuchen oder eingrenzen.<br><br>Wenn Sie mehr über die verschiedenen angepassten Attribut-Datentypen erfahren möchten, die Sie zur Segmentierung von Nutzer:innen verwenden können, sehen Sie unter <a href=\"/docs/user_guide/data_and_analytics/custom_data/custom_attributes/#custom-attribute-data-types\">Angepasste Attribut-Datentypen</a> nach."
...
glossaries:
  ...
  - name: Verschachtelte angepasste Attribute
    description: "Attribute, die die Eigenschaften von benutzerdefinierten Attributen sind.<br><br>Wenn Sie ein verschachteltes angepasstes Attribut für die Zeit filtern, können Sie wählen, ob Sie nach \"Tag des Jahres\" oder \"Zeit\" filtern möchten. \"Tag des Jahres\" prüft nur den Monat und den Tag zum Vergleich. \"Zeit\" vergleicht den vollständigen Zeitstempel, einschließlich des Jahres."
    tags:
      - Custom attribute
  ...
  - name: Angepasstes Event
    description: "Ermittelt, ob ein:e Nutzer:in ein speziell aufgezeichnetes Event durchgeführt hat oder nicht.<br><br> Beispiel:<br>Aktivität mit der Eigenschaft activity_name abgeschlossen.<br><br>Zeitzone:<br>UTC - Kalendertag = 1 Kalendertag betrachtet 24-48 Stunden des Verlaufs der Nutzer:innen"
    tags:
      - Custom events
  ...
  - name: X angepasstes Event in Y Tagen
    description: "Ermittelt, ob ein:e Nutzer:in in der letzten angegebenen Anzahl von Kalendertagen zwischen 1 und 30 ein speziell aufgezeichnetes Event zwischen 0 und 50 Mal durchgeführt hat oder nicht. (Kalendertag = 1 Kalendertag betrachtet 24-48 Stunden des Verlaufs der Nutzer:innen)<br> <a href=\"/docs/x-in-y-behavior/\"> Erfahren Sie hier mehr über das X-in-Y-Verhalten.</a> <br><br>Beispiel:<br>In den letzten 1 Kalendertagen genau 0 Mal den Warenkorb verlassen<br><br>Zeitzone:<br>UTC - Um alle Zeitzonen zu berücksichtigen, werden für 1 Kalendertag 24-48 Stunden des Nutzer:innen-Verlaufs betrachtet, je nachdem, zu welchem Zeitpunkt das Segment ausgewertet wird; für 2 Kalendertage werden 48-72 Stunden des Nutzer:innen-Verlaufs betrachtet, usw."
    tags:
      - Custom events
  - name: X angepasstes eigenschaftsbezogenes Event in Y Tagen
    description: "Ermittelt, ob ein Benutzer ein speziell aufgezeichnetes Ereignis in Bezug auf eine bestimmte Eigenschaft zwischen 0 und 50 Mal in der letzten angegebenen Anzahl von Kalendertagen zwischen 1 und 30 durchgeführt hat oder nicht. (Kalendertag = 1 Kalendertag betrachtet 24-48 Stunden des Verlaufs der Nutzer:innen)<br><a href=\"/docs/x-in-y-behavior/\">Erfahren Sie hier mehr über das X-in-Y-Verhalten.</a> <br><br>Beispiel:<br> Zu den Favoriten hinzugefügt mit der Eigenschaft \"event_name\" genau 0 Mal in den letzten 1 Kalendertag<br><br>Zeitzone:<br>UTC - Um alle Zeitzonen zu berücksichtigen, werden für 1 Kalendertag 24-48 Stunden des Nutzer:innen-Verlaufs betrachtet, je nachdem, zu welchem Zeitpunkt das Segment ausgewertet wird; für 2 Kalendertage werden 48-72 Stunden des Nutzer:innen-Verlaufs betrachtet, usw."
    tags:
      - Custom events
  - name: E-Mail-Adresse 
  ...
  - name: Erste App-Nutzung
    description: "Segmentiert Ihre Nutzer nach dem frühesten aufgezeichneten Zeitpunkt, zu dem sie Ihre App geöffnet haben. <em>Damit wird die erste Sitzung erfasst, die sie mit einer Version Ihrer App mit integriertem Braze SDK durchführen.</em> (24-Stunden-Zeitraum)<br><br>Zeitzone:<br>Zeitzone des Unternehmens"
    tags:
      - Sessions
  ...
  - name: Hat Nachricht aus Canvas-Schritt empfangen
    description: "Unterteilt Ihre Nutzer danach, ob sie eine bestimmte Canvas-Komponente erhalten haben oder nicht. Dieser Filter erfasst nur Nutzer:innen, denen die Nachricht explizit gesendet wurde, und nicht andere Nutzer:innen mit der gleichen E-Mail oder Telefonnummer, die doppelte Nachrichten erhalten haben. Um doppelte Nutzer:innen zu erfassen, verwenden Sie <a href=\"/docs/user_guide/engagement_tools/segments/segmentation_filters/#received-message-from-campaign-or-canvas-with-tag\">Empfangene Nachricht aus Kampagne oder Canvas mit Tag</a>.<br><br> Bei Content-Cards und In-App-Nachrichten ist dies der Zeitpunkt, an dem ein:e Nutzer:in eine Impression protokolliert, nicht der Zeitpunkt, an dem die Karte oder In-App-Nachricht gesendet wird.<br><br>Bei Push- und Webhooks ist dies der Zeitpunkt, an dem die Nachricht an den Benutzer gesendet wird.<br><br> Bei WhatsApp ist dies der Zeitpunkt, an dem die letzte Nachrichten-API-Anfrage an WhatsApp gesendet wird, nicht der Zeitpunkt, an dem die Nachricht an das Gerät des Benutzers geliefert wird. <br><br>Bei E-Mails ist dies der Zeitpunkt, an dem eine E-Mail-Anfrage an den E-Mail-Dienstanbieter gesendet wird (unabhängig davon, ob sie tatsächlich zugestellt wird).<br><br>Bei SMS ist dies der Zeitpunkt, an dem die letzte Nachricht an den SMS-Anbieter zugestellt wurde. Dies ist keine Garantie dafür, dass die Nachricht auf dem Gerät des Benutzers angekommen ist."
    tags:
      - Retargeting
  - name: Letzte empfangene Nachricht aus einem bestimmten Canvas-Schritt
    description: "Segmentiert Ihre Nutzer danach, wann sie eine bestimmte Canvas-Komponente erhalten haben. Dieser Filter erfasst nur Nutzer:innen, denen die Nachricht explizit gesendet wurde, und nicht andere Nutzer:innen mit der gleichen E-Mail oder Telefonnummer, die doppelte Nachrichten erhalten haben. Um doppelte Nutzer:innen zu erfassen, verwenden Sie <a href=\"/docs/user_guide/engagement_tools/segments/segmentation_filters/#received-message-from-campaign-or-canvas-with-tag\">Empfangene Nachricht aus Kampagne oder Canvas mit Tag</a>. Dieser Filter berücksichtigt nicht, wenn Benutzer andere Canvas-Komponenten erhalten haben."
    tags:
      - Retargeting
  - name: Letzte empfangene Nachricht aus einer bestimmten Kampagne
    description: "Segmentiert Ihre Nutzer danach, ob sie eine bestimmte Kampagne erhalten haben oder nicht. Dieser Filter erfasst nur Nutzer:innen, denen die Nachricht explizit gesendet wurde, und nicht andere Nutzer:innen mit der gleichen E-Mail oder Telefonnummer, die doppelte Nachrichten erhalten haben. Um doppelte Nutzer:innen zu erfassen, verwenden Sie <a href=\"/docs/user_guide/engagement_tools/segments/segmentation_filters/#received-message-from-campaign-or-canvas-with-tag\">Empfangene Nachricht aus Kampagne oder Canvas mit Tag</a>. Dieser Filter berücksichtigt nicht, wann Benutzer andere Kampagnen erhalten haben."
    tags:
      - Retargeting
  - name: Hat Nachricht aus Kampagne oder Canvas mit Tag empfangen
    description: "Segmentiert Ihre Nutzer danach, ob sie eine bestimmte Kampagne oder Leinwand mit einem bestimmten Tag erhalten haben oder nicht. Im Gegensatz zu \"Empfangene Nachricht aus Kampagne\" und \"Empfangene Nachricht aus Canvas-Schritt\" erfasst dieser Filter alle Nutzer:innen mit der gleichen E-Mail oder Telefonnummer, die doppelte Nachrichten erhalten haben.<br><br> Bei Content-Cards, Bannern (nur Kampagnen) und In-App-Nachrichten ist dies der Zeitpunkt, an dem ein Nutzer:innen eine Impression protokolliert, nicht der Zeitpunkt, an dem die Karte oder die In-App-Nachricht gesendet wird.<br><br>Bei Push- und Webhooks ist dies der Zeitpunkt, an dem die Nachricht an den Benutzer gesendet wird.<br><br> Bei WhatsApp ist dies der Zeitpunkt, an dem die letzte Nachrichten-API-Anfrage an WhatsApp gesendet wird, nicht der Zeitpunkt, an dem die Nachricht an das Gerät des Benutzers geliefert wird. <br><br>Bei E-Mails ist dies der Zeitpunkt, an dem eine E-Mail-Anfrage an den E-Mail-Dienstanbieter gesendet wird (unabhängig davon, ob sie tatsächlich zugestellt wird). Wenn mehrere Benutzer dieselbe E-Mail-Adresse verwenden:<br>- Beim ersten Senden wird nur das Profil des oder der spezifischen Targeting-Nutzer:in aktualisiert. <br>- Wenn die E-Mail zugestellt wird oder wenn der Nutzer:innen die E-Mail oder einen Link in der E-Mail öffnet, scheinen alle Nutzer:innen, die diese E-Mail-Adresse teilen, die Nachricht erhalten zu haben.<br><br>Bei SMS ist dies der Zeitpunkt, an dem die letzte Nachricht an den SMS-Anbieter zugestellt wurde. Dies ist keine Garantie dafür, dass die Nachricht auf dem Gerät des Benutzers angekommen ist."
    tags:
      - Retargeting
  ...
  - name: In Canvas-Kontrollgruppe
    description: "Segmentiert Ihre Nutzer danach, ob sie in der Kontrollgruppe für ein bestimmtes Canvas waren oder nicht. Dieser Filter wertet nur Benutzer aus, die das Canvas betreten haben.<br><br>Wenn Sie zum Beispiel nach Nutzer:innen filtern, die nicht in der Kontrollgruppe für ein Canvas sind, erhalten Sie alle Nutzer:innen, die das Canvas betreten haben, aber nicht in der Kontrollgruppe sind."
    tags:
      - Retargeting
  ...
  - name: In Canvas-Variation aufgenommen
    description: "Segmentiert Ihre Nutzer:innen danach, ob sie einen Variationspfad eines bestimmten Canvas eingegeben haben oder nicht. Dieser Filter wertet alle Benutzer aus.<br><br>Wenn Sie zum Beispiel nach Nutzern:innen filtern, die keine Kontrollgruppe für eine Canvas-Variante eingegeben haben, erhalten Sie alle Nutzer:innen, die nicht in der Kontrollgruppe sind, unabhängig davon, ob sie das Canvas eingegeben haben."
    tags:
      - Retargeting
  ...
  - name: E-Mail-Adresse verfügbar
    description: "Segmentiert Ihre Nutzer:innen danach, ob sie eine gültige E-Mail-Adresse haben und ob sie ein Abonnent:in sind oder ein Opt-in für E-Mails haben. Dieser Filter prüft auf drei Kriterien: ob der Nutzer:innen sich von E-Mails abgemeldet hat, ob Braze einen Hard Bounce erhalten hat und ob die E-Mail als Spam markiert wurde. Wenn eines dieser Kriterien erfüllt ist, oder wenn für einen Nutzer:innen keine E-Mail existiert, wird der Nutzer nicht berücksichtigt.<br><br>Nutzer:innen, deren E-Mail verfügbar ist <code>false</code> sind von der Zielgruppe der Kampagne ausgeschlossen und erhalten die E-Mail nicht - auch wenn Ihre Sendeeinstellungen so konfiguriert sind, dass sie an alle Nutzer:innen gesendet werden (einschließlich abgemeldeter Nutzer:innen).<br><br>Für E-Mails, bei denen der Opt-in-Status eine Rolle spielt, verwenden Sie E-Mail verfügbar anstelle von <a href=\"/docs/user_guide/engagement_tools/segments/segmentation_filters#email-address\">E-Mail Adresse</a>. Mit den zusätzlichen Kriterien können Sie Nutzer:innen, die für den Empfang von E-Mails in Frage kommen, gezielt zusammenstellen."
    tags:
      - Channel subscription behavior
  ...
  - name: Foreground-Push aktiviert
    description: "Segmentiert Ihre Benutzer, die über eine vorläufige Push-Autorisierung verfügen oder für Push im Vordergrund aktiviert sind. Diese Zählung umfasst insbesondere:<br>1. iOS-Benutzer, die vorläufig für Push autorisiert sind. <br>2. Nutzer:innen, die Push im Vordergrund aktiviert haben und deren Push-Abonnementstatus nicht abgemeldet ist, für jede Ihrer Apps. Für diese Benutzer umfasst diese Zählung nur den Push im Vordergrund.<br><br>Bei Foreground Push Enablement werden Nutzer:innen, die sich abgemeldet haben, nicht berücksichtigt. <br><br>Nach der Segmentierung mit diesem Filter sehen Sie im unteren Panel mit der Bezeichnung <em>Erreichbare Nutzer</em>:innen eine Aufschlüsselung der Nutzer:innen in diesem Segment für Android, iOS und Internet."
    tags:
      - Channel subscription behavior
  ...
  - name: Letzte Bestellung (letzte 730 Tage)
    description: "Segmentiert Ihre Nutzer:innen nach dem Zeitpunkt, an dem sie zuletzt eine Bestellung aufgegeben haben, basierend auf dem <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Ereignis</a> für die aufgegebene Bestellung (Workspaces, die keine E-Commerce-Ereignisse tracken, haben keine Daten für diesen Filter). Nutzer:innen werden für diesen Filter einmal pro Tag ausgewertet, und das maximale Rückblicksfenster sind die letzten 2 Jahre.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze-Konto Manager:in, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Gesamtzahl der Bestellungen (letzte 730 Tage)
    description: "Segmentiert Ihre Nutzer:innen nach der Gesamtzahl der Bestellungen eines Nutzers innerhalb der letzten 2 Jahre, basierend auf dem <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Ereignis</a> für die aufgegebene Bestellung (Workspaces, die keine E-Commerce-Ereignisse tracken, haben keine Daten für diesen Filter). Diese Zahl schließt stornierte Bestellungen aus, die über das <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">im E-Commerce empfohlene Ereignis</a> für stornierte Bestellungen getrackt werden müssen. Nutzer:innen werden einmal pro Tag für diesen Filter ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze-Konto Manager:in, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Bestellungen gesamt
    description: "Segmentiert Ihre Nutzer:innen nach der Gesamtzahl der Bestellungen eines Nutzers über dessen Lifetime, basierend auf dem <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Ereignis</a> für die aufgegebene Bestellung (Workspaces, die keine E-Commerce-Ereignisse tracken, haben keine Daten für diesen Filter). Diese Zahl schließt stornierte Bestellungen aus, die über das <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">im E-Commerce empfohlene Ereignis</a> für stornierte Bestellungen getrackt werden müssen. Nutzer:innen werden für diesen Filter in Realtime ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze-Konto Manager:in, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Gesamtzahl der stornierten Bestellungen (letzte 730 Tage)
    description: "Segmentiert Ihre Nutzer:innen nach der Gesamtzahl der Bestellungen, die ein Nutzer innerhalb der letzten 2 Jahre storniert hat, basierend auf dem <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Ereignis</a> für die aufgegebene Bestellung (Workspaces, die keine E-Commerce-Ereignisse tracken, haben keine Daten für diesen Filter). Nutzer:innen werden einmal pro Tag für diesen Filter ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze-Konto Manager:in, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: "Lifetime-Value Kund:in (letzte 730 Tage)"
    description: "Segmentiert Ihre Nutzer:innen nach dem Gesamtumsatz, den ein Nutzer im Verlauf seines Einkaufs bei Ihrer Marke voraussichtlich erzielen wird. Die Berechnung berücksichtigt die letzten 730 Tage und nimmt den durchschnittlichen Bestellwert (AOV), multipliziert ihn mit der Gesamtzahl der getätigten Bestellungen und berücksichtigt dann die aktive Kaufdauer des Nutzers:innen (die Zeitspanne zwischen seiner ersten und seiner letzten Bestellung). Dieser Filter verwendet Daten, die in den <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Ereignissen</a>getrackt wurden (Workspaces, die keine E-Commerce-Ereignisse tracken, haben keine Daten für diesen Filter). Nutzer:innen werden einmal pro Tag für diesen Filter ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze-Konto Manager:in, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Gesamterstattungswert (letzte 730 Tage)
    description: "Segmentiert Ihre Nutzer:innen nach dem Wert der Rückerstattungen, die einem Nutzer in den letzten 2 Jahren gewährt wurden, basierend auf dem <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Ereignis</a> für die zurückerstattete Bestellung (Workspaces, die keine E-Commerce-Ereignisse tracken, haben keine Daten für diesen Filter). Nutzer:innen werden einmal pro Tag für diesen Filter ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze-Konto Manager:in, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Erstattung gesamt
    description: "Segmentiert Ihre Nutzer:innen nach dem Gesamtwert der Rückerstattungen, die einem Nutzer über seine Lebenszeit hinweg gewährt wurden, basierend auf dem <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Ereignis</a> für die zurückerstattete Bestellung (Workspaces, die keine E-Commerce-Ereignisse tracken, haben keine Daten für diesen Filter). Nutzer:innen werden für diesen Filter in Realtime ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze-Konto Manager:in, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Gesamtumsatz (letzte 730 Tage)
    description: "Segmentiert Ihre Nutzer:innen nach dem Gesamtumsatz, der mit den Bestellungen eines Nutzers in den letzten 2 Jahren erzielt wurde. Die Berechnung basiert auf der Subtraktion des Umsatzes, der mit dem <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Ereignis</a> für die zurückerstattete Bestellung verbunden ist, von dem Umsatz, der mit dem E-Commerce-Ereignis für die aufgegebene Bestellung verbunden ist (Workspaces, die keine E-Commerce-Ereignisse tracken, haben keine Daten für diesen Filter). Nutzer:innen werden einmal pro Tag für diesen Filter ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze-Konto Manager:in, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Umsatz gesamt
    description: "Segmentiert Ihre Nutzer:innen nach dem Gesamtumsatz, der durch die Bestellungen eines Nutzers über die Lifetime des Nutzers generiert wurde. Die Berechnung basiert auf der Subtraktion des Umsatzes, der mit dem <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Ereignis</a> für die zurückerstattete Bestellung verbunden ist, von dem Umsatz, der mit dem E-Commerce-Ereignis für die aufgegebene Bestellung verbunden ist (Workspaces, die keine E-Commerce-Ereignisse tracken, haben keine Daten für diesen Filter). Nutzer:innen werden für diesen Filter in Realtime ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze-Konto Manager:in, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Durchschnittlicher Bestellwert (letzte 730 Tage)
    description: "Segmentiert Ihre Nutzer:innen nach dem durchschnittlichen (mittleren) Wert der Bestellungen eines Nutzers in den letzten 2 Jahren, basierend auf dem <a href=\"/docs/user_guide/data/activation/custom_data/recommended_events/ecommerce_events\">empfohlenen E-Commerce-Ereignis</a> für die aufgegebene Bestellung (Workspaces, die keine E-Commerce-Ereignisse tracken, haben keine Daten für diesen Filter). Nutzer:innen werden einmal pro Tag für diesen Filter ausgewertet.<br><br>Dieser Filter befindet sich in der Beta-Phase. Kontaktieren Sie Ihren Braze-Konto Manager:in, wenn Sie diesen Filter verwenden möchten."
    tags:
      - eCommerce
  - name: Land
  ...
  - name: Gerätemodell
    ...
    tags:
      - Devices
  - name: Betriebssystem
    description: "Segmentiert Ihre Benutzer, die über ein oder mehrere Geräte mit dem angegebenen Betriebssystem verfügen. Um Nutzer:innen nach verschiedenen Betriebssystemen zu segmentieren, verwenden Sie den Filter <a href=\"/docs/user_guide/engagement_tools/segments/segmentation_filters#device-os-version-number\">Versionsnummer des Betriebssystems des Geräts</a>."
    tags:
      - Devices
  - name: Versionsnummer des Geräte-Betriebssystems
    description: "Segmentiert Ihre Nutzer:innen, die über ein oder mehrere Geräte mit einer Betriebssystem-Version verfügen, die innerhalb eines bestimmten Bereichs liegt. Sie können zum Beispiel Nutzer:innen mit einer iOS-Betriebssystemversion von 26.0 oder höher als diese zusammenstellen."
    tags:
      - Devices
  ...
  - name: Wahrscheinlichkeit der Nachrichtenöffnung
    description: "Filtert Ihre Nutzer:innen anhand der <a href=\"/docs/user_guide/brazeai/intelligence/intelligent_channel/#individual-channels\">Wahrscheinlichkeit, dass sie eine Nachricht auf einem bestimmten Kanal öffnen</a>, auf einer Skala von 0-100%. Benutzer ohne ausreichende Daten, um eine Wahrscheinlichkeit für einen Kanal zu messen, können mit \"ist leer\" ausgewählt werden.<br><br>Bei E-Mails werden die Öffnungen durch Maschinen von der Wahrscheinlichkeitsberechnung ausgeschlossen."
    tags:
      - Intelligence and predictive
