...
Wählen Sie Nutzer aus, die in jedem der letzten vier Quartale einen Kauf getätigt haben. Dieses Nutzersegment kann mit [Zielgruppen-Synchronisierung]({{site.baseurl}}/partners/canvas_steps) verwendet werden, um hochwertige ähnliche Kund:innen für die Akquisition zu identifizieren.
