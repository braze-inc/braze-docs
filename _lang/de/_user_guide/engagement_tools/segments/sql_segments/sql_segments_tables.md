---
nav_title: "SQL-Tabellen-Referenz"
...
[USERS_MESSAGES_PUSHNOTIFICATION_OPEN_SHARED](#USERS_MESSAGES_PUSHNOTIFICATION_OPEN_SHARED) | Wenn ein Benutzer eine Push-Benachrichtigung öffnet oder auf eine Push-Benachrichtigungsschaltfläche klickt (einschließlich einer SCHLIESSEN-Schaltfläche, die die App NICHT öffnet). <br><br> Aktionen auf Knopfdruck haben mehrere Auswirkungen. Aktionen wie „Nein“, „Ablehnen“ und „Abbrechen“ werden durch Klicken ausgeführt, während Aktionen wie „Akzeptieren“ durch Öffnen ausgeführt werden. Beide sind in dieser Tabelle vertreten, aber sie können in der Spalte **BUTTON_ACTION_TYPE** unterschieden werden. Beispielsweise kann eine Abfrage verwendet werden, um nach einem `BUTTON_ACTION_TYPE` zu gruppieren, bei dem es sich nicht um „Nein“, „Ablehnen“ und „Abbrechen“ handelt.
...
[USERS_RANDOMOMBUCKETNUMBERUPDATE_SHARED](#USERS_RANDOMBUCKETNUMBERUPDATE_SHARED) | Wenn die zufällige Bucket-Nummer eines Benutzers geändert wird
...
`external_user_id` | `null,` `string` | [PII] Externe Benutzer-ID des Benutzers
...
`gender` | `null,` `string` | [PII] Geschlecht des Nutzers oder der Nutzerin
`country` | `null,` `string` | [PII] Land des Benutzers
`timezone` | `null,` `string` | Zeitzone des Benutzers
`language` | `null,` `string` | [PII] Sprache des Benutzers
...
`ad_id` | `null,` `string` | [PII] Bezeichner für Werbung
...
`external_user_id` | `null,` `string` | [PII] Externe Benutzer-ID des Benutzers
`email_address` | `null,` `string` | [PII] E-Mail Adresse des Benutzers
...
`app_group_api_id` | `null,` `string` | API-ID des Arbeitsbereichs, zu dem dieser Benutzer gehört
`email_address` | `null,` `string` | [PII] E-Mail Adresse des Benutzers
`phone_number` | `null,` `string` | [PII] Telefonnummer des Benutzers im Format e164
`app_api_id` | `null,` `string` | API-ID der App, zu der das Event gehört
`campaign_id` | `null,` `string` | Intern verwendete Braze-ID der Kampagne, zu der dieses Event gehört
`campaign_api_id` | `null,` `string` | API-ID der Kampagne, zu der dieses Event gehört
`message_variation_api_id` | `null,` `string` | API-ID der Nachrichtenvariante, zu der dieses Ereignis gehört
...
| `external_user_id`                     | `string`, `null`    | [PII] Externe Benutzer-ID des Benutzers                                                                              |
...
| `gender`                               | `string`, `null`    | [PII] Geschlecht des Nutzers oder der Nutzerin                                                                                        |
| `country`                              | `string`, `null`    | [PII] Land des Benutzers                                                                                       |
| `timezone`                             | `string`, `null`    | Zeitzone des Benutzers                                                                                            |
| `language`                             | `string`, `null`    | [PII] Sprache des Benutzers                                                                                      |
...
| `canvas_api_id`           | `string`, `null`    | API-ID des Canvas, zu dem dieses Event gehört                           |
| `canvas_variation_api_id` | `string`, `null`    | API-ID der Canvas-Variation, zu der dieses Ereignis gehört                 |
| `canvas_step_api_id`      | `string`, `null`    | [Veraltet] API-ID des Canvas-Schritts, zu dem dieses Event gehört         |
| `gender`                  | `string`, `null`    | [PII] Geschlecht des Nutzers oder der Nutzerin                                             |
| `country`                 | `string`, `null`    | [PII] Land des Benutzers                                            |
| `timezone`                | `string`, `null`    | Zeitzone des Benutzers                                                 |
| `language`                | `string`, `null`    | [PII] Sprache des Benutzers                                           |
...
`timezone` | `null,` `string` | Zeitzone des Benutzers
`language` | `null,` `string` | [PII] Sprache des Benutzers
`abort_type` | `null,` `string` | Typ des Abbruchs, einer von: `liquid_abort_message`, `quiet_hours`, `rate_limit`
`abort_log` | `null,` `string` | [PII] Log Nachricht, die Details zum Abbruch beschreibt (maximal 128 Zeichen)
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
`timezone` | `null,` `string` | Zeitzone des Benutzers
`language` | `null,` `string` | [PII] Sprache des Benutzers
`email_address` | `string` | [PII] E-Mail Adresse des Benutzers
...
`ip_pool` | `null,` `string` | IP-Pool, von dem aus die E-Mail gesendet wurde
`bounce_reason` | `null,` `string` | [PII] Der für dieses Bounce-Event empfangene SMTP-Ursachencode und die nutzerfreundliche Nachricht
`esp` | `null,` `string` | ESP im Zusammenhang mit dem Ereignis (SparkPost oder SendGrid)
...
`language` | `null,` `string` | [PII] Sprache des Benutzers
`platform` | `null,` `string` | Plattform des Geräts
`ad_id` | `null,` `string` | [PII] Werbe-ID des Geräts, an das wir einen Zustellungsversuch unternommen haben
...
`carrier` | `null,` `string` | Netzbetreiber des Geräts
`browser` | `null,` `string` | Browser des Geräts
`button_string` | `null,` `string` | Identifikator (button_string) der angeklickten Schaltfläche der Push-Benachrichtigung. null, wenn nicht von einem Schaltflächenklick
`button_action_type` | `null,` `string` | Aktiontyp des Buttons „Push-Benachrichtigung“. Eine von [URI, DEEP_LINK, NONE, CLOSE]. null, wenn nicht durch einen Klick auf eine Schaltfläche
...
`timezone` | `null,` `string` | Zeitzone des Benutzers
`language` | `null,` `string` | [PII] Sprache des Benutzers
`to_phone_number` | `null,` `string` | [PII] Telefonnummer des Empfängers
...
`time` | `int` | Unix-Zeitstempel, zu dem das Ereignis eingetreten ist
`user_phone_number` | `string` | [PII] die Telefonnummer des Nutzers oder der Nutzerin, von dem oder der die Nachricht empfangen wurde
...
------|------|------------
`id` | `string` | Globale eindeutige ID für dieses Event
`user_id` | `null,` `string` | Braze ID des Benutzers, auf den short_url abzielt, null, wenn short_url kein User Click Tracking verwendet hat
`external_user_id` | `null,` `string` | [PII] Externe ID des Benutzers, auf den short_url abzielt, falls vorhanden, null, wenn short_url kein User Click Tracking verwendet hat
`app_group_api_id` | `null,` `string` | API-ID des Arbeitsbereichs, der zur Erzeugung von short_url verwendet wird
...
`campaign_api_id` | `null,` `string` | API-ID der Kampagne, für die short_url generiert wurde, null, wenn nicht von einer Kampagne
...
`canvas_api_id` | `null,` `string` | API-ID des Canvas, für das short_url generiert wurde, null, wenn nicht von einem Canvas
...
`canvas_step_api_id` | `null,` `string` | API-ID des Canvas-Schritts, für den short_url generiert wurde. Null, falls nicht von einem Canvas
`canvas_step_message_variation_api_id` | `null,` `string` | API-ID der Nachrichtenvariante des Canvas-Schritts, für die short_url generiert wurde. Null, falls nicht von einem Canvas
`url` | `string` | ursprüngliche URL in der Nachricht, auf die short_url umleitet
`short_url` | `string` | verkürzte URL, die angeklickt wurde
`user_agent` | `null,` `string` | Benutzeragent, der short_url anfordert
`user_phone_number` | `string` | [PII] die Telefonnummer des Benutzers
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
### USERS_RANDOMOMBUCKETNUMBERUPDATE_SHARED {#USERS_RANDOMBUCKETNUMBERUPDATE_SHARED}
