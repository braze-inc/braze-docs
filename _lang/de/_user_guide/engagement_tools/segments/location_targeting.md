...
Sobald Sie Ihr Segment erstellt haben, fügen Sie einen Filter für **den letzten Standort** hinzu, um Nutzer nach dem letzten Ort, an dem sie Ihre App verwendet haben, anzusprechen. Sie haben die Möglichkeit, Nutzer:innen entweder in einer kreisförmigen Standardregion oder in einer anpassbaren polygonalen Region hervorzuheben.
...
![Ein kreisförmiger Umriss der Städte zwischen New Jersey und New York.][3]{: style="max-width:70%;"}

### Polygonale Regionen

Bei polygonalen Regionen können Sie genauer festlegen, welche Bereiche in Ihrem Segment enthalten sein sollen.

![Ein Umriss des Staates New York als ausgewählte polygonale Region.][4]{: style="max-width:70%;"}
