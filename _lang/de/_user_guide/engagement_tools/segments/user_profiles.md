...
]({% image_buster /assets/img_archive/User_Search_Nonunique.png %})Suchergebnisse mit einem Banner mit der Aufschrift "Mehrere Nutzer:innen entsprechen Ihren Suchkriterien" und zwei Buttons mit der Aufschrift Zurück und Weiter.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img_archive/user_profile2.png %})Der Tab Übersicht eines Nutzerprofils.()
...
]({% image_buster /assets/img_archive/profiles_engagement_tab.png %})Der Tab Engagement eines Nutzerprofils, auf dem die Kontakteinstellungen und Kommunikationsstatistiken angezeigt werden.()
...
]({% image_buster /assets/img_archive/profiles_messaging_history_tab.png %})Der Tab Messaging-Verlauf zeigt an, welche Kampagnen und Canvase ein Nutzer:innen erhalten hat.()
