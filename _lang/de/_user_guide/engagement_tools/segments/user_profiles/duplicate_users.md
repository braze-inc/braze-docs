...
]({% image_buster /assets/img/audience_management/duplicate_users/individual_merging/select_search_users.png %})Die Kachel "Benutzersuche" wird im Navigationsmenü hervorgehoben.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/audience_management/duplicate_users/individual_merging/search_user.png %})Die Seite "Nutzersuche" im Braze-Dashboard.{: style="max-width:60%;"}()

### Schritt 2: Duplikate zusammenführen

Um die Zusammenführung zu starten, wählen Sie **Duplikate zusammenführen**.

]({% image_buster /assets/img/audience_management/duplicate_users/individual_merging/select_merge_duplicates.png %})Eines der Profile des doppelten Benutzers.{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/audience_management/duplicate_users/individual_merging/select_merge_profiles.png %})Die individuelle Zusammenführungsseite für ein Duplikatprofil.{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/audience_management/duplicate_users/bulk_merging/select_manage_audience.png %})Die Kachel "Zielgruppe verwalten" wird im Navigationsmenü hervorgehoben.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/audience_management/duplicate_users/bulk_merging/select_generate_list.png %})Die Seite "Zielgruppe verwalten" mit der markierten Option "Doublettenliste erstellen".()

Braze erstellt Ihre Vorschau und sendet sie als CSV-Datei an Ihre E-Mail-Adresse.

]({% image_buster /assets/img/audience_management/duplicate_users/bulk_merging/example_email.png %})Eine E-Mail von Braze mit einem Link zu der generierten CSV-Datei.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/audience_management/duplicate_users/bulk_merging/select_merge_profiles.png %})Die Seite "Zielgruppe verwalten" mit markierter Option "Alle Doubletten zusammenführen".{: style="max-width:70%;"}()
...
]({% image_buster /assets/img/audience_management/duplicate_users/edit_rules.png %})Das Panel "Regeln bearbeiten" mit Abschnitten zum Auswählen von Optionen für "Profil beibehalten" und "Verknüpfungen auflösen".{: style="max-width:40%;"}()
...
]({% image_buster /assets/img/audience_management/duplicate_users/bulk_merging/select_scheduled_merge_rules.png %})Die Seite "Zielgruppe verwalten" mit dem Button "Zeitplan".()
