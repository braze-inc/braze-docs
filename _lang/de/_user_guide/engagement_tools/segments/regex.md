...
# [![Braze Learning Kurs]](https://learning.braze.com/regular-expression-basics-for-braze) ( [{% image_buster /assets/img/bl_icon3.png %})](https://learning.braze.com/regular-expression-basics-for-braze){: style="float:right;width:120px;border:0;" class="noimgborder"} Reguläre Ausdrücke
