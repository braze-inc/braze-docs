...
# []({% image_buster /assets/img/bl_icon3.png %})Braze Learning Kurs{: style="float:right;width:120px;border:0;" class="noimgborder"}](https://learning.braze.com/regular-expression-basics-for-braze) ( [)](https://learning.braze.com/regular-expression-basics-for-braze) Reguläre Ausdrücke
...
braze.comFilter für eine E-Mail Adresse, die dem Regex von „@]({% image_buster /assets/img/regex/regeximg1.png %})“ entspricht.()
...
]({% image_buster /assets/img/regex/regeximg2.png %})Filter für einen Ort, der dem Regex von „^San \\w“ entspricht.()
...
]({% image_buster /assets/img/regex/regeximg3.png %})Filter für eine Telefonnummer, die dem Regex von „^1?718\\d\\d\\d\\d\\d\\d“ entspricht.()
