...
]({% image_buster /assets/img/landing_pages/connect_subdomain.png %})Seite mit den Einstellungen für die Landing Page mit einem TXT- und zwei CNAME-Einträgen, die mit ihren jeweiligen Namen und Werten aufgeführt sind.()
