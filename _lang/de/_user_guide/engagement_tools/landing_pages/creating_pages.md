...
]({% image_buster /assets/img/landing_pages/landing-pages-homepage.png %})Der Bereich Landing Pages im Braze-Dashboard.()
...
]({% image_buster /assets/img/landing_pages/template.png %})Ein Beispiel für eine Landing Page, die im Drag-and-Drop-Editor erstellt wird.()
...
]({% image_buster /assets/img/landing_pages/dnd.png %})Der Bereich 'Bauen' mit 'Zeilen' und 'Formularblöcken'.{: style="max-width:35%;"}()
...
]({% image_buster /assets/img/landing_pages/form.png %})Ein Formularblock, der eine neue Kund:in registriert und einen Rabattcode an ihre E-Mail sendet.{: style="max-width:70%;"}()
...
]({% image_buster /assets/img/landing_pages/page_container.png %})Der Bereich 'Seitencontainer' mit Optionen zum Anpassen von Hintergrundbildern, Farben, Rahmendetails und der Gestaltung des Inhalts.{: style="max-width:40%;"}()
...
]({% image_buster /assets/img/landing_pages/lp-optional-required.png %})Ein Formularfeld mit einem Kontrollkästchen, in dem die Option "Erforderliches Eingabefeld" umgeschaltet ist.{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/landing_pages/copy-url.png %})Eine Landing Page mit geöffnetem Menü, das die Option "URL kopieren" anzeigt.()
...
]({% image_buster /assets/img/landing_pages/manage-lp-template.png %})Ein Dropdown mit Optionen zum Speichern, Ändern und Löschen einer Landing Page.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/landing_pages/analytics.png %})Der Analytics-Bereich für eine Landing Page.()
