...
![Der Abschnitt "Zustellung" mit ausgewähltem "Zeitplan" und der Option, den Versand zeitlich zu planen, sobald die Kampagne gestartet wird]({% image_buster /assets/img_archive/schedule_immediately.png %})
