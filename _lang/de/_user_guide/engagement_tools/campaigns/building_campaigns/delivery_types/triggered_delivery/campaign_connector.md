...
{% alert important %}
Konnektoren für Kampagnen können nicht verwendet werden, um In-App-Nachricht-Kampagnen zu triggern. In-App-Nachrichten können nur durch SDK-Ereignisse wie angepasste Events oder den Start einer Sitzung getriggert werden. Weitere Informationen finden Sie unter [Erstellen einer In-App-Nachricht]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/traditional/create/).
{% endalert %}
