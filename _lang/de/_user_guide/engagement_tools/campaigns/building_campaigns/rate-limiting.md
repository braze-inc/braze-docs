...
]({% image_buster /assets/img_archive/rate_limit_daily.png %})Abschnitt "Segmentdetails" mit hervorgehobenem Filter für das Segment "Letzte erhaltene Nachricht".()
...
]({% image_buster /assets/img_archive/total_limit.png %})Zusammenfassung der Zielgruppe mit einem ausgewählten Kontrollkästchen zur Begrenzung der Anzahl der Personen, die die Kampagne erhalten.()
...
]({% image_buster /assets/img_archive/per_minute_rate_limit.png %})Zusammenfassung der Zielgruppe mit einem ausgewählten Kontrollkästchen zur Begrenzung der Rate, mit der die Kampagne endet, und einer Rate von 500.000 pro Minute.()
...
]({% image_buster /assets/img_archive/rate_limiting_overview_2.png %})Frequency-Capping-Bereich mit Listen von Kampagnen und Canvase, für die die Regeln gelten und nicht gelten.()
...
]({% image_buster /assets/img_archive/frequencycappingupdate.png %})Abschnitt Zustellungssteuerung mit eingeschaltetem Frequency-Capping.()
...
]({% image_buster /assets/img/standard_rules_fnfn.png %})Abschnitt Frequency-Capping mit der Regel, nicht mehr als 2 Push-Benachrichtigungen Kampagnen/Canvas-Schritte aus allen Kampagnen/Canvas-Schritten an einen Nutzer:innen pro 1 Woche zu senden.()
...
]({% image_buster /assets/img/tag_rule_fnfn.png %} "rules")Frequency-Capping mit zwei Regeln, die festlegen, wie viele Kampagnen/Canvase mit Push-Benachrichtigungen pro Woche an einen Nutzer:innen gesendet werden können.
...
]({% image_buster /assets/img/global_rules.png %} "global rules")Abschnitt Frequency-Capping mit widersprüchlichen Regeln, um zu begrenzen, wie viele Push-Benachrichtigungen Kampagnen/Canvas-Schritte pro 1 Woche an einen Nutzer:innen gesendet werden.
