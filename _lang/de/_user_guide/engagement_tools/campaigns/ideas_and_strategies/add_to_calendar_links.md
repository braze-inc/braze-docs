...
![Google Kalender-Dialog zum Hinzufügen eines Termins mit den hinzugefügten und speicherbereiten Details des Termins.]({% image_buster /assets/img_archive/calendar_2.png %}){: style="max-width:75%"}
...
![iCal-Kalender mit einem Dialogfeld zum Hinzufügen eines neuen Ereignisses, in dem der Nutzer oder die Nutzerin aufgefordert wird, einen Kalender auszuwählen und zu bestätigen.]({% image_buster /assets/img_archive/calendar_3.png %}){: style="max-width:75%"}
...
![iOS-Pop-up, wenn Sie auf einem Kalenderlink drücken und halten, der einen „Zum Kalender hinzufügen“-Button enthält.]({% image_buster /assets/img_archive/calendar_5.png %}){: style="max-width:50%"}
