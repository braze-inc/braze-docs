...
]({% image_buster /assets/img/zoom/zoom1.png %})Nachrichten mit Liquid-Templates, die den Vornamen, den Nachnamen, die E-Mail-Adresse und den Ort enthalten.()
...
1. Erstellen Sie eine Push-Kampagne<br><br>
	...
	]({% image_buster /assets/img/zoom/zoom2.png %})Verlinkung zum Webinar, wenn ein Button angeklickt wird.()<br><br>
	...
	]({% image_buster /assets/img/zoom/zoom4.png %})]({% image_buster /assets/img/zoom/zoom4.png %})<br><br>
...
2. Erstellen Sie eine Webhook-Kampagne, die durch eine In-App-Nachricht oder einen Klick auf einen Button getriggert wird.<br><br>
	...
	]({% image_buster /assets/img/zoom/zoom6.png %})Eine aktionsbasierte Kampagne, die an Benutzer gesendet wird, die auf eine Schaltfläche für eine bestimmte Kampagne geklickt haben.()<br><br>
...
1. In-App-Nachrichtenkampagne erstellen<br><br>
	...
	]({% image_buster /assets/img/zoom/zoom3.png %})Verlinkung zum Webinar, wenn ein Button angeklickt wird.()<br><br>
...
2. Erstellen Sie eine Webhook-Kampagne, die durch eine In-App-Nachricht oder einen Klick auf einen Button getriggert wird.<br><br>
	...
	]({% image_buster /assets/img/zoom/zoom5.png %})Eine aktionsbasierte Kampagne, die an Benutzer gesendet wird, die auf eine Schaltfläche für eine bestimmte Kampagne geklickt haben.()<br><br>
