...
]({% image_buster /assets/img_archive/push_2.png %})Benachrichtigungstyp mit ausgewähltem Standard-Push als Beispiel.{: style="float:right;max-width:40%;margin-left:15px;"}()
...
]({% image_buster /assets/img_archive/push_compose.png %})Registerkarte "Verfassen" zum Erstellen einer Push-Benachrichtigung.()
...
]({% image_buster /assets/img/ai_copywriter/ai_copywriter_push.png %})Gehen Sie auf den Button "KI-Texter" im Textfeld des Push-Editors.{: style="max-width:60%"}()
{% endalert %}
...
]({% image_buster /assets/img_archive/push_recent_device.png %})Aktivieren Sie das Kontrollkästchen Geräteoptionen, um diesen Push nur an das zuletzt verwendete Gerät des Nutzers zu senden.{: style="max-width:70%;" }()
...
]({% image_buster /assets/img_archive/multi_channel_footer.png %})Tabelle mit detaillierten Zielgruppenstatistiken für erreichbare Nutzer:innen.()
