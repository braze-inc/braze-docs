...
![Push-Token-Changelog auf dem Tab \*\*Engagement** des Profils eines Nutzers oder einer Nutzerin. Hier wird aufgeführt, wann der Push-Token an eine:n andere:n Nutzer:in weitergegeben wurde und um welchen Token es sich handelte.]({% image_buster /assets/img/push_token_changelog.png %})
