...
]({% image_buster /assets/img/push_changelog.png %})Push Changelog mit einem Beispiel für ein Push-Token.{: style="float:right;max-width:40%;margin-left:15px;margin-top:10px;"}()
...
]({% image_buster /assets/img/push_process.png %})Ein Flussdiagramm, das den oben genannten Push-Prozess zwischen Braze, dem Kunden und dem Apple Push Notification Service oder Firebase Cloud Messaging abbildet.()
