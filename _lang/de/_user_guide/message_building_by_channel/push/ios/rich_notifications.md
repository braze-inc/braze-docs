...
# Erstellen Sie Rich-Push-Benachrichtigungen für iOS
...
![Beispiel einer Push-Benachrichtigung mit dem Zeitstempel "Gestern, 8:37 AM" und der Anzahl der Zeichen im Titel von 22.]({% image_buster/assets/img_archive/push_ios_timing_22.png %})
...
![Beispiel einer Push-Benachrichtigung mit einem Bild und einer Zeichenanzahl von 154.]({% image_buster/assets/img_archive/push_ios_images_154.png %})
...
![Ein:e Nutzer:in erhält eine Push-Benachrichtigung und drückt auf die Nachricht, um ein erweitertes Bild mit der Aufschrift „Hallo!“ anzuzeigen.]({% image_buster /assets/img_archive/rich_notification_ios.gif %}){: style="max-width:50%;" }
