...
]({% image_buster /assets/img_archive/push_ios_notification_states.png %})Beispiel für Push-Benachrichtigungen, die auf dem Sperrbildschirm angezeigt werden, wenn sie erweitert werden und wenn das Gerät aktiv ist.()
...
]({% image_buster/assets/img_archive/push_ios_timing_35.png %})Beispiel für eine Push-Benachrichtigung mit dem Zeitstempel „jetzt“ und der Anzahl der Zeichen im Titel von 35.()
<br>Anzahl der Zeichen im Titel: **35**

]({% image_buster/assets/img_archive/push_ios_timing_33.png %})Beispiel für eine Push-Benachrichtigung mit einem Zeitstempel von "vor 3 Stunden" und einer Anzahl von 33 Zeichen im Titel.()
<br>Anzahl der Zeichen im Titel: **33**

]({% image_buster/assets/img_archive/push_ios_timing_22.png %})Beispiel für eine Push-Benachrichtigung mit einem Zeitstempel von "Gestern, 8:37 AM" und einer Anzahl von 22 Zeichen im Titel.()
...
]({% image_buster/assets/img_archive/push_ios_images_179.png %})Beispiel für eine Push-Benachrichtigung ohne Bild und mit einer Zeichenanzahl von 179.()
<br>Anzahl der Zeichen im Text: **179**

]({% image_buster/assets/img_archive/push_ios_images_154.png %})Beispiel für eine Push-Benachrichtigung mit einem Bild und einer Textlänge von 154 Zeichen.()
...
]({% image_buster/assets/img_archive/push_ios_interruption_level_35.png %})Beispiel für eine Push-Benachrichtigung, die weder als zeitkritisch noch als kritisch bezeichnet wird und deren Titel 35 Zeichen enthält.()
<br>Anzahl der Zeichen im Titel: **35**

]({% image_buster/assets/img_archive/push_ios_interruption_level_39.png %})Beispiel für eine Push-Benachrichtigung, die als zeitkritisch bezeichnet wird und deren Titel 39 Zeichen enthält.()
...
]({% image_buster /assets/img_archive/rich_notification_add_image.png %})Ein Beispiel für einen zusammenfassenden Text für eine Push-Benachrichtigung.{: style="max-width:70%;" }()
...
]({% image_buster /assets/img_archive/rich_notification_ios10_select.png %})Der erweiterte Bereich für Benachrichtigungsbilder, in dem Sie ein Bild hinzufügen oder eine Bild-URL eingeben können.{: style="max-width:70%;" }()
...
]({% image_buster /assets/img_archive/rich_notification_ios.gif %})Ein Nutzer:in erhält eine Push-Benachrichtigung und drückt auf die Nachricht, um ein erweitertes Bild mit der Aufschrift "Hallo!" anzuzeigen.{: style="max-width:50%;" }()
