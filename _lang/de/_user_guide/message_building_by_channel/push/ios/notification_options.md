...
![Das Tab „Einstellungen“ mit einem Dropdown-Menü „Benachrichtigungsgruppe“, in dem der Wert „Gutscheine“ ausgewählt wurde.]({% image_buster /assets/img_archive/notification_group_dropdown.png %}){: style="max-width:50%;" }
...
![Kontakteinstellungen mit Push-Abonnementstatus.]({% image_buster /assets/img/profile-push-prov-auth.png %}){: width="50%"}
...
![Segmentdetails-Panel mit dem Beispielsegmentfilter „Vorläufig autorisiert auf iOS-Stoppuhr (iOS) ist wahr“, um die Zielgruppe zusammenzustellen.]({% image_buster /assets/img/segment-push-prov-auth.png %})
