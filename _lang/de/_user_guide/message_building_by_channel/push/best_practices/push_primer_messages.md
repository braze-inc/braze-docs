...
]({% image_buster /assets/img_archive/push_primer_trigger.png %})Aktionsbasierte Zustellung an Nutzer:innen, die das angepasste Event "Zur Beobachtungsliste hinzufügen" ausgeführt haben.()
