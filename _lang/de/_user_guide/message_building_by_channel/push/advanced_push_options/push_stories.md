...
Um Push Stories zu verwenden, erstellen Sie eine [Push-Kampagne]({{site.baseurl}}/user_guide/message_building_by_channel/push/creating_a_push_message/) und wählen Sie **Push Stories** als **Benachrichtigungstyp**.
