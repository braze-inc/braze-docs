...
]({% image_buster /assets/img_archive/push_action_buttons_ios.png %})Dropdown-Menü der iOS-Benachrichtigungskategorie.{: style="max-width:70%"}()
...
]({% image_buster /assets/img_archive/push_action_buttons_android.png %})Auswählen von "App öffnen" als Klickverhalten für einen Benachrichtigungs-Button.{: style="max-width:70%"}()
...
]({% image_buster /assets/img_archive/push_action_truncated.png %})Push-Action-Buttons für Android mit abgeschnittenem Text.{: style="max-width:50%"}()
