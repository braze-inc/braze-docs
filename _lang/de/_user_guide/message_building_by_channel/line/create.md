...
]({% image_buster /assets/img/line/line_composer.png %})LINE composer with a message displayed in the preview.()
...
]({% image_buster /assets/img/line/test_preview.png %})The "Tests" tab displaying a preview of a test message.()
