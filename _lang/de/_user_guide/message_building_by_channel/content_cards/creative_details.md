...
]({% image_buster /assets/img/content_card_classic.png %})Bild einer klassischen Karte mit empfohlenen Details und einem klassischen Kartenbeispiel{: style="max-width:45%;border:0;"}()
...
]({% image_buster /assets/img/content_card_captioned.png %})Abbildung einer Bildunterschriftenkarte mit empfohlenen Details und ein Beispiel für eine Bildunterschriftenkarte{: style="max-width:90%;border:0;"}()
...
]({% image_buster /assets/img/content_card_banner.png %})Bild einer reinen Content-Card mit empfohlenen Details und einem reinen Bildbeispiel{: style="max-width:45%;border:0;"}()
...
]({% image_buster /assets/img/dismissal-cc.png %})Bild, das das Verhalten beim Durchziehen oder Schließen der Karten-Ausblendung für eine Karte zeigt()
...
]({% image_buster /assets/img/empty-cc.png %})Bild eines leeren Content-Card-Feed{: style="max-width:45%"}()
