...
|---|---|---|
|[Klassisch]({{site.baseurl}}/user_guide/message_building_by_channel/content_cards/creative_details/#classic)| ]({% image_buster/assets/img_archive/cc_steppington_classic.png %})Eine klassische Inhaltskarte mit einem kleinen Symbol und einem Text, der zur Buchung eines Trainingskurses anregt.() |Die Classic Card hat ein einfaches Layout mit einem fettgedruckten Titel, einem Nachrichtentext und einem optionalen Bild, das links neben dem Titel und dem Text platziert wird. Für die Classic Card verwenden Sie am besten ein quadratisches Bild oder Symbol. |
|[Bild mit Bildunterschrift]({{site.baseurl}}/user_guide/message_building_by_channel/content_cards/creative_details/#captioned-image)| ]({% image_buster/assets/img_archive/cc_steppington_captioned.png %})Eine Content-Card mit hervorgehobenem Bild eines Gewichthebers und Text, der zur Buchung eines Trainingskurses ermutigt.() | Die hervorgehobene Image-Card präsentiert Ihren Inhalt mit Text und einem aufmerksamkeitsstarken Bild. |
|[Nur Bild]({{site.baseurl}}/user_guide/message_building_by_channel/content_cards/creative_details/#banner)| ]({% image_buster/assets/img_archive/cc_steppington_banner.png %})Eine Karte mit reinem Bildinhalt und nur Text.() | Die Karte mit reinem Bildinhalt bietet Platz für Bilder, GIFs und andere kreative Nicht-Text-Inhalte. |
...
]({% image_buster /assets/img/content_card_compose.png %})Beispiele für Content-Card-Details auf dem Tab Verfassen des Nachrichten-Editors.()
...
]({% image_buster /assets/img/add_languages.png %})Ein Fenster, in dem Englisch, Spanisch und Französisch als Sprachen ausgewählt sind und Titel, Beschreibung und Linktext als zu internationalisierende Felder ausgewählt sind.{: style="max-width:70%;"}()
...
]({% image_buster /assets/img/cc_pin_to_top.png %})Side-by-Side-Vorschau der Content-Cards in Braze für Mobilgeräte und Web mit aktivierter Option "Diese Karte oben im Feed pinnen".{:style="border:none"}()
...
]({% image_buster /assets/img/cc_remove.png %})Dialog zur Bestätigung der Deaktivierung von Content-Cards{: style="max-width:75%" }()
...
]({% image_buster /assets/img/content_cards/content_card_removal_event.png %})Fenster „Bedingungen für das Entfernen von Content-Cards“ mit der Option „Event zum Entfernen von Content-Cards“.()
