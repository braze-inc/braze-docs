...
]({% image_buster /assets/img/sms_segment_pic.png %}){: style="border:0;"}]({% image_buster /assets/img/sms_segment_pic.png %})
...
Ihr [Dashboard für die Nutzung von Nachrichten]({{site.baseurl}}/message_usage_dashboard/) spiegelt diese Abrechnungsarten wider und zeigt die Anzahl der Segmente an, die für Nachrichten in den USA verwendet wurden, so dass Sie einen transparenten Überblick über den Verbrauch Ihres Nachrichten-Guthabens erhalten.