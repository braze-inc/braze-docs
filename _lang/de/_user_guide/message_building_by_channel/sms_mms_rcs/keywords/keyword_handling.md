...
]({% image_buster /assets/img/sms/canvas_trigger.png %})Aktionsbasierter Canvas-Schritt mit dem Auslöser Eingehende SMS an die Abo-Gruppe "Messaging Service" innerhalb der Schlüsselwortkategorie "Andere" senden, wenn der Nachrichtentext mit dem regulären Ausdruck "Caret-Symbol überspringen" übereinstimmt.{: style="max-width:90%;"}()

#### Kampagne

]({% image_buster /assets/img/sms/campaign_trigger.png %})Aktionsbasierte Kampagne mit dem Trigger Eingehende SMS an die Abo-Gruppe "Marketing Message Service A" innerhalb der Keyword-Kategorie "Andere" senden, wobei der Nachrichtentext "Keyword1" oder "Keyword2" oder nicht "Keyword A" ist.{: style="max-width:90%;"}()
...
\![Aktionsbasiertes Senden für eine Kampagne mit dem Trigger "Eingehende SMS an Abo-Gruppe innerhalb der Stichwortkategorie "Sonstige" gesendet".]({% image_buster /assets/img/sms/sms_other.png %})
