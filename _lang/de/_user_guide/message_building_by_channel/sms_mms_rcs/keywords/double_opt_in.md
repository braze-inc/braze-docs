...
]({% image_buster /assets/img/double_opt_in_fields.png %})Die konfigurierbaren Felder haben zwei Abschnitte, Opt-in-Anfrage und doppelte Opt-in-Bestätigung, jeweils mit den Feldern Schlüsselwörter und Antwortnachricht.()
