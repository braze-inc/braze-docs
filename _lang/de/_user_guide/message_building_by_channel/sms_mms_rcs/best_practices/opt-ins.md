...
]({% image_buster /assets/img_archive/dnd_iam_phone_capture_select.png %})In-App-Nachricht-Editor mit einem Template für die Erfassung von Telefonnummern.{: style="max-width:80%;"}()
