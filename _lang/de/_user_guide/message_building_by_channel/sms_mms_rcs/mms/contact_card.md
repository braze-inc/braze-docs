...
> Kontaktkarten (auch bekannt als vCard oder Virtual Contact Files (VCF)) sind ein standardisiertes Dateiformat zum Versenden von Geschäfts- und Kontaktinformationen, die Sie problemlos in Adressbücher oder Kontaktverzeichnisse importieren können. 

{% alert note %}
Das Versenden einer Kontaktkarte wird als MMS berechnet. Bitte überprüfen Sie das voraussichtliche MMS-Volumen und die Nutzung des Nachrichtenguthabens, wenn Sie Kontaktkarten erstellen, und bestätigen Sie die Kosten auf Ihrer Braze[-Abrechnungsseite]({{site.baseurl}}/user_guide/administrative/app_settings/subscription_and_usage/).
{% endalert %}
...
![Das Tab „Kontaktkartengenerator“.]({% image_buster /assets/img/sms/contact_card1.png %}){: style="max-width:60%" }
