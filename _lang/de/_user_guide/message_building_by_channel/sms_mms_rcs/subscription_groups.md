...
]({% image_buster /assets/img/sms/sms_subgroup_select.png %})SMS-Editor mit geöffnetem Abo-Gruppen-Dropdown und der Markierung "Messaging Dienst A für SMS" durch den Nutzer:innen.()
...
]({% image_buster /assets/img/sms/user_update_object.png %})"User Update Object", das den zuvor angegebenen JSON Code enthält.()
