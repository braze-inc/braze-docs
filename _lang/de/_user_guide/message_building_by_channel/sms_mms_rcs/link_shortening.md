...
]({% image_buster /assets/img/link_shortening/shortening1.png %})Nachrichten-Editor mit einem Umschalter zum Verkürzen von Links.()
...
]({% image_buster /assets/img/link_shortening/shortening3.png %})Nachrichten-Editor mit einer langen URL im Feld "Nachricht" und einem generierten verkürzten Link in der Vorschau.()
...
]({% image_buster /assets/img/link_shortening/shortening2.png %})Tab "Test" für Nachrichten mit Feldern zum Auswählen von Testempfängern.()
...
]({% image_buster /assets/img/link_shortening/shortening4.png %})Tabelle mit Metriken zur SMS- und MMS-Performance.()
