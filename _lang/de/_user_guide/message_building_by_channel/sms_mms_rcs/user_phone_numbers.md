...
]({% image_buster /assets/img/sms/e164.png %})Beispiel einer gültigen internationalen e164-Telefonnummer.{: style="max-width:50%;border: 0;"}()
...
]({% image_buster /assets/img/sms/invalid_banner.png %})Beispiel einer Fehlermeldung für ungültige Telefonnummern in Braze.{: style="max-width:50%;border: 0;"}()
