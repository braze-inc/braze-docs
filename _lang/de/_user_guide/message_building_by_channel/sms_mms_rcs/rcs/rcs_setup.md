...
Nachdem Sie die RCS SKU(s) zu Ihrem Bestellformular hinzugefügt haben, wird Braze benachrichtigt und setzt sich mit Ihnen in Verbindung, um Ihnen Informationen zur Registrierung von RCS-Sendern zukommen zu lassen. Das Format dieser Nachrichten hängt von den Ländern ab, an die Sie RCS Nachrichten senden möchten. 
