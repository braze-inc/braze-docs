...
]({% image_buster /assets/img/sms/multi_country_subgroups.png %})SMS Payloads werden unter Verwendung des gleichen Codes wie die Telefonnummer der Zielgruppe Nutzer:innen() gesendet.
