...
]({% image_buster /assets/img/whatsapp/whatsapp1.png %})WhatsApp Partnerseite mit einem Button, um die Integration zu beginnen.{: style="max-width:70%;"}()
...
]({% image_buster /assets/img/whatsapp/instructions.png %})Anleitung zur Verbindung von Braze mit WhatsApp.{: style="max-width:50%;"}()
