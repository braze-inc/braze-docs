...
{% alert tip %}
Beachten Sie, dass Sie im [WhatsApp-Manager](https://business.facebook.com/wa/manage/phone-numbers/) unter **Telefonnummer** > **Nachrichtenlinks** eine URL oder einen QR-Code erstellen können, um einem WhatsApp-Kanal beizutreten.<br>]({% image_buster /assets/img/whatsapp/whatsapp115.png %})Editor für QR-Codes in WhatsApp.{: style="max-width:55%;"}()
{% endalert %}
...
]({% image_buster /assets/img/whatsapp/whatsapp116.png %})Aktionsbasierter Canvas-Eingangs-Schritt, der Nutzer:innen erfasst, die eine eingehende WhatsApp Nachricht senden.{: style="max-width:85%;"}()
...
]({% image_buster /assets/img/whatsapp/whatsapp117.png %})Nachrichtenschritt zum Senden einer eingehenden WhatsApp-Nachricht, bei der der Nachrichtentext "STOP" oder "KEINE NACHRICHT" lautet.{: style="max-width:85%;"}()
...
1. Erstellen Sie eine Nachrichtenvorlage mit der Schnellantwort "Keine Werbesendungen erhalten".<br>]({% image_buster /assets/img/whatsapp/whatsapp121.png %})Template für Nachrichten mit der Option "Marketing opt-out" in der Fußzeile()<br><br>]({% image_buster /assets/img/whatsapp/whatsapp122.png %})Abschnitt zur Konfiguration eines Marketing oopt-out Buttons.()<br><br>
...
]({% image_buster /assets/img/whatsapp/whatsapp_inbound_message.png %})Ein WhatsApp-Nachrichtenschritt, bei dem der Nachrichtentext "START" lautet.{: style="max-width:80%;"}()

{: start="2"}
2\. Erstellen Sie im Canvas einen Schritt **Benutzeraktualisierung ein** richten und wählen Sie für **Aktion** die Option **Erweiterter JSON-Editor**. <br><br>]({% image_buster /assets/img/whatsapp/user_update.png %})Nutzer:in Update-Schritt mit einer Aktion von "Advanced JSON Editor".()<br><br>
...
{: start="4"}
4\. Ergänzen Sie einen weiteren WhatsApp-Nachrichtenschritt. <br><br>]({% image_buster /assets/img/whatsapp/message_step.png %})Nutzer:in-Update-Schritt in einem Canvas.{: style="max-width:25%;"}()
...
]({% image_buster /assets/img/whatsapp/whatsapp_inbound_message.png %})Schritt der WhatsApp Nachricht, bei der der Nachrichtentext "START" lautet.{: style="max-width:85%;"}()

{: start="2"}
2\. Erstellen Sie in der Kampagne oder im Canvas einen Schritt Webhook-Nachricht und ändern Sie den **Anfragetext** in **Rohtext**.

]({% image_buster /assets/img/whatsapp/webhook_step.png %})Nachrichtenschritt für einen Webhook.{: style="max-width:85%;"}()
...
]({% image_buster /assets/img/whatsapp/campaigns_webhook_url.png %})Webhook-URL-Feld unter dem Abschnitt "Webhook zusammenstellen".{: style="max-width:70%;"}()
