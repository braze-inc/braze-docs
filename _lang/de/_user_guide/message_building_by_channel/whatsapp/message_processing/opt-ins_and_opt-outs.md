...
![Aktionsbasierter Canvas-Schritt zum Eingang von Nutzern, die eine eingehende WhatsApp-Nachricht senden.]({% image_buster /assets/img/whatsapp/whatsapp116.png %}){: style="max-width:85%;"}
...
![Nachrichtenschritt zum Senden einer eingehenden WhatsApp-Nachricht, deren Text „STOP“ oder „KEINE NACHRICHT“ lautet.]({% image_buster /assets/img/whatsapp/whatsapp117.png %}){: style="max-width:85%;"}
...
1. Erstellen Sie eine Nachrichtenvorlage mit der Schnellantwort "Keine Werbesendungen erhalten".<br>![Template für Nachrichten mit der Option "Keine Werbesendungen erhalten" in der Fußzeile]({% image_buster /assets/img/whatsapp/whatsapp121.png %})<br><br>![Abschnitt zur Konfiguration eines Buttons zur Abmeldung von Werbesendungen.]({% image_buster /assets/img/whatsapp/whatsapp122.png %})<br><br>
...
![WhatsApp-Nachrichtenschritt mit dem Nachrichtentext "START".]({% image_buster /assets/img/whatsapp/whatsapp_inbound_message.png %}){: style="max-width:80%;"}

{: start="2"}
2\. Erstellen Sie im Canvas einen Schritt **Benutzeraktualisierung ein** richten und wählen Sie für **Aktion** die Option **Erweiterter JSON-Editor**. <br><br>![Nutzeraktualisierung mit der Aktion "Advanced JSON Editor".]({% image_buster /assets/img/whatsapp/user_update.png %})<br><br>
...
{: start="4"}
4\. Ergänzen Sie einen weiteren WhatsApp-Nachrichtenschritt. <br><br>![Nutzeraktualisierung im Canvas.]({% image_buster /assets/img/whatsapp/message_step.png %}){: style="max-width:25%;"}
...
![WhatsApp-Nachrichtenschritt mit dem Nachrichtentext "START".]({% image_buster /assets/img/whatsapp/whatsapp_inbound_message.png %}){: style="max-width:85%;"}
...
![Das Feld "Webhook-URL" unter "Webhook erstellen".]({% image_buster /assets/img/whatsapp/campaigns_webhook_url.png %}){: style="max-width:70%;"}
...
| `Matches regex` | `STOP` | Erfasst jede Verwendung von „STOP“ in genau diesem Fall. Dies erfasst beispielsweise „STOPPEN“ und „BITTE STOPPEN“, jedoch nicht „stoppen“. |
