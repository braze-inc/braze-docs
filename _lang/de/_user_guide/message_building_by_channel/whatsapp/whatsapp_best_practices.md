...
![WhatsApp Nachricht mit einer Fußzeile, die besagt, dass Sie STOP antworten sollen, um sich von dem Kanal abzumelden]({% image_buster /assets/img/whatsapp/whatsapp_unsubscribe.png %}){: style="max-width:35%;"}
