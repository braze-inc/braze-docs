...
]({% image_buster /assets/img/whatsapp/whatsapp118.png %})Webhook-Composer mit einer Nachricht über die POST-Methode.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/whatsapp/whatsapp_json_editor.png %})Nutzer:innen Update mit einem erweiterten JSON-Editor-Schritt.{: style="max-width:90%;"}()
