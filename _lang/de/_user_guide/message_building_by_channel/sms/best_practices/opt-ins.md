...
Braze empfiehlt, dass Sie auch die [SMS-Double-Opt-In-Funktion]({{site.baseurl}}/user_guide/message_building_by_channel/sms/keywords/sms_double_opt_in/) verwenden. Diese Funktion arbeitet automatisch mit dem In-App-Formular zur Erfassung von Telefonnummern zusammen und fordert die Nutzer:innen auf, ihre Absicht zu bestätigen, nachdem sie ihre Telefonnummer über das Formular übermittelt haben.
