...
]({% image_buster /assets/img_archive/universal_links_1b.png %}){: style="max-width:75%;"}]({% image_buster /assets/img_archive/universal_links_1b.png %})
...
]({% image_buster /assets/img_archive/universal_links_1d.png %})]({% image_buster /assets/img_archive/universal_links_1d.png %})
...
]({% image_buster /assets/img/text_click_tracking_off.png %})Ein angepasstes Attribut für einen Textlink.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/button_click_tracking_off.png %})Ein angepasstes Attribut für einen Button.{: style="max-width:60%;"}()
