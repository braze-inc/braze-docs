...
]({% image_buster /assets/img/preference_center/preference_center7.png %})Möglichkeit zur Anpassung von Spalteneigenschaften wie Hintergrundfarbe, Rahmenstil, Rahmenradius und Padding.{: style="max-width:45%;"}()
