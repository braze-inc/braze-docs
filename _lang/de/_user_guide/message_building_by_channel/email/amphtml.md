...
]({% image_buster /assets/img/dynamic-content.png %})Ein Beispiel für die Google Mail-Einstellungen mit ausgewähltem Kontrollkästchen "Dynamische E-Mail aktivieren".()
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td class="no-split">Bei AMP-E-Mails ist dies die Gesamtzahl der Öffnungen für die HTML- und die Klartextversion.</td>
        </tr>
        <tr>
            <td class="no-split">Klicks gesamt</td>
            <td class="no-split">Bei AMP-E-Mails ist dies die Gesamtzahl der Klicks in der HTML- und der Klartextversion.</td>
        </tr>
        <tr>
