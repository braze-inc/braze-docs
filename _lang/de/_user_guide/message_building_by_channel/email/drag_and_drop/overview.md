...
]({% image_buster /assets/img/dnd/dnd_emailvariant.png %})Der Abschnitt "E-Mail-Varianten" mit einem Beispiel für einen E-Mail-Text.()
...
]({% image_buster /assets/img/ai_copywriter/ai_copywriter_dnd.png %})Copywriter-Button im Content-Panel neben den Stileinstellungen im Drag-and-Drop-Editor.()
{% endalert %}
...
]({% image_buster /assets/img/dnd_email_link_preview.png %})E-Mail Vorschau mit einem Button "Vorschau-Link kopieren" und kopieren Sie den generierten Link.()
...
]({% image_buster /assets/img/dnd/dnd1.png %})Automatische Breitenoption im Tab Inhalt des Drag-and-Drop-Editors.()
...
]({% image_buster /assets/img/dnd/dnd2.png %})Beispiel für die Farbüberlagerung im Drag-and-Drop-Editor.()

### Content-Padding

]({% image_buster /assets/img/dnd/dnd3.png %})Blockoptionen für den Drag-and-Drop-Editor.{: style="float:right;max-width:25%;margin-left:15px;"}()
...
]({% image_buster /assets/img/dnd/language_setting_dnd.png %})Einstellen des Werts "Sprache" für eine E-Mail.{: style="max-width:70%;"}()

### Personalisierung

]({% image_buster /assets/img/dnd/dnd4.png %})Optionen zum Hinzufügen von Personalisierungen für den Drag-and-Drop-Editor.{: style="float:right;max-width:25%;margin-left:15px;"}()
...
]({% image_buster /assets/img/dnd/dnd_template1.png %})E-Mail Drag-and-Drop-Editor Menü mit Button zum Umschalten der Textausrichtung zwischen rechts-nach-links und links-nach-rechts.{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/dnd_custom_attributes.png %})Der Abschnitt "Attribute" mit dem deaktivierten Attribut "clicktracking" für einen Link.{: style="float:right;max-width:35%;margin-left:15px;"}()
...
Alles, was außerhalb der Tags von `<head>` hinzugefügt wird, wird in Ihrer E-Mail nach dem Tag `<body>` eingefügt. Das bedeutet, dass der hinzugefügte Inhalt in der E-Mail angezeigt wird.
