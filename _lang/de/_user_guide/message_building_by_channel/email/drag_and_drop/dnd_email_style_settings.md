...
]({% image_buster /assets/img_archive/dnd_global_style_settings.png %})Abschnitt Globale Einstellungen für den E-Mail-Stil auf dem Tab Einstellungen des Drag-and-Drop-Editors.()
...
]({% image_buster /assets/img_archive/dnd_basic_styling.png %})Grundlegende Styling-Optionen, die Optionen zur Bearbeitung der Hintergrundfarben von E-Mail und Inhalt, des Standard-Schriftnamens und der Standard-Linkfarbe umfassen.() 
...
]({% image_buster /assets/img_archive/dnd_fallbacks.png %})Ein Beispiel für "Arial" als Fallback-Schriftart mit "Sans-serif" als Schriftfamilie.()
...
]({% image_buster /assets/img_archive/dnd_title_styling.png %})Titel Styling-Einstellungen für eine mittig ausgerichtete Haupt- und Nebenüberschrift.()
...
]({% image_buster /assets/img_archive/dnd_paragraph_styling.png %})Absatzstileinstellungen für Text mit 14pt Schrift.()
...
]({% image_buster /assets/img_archive/dnd_list_styling.png %})Styling-Einstellungen für eine Aufzählung.()
...
]({% image_buster /assets/img_archive/dnd_button_styling.png %})Button Styling-Einstellungen für einen rechteckigen Button mit blauem Hintergrund.()
...
]({% image_buster /assets/img_archive/dnd_email_template_width.png %})Breite des Templates für E-Mails auf 600px eingestellt.()
...
]({% image_buster /assets/img_archive/dnd_content_block_width.png %})Die Breite des Content-Blocks wurde auf 600px festgelegt.()
