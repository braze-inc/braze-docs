...
]({% image_buster /assets/img_archive/choose_email_creation.png %})Wählen Sie zwischen dem Drag-and-Drop-Editor, dem HTML-Editor oder Templates für die Bearbeitung Ihrer E-Mails.{: style="max-width:75%" }()
...
]({% image_buster /assets/img_archive/regenerate_from_html.png %})Der Button "Aus HTML neu generieren".{: style="max-width:30%;float:right;margin-left:15px;border:none;" }()
...
]({% image_buster /assets/img/email.png %})Panel für E-Mail-Varianten zum Verfassen Ihrer E-Mail.{: style="max-width:75%" }()
...
]({% image_buster /assets/img/ai_copywriter/ai_copywriter_email.png %})Button „KI-Copywriter starten“, das sich im Tab „Text“ des E-Mail-Editors befindet.{: style="max-width:80%"}()
{% endalert %}
...
]({% image_buster /assets/img_archive/newEmailTest.png %})Testen Sie die Sendeoption und die Vorschau einer Beispiel-E-Mail beim Verfassen Ihrer E-Mail.()
