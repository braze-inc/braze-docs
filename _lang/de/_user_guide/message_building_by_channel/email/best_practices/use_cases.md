---
nav_title: E-Mail Anwendungsfälle
...
![Einführungs-E-Mail von LivingSocial, die neue Benutzer willkommen heißt.][26]{: style="max-width:70%;"}
...
![Werbe-E-Mail von Ideeli, die den Nutzer über ein zeitlich begrenztes Angebot informiert. Ein großes Banner enthält den Text "Endet um Mitternacht EDT. 6-stündiger Blitzverkauf. Beeilen Sie sich! Diese erstaunlichen Funde werden nicht lange halten."][27]{: style="max-width:70%;"}
...
![Beispiel für eine soziale E-Mail von Hailo, die ihre Nutzer zur Teilnahme an einer Foto-Challenge auffordert.][30]{: style="max-width:70%;"}
