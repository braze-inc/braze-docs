...
]({% image_buster /assets/img/email_templates/template2.png %})Eine E-Mail-Vorlage für den Frühjahrsverkauf eines Unternehmens mit der Möglichkeit, den Drag-and-Drop-Editor oder den HTML-Editor auszuwählen oder aus Braze-Vorlagen auszuwählen.()
...
]({% image_buster /assets/img/dnd_compose_error.png %})Liste der Fehler und Warnungen aus einer Beispiel-E-Mail.{: style="float:right;max-width:40%;margin-left:15px;"}()
...
]({% image_buster /assets/img_archive/newEmailTest.png %})Beispiel für eine Vorschau einer E-Mail, die zu Testzwecken verschickt wird.()
...
]({% image_buster /assets/img/email_templates/template5.png %})API Bezeichner, der sich am unteren Rand eines E-Mail Templates befindet.()
...
]({% image_buster /assets/img/email_templates/template_comment.png %})Ein Kommentar zu einer E-Mail-Vorlage, der lautet "Sieht gut aus".()
