...
]({% image_buster /assets/img/link_aliasing_composer.png %})Link Management Seite mit vier Link-Aliases.()
...
]({% image_buster /assets/img/link_management_dnd.png %})Tab „Link-Management“ des Drag-and-Drop-Editors für E-Mails.()

{% endtab %}
{% tab HTML editor %}

]({% image_buster /assets/img/link_management_html.png %})Registerkarte Linkverwaltung des HTML-E-Mail-Editors.()
...
]({% image_buster /assets/img/link_aliasing_action_based_filters.png %})Aktionsbasierte Optionen zum Targeting von Nutzern:in, die auf einen Alias in einer Canvas-Komponente geklickt oder mit einer Kampagne interagiert haben.()
...
]({% image_buster /assets/img/link_aliasing_click_table.png %})Analytics Tab für Kampagnen, der drei Link-Aliasing und die Gesamtzahl der Klicks anzeigt.()
