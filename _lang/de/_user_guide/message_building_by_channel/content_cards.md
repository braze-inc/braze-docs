...
]({% image_buster /assets/img_archive/cc_placements.png %})3 Beispiel-Content-Cards, die die verschiedenen Platzierungsoptionen zeigen: Posteingang, Karussell und Banner.{: style="border:0px;"}()

### Posteingang für Nachrichten

]({% image_buster /assets/img_archive/cc_placement_inbox.png %})Ein Beispiel für eine Inhaltskarte mit der Platzierung "Nachrichteneingang".{: style="float:right;margin-left:15px;max-width:30%;border:0px;"}()
...
]({% image_buster /assets/img_archive/cc_politer_carousel.png %})Ein Beispiel für eine Content-Card, die die „Karussell“-Platzierung verwendet.{: style="float:right;margin-left:15px;max-width:30%;border:0px;"}()
