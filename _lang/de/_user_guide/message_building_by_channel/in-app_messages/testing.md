...
]({% image_buster /assets/img/iam-generations.gif %})Switching between generations when previewing an in-app message.{: height="50%" width="50%"}()
...
Tab Testen beim Erstellen einer In-App-Nachricht. "Vorschau der Nachricht als Nutzer:in" ist auf "Angepasster Nutzer" eingestellt, wobei die verfügbaren Felder des Profils als konfigurierbare Optionen erscheinen.]({% image_buster /assets/img/iam-user-preview.png %})
...
]({% image_buster /assets/img/Accessibilty_Scanner_IAM.png %})Accessibility scan results()
