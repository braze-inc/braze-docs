...
]({% image_buster /assets/img/iam/iam-survey2.png %})Tab des einfachen Umfragen-Editors mit Feldern für eine Überschrift, einen optionalen Hauptteil und einen optionalen Hilfstext.{: style="max-width:90%"}()
...
]({% image_buster /assets/img/iam/collect-attributes.png %})Wählen Sie das Dropdown-Menü mit der Auswahl "Attribute bei der Einreichung protokollieren".{: style="max-width:60%"}()
...
]({% image_buster /assets/img/iam/confirmation-option.png %})On-Click-Verhalten auf "Antworten einreichen und Bestätigungsseite anzeigen" eingestellt.{: style="max-width:60%"}()
...
Registerkarte Bestätigungsseite des einfachen Umfrage-Editors. Die verfügbaren Felder sind Überschrift, optionaler Textkörper, Button-Text und das On-Click-Verhalten des Buttons.]({% image_buster /assets/img/iam/confirmation-page.png %})({: style="max-width:90%"})
...
]({% image_buster /assets/img/iam/color-theme-picker.png %})Tab des einfachen Umfragen-Editors mit der erweiterten Farbauswahl, nachdem ein:e Nutzer:in auf die Farbpalette geklickt hat.{: style="max-width:80%"}()
