...
article_title: Drag-and-Drop-Editor für In-App-Nachrichten
alias: /iam_drag_and_drop/
page_order: 2
layout: dev_guide
guide_top_header: "Drag-and-Drop-Editor für In-App-Nachrichten"
description: "Auf dieser Landing Page finden Sie alles rund um das Thema Drag-and-Drop von In-App-Nachrichten, z. B. wie Sie eine In-App-Nachricht mit dem Drag-and-Drop-Editor erstellen können und eine Erklärung zu den Editorblöcken."
guide_top_text: "Der Drag-and-Drop-Editor erleichtert die Erstellung von In-App-Nachrichten in Braze. Mit der Drag-and-Drop-Bearbeitungsfunktion können Sie völlig benutzerdefinierte und personalisierte In-App-Nachrichten für mobile Apps und Webbrowser erstellen, ohne HTML zu verwenden."
...
- name: E-Mail-Registrierung mit Sonderangebot
...
- name: E-Mail-Registrierung mit Hintergrundbild
...
- name: E-Mail-Registrierung mit Bestätigungsseite
