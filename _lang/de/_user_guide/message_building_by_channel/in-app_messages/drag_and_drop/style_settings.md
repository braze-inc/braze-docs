...
]({% image_buster /assets/img_archive/dnd_iam_message_styles.png %})Tab "Nachrichtenstile".{: style="float:right;max-width:25%;margin-left:15px;max-width:30%"}()
...
]({% image_buster /assets/img_archive/dnd_iam_create.gif %})Ein GIF, das zeigt, wie eine In-App-Nachricht zu Werbezwecken erstellt wird.()
...
\![Option, die angezeigt wird, wenn Sie Text in einer In-App-Nachricht hervorheben. Ein kleines Pinselsymbol zeigt an, dass Sie mit der Spanne für den Stil umbrechen können.]({% image_buster /assets/img_archive/span_1.png %}){: style="max-width:40%"}
...
]({% image_buster /assets/img_archive/dnd_iam_rows.png %})Zeilen, die Sie in Ihrer In-App-Nachricht hinzufügen können.{: style="max-width:40%"}()
...
]({% image_buster /assets/img_archive/dnd_iam_column_customization.gif %})Anpassen von Spalten aus dem Bereich "Spaltenanpassung".{: style="max-width:40%"}()
...
]({% image_buster /assets/img_archive/dnd_iam_editor_blocks.png %})Drag-and-Drop-Boxen zum Auswählen.{: style="max-width:40%"}()
...
]({% image_buster /assets/img_archive/dnd_iam_fullscreen_example.png %})Beispiel für eine In-App-Nachricht im Vollbildmodus.{: style="border:none"}()
...
]({% image_buster /assets/img_archive/dnd_iam_liquid.png %})Symbol zum Hinzufügen der Personalisierung von Liquid.{: style="float:right;max-width:25%;margin-left:15px"}()
...
Als Nächstes nehmen Sie Ihr generiertes Liquid-Snippet und fügen es in Ihre Nachricht ein. Nachdem Sie Ihre In-App-Nachricht entworfen und erstellt haben, gehen Sie zu **Vorschau & Test**, um eine Vorschau Ihrer Nachricht anzuzeigen.
...
]({% image_buster /assets/img_archive/dnd_iam_ai_copywriter.gif %})GIF des KI-Werbetexters.()
...
]({% image_buster /assets/img_archive/dnd_iam_reset_styles.gif %})Oranger Punkt, der eine Textgröße auf die Standardgröße zurücksetzt.{: style="max-width:45%"}()
...
]({% image_buster /assets/img_archive/dnd_iam_copypaste_styles.png %})Dropdown-Menü mit der Möglichkeit, Stile zu kopieren.{: style="float:right;margin-left:15px;max-width:35%"}()
