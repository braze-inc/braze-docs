...
]({% image_buster /assets/img/drag_and_drop/templates/email_capture_image.png %})Der In-App-Nachricht-Editor mit dem Template für ein E-Mail-Registrierungsformular mit einem Hintergrundbild.()
...
]({% image_buster /assets/img/drag_and_drop/templates/email_capture_field_image.png %})Der In-App-Nachricht-Editor mit einem Seitenmenü zum Anpassen des Elements für die E-Mail-Erfassung.()
