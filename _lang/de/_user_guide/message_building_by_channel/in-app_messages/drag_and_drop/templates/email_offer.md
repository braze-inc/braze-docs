...
]({% image_buster /assets/img/drag_and_drop/templates/email_capture_offer.png %})Der Editor für In-App-Nachrichten mit dem Template für eine E-Mail-Registrierung mit einem Sonderangebot.()
...
]({% image_buster /assets/img/drag_and_drop/templates/email_capture_field_offer.png %})Der In-App-Nachricht-Editor mit einem Seitenmenü zum Anpassen des Elements für die E-Mail-Erfassung.()
