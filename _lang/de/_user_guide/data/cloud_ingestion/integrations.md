...
- **BigQuery Job Benutzer:** Dadurch erhält Braze Zugriff auf die Ausführung von Aufträgen
...
3. Geben Sie einen Namen ein, und wählen Sie dann `Accounts in this organizational directory only` als unterstützten Kontotyp aus. Wählen Sie dann **Register**. 
4. Wählen Sie die Anwendung (Dienstprinzipal) aus, die Sie gerade erstellt haben, und navigieren Sie dann zu **Zertifikate & Geheimnisse** > **\+ Neues Client-Geheimnis**.
