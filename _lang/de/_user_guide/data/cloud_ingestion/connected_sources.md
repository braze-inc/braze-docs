...
Nachdem Sie eine verbundene Quelle zu Ihrem Braze Workspace hinzugefügt haben, können Sie ein CDI-Segment innerhalb der Segment-Erweiterungen erstellen. Mit CDI Segmenten können Sie SQL-Anfragen direkt an Ihr Data Warehouse stellen (unter Verwendung von Daten, die dort über Ihre CDI Connected Source zur Verfügung gestellt werden) und eine Gruppe von Nutzer:innen erstellen und pflegen, die innerhalb von Braze zielgerichtet zusammengestellt werden können. 
...
{% alert warning %}
Da die angeschlossenen Quellen direkt auf Ihrem Data Warehouse laufen, entstehen Ihnen alle Kosten, die mit der Ausführung dieser Abfragen in Ihrem Data Warehouse verbunden sind. Verbundene Quellen verbrauchen keine Datenpunkte, und CDI Segmente verbrauchen keine SQL-Segmentierungen.
{% endalert %}
...
Für die Instanzen `US-01`, `US-02`, `US-03`, `US-04`, `US-05`, `US-06`, `US-07`, sind dies die entsprechenden IP-Adressen:
- `23.21.118.191`
- `34.206.23.173`
- `50.16.249.9`
- `52.4.160.214`
...
{% endsubtab %}
{% subtab Australia (AU) %}
Für die Instanz `AU-01` sind dies die entsprechenden IP-Adressen:
- `13.210.1.145`
- `13.211.70.159`
- `13.238.45.54`
- `52.65.73.167`
...
Nachdem die Quelle erstellt wurde, können Sie sie verwenden, um ein oder mehrere CDI Segmente zu erstellen. Weitere Informationen zur Erstellung eines Segmente mit dieser Quelle finden Sie in der [Dokumentation zu CDI Segmente]({{site.baseurl}}/user_guide/engagement_tools/segments/segment_extension/cdi_segments/).
