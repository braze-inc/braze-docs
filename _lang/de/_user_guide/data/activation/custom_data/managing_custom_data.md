...
]({% image_buster /assets/img_archive/manageproperties1.png %})Angepasste Eigenschaften für ein angepasstes Event.{: style="max-width:80%"}()
...
]({% image_buster /assets/img_archive/blocklist_custom_attr.png %})Mehrere ausgewählte angepasste Attribute, die auf der Seite "Angepasste Attribute" in einer Blockliste aufgeführt sind.()
...
]({% image_buster /assets/img_archive/custom_events_view_data_type_dropdown.png %})Angepasste Attribute Datentyp Dropdown()
