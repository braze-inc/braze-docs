...
]({% image_buster /assets/img/purchase_filter_example.gif %})Filter für Nutzer:innen, die genau drei Käufe getätigt haben{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/purchase2.png %})Einstellungen für aktionsbasierte Zustellung, um eine Kampagne an Nutzer:innen zu senden, die einen Kopfhörer mit dem Markennamen HeadphoneMart{: style="max-width:80%;margin-left:15px;"}() kaufen.
...
]({% image_buster /assets/img/nested_object3.png %}){: style="max-width:80%;margin-left:15px;"}]({% image_buster /assets/img/nested_object3.png %})
