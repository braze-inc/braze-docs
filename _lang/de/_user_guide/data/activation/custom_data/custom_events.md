...
]({% image_buster /assets/img_archive/custom_event_analytics_example.png %} "custom_event_analytics_example.png")Diagramm zur Anzahl angepasster Events auf der Seite "Angepasste Events" im Dashboard mit Trends bei angepassten Events
...
]({% image_buster /assets/img/custom_events_report_filters.png %})Angepasste Event-Filter{: style="max-width:40%;"}()
...
]({% image_buster /assets/img/nested_object3.png %})Eine Filter-Gruppe, die 'Warenkorb-Abbruch' mit der Eigenschaft 'Anzahl der Itemes' und dem Wert 2 mehr als 1 Mal in den letzten 30 Kalendertagen hat.()
