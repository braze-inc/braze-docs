...
]({% image_buster /assets/img_archive/catalog_CSV_upload.png %}){: style="max-width:80%;"}]({% image_buster /assets/img_archive/catalog_CSV_upload.png %})
...
]({% image_buster /assets/img_archive/catalog_data_type.png %}){: style="max-width:80%;"}]({% image_buster /assets/img_archive/catalog_data_type.png %})
...
]({% image_buster /assets/img_archive/add_catalog_fields.png %})Zwei Beispielfelder "Bewertung" und "Name".{: style="max-width:50%;"}()
...
]({% image_buster /assets/img_archive/add_catalog_items.png %})Fügen Sie einen Katalogartikel hinzu.{: style="max-width:50%;"}()
