...
]({% image_buster /assets/img_archive/use_catalog_personalization.png %})]({% image_buster /assets/img_archive/use_catalog_personalization.png %})
...
]({% image_buster /assets/img_archive/catalog_multiple_items.png %}){: style="max-width:70%" }]({% image_buster /assets/img_archive/catalog_multiple_items.png %})
...
]({% image_buster /assets/img_archive/catalog_image_link1.png %})Content-Card-Composer mit dem Liquid-Tag des Katalogs, der im Bildfeld verwendet wird.()

So sieht das aus, wenn das Liquid gerendert wird:

]({% image_buster /assets/img_archive/catalog_image_link2.png %})Beispiel Content-Card mit gerenderten Liquid-Tags.{: style="max-width:50%" }()
...
]({% image_buster /assets/img_archive/catalog_liquid_templating.png %}){: style="max-width:80%;"}]({% image_buster /assets/img_archive/catalog_liquid_templating.png %})
