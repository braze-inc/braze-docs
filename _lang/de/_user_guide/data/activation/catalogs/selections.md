...
]({% image_buster /assets/img_archive/catalog_selections1.png %})Der Abschnitt Auswahlen in einem Beispielkatalog.()
...
]({% image_buster /assets/img_archive/catalog_selections7.png %})Filtereinstellungen für die Katalogauswahl, bei denen das Attribut auf ein angepasstes Liquid Attribut gesetzt ist.()
...
]({% image_buster /assets/img_archive/catalog_selections4.png %})Eine Content-Card mit einem Bild von gegrilltem Zitronenhähnchen und einer Liste von drei Essensempfehlungen, die Hähnchen enthalten, basierend auf der zuletzt angesehenen Kategorie des Nutzers.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img_archive/catalog_selections5.png %})Eine Content-Card mit einem Bild von Beef Stroganoff und einer Liste von zwei Essensempfehlungen, die Rindfleisch enthalten, basierend auf der vom Nutzer:innen zuletzt angesehenen Kategorie.{: style="max-width:90%;"}()
