...
![Zeitspanne und App-Felder im Home-Dashboard.]({% image_buster /assets/img_archive/home_dashboard_select_date.png %}){: style="max-width:60%;"}
...
![Diagramm "Leistung im Zeitverlauf" im Home-Dashboard.]({% image_buster /assets/img_archive/home_dashboard_export.png %})
