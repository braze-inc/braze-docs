...
]({% image_buster /assets/img/message_engagement_event.png %})Aufschlüsselung eines Nachrichten-Engagements mit einem E-Mail-Abmelde-Ereignis mit den aufgeführten Eigenschaften, gruppiert nach benutzerspezifischen Eigenschaften, Kampagnen- oder Canvas-Tracking-Eigenschaften und ereignisspezifischen Eigenschaften()
...
{% api %}
## Banner Impressionen Ereignisse
...
{% api %}
## In-App-Nachricht Abbruch-Ereignisse
...
{% api %}
## Ereignisse abbrechen {#abort-events}
...
{% api %}
## Live-Aktivitäten Ergebnisse Ereignisse
...
{% api %}
## Live-Aktivität Ereignisse senden

{% apitags %}
Live-Aktivität, Sendungen
{% endapitags %}

Dieses Ereignis tritt ein, wenn das Backend von Braze eine Anfrage an seinen Provider bezüglich der Live-Aktivität stellt
...
{% api %}
## Ereignisse der Zustellung {#delivery-events}
...
{% api %}
## Eingehende Empfangsereignisse {#inbound-receive-events}
...
{% api %}
## Ablehnende Ereignisse {#rejection-events}
...
{% api %}
## WhatsApp Tracking Link Klick-Ereignisse
...
{% apitags %}
Eingehende WhatsApp-Nachricht empfangen
{% endapitags %}
