...
]({% image_buster /assets/img/customer_engagement_event.png %})Aufschlüsselung eines Benutzerereignisses, das ein Kaufereignis mit den aufgelisteten Eigenschaften gruppiert nach benutzerspezifischen Eigenschaften, verhaltensspezifischen Eigenschaften und gerätespezifischen Eigenschaften zeigt()
...
{% api %}
## Live Activity Push To Start Token Change Ereignisse
...
{% api %}
## Live Activity Update Token Änderungsereignisse
...
{% api %}
## Push-Benachrichtigung Token Zustandsänderung Ereignisse
