...
]({% image_buster /assets/img/aws-properties.png %})AWS Tab Eigenschaften{: height="50%" width="50%"}()
...
]({% image_buster /assets/img/aws-events.png %})Erstellen eines neuen Ereignisses in AWS{: height="50%" width="50%"}()
