...
# [![Braze-Lernkurs]](https://learning.braze.com/currents-the-basics-2/) ( [{% image_buster /assets/img/bl_icon3.png %})](https://learning.braze.com/currents-the-basics-2/){: style="float:right;width:120px;border:0;" class="noimgborder"}Currents einrichten
...
Gehen Sie zu **Partnerintegrationen** > Datenexport, um damit zu beginnen. Sie gelangen auf die Seite zur Verwaltung der Currents-Integration.
...
Fügen Sie einen Partner hinzu, der manchmal auch als "Currents Konnektor" bezeichnet wird, indem Sie die Dropdown-Liste oben auf dem Bildschirm auswählen.
...
### Schritt 4: Konfigurieren Sie Ihre Ereignisse
...
Bei Bedarf erfahren Sie mehr über unsere Ereignisse in unserem Artikel [zur Semantik der Zustellung von Ereign]({{site.baseurl}}/user_guide/data/braze_currents/event_delivery_semantics/) issen.
...
Sie können Ihre Integration testen oder sich die Currents-Beispieldaten in unserem [GitHub-Repository für](https://github.com/Appboy/currents-examples) Currents-Beispiele ansehen.

{% alert important %}
Currents verwirft Ereignisse mit übermäßig großen Nutzdaten von mehr als 900 KB.
{% endalert %}

#### Currents Konnektoren testen

Test Currents Konnektoren sind kostenlose Versionen unserer bestehenden Konnektoren, die Sie zum Testen und Ausprobieren verschiedener Ziele verwenden können. Test Currents haben:

- Die Anzahl der Test Currents Konnektoren, die Sie bauen können, ist unbegrenzt.
- Insgesamt maximal 10.000 Ereignisse pro rollierendem Siebentageszeitraum. Diese Ereignissumme wird stündlich auf dem Dashboard aktualisiert.

Wenn Ihre Test Currents Konnektoren die Sendegrenze erreicht haben, sendet Ihr Konnektor bis zum nächsten Sieben-Tage-Zeitraum keine Ereignisse mehr.
