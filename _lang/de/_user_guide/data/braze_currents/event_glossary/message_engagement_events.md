...
## WhatsApp Nachrichten-Ereignisse abbrechen

{% apitags %}
WhatsApp, Abbrechen
{% endapitags %}

Dieses Ereignis tritt ein, wenn eine WhatsApp Nachricht aufgrund von Liquid-Abbrüchen, Ruhezeiten usw. abgebrochen wurde.
...
## Content-Card Abbruch von Nachrichten-Ereignissen

{% apitags %}
Abbruch, Content-Cards
{% endapitags %}

Dieses Ereignis tritt ein, wenn eine Content-Card Nachricht aufgrund von Liquid-Abbrüchen, Ruhezeiten, etc. abgebrochen wurde.
...
## Abbruch von Nachrichten per E-Mail

{% apitags %}
Abbrechen, E-Mail
{% endapitags %}

Dieses Ereignis tritt ein, wenn eine E-Mail Nachricht aufgrund von Liquid-Abbrüchen, Ruhezeiten usw. abgebrochen wurde.
...
Dieses Ereignis tritt ein, wenn eine Push-Benachrichtigung aufgrund von Liquid-Abbrüchen, Ruhezeiten, etc. abgebrochen wurde.
...
## SMS-Abbruch von Nachrichtenereignissen

{% apitags %}
Abbrechen, SMS
{% endapitags %}

Dieses Ereignis tritt ein, wenn eine SMS Nachricht aufgrund von Liquid-Abbrüchen, Ruhezeiten, etc. abgebrochen wurde.
...
## Webhook Abbruch von Nachrichten-Ereignissen

{% apitags %}
Abbrechen, Webhooks
{% endapitags %}

Dieses Ereignis tritt ein, wenn eine Webhook Nachricht aufgrund von Liquid Abbrüchen oder Ruhezeiten abgebrochen wurde.
...
## Canvas beenden Performance-Ereignisse
...
## Canvas Ausgang abgestimmt auf die Zielgruppe
...
{% api %}
## Experiment geteilter Eingang Ereignisse
...
- Für `ad_id`, `ad_id_type` und `ad_tracking_enabled` müssen Sie die iOS Identifier for Advertisers (IDFA) und Android Google Advertising ID explizit über die nativen SDKs erfassen. Erfahren Sie mehr über diese Einrichtung für [iOS]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/analytics/swift_idfv/) und [Android]({{site.baseurl}}/developer_guide/platform_integration_guides/android/initial_sdk_setup/optional_gaid_collection/#optional-google-advertising-id).
...
## Push-Benachrichtigungen in den iOS-Ereignissen im Vordergrund
...
## Push-Benachrichtigungen prallen ab
...
## Ereignisse zum Senden von E-Mails
...
## Ereignisse der E-Mail-Zustellung
...
{% alert note %}
Das Feld `message_extras` wird am 4. April 2024 aktiv sein.
{% endalert %}
...
{% api %}
## Content-Card Impressionen Ereignisse
...
{% api %}
## Content-Card-Ausblendung Ereignisse
...
## SMS-Sendungen an Träger-Ereignisse
...
## Ereignisse bei der SMS-Zustellung
...
## Feature-Flags Impressions-Ereignisse
...
## Canvas-Schritt-Verlaufsereignisse
...
{% api %}
## Einschreibungsereignisse der Kontrollgruppe der Kampagne
...
## Globale Zustandsänderungsereignisse
