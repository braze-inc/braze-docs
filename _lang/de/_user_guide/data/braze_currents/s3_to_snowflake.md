...
![AWS Eigenschaften Tab][1]{: height="50%" width="50%"}
...
![Erstellen eines neuen Ereignisses in AWS][2]{: height="50%" width="50%"}
...
{% tabs %}
  {% tab Nutzer:in Ereignisse des Benutzerverhaltens %}
