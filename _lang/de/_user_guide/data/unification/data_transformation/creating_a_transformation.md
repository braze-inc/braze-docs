...
]({% image_buster /assets/img/data_transformation/data_transformation8.png %})]({% image_buster /assets/img/data_transformation/data_transformation8.png %})
...
]({% image_buster /assets/img/data_transformation/data_transformation11.png %})Beispiel für einen Code zur Datentransformation, der den Webhook auf Braze-Nutzerprofile abbildet.()
...
]({% image_buster /assets/img/data_transformation/data_transformation3.png %})]({% image_buster /assets/img/data_transformation/data_transformation3.png %})
{% endalert %}
