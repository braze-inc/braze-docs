...
]({% image_buster /assets/img_archive/Braze_User_aliases.png %})Zwei unterschiedliche Nutzerprofile für verschiedene Nutzer:innen mit demselben Nutzer-Alias-Label, aber unterschiedlichen Alias-Namen()
