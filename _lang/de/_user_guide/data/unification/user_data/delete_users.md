...
| Wartezeit | Für alle Segmente, die gelöscht werden, gilt eine Wartezeit von 7 Tagen zuzüglich der Zeit, die für die Bearbeitung der Löschungen benötigt wird. |
...
Wenn Sie eine Anfrage zur Löschung eines Segments von Nutzer:innen stellen, wird automatisch ein [Segment-Filter]({{site.baseurl}}/user_guide/engagement_tools/segments/managing_segments/#filters) mit der Bezeichnung **Ausstehende Löschung** erstellt. Sie können es verwenden, um:
...
| Feld | Beschreibung |
|-------|-------------|
| Anfragedatum | Das Datum, an dem die Anfrage ursprünglich gestellt wurde. Verwenden Sie ihn zusammen mit dem Filter **Ausstehende Löschung**, um die Liste der Profile zu erhalten, die zur Löschung anstehen. |
