...
]({% image_buster /assets/img/cloud_ingestion/s3_ARN.png %})Auswählen von "Erweitert" mit einem JSON-Beispielobjekt, um festzulegen, wer auf eine Warteschlange zugreifen darf.()
...
1. Gehen Sie zum Abschnitt IAM der AWS Konsole, wählen Sie in der Navigationsleiste **Richtlinien** aus und wählen Sie dann **Richtlinie erstellen**.<br><br>]({% image_buster /assets/img/create_policy_1_list.png %})Der Button "Richtlinie erstellen" in der AWS-Konsole.()<br><br>
...
]({% image_buster /assets/img/create_policy_3_name.png %})Eine Beispielrichtlinie mit dem Namen "new-policy-name".()

]({% image_buster /assets/img/create_policy_4_created.png %})Das Beschreibungsfeld für die Richtlinie.()
...
<br><br>]({% image_buster /assets/img/create_role_1_list.png %})Der Button "Rolle erstellen".()<br><br>
...
<br><br>]({% image_buster /assets/img/create_role_3_attach.png %})Rollen-ARN mit ausgewähltem new-policy-name.()<br><br>

Geben Sie der Rolle einen Namen und eine Beschreibung, und wählen Sie **Rolle erstellen**.

<br><br>]({% image_buster /assets/img/create_role_4_name.png %})Eine Beispielrolle mit dem Namen "new-role-name".()<br><br>
...
]({% image_buster /assets/img/cloud_ingestion/s3_ingestion_1.png %})Beispiel für Sicherheits-Zugangsdaten, wie sie in S3 angezeigt werden, um eine neue Importsynchronisation zu erstellen.()

{: start="3"}
3\. Benennen Sie Ihre Integration und wählen Sie den Datentyp für diese Integration aus. 

<br><br>]({% image_buster /assets/img/cloud_ingestion/s3_ingestion_2.png %})Einrichten von Synchronisierungsdetails für "cdi-s3-as-source-integration" mit Nutzer:in-Attributen als Datentyp.()<br><br>
...
<br><br> ]({% image_buster /assets/img/cloud_ingestion/s3_ingestion_3.png %})Einrichten von Benachrichtigungseinstellungen für Synchronisationsfehler-Benachrichtigungen.()<br><br>

{: start="5"}
5\. Testen Sie schließlich die Verbindung und speichern Sie die Synchronisierung. 

<br><br>]({% image_buster /assets/img/cloud_ingestion/s3_ingestion_4.png %})Eine Option zum Testen der Verbindung mit einer Vorschau der Daten.()
