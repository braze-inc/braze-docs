...
Auf die Formeln können Sie in den Statistik-Panels auf den Seiten [Home][9], [Umsatzbericht][10] und [Bericht über angepasste Events][11] im Dashboard zugreifen. Um dieses Panel anzuzeigen, gehen Sie zum Chart **Performance im Zeitverlauf**, ändern Sie die Dropdown-Liste **Statistik für** in **KPI-Formeln** und wählen Sie dann mindestens eine KPI-Formel aus, um das Chart zu füllen.

![Statistiken für KPI-Formeln im Braze-Dashboard anzeigen][16]
...
|  | DAU |
|  | Segmentgröße (nur Segmente, für die [Analytics-Tracking][17] aktiviert ist, können verwendet werden) |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
