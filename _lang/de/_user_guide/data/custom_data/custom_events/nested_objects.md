...
Um diese Eigenschaften zum Triggern einer Kampagne zu verwenden, wählen Sie Ihr angepasstes Event oder Ihren Kauf aus und fügen dann einen Filter für **verschachtelte Eigenschaften** hinzu. Beachten Sie, dass das Triggern von Nachrichten für In-App-Nachrichten noch nicht unterstützt wird, aber verschachtelte Eigenschaften in der Personalisierung von Liquid in den Nachrichten werden trotzdem angezeigt.
...
![Ein Nutzer:in, der die Eigenschaft filter r_details.name ist McDonalds für ein angepasstes Event.]({% image_buster /assets/img/nested_object1.png %})
...
Die Art und Weise, wie wir Datenpunkte abrechnen, ändert sich durch die Hinzufügung dieser Funktion nicht. Bei der Segmentierung auf der Grundlage verschachtelter Objekte werden Segment-Erweiterungen verwendet, die keine zusätzliche Datenpunkt-Nutzung mit sich bringen.
