...
![Content-Card-Composer mit dem Liquid-Tag des Katalogs, der im Bildfeld verwendet wird.][3]

So sieht das aus, wenn das Liquid gerendert wird:

![Beispiel Content-Card mit gerenderten Liquid-Tags.][4]{: style="max-width:50%" }
