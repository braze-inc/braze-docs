...
]({% image_buster /assets/img/liquid_color_code.png %})]({% image_buster /assets/img/liquid_color_code.png %})
...
]({% image_buster /assets/img/liquid_auto_complete.gif %}){: style="max-width:70%;"}]({% image_buster /assets/img/liquid_auto_complete.gif %})
