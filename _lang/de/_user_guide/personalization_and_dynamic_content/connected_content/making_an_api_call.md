...
]({% image_buster /assets/img/connected_content/basic_auth_mgmt.png %})Die Einstellungen für 'Connected-Content' im Braze-Dashboard.()
...
]({% image_buster /assets/img/connected_content/basic_auth_token.png %})Das Fenster 'Neue Zugangsdaten erstellen' mit der Möglichkeit, einen Namen, einen Benutzernamen und ein Passwort einzugeben.{: style="max-width:60%"}()
