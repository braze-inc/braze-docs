...
]({% image_buster /assets/img/samlsso.png %})SAML SSO Einstellungen mit ausgewähltem Umschalter.()
...
]({% image_buster /assets/img/sso1.png %})Dashboard-Anmeldebildschirm mit aktiviertem SSO{: style="max-width:60%;"}()
...
4. Erweitern Sie das Dropdown-Menü **SSO** unter **Berechtigungen** und markieren Sie **sso.saml.login**.<br><br>sso.saml.loginDer Abschnitt "Berechtigungen" mit ]({% image_buster /assets/img/relaystate_troubleshoot.png %}) markiert.{: style="max-width:70%;"}()<br><br>
...
]({% image_buster /assets/img/saml_tracer_example.png %})SAML-Tracer für Google Chrome.()
...
]({% image_buster /assets/img/export_saml_trace_preferences.png %})Menü "SAML-Trace-Einstellungen exportieren" mit der Auswahl "Keine".()
