...
1. Melden Sie sich bei [OneLogin](https://app.onelogin.com/login) an. Klicken Sie auf **Verwaltung**.![OneLogin-Verwaltungsseite.]({% image_buster /assets/img/onelogin_1.jpg %})<br><br>
2. Gehen Sie zu **Apps** > **Apps hinzufügen** in der oberen Navigationsleiste. Suchen Sie nach "Braze" und wählen Sie die App Braze aus.![Suchergebnisse für Braze in OneLogin.]({% image_buster /assets/img/onelogin_2.jpg %})<br><br>
