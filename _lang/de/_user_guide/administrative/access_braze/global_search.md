...
]({% image_buster /assets/img/navigation/global_search_new.png %})Suchergebnisse für den Suchbegriff "promo", zeigt Kampagnen und Artikel, die den Begriff promo enthalten, einschließlich der Seite Promotion Codes.()
...
]({% image_buster /assets/img/navigation/search_recently_opened.png %})Erweiterte Suche mit Anzeige der zuletzt geöffneten Seiten und Braze-Inhalte für den Nutzer:innen.()
...
]({% image_buster /assets/img/navigation/global_search_synonym.png %})Suchergebnisse für "Datenexport", wenn der Nutzer:in nach "Currents" gesucht hat.()
...
]({% image_buster /assets/img/navigation/show_active_draft_new.png %})Das Umschalten zwischen "Nur aktiv und Entwurf anzeigen".()
