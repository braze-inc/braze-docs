...
]({% image_buster /assets/img_archive/get_help.png %})Das Dropdown-Menü "Support" mit der Option, Hilfe zu erhalten.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img_archive/designated_support_contact.png %})Das Kontrollkästchen zum Festlegen eines Nutzers:innen als Kontaktperson für den Support.{: style="max-width:70%;"}()
...
3. Nehmen Sie eine Bildschirmaufnahme oder einen Screenshot auf, auf dem **Name**, **Status**, **Größe** und **Zeit** der Elemente zu sehen sind.<br><br>]({% image_buster /assets/img/network_xhr.png %})Der Tab "Fetch/XHR" in einem Chrome-Browser.{: style="max-width:60%;"}()
