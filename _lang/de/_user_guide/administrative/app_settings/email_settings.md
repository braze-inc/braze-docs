...
]({% image_buster /assets/img/email_settings/bcc_address.png %})BCC-Adresse auf dem Tab „E-Mail-Einstellungen“.{: style="max-width:75%;" }()
...
[]({% image_buster /assets/img/bl_icon3.png %})Braze Lernkurse{: style="float:right;width:120px;border:0;" class="noimgborder"}()](https://learning.braze.com/email-open-tracking-pixel/)
...
]({% image_buster /assets/img/open_pixel.png %})Öffnen Sie den Abschnitt "Tracking Pixel" mit den Optionen zum Verschieben für SendGrid, SparkPost oder Amazon SES.{: style="max-width:80%;" }()
...
]({% image_buster /assets/img_archive/list_unsub_img1.png %}){: style="float:right;max-width:60%;margin-left:15px;"}]({% image_buster /assets/img_archive/list_unsub_img1.png %})
...
]({% image_buster /assets/img/email_settings/email_unsub_header_workspaces.png %})Auswählen der "Nutzer:in", die abonniert oder Opt-in sind, an die Nutzer:innen gesendet werden sollen.{: style="float:right;max-width:50%;margin-left:15px;"}()
...
]({% image_buster /assets/img/email_settings/email_unsubscribe_header.png %})Option zum automatischen Einfügen einer Kopfzeile zum Abmelden von E-Mails, die an abonnierte oder Opt-in-Nutzer:in gesendet werden.()
...
]({% image_buster /assets/img/email_settings/one_click_list_unsubscribe_message_level.png %}){: style="max-width:70%;"}]({% image_buster /assets/img/email_settings/one_click_list_unsubscribe_message_level.png %})
...
]({% image_buster /assets/img/email_settings/email_unsubscribe_header_custom.png %}){: style="max-width:80%;"}]({% image_buster /assets/img/email_settings/email_unsubscribe_header_custom.png %})
...
]({% image_buster /assets/img/email_settings/test_and_seed_email_subject_line.png %}){: style="max-width:70%;"}]({% image_buster /assets/img/email_settings/test_and_seed_email_subject_line.png %})
...
]({% image_buster /assets/img/email_settings/resubscribe_users.png %}){: style="max-width:90%;" }]({% image_buster /assets/img/email_settings/resubscribe_users.png %})
...
]({% image_buster /assets/img/email_settings/custom_footer.png %})]({% image_buster /assets/img/email_settings/custom_footer.png %})
...
]({% image_buster /assets/img/email_settings/custom_unsubscribe.png %})]({% image_buster /assets/img/email_settings/custom_unsubscribe.png %})
...
]({% image_buster /assets/img/email_settings/custom_opt_in.png %})]({% image_buster /assets/img/email_settings/custom_opt_in.png %})
