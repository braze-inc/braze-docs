...
]({% image_buster /assets/img_archive/tags_add_tag.png %})Hinzufügen von Tags bei der Erstellung von Kampagnen.{: style="max-width:60%;" }()
...
]({% image_buster /assets/img_archive/tags_apply_multiple.gif %})Hinzufügen von Tags zu mehreren Kampagnen zur gleichen Zeit.()
...
]({% image_buster /assets/img_archive/tag_details_page.png %})Tags, die auf der Seite Campaign Analytics angezeigt werden.{: style="max-width:60%;" }()
...
]({% image_buster /assets/img_archive/tags_grid.png %})Tags auf der Liste der Kampagnen.()
...
]({% image_buster /assets/img_archive/tags_view.png %})Tab Tags auf der Seite Einstellungen verwalten.()
...
]({% image_buster /assets/img_archive/tag_nested.png %})Erstellen Sie einen verschachtelten Tag.{: style="max-width:70%;" }()
