...
]({% image_buster /assets/img/workspaces/workspace_create.png %})The workspace dropdown with the "Create workspace" button.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/workspaces/workspace_name.png %})"Create Workspace" modal with the name "Upon Voyage US - Staging".{: style="max-width:60%" }()
...
]({% image_buster /assets/img/workspaces/workspace_empty_state.png %})"App Settings" page for the Upon Voyage US - Staging workspace with a button for adding an app.()
...
]({% image_buster /assets/img/workspaces/workspace_add_app.png %})"Add New App to Upon Voyage US - Staging" modal with options to select app details.{: style="max-width:60%" }()
...
]({% image_buster /assets/img/workspaces/app_api_key.png %})Settings page for the Upon Voyage iOS app with fields for the API Key and SDK Endpoint.()
...
]({% image_buster /assets/img/workspaces/app_live_sdk_version.png %})"Live SDK Version" section with a field value of "5.4.0" and an icon that says a new version is available.()
...
]({% image_buster /assets/img/workspaces/workspace_favorites.png %})Workspace dropdown with the tab for "Favorite workspaces".{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/workspaces/workspace_rename.gif %})The pencil icon appearing next to the workspace name.{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/workspaces/workspace_delete.png %})The App Settings page with a button to delete a workspace and a trash can icon to delete an app.()
...
]({% image_buster /assets/img/workspaces/users_from_specific_apps_filter.png %})Segment that is targeting users from specific apps.()
