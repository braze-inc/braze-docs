...
]({% image_buster /assets/img/guidelines_create.png %})Das Fenster "Markenrichtlinie erstellen" mit Feldern zur Eingabe des Namens, der Beschreibung, der Persönlichkeit, der Ausschlüsse und des Tons.()
...
]({% image_buster /assets/img/unarchive_brand_guideline.png %})Die Seite "Markenrichtlinien" wurde nach archivierten Markenrichtlinien gefiltert.()
...
]({% image_buster /assets/img/guidelines_ai_assistant.png %})"KI-Textwerkstatt-Assistent mit "Important Alerts!!" als Markenleitfaden ausgewählt.()
