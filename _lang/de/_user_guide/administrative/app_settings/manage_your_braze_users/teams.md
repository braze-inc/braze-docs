...
]({% image_buster /assets/img/teams1.png %})Hinzufügen eines Team Tags zu einer Kampagne{: style="max-width:70%;"}()
...
]({% image_buster /assets/img_archive/archive_a_team.png %})Archivierung eines Teams, das mit einem Objekt in Braze verbunden ist{: style="max-width:70%;"}()
