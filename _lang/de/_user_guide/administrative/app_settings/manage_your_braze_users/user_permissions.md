...
| Admin des Unternehmens | Unternehmensadministratoren haben umfassendere Berechtigungen, einschließlich der Möglichkeit, Nutzer:innen des Dashboards zu löschen. Sie können jedoch nicht ihre eigenen Konten löschen und müssen sich für diese Aktion an einen anderen Unternehmensadministrator wenden. |
...
Um die aktuellen **Admin-**, **Unternehmens-** oder Arbeitsbereichsberechtigungen eines Benutzers zu bearbeiten, gehen Sie zu Einstellungen > Unternehmensbenutzer und wählen Sie den Namen des Benutzers.

]({% image_buster /assets/img/braze_permissions/selecting_a_user.png %})Die Seite "Benutzer des Unternehmens" in Braze mit einem Benutzer in den Ergebnissen.{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/braze_permissions/admin_level_permissions.png %})Die ausgewählten Nutzerdaten mit dem Kontrollkästchen "Admin" im Fokus.{: style="max-width:40%;"}()
...
]({% image_buster /assets/img/braze_permissions/workspace_level_permissions_individual.png %})Workspace-Berechtigungen werden in Braze manuell ausgewählt.()
...
]({% image_buster /assets/img/braze_permissions/workspace_level_permissions_set.png %})Workspace-Berechtigungen, die als Paket zugewiesen werden.()
...
]({% image_buster /assets/img/braze_permissions/exporting_user_permissions.png %})Die Seite "Unternehmensbenutzer" in Braze mit der Option "Benutzer exportieren" im Fokus.()
...
|Workspace|Angepasste KI-Agenten anzeigen|Nutzer:innen dürfen angepasste KI-Agenten anzeigen Dieses Feature befindet sich derzeit in der Beta-Phase.|
|Workspace|Angepasste KI-Agenten erstellen|Nutzer:innen dürfen angepasste KI-Agenten erstellen Dieses Feature befindet sich derzeit in der Beta-Phase.|
|Workspace|Angepasste KI-Agenten bearbeiten|Nutzer:innen dürfen angepasste KI-Agenten bearbeiten Dieses Feature befindet sich derzeit in der Beta-Phase.|
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
