...
]({% image_buster /assets/img_archive/notification_preferences.png %})Seite mit den Benachrichtigungseinstellungen im Braze-Dashboard()
...
]({% image_buster /assets/img_archive/company_analytics_report_new.png %})Auswählen von Ereignissen, die in den Analytics-Bericht aufgenommen werden sollen()
...
1. Wählen Sie den Slack-Kanal aus, an den die Benachrichtigungen gehen sollen, und klicken Sie auf **Eingehende Webhooks-Integration hinzufügen**.<br><br>
    ]({% image_buster /assets/img_archive/slack_f.png %})Integration von eingehenden Webhooks in Slack()<br><br>
...
2. Kopieren Sie die **Webhook-URL**.<br><br>
    ]({% image_buster /assets/img_archive/copy_url.png %})Webhook-URL kopieren()<br><br>
...
4. Wählen Sie die Benachrichtigung aus, die Sie für Slack aktivieren möchten. Wenn Sie mehrere Benachrichtigungen haben, die Sie an diesen Slack-Kanal senden möchten, können Sie den Webhook mithilfe von **Masseneintrag** zu mehreren Benachrichtigungen hinzufügen.<br><br>
    ]({% image_buster /assets/img_archive/click_edit_f.png %})Wählen Sie Slack-Benachrichtigungen aus, um{: style="max-width:60%;"} zu aktivieren ()<br><br>
