...
]({% image_buster /assets/img/security_export/credentials1.png %})Eine Übersichtsseite für eine Rolle namens "liyu-chen-test".()
...
]({% image_buster /assets/img/security_export/retrieve_access_keys.png %})Felder, die den Zugangsschlüssel und den geheimen Zugangsschlüssel enthalten.()
...
]({% image_buster /assets/img/security_export/security_event_download1.png %})Die Seite "Sicherheitsereignis-Download" mit ausgefüllten Braze-Kontos und externen IDs.()

{: start="4"}
4\. Wählen Sie **Änderungen speichern**. 

]({% image_buster /assets/img/security_export/save_changes_button.png %})Button "Änderungen speichern".{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/security_export/policies.png %})Eine Seite mit einer Liste von Richtlinien und einem Button "Richtlinie erstellen".()
...
]({% image_buster /assets/img/security_export/specify_permissions.png %})Eine Seite, auf der Sie Ihre Richtlinie überprüfen und optional Berechtigungen hinzufügen können.()

{: start="5"}
5\. Geben Sie der Richtlinie einen Namen und eine Beschreibung, und wählen Sie dann **Richtlinie erstellen**.

]({% image_buster /assets/img/security_export/review_and_create.png %})Eine Seite zur Überprüfung und Erstellung Ihrer Richtlinie.()
...
]({% image_buster /assets/img/security_export/security_event_download2.png %})Die Seite "Sicherheitsereignis-Download" mit ausgefüllten Braze-Kontos und externen IDs.()
...
]({% image_buster /assets/img/security_export/select_trusted_entity.png %})Eine Seite mit Optionen zum Auswählen eines vertrauenswürdigen Entitätstyps und zur Angabe von Informationen über Ihr AWS-Konto.()
...
]({% image_buster /assets/img/security_export/add_permissions.png %})Eine Liste von Richtlinien mit Spalten für deren Typ und Beschreibung.()

{: start="3"}
3\. Geben Sie der Rolle einen Namen und eine Beschreibung, und wählen Sie **Rolle erstellen**.

]({% image_buster /assets/img/security_export/name_review_create.png %})Felder zur Angabe von Rollendetails, wie Name, Beschreibung, Vertrauensrichtlinie, Berechtigungen und Tags.()
...
]({% image_buster /assets/img/security_export/credentials2.png %})Die Zusammenfassungsseite für eine Rolle namens "security-event-export-olaf".()
...
]({% image_buster /assets/img/security_export/security_event_download3.png %})Abschnitt "Download von Sicherheitsereignissen" mit einem umgeschalteten Schalter für "Export zu AWS S3".()
...
]({% image_buster /assets/img/security_export/save_changes_button.png %})Button "Änderungen speichern".{: style="max-width:40%;"}()
