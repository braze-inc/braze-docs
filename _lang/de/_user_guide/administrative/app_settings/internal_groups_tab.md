...
]({% image_buster /assets/img_archive/internal_group.png %})Eine interne Gruppe mit dem Namen "E-Mail-Testgruppe".()
...
]({% image_buster /assets/img_archive/internal_group_add_user.png %})Einstellungen der internen Gruppe bei der Erstellung einer neuen internen Gruppe()
...
]({% image_buster /assets/img_archive/content_test_preview.png %})Der Bereich Test des In-App-Nachricht-Editors, um die Testgruppe für Inhalte auszuwählen.{: style="max-width:60%" }()
...
]({% image_buster /assets/img_archive/seed_group_campaign.png %})Die für die E-Mail-Kampagne der Variante 1 ausgewählte Seed-Gruppe "E-Mail-Seed-Test".()
