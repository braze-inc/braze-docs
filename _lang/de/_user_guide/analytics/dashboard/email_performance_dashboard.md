...
]({% image_buster /assets/img_archive/email_performance_dashboard_1.png %})Dashboard zur Performance von E-Mails, das das Engagement des E-Mail-Kanals in den letzten dreißig Tagen anzeigt.()
...
\![Engagement nach Gerät Bericht, der die Anzahl der Klicks für Mobile, Desktop, Tablet, Apple Privacy Proxy, Google Image Proxy, Yahoo Mail Proxy und Andere anzeigt. Die meisten Öffnungen erfolgen auf mobilen Geräten.]({% image_buster /assets/img/engagement_by_device_type_proxy.png %})({: style="max-width:70%;"})
...
]({% image_buster /assets/img_archive/dashboard_filters.png %})Filteroptionen auf dem Channel Performance Dashboard, wo Sie einen Tag und eine Liste von Canvase auswählen können, nach denen Sie filtern möchten.()
...
]({% image_buster /assets/img_archive/email_performance_dashboard_3.png %})Radio-Buttons zum Umschalten zwischen der Anzeige von Änderungen in den Summen oder Änderungen in den Raten für das Kanal Performance Dashboard.{: style="max-width:60%"}()
