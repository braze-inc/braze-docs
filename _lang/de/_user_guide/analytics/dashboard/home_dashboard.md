...
]({% image_buster /assets/img_archive/home_dashboard.png %})Home Dashboard in Braze.()
...
]({% image_buster /assets/img/pick_up_where_you_left_off.png %})Ein Canvas-Entwurf, ein aktives Segment und ein Entwurf für eine Kampagne im Abschnitt "Weitermachen, wo Sie aufgehört haben".()
...
]({% image_buster /assets/img_archive/home_dashboard_select_date.png %})Datumsbereich und App-Felder auf dem Home Dashboard.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img_archive/home_dashboard_metric_tile.png %}){: style="max-width:60%;"}]({% image_buster /assets/img_archive/home_dashboard_metric_tile.png %})
...
]({% image_buster /assets/img_archive/home_dashboard_breakdown.png %})Erweitern Sie()
