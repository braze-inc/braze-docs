...
![Datum des Berichts]({% image_buster /assets/img/date_select_retention.png %}){: style="float:right;max-width:30%;margin-left:15px;"}
...
![Bindungs-Event auswählen]({% image_buster /assets/img/retention_1.png %}){: style="max-width:80%"}
...
![Laufender Bericht]({% image_buster /assets/img/campaign_retention3.png %})
