...
]({% image_buster /assets/img/date_select_retention.png %})Berichtsdatum{: style="float:right;max-width:30%;margin-left:15px;"}()
...
]({% image_buster /assets/img/retention_1.png %})Wählen Sie eine Bindung aus{: style="max-width:80%"}()
...
]({% image_buster /assets/img/retention_2.png %})Bericht ausführen{: style="max-width:80%"}()
...
]({% image_buster /assets/img/campaign_retention3.png %})Vollständiger Bericht

{% endtab %}
{% tab Canvas %}

]({% image_buster /assets/img/canvas_retention_report.png %})Vollständiger Bericht{: style="max-width:70%"}
...
]({% image_buster /assets/img/campaign_retention3.png %})Rollender Bericht()
...
]({% image_buster /assets/img/range_retention.png %})Bindung Bericht()
...
]({% image_buster /assets/img/variant_view.png %})Ansicht nach Variante()

{% endtab %}
{% tab Canvas %}

]({% image_buster /assets/img/variant_view_canvas.png %})Ansicht nach Variante()
