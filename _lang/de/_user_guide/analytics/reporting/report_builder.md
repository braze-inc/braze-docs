...
2. Klicken Sie auf den Pfeil für **weitere Optionen** neben dem Button **Neuen Bericht erstellen** und wählen Sie dann **eine Berichtsvorlage verwenden**.<br><br>]({% image_buster /assets/img/report_builder_2/create_new_report.png %})Button "Neuen Bericht erstellen" mit Optionen zum Erstellen eines angepassten Berichts oder zur Verwendung einer Vorlage.{: style="max-width:40%;"}()<br><br>
3. Wählen Sie eine der Berichtsvorlagen aus der Bibliothek für Braze-Vorlagen aus.
    - Verwenden Sie das Dropdown-Menü **Artikel** und **Tags**, um relevante Berichte für Ihre Anwendungsfälle zu finden.<br><br>]({% image_buster /assets/img/report_builder_2/report_templates.png %})Fenster "Braze-Berichtsvorlagen" mit einer Liste von Braze-Templates, aus der Sie auswählen können.{: style="max-width:90%;"}()<br><br>
...
]({% image_buster /assets/img/report_builder_2/rows_and_columns.png %})Der Bereich "Zeilen und Spalten" mit Feldern zum Auswählen der Zeilen und Gruppierungen für Ihren Bericht.{: style="width:90%;"}()
...
]({% image_buster /assets/img/report_builder_2/customize_metrics.png %})Der Bereich "Metriken anpassen" mit Optionen zum Auswählen mehrerer Metriken.{: style="width:90%;"}()
...
8\. Wählen Sie dann je nach Ihrer Auswahl in Schritt 3, ob Sie Ihrem Bericht manuell oder automatisch Kampagnen, Canvase oder beides hinzufügen möchten.
    - **Manuell hinzufügen:** Wählen Sie die einzelnen Kampagnen oder Canvas aus, die in den Bericht aufgenommen werden sollen, indem Sie die Filter für das Datum der **letzten Sendung** und die Tags oder Kanäle verwenden oder den Namen der Kampagne oder des Canvas suchen.<br><br>]({% image_buster /assets/img/report_builder_2/manually_add.png %})Der Bereich "Manuelles Hinzufügen von Kampagnen und Canvases" mit einer Liste von Kampagnen zum Auswählen.{: style="width:90%;"}()<br><br>
    - **Automatisch hinzufügen:** Legen Sie Regeln dafür fest, welche Kampagnen oder Canvase in den Bericht aufgenommen werden sollen. Sie müssen auf dieser Seite nur ein Feld auswählen.
        \- Beachten Sie, dass zusätzliche Kampagnen oder Canvase, die die Bedingungen erfüllen, die Sie auf diesem Bildschirm festgelegt haben, automatisch zu zukünftigen Ausführungen Ihres Berichts hinzugefügt werden.<br><br>]({% image_buster /assets/img/report_builder_2/automatically_add.png %})Der Bereich "Kampagnen und Canvase automatisch hinzufügen" mit Feldern zum Festlegen von Regeln, welche Kampagnen und Canvase dem Bericht hinzugefügt werden sollen.{: style="width:90%;"}()<br><br>
...
]({% image_buster /assets/img/report_builder_2/report_table.png %})Eine Tabelle mit den Berichtsdaten für die Metriken der einzelnen Kampagnen.{: style="width:90%;"}()
...
]({% image_buster /assets/img/report_builder_2/visualize_table.png %})Ein Chart der Berichtsdaten mit Optionen zur Konfiguration der x-Achse, y-Achse, des Chart-Typs und mehr.{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/report_builder_2/download_options.png %})Ein Menü mit Download-Optionen für verschiedene Dateiformate.{: style="max-width:70%;"}()
...
3. Wählen Sie aus, ob Sie ein neues Dashboard erstellen oder zu einem bestehenden Dashboard hinzufügen möchten.<br><br>]({% image_buster /assets/img/report_builder_2/add_to_dashboard.png %})Fenster mit Optionen zum Auswählen, ob Sie den Bericht zu einem neuen oder bestehenden Dashboard hinzufügen möchten.{: style="width:90%;"}()<br><br>
