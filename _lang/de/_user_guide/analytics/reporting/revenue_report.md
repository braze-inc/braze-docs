...
]({% image_buster /assets/img/revenue_report.png %})Die Seite "Umsatzbericht" zeigt die Grafik "Performance im Zeitverlauf" mit dem Parameter "Umsatz".()
...
]({% image_buster /assets/img/revenue_report_product_breakdown.png %})Die Tabelle "Aufschlüsselung der Produkte" mit den Spalten "Produktname", "Gekauft" und "Umsatz".()
