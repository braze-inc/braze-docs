...
]({% image_buster /assets/img/campaign_comparison/campaign_main.png %})Kampagnen Vergleich Beispiel{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/campaign_comparison/create_report.png %})Dashboard für Kampagnen{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/campaign_comparison/campaign_comparison_columns.png %})Kampagnen Optionen{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/campaign_comparison/metric.png %})Numerische Metrik für Kampagnen{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/campaign_comparison/comparison_name.png %})Kampagne Notiz{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/campaign_comparison/compare_note.png %})Kampagne Notiz{: style="float:right;max-width:15%;margin-left:15px;"}()
...
]({% image_buster /assets/img/campaign_comparison/campaign_comparison1.png %})Varianten{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/campaign_comparison/campaign_comparison2.png %})Steps{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/campaign_comparison/campaign_comparison3.png %})Bericht{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/campaign_comparison/download.png %})Kampagne Download{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/campaign_comparison/report_builder_charts.png %})Kampagnen Performance Chart mit der Metrik Gesendete Nachrichten ausgewählt()
