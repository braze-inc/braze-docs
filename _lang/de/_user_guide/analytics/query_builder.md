...
]({% image_buster /assets/img_archive/query_builder.png %})Der Abfrage-Builder zeigt die Ergebnisse zur Template-Abfrage "Engagement und Umsatz auf diesem Kanal in den letzten 30 Tagen".()
...
]({% image_buster /assets/img_archive/query_builder_ai_tab.png %})Der SQL KI Query Builder.{: style="max-width:60%;" }()
