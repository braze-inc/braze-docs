...
]({% image_buster /assets/img_archive/Uninstall_Segment.png %} "Uninstall Segment") "Segmentierung deinstallieren"
...
]({% image_buster /assets/img_archive/campaign_level_uninstall_tracking.png %})Deinstallation auf Kampagnen-Ebene.()
