...
| Name der Abfrage | Beschreibung | 
| --- | --- | 
| E-Mail-Absprünge pro Domain | Die Anzahl der Bounces pro E-Mail Domain, aufgeschlüsselt in Bounces insgesamt, Hard Bounces und Soft Bounces. <br> ]({% image_buster /assets/img_archive/query_builder_q4.png %}){: style="max-width:60%;"}]({% image_buster /assets/img_archive/query_builder_q4.png %}) |
...
| E-Mail-Performance nach Land | Dieser Bericht zeigt die folgenden Metriken für jedes Land: Versendungen, indirekte Öffnungsrate und direkte Öffnungsrate. Land ist das Land des Nutzers:innen zum Zeitpunkt des Push-Versands. <br><br> ]({% image_buster /assets/img_archive/query_builder_q3.png %})]({% image_buster /assets/img_archive/query_builder_q3.png %}) |
...
| Name der Abfrage | Beschreibung | 
| --- | --- | 
| Geräte-Netzbetreiber | Die Anzahl der Nutzer:innen pro Gerät und Anbieter, z. B. Verizon und T-Mobile. <br><br> ]({% image_buster /assets/img_archive/device_carriers.png %}){: style="max-width:50%;"}]({% image_buster /assets/img_archive/device_carriers.png %}) |
| Gerätemodelle | Die Anzahl der Nutzer:innen pro Gerätemodell, z. B. iPhone 15 Pro und Pixel 7. <br><br> ]({% image_buster /assets/img_archive/device_models.png %}){: style="max-width:50%;"}]({% image_buster /assets/img_archive/device_models.png %}) |
| Geräte-Betriebssysteme | Die Anzahl der Nutzer:innen pro Betriebssystem, z.B. 17.4 und Android 14. <br><br> ]({% image_buster /assets/img_archive/os_version.png %}){: style="max-width:50%;"}]({% image_buster /assets/img_archive/os_version.png %}) |
| Geräte-Bildschirmauflösungen | Die Anzahl der Nutzer:innen pro Gerät und Bildschirmauflösung, z.B. 1179x2556 und 750x1334. <br><br> ]({% image_buster /assets/img_archive/device_screen_resolutions.png %}){: style="max-width:40%;"}]({% image_buster /assets/img_archive/device_screen_resolutions.png %}) |
| SMS-Fehlercodes | Dieser Bericht zeigt die Fehlerart und die Anzahl der Fehler für jeden SMS Fehlercode an. <br><br>]({% image_buster /assets/img_archive/sms_errors.png %}){: style="max-width:50%;"}]({% image_buster /assets/img_archive/sms_errors.png %}) |
...
| Name der Abfrage | Beschreibung | 
| --- | --- | 
| Push-Performance nach Land | Dieser Bericht zeigt die folgenden Metriken für jedes Land: Zustellungen, Öffnungsrate und Klickrate. Land ist das Land des Nutzers:innen zum Zeitpunkt des Versendens der E-Mail. <br><br> ]({% image_buster /assets/img_archive/query_builder_q7.png %}){: style="max-width:70%;"}]({% image_buster /assets/img_archive/query_builder_q7.png %}) |
{: .reset-td-br-1 .reset-td-br-2 }
