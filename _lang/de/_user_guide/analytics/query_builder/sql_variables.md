...
]({% image_buster /assets/img/query_builder_example.png %})Der Tab "Variable" im Query Builder mit dem angegebenen Beispiel.()
...
]({% image_buster /assets/img_archive/sql_variables_campaigns.png %})Ein Beispiel für einen in Braze gerenderten Radio Button.{: style="max-width:50%;"}()
...
]({% image_buster /assets/img_archive/sql_variables_productname.png %})Ein Beispiel für eine in Braze gerenderte Mehrfachauswahlliste.{: style="max-width:50%;"}()
...
]({% image_buster /assets/img_archive/query_builder_time_range.png %})Ein in Braze gerenderter Beispielkalender.{: style="max-width:50%;"}()
