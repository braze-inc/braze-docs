...
]({% image_buster /assets/img/b2b/step_2_simple.png %})Schritt 2 der Erstellung eines Canvas mit dem Zeitplan für den Eingang "Aktionsbasiert" und aktionsbasierten Optionen zum Ändern eines angepassten Attributs "Lead Score" und Hinzufügen einer E-Mail Adresse.{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/b2b/step_3_simple.png %})Schritt 3 der Erstellung eines Canvas mit Optionen zur Auswahl von Segmenten und Filtern zur Eingrenzung der Zielgruppe für den Eingang.{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/b2b/entry_controls_simple.png %})"Eingangskontrollen" mit Auswahlmöglichkeiten für "Nutzern:innen erlauben, diesen Canvas erneut zu betreten" in einem "festgelegten Fenster" von 0 Sekunden.{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/b2b/step_4_simple.png %})Schritt 4 der Erstellung eines Canvas zur Einstellung der Optionen für den Versand von Nachrichten.{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/b2b/action_paths_simple.png %})Canvas mit "Aktions-Pfaden", die in dem über das Plus-Symbol geöffneten Menü angezeigt werden.{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/b2b/action_paths_selected_simple.png %})Aktions-Pfad mit Aktionsgruppen für das Addieren von einem Punkt, fünf Punkten und zehn Punkten, das Subtrahieren von einem Punkt und zehn Punkten und "Alle anderen".{: style="max-width:20%;"}()
...
]({% image_buster /assets/img/b2b/action_groups_simple.png %})Aktionsgruppe zum Hinzufügen eines Punktes mit den Triggern "Sitzung in einer beliebigen App starten" und "Angepasstes Event durchführen".{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/b2b/user_update_paths_simple.png %})Canvas, das den Aktions-Pfad mit verzweigten Nutzer:innen-Update-Pfaden für jede Aktionsgruppe anzeigt.{: style="max-width:80%;"}()
