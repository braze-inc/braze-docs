...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Steppington</td>
            <td>Event</td>
            <td><code>Stringclass_type:<br>Zahl<br>Zahl</td>
        ...
        <tr>
            ...
            <td>Steppington</td>
            <td>Event</td>
            <td><code>Stringgoal_name:<br><code>Ziel: Nummer</code><br><code>Einheiten: String</code></td>
            <td>Wenn der Nutzer:innen den Button <strong>Kostenlose Demo starten</strong> auswählt.</td>
        </tr>
    </tbody>
</table>
