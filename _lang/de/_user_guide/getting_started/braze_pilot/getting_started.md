...
![Das Workspace-Dropdown im Braze-Dashboard mit "Demo - Braze" als aktivem Workspace ausgewählt.]({% image_buster /assets/img/braze_pilot/dashboard_workspace.png %}){:style="max-width:60%"}
