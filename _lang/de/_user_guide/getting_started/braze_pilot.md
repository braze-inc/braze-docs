...
\![Eine In-App-Nachricht in der MovieCanon App "Gefällt Ihnen MovieCanon? Empfehlen Sie Ihre Freunde!" mit der Option, Ihre E-Mail Adresse einzugeben, um eine Empfehlung zu senden.]({% image_buster /assets/img/braze_pilot/moviecanon_iam.png %}){:style="max-width:40%"}