...
- **Nutzerkennung:** Jedes Benutzerprofil wird durch eine Benutzer-ID, `external_id` genannt, eindeutig identifiziert. Diese Kennung ermöglicht es Braze, Benutzerdaten über verschiedene Kanäle und Geräte hinweg zu verfolgen und zuzuordnen. So erhalten Sie einen einheitlichen Überblick über die Interaktionen der einzelnen Benutzer mit Ihrer Marke. 
