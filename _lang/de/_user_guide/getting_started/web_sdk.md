...
]({% image_buster /assets/img_archive/web_push_macbook.png %})Push, der in einem Webbrowser angezeigt wird{: style="float:right;max-width:45%;margin-left:20px;border:0;"}()
...
]({% image_buster /assets/img_archive/web-users-segment.png %})Segment Detailseite mit Web App im Fokus{:style="max-width:60%"}()
