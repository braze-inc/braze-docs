...
Wenn Kund:innen Tickets für den Dienst auf einer Plattform wie Zendesk öffnen, können Sie diese anpassen:
...
Braze verfügt über eine Integration mit [Iterate]({{site.baseurl}}/partners/message_orchestration/channel_extensions/surveys/iterate/), einer Plattform für Insights und Umfragen. Mit der Datentransformation können Sie mehrere Antworten auf Umfragen unter einem verschachtelten angepassten Attribut speichern, anstatt wie bei der bestehenden Integration mehrere angepasste Attribute zu speichern.
...
{% endtab %}
{% tab Fortschrittliche Transformation %}
