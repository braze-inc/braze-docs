...
page_order: 4
page_type: reference
description: "In diesem Artikel erfahren Sie, wie Sie mit dem Berichts-Builder Berichte und Diagramme zu Kampagnen und Canvases erstellen."
tool: 
  - Reports
...
{% alert tip %}
Versuchen Sie, in allen Kampagnen und Canvases, die Sie vergleichen möchten, dieselben Konversions-Events für Konversion A, B usw. zu verwenden.
{% endalert %}
...
{% alert note %}
Wenn Sie die [ältere Navigation]({{site.baseurl}}/navigation) verwenden, finden Sie **Report Builder** unter **Daten**.
{% endalert %}

Klicken Sie auf **Neuen Bericht erstellen** und wählen Sie entweder einen Kampagnenvergleichsbericht oder einen Canvas-Vergleichsbericht.

Wenn Sie einen Bericht über Kampagnen erstellen möchten, können Sie zwischen einem **manuellen** und einem **automatischen** Bericht wählen. Berichte können entweder Kampagnen oder Canvases enthalten, aber nicht beides. Alle Kampagnen und Canvase, die innerhalb der letzten 12 Monate zuletzt Nachrichten gesendet haben, kommen für einen Bericht in Frage.
...
| **Bericht bearbeiten** | Sie können auf "Bericht bearbeiten" klicken, um Kampagnen zu Ihrem Bericht hinzuzufügen oder zu löschen. | Sie können Ihren Bericht bearbeiten, indem Sie die Filterkriterien anpassen. |
...
Sobald Sie Ihren Bericht erstellt haben, sehen Sie eine leere Tabelle mit Kampagnen in jeder Zeile. Die Tabelle füllt sich, nachdem Sie **Spalten bearbeiten** gewählt und die Metriken ausgewählt haben, die Sie hinzufügen möchten.
...
![Numerische Metrik für die Kampagne][4]{: style="max-width:60%;"}
...
Wenn Sie bereit sind, klicken Sie auf **Speichern**. Gespeicherte Berichte können zu einem späteren Zeitpunkt auf der Seite **Report Builder** angezeigt werden.
...
Die Metriken, die die Zeile für Ihre Gesamtkampagne auffüllen, spiegeln die Leistung ihrer Varianten wider, enthalten aber nicht die Leistung der Kontrolle. So ergibt sich das primäre Konversions-Event A für eine gesamte Kampagne aus der Summe der primären Konversions-Events A der einzelnen Varianten, beinhaltet aber nicht das primäre Konversions-Event A zur Kontrolle.
...
Wenn Sie die Option **Aufschlüsselung nach Variante** wählen, können Sie die übergeordneten Statistiken für Ihre gesamten Leinwände sowie die Statistiken für jede einzelne Variante einsehen, die Sie durch Klicken auf den Pfeil neben dem Namen der Leinwand erweitern können.

![Varianten][12]{: style="max-width:90%;"}

### Schritte 

Wenn Sie **Aufschlüsselung nach Schritten** wählen, können Sie Metriken auf Schrittebene anzeigen, wobei jede Zeile des Berichts die Zeile eines Schritts enthält.
...
Wenn Sie auf einen gespeicherten **manuellen Bericht** zugreifen, können Sie dieselben Kampagnen sehen, die Sie zuvor hinzugefügt haben, da diese Kampagnen immer noch unter Ihren Filter "Zuletzt gesendet" fallen.

Wenn Sie auf einen gespeicherten **automatischen Bericht** zugreifen, wird der Bericht automatisch aktualisiert und enthält alle Kampagnen, die derzeit Ihren Filtern entsprechen. Wenn Ihr Bericht beispielsweise Kampagnen mit dem Tag "Promotion" gefiltert hat, können Sie jedes Mal, wenn Sie diesen Bericht aufrufen, alle Kampagnen mit dem Tag "Promotion" sehen, auch wenn diese Kampagnen nach der Erstellung dieses Berichts erstellt wurden.

## Berichte bearbeiten

In einem **manuellen Bericht** können Sie einen Bericht bearbeiten, indem Sie auf **Bearbeiten** klicken. Von dort aus können Sie Kampagnen auswählen oder abwählen, die in Ihren Bericht aufgenommen werden sollen.

In einem **automatischen Bericht** schalten Sie einfach die Filter um, um die Ergebnisse in Ihrem Bericht einzugrenzen.

## Berichte exportieren

Sie können auch auf **Exportieren** klicken, um Ihren Bericht im CSV-Format herunterzuladen.
...
Ihr CSV-Export spiegelt die Ansicht wider, in der Sie sich befanden, als Sie auf **Exportieren** geklickt haben. Wenn Sie sich beispielsweise in der Aufschlüsselung auf Schrittebene befinden, enthält der Export Daten zu Ihren Metriken für die einzelnen Schritte. Um Daten aus einer anderen Untergliederung zu exportieren, müssen Sie zunächst zu dieser Untergliederung navigieren und dort auf **Exportieren** klicken.
