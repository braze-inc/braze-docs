...
> Erfahren Sie mehr über die verschiedenen Ereignisse in Braze und ihren Zweck.

Braze nutzt verschiedene Event-Typen, um ein umfassendes Verständnis des Verhaltens der Nutzer:innen und des Engagements für Ihre Marke zu erhalten. Jede Art von Event dient einem eindeutigen Zweck:

- [Standard-Events](#standard-events): Vermitteln Sie ein grundlegendes Verständnis des Engagements der Nutzer:innen Ihrer App oder Website.
...
- [Angepasste Events](#custom-events): Verschaffen Sie sich tiefere Insights in das Nutzerverhalten, das für Ihre App oder Ihr Unternehmen eindeutig ist.

Indem Sie diese verschiedenen Arten von Ereignissen verfolgen, können Sie ein tieferes Verständnis für Ihre Nutzer gewinnen, das Ihnen Informationen für Ihre Marketingstrategien liefert, Ihnen bei der Optimierung Ihrer App hilft und es Ihnen ermöglicht, ein persönlicheres Nutzererlebnis zu bieten. Lassen Sie uns eintauchen.
...
Als Marketingspezialist können Sie diese Standardereignisse nutzen, um das Nutzerverhalten und das Engagement für Ihre App zu verstehen. Sie können zum Beispiel sehen, wie oft Nutzer Ihre App starten oder wie viele Käufe getätigt werden. Diese Informationen können von unschätzbarem Wert sein, wenn es darum geht, gezielte Marketing Kampagnen zu erstellen.
...
Kauf-Events sind eine Möglichkeit, die Einkäufe Ihrer Nutzer:innen zu erfassen und zu tracken. Sie sind eine Art von Standard-Event, das nach der Integration des Braze SDK standardmäßig verfügbar ist. Wenn Sie also Kauf-Events zum Tracking von Käufen verwenden, können Sie Ihre Umsätze im Laufe der Zeit und über verschiedene Umsatzquellen hinweg direkt von Braze aus überwachen.
...
Wenn Sie mehr erfahren möchten, besuchen Sie unseren Artikel über [Kauf-Events]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/purchase_events/).

{% details Beispielhafte Implementierung %}

Bitte beachten Sie, dass die tatsächliche Implementierung von Kauf-Events einige technische Kenntnisse erfordert, da es sich um die Integration des Braze SDK mit Ihrer App handelt. Ihr Customer-Success-Manager wird Ihr Team im Rahmen Ihres Onboardings durch diesen Prozess führen, aber die allgemeinen Schritte sind wie folgt:

1. **Integrieren Sie das Braze SDK:** Bevor Sie irgendwelche Events protokollieren, müssen Sie das Braze SDK in Ihre App integrieren.
...
In diesem Beispiel ist "Produktname" der Name des gekauften Produkts, "USD" ist die Währung des Kaufs, "1.99" ist der Preis des Produkts und 1 ist die gekaufte Menge.
...
Benutzerdefinierte Ereignisse sind Ereignisse, die Sie auf der Grundlage der spezifischen Aktionen definieren, die Sie innerhalb Ihrer App oder Website verfolgen möchten. Braze verfolgt sie nicht automatisch. Sie müssen diese Events manuell in Ihrer Braze SDK-Implementierung einrichten. Benutzerdefinierte Ereignisse können alles sein, von einem Benutzer, der ein Level in einem Spiel abschließt, bis hin zu einem Benutzer, der seine Profilinformationen aktualisiert.
...
Wenn Sie mehr erfahren möchten, besuchen Sie unseren Artikel über [benutzerdefinierte Ereignisse]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_events/).
...
1. **Integrieren Sie das Braze SDK:** Bevor Sie irgendwelche Events protokollieren können, müssen Sie das Braze SDK in Ihre App integrieren.
...
{:start="4"}
4\. **Fügen Sie Eigenschaften zu Ihrem angepassten Event hinzu (optional):** Wenn Sie zusätzliche Details über das angepasste Event erfassen möchten, können Sie ihm Eigenschaften hinzufügen. Dazu übergeben Sie ein Wörterbuch mit Eigenschaften, wenn Sie das Event protokollieren.
