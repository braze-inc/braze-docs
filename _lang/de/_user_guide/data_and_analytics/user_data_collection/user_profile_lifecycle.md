...
Wie Sie eine `external_id` für ein Benutzerprofil einstellen, erfahren Sie in der Dokumentation ([iOS][24], [Android][30], [Web][31]).
...
Im Gegensatz zu `external_id` können Pseudonyme um einen neuen Namen für ein bestimmtes Label ergänzt werden, sofern dieses über die [Benutzerdaten-Endpunkte][32] oder die Übergabe eines neuen Namens über das SDK festgelegt wird. Der Nutzer-Alias wird dann beim Exportieren der Daten des Nutzers:innen sichtbar sein.

![Zwei Benutzerprofile für verschiedene Benutzer mit demselben Alias-Label aber unterschiedlichen Alias-Namen][29]
...
Um Benutzer zu Testzwecken in Ihrem Dashboard zu finden und zu erkennen, können alle Benutzer-IDs verwendet werden. Wie Sie Benutzer im Braze-Dashboard finden, erfahren Sie unter [Testbenutzer hinzufügen][28].
