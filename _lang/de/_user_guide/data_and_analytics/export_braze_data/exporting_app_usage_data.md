...
![Zeitspanne und App-Felder im Home-Dashboard.][1]{: style="max-width:60%;"}
...
![Diagramm "Leistung im Zeitverlauf" im Home-Dashboard.][2]
...
- Newsfeed Impressionen nach Datum
...
{% alert tip %}
Hilfe bei CSV- und API-Exporten finden Sie in unserem Artikel zur [Fehlerbehebung bei Exporten]({{site.baseurl}}/user_guide/data_and_analytics/export_braze_data/export_troubleshooting/).
{% endalert %}
