---
nav_title: Benutzer mit CDI löschen 
article_title: Benutzer mit Cloud Data Ingestion löschen
page_order: 30
page_type: reference
description: "Dieser Referenzartikel bietet einen Überblick über den Prozess zum Löschen von Nutzer:innen mit Cloud Data Ingestion."

---

# Benutzer mit Cloud Data Ingestion löschen

Synchronisierungen zum Löschen von Benutzern werden für alle verfügbaren Cloud Data Ingestion-Datenquellen unterstützt. 

## Konfiguration der Integration 

Folgen Sie dem Standardverfahren zur [Erstellung einer neuen Integration im Braze-Dashboard]({{site.baseurl}}/user_guide/data_and_analytics/cloud_ingestion/integrations/#step-1-set-up-tables-or-views) für das Data Warehouse, mit dem Sie sich verbinden möchten. Stellen Sie sicher, dass Sie eine Rolle angeben, die Zugriff auf die Löschtabelle hat. Auf der Seite **Import-Synchronisierung erstellen** stellen Sie den **Datentyp** auf **Benutzer löschen** ein. Dadurch wird sichergestellt, dass während des Integrationslaufs die richtigen Aktionen zum Löschen von Nutzer:innen durchgeführt werden.

![]({% image_buster /assets/img/cloud_ingestion/deletion_1.png %})

## Konfiguration der Quelldaten 

Die Quelltabellen für die Löschung von Nutzer:innen sollten einen oder mehrere Typen von Bezeichnern und einen `UPDATED_AT`-Zeitstempel enthalten. Nutzdaten-Spalten werden für Benutzer-Löschdaten nicht unterstützt.
