...
> Braze verwendet Currents! Das stimmt, wir mögen unser eigenes Produkt so sehr, dass wir es in Verbindung mit einigen [unserer Partner]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/available_partners/) verwenden.
...
Wir haben Currents eingerichtet, um Braze-Ereignisdaten zur Speicherung und Extraktion an Amazon S3 zu senden. Wir wissen, dass Sie [Athena][2] verwenden können, um auf S3 aufzusetzen und Abfragen durchzuführen. Das ist eine großartige kurzfristige Lösung. Aber wir wollten eine langfristige Lösung mit einer relationalen Datenbank und einem Business-Intelligence/Analytics-Tool. (Das empfehlen wir auch für Sie.)
