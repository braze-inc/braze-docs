...
article_title: Erstellen Sie regelbasierte Artikelempfehlungen
...
<table style="text-align: center;">
  <thead>
    <tr>
      ...
      <th>Es wurden keine Datenpunkte protokolliert.</th>
...
2. Fügen Sie für jedes Produkt eine Liste empfohlener Produkte als String hinzu, der durch ein Trennzeichen (z. B. ein Pipe-Zeichen`|`) in einer Spalte mit dem Namen “product_recommendations”.
...
![Ein Beispiel für einen Klick-Verhaltensblock im Composer.]({% image_buster /assets/img/recs/on_click_behavior.png %}){: style="max-width:60%;"}<br><br>
...
![Darstellung einer Restaurantliste, die durch den Beispiel-Final-Call generiert wurde.]({% image_buster /assets/img/recs/sample_response.png %}){: style="max-width:30%;"}
{% endtab %}
{% endtabs %}
