...
]({% image_buster /assets/img/churn/churn1.png %})Abwanderungsdefinition: Ein:e Nutzer:in gilt als abgewandert, wenn sie:er innerhalb von 7 Tagen keine Sitzung beginnt()
...
Ihre Prognose-Zielgruppe ist die Gruppe von Nutzer:innen, für die Sie das Abwanderungsrisiko prognostizieren möchten. Die Zielgruppe für Prognosen definiert die Gruppe der Nutzer:innen, die das Modell für maschinelles Lernen betrachtet, um aus der Vergangenheit zu lernen. Standardmäßig ist diese Option auf **Alle Nutzer:innen** eingestellt. Das bedeutet, dass diese Prognose für alle aktiven Nutzer:innen Risikowerte für das Abwandern erstellt (siehe den vorherigen Hinweis, wer für ein Abwanderungsmodell als aktiv gilt).
...
]({% image_buster /assets/img/churn/churn5.png %})]({% image_buster /assets/img/churn/churn5.png %})
...
]({% image_buster /assets/img/churn/churn2.png %})Der Zeitplan für das Update der Prognosen ist auf täglich um 17 Uhr eingestellt.()
