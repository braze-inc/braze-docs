...
]({% image_buster /assets/img/intelligent_timing/campaign_scheduling.png %})Zeitplan für Kampagnen mit intelligentem Timing mit Fallback-Zeit und Einstellungen für Ruhezeiten()
...
]({% image_buster /assets/img/intelligent_timing/quiet_hours.png %})Ruhezeiten umschalten und Start- und Endzeit festlegen, um die Zustellung von Nachrichten über Nacht zu blockieren()
...
]({% image_buster /assets/img/intel-timing-preview.png %})Das Chart mit der Zustellungsvorschau für Android Push zeigt das größte Engagement zwischen 12 und 14 Uhr, wobei 14 Uhr die beliebteste Zeit für die App ist.()
...
]({% image_buster /assets/img/intelligent_timing/first_used_app.png %})Filter für die Zielgruppe, bei der die Kampagne auf Nutzer:innen abzielt, die die App vor 1 bis 4 Tagen zum ersten Mal genutzt haben.()
...
]({% image_buster /assets/img/intelligent_timing/ab_testing_intelligent_timing.png %})A/B-Tests mit ausgewählter Variante, Gewinnkriterien, Versanddatum und Lokalisierung der Versandzeit()
...
]({% image_buster /assets/img/intelligent_timing_hours.png %})Kontrollkästchen für "Nachrichten nur innerhalb bestimmter Stunden senden" ausgewählt, wobei das Zeitfenster auf 8 bis 12 Uhr in der Ortszeit des Nutzers:innen festgelegt ist.()
...
]({% image_buster /assets/img/intelligent_timing_1.png %})Zeitplan für eine Kampagne mit intelligentem Timing()
...
]({% image_buster /assets/img/intel-timing-preview.png %})Beispielhafte Vorschau der Zustellungszeiten für Android Push.()
...
Wählen Sie einen Fallback-Zeitpunkt für die Nachricht, die an Nutzer:innen Ihrer Zielgruppe gesendet werden soll, die nicht über genügend Daten zum Engagement verfügen, damit Braze einen optimalen Sendezeitpunkt berechnen kann. {% multi_lang_include brazeai/intelligent_suite/fallback_time.md %} 
