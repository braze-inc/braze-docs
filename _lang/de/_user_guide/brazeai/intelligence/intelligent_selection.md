...
]({% image_buster /assets/img/intelligent_selection1.png %})A/B-Tests in einer Kampagne mit aktivierter intelligenter Auswahl.()
...
]({% image_buster /assets/img/intelligent_selection.png %})Ein Canvas mit zwei Varianten, die jeweils auf 50 % Variantenverteilung eingestellt sind, was die Aktivierung der intelligenten Auswahl zulässt.()

Damit können Sie die Variantenverteilung bearbeiten und die Intelligente Auswahl einschalten. 

]({% image_buster /assets/img_archive/canvas_intelligent_selection.png %})Option "Intelligente Auswahl" für einen Canvas aktiviert ()
