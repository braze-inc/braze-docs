...
![Die Daten für die Prognosen zeigen 31 Abgewanderte in der Vergangenheit (erfüllt die Anforderungen) und 0 Nicht-Abgewanderte in der Vergangenheit (unter dem Minimum). Eine Warnung weist darauf hin, dass nicht genügend Nicht-Abgewanderte vorhanden sind, um die Prognose zu erstellen.]({% image_buster /assets/img/churn/audience_size_error.png %})
