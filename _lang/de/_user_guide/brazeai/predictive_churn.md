...
Die Aktualisierung der Risikobewertungen für die Zielgruppe der Prognosen kann in einem [von Ihnen gewählten Rhythmus]({{site.baseurl}}/user_guide/brazeai/predictive_churn/creating_a_churn_prediction/#step-4-choose-the-update-frequency-for-churn-prediction) erfolgen. Auf diese Weise können Sie Nutzer:innen, bei denen das Risiko des Abwanderns besteht, kontaktieren, bevor sie es tatsächlich tun, und es so von vornherein verhindern. Mithilfe von bis zu drei aktiven Prognosen können Sie Predictive Churn nutzen, um individuelle Modelle zu erstellen, mit denen Sie die Abwanderung in bestimmten Segmenten Ihrer Nutzer:innen verhindern können, die Sie als besonders wertvoll erachten.
