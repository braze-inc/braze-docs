...
]({% image_buster /assets/img/ai_liquid/ai_assistant_icon.png %})Nachrichten-Editor mit dem KI-Assistenten.{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/ai_liquid/use_app_activity.png %})Beispiel für die Ausgabe der Aufforderung "App-Aktivität verwenden".{: style="max-width:45%;"}()
{% endtab %}
...
]({% image_buster /assets/img/ai_liquid/add_countdown.png %})Beispiel für die Ausgabe der Aufforderung "Countdown hinzufügen".{: style="max-width:45%;"}()
{% endtab %}
...
]({% image_buster /assets/img/ai_liquid/inspire_me.png %})Beispiel für die Ausgabe der Aufforderung "Inspire me".{: style="max-width:45%;"}()
{% endtab %}
...
]({% image_buster /assets/img/ai_liquid/improve_my_liquid.png %})Beispiel für die Ausgabe der Aufforderung "Verbessere mein Liquid".{: style="max-width:45%;"}()
{% endtab %}
{% endtabs %}

Um Ihren Liquid-Code zu generieren, wählen Sie **Editor aktualisieren**.

]({% image_buster /assets/img/ai_liquid/ai_assistant_window.png %})KI-Assistent-Fenster mit Eingabeaufforderungen.{: style="max-width:50%;"}()
