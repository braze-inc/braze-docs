...
]({% image_buster /assets/img/recs/catalog_items.png %})Beispielkatalog in Braze.()
...
]({% image_buster /assets/img/recs/content_card_preview.png %})Ein Beispiel für einen Nachrichten-Editor für eine Content-Card-Kampagne.()
...
]({% image_buster /assets/img/recs/on_click_behavior.png %})Ein Beispiel für einen Verhaltensblock bei einem Klick im Composer.{: style="max-width:60%;"}()<br><br>
...
]({% image_buster /assets/img/recs/sample_response.png %})Rendering einer Restaurantliste, die durch den finalen Aufruf des Beispiels erzeugt wurde.{: style="max-width:30%;"}()
{% endtab %}
{% endtabs %}
