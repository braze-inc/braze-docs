...
![In-App-Nachricht mit dem Text "Als nächstes, nur für Sie. Weil Sie "Nomaden der Sonne" gesehen haben, mit einem Bild, einem Titelnamen, einer Beschreibung und einer CTA zum "Jetzt ansehen" oder "Überspringen" zur nächsten Empfehlung.]({% image_buster /assets/img/ai_use_cases/recommendation_rendered.png %})
...
![Das Modal "Personalisierung hinzufügen" wird im Braze-Editor geöffnet, wobei als Personalisierungstyp "Artikelempfehlung" ausgewählt ist.]({% image_buster /assets/img/ai_use_cases/recommendation_add_personalization.png %})
...
![In-App-Nachricht-Editor mit rohem Liquid zu Template in bestimmten Feldern von Katalogartikeln aus der Empfehlung.]({% image_buster /assets/img/ai_use_cases/recommendation_liquid.png %})
