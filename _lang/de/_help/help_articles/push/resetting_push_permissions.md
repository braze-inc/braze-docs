...
page_type: solution
description: "In diesem Hilfeartikel erfahren Sie, wie Sie die Push-Berechtigungen und Daten des Browsers zurücksetzen."
channel: push
---

# Push-Berechtigungen zurücksetzen

Wenn Sie Probleme mit Push-Benachrichtigungen in Ihrem Browser haben, müssen Sie möglicherweise die Benachrichtigungsberechtigungen für Ihre Website zurücksetzen und den Speicher Ihrer Website leeren. Die folgenden Schritte helfen Ihnen dabei.
...
3. Öffnen Sie Chrome DevTools. Im Folgenden finden Sie die relevanten Verknüpfungen pro Betriebssystem.
...
{:start="4"}
4\. Navigieren Sie in DevTools zur Registerkarte **Anwendung**.
5\. Wählen Sie in der Seitenleiste **Speicher**.
6\. Klicken Sie auf **Standortdaten löschen**.
...
Ihre Push-Berechtigungen werden jetzt zurückgesetzt. Öffnen Sie eine neue Registerkarte zu Ihrer Website und probieren Sie es aus.
...
4. Stellen Sie sicher, dass die Benachrichtigungen auf "Vor dem Senden fragen (empfohlen)" eingestellt sind.
5. Finden Sie Ihre Website in der Liste.
6. Wählen Sie den Eintrag und tippen Sie auf **Löschen und Zurücksetzen**.
...
3. Wählen Sie im selben Menü die Option **Cookies und Websitedaten löschen**.
4. Es erscheint ein Dialog, in dem Sie Ihre Wahl bestätigen müssen. Klicken Sie auf **OK**.

Ihre Push-Berechtigungen werden jetzt zurückgesetzt. Öffnen Sie eine neue Registerkarte zu Ihrer Website und probieren Sie es aus.

## Firefox auf Android zurücksetzen

Wie Sie die Push-Berechtigungen unter Android zurücksetzen können, erfahren Sie in diesem [Support-Artikel von Mozilla](https://support.mozilla.org/en-US/kb/clear-your-browsing-history-and-other-personal-data#w_clear-specific-items-from-your-browser).

## Safari unter macOS zurücksetzen
...
7. Klicken Sie auf **Entfernen**, oder um alle Standortdaten zu entfernen, klicken Sie auf **Alle entfernen**.
