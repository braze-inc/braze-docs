...
Sie können [die Liste der angepassten Attribute]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_attributes/#exporting-data) als CSV-Datei [exportieren]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_attributes/#exporting-data), indem Sie auf der Seite **Angepasste Attribute** die Option **Alle exportieren** auswählen. Die CSV-Datei wird generiert, und ein Download-Link wird Ihnen per E-Mail zugesandt.
