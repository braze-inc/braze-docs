...
{% alert note %}
[Autoren, die]({{site.baseurl}}/contributing/home) zu Braze Docs [beitragen]({{site.baseurl}}/contributing/home), sollten beachten, dass die Website jetzt mit Ruby 3.3.0 läuft. Bitte upgraden Sie bei Bedarf Ihre Ruby-Version.
{% endalert %}
