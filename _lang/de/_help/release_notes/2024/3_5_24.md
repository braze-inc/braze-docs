...
Um [die Pfadzuweisung]({{site.baseurl}}/user_guide/engagement_tools/canvas/canvas_components/experiment_step) für einen Experiment-Pfad-Schritt immer [nach dem Zufallsprinzip durchzuführen]({{site.baseurl}}/user_guide/engagement_tools/canvas/canvas_components/experiment_step), wählen Sie **in dem Schritt Randomisierte Pfade in Experiment-Pfade** aus. Diese Option ist nicht verfügbar, wenn Sie entweder den Gewinnerpfad oder personalisierte Pfade verwenden.
