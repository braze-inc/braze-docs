...
layout: api_page
page_type: reference
description: "Dieser Artikel enthält Details über den Export täglicher App-Deinstallationen nach Datum Braze Endpunkt."

---
{% api %}
# Exportieren Sie KPIs für tägliche App-Deinstallationen nach Datum
{% apimethod get %}
/kpi/uninstalls/data_series
{% endapimethod %}

> Verwenden Sie diesen Endpunkt, um eine tägliche Reihe der Gesamtzahl der Deinstallationen an jedem Datum abzurufen.
