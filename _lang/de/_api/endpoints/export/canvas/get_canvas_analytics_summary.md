...
article_title: "GET: Exportieren von Canvas-Daten Zusammenfassung Analytics"
search_tag: Endpoint
page_order: 4
layout: api_page
page_type: reference
description: "Dieser Artikel beschreibt die Details des Endpunkts Export Canvas data summary analytics Braze."

---
{% api %}
# Exportieren Sie zusammenfassende Analysen von Canvas-Daten
{% apimethod get %}
/canvas/data_summary
{% endapimethod %}

> Mit diesem Endpunkt können Sie Rollups von Zeitreihendaten für ein Canvas exportieren und so eine übersichtliche Zusammenfassung der Canvas-Ergebnisse erhalten.
