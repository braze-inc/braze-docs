...
| `gender`              | String          | Geschlecht der Nutzer:in. Mögliche Werte sind:<br><br>- `M`: männlich<br>- `F`: weiblich<br>- `O`: Sonstiges<br>- `N`: nicht zutreffend<br>- `P`: möchte ich nicht angeben<br>- `nil`: unbekannt                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `total_revenue`       | Gleitkommazahl           | Gesamtumsatz, der dieser Nutzer:in zugerechnet wird. Der Gesamtumsatz wird auf der Grundlage der Käufe berechnet, die die Nutzer:innen während der Konversionsfenster für die Kampagnen und Canvase getätigt haben, die sie erhalten haben.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
