---
nav_title: "GET: Liste der News-Feed-Karten exportieren"
article_title: "GET: Liste der News-Feed-Karten exportieren"
search_tag: Endpoint
page_order: 4
layout: api_page
page_type: reference
description: "Dieser Artikel beschreibt die Details des Export News Feed cards list Braze Endpunkts."

---
{% api %}
# Liste der News Feed-Karten exportieren
{% apimethod get %}
/feed/list
{% endapimethod %}

> Verwenden Sie diesen Endpunkt, um eine Liste von News Feed-Karten zu exportieren, die jeweils den Namen und die API-Kennung der Karte enthalten.
...
| `include_archived` | Optional | Boolesche   | Ob archivierte Karten einbezogen werden sollen oder nicht, Standardwert ist false. |
