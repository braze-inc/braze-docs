...
layout: api_page
page_type: reference
description: "Dieser Artikel beschreibt die Details des Braze-Endpunkts Generate preference center URL."
...
Jede URL des Einstellungszentrums ist für jeden Benutzer einzigartig.
...
|`userID`| Erforderlich | String | Die Benutzer-ID. |
{:  role="presentation" }
...
|`external_id`| Erforderlich | String | Die externe ID für einen Benutzer. |
...
{% alert note %}
Dieser Endpunkt generiert nur URLs für das neue Einstellungszentrum (z. B. für Einstellungszentren, die mit unserer API oder dem Drag-and-Drop-Editor erstellt wurden).
{% endalert %}
