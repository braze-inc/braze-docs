...
Administratoren können nun die Mindestanzahl neuer, eindeutiger Passwörter festlegen, die andere Nutzer:innen in ihrem Unternehmen verwenden müssen, bevor sie ein zuvor verwendetes Passwort erneut verwenden dürfen. Dies kann über das Panel [Authentifizierungsregeln]({{site.baseurl}}/user_guide/onboarding/platform_administrative_features/#authentication-rules) in den **Unternehmenseinstellungen** auf dem Tab **Sicherheitseinstellungen** gesteuert werden.
