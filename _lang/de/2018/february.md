...
Sie können jetzt [E-Mail Templates über API]({{site.baseurl}}/developer_guide/rest_api/email_templates/#email-templates) erstellen und aktualisieren. Jedes Template kann referenziert werden, um**email_template_id**es in anderen API-Aufrufen zu verwenden.
