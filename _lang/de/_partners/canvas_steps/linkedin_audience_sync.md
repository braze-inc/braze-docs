...
| ------ | ----------- | 
| Eingetreten | Anzahl der Benutzer, die diese Komponente eingegeben haben, die mit LinkedIn synchronisiert werden soll. |
...
### Woher weiß ich, ob die Benutzer übereinstimmen, nachdem ich sie an LinkedIn weitergegeben habe?
 ...
 Sie können es auf LinkedIn unter der Rubrik **Audiences** einsehen. 
