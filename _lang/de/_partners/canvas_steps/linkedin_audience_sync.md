...
![Die LinkedIn Technologieseite in Braze enthält eine Übersicht und einen Abschnitt LinkedIn Audience Sync mit dem Button Connected LinkedIn.][3]{: style="max-width:75%;"}
...
!["Braze Self Service" ist als das zu verbindende Anzeigenkonto ausgewählt.][7]{: style="max-width:75%;"}
...
![Ein Eingang Zielgruppe mit dem Filter "Ad Tracking Enablement ist wahr".][5]{: style="max-width:75%;"}
...
![Ein Canvas mit einem Eingang Zielgruppe "opted_in_marketing" ist gleich "true".][4]{: style="max-width:75%;"}
...
![Synchronisierung der Zielgruppe mit LinkedIn, wobei Braze als Anzeigenkonto ausgewählt ist.][11]
...
![LinkedIn-Seite mit den folgenden Metriken für die angegebene Zielgruppe.][8]
