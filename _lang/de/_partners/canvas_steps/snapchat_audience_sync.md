...
| --- | --- |
| Eingetreten | Anzahl der Benutzer, die diese Komponente eingegeben haben, um mit Snapchat synchronisiert zu werden. |
...
Sie können die Verbindung zu Ihrem Snapchat-Konto auf der Snapchat-Partnerseite trennen und wiederherstellen. 
