...
![Criteo Technologieseite in Braze, die eine Übersicht und einen Criteo Bereich mit dem Connected Criteo Button enthält.][5]{: style="max-width:80%;"}
...
![Eine Liste der verfügbaren Anzeigenkonten, die Sie mit Criteo verbinden können.][7]{: style="max-width:80%;"}
...
![Eine aktualisierte Version der Technologie-Partnerseite von Criteo, auf der die erfolgreich verbundenen Werbekonten angezeigt werden.][4]{: style="max-width:80%;"}
...
![Workflow der vorherigen Schritte zum Hinzufügen einer Criteo Audience-Komponente in Canvas Flow.][9]{: style="max-width:35%;"} ![Workflow der vorherigen Schritte zum Hinzufügen einer Criteo Audience-Komponente in Canvas Flow.][10]{: style="max-width:28%;"}
