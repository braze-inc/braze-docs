...
![Pinterest-Technologie-Seite in Braze, die eine Übersicht und einen Abschnitt Pinterest Audience Sync mit dem Button Connected Pinterest enthält.][1]{: style="max-width:80%;"}
...
![Eine aktualisierte Version der Technologie-Partnerseite von Pinterest, auf der die erfolgreich verbundenen Werbekonten angezeigt werden.][3]{: style="max-width:80%;"}
...
![Zielgruppendetails für eine bestimmte Pinterest-Zielgruppe, einschließlich Zielgruppenname, Zielgruppen-ID, Zielgruppentyp und Zielgruppengröße.][11]
