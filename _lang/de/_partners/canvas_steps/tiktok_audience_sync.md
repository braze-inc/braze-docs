...
![Die TikTok-Technologie-Seite in Braze enthält eine Übersicht und einen Abschnitt TikTok Audience Sync mit dem Button Connected TikTok.][1]{: style="max-width:75%;"}
...
![TikTok-Seite mit den folgenden Metriken für die angegebene Zielgruppe.][5]
