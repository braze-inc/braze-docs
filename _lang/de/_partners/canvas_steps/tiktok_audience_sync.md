...
| ------ | ----------- |
| Eingetreten | Anzahl der Benutzer, die diese Komponente eingegeben haben, die mit TikTok synchronisiert werden soll. |
...
| Canvas wurde verlassen | Anzahl der Benutzer, die den Canvas verlassen haben. Dies geschieht, wenn der letzte Schritt in einem Canvas eine Audience-Synchronisationskomponente ist. |
