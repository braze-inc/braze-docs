...
> [Dyspatch][1] bietet einen intuitiven E-Mail-Builder per Drag-and-Drop, mit dem Sie schöne, responsive und engagierte E-Mails erstellen können, ohne Code schreiben zu müssen. Arbeiten Sie mit Ihrem Team zusammen, um E-Mails in Dyspatch zu erstellen und zu genehmigen und sie dann in wenigen Schritten nach Braze zu exportieren! 
...
| ----------- | ----------- |
| Dyspatch Konto | Sie benötigen ein [Dyspatch-Konto][3] mit einer [Eigentümer- oder Administratorrolle][4], um die Vorteile dieser Partnerschaft zu nutzen. |
...
Im Feld **Lokalisierung von Exporten nach** können Sie wählen, wie Sie die Lokalisierung verwalten möchten. Mit diesem Feld können Sie [Ihre Templates für E-Mails lokalisieren][6] und nach Braze exportieren, um auf einfache Weise E-Mails zu versenden, die nach Sprache oder Region personalisiert sind. 
