...
![Segmentdetailseite für ein Shopify_Test Segment mit dem Filter für das angepasste Event "shopify_checkouts_abandon" hervorgehoben.][12]{: style="max-width:80%;"}
...
![Segmentierungsfilter für Nutzer:innen, die nach dem 17\. Oktober 2020 zum ersten Mal einen Kauf getätigt haben.][13]

![Suche nach einer bestimmten Produkt ID als Filter für die Segmentierung.][14]
...
![Aktionsbasiertes Canvas, das Nutzer:innen erfasst, die das angepasste Event "shopify_checkouts_abandon" ausführen.][5]
...
![Aktionsbasierte Kampagne, die an Nutzer:innen gesendet wird, die das angepasste Event "shopify_created_order" ausführen, wobei die verschachtelte Eigenschaft "product_id" einer bestimmten Zahl entspricht.][26]
