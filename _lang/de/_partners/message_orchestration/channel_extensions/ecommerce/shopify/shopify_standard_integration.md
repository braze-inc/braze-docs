...
{: start="2"}
2\. Wählen Sie auf der Shopify Partnerseite **Einrichtung beginnen**, um die Integration zu starten.<br><br>![Shopify Integrationsseite mit Button, um mit der Einrichtung zu beginnen.][1]<br><br> 
3\. Installieren Sie im Shopify App-Store die Anwendung Braze.<br><br>![Die Braze App Shop Seite mit einem Button zur Installation der Anwendung.][5]{: style="max-width:70%;"}
...
{: start="4"}
4\. Nach der Installation der Braze App werden Sie zu Braze weitergeleitet, um den Workspace zu bestätigen, den Sie mit Shopify verbinden möchten. Ein Shopify Shop kann sich nur mit einem Workspace verbinden. Wenn Sie wechseln müssen, wählen Sie den richtigen Workspace aus.<br><br>![Ein Fenster, das Sie auffordert zu bestätigen, dass Sie sich im richtigen Workspace befinden.][2]{: style="max-width:70%;"}

{: start="5"}
5\. Wählen Sie **Einrichtung beginnen**.<br><br>!["Integrationseinstellungen" mit einem Feld zur Eingabe der Domain und einem Button zum Starten der Einrichtung.][9]
...
![Schritt "Internet SDK aktivieren" mit Optionen zur Implementierung über eine Standardeinrichtung oder eine angepasste Einrichtung.][3]
...
![Abschnitt "Tracking von Shopify-Daten" mit einem Kontrollkästchen zum Tracking von Verhaltensdaten und Nutzer:innen-Attributen.][6]
...
![Historische Daten umschalten.][4]
...
{% alert note %}
Wenn Sie ein bestehender Braze-Kunde mit aktiven Kampagnen oder Canvase sind, lesen Sie die [Shopify Daten Features]({{site.baseurl}}/shopify_data_features/#historical-backfill) für weitere Details.
{% endalert %}
...
Wählen Sie zunächst Ihre `external_id` aus der Dropdown-Liste aus. 

![Abschnitt "Abonnent:innen sammeln".][10]
...
Zweitens haben Sie die Möglichkeit, Ihre Opt-ins für E-Mail- oder SMS-Marketing in Shopify zu sammeln. 
...
![Abschnitt "Abonnent:innen sammeln" mit der Option, Opt-ins für E-Mail- oder SMS-Marketing zu sammeln.][13]
...
![Einrichtungsschritt zur Aktivierung von Kanälen, wobei die verfügbare Option In-Browser Messaging ist.][13]

### Unterstützung für zusätzliche SDK Kanäle

Die SDKs von Braze ermöglichen verschiedene Messaging-Kanäle, darunter In-App-Nachrichten und Content-Cards.
...
![Ein Banner, das darauf hinweist, dass Sie die Einbettung der Braze App in Shopify aktivieren müssen und einen Button zum Öffnen von Shopify enthält.][7]

{: start="3"}
3\. Nachdem Sie die Einbettung der App aktiviert haben, ist Ihre Einrichtung abgeschlossen!
Bestätigen Sie, dass Sie Ihre Integrationseinstellungen, den Status der ersten Datensynchronisation und Ihre aktiven Shopify-Ereignisse einsehen können. <br><br>![Shopify Partnerseite mit den Einstellungen für die Integration.][8]
