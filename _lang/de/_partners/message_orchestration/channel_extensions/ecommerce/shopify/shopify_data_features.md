...
{% subtabs global %}
{% subtab Product viewed %}
**Veranstaltung**: `ecommerce.v1.product_viewed`<br>
...
{% endsubtab %}
{% subtab Cart updated %}
**Veranstaltung**: `ecommerce.v1.cart_updated`<br>
**Typ**: Empfohlene Veranstaltung<br>
...
{% endsubtab %}
{% subtab Checkout started %}
**Veranstaltung**: `ecommerce.v1.checkout_started`<br>
**Typ**: Empfohlene Veranstaltung<br>
**Ausgelöst**: Wenn eine Kund:in ihren Warenkorb hinzufügt, entfernt oder aktualisiert<br>
...
{% endsubtab %}
{% subtab Order placed %}
**Veranstaltung**: `ecommerce.v1.order_placed`<br>
**Typ**: Empfohlene Veranstaltung<br>
...
**Typ**: [Angepasstes Event]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_events)<br>
...
Weitere Informationen darüber, welche Daten von den Braze SDKs erfasst werden, finden Sie unter [SDK Datenerfassung]({{site.baseurl}}/user_guide/data_and_analytics/user_data_collection/sdk_data_collection/). 
