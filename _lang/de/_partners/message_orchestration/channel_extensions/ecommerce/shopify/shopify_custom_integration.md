...
## Schritt 6: Installieren Sie die Braze Shopify Integration

### Schritt 6.1: Verbinden Sie Ihren Shopify Shop
...
![Einrichtungsseite für die Integration von Shopify auf dem Braze-Dashboard.][2]

### Schritt 6.2: Enablement von Braze SDKs 
...
![Einrichtungsschritt zur Aktivierung der Braze SDKs.][3]

### Schritt 6.3: Shopify-Daten verfolgen 
...
![Einrichtungsschritt zum Tracking von Shopify Daten.][4]

### Schritt 6.4: Historische Verfüllung (optional)
...
![Abschnitt zum Einrichten des Backfill von historischen Daten.][5]
...
### Schritt 6.5: Angepasstes Tracking von Daten (Fortschritt) 
...
### Schritt 6.6: Konfigurieren Sie, wie Sie Nutzer:innen verwalten (optional)

Wählen Sie zunächst Ihre `external_id` aus der Dropdown-Liste aus. 

![Abschnitt "Abonnent:innen sammeln".][6]
...
![Abschnitt "Abonnent:innen sammeln" mit der Option, Opt-ins für E-Mail- oder SMS-Marketing zu sammeln.][9]
...
### Schritt 6.7: Produkte synchronisieren (optional)
...
![Einrichtungsschritt zur Synchronisierung von Produktdaten mit Braze.][7]

### Schritt 6.8: Kanäle aktivieren
...
### Schritt 6.9: Einrichtung abschließen
...
![Banner, das Sie auffordert, die Einbettung der Braze App in Shopify zu aktivieren, damit Sie Ihre Integration fertigstellen können.][8]
