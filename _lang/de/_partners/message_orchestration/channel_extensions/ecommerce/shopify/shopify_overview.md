...
{% alert note %}
Wenn Sie bereits Kund:in von Braze sind und über aktive Kampagnen oder Canvase verfügen, finden Sie wichtige Informationen in der [Shopify Historie]({{site.baseurl}}/shopify_features#historical-backfill). Um zu sehen, welche spezifischen Kundendaten abgefüllt werden, lesen Sie die [Shopify Features]({{site.baseurl}}/shopify_features/#shopify-data).
{% endalert %}
