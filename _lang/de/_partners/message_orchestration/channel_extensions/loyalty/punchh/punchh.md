...
3. Navigieren Sie zu **Webhooks Manager:** in der Registerkarte **Einstellungen**, wählen Sie die Registerkarte **Adapter** und klicken Sie auf **Adapter erstellen**. <br><br>![][1]<br><br>
