...
![ViralSweep Seite zur Integration von Diensten, die den Nutzer:innen zur Eingabe des Braze API-Schlüssels und der URL des Braze-Dashboards auffordert.][2]{: style="max-width:40%;"}
