...
Gehen Sie in [Friendbuy][1] zu **Entwickler:in** > **Integrationen** und wählen Sie dann auf der Braze-Integrationskarte **Integration hinzufügen**.
...
![Das Formular für die Integration von Friendbuy.][101]{: style="max-width:55%;"}

Gehen Sie zurück zu Ihrem [Friendbuy-Konto][1] und aktualisieren Sie die Seite. Wenn Ihre Integration erfolgreich war, sehen Sie eine Nachricht ähnlich der folgenden:
