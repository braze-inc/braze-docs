...
| ----------- | ----------- | ----------- | ----------- |
| `subscribed` | Ein Teilnehmer hat sich für den Erhalt von Marketingnachrichten entschieden. | -- | E-Mail  <br>Listentyp  <br>Externe ID  <br>E-Mail-Abonnement (abonniert) |
| `unsubscribed` | Ein Teilnehmer hat sich gegen den Erhalt von Extole E-Mail-Nachrichten entschieden.| E-Mail  <br>Externe ID  <br>Status des Abonnements (abgemeldet)  <br>ID der Abonnementgruppe  | Listentyp |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 role="presentation" }
