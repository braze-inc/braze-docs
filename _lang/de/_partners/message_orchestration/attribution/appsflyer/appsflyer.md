...
Mit der [AppsFlyer Audiences]({{site.baseurl}}/partners/data_and_infrastructure_agility/cohort_import/appsflyer_audiences/) Integration können Sie Ihre AppsFlyer Zielgruppen (Kohorten) direkt an Braze weitergeben, was es Ihnen erlaubt, leistungsstarke Customer-Engagement Kampagnen zu erstellen, die genau auf die richtigen Nutzer:innen zur richtigen Zeit ausgerichtet sind. 
