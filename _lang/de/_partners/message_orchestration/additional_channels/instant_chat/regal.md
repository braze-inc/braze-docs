...
#### Events
Der Leitfaden [Reporting Webhooks] von Regal][7] enthält eine vollständige Liste der von Regal veröffentlichten Reporting-Ereignisse. Dort können Sie auch Definitionen von Eigenschaften und Beispiel-Nutzdaten sehen.
...
- Braze unterstützt keine Telefonnummern als Bezeichner. Um dies als Bezeichner zu verwenden, kann die Telefonnummer in Braze als [Nutzer-Alias][8] ] festgelegt werden.
