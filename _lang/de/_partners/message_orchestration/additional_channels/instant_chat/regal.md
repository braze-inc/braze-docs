...
| Braze Data Transformation | Die Datenumwandlung befindet sich derzeit im Early Access. Wenden Sie sich an Ihren Customer-Success-Manager von Braze, wenn Sie an einer Teilnahme am Early Access interessiert sind. Dies ist notwendig, um Daten von Regal zu empfangen. |
...
{% alert important %}
Die Datenumwandlung befindet sich derzeit im Early Access. Wenden Sie sich an Ihren Customer-Success-Manager von Braze, wenn Sie an einer Teilnahme am Early Access interessiert sind.
{% endalert %}
