...
- SMS-Nachrichten werden bei Braze pro Nachrichtensegment berechnet. Wenn Sie verstehen, was ein Segment definiert und wie diese Nachrichten aufgeteilt werden, können Sie sich ein Bild davon machen, wie Sie für Nachrichten abgerechnet werden. Weitere Informationen finden Sie in unserer [Dokumentation]({{site.baseurl}}/user_guide/message_building_by_channel/sms/campaign/segments).
