...
> [Quikly][1], eine Plattform für Dringlichkeits-Marketing, nutzt die Psychologie, um Verbraucher:in zu motivieren, so dass Marken die Resonanz auf ihre wichtigsten Marketing-Initiativen sofort erhöhen können.
...
| ----------- | ----------- |
| Schnelles Konto | Um die Vorteile dieser Partnerschaft nutzen zu können, benötigen Sie ein Partnerkonto [bei Quikly][1]. |
...
Zum Beispiel:
 - Bauen Sie über Tage hinweg Vorfreude und Engagement auf, indem Sie Verbraucher:in für die Chance auf aufregende Rewards mit [Quikly Hype][3] opt-in gewinnen. First-Party-Daten werden automatisch an Braze gepusht.
 - Beschleunigen Sie die Gewinnung neuer E-Mail- und SMS-Abonnenten mit eindeutigen Realtime-Angeboten, die auf der Reaktionsgeschwindigkeit der Verbraucher:in, dem Ranking mit anderen, dem Zufallsprinzip oder vor Ablauf der Zeit oder der Mengen basieren, mit [Quikly Swap][4].
