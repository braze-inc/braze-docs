...
> [Inkit][1] und Braze ermöglichen es Unternehmen, Dokumente sicher zu erstellen und zu verteilen - sowohl digital als auch per Direkt-Mailing.
...
![Eine Auswahl der verfügbaren vorgefertigten Webhook-Templates finden Sie auf dem Tab Webhook Templates im Bereich Templates und Medien.][7]
...
![Der Code des Anfragekörpers und die Webhook-URL werden im Tab "Braze webhook builder compose" angezeigt.][5]
...
Ihr Rohtext wird automatisch hervorgehoben, wenn es sich um einen passenden Braze Tag handelt. `street`, `unit`, `state` und `zip` müssen als [angepasste Attribute][3] eingerichtet werden, um diesen Webhook zu senden.
