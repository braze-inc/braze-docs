...
> [optilyz][1] ist eine Plattform zur Automatisierung von Direkt-Mailings, mit der Sie kundenorientierte, nachhaltige und gewinnbringende Kampagnen durchführen können. 
...
Für die Integration mit Optilyz verwenden Sie die [Optilyz API][2], um Empfänger:innen-Daten an den Braze-Webhook zu senden.
...
![Die Anfrage-Header und die HTTP-Methode, die im Braze-Webhook-Builder angezeigt werden.][6]{: style="max-width:50%"}
...
![Ein Bild des Codes des Anfragekörpers und der Webhook-URL, die auf dem Braze Webhook Builder Tab angezeigt werden.][5]
...
![Verschiedene Testfelder, die im Tab Test des Braze Webhook Builders verfügbar sind.][7]
