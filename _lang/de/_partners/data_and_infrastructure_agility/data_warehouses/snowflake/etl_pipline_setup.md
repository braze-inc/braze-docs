...
page_order: 2
description: "Auf dieser Partnerseite finden Sie ein Beispiel für die Einrichtung einer E-Mail-Klick-Abfrage, das Sie bei der Einrichtung Ihrer eigenen Abfragen verwenden können."
page_type: partner
search_tag: Partner

---

# Einrichtung der ETL-Ereignis-Pipeline

> Auf dieser Partnerseite finden Sie ein Beispiel für die Einrichtung einer E-Mail-Klickabfrage, auf das Sie sich bei der Einrichtung Ihrer eigenen Abfragen beziehen können.

Sie können diese Abfrage für E-Mail-Klicks verwenden, um die Interaktionen mit bestimmten E-Mails in Ihren Braze-Kampagnen und Canvases zu analysieren.
...
Kopieren Sie die `notification_channel` aus der Ausgabe des vorangegangenen Befehls und verwenden Sie diese bei der Konfiguration der S3-Bucket-Benachrichtigungen.
...
Zeigen Sie schließlich die Kopierhistorie für die Tabelle an, indem Sie `*` wählen von:
```sql
