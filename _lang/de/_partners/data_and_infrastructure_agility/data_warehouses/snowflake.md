...
- **Keine Datensilos mehr**<br>Schaffen Sie eine ganzheitliche Sicht auf Ihre Kunden über alle Kanäle und Plattformen hinweg. Die gemeinsame Nutzung von Daten macht es einfacher als je zuvor, Ihre Braze-Kundenbindungsdaten mit all Ihren anderen Snowflake-Daten zu verknüpfen. So erhalten Sie umfassendere Einblicke über eine einzige, zuverlässige Quelle der Wahrheit.
...
## Verwendung und Visualisierung
 ...
 Beachten Sie jedoch, dass die gemeinsam genutzten Daten schreibgeschützt sind und nur abgefragt, aber nicht verändert oder gelöscht werden können.
