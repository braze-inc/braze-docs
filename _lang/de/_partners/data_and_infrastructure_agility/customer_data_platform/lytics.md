...
Navigieren Sie in Braze zu **Zielgruppe** > **Segmente**. Suchen Sie das Segment, das Sie exportieren möchten, und wählen Sie dann <i class="fas fa-gear" aria-label="Einstellungen"></i> und dann **CSV-Benutzerdaten exportieren**. Sie können bis zu 500.000 Benutzer in ein Segment exportieren. 
