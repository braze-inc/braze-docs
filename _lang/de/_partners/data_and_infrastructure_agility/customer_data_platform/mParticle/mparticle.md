...
- [Senden Sie die Interaktion von Braze-Nutzern:innen über Currents an mParticle]({{site.baseurl}}/partners/data_and_infrastructure_agility/customer_data_platform/mParticle/mparticle_for_currents/) und machen Sie sie im gesamten Growth Stack nutzbar. 
...
![mParticle Segmente Mitgliedschaft][6]
...
![mParticle angepasstes Attribut][7]
...
- **Einzelnes Attribut eines Arrays:** Wählen Sie `SegmentMembershipArray` als Ihren Filter aus. Verwenden Sie als nächstes die Option "enthält Wert" und geben Sie die gewünschte Zielgruppen-ID ein. ![mParticle Segmente-Filter "SegmentMembershipArray" als "enthält Wert" und Zielgruppen-ID eingestellt.][11]<br><br>
- **Ein Attribut pro Segment:** Wählen Sie Ihr angepasstes Attribut als Filter aus. Verwenden Sie dann die Option "gleich" und wählen Sie die entsprechende Logik. ![mParticle Segmente Filter "in möglichen Parisern" als "gleich" und "wahr" eingestellt.][8]
