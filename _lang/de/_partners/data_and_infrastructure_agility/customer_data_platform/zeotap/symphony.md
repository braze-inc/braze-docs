...
| Telefon | Statisches Mapping | Im Zeotap-Katalog ist dies auf `Mobile Raw` abgebildet.<br><br>\- Braze akzeptiert Telefonnummern im Format `E.164`. Zeotap führt keine Transformation durch. Daher müssen Sie die Telefonnummern in dem vorgeschriebenen Format eingeben. Weitere Informationen finden Sie unter [Benutzertelefonnummern]({{site.baseurl}}/user_guide/message_building_by_channel/sms/phone_numbers/user_phone_numbers/). |
