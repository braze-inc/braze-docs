...
- **Operation Benutzerdefinierte Attribute verwenden**:  Weitere Informationen finden Sie unter [Senden von Benutzermerkmalen als verschachtelte benutzerdefinierte Attribute](https://www.rudderstack.com/docs/destinations/streaming-destinations/braze/#send-user-traits-as-nested-custom-attributes).
...
{% alert note %}
Für die Vorgänge Aktualisieren und Entfernen ist `identifier` ein erforderlicher Schlüssel. Wenn die Operationen Hinzufügen, Aktualisieren oder Entfernen in dem verschachtelten Array nicht vorhanden sind, verwendet RudderStack standardmäßig die Operation Erstellen, um die Eigenschaften zu erstellen. 
{% endalert %}
