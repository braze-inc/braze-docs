...
{% alert important %}
Tealium AudienceStreams und EventStreams bieten sowohl Batch- als auch Non-Batch-Connector-Aktionen.  Wenden Sie sich an den [Braze-Support]({{site.baseurl}}/braze_support/) oder Ihren Kundenbetreuer, wenn Sie irgendwelche Fragen haben.
{% endalert %}
