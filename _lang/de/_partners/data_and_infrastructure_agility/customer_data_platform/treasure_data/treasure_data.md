...
> [Treasure Data][4] ist eine Customer Data Platform (CDP), die Informationen aus verschiedenen Quellen sammelt und an eine Vielzahl anderer Standorte in Ihrem Marketing Stack weiterleitet.
...
![Die Seite "Ergebnisse exportieren". Auf dieser Seite befinden sich Felder für "Modus", "Tracking-Datensatztyp" und "Vorformatierte Felder". In diesem Beispiel sind "User-Track" und "Angepasste Events" auf diese Felder eingestellt.][3]{: style="max-width:80%;"}
...
Nutzer:innen von Treasure Data können Daten über die öffentliche REST API aufnehmen. Sie können Treasure Data verwenden, um angepasste Webhooks für Ihre Daten zu erstellen. Um mehr zu erfahren, besuchen Sie [Treasure Data][6]
