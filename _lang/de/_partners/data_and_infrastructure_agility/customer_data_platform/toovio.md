...
| Braze-Currents | Mit Braze Currents können Braze-Clients Ereignis- oder Verhaltensdaten an einen Braze-Datenpartner (AWS S3, Google Cloud Storage oder Microsoft Azure Blob Storage) zur Verarbeitung außerhalb der Braze-Plattform streamen. |
