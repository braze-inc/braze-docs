...
> [Zapier][1] ist ein Internet-Tool für die Automatisierung, das es Ihnen erlaubt, Daten zwischen Web-Apps auszutauschen und diese Informationen dann zur Automatisierung von Aktionen zu verwenden. 

Die Partnerschaft zwischen Braze und Zapier nutzt die Braze API und die [Braze-Webhooks][3] für die Verbindung mit Anwendungen von Drittanbietern - wie Google Workplace, Slack, Salesforce, WordPress usw. - um verschiedene Aktionen zu automatisieren.
...
| Braze REST Endpunkt | Ihre URL für den REST-Endpunkt. Ihr Endpunkt hängt von der [Braze-URL für Ihre Instanz][0] ab. |
