...
Die Personalisierungs-API von Hightouch bietet einen REST-Endpunkt zur Verwendung in Ihrer Braze-Konfiguration.  Die von dieser API bereitgestellten Daten können Kunden-, Produkt- oder andere Objektdaten darstellen. 
