...
Die Integration von Braze und Mixpanel erlaubt es Ihnen, [Mixpanel Kohorten in Braze zu importieren]({{site.baseurl}}/partners/data_and_infrastructure_agility/cohort_import/mixpanel/), um Braze Segmente zu erstellen, die für das Targeting von Nutzern:innen in zukünftigen Kampagnen oder Canvase verwendet werden können. Sie können Braze-Currents auch nutzen, um [Ihre Braze-Events nach Mixpanel zu exportieren](#data-export-integration) und so tiefere Analytics zu Konversionen, Bindung und Produktnutzung zu erhalten. 
...
Wenden Sie sich an Ihren Account Manager:in oder öffnen Sie ein [Support-Ticket][support], wenn Sie Zugang zu zusätzlichen Veranstaltungsberechtigungen benötigen.
