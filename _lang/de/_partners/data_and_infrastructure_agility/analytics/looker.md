...
- [Analytics-Block für das Engagement von Nachrichten README][2]
- [Block für Verhaltensanalysen Nutzer:in README][3]
...
5. Wählen Sie unter **Erweiterte Optionen** **Ergebnisse in Tabelle** oder **Alle Ergebnisse** und dann **Senden**.<br><br>![][13]<br><br>Wenn der Export korrekt gesendet wurde, dann sollte `LOOKER_EXPORT` im Profil des Nutzers:in als angepasstes Attribut mit dem Wert erscheinen, den Sie in der Aktion eingegeben haben.<br><br>![][14]
...
## Fehlersuche
Wenn Sie Probleme mit der Looker-Aktion haben, fügen Sie einen Testnutzer:in zu [interne Gruppen][16] ] hinzu und überprüfen Sie, ob die folgenden Punkte erfüllt sind:
