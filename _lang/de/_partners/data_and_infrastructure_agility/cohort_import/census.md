...
> Dieser Artikel beschreibt, wie Sie Nutzer:innen-Kohorten aus [Census][1] nach Braze importieren. Weitere Informationen zur Integration von Census finden Sie im [Hauptartikel zu Census]({{site.baseurl}}/partners/data_and_infrastructure_agility/workflow_automation/census/).
...
7. Abschließend ordnen Sie die Census Datenfelder den entsprechenden Braze Feldern zu.<br>![Census-Abbildung][11]{: style="max-width:80%;"}<br><br>
