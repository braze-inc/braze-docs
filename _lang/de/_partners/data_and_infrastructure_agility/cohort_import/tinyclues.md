...
![In der Segmentierung von Braze ist der Filter für die Nutzer:innen-Attribute "Tinyclues Kohorte" auf "umfasst" und "Primärkohorte" eingestellt.][4]{: style="max-width:90%;"}
...
![Im Braze Kampagnen-Builder ist im Schritt Targeting der Filter "Nutzer:innen nach Segmenten zusammenstellen" auf "Tinyclues Kohorte" eingestellt.][5]{: style="max-width:90%;"}
...
![Unten auf der Detailseite der Kampagne wird der Name Ihrer Kohorte angezeigt.][2]{: style="max-width:30%;"}
