...
> Dieser Artikel beschreibt, wie Sie Nutzer:innen-Kohorten aus [Kubit](https://kubit.ai/) nach Braze importieren. Weitere Informationen zur Integration von Kubit und seinen anderen Funktionalitäten finden Sie im [Hauptartikel zu Kubit]({{site.baseurl}}/partners/data_and_infrastructure_agility/analytics/kubit/).
