...
- **Canvas:** Erstellen Sie aus einem neuen oder bestehenden Canvas einen Voll- oder Nachrichtenschritt im Canvas-Builder. Klicken Sie dann auf **Nachrichten** und wählen Sie **Webhook** aus den Nachrichtenoptionen.
