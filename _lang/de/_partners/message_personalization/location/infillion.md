...
| ---| ---|
| [Infillion Manager:in](https://manager.gimbal.com/login/users/sign_in) | Um die Vorteile dieser Partnerschaft zu nutzen, benötigen Sie ein Infillion Manager:in-Konto. |
...
2. Verwenden Sie die [REST API](https://docs.gimbal.com/rest.html) von Infillion, um Nutzer:innen zu erhalten `places`.
