...
| ----------- | ----------- |
| Klugscheißer-Konto | Um die Vorteile dieser Partnerschaft zu nutzen, benötigen Sie ein [Smartling-Konto][2]. |
...
* Einzelheiten zur Konfiguration des Konnektors finden Sie in der [Dokumentation von Smartling][3].
...
1. Erstellen Sie in [Smartling][2] einen [Braze Konnektor-Projekttyp][6] in Ihrem Smartling-Konto.
...
Einzelheiten zur Konfiguration des Konnektors finden Sie in der [Dokumentation][3] von Smartling.
...
![Konfiguration der Sprache des Konnektors.][8]

### Schritt 2: Inhalte an Smartling senden

Sobald der Konnektor von Braze angeschlossen und eingerichtet ist, finden Sie Braze-Inhalte auf dem Tab **Braze** in Ihrem Smartling-Projekt. Lesen Sie die [Dokumentation][7] von Smartling, um mehr zu erfahren.
