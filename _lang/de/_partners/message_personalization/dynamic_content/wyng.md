...
> [Wyng][0] macht es Ihnen leicht, interaktive digitale Erlebnisse (d.h. Quiz, Präferenzzentren, Aktionen) zu erstellen, die Verbraucher:in den richtigen Momenten einbinden, Präferenzen und andere Zero-Party-Daten erfassen und in Realtime personalisieren.
...
Gehen Sie in Wyng zu [**Integrationen**][1] und wählen Sie den Tab **Hinzufügen**. Bewegen Sie dann den Mauszeiger über **Braze** und klicken Sie auf **Verbinden** für die Integration.

![Die Braze Partner-Kachel in der Wyng Plattform.][2]{: style="max-width:80%;"}
...
![Ein Bild, das zeigt, wie die Eingabeaufforderung für die Zugangsdaten aussieht.][4]{: style="max-width:80%;"}<br><br>
2. Wählen Sie dann aus der Dropdown-Liste die Wyng-Kampagne aus, die Sie mit Braze teilen möchten.![Ein Bild des Konnektors von Braze, der Sie auffordert, eine bestehende Wyng-Kampagne auszuwählen, die Sie mit Braze teilen möchten.][5]{: style="max-width:80%;"}<br><br>
...
Um Nutzer:innen für Abo-Gruppen zu abonnieren, klicken Sie auf **Abonnement hinzufügen** und fügen Sie den Namen und die ID Ihrer Abo-Gruppe hinzu. Um mehrere Gruppennamen und IDs hinzuzufügen, klicken Sie erneut auf den Button **Abonnement hinzufügen**.<br>![Ein Bild, das Sie auffordert, den Namen und die ID einer Abo-Gruppe einzugeben.][8]{: style="max-width:80%;"}<br><br>
- **Nutzer:innen Tracking einrichten**<br>
Klicken Sie auf **Angepasste Eigenschaft hinzufügen**, um Attribut- und Ereignisobjektpaare hinzuzufügen, die an den Endpunkt `/users/track` gesendet werden sollen. Verwenden Sie diese Option, um fest kodierte Attributwerte für jede Datentransaktion hinzuzufügen, die für die Integration gesendet wird. Um mehrere Eigenschaften hinzuzufügen, klicken Sie erneut auf den Button **Angepasste Eigenschaft hinzufügen**.<br>![Ein Bild, das Sie auffordert, angepasste Attribute Eigenschaften hinzuzufügen.][9]{: style="max-width:80%;"}<br><br>
- **Angepasstes Event senden**<br>
Optional können Sie das **Senden von angepassten Events** aktivieren. Falls aktiviert, sollten Sie den Ereignisnamen und die entsprechende App ID angeben.<br>![Ein Bild, das Sie auffordert, angepasste Events zu senden, falls erforderlich.][10]{: style="max-width:80%;"}<br><br>
...
Die Anwendungen sind breit gefächert, und spezifische Fragen können Sie an [contact@wyng.com][13] oder an Ihren spezifischen Account Manager:in richten.
...
![Ein Beispiel für ein Fehlerprotokoll auf der Wyng Plattform.][16]{: style="max-width:80%;"}

Sollten Sie weitere Fragen haben, wenden Sie sich bitte an den Wyng-Support ([support@wyng.com][13]), um Hilfe zu erhalten.
