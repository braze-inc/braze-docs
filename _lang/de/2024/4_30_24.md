...
[Just-in-Time-Bereitstellung]({{site.baseurl}}/user_guide/administrative/access_braze/single_sign_on/saml_jit) funktioniert mit SAML SSO, sodass neue Unternehmensnutzer:innen bei ihrer ersten Anmeldung ein Braze-Konto erstellen können. Dadurch entfällt für Administratoren die Notwendigkeit, manuell ein Konto für einen neuen Nutzer:in zu erstellen, dessen Berechtigungen auszuwählen, ihn einem Workspace zuzuweisen und darauf zu warten, dass er sein Konto aktiviert.
