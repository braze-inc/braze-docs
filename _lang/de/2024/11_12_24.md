...
Sie können LinkedIn jetzt mit [Braze Audience Sync]({{site.baseurl}}/partners/canvas_audience_sync/) nutzen, einem Tool, mit dem Sie die Reichweite Ihrer Kampagnen auf viele der wichtigsten sozialen und Werbetechnologien ausweiten können. Um an der Beta-Phase teilzunehmen, wenden Sie sich bitte an Ihren Braze-Success-Manager:in.
...
|Vor|Nach|
|------|-----|
|![Die alte Navigation für das Braze-Entwicklerhandbuch.]({% image_buster /assets/img/release_notes/developer_guide_improvements/old_navigation.png %})|![Die neue Navigation für den Braze-Entwickler:in-Guide.]({% image_buster /assets/img/release_notes/developer_guide_improvements/new_navigation.png %})|
