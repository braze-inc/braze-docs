...
## CurrentsとSnowflakeのデータ共有message_extrasLiquidタグ
...
### Sendbird - メッセージング
Brazeと[Sendbird]({{site.baseurl}}/partners/additional_channels_and_extensions/additional_channels/instant_chat/sendbird/)の連携により、企業ユーザーは以下のことが可能となる：
