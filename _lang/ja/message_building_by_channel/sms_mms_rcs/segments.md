...
<form id="sms_split">
  ...
  <br />
  <input type="checkbox" id="segment_section" name="segment_section"> <label for="segment_section" style="padding-left: 5px; margin-bottom: 0px;">セグメントを表示する： </label>
...
シングルRCSメッセージとは、160文字を超えるか、ボタンやメディアなどのリッチ要素を含むメッセージのことである。これらはメッセージの長さに関係なく、1つのメッセージとして請求される。
