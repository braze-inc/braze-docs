...
| メッセージの種類 | 例 | 説明 |
|---|---|---|
|[クラシック]({{site.baseurl}}/user_guide/message_building_by_channel/content_cards/creative_details/#classic)| ![ワークアウトクラスの予約を促す小さなアイコンとテキストを持つクラシックコンテンツカード。]({% image_buster/assets/img_archive/cc_steppington_classic.png %})() |クラシックカードには、太字のタイトル、メッセージテキスト、オプションの"画像があり、タイトルとテキストの左側に配置されています。クラシックカードには正方形の画像やアイコンを使うことがいます。 |
