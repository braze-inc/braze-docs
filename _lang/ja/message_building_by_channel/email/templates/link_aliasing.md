...
![Tracked Link Aliases ページ。"TechPartners"および"Help"という2 つのリンクエイリアスが表示されます。これらのエイリアスは、"Email_Survey".]({% image_buster /assets/img/tracked_aliases.png %} という名前のキャンペーンに関連付けられ
