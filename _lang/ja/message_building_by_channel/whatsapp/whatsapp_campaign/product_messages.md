...
![パートナーとカタログを共有するためのウィンドウ。パートナービジネス ID を入力し、「Manage catalog」権限を割り当てるためのフィールドが表示されている。]({% image_buster /assets/img/whatsapp/share_meta_catalog.png %})({: style="max-width:70%;"})
