...
次に、[**テンプレートを作成**] を選択します。<br><br>![メッセージテンプレートs の一覧を含むWhatsAppマネージャ。]({% image_buster /assets/img/whatsapp/whatsapp2.png %}){: style="max-width:100%;"}<br><br>
2. **メッセージの設定**<br>
