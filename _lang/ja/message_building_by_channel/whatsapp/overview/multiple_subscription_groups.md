...
![ワークスペースとWhatsApp Businessアカウントの相互接続を示す、Braze と WhatsApp のエコシステム図: 1 つの購読グループを 1 つの電話番号に、複数の WhatsApp Business アカウントを 1 つのワークスペースに、1 つのワークスペースを複数の Meta Business ポートフォリオに接続できる。 
