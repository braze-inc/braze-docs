...
## ドラッグ&＆ドロップエディタ用コンテンツブロック

ドラッグ&＆ドロップエディター専用に使用される[コンテンツブロック]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/content_blocks/)は、異なるチャネル全体で使用されるコンテンツブロックと機能が似ている。様々なメールキャンペーンで参照できる情報を一元管理できる。これには、Eメールのヘッダーやプロモーションの吹き出しなどを、再利用可能な1つの行にまとめることも含まれる。
