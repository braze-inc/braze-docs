...
2022年4月現在、Android開発者はGoogle Playの[データ安全フォーム][4]を完了し、プライバシーとセキュリティ対策を開示しなければならない。[このガイド]({{site.baseurl}}/developer_guide/platform_integration_guides/android/google_play_privacy#google-play-privacy-questionnaire)は、Brazeがアプリデータをどのように処理するかに関する情報を含む新しいフォームの記入方法についての指示を提供します。 
