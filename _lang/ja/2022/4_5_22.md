...
ドラッグ&＆ドロップエディタの[グローバルスタイル設定]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/dnd_email_style_settings/)を紹介する！デフォルトテーマの追加、基本的なテキストスタイルの設定など、メールキャンペーンやキャンバスの見た目を簡単にパーソナライズできるようになった。
