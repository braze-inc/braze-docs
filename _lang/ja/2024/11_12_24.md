...
LinkedInを[Braze Audience Sync]({{site.baseurl}}/partners/canvas_audience_sync/) で利用できるようになりました。[Braze Audience Syncは]({{site.baseurl}}/partners/canvas_audience_sync/)、トップクラスのソーシャルテクノロジーや広告テクノロジーの多くにキャンペーンのリーチを広げるのに役立つツールだ。ベータ版に参加するには、Braze サクセスマネージャにお問い合わせください。
