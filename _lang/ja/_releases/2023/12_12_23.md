...
Braze と[SmarterSends]({{site.baseurl}}/partners/message_orchestration/templates/smartersends/) パートナーシップにより、Braze の能力と、分散ユーザー が所有するハイパーローカライズされたコンテンツを組み合わせて、マーケティング キャンペーンs を向上させることができます。
