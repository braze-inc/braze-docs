...
[`Live Activities Push to Start Registered for App` フィルター]({{site.baseurl}}/user_guide/engagement_tools/segments/segmentation_filters#live-activites-push-to-start-registered-for-app) Segmentは、指定されたアプリのiOS プッシュ通知 s を介してLive Activity を起動するために登録されているかどうかによって、ユーザー を制御します。
