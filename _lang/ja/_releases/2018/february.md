...
[メールテンプレートを API を介して]({{site.baseurl}}/developer_guide/rest_api/email_templates/#email-templates)作成および更新できるようになりました。各テンプレートは、他のAPIコールで参照できる **email_template_id**を持つ。
