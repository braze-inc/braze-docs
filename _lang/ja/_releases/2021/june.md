...
新しい[`hmac_sha1`と`hmac_sha256`リキッドエンコードフィルター]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/liquid/advanced_filters/)がBraze プラットフォームに追加されました。
