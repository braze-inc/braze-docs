...
> [Wunderkindは](https://www.wunderkind.co)、パフォーマンスの高い1対1のメール送信によってeコマースの収益を拡大するプラットフォームである。Wunderkind の識別技術により、ブランドは、実用的なメールアドレスに至るまで、デバイス間でより多くの匿名ユーザーを認識することができます。平均して、Wunderkindは識別の割合をウェブサイトトラフィックの3～5%から～40～60%に拡大している。

_この統合はWunderkindによって維持されている。_
