...
nav_title: Toovio
article_title:トゥービオ
description:"この参考記事では、Brazeとデータ・アズ・ア・サービス企業であるToovioのパートナーシップについて概説している。"Toovioは、アクション可能なデータを発見し、最も重要な要素を使用して、事前に定義された目標に基づいて、段階的に成果を上げることを支援する。
...
> [Toovioは](https://toovio.com/)、人工知能を搭載したデータ・アズ・ア・サービス企業であり、アクション可能なデータを発見し、最も重要な要素を使用して、事前に定義された目標に基づき、段階的に成果を上げることを支援する。

BrazeとToovioのパートナーシップは、ほぼリアルタイムのメッセージトリガー、パフォーマンスを向上させるツール、Toovioの高度なキャンペーン測定ツールへのアクセスを提供する。
...
これにより、Toovioはユーザーイベントおよび行動データにアクセスし、処理することができる。
...
[info@toovio.com](mailto:info@toovio.com?subject=New%20Customer%20Request)、件名を「新規顧客リクエスト」としてToovioに連絡し、アカウントを設定する。トゥービオはクライアントと協力してトリガーや基礎となるモデルを設定する。
