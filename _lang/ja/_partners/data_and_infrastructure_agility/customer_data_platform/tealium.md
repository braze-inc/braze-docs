...
guide_top_text:「Tealiumは、Web、モバイル、オフライン、IoTデバイスにまたがる顧客データを結びつけ、ブランドが顧客とつながるのを支援する。Tealiumのターンキー統合エコシステムは、1,200を超えるクライアントサイドとサーバーサイドのベンダーとテクノロジーをサポートし、ブランドがリアルタイムで統一された顧客データインフラを構築できるようにする。
description:"このランディングページには、統合ガイダンス、Tealium AudienceStream、Tealium for Currentsなど、Tealiumに関するあらゆることが掲載されている。"
