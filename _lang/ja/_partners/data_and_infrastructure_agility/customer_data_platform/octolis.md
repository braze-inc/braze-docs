...
| Braze REST API キー | [**users.track**][1] 権限を持つBraze REST API キー。<br><br> これは、Brazeダッシュボードの**「設定」**>「**APIキー**」から作成できる。 |
...
| フィールド | 説明 |
| --- | --- |
| Where do you want to sync the audience to? | レコードを作成または更新するBrazeエンティティ。 |
