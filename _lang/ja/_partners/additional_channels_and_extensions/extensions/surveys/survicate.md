...
BrazeとSurvicateは協力して、様々なフィードバックのユースケースをカバーし、アクション可能なユーザーインサイトを収集し、カスタマーエクスペリエンスを向上させている：
...
![ワークスペースAPIキーとBrazeインスタンスURLを入力するフィールド。]({% image_buster /assets/img/survicate/image1.png %})
