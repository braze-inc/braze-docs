...
> クエリビルダーを使用すると、Snowflake の Braze データを使用してレポートを生成できます。クエリビルダーには、事前組み込みの SQL [クエリテンプレート]({{site.baseurl}}/user_guide/data_and_analytics/query_builder/query_templates/)が付属しているので、すぐに始めることができます。また、独自のカスタム SQL クエリを作成して、より多くのインサイトを得ることもできます。

## アクセスできるユーザー

\[\[B$PSEUDOe$PSEUDOc$PSEUDOa$PSEUDOu$PSEUDOs$PSEUDOe$PSEUDO t$PSEUDOh$PSEUDOi$PSEUDOs$PSEUDO f$PSEUDOe$PSEUDOa$PSEUDOt$PSEUDOu$PSEUDOr$PSEUDOe$PSEUDO a$PSEUDOl$PSEUDOl$PSEUDOo$PSEUDOw$PSEUDOs$PSEUDO d[]({{site.baseurl}}/user_guide/administrative/manage_your_braze_users/user_permissions/)]]
...
{:start="2"}
2\.\[\[S$PSEUDOe$PSEUDOl$PSEUDOe$PSEUDOc****]]クエリの作成にヒントやヘルプが必要な場合は、\[**クエリテンプレート**] を選択し、リストからテンプレートを選択します。それ以外の場合は、\[**SQL エディター**] を選択してエディターに直接移動します。
...
5. \[**クエリを実行**] をクリックします。
6. クエリを保存します。
7. \[\[T$PSEUDOo$PSEUDO d$PSEUDOo$PSEUDOw$PSEUDOn$PSEUDOl$PSEUDOo$PSEUDOa$****]]

\[\[![Q$PSEUDOu$PSEUDOe$PSEUDOr$PSEUDOy$PSEUDO B$PSEUDOu$PSEUDOi$PSEUDOl$PSEUDOd$PSEUDOe$PSEUDOr$PSEUDO s$PSEUDOh$PSEUDOo$PSEUDOw$PSEUDOi$PSEUDOn$PSEUDOg$PSEUDO t$PS]{% image_buster /assets/img_archive/query_builder.png %}]]
...
2. \[\[T$PSEUDOy$PSEUDOp$PSEUDOe$PSEUDO i$PSEUDOn$PSEUDO y$PSEUDOo$PSEUDOu$PSEUDOr$PSEUDO p$PSEUDOr$PSEUDOo$PSEUDOm$PSEUDOp$PSEUDOt$PSEUDO o$PSEUDO****]]
3. \[\[R$PSEUDOe$PSEUDOv$PSEUDOi$PSEUDOe$PSEUDOw$PSEUDO t$PSEUDOh$PSEUDOe$PSEUDO g$PSEUDOe$PSEUDOn$PSEUDOe$PSEUDOr$PSEUDOa$PSEUDOt$PSE****]]
...
\[\[R$PSEUDOe$PSEUDOp$PSEUDOo$PSEUDOr$PSEUDOt$PSEUDOs$PSEUDO t$PSEUDOh$PSEUDOa$PSEUDOt$PSEUD]]これが、ある時点で実行する最初のクエリである場合、処理に時間がかかるため、タイムアウトする可能性が高くなります。タイムアウトした場合は、レポートをもう一度実行してみてください。

\[\[I$PSEUDOf$PSEUDO a$PSEUDO r$PSEUDOe$PSEUDOp$PSEUDOo$PSEUDOr$PSEUDOt$PSEUDO t$PSEUDOi$PSEUDOm$PSEUDOe$PSEUDOs$PSEUDO o$PS[]({{site.baseurl}}/help/support#braze-support)]]

## クエリテンプレート

すべてのテンプレートは、過去 60 日間のデータを読み込んで表示できます。クエリテンプレートにアクセスするには、最初にレポートを作成するときに \[**SQL クエリを作成**] > \[**クエリテンプレート**] を選択します。

\[\[S$PSEUDOe$PSEUDOe$PSEUDO [Q$PSEUDOu$PSEUDOe$PSEUDOr$PSEUDOy$PSEUDO t$PSEUDOe]({{site.baseurl}}/user_guide/data_and_analytics/query_builder/query_templates/)]]
...
| \[\[D$PSEUDOa$PSEUDOt$PSE]] | 説明 | \[\[R$PSEUDOe$PSEUDOq$PSE]] |
| --- | --- | --- |
| \[\[R$PSEUDOe$P]] | \[\[A$PSEUDOl$PSEUDOl$PSEUDOo$PSEUDOw$PSEUDOs$PSEUDO y$]] | \[\[R$PSEUDOe$PS`start_date`]] |
| 開始日 | \[\[A$PSEUDOl$PSEUDOl$PSEUDOo$PSEUDOw$PSEUDOs$PSEUD]] | \[\[R$PSEUDOe$PS`start_date`]] |
| 終了日 | \[\[A$PSEUDOl$PSEUDOl$PSEUDOo$PSEUDOw$PSEUDOs$PSEU]] | \[\[R$PSEUDOe$PS`end_date`]] |
| 期間 | \[\[A$PSEUDOl$PSEUDOl$PSEUDOo$PSEUDOw$PSEUDOs$PSEUDO y$PSEUDOo$PSEUDO]] | \[\[R$PSEUDOe$PSEUDOq$PSEUDOu$`start_date``end_date`]] |
...
\[\[![Q$PSEUDOu$PSEUDOe$PSEUDOr$PSEUDOy$PSEUDO B$PSEUDOu$PSEUDOi$PSEUDOl$PSEUDOd$PSEUDOe$PSEUDOr$PSEUDO ][1]{: style="max-width:60%;"}]]
