...
![Shopify_Test セグメントの Segment 詳細ページ。カスタムイベント「shopify_checkouts_abandon」のフィルターがハイライトされている。]({% image_buster /assets/img/Shopify/shopify_segmentation2.png %}){: style="max-width:80%;"}
...
![2020年10月17日以降に初めて購入したユーザーを対象としたセグメンテーションフィルター。]({% image_buster /assets/img/Shopify/shopify_segmentation3.png %})

![セグメンテーションのフィルターでの特定の商品 IDの検索。]({% image_buster /assets/img/Shopify/shopify_segmentation4.png %})
...
![カスタムイベント「shopify_checkouts_abandon」を実行したユーザーを入力するアクションベースのキャンバス。]({% image_buster /assets/img/Shopify/shopify_integration11.png %})
...
![カスタムイベント「shopify_created_order」を実行し、ネストされたプロパティ「product_id」が特定の数字と等しいユーザーに送信するアクションベースのキャンペーン。]{% image_buster /assets/img/Shopify/shopify_integration17.png %}
