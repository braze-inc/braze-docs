...
> [Olo](https://www.olo.com/) は、あらゆるタッチポイントでの応対を可能にする飲食店向けの大手オープン SaaS プラットフォームです。
...
Olo ダッシュボード内の[セルフサービス Webhooks ツール](https://olosupport.zendesk.com/hc/en-us/articles/360061153692-Self-Service-Webhooks)を使用して、Data Transformation に送信する Webhook を設定します。
...
{:start="3"}
3\.[テストイベント](https://developer.olo.com/docs/load/webhooks#operation/test)を Data Transformation に送信して、Webhook が正しく設定されていることを確認します。テストイベントを送信できるのは、[Developer Tools 権限を](https://olosupport.zendesk.com/hc/en-us/articles/115001427843-Dashboard-Permissions)持つ Olo Dashboard ユーザのみである。
...
Braze で Data Transformation を有効化したら、Olo ダッシュボード内の[セルフサービス Webhook ツール](https://olosupport.zendesk.com/hc/en-us/articles/360061153692-Self-Service-Webhooks)を使用して Webhook を公開します。Webhook が公開されると、Data Transformation はOlo Webhook イベントメッセージの受信を開始します。
