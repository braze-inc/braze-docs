...
![「Kitchenerieが通知を送信することを許可しますか?」を求めるAndroidのプッシュメッセージで、メッセージの下部に「許可」と「許可しない」の2つのボタンがあります。]({% image_buster /assets/img/android/android-13-push-prompt.png %}){: style="float:right;max-width:430px;width:50%;margin-left:15px;border:0"}
