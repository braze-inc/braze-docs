...
TikTokパートナーページで、TikTokアカウントがBrazeに正常に接続されていることを確認する。次に、広告アカウントを選択し、新しいオーディエンスの名前を入力し、一致するフィールドを選択していることを確認する。

### TikTokにユーザーを渡した後、ユーザーがマッチしたかどうかを知るには？

TikTokはデータプライバシーポリシーに関するこの情報を提供していません。

### TikTokにオーディエンスが登録されるまで、どのくらいかかる？

オーディエンスのサイズは、TikTokの広告マネージャーのオーディエンスページで24〜48時間以内に更新されます。

### TikTok広告アカウントに設定できるオーディエンスの最大数は？

TikTok広告アカウント1つにつき、最大400オーディエンスまで設定できる。

### TikTokのオーディエンスサイズやマッチ率が、Audience SyncでBrazeに同期されたユーザーよりも高いのはなぜか？

TikTokでは、1つのIDが複数のTikTokユーザーに関連付けられている場合があるからだ。これは、クライアントがモバイル広告ID（iOS IDFAおよびAndroid GAID）を使用している場合に最もよく発生する現象で、1つのデバイスに複数のTikTokユーザーがログインしている可能性があるためだ。 

さらに、TikTokはPangleユーザーもマッチングユーザーとしてカウントしているため、場合によってはマッチング率が高くなることもある。しかし、広告配信にオーディエンスを使用する場合、プレースメントやその他の影響要因に左右されるため、実際に配信可能なオーディエンスサイズはマッチしたユーザーサイズほど高くならない可能性がある。
