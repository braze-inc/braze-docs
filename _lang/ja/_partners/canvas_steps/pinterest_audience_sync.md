...
Braze ダッシュボードで、**Partner Integrations**> **Technology Partners**に移動し、**Pinterest**を選択します。Pinterest Audience Export (Pinterest オーディエンスエクスポート) モジュールで、\[**Pinterest に接続**] をクリックします。
