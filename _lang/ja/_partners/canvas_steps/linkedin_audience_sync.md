...
### オーディエンスサイズがLinkedInに反映されるまでどのくらいかかるのか？

LinkedIn アカウント内のオーディエンスを表示するのに最大48時間の遅延があります。

### LinkedInが広告アカウントに入力するオーディエンスの最小サイズは？
...
LinkedInパートナーページで、LinkedIn広告アカウントがBrazeに正常に接続されていることを確認する。次に、広告アカウントを選択し、新しいオーディエンスの名前を入力し、一致するフィールドを選択していることを確認する。

### ユーザーを LinkedIn に渡した後、ユーザーが一致したかどうかを知るにはどうすればよいですか？

LinkedInはダッシュボードでマッチ率に関する情報を提供している。LinkedIn の [**オーディエンス**] セクションで確認できます。LinkedInオーディエンスのマッチ率は、オーディエンス同期ステップのキャンバスステップ詳細で確認できる。

### LinkedInは何人のオーディエンスに対応できるのか？

現在、LinkedIn アドアカウントのオーディエンス数に制限はありません。

### セグメンテーションがBUILDINGステータスに留まり、更新されないのはなぜか？
