...
開始するには、**パートナー統合** > **テクノロジーパートナー** > **Google 広告** に移動し、**Google 広告を接続** を選択します。
...
Google オーディエンス同期の下で、[**モバイル広告 ID を追加**] を選択し、iOS アプリ ID と Android アプリ ID (アプリパッケージ名) を入力して、それぞれ保存します。
...
Braze では、これらのオーディエンスが最新の状態であるようにするために、既存の Google 顧客リストからユーザーを追加または削除することもできます。

1. 
2. 
3.  
4. Google オーディエンスステップには、新しいオーディエンスに関する詳細情報が含まれます。
