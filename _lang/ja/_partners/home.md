...
partner_top_text: "Alloys（私たちの仲間、最高のパートナー）のリストへようこそ！このリストを使って、テクノロジーパートナーを Braze SDK に実装するための技術ドキュメントをご覧ください。<br> <br>  Braze を活用してカスタマーエクスペリエンスやマーケティングを革新するコミュニティ「Firebrands」への参加をご検討の方は、<a href='https://brazefirebrands.splashthat.com/'>こちら</a>の情報ページをご覧ください。"
