...
> [Knak][1] は、企業のマーケティングチームが社内で使用するために構築された、初のキャンペーン作成プラットフォームです。ドラッグ・アンド・ドロップのプラットフォームは、コーディングや外部の手を借りることなく、誰でも数分で美しく、ブランドのあるEメールやランディングページを作成することができる。

_この統合はKnakによって維持されている。_
