...
![Knak 統合1]({% image_buster /assets/img/knak/integration-post-step-1-sync.png %})
...
アップロードしたKnakメールは、Brazeの「**エンゲージメント」>「テンプレート」& 「メディア**」で確認できる。見た目がよく、ブランドらしく、完全にレスポンシブです。クリエイティビティを存分に発揮してください。