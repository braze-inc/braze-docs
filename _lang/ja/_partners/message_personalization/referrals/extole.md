...
以下のユースケースは、ExtoleとBrazeの統合を使用するいくつかの方法を示している。Extole の実装マネージャーおよびカスタマーサクセスマネージャーと協力して、お客様の自社固有のニーズに対応するオプションを開発します。

- 紹介プログラムやエンゲージメントプログラムのカスタムイベントを使用して、Brazeキャンペーンやキャンバスをトリガーする
...
以下は、ExtoleがBrazeに送信するデフォルトのイベント、イベントプロパティ、ユーザー属性である。Extoleの実装またはカスタマー・サクセス・マネージャーに連絡し、Extoleイベントを識別して統合に追加する。
