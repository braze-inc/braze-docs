...
![altテキスト]({% image_buster /assets/img/niftyimages/2.png %}){: style="max-width:70%;"}

オプションで、データ型を入力してから**次へ**を選択します。

![altテキスト]({% image_buster /assets/img/niftyimages/3.png %})
{: style="max-width:70%;"}

必要に応じて、タグを将来使用するために保存することもできます。完了したら、**保存**を選択してマージタグを作成します。

![altテキスト]({% image_buster /assets/img/niftyimages/4.png %}){: style="max-width:70%;"}

### ステップ 2:画像をカスタマイズする

画像のフォント、フォントサイズ、位置、色、レイヤリングなどをカスタマイズします。終了したら、画像のURLをコピーしてください。

![altテキスト]({% image_buster /assets/img/niftyimages/5.png %})
...
![altテキスト]({% image_buster /assets/img/niftyimages/6.png %})
