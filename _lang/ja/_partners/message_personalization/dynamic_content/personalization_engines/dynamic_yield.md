...
description: "このリファレンス記事では、Braze と Dynamic Yieldのパートナーシップについて説明します。この提携により、ダイナミック・イールドのレコメンドとセグメンテーション・エンジンを使用して、Braze・メッセージに埋め込むことができるエクスペリエンス・ブロックを作成できます。"
...
Brazeとダイナミック・イールド・パートナーシップでは、ダイナミック・イールドのレコメンデーションとセグメンテーション・エンジンを使用して、Brazeメッセージに埋め込むことができるエクスペリエンス・ブロックを作成できます。エクスペリエンスブロックは以下のブロックで構成できます。
