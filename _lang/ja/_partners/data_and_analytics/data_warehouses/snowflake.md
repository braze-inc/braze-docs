...
複数のワークスペースが同じSnowflakeアカウントにデータを共有している場合は、[マルチワークスペース構成の管理に関するガイダンスについてのSnowflakeデータ共有のFAQ]({{site.baseurl}}/partners/data_and_analytics/data_warehouses/snowflake/faqs/)を参照してください。
{% endalert %}
