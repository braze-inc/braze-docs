...
![Brazeサブスクリプション・グループID。]({% image_buster /assets/img/ketch/ketch1.png %})
...
ユーザーは、Ketchがそのユーザーのマーケティング・プリファレンス・アイデンティティを確認できる場合にのみ、マーケティング・プリファレンス・センターを見ることができる。もしKetchがユーザーの身元を適切に捕捉できない場合、Ketchがユーザー設定を管理できないため、マーケティング設定ページはそのユーザーに表示されない。
