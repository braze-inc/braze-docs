...
| Braze REST エンドポイント | [ REST エンドポイント URL]({{site.baseurl}}/api/basics/#api-definitions) を確認してください。API エンドポイントは、Brazeインスタンスのダッシュボード URL と一致します。<br><br> たとえば、ダッシュボード URL が`https://dashboard-03.braze.com` の場合、エンドポイントは`dashboard-03` になります。 |
