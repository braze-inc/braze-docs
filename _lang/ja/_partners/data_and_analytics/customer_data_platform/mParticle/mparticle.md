...
mParticleの[Android](https://github.com/mparticle-integrations/mparticle-android-integration-appboy)、[iOS](https://github.com/mparticle-integrations/mparticle-apple-integration-appboy)、[Web](https://github.com/mparticle-integrations/mparticle-javascript-integration-braze)用SDKのこれらのマッピングはオープンソースであり、[mParticleのGitHubページで](https://github.com/mparticle-integrations)見ることができる。 
