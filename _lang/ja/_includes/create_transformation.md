...
!["テンプレート" または"Start from scratch" を選択するオプションを使用したトランスフォーメーションの詳細は、編集エクスペリエンス用です。]({% image_buster /assets/img/data_transformation/data_transformation10.png %}){: style="max-width:80%;"}
...
![Webhookのディテールとトランスフォーメーションコードのサンプル。]({% image_buster /assets/img/typeform/data_transformation_typeform.png %})
