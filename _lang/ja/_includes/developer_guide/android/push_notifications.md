...
まだアプリにディープリンクを追加していない場合は、[Android開発者のドキュメントに](http://developer.android.com/training/app-indexing/deep-linking.html)あるディープリンクに関する指示に従ってほしい。ディープリンクの詳細については、[FAQ の記事を]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/deep_linking_to_in-app_content/#what-is-deep-linking)参照してください。
