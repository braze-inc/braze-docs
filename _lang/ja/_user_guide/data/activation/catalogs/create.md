...
![カタログの名前と説明を入力する画面。]({% image_buster /assets/img_archive/in_browser_catalog.png %}){: style="max-width:80%;"}
...
![カタログに名前を付けた例。]({% image_buster /assets/img_archive/catalog_new_name.png %}){: style="max-width:85%;"}
