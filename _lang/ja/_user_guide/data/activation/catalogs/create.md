...
]({% image_buster /assets/img_archive/catalog_CSV_upload.png %})
...
]({% image_buster /assets/img_archive/catalog_data_type.png %})
...
]({% image_buster /assets/img_archive/add_catalog_fields.png %})「rating」と「name」という2つのフィールドの例。{: style="max-width:50%;"}()

[**カタログを更新**] > [**項目を追加**] を選択し、以前に追加したフィールドに基づいて情報を入力して、カタログに項目を追加します。次に、[**項目を保存**] または [**保存して追加**] を選択して、項目の追加を続行します。

]({% image_buster /assets/img_archive/add_catalog_items.png %})カタログアイテムを追加します。{: style="max-width:50%;"}()
