...
![マイカタログという名前のカタログ。]({% image_buster /assets/img_archive/in_browser_catalog.png %}){: style="max-width:80%;"}
...
![ゲームズカタログという名前のカタログ。]({% image_buster /assets/img_archive/catalog_new_name.png %}){: style="max-width:85%;"}
...
カタログは、データウェアハウス(Snowflake、Redshift、BigQuery、Databricks、Microsoft Fabric、S3 など) からスケジュールされたベースで直接的に同期することで、[Cloud Data Ingestion]({{site.baseurl}}/user_guide/data/unification/cloud_ingestion/sync_catalogs_data/) を介して管理できます。
