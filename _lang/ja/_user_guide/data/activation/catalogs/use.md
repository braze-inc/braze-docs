...
]({% image_buster /assets/img_archive/catalog_multiple_items.png %})
...
]({% image_buster /assets/img_archive/catalog_image_link1.png %})画像フィールドで使用されるカタログの Liquid タグを含むコンテンツカード作成画面。()

Liquid がレンダリングされると、次のように表示されます。

]({% image_buster /assets/img_archive/catalog_image_link2.png %})カタログの Liquid タグをレンダリングしたコンテンツカードの例。{: style="max-width:50%" }()
...
]({% image_buster /assets/img_archive/catalog_liquid_templating.png %})
