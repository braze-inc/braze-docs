...
![放置カードのカスタムイベントプロパティフィルタ。2 つのフィルター をAND 演算子と組み合わせて、このキャンペーンを100 ～200 ドルのアイテム価格でカードを放棄したユーザーに送信します]({% image_buster /assets/img_archive/customEventProperties.png %} "customEventProperties.png")
