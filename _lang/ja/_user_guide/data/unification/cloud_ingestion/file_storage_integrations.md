...
このページでは、現在早期アクセス（EA）段階にある同期とソースのステップを示しています。一般提供版のステップについては、[一般提供版のエクスペリエンス](#一般提供版のエクスペリエンス)を参照してください。
...
{: start="7"}
6. ステップ 5 で作成したポリシーをロールにアタッチします。検索バーでポリシーを検索し、ポリシーの横のチェックマークを選択してアタッチします。完了したら [**次へ**] を選択します。
