...
]({% image_buster /assets/img/aws-properties.png %})AWS の [プロパティ] タブ{: height="50%" width="50%"}()
...
]({% image_buster /assets/img/aws-events.png %})AWS で新しいイベントを作成する{: height="50%" width="50%"}()
