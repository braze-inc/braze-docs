...
]({% image_buster /assets/img_archive/messaging_matrix.png %})モバイル/Web プッシュはシンプルな内容で緊急性が高い。メールはリッチな内容で緊急性が高い。アプリ内/ブラウザーメッセージはシンプルな内容で緊急性が低い。コンテンツカードは緊急性が低く、リッチな内容である()
