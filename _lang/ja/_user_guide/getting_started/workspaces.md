...
<table>
    ...
    <tr>
        ...
        <td>カスタム属性とイベントはすべてのアプリインスタンスに適用されるため、ユーザープロファイルのどのデータとどのアプリインスタンスが関連しているのかを判断しにくくなる可能性がある。たとえば、「date_of_parking」はアプリ 1 とアプリ 2 のどちらに関連するか、これに対処するには、適切に構造化された命名規則を使用してください。</td>
    </tr>
    <tr>
        <td>フリークエンシーキャップ</td>
