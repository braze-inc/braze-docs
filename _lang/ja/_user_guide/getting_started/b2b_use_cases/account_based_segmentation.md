...
<<<<<<< HEAD
1. [**オーディエンス**] > [**セグメントエクステンション**] > [**新規エクステンションの作成**] > [**テンプレートで開始**] の順に移動し、[**イベント用のカタログセグメント**] テンプレートを選択します。<br><br> !["テンプレートとクォートを選択します。モーダルには、行動または購入のカタログ Segment項目があります。]({% image_buster /assets/img/b2b/select_a_template.png %})<br><br>SQLエディタには、ユーザーイベントデータとカタログデータを結合し、特定のカタログアイテムにエンゲージしたユーザーをセグメンテーションするテンプレートが自動的に入力される。<br><br>![開封"Variables" タブを持つ新しい拡張のSQL エディタ。]({% image_buster /assets/img/b2b/enter_new_name.png %})<br><br>
=======
1. [**オーディエンス**] > [**セグメントエクステンション**] > [**新規エクステンションの作成**] > [**テンプレートで開始**] の順に移動し、[**イベント用のカタログセグメント**] テンプレートを選択します。<br><br> \!["テンプレートとクォートを選択します。モーダルには、行動または購入のカタログ Segment項目があります。]({% image_buster /assets/img/b2b/select_a_template.png %})<br><br>SQLエディタには、ユーザーイベントデータとカタログデータを結合し、特定のカタログアイテムにエンゲージしたユーザーをセグメンテーションするテンプレートが自動的に入力される。<br><br>\![開封"Variables" タブを持つ新しい拡張のSQL エディタ。]({% image_buster /assets/img/b2b/enter_new_name.png %})<br><br>
>>>>>>> main
