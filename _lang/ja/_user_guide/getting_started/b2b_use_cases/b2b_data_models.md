...
]({% image_buster /assets/img/b2b/sf_accounts.png %})請求先住所やアカウント所有者などの該当する情報を含む Salesforce アカウントのテーブル。()
...
]({% image_buster /assets/img/b2b/sf_opportunities.png %})請求先住所やアカウント所有者などの該当する情報を含む Salesforce の商談の表。()
