...
Braze からLINE メッセージを送信すると、アカウントのメッセージクレジットから取得されます。
...
必要に応じて、パーソナライゼーション(Liquid やConnected Content など) を使用してメッセージを書きます。LINE では、各メッセージに最大5 つのメッセージバブルを使用できます。これらのバブルには、テキスト、イメージ、リッチ、またはカードベースのいずれかの使用可能なメッセージレイアウトを使用できます。

![LINEコンポーザー。プレビューにメッセージが表示されます。][1]
