...
3. [サブスクリプションステータスの同期をリクエストする](#step-3-request-a-subscription-status-sync)
4. [ユーザーの更新方法を更新する](#step-4-change-your-user-update-methods)
5. [(省略可) ユーザーをマージする](#step-5-merge-profiles-optional)
