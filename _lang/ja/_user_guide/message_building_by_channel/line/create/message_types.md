...
![テキスト、イメージ、リッチメッセージ、カードベースのメッセージなど、コンポーザーエディタにドラッグするメッセージタイプのメッセージタイプパネル。]({% image_buster /assets/img/line/line_message_types.png %}){: style="max-width:40%;"}
...
![ブラック・フライデー・パーティーについて忘れず、深夜12時までに最大80%節約できる可能性があることをユーザーに知らせるテキスト・メッセージ。]({% image_buster /assets/img/line/line_text_message.png %}){: style="max-width:40%;"}
...
![トースターセールを宣伝するイメージメッセージ。]({% image_buster /assets/img/line/line_image_message.png %}){: style="max-width:40%;"}
...
![ユーザー s が無作為にオファーを受け取ることができる白黒のグリッドの写真付きの6 平方のリッチメッセージ。]({% image_buster /assets/img/line/line_rich_message.png %})
...
![コンポーザーエディタでサンドイッチを促進する、少なくとも2 つのカード s を持つカード ベースのメッセージ。]({% image_buster /assets/img/line/line_card_message.png %})
