...
![3 つのセグメンテーション フィルター をすべて表示するフィルター群:"Clicked/Opened Campaign"、"Clicked/Opened Campaign またはCanvas with Tag"、および"Clicked/Opened Step"]({% image_buster /assets/img/line/line_segmentation_filters.png %})
