...
リンク識別子s は、メール キャンペーン、キャンバス、メールメッセージ、またはコンテンツブロックが複製されている場合にも更新されます。
...
]({% image_buster /assets/img/link_aliasing_composer.png %})4つのリンクエイリアスを持つリンクマネージメントページ()
...
]({% image_buster /assets/img/link_management_dnd.png %})ドラッグ＆ドロップ・メール・エディタのリンク管理タブ()

{% endtab %}
{% tab HTML editor %}

]({% image_buster /assets/img/link_management_html.png %})HTMLメールエディターのリンク管理タブ()
...
]({% image_buster /assets/img/link_aliasing_action_based_filters.png %})キャンバスコンポーネントのエイリアスをクリックしたユーザーやキャンペーンに参加したユーザーをターゲットにするアクションベースオプション。()
...
]({% image_buster /assets/img/link_aliasing_click_table.png %})3つのリンクエイリアスとその合計クリック数を表示するキャンペーン分析タブ。()
