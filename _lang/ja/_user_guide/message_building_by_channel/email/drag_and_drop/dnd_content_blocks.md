...
3. (オプション） ナビゲーションメニューのボタンを選択して、コンテンツブロックの幅を調整します。デフォルトの幅は100％である。<br><br>![幅を編集するオプションがある双方向矢印。]({% image_buster /assets/img_archive/content_block_width.png %}){: style="max-width:30%;" }<br><br>
