...
]({% image_buster /assets/img_archive/pushstories_composer_dropdown2.png %})
...
1. メインの作成画面から [**ページを管理**] をクリックします。
    <br><br>]({% image_buster /assets/img_archive/pushstories_add_pages.png %})<br><br>
...
]({% image_buster /assets/img_archive/pushstories_composer.png %})
...
]({% image_buster /assets/img_archive/pushstories_analytics.png %})iOS のプッシュパフォーマンス表には、分析サンプルと直接開封数指標の詳細が表示されます。()
