...
動画 | 現在のところ、URL でホストされ、16MB 未満でなければなりません。また、動画の種類は 3GPP または MP4 でなければなりません。<br><br>動画メッセージは現在、早期アクセス段階です。早期アクセスへの参加に興味がある方は、Brazeのアカウントマネージャーに連絡を。
オーディオ | 応答メッセージングのみサポートされます。AAC、AMR、MP3、MP4オーディオ、またはOGGで、URLでホストされ、16MB未満でなければならない。<br><br>音声メッセージは現在、早期アクセス段階です。早期アクセスへの参加に興味がある方は、Brazeのアカウントマネージャーに連絡を。
文書 | URL でホストされ、100MB 未満でなければなりません。また、ドキュメントタイプがテキスト (`.txt`)、Microsoft Excel (`.xls`,`.xlsx`)、Microsoft Word (`.doc`,`.docx`)、Microsoft PowerPoint (`.ppt`,`pttx`)、またはPDF (`.pdf`) でなければなりません。<br><br>ドキュメント・メッセージは現在早期アクセス中である。早期アクセスへの参加に興味がある方は、Brazeのアカウントマネージャーに連絡を。
