...
]({% image_buster /assets/img/whatsapp/whatsapp118.png %})POST メソッドを使用したメッセージが表示されている Webhook 作成画面。{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/whatsapp/whatsapp_json_editor.png %})「高度なJSONエディター」ステップが選択されているユーザー更新ステップ。{: style="max-width:90%;"}()
