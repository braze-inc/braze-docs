...
![「作成」タブでメッセージを書く。]({% image_buster /assets/img/sms/mms_composer.png %}){: style="max-width:80%;"}
...
![「ジムに行く準備はできたか…家で？」というメッセージの一例だ。プレビューでは、メッセージと画像, 写真がテキストとして送信される様子が表示される。]({% image_buster /assets/img/sms/mms_preview.png %})
