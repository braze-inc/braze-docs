...
]({% image_buster /assets/img/sms/mms_composer.png %})メッセージを作成するための [作成] タブ。{: style="max-width:80%;"}()
...
\![メッセージ"ジムを打つ準備ができました。。。自宅で?"の例。プレビューには、テキストとして送信されたメッセージと画像が表示される。]({% image_buster /assets/img/sms/mms_preview.png %})()
