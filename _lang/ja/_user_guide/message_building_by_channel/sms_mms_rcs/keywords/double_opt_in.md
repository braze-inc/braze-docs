...
![ユーザーが "JOIN "と送信し、"Reply Y to confirm you want to join our SMS program. "という応答を受信した受信SMSメッセージのスクリーンショット。3msg/week, text STOP at any time to STOP, then texts back "Y"。]({% image_buster /assets/img/double_opt_in_inbound.png %}){:style="max-width:40%;"}
