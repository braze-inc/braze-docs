...
page_order: 7
description: "このページでは、アプリ内メッセージのドラッグ＆ドロップエディタを使用して、新しい製品の起動に対する認識を高める方法について説明します。"
---
...
]({% image_buster /assets/img/drag_and_drop/templates/product_announcement.png %})製品アナウンスのテンプレートを含むアプリ内メッセージエディタ。()
...
]({% image_buster /assets/img/drag_and_drop/templates/product_announcement_button.png %})ボタンエレメントをカスタマイズするためのサイドメニューを備えたアプリ内メッセージエディター()
...
ドラッグ＆ドロップ[アプリ内メッセージコンポーネント]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop/style_settings/#message-components)を使用して、製品アナウンスのルックアンドフィールをカスタマイズします。
