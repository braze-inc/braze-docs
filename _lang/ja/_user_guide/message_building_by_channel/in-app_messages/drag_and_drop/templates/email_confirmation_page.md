...
]({% image_buster /assets/img/drag_and_drop/templates/email_capture_confirmation.png %})確認ページがあるメールサインアップフォームのテンプレートを含むアプリ内メッセージエディタ。()
...
]({% image_buster /assets/img/drag_and_drop/templates/email_capture_field_confirmation.png %})メールキャプチャ要素をカスタマイズするためのサイドメニューを持つアプリ内メッセージエディタ。()
