...
]({% image_buster /assets/img/drag_and_drop/templates/seasonal_promo.png %})アプリ内メッセージエディターと季節プロモーションのテンプレート。()
...
]({% image_buster /assets/img/drag_and_drop/templates/seasonal_promo_button.png %})ボタンエレメントをカスタマイズするためのサイドメニューを備えたアプリ内メッセージエディター()
...
]({% image_buster /assets/img/drag_and_drop/templates/seasonal_promo_image.png %})背景画像を選択するサイドメニューを備えたアプリ内メッセージエディター。()
