...
]({% image_buster /assets/img_archive/card_creation.png %})スケジュールされたコンテンツカードの配信を編集する際のコンテンツカードコントロールセクション。()
...
]({% image_buster /assets/img_archive/card_creation_canvas.png %})スケジュールされたコンテンツカードの配信を編集する際のコンテンツカードコントロールセクション。()
