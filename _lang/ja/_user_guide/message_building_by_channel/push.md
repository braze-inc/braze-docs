...
]({% image_buster /assets/img/red-dress.gif %})Apple 製品間のプッシュメッセージの例。{: height="400px"}()iPhone ホーム画面のStopwatch からのプッシュメッセージの例:「こんにちは。これは iOS プッシュ通知です。」]({% image_buster /assets/img/ios_push.png %}){: height="400px"}
