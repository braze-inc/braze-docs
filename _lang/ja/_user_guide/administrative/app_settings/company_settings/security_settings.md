...
以下では、すべてのフィールドが PII に設定されており、言及されているユーザーが Braze プラットフォームを使用しているユーザーであると仮定しています。また、"先行する "属性とは、[潜在的PII属性](#potential-pii-attributes)表にあるものを指す。ユーザーからPII権限を削除することは、これらの列挙された領域以外にもユーザビリティに影響を与える可能性がある。
