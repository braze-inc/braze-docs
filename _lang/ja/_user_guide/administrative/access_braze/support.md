...
]({% image_buster /assets/img_archive/get_help.png %})問い合わせのオプションがある [サポート] ドロップダウン。{: style="max-width:60%;"}()
...
]({% image_buster /assets/img_archive/designated_support_contact.png %})指定したサポート担当者としてユーザを設定するチェックボックス。{: style="max-width:70%;"}()
...
3. 要素の**名前**、**ステータス**、**サイズ**、**時刻**を示すスクリーンショットまたはスクリーン録画をキャプチャします。<br><br>]({% image_buster /assets/img/network_xhr.png %})Chrome ブラウザの"Fetch/XHR" タブ。{: style="max-width:60%;"}()
