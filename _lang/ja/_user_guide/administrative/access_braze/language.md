...
1. グローバルヘッダーで、<i class="fa-solid fa-globe" aria-label="言語"></i>を選択する。
2. リストから言語を選択します。

![Brazeダッシュボードの言語として英語が選択された。]({% image_buster /assets/img_archive/language_dashboard.png %}){: style="max-width:40%"}
