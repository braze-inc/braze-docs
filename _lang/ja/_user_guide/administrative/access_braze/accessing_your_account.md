...
どちらのメールアドレスも同じ受信トレイにメールを転送するが、Brazeにログインすると別々のアカウントとして認識される。
...
ほとんどの企業ユーザーには、ドラッグ＆ドロップ・エディターが読み込まれるはずだ。しかし、VPN を使用していたり、ファイアウォールで保護されている場合は、ドメインを許可リストに追加する必要があることがあります。IT管理者に連絡し、`*.bz-rndr.com` が許可リストに登録されていることを確認する。
