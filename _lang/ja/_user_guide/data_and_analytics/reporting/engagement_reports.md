...
特定のデータは、個々のキャンペーンバリアントまたはキャンバスステップのレベルではなく、キャンペーンまたはキャンバスのレベルで集計されます。
...
![engagement\_reports\_message\_selection][2]
...
![engagement\_report\_add\_stats][3]

|チャネル | 利用可能な統計情報 |
| ------| --------------|
| メール | 送信数、開封数、ユニーク開封数、クリック数、ユニーククリック数、クリック開封数、配信停止数、バウンス数、配信数、スパムとしてレポートされたメール数 |
...
![engagement\_reports\_data\_coverage][4]
...
![engagement\_reports\_schedule\_report][5]{: style="max-width:65%;" }
