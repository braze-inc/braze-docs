...
| メールサブスクリプショングループのオプトインとオプトアウト | このレポートは、週ごとの任意のメールサブスクリプショングループにおけるユニークユーザーのオプトインおよびオプトアウトの数を示しています。<br><br> ![]({% image_buster /assets/img_archive/query_builder_q2.png %}){: style="max-width:70%;"} |
