...
エクスポートされたファイルには、\[Segment][40] のユーザーデータをエクスポート] するときに含まれるのと同じユーザーデータ フィールドs が含まれます。\[すべての受信者データをエクスポート] を選択すると、エクスポートされたファイルには、それらのデータフィールドに加えて各ユーザーの以下のデータも含まれます。
