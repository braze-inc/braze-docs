...
たとえば、午後1 時で午後3 時のローカルタイムゾーン キャンペーンをスケジュールすると、キャンペーンは、現地時間が午後3 ～4 時のすべてのユーザーs にすぐに送信しますが、現地時間が午後5 時のユーザーs には送信しません。さらに、キャンペーンで選択する送信時刻は、会社のタイムゾーンでまだ発生していない時刻でなければなりません。
...
6. このレポートを受け取る企業ユーザーのメール住所を入力します。
