...
アクティブユーザー を振り返ると、29.8k ユーザー s が含まれているにもかかわらず、64% しかプッシュが有効になっていないことがわかります。

!["Push Enabled" フィルターが"true"および推定ユーザーが29.8kに設定されたセグメント。]({% image_buster /assets/img_archive/trouble16.png %})
