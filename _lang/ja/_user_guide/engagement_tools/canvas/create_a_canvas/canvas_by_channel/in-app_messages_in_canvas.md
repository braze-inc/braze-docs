...
]({% image_buster /assets/img_archive/canvas_priority2.png %})2 つのステップ「Welcome IAM」と「Followup IAM」が表示されている優先順位の並べ替え。{: style="max-width:85%"}()
...
]({% image_buster /assets/img_archive/canvas_trigger_actions.png %})[特定の購入] がトリガーアクションとして選択されている。{: style="max-width:90%"}()
