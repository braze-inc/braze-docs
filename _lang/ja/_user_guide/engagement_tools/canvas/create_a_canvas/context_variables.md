...
![フィルター設定でコンテキスト変数に対するパーソナライゼーションタイプとして、コンテキスト変数「reminder_date」とコンテキスト変数「appointment_deadline」を用いたフィルター。]({% image_buster /assets/img/context_variable_filter3.png %})
