...
終了イベントを実行すると、現在のステップが終了するとすぐに、ユーザー がキャンバスから終了します。たとえば、ユーザーが30 日間遅延ステップにあり、遅延ステップの最初の日に終了イベントを実行した場合、ユーザーはさらに29 日間キャンバスを終了しません。
...
2. 3 つのユーザー が5 分以内にコンバージョンイベントを実行します(終了イベントの数は3 で、コンバージョンイベントの数s は3 です)。
