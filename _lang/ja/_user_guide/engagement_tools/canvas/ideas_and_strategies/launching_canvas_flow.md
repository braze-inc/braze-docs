...
]({% image_buster /assets/img_archive/launch_with_canvas_flow_example.png %})2025年4月30日午後12時から2025年5月7日午後12時までのユーザーのローカライゼーション期間中に、ユーザーが何らかの買い物をすると入るアクションベースのキャンバス。{: style="max-width:75%;"}()
