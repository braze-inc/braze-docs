...
]({% image_buster /assets/img/preview_user_path_example.png %})メッセージステップ、ディレイステップ、オーディエンスパスステップ、2つのメッセージステップを持つキャンバスの例。{:style="max-width:70%"}()
...
]({% image_buster /assets/img/preview_user_path_results_example.png %})[テスト結果] セクションには、テストユーザーがエントリ条件を満たしていることが示され、送信された手順を含むユーザージャーニーの概要が示されます。()
