...
{% tabs %}
  ...
  ]({% image_buster /assets/img/canvas_intro/canvas_intro.gif %})ユーザーがプッシュを有効にしているかどうかに応じて、2つの異なるユーザー体験への条件分岐ステップを含むキャンバスの例。()
