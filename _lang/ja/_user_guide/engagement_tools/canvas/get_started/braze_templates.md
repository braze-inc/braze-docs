...
guide_top_text: "<a href='/docs/user_guide/engagement_tools/canvas/create_a_canvas/canvas_templates/' target='_blank'>Braze キャンバステンプレート</a> を使用して、マーケティングキャンペーンの可能性を引き出しましょう。これらのテンプレートは、効果的なユーザジャーニーを作成するための効率的なアプローチを提供し、重要な瞬間にユーザを参加させることができます。以下のユースケース記事を調べて、マーケティング目標のためにこれらのキャンバステンプレートを構築する方法を確認します。"

page_type: landing
description: "このランディングページには、機能導入のためのユーザーのターゲティングや、ユーザーのオンボーディングのためのメッセージのパーソナライズなどのユースケースに合わせて、Braze キャンバステンプレートをカスタマイズし、活用する方法を説明する記事が記載されています。"
tool: Canvas
