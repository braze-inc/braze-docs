...
テストユーザーを整理する便利な方法として、キャンペーンからテストメッセージを受け取るユーザーのグループを含む[コンテンツテストグループ]({{site.baseurl}}/user_guide/administrative/app_settings/internal_groups_tab/)を作成することができます。このテストグループは、キャンペーンの**コンテンツテストグループの追加**フィールドの**テストレシピエント**に追加し、個々のテストユーザー を作成または追加せずにテストを開始できます。
...
3. テストメッセージを送信するには、コンテンツテストグループまたは1 つ以上の個々のユーザー を**Test Recipients** として追加し、**Send Test** を選択します。 
...
1. LINE メッセージを作成します。
2. [**テスト**] タブを選択し、このテストメッセージを受信するコンテンツテストグループを少なくとも 1 つ、あるいは個々のユーザーを少なくとも 1 人選択します。
3. **Send Test**を選択してメッセージを送信します。

![LINEメッセージをテストする。]({% image_buster /assets/img/line/test_preview.png %})
...
SMS、MMS、またはRCSメッセージを作成した後、電話機にテストメッセージを送信して、リアルタイムでどのように見えるかを確認できます。 

1. SMS、MMS、またはRCSメッセージを作成します。
2. [**テスト**] タブを選択し、このテストメッセージを受信するコンテンツテストグループを少なくとも 1 つ、あるいは個々のユーザーを少なくとも 1 人選択します。 
...
1. WhatsAppを作成します。
2. [**テスト**] タブを選択し、このテストメッセージを受信するコンテンツテストグループを少なくとも 1 つ、あるいは個々のユーザーを少なくとも 1 人選択します。
3. このメッセージに使用しているサブスクリプショングループに関連付けられている電話番号にWhatsAppメッセージを送信して、対話ウィンドウを開始します。関連する電話番号は、**Test**タブのアラートに表示される。
4. **Send Test**を選択してメッセージを送信します。

![試験WhatsApp伝文]({% image_buster /assets/img/whatsapp/whatsapp_test.png %})
