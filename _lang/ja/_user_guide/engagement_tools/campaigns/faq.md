...
これは、キャンペーンが更新された正確な時刻にキャンペーンが開始される予定になっている場合に起こりうる。例えば、現在午後3時10分で、午後3時10分にキャンペーンを開始するように変更し、**キャンペーンの更新を**選択した場合、現在午後3時10分を過ぎており、開始予定時刻を過ぎていることを意味する。キャンペーンを同じ時間にスケジュールするのではなく、[**キャンペーン開始後すぐに送信**] を選択してください。
