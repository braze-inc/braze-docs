...
layout: dev_guide
page_order: 0
guide_top_header: "キャンペーンを作成"
guide_top_text: "Braze でのキャンペーン s の基本を理解したので、どのようなメッセージを送信するかを決めるために、利用可能な別の<a href='/docs/user_guide/message_building_by_channel/'>メッセージング チャネル s</a> を確認してください。次の一覧からメッセージング チャネルを選択して、その型の単一のチャネル メッセージング キャンペーンを作成および構成する方法、または複数のチャネル キャンペーンを作成して型を組み合わせる方法を学習します。<br><br>また、弊社の<a href='https://learning.braze.com/campaign-setup-delivery-targeting-conversions'>キャンペーンセットアップ</a>Brazeラーニングコースをご覧になることを強くお勧めします!"
page_type: landing
description: "このランディングページには、さまざまな Braze メッセージングチャネルのキャンペーンを作成する方法に関する記事へのリンクが含まれています。"

search_rank: 1
guide_featured_title: "キャンペーンタイプを選択"
guide_featured_list:
- name: コンテンツカードキャンペーン
