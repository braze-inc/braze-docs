...
article_title: キャンペーンをマネージャーする
layout: dev_guide
guide_top_header: "キャンペーンの管理"
guide_top_text: "キャンペーンを開始すると、データが自動的に集まってきます。キャンペーンに変更を加えたり、アラートを設定したり、キャンペーンをアーカイブしたりする必要がある場合は、以下の記事を参照してください。"
page_order: 3

tool: Campaigns
page_type: landing
description: "このランディングページは、キャンペーンの管理を対象としています。ここにはキャンペーンの承認、複製、アラート、アーカイブ、開始後のキャンペーンの変更などに関する記事があります。"
