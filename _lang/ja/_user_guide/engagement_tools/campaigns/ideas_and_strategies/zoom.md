...
![Liquidテンプレートを使用したメールメッセージには、名、姓、メールアドレス、市区町村が含まれていた。]({% image_buster /assets/img/zoom/zoom1.png %})
...
1. プッシュキャンペーンを作成します。<br><br>
	...
	![ボタンがクリックされた時にウェビナーへリンクする。]({% image_buster /assets/img/zoom/zoom2.png %})<br><br>
...
2. アプリ内メッセージやボタンクリックによってトリガーされる Webhook キャンペーンを作成します。<br><br>
	...
	![特定のキャンペーンのボタンをクリックしたユーザーに送信される、アクションベースのキャンペーンである。]({% image_buster /assets/img/zoom/zoom6.png %})<br><br>
...
1. アプリ内メッセージキャンペーンを作成する<br><br>
	...
	![ボタンがクリックされた時にウェビナーへリンクする。]({% image_buster /assets/img/zoom/zoom3.png %})<br><br>
...
2. アプリ内メッセージやボタンクリックによってトリガーされる Webhook キャンペーンを作成します。<br><br>
	...
	![特定のキャンペーンのボタンをクリックしたユーザーに送信される、アクションベースのキャンペーンだ。]({% image_buster /assets/img/zoom/zoom5.png %})<br><br>
