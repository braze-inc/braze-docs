...
![メールメッセージ(名、姓、メール住所、および都市を含めるために使用されるリキッドテンプレートあり)。]({% image_buster /assets/img/zoom/zoom1.png %})
...
1. プッシュキャンペーンを作成する<br><br>
	...
	![ボタンをクリックしたときのウェビナーへのリンクアウト]({% image_buster /assets/img/zoom/zoom2.png %})<br><br>
...
1. アプリ内メッセージキャンペーンを作成する<br><br>
	...
	![ボタンをクリックしたときのウェビナーへのリンクアウト]({% image_buster /assets/img/zoom/zoom3.png %})<br><br>
