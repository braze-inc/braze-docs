...
障がい者を排除したマーケティングコンテンツは、意図しなくても、何百万人もの人々がブランドと関わることを妨げる可能性があります。マーケティングにおけるアクセシビリティとは、誰もがあなたのマーケティングを体験し、コミュニケーションを理解し、製品・サービス・ブランドへの投資やファンになる機会を得られるようにすることだ。 
...
- 世界人口の約10～20％が神経多様性を持つとされている（[デロイト](https://www2.deloitte.com/us/en/insights/topics/talent/neurodiversity-in-the-workplace.html)参照）
...
留意点は以下のとおりです。
- **十分なタッチターゲットサイズを使用せよ。**タッチターゲットの最小サイズを44×44ピクセルに設定します。これは、[タッチターゲット](https://www.w3.org/WAI/WCAG22/Understanding/target-size-minimum.html)に関する WCAG 2.2ガイドラインおよび一般的なモバイルユーザビリティ基準に沿ったものです。
