...
![「Braze ダッシュボード」のキャンバスの一覧。いずれかのキャンバスのメニュー開封が表示されます。]({% image_buster /assets/img/messaging_fundamentals/change-status.png %})
...
- **ドラフトの変更:**キャンバスへの下書きの変更は、キャンバスが停止するとカードされます。
