...
アクティブユーザー向けにパーソナライズされたホリデーキャンペーンを作成しているとしましょう。**2～3日以内にセッションを開始する**という変換イベントは、メッセージを受け取ることからユーザーエンゲージメントの感覚を集めることができるため、適切な場合があります。**Places Order**、**Upgrade App**、または任意のカスタムイベントs などの追加のイベントをコンバージョンイベントs として選択できます。
...
1次コンバージョンのイベントカウントは、1次コンバージョン アクションを実行したユーザーの数です。1次コンバージョンイベントレートは、このカウントを一意の受信者s の数で割ることによって計算されます。ユーザーは、チャネルに応じて送信または表示されると、受信者と見なされます。たとえば、プッシュまたはメールでは、メッセージの送信後にユーザーが受信者になります。アプリ内メッセージまたはコンテンツカードの場合、ユーザーは受信者と見なされるメッセージを表示する必要があります。
