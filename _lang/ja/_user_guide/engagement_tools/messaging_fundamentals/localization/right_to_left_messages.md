...
<<<<<<< HEAD
4. テキストの書式設定と配置を確認します。ドラッグアンドドロップまたはHTML メールメッセージを作成する場合は、コンポーザー内でこれを行うことができます。それ以外の場合は、別のワードプロセッサを使用する必要があります。<br><br>![Email ドラッグ&ドロップエディターメニューとボタンで、テキストの配置を右から左へ、左から右へ切り替えます。]({% image_buster /assets/img/rtl_button.png %}){: style="max-width:50%;"}
=======
4. テキストの書式設定と配置を確認します。ドラッグアンドドロップまたはHTML メールメッセージを作成する場合は、コンポーザー内でこれを行うことができます。それ以外の場合は、別のワードプロセッサを使用する必要があります。<br><br>\![Email ドラッグ&ドロップエディターメニューとボタンで、テキストの配置を右から左へ、左から右へ切り替えます。]({% image_buster /assets/img/rtl_button.png %}){: style="max-width:50%;"}
>>>>>>> main
