...
Brazeは、個々のSegment フィルターs を最大10,000 バイトに制限します。これは、10,000 の英字または3333 の日本語文字に相当します。フィルターがSegment内にあるか、キャンペーンまたはキャンバスに直接追加されているかにかかわらず、個々のフィルターが10,000 バイトを超えると、警告アプリが表示されます。 
