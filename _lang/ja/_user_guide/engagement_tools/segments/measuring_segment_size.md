...
![]({% image_buster /assets/img_archive/cancel_calculation.png %})をキャンセルするオプションを指定したアクティブな計算{: style="max-width:25%"}
...
![[過去のメンバーシップ] ドロップダウンを使用して、日付範囲でセグメントメンバーシップをフィルタリングする。]({% image_buster /assets/img_archive/historical_membership2.png %})
