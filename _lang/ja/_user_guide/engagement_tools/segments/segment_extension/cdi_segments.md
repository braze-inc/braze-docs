...
]({% image_buster /assets/img/segment/segment_extension_modal.png %})

データソースには [**CDI データテーブル**] を選択します。

]({% image_buster /assets/img/segment/cdi_data_tables.png %})
...
]({% image_buster /assets/img/segment/connection_schema_with_descriptions.png %})
