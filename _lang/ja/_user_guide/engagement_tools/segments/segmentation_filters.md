...
glossaries:
  ...
  - name: アプリのプッシュ有効化
    ...
    tags:
      - Channel subscription behavior
  - name: バックグラウンドプッシュ有効
    description: ユーザーがプッシュトークンを持っており配信停止していないかどうかに基づいてセグメント化します。
    tags:
      - Channel subscription behavior
  - name: プッシュ通知のオプトイン日
