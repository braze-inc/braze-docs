...
![目的のオーディエンスを選択するときに、AB テストの項に記載されている最適化オプション。次の3 つのオプションが表示されます。最適化なし、勝利バリアント、および個人用バリアント。パーソナライズされたバリアントが選択されている。]({% image_buster /assets/img_archive/ab_personalized_variant.png %})
