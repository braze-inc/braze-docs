---
nav_title: メッセージングの基本
article_title: メッセージングの基本
layout: dev_guide
page_order: 0
guide_top_header: "メッセージングの基本"
guide_top_text: "> Braze では、<a href='/docs/user_guide/getting_started/campaigns_canvases'>キャンペーンまたはキャンバス</a> を使用してメッセージを作成、送信、管理できます。これらのメッセージング方法の両方について、構成(メッセージのセットアップ)と管理(メッセージを管理的に処理)のためのいくつかの共有メッセージングの基本があります。"
page_type: landing
tool: 
    - Campaigns
    - Canvas
description: "このランディングページには、キャンペーンとキャンバスを使用したメッセージングの基本に関する記事が掲載されています。ここでは、変換イベントを戦略的に使用し、メッセージの作成時に配信タイプを決定し、メッセージの管理時に承認ワークフローと理解ステータスを使用する方法について説明します。"

guide_featured_title: "構成"
