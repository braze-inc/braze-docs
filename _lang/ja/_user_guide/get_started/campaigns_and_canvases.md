...
- カスタマージャーニー全体において継続的なメッセージングを送信するには、当社のオーケストレーションツールであるキャンバスを選択せよ。キャンペーンはシンプルでターゲットを絞ったメッセージを送信するのに適していますが、キャンバスは顧客との関係を次のレベルに引き上げる場所です。
...
キャンバスについてさらに詳しく学習するには、以下の追加リソースを参照せよ：
