...
> Braze Intelligence Suite は、データに基づくインサイトで意思決定の自動化を支援します。配信時間から多変量テストまで、ブランドはこれらのツールと機能を使用して、大規模に最適化されるダイナミックなクロスチャネルのエクスペリエンスを構築できます。Intelligence Suite は、インテリジェントタイミング、インテリジェントチャネル、インテリジェントセレクションの 3 つの主要機能で構成されています。
