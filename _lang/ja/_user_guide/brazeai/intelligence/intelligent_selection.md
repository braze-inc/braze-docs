...
]({% image_buster /assets/img/intelligent_selection1.png %})インテリジェントセレクションを有効にしたキャンペーンの [AB テスト] セクション。()
...
]({% image_buster /assets/img/intelligent_selection.png %})それぞれのバリアント分布が 50% に設定された 2 つのバリアントがあり、インテリジェントセレクションを有効にできるキャンバス。()

これにより、バリアント分布を編集してインテリジェントセレクションをオンにすることができます。 

]({% image_buster /assets/img_archive/canvas_intelligent_selection.png %})キャンバスで [インテリジェントセレクション] オプションがオンになっている()
