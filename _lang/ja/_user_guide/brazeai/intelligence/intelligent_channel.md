...
![インテリジェント・チャンネル・フィルター(選択可能な各チャンネルのドロップダウン)。][1]{: style="float:right;max-width:40%;margin-left:10px;margin-top:10px;border:0"}
...
![モバイルプッシュ用のインテリジェント・チャネル・フィルタ、または十分なデータがない。][2]
