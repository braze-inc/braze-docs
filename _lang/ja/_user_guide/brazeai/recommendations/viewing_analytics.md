...
![精度 (25.3%)、カバレッジ (54.3%)、およびパーソナライズされた項目と使用率が最も高い項目に分割されたレコメンデーションタイプを示すレコメンデーションのオーディエンスの指標。]({% image_buster /assets/img/item_recs_analytics_1.png %})
...
![ユーザーに割り当てられた項目を、パーソナライズされたレコメンデーションと使用率が最も高いレコメンデーションで分けて一覧表示した表。]({% image_buster /assets/img/item_recs_analytics_2.png %})
...
![推奨概要テーブル表示タイプ、カタログ、イベントタイプ、カスタムイベント名、プロパティ名、最終更新日。]({% image_buster /assets/img/item_recs_analytics_3.png %}){: style="max-width:50%" }
