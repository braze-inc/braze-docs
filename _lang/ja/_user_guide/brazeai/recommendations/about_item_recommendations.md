...
description: "この記事では、Braze を使用する顧客にアイテムを推奨する場合のさまざまなユースケースについて説明します。"
page_order: 1
---
...
「AI でパーソナライズ」されたモデルに加えて、[AI によるアイテムのおすすめ][1]機能には、ユーザーエンゲージメントが最も多いアイテムを勧める「最も人気がある」アイテムのレコメンデーションモデルも含まれています。
...
「AI でパーソナライズ」されたモデルに加えて、[AI によるアイテムのおすすめ][1]機能には、ユーザーエンゲージメントが一番最近あったアイテムを勧める「最新」アイテムのレコメンデーションモデルも含まれています。このモデルを使用して、離脱ユーザーに関連コンテンツへの再エンゲージを促すことにより、解約を防止します。
...
### トレンドアイテムのおすすめ {#trending}

「AI でパーソナライズ」されたモデルに加えて、[AI によるアイテムのおすすめ][1]機能には、最近のユーザーインタラクションで最もポジティブな勢いのあったアイテムを勧める「トレンド」のレコメンデーションモデルも含まれています。 

インタラクションが一貫して高いアイテムを勧める「最も人気のある」モデルとは異なり、このモデルはインタラクションが増えているアイテムを特徴としています。新進気鋭で、現在けん引力が増している製品をおすすめするのに使えます。

追跡しているインタラクションデータに基づき、このモデルのユースケースとして、次のおすすめが考えられます。

- [トレンドの購入アイテム](#trending-purchased-items)
- [トレンドの「いいね」アイテム](#trending-liked-items)
...
ユーザーが最近購入したアイテムを頻度を上げて強調表示します。たとえば、e コマース事業では、次のシーズンに向けてユーザーが購入し始める季節商品を勧めることができます。 
