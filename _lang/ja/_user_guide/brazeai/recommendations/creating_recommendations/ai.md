...
!["おすすめとクォートを定義します。"AI Personalized"を使用してステップします。種類と"ユーザーが以前に&quot とやり取りしたことがあるアイテムはおすすめしません。オプションが選択されています。]({% image_buster /assets/img/item_recs_2-3.png %})
