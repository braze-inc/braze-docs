...
guide_top_text: "BrazeAI<sup>TM</sup> は、効率と創造性を高める様々な自動生成 AI 機能を搭載しています。定型的なコピーライティング作業、コンテンツの改良、画像の作成に費やす時間を削減しつつ、魅力的なクロスチャネルの顧客体験を創造します。<br><br>詳細については、以下の記事をご覧ください。"
description: "BrazeAI<sup>TM</sup> は、効率と創造性を高める様々な自動生成 AI 機能を搭載しています。"
