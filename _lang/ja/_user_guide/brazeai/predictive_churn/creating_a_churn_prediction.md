...
![ユーザーが7日間でセッションを起動しない場合、チャーンしたとみなされるチャーンデフィニション]]({% image_buster /assets/img/churn/churn1.png %})
...
![予測更新スケジュールは毎日午後5時に設定されます。]({% image_buster /assets/img/churn/churn2.png %})
