...
4. キャンペーン名を入力します。例えば、「Decisioning Studio Go メール」である。

![Decisioning Studio Go メールという API キャンペーン。]({% image_buster /assets/img/decisioning_studio_go/api_campaign_name.png %})
