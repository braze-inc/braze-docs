...
- [デシジョン・スタジオ・プロデータソースを接続する]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/preparing_your_data/connecting_your_data/)
...
- [デシジョン・スタジオ・プロオーケストレーションの設定]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/set_up_orchestration/)
...
- [デシジョン・スタジオ・プロエージェントをデザインする]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/getting_started/)
...
- [デシジョン・スタジオ・プロエージェントを立ち上げる]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/launch_your_agent/)
