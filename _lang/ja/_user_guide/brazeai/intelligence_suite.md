...
page_order: 6
search_rank: 12
description: "Braze Intelligence Suiteは、データに基づくインサイトで意思決定をオートメーション化する。配信時間から多変量テストまで、ブランドはこれらのツールと機能を使用して、大規模に最適化されるダイナミックなクロスチャネルのエクスペリエンスを構築できます。"
tool:
  - Dashboard
---
...
> Braze Intelligence Suiteは、データに基づくインサイトで意思決定をオートメーション化する。配信時間から多変量テストまで、ブランドはこれらのツールと機能を使用して、大規模に最適化されるダイナミックなクロスチャネルのエクスペリエンスを構築できます。インテリジェンススイートは主に三つの機能から構成される：3 つの主要機能で構成されています。
