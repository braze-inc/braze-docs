...
> ファネルレポートは、キャンペーンやキャンバスを受け取った後の顧客のジャーニーを分析できるビジュアルレポートを提供する。![ファンネルレポート2]({% image_buster /assets/img/funnel_report/funnel_report2.png %}){: style="float:right;max-width:15%;margin-bottom:15px; border: 0"}
...
![ファンネルレポート5]({% image_buster /assets/img/funnel_report/funnel_report5.png %}){: style="max-width:90%;"}
...
![ファンネルレポート3]({% image_buster /assets/img/funnel_report/funnel_report3.png %}){: style="max-width:80%;"}
...
![ファンネルレポート4]({% image_buster /assets/img/funnel_report/funnel_report4.jpg %})
