...
]({% image_buster /assets/img/campaign_comparison/campaign_main.png %})キャンペーン比較例{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/campaign_comparison/create_report.png %})キャンペーンダッシュボード{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/campaign_comparison/campaign_comparison_columns.png %})キャンペーンオプション{: style="max-width:80%;"}()
...
]({% image_buster /assets/img/campaign_comparison/metric.png %})キャンペーンの数値指標{: style="max-width:60%;"}()

### ステップ 4: レポートに名前を付けて保存

レポートを保存する前に、レポートに名前を付けます。レポートに名前を付けずに保存すると、Braze によりデフォルトの名前である「キャンペーン比較レポート」が適用されます。

]({% image_buster /assets/img/campaign_comparison/comparison_name.png %})キャンペーンノート{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/campaign_comparison/compare_note.png %})キャンペーンノート{: style="float:right;max-width:15%;margin-left:15px;"}()
...
]({% image_buster /assets/img/campaign_comparison/campaign_comparison2.png %})ステップ{: style="max-width:90%;"}()

### メッセージ

ステップレベルの内訳と同様に、[**メッセージごとの内訳**] を選択すると各行にステップ名が表示されます。ただし、[**列を編集**] では、メールクリック数やプッシュ通知の開封数など、チャネル固有の統計情報のようなメッセージレベルの指標にアクセスできます。

]({% image_buster /assets/img/campaign_comparison/campaign_comparison3.png %})レポート{: style="max-width:90%;"}()
...
]({% image_buster /assets/img/campaign_comparison/download.png %})キャンペーンダウンロード{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/campaign_comparison/report_builder_charts.png %})メトリックメッセージ付きのキャンペーンパフォーマンスチャートが送信されました()
