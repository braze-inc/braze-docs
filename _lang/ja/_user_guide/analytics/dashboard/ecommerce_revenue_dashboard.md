...
page_order: 6
description: "本稿では、eコマース収益 - ラストタッチ属性ダッシュボードの概略を紹介する。"
---

# eコマース収益ダッシュボード

> **eコマース収益 - ラストタッチ属性**ダッシュボードは、[eコマース推奨イベント]({{site.baseurl}}/ecommerce_events/)を使用して、キャンペーンとキャンバスのラストタッチ属性d収益を追跡します。このダッシュボードを使用して、どのメッセージが収益を促進するかを理解し、eコマースパフォーマンス全体を経時的に監視します。
...
eコマースの収益ダッシュボードを表示するには、**分析** > **ダッシュボードビルダー**に移動し、**eコマース収益 - ラストタッチ属性**を選択します。このダッシュボード レポートでは、選択したコンバージョンウィンドウ内で、収益属性d を最後のキャンペーンまたはキャンバスに表示してから、ユーザーを操作してから発注します。
...
**eコマース収益 - ラストタッチ属性** ダッシュボードはラストタッチアトリビューションを使用します。つまり、収益は、発注前に関与したユーザーの最新のBraze キャンペーンまたはキャンバスに属性されます。
...
**eコマース収益 - ラストタッチ属性** ダッシュボードは、eCommerce 推奨イベントからデータを取得します。
...
レガシー購入イベントを使用してログに記録された購入は含まれません。**eコマース収益 - ラストタッチ属性** ダッシュボードは、現在、キャンペーン s またはCanvase 内の生涯価値や収益レポートなど、レガシー購入イベントに関連付けられた機能に対応していません。 
