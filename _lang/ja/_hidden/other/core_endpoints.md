...
# Braze コア API エンドポイント

Braze の API コア エンドポイントは、Braze アカウントのサービス レベル アグリーメント (SLA) に従ってダウンタイムが許容される Braze の REST API 内の特定のエンドポイントです。詳細については、SLA ドキュメントを参照するか、アカウント マネージャーにお問い合わせください。 
