...
<div id="braze_internal" ><i class="fa-solid fa-lock"></i> 内部のみ。顧客と共有しないでください。</div>
<div class="container-fluid" id="main-container">
      ...
      <div id="doc_div">
        <form id="doc_form">
          <div class="row">
            <div class="col">
              <h1 class="h1">資料請求フォーム</h1>
              <p class="subhead">特に断りのない限り、すべてのフィールドは必須です。</p>
          ...
          <div class="row">
            <div class="col">
              <div class="form-group" id="doc_name_div">
                <label for="doc_name" id="doc_name_label">名前</label>
                <input type="text" name="Name" id="doc_name" maxlength="80" required="required" value="" placeholder="あなたの名前を入力してください" class="form-control" />
              </div>
              ...
              <div class="form-check">
                ...
                <span></span> 私はプロダクトマネージャーです
              </label>
              </div>
              </div>
              <div class="form-group">
                <label for="doc_due_date" id="doc_due_date_label">期日 (オプション)</label>
                <div class="sublabel">このリクエストが時間的制約がある場合、または機能リリースに関連する場合は、期日を入力してください。</div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="email" class="form-control email-input" id="doc_email" maxlength="80" name="Email" placeholder="例えば、firstname.lastname@braze.com" required="required" value="" />
                  <i class="fa-solid fa-envelope email-icon"></i>
                  </div>
              </div>
              <div class="form-group" id="doc_request_div">
                <label for="doc_request" id="doc_request_label">要求の概要</label>
                <div class="sublabel">これがチケットの名前です</div>
              ...
              <option value="urgent">緊急 — 緊急の問題があり、すぐに作業がブロックされています</option>
              <option value="major">メジャー — 大きな問題があり、回避策が見つかりません</option>
              <option value="minor" selected="selected">軽微 — 軽微な問題がありますが、回避策があります</option>
              <option value="trivial" selected="selected">些細なこと — 質問や提案があります</option>
              </select>
              ...
              <div class="form-group" id="doc_request_url">
                ...
                <input type="url" name="Request_Url" id="doc_request_url" maxlength="180" required="required" value="" placeholder="例: https://www.braze.com/docs/" class="form-control" />
              </div>

              <div class="form-group">

                <label for="doc_description" id="doc_description_label" style="margin-bottom:6px;line-height:1.2;">説明</label>
                <div class="sublabel">この要求が完了したと見なすには、何をする必要がありますか?画像のドライブ フォルダ、関連する Slack スレッド、Confluence の記事、ドキュメントに含める必要のある関連リンクなど、リソースへのリンクを含めます。</div>
              ...
              <div class="form-group">
                ...
                <label for="doc_snippet" id="doc_snippet_label" style="margin-bottom:6px;line-height:1.2;">コード スニペット (オプション)</label>
                <div class="sublabel" style="margin-bottom:6px;">これは、開発者にとって便利です。コンテキストを含め、どのコード言語が使用されているかを明確にします。</div>
              ...
              <div class="form-check">
                ...
                <span></span> この情報は、それぞれの製品チームに確認しました
              </label>
              </div>
              </div>
              ...
              送信後、リクエストが処理されるまで最大10秒お待ちください。</div>

              <button type="submit" name="Submit Question" value="送信" class="btn" id="ticket_submit_button" role="button">
