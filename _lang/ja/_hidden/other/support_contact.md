...
<div id="firefox_warning" style="display:none;">Firefox ユーザーの場合は、このサイトを許可するか、<a href="https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Privacy/Tracking_Protection?utm_source=mozilla&utm_medium=firefox-console-errors&utm_campaign=default" target="_blank">Tracking Protection Settings</a> をチェックするか、チケットが送信されない可能性があります。</div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group" id="ticket_topic_div">
                          <label for="ticket_topic" id="ticket_topic_label"> 何をお手伝いできますか? *</label>
                        ...
                        <div class="form-group" id="ticket_subcategory_div">
                          <label for="ticket_subcategory" id="ticket_subcategory_label">質問ですが・・・ </label>
                          <select id="ticket_subcategory" name="00N0V000009G0ML"  class="form-control" ></select>
                        </div>
                        <div class="form-group" id="ticket_type_div">
                          プラットフォーム: <label for="ticket_type" id="ticket_type_label">
                  ...
                  <div class="col">
                    <div id="ticket_submit_option">
                      ...
                      <div class="form-group" >
                          ...
                          <input type="text" name="Name" id="ticket_name"  maxlength="80" required="required" value="" placeholder="名前を入力" class="form-control" />
                      </div>
                      <div class="form-group" >
                        ...
                        <div class="input-group">
                          ...
                          <input type="email" class="form-control" id="ticket_email"  maxlength="80" name="Email" placeholder="メールを入力" required="required" value="" /></div>
                      </div>
                      <div class="form-group" >
                        ...
                        <div class="input-group">
                          ...
                          <input type="email" class="form-control" id="ticket_ccemail"  maxlength="80" name="CCEmail" placeholder="CCメールを入力"  value="" /></div>
                      </div>
                      <div class="form-group" >
                          <label for="ticket_subject" id="ticket_subject_label">   件名 *</label>
                          <input type="text" class="form-control" id="ticket_subject"  maxlength="80" name="Subject" placeholder="あなたの質問は何ですか？" required="required" value="" />
                      </div>
                      ...
                      <div class="form-group" id="ticket_priority_div">
                        ...
                        <select id="ticket_priority" name="priority"  class="form-control" >
                          <option value="Critical">重大システムがダウンしているか、重大なデータ整合性の問題</option>
                          <option value="High">高:機能の重大な喪失またはキャンペーンが送信されない</option>
                          <option value="Medium">中:業績の悪化または重要な事業上の影響を引き起こす問題</option>
                          <option value="Low" selected="selected">低:ろう付け機能または分析に関する質問</option>
                        </select>
                      </div>
...
- セグメントまたはキャンペーンへのリンク
- 関連するユーザID
- 問題を再現する手順など、調査およびトラブルシューティングに役立つ情報を含めます  " rows="7"></textarea>
                      </div>
                      <!-- div class="form-group" >
                      ...
                      <div class="form-group">
                         ...
                         テクニカルサポート、アドレスサービス、または技術的な問題を提供するには、Braze がダッシュボードとデータにアクセスする必要がある場合があることに注意してください。
                          </label>
                          <label style="font-size: 12px;">
                          ろう付け技術サポートの営業時間は、GMTの午前9:00～午後5:00、およびETの午前8:00～午後8:00、月曜～金曜日、ろう付け認定休日を除く。対応時間外にご連絡いただいたお問い合わせについては、翌営業日の回答とさせていただきます。
                          </label>
                      </div>
                      <button type="submit" name="Submit Ticket" value="送信" class="btn btn-black" id="ticket_submit_button" role="button">送信チケット </button>
                      </div>
                  </div>
              </div>
              </form>
        ...
        <div id="support-search-div">
           ...
           <div id="support-search-panel"></div>
            ...
            <div id="ticket_usefulresources">
              ...
              <a target="" href="{{site.baseurl}}/help/home/">ヘルプ&amp;アンプ;トラブルシューティングガイド</a><br />
              <a target="" href="{{site.baseurl}}/help/faqs/">よくある質問</a><br />
              <a target="" href="https://learning.braze.com/">Braze 学習</a><br />
