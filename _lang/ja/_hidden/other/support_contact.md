...
<div id="firefox_warning" style="display:none;">Firefox ユーザー sでは、このサイトを許可するか、<a href="https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Privacy/Tracking_Protection?utm_source=mozilla&utm_medium=firefox-console-errors&utm_campaign=default" target="_blank">トラッキングプロテクション設定</a>を確認するか、チケットが送信されない可能性があります。</div>

<div class="container-fluid" id="main-container">
      <div class="row">
          <div class="col" >
              <h1 class="h1">ヘルプが必要か?</h1>
