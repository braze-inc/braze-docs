...
{% alert important %}
このページのBraze推奨事項は、BrazeAI Decisioning Studio™には適用されない。BrazeAI Decisioning Studio™の個人データに関するプライバシーの権利要求については、アカウントマネージャーに連絡すること。
{% endalert %}
...
- データ主体は、例えば、お客様の顧客アプリケーションのエンドユーザー（e.g 。お客様の顧客/クライアント）またはBrazeサービスのお客様のインスタンスの企業ユーザーであるお客様の従業員である。
