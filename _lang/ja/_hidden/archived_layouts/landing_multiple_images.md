...
guide_top_text: "マルチセクションのランディングページは、通常トピックごとにセクション内のページ間に区分がある大きなセクションに最適です。この特別なテンプレートは「dev_guide」レイアウト YAML パラメーター ('layout: dev_guide') を使用します。これにより、ページの下部に余分な情報を追加できなくなりますが、ボタンの複数のセクションを持つことができます。"
