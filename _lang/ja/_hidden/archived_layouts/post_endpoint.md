...
article_title: "レイアウト例：ポストだ：ユーザートラック"
search_tag: Endpoint
page_order: 4
layout: api_page
page_type: reference
...
このエンドポイントを使用して、Brazeの無効リストから「無効な」電話番号を削除する。これは、無効とマークされた電話番号を再度検証するために使用できる。
...
| ----------|-----------| ---------|------ |
| `phone_number` | required | e.164 形式の文字列の配列 | 最大50の電話番号の配列が変更できる。 |
