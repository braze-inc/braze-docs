...
<legend style="font-size: 2.5rem;color: #212123;font-weight:bold;">マニュアルのフィードバック</legend>
<div id="feedback">
    <div id="feedback_section">
    私たちの書類を改善するアイデアや、何か問題に気づいたことはありますか?ぜひご連絡ください！私たちのチームは、より良いものを作り続けるために、すべての投稿をレビューする。<br /><br />

    <b>Braze docsは平均的にどのくらい役に立ちますか?</b><br />

    <div id="feedback_answer_star">
      <ul class="list-inline rating-list">
        <li class="inline-star feedback-star" tabindex="0"><i class="fas fa-star" data-value="Very Helpful" title="とても役に立つ"></i><br />5<br />非常に便利</li>
        <li class="inline-star feedback-star" tabindex="0"><i class="fas fa-star" data-value="Helpful" title="役に立つ"></i></li>
        <li class="inline-star feedback-star" tabindex="0"><i class="fas fa-star" data-value="Somewhat Helpful" title="やや役に立つ"></i><br />3<br />やや有用</li>
        <li class="inline-star feedback-star" tabindex="0"><i class="fas fa-star" data-value="Unhelpful" title="役に立たない"></i></li>
        <li class="inline-star feedback-star" tabindex="0"><i class="fas fa-star" data-value="Very Unhelpful" title="非常に役に立たない"></i><br />1<br />有用ではない</li>
      </ul>
    </div>
    <div style="margin-top: 15px;">
      <b>フィードバックを共有する</b><br />
      <textarea id="feedback_comment" placeholder="&quot; このエラーメッセージ&amp;quot に関する情報が見つかりませんでした。"></textarea><br />
        質問はありますか?サポートチームにお問い合わせください。
    </div>
  ...
  <h3> これらの書類を素晴らしくするお手伝いをしましょう</h3>

  Braze Docsは、誰もが貢献することを歓迎するオープンソースプロジェクトです。288人以上の寄稿者に参加し、今日最初のプルリクエストを送信します。<br /><br />


  <button type="submit" onclick="location.href='{{site.baseurl}}/contributing/home'" value="貢献" class="btn">貢献開始</button>
