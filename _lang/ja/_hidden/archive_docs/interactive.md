...
\#スワッガーUIテーブル、#スワッガーUIテーブルtd、#スワッガーUIテーブルthead、#スワッガーUIテーブルtr {
border: none !important;
}
  \#swagger-ui .model-box {
width: 100%;
}
\#swagger-ui tabletd.col, #swagger-ui table th.col  {
...
\#swagger-uibtn.authorize.、#swagger-ui .servers select{。
