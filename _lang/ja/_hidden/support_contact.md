      ...
      'SelectOption' : {
        'SDK Integrations' : {
          ...
          'SelectOption' : {
            ...
            'User Data' :{
              'ShowSubmit': false,
              'Label': 'カテゴリ*',
              'LinksTitle': ['自動収集データ,「イベント命名規則」,ユーザープロファイルのライフサイクル'],
        ...
        'REST APIs' : {
          ...
          'SelectOption' : {
            ...
            'Importing Data' : {
              'ShowSubmit': true,
              'LinksTitle': ['ユーザーインポート','REST API:ユーザーデータエンドポイント'],
        ...
        'Email' : {
          ...
          'SelectOption': {
            'Setup (whitelabeled IPs, DNS records)' : {
              'ShowSubmit': true,
              'LinksTitle': ['電子メールオンボーディングリソース,IP とドメインの設定,IP温暖化'],
            ...
            'Deliverability' :{
              'ShowSubmit': true,
              'LinksTitle': ['配信可能性の落とし穴とスパムトラップ,IPウォーミング,Brazeラーニングコース:高い電子メール配信性の実現'],
        ...
        'Campaigns and Canvas' :{
          ...
          'SelectOption': {
            'Messaging Personalization' : {
              'ShowSubmit': true,
              'LinksTitle': ['カスタマイズと動的コンテンツ','液体タグを使用したカスタマイズ','リキッドユースケースライブラリ','接続されたコンテンツ'],
            ...
            'Message Composition by Channel' : {
              ...
              'SelectOption' : {
                'Email' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['ドラッグアンドドロップエディタを使用したメールキャンペーンの作成,HTMLエディタを使用したメールキャンペーンの作成'],
                ...
                'Push' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['プッシュキャンペーンの作成,Brazeラーニングコース:プッシュ'],
                ...
                'Content Cards' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['コンテンツカードキャンペーンの作成,Brazeラーニングコース:コンテンツカード'],
        ...
        'Technology Partners' :{
          ...
          'SelectOption': {
            ...
            'Data Infrastructure and Agility' : {
              'ShowSubmit': true,
              'LinksTitle': ['データとインフラストラクチャのアジリティパートナー'],
              'Links' : ['{{site.baseurl}}/partners/data_and_infrastructure_agility']
            },
            'Other' : {
              'ShowSubmit': true,
              'LinksTitle': ['利用可能なパートナー統合'],
