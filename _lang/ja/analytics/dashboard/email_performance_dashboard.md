...
![たとえば、335,630 件の送信があり、1 日あたり平均11,187.667 件のメール キャンペーンがあります。]({% image_buster /assets/img_archive/email_performance_dashboard_2.png %}){: style="max-width:40%;float:right;margin-left:15px;border:none;"}
...
![Google、Apple iCloud、Yahoo、Microsoft、およびMail.Ru グループとのメールボックスプロバイダーレポートによるエンゲージメントと、それに対応するクリック回数。]({% image_buster /assets/img_archive/mailbox_provider_time_engagement.png %}){: style="max-width:70%;"}
...
![月曜日と水曜日のクリック数が最も多い曜日エンゲージメント レポートの例。]({% image_buster /assets/img_archive/time_engagement.png %})

**時間帯**エンゲージメントレポートには、24時間の1時間ごとの開封またはクリックの内訳が表示されます。

![開封がs またはクリックの曜日エンゲージメント レポートのサンプルは、午前12 時から午後11 時までです。]({% image_buster /assets/img_archive/time_engagement_day.png %})
...
![たとえば、335,630 件のSMS キャンペーンがあり、1 日あたり平均11,187.667 件のSMS が送信されます。]({% image_buster /assets/img_archive/email_performance_dashboard_2.png %}){: style="max-width:40%;float:right;margin-left:15px;border:none;"}
