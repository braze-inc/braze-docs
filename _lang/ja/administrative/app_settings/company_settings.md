...
guide_top_text: "このページは、[<b>設定</b>] > [<b>管理者設定</b>] にあります。次に対応するタブを選択して、管理する設定に移動できます。<br> <br> <b>管理者設定</b>内のほとんどの機能は、Brazeアカウント管理者のみが利用できる。アクセス権がないが、アクセスすべきだと思われる場合は、会社のBrazeアカウント管理者に連絡する。"
