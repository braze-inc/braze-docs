...
![ユーザーに割り当てられた項目を、パーソナライズされた推奨事項と最も人気のある推奨事項で分けて一覧表示した表。]({% image_buster /assets/img/item_recs_analytics_2.png %})
...
![タイプ、カタログ、イベントタイプ、カスタムイベント名、プロパティ名、および最終更新日を表示する推奨概要テーブル。]({% image_buster /assets/img/item_recs_analytics_3.png %}){: style="max-width:50%" }
