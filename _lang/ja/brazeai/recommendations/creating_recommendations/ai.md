...
![カタログのアイテムIDに対応するプロパティ名"purchase_item" 。]({% image_buster /assets/img/item_recs_4.png %})
...
- **[eコマースイベントを]({{site.baseurl}}/user_guide/data/activation/custom_data/recommended_events/ecommerce_events/)アイテム推奨のトレーニングに使用する場合：**イベントからプロダクトIDにアクセスするために、`products.product_id` を追加する。
