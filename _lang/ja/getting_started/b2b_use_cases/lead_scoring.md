...
![1 ポイント、5 ポイント、および 10 ポイントを加算するアクショングループ、1 ポイントと 10 ポイントを減算するアクショングループ、および「その他のユーザー」のアクショングループを含むアクションパス。]({% image_buster /assets/img/b2b/action_paths_selected_simple.png %})({: style="max-width:20%;"})
