...
マーケティングプロセスを効率化するため、Brazeの**「テンプレート」**タブに全ての[テンプレート]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/)**&**と画像, 写真を統合した。**テンプレート&・メディア**ページにはリンクテンプレートも格納されている。
