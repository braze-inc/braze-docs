...
企業はOktaを利用してBrazeへのアクセスをコントロールし、自社のユーザーがOktaの認証情報でログインすることを許可または強制できる。この新しい製品にアクセスするには、カスタマーサクセスマネージャーまたはアカウントマネージャーに連絡するか、[サポートチケット]({{site.baseurl}}/braze_support/)を登録してください。
