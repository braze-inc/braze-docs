...
新しい[APIエンドポイント]({{site.baseurl}}/developer_guide/rest_api/api_network_connectivity_issues/#whitelisting-brazes-api-endpoint-ip-ranges)、/raw_data/status, 。指定した日がRaw Event Exportに読み込まれたかどうかを問い合わせることができる。これを使用して、特定の日の生データが利用可能かどうかを確認し、デバッグとオートメーションに役立てることができます。
