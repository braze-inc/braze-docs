...
| `BrazeUI`       | Brazeが提供するアプリ内メッセージ、コンテンツカード、バナー用のユーザーインターフェイスライブラリー。デフォルトのUIコンポーネントを使用する場合は、このライブラリーをインポートする。 |
...
| `pod 'BrazeUI'`       | Brazeが提供するアプリ内メッセージ、コンテンツカード、バナー用のユーザーインターフェイスライブラリー。デフォルトのUIコンポーネントを使用する場合は、このライブラリーをインポートする。 |
...
![新しいBrazeExample.workspace を表示するために拡張された Braze Example フォルダ]({% image_buster /assets/img/braze_example_workspace.png %})()
...
| `BrazeUI`                  | いいえ        | Brazeが提供するアプリ内メッセージ、コンテンツカード、バナー用のユーザーインターフェイスライブラリー。デフォルトのUIコンポーネントを使用する場合は、このライブラリーをインポートする。                                                                                                                                                                      |
