...
![Google タグマネージャのサンプルワークスペースのテンプレート s ページ。]({% image_buster /assets/img/web-gtm/search_tag_template_gallery.png %}){: style="max-width:95%;"}

### ステップ 2: 初期化タグ テンプレートの追加

テンプレートギャラリーで`braze-inc` を検索し、**Braze初期化タグ** を選択します。

![様々な「ろう付け-インチ」テンプレートを示すテンプレート画廊。]({% image_buster /assets/img/web-gtm/template_gallery_results.png %}){: style="max-width:80%;"}
...
![「" テンプレート s"」ページ(Googleタグマネージャ)に、Braze初期化タグテンプレートが表示されます。]({% image_buster /assets/img/web-gtm/select_tag_template.png %}){: style="max-width:95%;"}

鉛筆アイコンを選択し、**Tag Configuration**ドロップダウンを開封します。

![タグ設定タイルに「鉛筆」アイコンが表示されます。]({% image_buster /assets/img/web-gtm/gtm-initialization-tag.png %})
...
![「タグ設定」のBraze初期化オプションの一覧。]({% image_buster /assets/img/web-gtm/braze_initialization_options.png %}){: style="max-width:65%;"}
