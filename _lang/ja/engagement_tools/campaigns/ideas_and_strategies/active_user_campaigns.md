...
![iOS のリッチプッシュ通知を使用した「作成」ステップのキャンペーン。文面は次のとおりです。「ご購入いただき誠にありがとうございます!日頃の感謝を込めて、次回のお買い物から送料を無料にさせていただきます」。]({% image_buster /assets/img/congratulations_push.jpg %})
