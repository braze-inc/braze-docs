...
![指定した時間にキャンペーンを送信する、時間ベースのスケジュールオプション。]({% image_buster /assets/img_archive/schedule_designated.png %})
...
![インテリジェントタイミングを使用して、全ユーザーの間でアプリを使用する最も人気のある時間にキャンペーンを送信するための時間ベースのスケジュールオプション。]({% image_buster /assets/img_archive/schedule_intelligent.png %})
