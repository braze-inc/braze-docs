...
![アイテム"sun ブロック" を属性"items_in_wishlist".]({% image_buster /assets/img_archive/canvas_user_update_wishlist.png %} に追加するユーザアップデートステップ{: style="max-width:90%;"}
...
![アイテムID で属性"most_recent_cart_item" を更新するユーザ更新 ステップ。]({% image_buster /assets/img_archive/canvas_user_update_cep.png %}){: style="max-width:90%;"}
