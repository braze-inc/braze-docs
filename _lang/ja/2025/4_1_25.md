...
![以前のSWIFTのドキュメントは、プラットフォーム統合ガイドセクションにあった。]({% image_buster /assets/img/before_swift.png %})
...
![SDKの統合に関する記事のSwiftタブにある更新されたSwiftドキュメント。]({% image_buster /assets/img/after_swift.png %})

![SDKの統合に関する記事のAndroidタブにある更新されたAndroidドキュメント。]({% image_buster /assets/img/after_android.png %})
...
- [バナーキャンペーンを作成する]({{site.baseurl}}/user_guide/message_building_by_channel/banners/create/)
