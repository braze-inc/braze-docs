...
「キャンペーンからメールを開いた」または「キャンペーンからメールをクリックした」のコンバージョンイベントを指定できるようになりました。詳細については、「[キャンペーン配信タイプ][16]」を参照してください。
...
新しく作成した「メールアドレスの追加」アクションベーストリガーを使用して、ユーザーが最初にメールアドレスを追加したときに、ダブルオプトインメールまたはウェルカムメールを送信しやすくなりました。[電子メールのベストプラクティス][18]について詳しく説明します。
