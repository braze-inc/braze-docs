...
## インポート後のCSV ダウン読み込む
企業ユーザーは、最近インポートしたユーザーのCSVをダウンロードできるようになった。これにより、システムからのデータ同期の可視性が向上します。CSV インポートについて詳しくは、[こちら]({{site.baseurl}}/user_guide/data/user_data_collection/user_import/)をご覧ください。
