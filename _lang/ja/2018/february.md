...
[メールテンプレートを API を介して]({{site.baseurl}}/developer_guide/rest_api/email_templates/#email-templates)作成および更新できるようになりました。各テンプレートには、他のAPI呼び出しで参照できる**email_template_id**\`\`が存在する。
