...
| [ユニーククリック数]({{site.baseurl}}/user_guide/data_and_analytics/report_metrics#unique-clicks) | メッセージ内を1 回以上クリックした受信者の個数を、[`dispatch_id`]({{site.baseurl}}/help/help_articles/data/dispatch_id/) で測定します。各ユーザーは1 回のみカウントされます。 |
