...
3. プロジェクトの [**一般**] タブで、`Appboy_iOS_SDK.xcframework` の [**埋め込みと署名**] を選択します。

### オプション2:静的統合用の静的 XCFramework
...
3. **[ファイル] > [ファイルの追加] > [プロジェクト名]** に移動します。<br><br>
...
手順に従って[統合を完了]({{site.baseurl}}/developer_guide/platform_integration_guides/ios/initial_sdk_setup/completing_integration/)してください。
