...
新しいコンテンツをバックグラウンドでダウンロードするようにデバイスに指示するには、\[**コンテンツ利用可能フラグを追加**] チェックボックスをオンにします。ほとんどの場合、\[サイレント通知][2]]を送信することに興味がある場合、これを確認できます。

## mutable-content フラグを追加する

\[**Add Mutable-Content Flag**] チェックボックスをオンにして、iOS 10 以上のデバイスで受信者の高度なカスタマイズを有効にします。このフラグは、このチェックボックスの値に関係なく、\[リッチプッシュ通知][3]を作成するときに自動的に送信されます。
