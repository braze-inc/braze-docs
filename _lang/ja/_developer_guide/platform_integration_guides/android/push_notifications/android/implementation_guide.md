...
<br>
{% alert important %}
基本的なプッシュ通知開発者統合ガイドをお探しの場合は、[こちら]({{site.baseurl}}/developer_guide/platform_integration_guides/android/push_notifications/android/integration/standard_integration/)でご確認ください。
{% endalert %}
...
![パーソナライズされたプッシュダッシュボードの例][1]{: style="max-width:65%;border:0"}
...
![パーソナライズされたプッシュダッシュボードの例][2]{: style="max-width:60%;"}
...
![パーソナライズされたプッシュダッシュボードの例][3]{: style="max-width:80%;"}
