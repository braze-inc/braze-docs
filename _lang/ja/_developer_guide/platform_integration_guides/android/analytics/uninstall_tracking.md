...
プッシュ通知が自分自身をアンインストール追跡しているかどうかを検出したい場合は、[`isUninstallTrackingPush()`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.push/-braze-notification-utils/is-uninstall-tracking-push.html)を使用します。
