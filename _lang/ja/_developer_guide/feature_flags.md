...
guide_top_text: "フィーチャーフラグを使用すると、選択したユーザーに対してリモートで機能を有効または無効にすることができます。重要なことは、追加のコード展開やアプリストア更新を使用せずに、機能のオンオフを本番環境で切り替えることができることです。これにより、新しい機能を安全かつ確信を持ってロールアウトできます。"
description: "このランディングページには、フィーチャーフラグの作成方法に関する記事やユースケースなど、フィーチャーフラグに関するすべてのものが用意されています。"
channel:
  - feature flags
