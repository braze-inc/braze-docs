...
Braze でバナーメッセージをテストする前に、[Braze でバナーキャンペーン]({{site.baseurl}}/user_guide/message_building_by_channel/banners/create/)を作成する必要があります。さらに、テストしたい配置がすでに[アプリや Web サイトに配置されている]({{site.baseurl}}/developer_guide/banners/placements)ことを確認します。 
