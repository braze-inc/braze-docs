...
[`changeUser`](https://braze-inc.github.io/braze-swift-sdk/documentation/brazekit/braze/changeuser(userid:sdkauthsignature:fileid:line:)) の呼び出し時に JWT トークンを指定する：
...
### ステップ 3:ダッシュボードでの認証の有効化 {#braze-dashboard}
