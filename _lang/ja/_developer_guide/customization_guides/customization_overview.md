...
「ハイハイ」のアプローチは、マーケターに直接カスタマイズの力を与えます。いくつかの軽い開発作業が必要ですが、Brazeメッセージングチャネルをアプリやサイトに統合することで、このアプローチにより早く稼働を開始できます。 
...
![カスタムコンテンツカードを使用したサンプルの金融アプリで、メールキャプチャを表示]({% image_buster/assets/img_archive/cc_pyrite_run.png %}){: style="max-width:35%;float:right;margin-left:15px;border:none;"}
