...
{% alert tip %}
[GitHub で Unreal Engine Braze SDK の変更ログ](https://github.com/braze-inc/braze-unreal-sdk/blob/master/CHANGELOG.md)のコピーを見つけることもできます。
{% endalert %}
...
{% sdktab xamarin %}
{% alert tip %}
[GitHub で .NET MAUI の Braze SDK 変更ログ](https://github.com/braze-inc/braze-xamarin-sdk/blob/master/CHANGELOG.md)のコピーを見つけることもできます。
{% endalert %}
