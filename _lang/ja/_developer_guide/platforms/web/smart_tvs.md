...
アナリティクスのための同じWeb SDKメソッドはすべて、スマートTVで使用できる。カスタムイベントやカスタム属性のトラッキング, 追跡方法など、詳細な手順については[分析を]({{site.baseurl}}/developer_guide/analytics/tracking_sessions/?tab=web)参照せよ。
