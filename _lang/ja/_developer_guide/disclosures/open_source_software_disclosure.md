...
* Google Code Pretify Apache License 2.0
* Google Play Services Apache 2.0
* HighLine GNU General Public License v2.0以降
...
* syslog-logger MIT
* systemu ruby
* tablesorter jQuery plugin GNU General Public License v2.0以降
* teaspoon MIT
* teaspoon-mocha MIT
* temple MIT
