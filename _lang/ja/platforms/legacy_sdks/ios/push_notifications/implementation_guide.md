...
<br>
{% alert important %}
基本的なプッシュ通知開発者統合ガイドをお探しの場合は、それを見つける [here]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/integration/).
{% endalert %}
...
![キーと値のペアが3セットあるプッシュメッセージ。1. "Braze_id" は、Braze ID を取得するためのリキッドコールとして設定されます。2. "cert_title" &quot として設定; Braze マーケター認証&クォート;3. "Cert_description" &quot として設定;Certified Braze マーケター s drive..."。]({% image_buster /assets/img/push_implementation_guide/push18.png %}){: style="max-width:80%;"}
