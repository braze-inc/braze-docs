...
| -------- | -------- | --------- | ----------- |
| `event` | 必須 | string | アナリティクスを返すカスタムイベントの名前。 |
...
| `segment_id` | オプション | string | 「[セグメント API 識別子]({{site.baseurl}}/api/identifier_types/)」を参照してください。イベント分析が返されるべき、分析可能なセグメントを示すセグメント ID。 |
