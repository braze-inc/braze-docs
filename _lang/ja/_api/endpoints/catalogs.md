...
search_tag: Endpoint
description: "このランディングページには、Braze カタログエンドポイントがリストされます。"
page_type: landing

guide_top_header: "カタログエンドポイント"
guide_top_text: "Braze カタログエンドポイントを使用して、カタログとカタログ項目の詳細を追加、編集、管理します。カタログを一括変更するには、非同期カタログ エンドポイントを使用します。<br><br> カタログ作成の指針を探していますか?<a href='/docs/user_guide/personalization_and_dynamic_content/catalog/'>カタログの作成と使用</a>については、こちらの記事を参照してください。"
