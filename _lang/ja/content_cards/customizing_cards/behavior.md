...
![補足コンテンツカードのユースケースのキーと値のペア。このサンプルでは、"tile_id", "tile_deeplink", や"tile_title" などのカードのさまざまな側面が、Liquid を使用して設定されます。]({% image_buster /assets/img/cc_implementation/supplementary_content.png %}){: style="max-width:60%;"}
