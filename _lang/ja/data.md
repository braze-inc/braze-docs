...
- パートナー統合私たちは、リアルタイムで双方向のデータ共有を容易にする、最良のエコシステム・テクノロジーとの統合を優先する（そしてAPIを提供する）。
...
- **データプライバシー**顧客がエンドユーザーの同意を管理し、リクエストを処理し、消費者の権利をアクションできるようにする。