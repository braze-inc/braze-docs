...
{% alert important %}
このページのBraze推奨事項は、BrazeAI Decisioning Studio™には適用されない。BrazeAI Decisioning Studio™のパーソナライゼーションに関連するプライバシー権の要求については、アカウントマネージャーに連絡すること。
{% endalert %}
...
<tbody>
  <tr>
    ...
    <ul>
        <li>USERS_BEHAVIORS_CUSTOMEVENT のプロパティ</li>
        <li>USERS_BEHAVIORS_PURCHASE のプロパティ</li>
        <li>メッセージの</li>
            <ul>
