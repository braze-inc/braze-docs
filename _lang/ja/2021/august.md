...
2 要素認証によるログインに問題があるユーザーは、会社の管理者に連絡して2 [要素認証をリセット]({{site.baseurl}}/user_guide/administrative/app_settings/company_settings/security_settings/#user-authetication-reset)してもらうことができる。
