...
2 要素認証によるログインに問題があるユーザーは、会社の管理者に連絡して[2 要素認証をリセットする]({{site.baseurl}}/user_guide/administrative/app_settings/company_settings/security_settings/#user-authetication-reset)ことができる。
