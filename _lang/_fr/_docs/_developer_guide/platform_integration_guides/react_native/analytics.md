...
Before you start, read our [Analytics Overview][] article to learn more about Braze analytics and what is already tracked by default. We also recommend familiarizing yourself with our [event naming conventions][1].
...
[Analytics Overview]: {{site.baseurl}}/developer_guide/platform_wide/analytics_overview/
