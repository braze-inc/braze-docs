          ...
          <div class="row">
            <div class="col">
              ...
              <div class="form-group">
                ...
                <label for="doc_description" id="doc_description_label">   * Veuillez décrire votre demande. </label>
    
                <textarea name="Description" class="form-control" id="doc_description" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="Que faut-il faire pour que vous considériez cette demande complète ? Soyez aussi descriptif que possible.&#10;&#10;Lien vers autant de ressources que nécessaire, y compris des répertoires pleins d’images. Inclure des liens vers la documentation existante qui doit être réparée ainsi que des liens qui pourraient devoir être inclus dans la documentation. placeholder="Que faut-il faire pour que vous considériez cette requête complète ? Soyez aussi descriptif que possible.&#10;&#10;Lien vers autant de ressources que nécessaire, y compris des répertoires pleins d’images. Inclure les liens vers la documentation existante qui doit être réparée ainsi que les liens qui pourraient devoir être inclus dans la documentation."
                  rows="7"></textarea>
              </div>
    
              <div class="form-group">
    
                <label for="doc_snippet" id="doc_snippet_label">   * Veuillez insérer des extraits de code pertinents avec le contexte.</label>
    
                <textarea name="Snippet" class="form-control" id="doc_snippet" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="Ceci est utile si vous êtes un développeur. Assurez-vous qu'il soit clair dans quel langage il est écrit également. " placeholder="Ceci est utile si vous êtes un développeur. Assurez-vous qu'il soit clair dans quel langage il est écrit également. "
                  rows="7"></textarea>
              </div>
