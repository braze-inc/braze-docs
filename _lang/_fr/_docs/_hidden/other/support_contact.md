...
<div id="firefox_warning" style="display:none;">Pour les utilisateurs de Firefox, veuillez mettre ce site en liste blanche ou vérifier vos <a href="https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Privacy/Tracking_Protection?utm_source=mozilla&utm_medium=firefox-console-errors&utm_campaign=default" target="_blank">Paramètres de protection de suivi</a>, ou votre ticket pourrait ne pas être envoyé.</div>

<div class="container-fluid" id="main-container"> <div class="row">
          <div class="col" >
              <h1 class="h1">Besoin d'aide ? </h1>
              <div class="gradient-line"></div>
          </div>
      </div>
        <div id="ticket_mainform" class="row"> <div class="col-sm-7" id="ticket_leftmain">
          <form id="ticket_form">
                  ...
                  <div class="col">
                    <div id="ticket_submit_option">
                      ...
                      <div class="form-group" >
                          ...
                          <input type="text" name="Name" id="ticket_name"  maxlength="80" required="required" value="" placeholder="Entrez votre nom" class="form-control" />
                      </div>
                      <div class="form-group" >

                        <label for="ticket_email" id="ticket_email_label"> Adresse e-mail *</label>
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">@</span>
                          </div>
                          <input type="email" class="form-control" id="ticket_email"  maxlength="80" name="Email" placeholder="Entrez votre adresse e-mail" required="required" value="" /></div>
                      </div>
                      <div class="form-group" >
                        ...
                        <div class="input-group">
                          ...
                          <input type="email" class="form-control" id="ticket_ccemail"  maxlength="80" name="CCEmail" placeholder="Entrez l'email CC"  value="" /></div>
                      </div>
                      <div class="form-group" >
                          <label for="ticket_subject" id="ticket_subject_label">   Sujet *</label>
                          <input type="text" class="form-control" id="ticket_subject"  maxlength="80" name="Subject" placeholder="De quoi traite votre question ?" required="required" value="" />
                      </div>
                      ...
                      <div class="form-group" id="ticket_priority_div">
                        ...
                        <select id="ticket_priority" name="priority"  class="form-control" >
                          <option value="Critical">Critique : Le système est un problème d'intégrité des données faible ou sévère</option>
                          <option value="High">Haut: Une grave perte de fonctionnalités ou une campagne ne sera pas envoyée</option>
                          <option value="Medium">Moyenne : performance dégradée ou impact économique important sur les questions</option>
                          <option value="Low" selected="selected">Bas : Question sur la fonctionnalité de Braze ou l'analyse</option>
                        </select>
                      </div>
                      ...
                      <div class="form-group" >
                          ...
                          placeholder="Inclure des informations utiles pour les enquêtes et le dépannage, telles que votre plate-forme, la version SDK, les points de terminaison de l'API REST, les liens vers des segments ou des campagnes et les identifiants d'utilisateurs pertinents. Veuillez également inclure des étapes pour reproduire votre problème.  " rows="7"></textarea>
                      </div>
                      <!-- div class="form-group" >
                      ...
                      <div class="form-group">
                         ...
                         Afin de vous fournir un support technique ou une adresse de service ou de problèmes techniques, Veuillez noter que Braze peut avoir besoin d'accéder à votre tableau de bord et à vos données.
                          </label>
                          <label style="font-size: 12px;">
                          Les heures de support technique de Braze sont de 9 h à 17 h GMT et de 8 h à 20 h HE, du lundi au vendredi, hors jours fériés reconnus de Braze. Pour les problèmes enregistrés en dehors de ces heures, vous devriez anticiper une réponse le jour ouvrable suivant.
                          </label>
                      </div>
                      <button type="submit" name="Submit Ticket" value="Soumettre" class="btn btn-black" id="ticket_submit_button" role="button"> SOUMETTRE DES BILLETS </button>
                      </div>
                  </div>
              </div>
              </form>
  ...
  <div id="support-search-panel">
  </div><legend>Ressources utiles</legend> 
  
  <div id="ticket_usefulresources">
    <a target="" href="{{site.baseurl}}/user_guide/introduction/">Guide utilisateur</a><br /> <a target="" href="{{site.baseurl}}/developer_guide/platform_wide/platform_features/">Guide de développeur</a><br /> <a target="" href="{{site.baseurl}}/help/home/">Guides d'aide et de dépannage</a><br /> <a target="" href="{{site.baseurl}}/help/faqs/">FAQ</a><br /> <a target="" href="https://lab.braze.com/">LAB</a><br /> <a target="" href="https://dashboard.braze.com/">Tableau de bord Braze</a><br />
  </div>
</div></div> 

<div id="ticket_thankyou" style="display:none;">
  <div class="row">
    <div class="col" id="ticket_thankyou_msg">
    </div>
  </div>
</div></div>
