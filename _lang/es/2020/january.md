...
Braze ahora te permite [limitar la frecuencia]({{ site.baseurl}}/user_guide/engagement_tools/campaigns/testing_and_more/rate-limiting/) de los mensajes SMS. También puedes implementar un filtro de ]({{ site.baseurl}}/user_guide/engagement_tools/segments/segmentation_filters/)segmento añadido «Último SMS recibido».
