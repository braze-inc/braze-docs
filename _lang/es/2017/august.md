...
Hemos expuesto nuevos puntos finales de API,/email/hard_bounces,  que te permiten extraer rebotes duros por dirección de correo electrónico o en un intervalo de fechas determinado, y/messages/scheduled_broadcasts,  que te permiten extraer la próxima vez que comenzarán las campañas programadas y los lienzos de entrada programada. Estos nuevos puntos finales te permiten una mayor personalización y optimización de tus campañas. Más información sobre nuestros [puntos finales de la API]({{site.baseurl}}/developer_guide/rest_api/basics/#what-is-a-rest-api).
