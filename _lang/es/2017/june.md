...
Hemos actualizado la API externa para que admita elcollapse_idcampo  para Apple Push, lo que te permite enviar mensajes personalizados a tus clientes con precisión. Más información sobre [la API de mensajería Braze]({{site.baseurl}}/api/endpoints/messaging/).
