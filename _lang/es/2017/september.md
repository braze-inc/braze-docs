...
Hemos añadido un nuevo [punto final de API]({{site.baseurl}}/developer_guide/rest_api/api_network_connectivity_issues/#whitelisting-brazes-api-endpoint-ip-ranges) que/raw_data/status, te permite realizar una consulta para saber si un día determinado se ha cargado en la exportación de eventos sin procesar. Puedes utilizarla para comprobar si los datos brutos de un día concreto están disponibles, para ayudar a la depuración y automatización.
