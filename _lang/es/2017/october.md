...
Las empresas pueden utilizar Okta para controlar el acceso a Braze y permitir u obligar a los usuarios de su empresa a iniciar sesión con las credenciales de Okta. Para acceder a este nuevo producto, ponte en contacto con tu administrador del éxito del cliente, director de cuentas o abre un [ticket de soporte]({{site.baseurl}}/braze_support/).
