...
El [Protocolo de Contexto Modelo (MCP](https://modelcontextprotocol.io/docs/getting-started/intro) ) es un protocolo de código abierto introducido recientemente que puede ser susceptible de problemas de seguridad o vulnerabilidades en este momento.
