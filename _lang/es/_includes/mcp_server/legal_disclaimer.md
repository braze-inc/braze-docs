...
El [Model Context Protocol (MCP)](https://modelcontextprotocol.io/docs/getting-started/intro) es un protocolo de código abierto recientemente introducido que, en este momento, puede ser susceptible a problemas de seguridad o vulnerabilidades.
...
Si necesitas ayuda o aclaración, ponte en contacto con [soporte de Braze]({{site.baseurl}}/user_guide/administrative/access_braze/support).