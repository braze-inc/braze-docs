...
Si, por el contrario, el modelo te permitiera mensajear al 20% de los usuarios y, al hacerlo, captar a todos los "verdaderos" usuarios que abandonan y a nadie más, la elevación sería del 100% / 20% = 5. Si graficas esta relación para cada proporción de los usuarios que abandonan más probablemente a los que podrías enviar mensajes, obtendrás la [Curva de Elevación](https://en.wikipedia.org/wiki/Lift_(data_mining)). 
