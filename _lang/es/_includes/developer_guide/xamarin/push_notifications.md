...
Consulta [las instrucciones de integración de Swift]({{site.baseurl}}/developer_guide/push_notifications/?sdktab=swift) para obtener información sobre la configuración de tu aplicación con push y el almacenamiento de tus credenciales en nuestro servidor. Consulta la aplicación de ejemplo [MAUI de iOS](https://github.com/braze-inc/braze-xamarin-sdk/tree/master/appboy-component/samples/ios-net-maui/BrazeiOSMauiSampleApp) para más detalles.

### Paso 2: Solicitar permiso para notificaciones push

Nuestro SDK .NET MAUI ahora admite la configuración push automática. Configura la automatización push y los permisos añadiendo el siguiente código a la configuración de tu instancia de Braze:
