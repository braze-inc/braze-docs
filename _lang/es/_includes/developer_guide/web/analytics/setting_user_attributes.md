...
{% alert important %}
La plantilla GTM no admite propiedades anidadas en eventos o compras. Puedes utilizar el HTML anterior para registrar cualquier evento o compra que requiera propiedades anidadas.
{% endalert %}
{% endtab %}
{% endtabs %}
