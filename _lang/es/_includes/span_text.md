...
![Cuadro de texto con diferentes secciones de texto estilizadas, como distintos tamaños y colores de letra, y una sección resaltada que muestra una barra de herramientas con la opción "Ajustar con span por estilo".]({% image_buster /assets/img/landing_pages/wrap_with_span.png %}){: style="max-width:50%;"}
