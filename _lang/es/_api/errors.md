...
En caso de éxito, los mensajes que no se hayan visto afectados por un error en la`errors`matriz se seguirán entregando. Si tu mensaje contiene un error fatal, recibirás la siguiente respuesta:
