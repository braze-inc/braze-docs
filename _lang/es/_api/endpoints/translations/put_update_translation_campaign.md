...
{% alert important %}
La actualización de una traducción en una campaña a través de la API se encuentra actualmente en acceso temprano. Póngase en contacto con su gestor de cuenta Braze si está interesado en participar en el acceso anticipado.
{% endalert %}
