---
nav_title: "GET: Ver traducción específica y localización para plantilla de correo electrónico"
...
> Utiliza este punto final para ver una traducción y localización específicas para la plantilla de correo electrónico de una [plantilla]({{site.baseurl}}/user_guide/message_building_by_channel/email/templates).
