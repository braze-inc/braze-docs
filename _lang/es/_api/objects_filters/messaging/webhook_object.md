...
Como mejor práctica, Braze recomienda proporcionar un valor explícito para `Content-Type` en el campo `request_headers` para un comportamiento coherente y predecible, ya que los remitentes y servidores pueden cambiar con el tiempo. Si no especificas un valor para el encabezado `Content-Type`, el sistema infiere un valor a partir del cuerpo de la solicitud.
