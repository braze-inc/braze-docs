...
Ahora puedes utilizar LinkedIn con [Braze Audience Sync]({{site.baseurl}}/partners/canvas_audience_sync/), una herramienta que te ayuda a ampliar el alcance de tus campañas a muchas de las principales tecnologías sociales y publicitarias. Para participar en la beta, ponte en contacto con tu administrador de éxito de Braze.
...
|Antes de|Después de|
|------|-----|
|![La antigua navegación de la Guía para desarrolladores de Braze.]({% image_buster /assets/img/release_notes/developer_guide_improvements/old_navigation.png %})|![La nueva navegación para la Guía del desarrollador de Braze.]({% image_buster /assets/img/release_notes/developer_guide_improvements/new_navigation.png %})|
