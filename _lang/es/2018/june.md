...
Los administradores ahora pueden determinar el número mínimo de contraseñas nuevas y únicas que los demás usuarios de la empresa deben utilizar antes de poder reutilizar una contraseña anterior. Esto se puede controlar desde el panel [Reglas de autenticación]({{site.baseurl}}/user_guide/onboarding/platform_administrative_features/#authentication-rules) en la **configuración de la empresa**, en la pestaña **Configuración de seguridad**.
