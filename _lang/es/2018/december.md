...
[Los bloques de contenido]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/content_blocks/) te permiten gestionar tus contenidos reutilizables y de canales cruzados en una única ubicación centralizada. Para acceder a esta característica, ve a la pestaña **Biblioteca de bloques de contenido** en la sección **Plantillas&y medios** de tu cuenta de Braze. 
