...
Ahora puedes ir a **Análisis de campaña** y calcular las estadísticas exactas de tu audiencia. Haz clic en **Calcular estadísticas exactas** en el pie de página de la sección **Audiencias objetivo** y se mostrarán las estadísticas exactas de la audiencia. Tendrás que guardar la campaña antes de calcularla (los borradores de campaña se guardarán como borradores).
