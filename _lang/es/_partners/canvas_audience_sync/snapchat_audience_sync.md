...
![Vista ampliada del paso en Canvas Audiencia personalizada. Aquí se selecciona la cuenta de anuncios deseada y se crea una nueva audiencia.]({% image_buster /assets/img/audience_sync/snapchat3.png %})
