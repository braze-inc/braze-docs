...
| [Acortamiento de enlaces]({{site.baseurl}}/user_guide/message_building_by_channel/sms/campaign/link_shortening/) | Confirma que el acortamiento de enlaces está activado. | 
...
Después de que los usuarios guarden tu marca como contacto, ya sea a través de una [tarjeta de contacto]({{site.baseurl}}/user_guide/message_building_by_channel/sms/mms/contact_card/) o de otro método, podrán ver las indicaciones de **Tocar para cargar vista previa** y los enlaces de Movable Ink.
