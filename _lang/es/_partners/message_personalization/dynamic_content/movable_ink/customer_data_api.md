...
1. En Braze, [crea una campaña webhook][1].
...
![Pestaña Componer del compositor de webhooks en Braze con la URL del punto final de Movable Ink y el cuerpo de la solicitud configurados como Pares clave/valor JSON.][img1]{: style="max-width:75%" }
...
![Pestaña de configuración del compositor de webhooks en Braze con pares clave-valor para Content-Type y Authorization.][img2]{: style="max-width:75%" }

#### Paso 1c: Configura tu carga útil

1. Vuelva a la pestaña **Redactar**.
2. Para tu **cuerpo** de solicitud, crea tu propio cuerpo de solicitud con pares clave-valor JSON o introduce la carga útil de tu evento como texto sin formato. Consulte las [cargas útiles de muestra](#sample-payloads) para ver ejemplos de eventos de comercio electrónico estándar.
...
![Mensaje de respuesta de webhook en Braze que muestra una respuesta 200 OK.][img4]{: style="max-width:75%" }

### Paso 2: Finalice la configuración de su campaña

#### Paso 2a: Programa tu campaña

Cuando hayas terminado de componer y probar el webhook, [programa tu campaña][2]. 

Braze admite entregas programadas, basadas en acciones y activadas por API. [La entrega basada en acciones][3] suele ser la más adecuada para la mayoría de los casos de uso de eventos de comportamiento. Si tienes preguntas sobre lo que tiene sentido para tu caso de uso, ponte en contacto con tus administradores del éxito del cliente de Braze y Movable Ink.
...
A continuación, determina a qué usuarios quieres dirigir esta campaña. Para más información, consulte la sección [Dirigirse a los usuarios][4].
...
![Panel de pruebas A/B en una campaña Braze con una distribución de variantes del 100% asignada a la variante 1 y sin grupo de control.][img5]
...
Para obtener más información sobre las propiedades de eventos personalizados y el formato esperado de los datos contenidos en las propiedades, consulte [Propiedades de eventos personalizados][5].
