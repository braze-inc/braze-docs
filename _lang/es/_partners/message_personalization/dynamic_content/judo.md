...
![Una imagen del aspecto del panel de control cuando se selecciona el tipo de mensaje "Código personalizado".][2]
...
![Una imagen que muestra el código de validación del formulario añadido al paso de composición de su campaña.][3]

### Paso 2: Establecer un par clave-valor para Judo
![Esta imagen muestra el par clave-valor necesario para esta integración, siendo la "clave" "judo-experiencia" y el "valor" tu enlace de Judo.][4]{: style="float:right;max-width:50%;margin-left:15px;"}
