...
Crea una [campaña de mensajería dentro de la aplicación]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/create/) en Braze y establece el **Tipo de mensaje** en **Código personalizado**.
