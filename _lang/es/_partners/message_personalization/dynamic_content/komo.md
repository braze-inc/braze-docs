...
| ----------- | ----------- |
| Cuenta Komo | Necesitarás una cuenta activa de Komo para beneficiarte de esta asociación. Visita [Komo][7] para iniciar una prueba ahora. |
...
| Punto final REST Braze | [La URL de tu punto final REST][1]. Tu punto final dependerá de la URL Braze de tu instancia.<br><br>Por ejemplo, debería ser algo así https://rest.iad-03.braze.com |
