...
Antes de configurar Braze para enviar mensajes personalizados a los usuarios, revise los componentes relevantes necesarios para un sitio web de comercio electrónico típico, utilizando como ejemplo la arquitectura de Retail Demo Store.
