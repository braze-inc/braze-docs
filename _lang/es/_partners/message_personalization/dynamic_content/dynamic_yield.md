...
A continuación, selecciona **Crear bloque de experiencia** para diseñar un bloque de contenido dinámico o de recomendaciones para incrustar dentro de una plantilla de correo electrónico Braze.<br>![][8]

### Paso 2: Redacta tu mensajería

La siguiente imagen muestra un correo electrónico desde cero en el desarrollador.<br>![][6]
...
2. Selecciona una plantilla para la primera variación. Ahora puedes definir variables de diseño y contenido. Guarda la variación cuando la hayas completado. <br>![][4]<br><br> 
3. Configura la audiencia en el panel Contenido dinámico.<br>![][5]<br><br> 
...
2. Introduce el token correspondiente de Braze que inserta el CUID y el ID de correo electrónico del usuario.<br>![][3]
...
2. A continuación, haz clic en **Copiar al portapapeles**.<br>![][1]<br><br> 
