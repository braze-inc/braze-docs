...
> [Smartling][5] es un software integral de gestión de la traducción en la nube para clientes que buscan automatizar la traducción de sitios web, aplicaciones y experiencias de cliente.
...
| Proyecto de traducción de Smartling | Para conectar tu cuenta Braze con Smartling, primero debes registrarte y [crear un proyecto de traducción][6]. |
...
* Consulte la [documentación de Smartling][3] para obtener información detallada sobre la configuración de los conectores.
...
![Configuración del idioma del conector.][8]
...
![Lista de bloques de contenido.][9]
