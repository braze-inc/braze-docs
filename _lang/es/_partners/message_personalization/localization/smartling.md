...
description: "Este artículo de referencia describe la asociación entre Braze y Smartling, un software basado en la nube para la localización. El conector de Braze admite la traducción de plantillas de correo electrónico HTML, bloques de contenido, Canvas y mensajes de correo electrónico de campaña."
...
Para saber más sobre el flujo de trabajo heredado, consulta [Gestionar las traducciones mediante el flujo de trabajo heredado](#managing-translations-using-the-legacy-workflow).
...
{: start="5"}
5. En la configuración de Braze, comprueba que los valores de la columna **Idioma de destino (Braze)** coinciden con las localizaciones configuradas en la configuración multilingüe de Braze. La convención de nomenclatura de la localización debe coincidir exactamente.
