...
| --- | --- |
| cuenta loplat X | Para beneficiarse de esta integración es necesario disponer de una cuenta loplat X.<br><br>Envía un correo electrónico a [support@loplat.com][3] para solicitar una cuenta loplat X. |
...
- [Alerta de promoción en las tiendas libres de impuestos][2]
...
Integra el SDK de loplat y el SDK de Braze en tu aplicación siguiendo los pasos indicados en la documentación de [integración de loplat-Braze][4].
...
3. Vaya a loplat X y cree una campaña siguiendo las instrucciones de la [guía del usuario de loplat X][5].
...
1. Cree una campaña loplat X siguiendo las instrucciones de la [guía del usuario de loplat X][6].
