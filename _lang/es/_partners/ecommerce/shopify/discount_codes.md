...
# Envía códigos de descuento únicos a través de Shopify
...
![Diagrama de flujo que muestra la eliminación de la cabecera de fila "Promo" en un archivo CSV][3].{: style="max-width:60%;"}
