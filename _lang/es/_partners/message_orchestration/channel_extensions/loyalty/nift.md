...
Visita tu [panel de Nift][2], ve a **Cuentas** > **Integraciones** > **Braze** y haz clic en **Conectar**.
...
!["Página de integración del servicio Nift que solicita al usuario la clave de API de Braze y la URL del panel de Braze.][5]
