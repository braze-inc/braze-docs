...
| Clave de API REST de Braze   | Una clave de API REST de Braze con permisos `users.track`.<br><br>Para crear una nueva clave de API en el panel de Braze, ve a **Configuración** > **Claves de API** y haz clic en **Crear nueva clave de API**.  |
...
![Conecta la pantalla de Braze en Antavo con la URL de la instancia, el token de la API y el identificador de la aplicación.][1]
...
![Página Sincronizar campos en Antavo.][2]
...
![El perfil de Braze que muestra diferentes atributos personalizados.][3]
...
Utiliza eventos sincronizados desde Antavo para introducir miembros de fidelización en Canvas de Braze basados en acciones. La integración puede sincronizar cualquier evento de Antavo (incluidos los eventos de compra) que aparezcan en Braze como eventos personalizados.
