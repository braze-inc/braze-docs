...
|-----------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| Una cuenta Friendbuy   | Es necesario tener una [cuenta Friendbuy][1] para beneficiarse de esta asociación.                                                              |
...
En [Friendbuy][1], ve a **Centro de desarrollo** > **Integraciones** y, en la tarjeta de integración Braze, selecciona **Añadir integración**.

![La tarjeta de integración Braze en Friendbuy.][100]{: style="max-width:75%;"}

En el formulario, introduce tu punto final REST y tu clave de API y, a continuación, selecciona **Instalar integración**.

![El formulario de integración de Friendbuy.][101]{: style="max-width:55%;"}

Vuelve a tu [cuenta Friendbuy][1] y actualiza la página. Si la integración se ha realizado correctamente, aparecerá un mensaje similar al siguiente:

![integración instalada][102]{: style="max-width:55%;"}
