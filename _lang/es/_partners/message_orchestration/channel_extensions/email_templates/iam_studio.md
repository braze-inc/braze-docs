...
![La galería de plantillas de IAM Studio muestra diferentes plantillas como "modal de diapositivas en carrusel", "modal de iconos simples", "modal de imagen completa", y más.][1]
...
{% tabs local %}
{% tab Fuentes %}
![La interfaz de usuario de IAM Studio muestra las opciones para añadir Liquid. 
{% endtab %}
{% tab Líquido %}
