...
| ----------- | ----------- |
| Cuenta Dyspatch | Para beneficiarse de esta asociación, es necesario disponer de una [cuenta Dyspatch][3] con un [rol de propietario o administrador][4]. |
...
En el campo **Localizar exportaciones por**, puede elegir cómo desea gestionar la localización. Este campo le permite [localizar sus plantillas de correo electrónico][6] y exportarlas a Braze para enviar fácilmente correos personalizados por idioma o configuración regional. 
