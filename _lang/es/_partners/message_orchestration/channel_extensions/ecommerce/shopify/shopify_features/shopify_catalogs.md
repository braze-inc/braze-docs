...
![Paso 3 del proceso de configuración con "Shopify Variant ID" como "Identificador de producto del catálogo".][1]{: style="max-width:70%;"}
...
Para configurar las notificaciones de bajada de precios, sigue los pasos que se [indican aquí]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/catalogs/price_drop_notifications).
