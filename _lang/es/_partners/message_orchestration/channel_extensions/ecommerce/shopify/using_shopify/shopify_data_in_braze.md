...
**Evento**: Compra<br>
**Tipo**: [Evento de compra de Braze]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/purchase_events/)
...
Puedes filtrar los eventos de Shopify con todos los [filtros personalizados existentes]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_events/) en Segmentación. 
...
Además, también puedes utilizar el filtro de amplitud de compra de Braze para crear segmentos de usuarios basados en:
...
![Filtro de segmentación para usuarios que compraron por primera vez después del 17 de octubre de 2020.][13]

![Buscar un ID de producto específico como filtro de segmentación.][14]
...
Con la compatibilidad de objetos anidados para propiedades de eventos personalizados, ahora los clientes pueden desencadenar campañas y Canvas utilizando una propiedad de evento anidada. A continuación se muestra un ejemplo de desencadenar una campaña utilizando un producto específico del evento personalizado `shopify_created_order`. Asegúrate de utilizar `list_items[].product_id` para indexar tu lista de artículos y acceder al ID del producto.
