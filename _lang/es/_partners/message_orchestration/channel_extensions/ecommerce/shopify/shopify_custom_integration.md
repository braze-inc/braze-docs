...
1. **Inicializa y carga el SDK Web de Braze para habilitar el seguimiento in situ**<br><br> Añade manualmente código en tu sitio web de Shopify para habilitar el seguimiento in situ de Braze. Al implementar el SDK de Braze en tu tienda headless de Shopify, puedes hacer un seguimiento de las actividades in situ, incluidas las sesiones, el comportamiento del usuario anónimo, las acciones del comprador previas al pago y cualquier [evento personalizado]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_events/) o [atributo personalizado]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_attributes/) que decidas incluir con tu equipo de desarrolladores. También puedes añadir cualquier canal admitido por los SDK, como mensajes dentro de la aplicación o tarjetas de contenido. 

{: start="2"}
2\. **Conecta tu tienda a la integración nativa Braze**<br><br> Cuando conectes tu tienda Shopify a Braze, tendrás acceso a los datos de clientes, pagos, pedidos y productos a través de los webhooks de Shopify.
...
## Paso 6: Instala la integración Braze Shopify

### Paso 6.1: Conecta tu tienda Shopify
...
![Página de configuración de la integración de Shopify en el panel de Braze.][2]

### Paso 6.2: Habilitación de los SDK de Braze 
...
![Paso de configuración para habilitar los SDK de Braze.][3]

### Paso 6.3: Rastrear datos de Shopify 
...
![Paso de configuración para el seguimiento de los datos de Shopify.][4]

### Paso 6.4: Relleno histórico (opcional)
...
![Sección para configurar el relleno de datos históricos.][5]
...
### Paso 6.5: Configuración personalizada de seguimiento de datos (avanzada) 
...
### Paso 6.6: Configura cómo administras a los usuarios (opcional)

Primero, selecciona tu `external_id` en el desplegable. 

![Sección "Recoger suscriptores".][6]
...
![Sección "Recoger suscriptores" con opción de recoger las adhesiones voluntarias por correo electrónico o marketing por SMS.][9]
...
### Paso 6.7: Sincronizar productos (opcional)
...
![Paso de configuración para sincronizar los datos del producto con Braze.][7]

### Paso 6.8: Activar canales
...
### Paso 6.9: Configuración de acabado
...
![Banner que dice que actives la incrustación de la aplicación Braze en Shopify para que puedas terminar de configurar tu integración.][8]
