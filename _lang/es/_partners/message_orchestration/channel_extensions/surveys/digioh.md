...
!["Crea centros de preferencias de correo electrónico y comunicaciones flexibles con Digioh"][5]{: style="border:0"}
...
!["Selecciona la integración correcta en el desplegable"][2]{: style="max-width:50%;"}
...
!["Añadir la integración a un lightbox"][3]{: style="max-width:90%"}
