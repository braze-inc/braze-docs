...
![Una selección de plantillas de webhook prediseñadas disponibles en la pestaña Plantillas de webhook de la sección Plantillas y medios.][7]
...
![Código del cuerpo de la solicitud y URL del webhook mostrados en la pestaña de composición del creador de webhooks Braze.][5]
...
El texto sin formato se resaltará automáticamente si se trata de una etiqueta Braze aplicable. `street` `unit` , `state` y `zip` deben configurarse como [atributos personalizados][3] para enviar este Webhook.
