...
> [MyPostcard][1], una aplicación de postales líder en el mundo, te permite realizar campañas de correo directo con facilidad, proporcionándote una forma sencilla y rentable de conectar con tus clientes. 
...
Para integrarte con MyPostcard, [inicia sesión o regístrate][2] y crea tu primera campaña para utilizarla a través de [los webhooks Braze][3].
...
![La pestaña Componer muestra el cuerpo JSON y la información del webhook.][4]
...
![Prueba la pestaña Webhook con diferentes campos para validar la implementación.][5]
