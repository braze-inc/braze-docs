...
![Un ejemplo de webhook de Zendesk.][1]{: style="max-width:70%;"}
...
![Un SMS de ejemplo sin formatear.][2]{: style="max-width:40%;"}
...
![Un SMS de ejemplo con formato.][3]{: style="max-width:70%;"}
...
![API Entrega desencadenada][4]{: style="max-width:70%;"}

Por último, en **Controles de entrega**, activa la reelegibilidad.

![Rehabilitación habilitada en "Controles de entrega".][5]
...
![Responde por SMS Braze.][6]{: style="max-width:70%;"}
...
![Responde a través del cuerpo JSON de Braze SMS.][7]{: style="max-width:70%;"}
...
![Actualizar un usuario cuando se cierra un ticket.][8]{: style="max-width:70%;"}
...
![Resuelta la configuración de tickets en Zendesk.][9]{: style="max-width:70%;"}
...
![Cuerpo JSON de ticket resuelto.][10]{: style="max-width:70%;"}
...
![Un ejemplo de categoría de palabras clave SMS en Braze.][11]{: style="max-width:70%;"}
...
![Un ejemplo de solicitud con los dos encabezados requeridos.][12]{: style="max-width:70%;"}
...
![La página "Programar entrega" de la primera campaña webhook.][13]

En **Controles de entrega**, activa la reelegibilidad.

![Reelegibilidad seleccionada en "Controles de entrega" para la primera campaña webhook.][14]
