...
La integración de Braze y Nexla permite a los clientes que utilizan [Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/setting_up_currents/) aprovechar Nexla para extraer, transformar, y cargar datos de «data lakes» a otras ubicaciones en un formato personalizado, haciendo que los datos sean fácilmente accesibles en todo su ecosistema.

## Requisitos previos

| Requisito | Descripción |
|---|---|
| Cuenta Nexla | Se necesita una [cuenta Nexla][2] para beneficiarse de esta asociación. |
