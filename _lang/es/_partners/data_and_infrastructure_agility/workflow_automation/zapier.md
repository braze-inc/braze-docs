...
> [Zapier][1] es una herramienta web de automatización que permite compartir datos entre aplicaciones web y luego utilizar esa información para automatizar acciones. 

La asociación entre Braze y Zapier aprovecha la API de Braze y [los webhooks][3] de Braze para conectarse con aplicaciones de terceros, como Google Workplace, Slack, Salesforce, WordPress, etc. para automatizar diversas acciones.
...
| Punto final REST Braze | La URL de su punto final REST. Tu punto final dependerá de la [URL Braze de tu instancia][0]. |
