...
{% alert note %}
Los límites de velocidad varían en función del flujo. Visite la [tabla de límites de tarifas](https://www.braze.com/docs/api/api_limits/#rate-limits-by-request-type) para obtener más información.
{% endalert %}
