...
> [Hightouch][1] es una moderna plataforma de integración de datos que le permite sincronizar datos de clientes, productos o propietarios desde su almacén o lago de datos a cualquier aplicación de su elección, todo ello sin ayuda de sus equipos de TI o ingeniería.
...
Esta integración también le permite [importar cohortes de usuarios a Braze]({{site.baseurl}}/partners/data_and_infrastructure_agility/cohort_import/hightouch/), enviando campañas específicas basadas en datos que sólo pueden existir en su almacén.
...
| Punto final REST Braze  | La URL de su punto final REST. Tu punto final dependerá de la [URL Braze de tu instancia][2].<br><br>Hightouch necesita el nombre del clúster en el que se encuentra su instancia de Braze. Por ejemplo, si tu punto final Braze es `https://rest.iad-01.braze.com`, sólo necesitas `iad-01`.|
...
3. Proporciona tu punto final REST Braze (excluyendo "https://rest.") y tu clave de API REST Braze.<br><br>![][3]
