...
La API de personalización de Hightouch proporciona un punto final REST para utilizar en la configuración de Braze. En concreto, puede utilizar la oferta de contenido conectado de Braze para realizar una solicitud GET a la API de personalización para recuperar toda la información relacionada con un identificador concreto. Los datos expuestos por esta API pueden representar datos de clientes, productos o cualquier otro objeto. 
