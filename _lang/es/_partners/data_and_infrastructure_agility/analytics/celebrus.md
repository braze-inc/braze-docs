...
Esta integración utiliza Braze Cloud Data Ingestion. Siga las instrucciones en [Integraciones de almacenes de datos]({{site.baseurl}}/user_guide/data_and_analytics/cloud_ingestion/integrations/) para establecer y configurar [los ajustes de Cloud Data Ingestion]({{site.baseurl}}/user_guide/data_and_analytics/cloud_ingestion/overview/) según el tipo de almacén que esté utilizando. 
...
Celebrus utilizará los identificadores definidos para enviar los atributos del cliente definidos en el generador de perfiles de Celebrus, pero sólo cuando cambien los valores de los atributos. Tenga en cuenta que los nombres de los atributos serán los definidos en el generador de perfiles de Celebrus, por lo que los atributos de Braze reflejarán los del perfil de Celebrus. Es posible que haya que adaptarlas a las convenciones de denominación de Braze. Por ejemplo, ajustándose a [las convenciones de denominación de atributos estándar]({{site.baseurl}}/api/objects_filters/user_attributes_object/) de Braze.  
