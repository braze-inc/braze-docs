...
- [Importación de cohortes]({{site.baseurl}}/partners/data_and_infrastructure_agility/cohort_import/amplitude/): Una integración que permite reenviar cohortes de Amplitude a Braze.
...
Las sincronizaciones de rasgos de usuario y cómputo crearán nuevos usuarios para ID de usuario que aún no existan en Braze. Los cómputos y los rasgos de usuario sólo pueden sincronizarse utilizando el ID de usuario.
...
Para comprobar algunos de los puntos finales comunes de la API de Amplitude que se pueden utilizar con el Contenido Conectado, consulta la [documentación sobre la API de Amplitude]({{site.baseurl}}/partners/data_and_infrastructure_agility/analytics/amplitude/amplitude_user_profile_api/).
