...
| Artefactos de gestión de datos de Redpoint | La integración de Braze se apoya en un conjunto de artefactos de gestión de datos de Redpoint. Póngase en contacto con [el servicio de asistencia de Redpoint][3] para solicitar los artefactos correspondientes a su versión de Redpoint Data Management. |
...
Arrastre los atributos de Redpoint CDP a la columna **Atributos**. Establezca cada **valor de fila de encabezado** en el atributo de usuario correspondiente de Braze [][17]. 
...
![Una plantilla de exportación de muestra con los atributos `external_id` y nombre de salida.][8]{: style="max-width:75%;"}
...
![La pestaña de opciones muestra el formato de fecha establecido en aaaa-MM-dd.][16]{: style="max-width:75%;"}
