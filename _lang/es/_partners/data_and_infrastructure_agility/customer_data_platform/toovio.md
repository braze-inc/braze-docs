...
La siguiente integración permite a Toovio generar desencadenantes dirigidos a clientes específicos y comunicarse casi en tiempo real. Los desencadenantes determinados por Toovio se transmitirán a Braze a través del [punto final `/users/track`][3] de Braze.
...
Crea una [campaña desencadenada por la API de][4] Braze basada en los eventos de clientes a los que Toovio se dirigirá. Además, deben definirse los atributos del usuario objetivo y los valores que desencadenarán la campaña.
