...
La integración de Braze y mParticle te permite controlar fácilmente el flujo de información entre ambos sistemas. Con [Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/), también puedes conectar los datos a mParticle para que sean procesables en todo el stack de crecimiento. 
...
Braze admite la exportación a mParticle de los siguientes datos enumerados en los glosarios de [comportamiento de usuario]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/customer_behavior_events/) e [interacción con mensajes de]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/message_engagement_events/) Currents:
