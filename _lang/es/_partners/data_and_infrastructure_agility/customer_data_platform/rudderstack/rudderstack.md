...
> [RudderStack][1] es una infraestructura de datos de clientes de código abierto para recopilar y enrutar datos de eventos de clientes a su almacén de datos preferido y a docenas de otros proveedores de análisis, como Braze. Está preparado para la empresa y ofrece un sólido marco de transformación para procesar tus datos de eventos sobre la marcha.
...
| Fuente configurada | Un [origen][3] es esencialmente el origen de cualquier dato enviado a Rudderstack, como sitios web, aplicaciones móviles o servidores backend. Es necesario configurar la fuente antes de configurar Braze como destino en RudderStack. |
...
| Centro de datos | Tu centro de datos se alinea con tu panel de Braze [instancia][15].  |
...
Para empezar a enviar datos a Braze, primero debe asegurarse de que se ha configurado una fuente en su aplicación RudderStack. Visite [RudderStack][22] para aprender a configurar su fuente de datos.
...
Configure las asignaciones al SDK de RudderStack para su plataforma en el repositorio GitHub de Braze, como se describe en [los métodos compatibles](#supported-methods):
...
**Pedido realizado**<br>
Al utilizar la [API de comercio electrónico de RudderStack][20] para llamar al método de seguimiento de un evento con el nombre `Order Completed`, RudderStack envía los productos enumerados en ese evento a Braze como [`purchases`][21].
