...
{% alert important %}
Tealium AudienceStreams y EventStreams ofrecen acciones de conector por lotes y no por lotes.  Ponte en contacto con [el soporte de]({{site.baseurl}}/braze_support/) Braze o con tu administrador del éxito del cliente si tienes alguna pregunta.
{% endalert %}
...
| [Punto final REST de Braze][6] | La URL de tu punto final REST. Tu punto final dependerá de la [URL Braze de tu instancia]({{site.baseurl}}/api/basics/#endpoints). |
...
Visita [Tealium][1] para consultar la lista completa de tipos de datos disponibles.
