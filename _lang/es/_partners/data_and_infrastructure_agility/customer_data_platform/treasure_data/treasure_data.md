...
> [Treasure Data][4] es una plataforma de datos de clientes (CDP) que recopila y encamina información de múltiples fuentes a una variedad de otras ubicaciones en su pila de marketing.
...
| Punto final REST Braze  | La URL de su punto final REST. Tu punto final dependerá de la [URL de Braze para tu instancia][1]. |
...
![La página "Exportar resultados". En esta página hay campos para "modo", "tipo de seguimiento" y "campos preformateados". Para este ejemplo, "Seguimiento de usuario" y "Eventos personalizados" se establecen en estos campos, respectivamente.][3]{: style="max-width:80%;"}
...
Los usuarios de Treasure Data pueden ingerir datos a través de la API REST pública. Puedes utilizar Treasure Data para crear webhooks personalizados en tus datos. Para más información, visita [Treasure Data][6]
