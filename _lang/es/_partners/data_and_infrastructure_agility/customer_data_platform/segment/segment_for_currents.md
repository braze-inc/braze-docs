...
![La página de Corrientes de Segmento en Braze. Aquí puedes encontrar campos para el nombre de la integración, el correo electrónico de contacto, la región del segmento y la clave de API.][1]
