...
![Pantalla de integración en Simon Data][8]{: style="max-width:70%"}

### Añadir acciones Braze a Flows o Journeys en Simon

Después de autenticar tu cuenta Braze en Simon, puedes añadir acciones Braze a [Flows][4] y [Journeys][5].
...
![Desplegable que muestra la lista de acciones Braze disponibles en Simon Data.][9]{: style="max-width:60%"}
...
![Seleccionar rasgos de sincronización en Simon Data.][10]
