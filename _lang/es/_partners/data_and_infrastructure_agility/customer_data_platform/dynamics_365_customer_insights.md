...
| Clave REST API de Braze | Se necesita una clave de API REST de Braze con los permisos `users.track` y `users.export.segment`. <br><br> Puede crearse en el panel Braze desde **Configuración** > **Claves API**. |
