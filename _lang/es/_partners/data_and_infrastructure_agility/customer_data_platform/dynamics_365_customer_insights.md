...
| Clave REST API de Braze |  <br><br> Puede crearse en el panel Braze desde **Configuración** > **Claves API**. |
|  |  |
...
2.  Si no ves el nombre de esta sección, no hay conexiones de este tipo disponibles para ti.
3. 
4. En la sección **Coincidencia de datos**, en el campo **Correo electrónico**, seleccione el campo que representa la dirección de correo electrónico de un cliente.  
  a. 
  b. 
5.  
...
### Mediante esta integración
  ...
  Por ejemplo, `"Segment_API_Identifier": "0000-0000-0000"`

  Una vez creado el segmento, puede seleccionarlo como filtro de audiencia al crear una campaña o Canvas.
