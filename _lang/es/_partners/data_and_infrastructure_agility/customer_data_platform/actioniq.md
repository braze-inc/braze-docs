...
| Clave REST API de Braze | Una clave de API REST de Braze con los permisos necesarios para la integración correspondiente. Para más detalles, consulta la sección de Requisitos correspondientes. <br><br>Esta clave puede crearse en el panel de Braze desde **Configuración** > **Claves de API**. |
