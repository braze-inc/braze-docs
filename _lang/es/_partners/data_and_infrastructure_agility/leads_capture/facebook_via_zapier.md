...
| Punto final REST Braze | Asegúrate de que conoces la [URL de tu punto final REST][1]. Tu punto final de API coincide con la URL del panel de tu instancia de Braze. <br><br> Por ejemplo, si la URL de tu panel es `https://dashboard-03.braze.com`, tu punto final será `dashboard-03`. |
