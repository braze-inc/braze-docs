...
![En el creador de segmentos Braze, el filtro de atributos de usuario "cohorte de Tinyclues" se establece en "incluye" y "cohorte principal".][4]{: style="max-width:90%;"}
...
![En el constructor de campañas Braze, en el paso de segmentación, el filtro "Usuarios objetivo por segmento" está establecido en "cohorte de Tinyclues".][5]{: style="max-width:90%;"}
...
![La parte inferior de la página de detalles de la campaña muestra el nombre de tu cohorte.][2]{: style="max-width:30%;"}
