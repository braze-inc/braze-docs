...
> [Sisu Data][2] es el líder en inteligencia de decisiones en la nube que utiliza el aprendizaje automático para descomponer automáticamente el rendimiento de las métricas y ofrecer información rápida, completa y práctica.
...
Los usuarios pueden extraer los resultados de Sisu utilizando [la API de Sisu][10] y materializar los segmentos en un almacén de datos. Los clientes de Snowflake pueden activar estos segmentos en Braze a través de [Cloud Data Ingestion][5].
