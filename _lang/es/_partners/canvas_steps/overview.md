...
| Destino |  | Límite de velocidad |  | Consejos |
| --- | --- | --- | --- | --- |
| [Criteo]({{site.baseurl}}/partners/canvas_steps/criteo_audience_sync) |  |   | Sí | {::nomarkdown}<ul><li></li><li></li></ul>{:/} |
|  |  |  | Sí | {::nomarkdown}<ul><li></li><li></li></ul>{:/} |
|  |  |  | No | {::nomarkdown}<ul><li> </li><li></li><li></li></ul>{:/} |
| [LinkedIn]({{site.baseurl}}/partners/canvas_steps/linkedin_audience_sync) |  |   |  | {::nomarkdown}<ul><li></li><li></li></ul>{:/} |
| [Pinterest]({{site.baseurl}}/partners/canvas_steps/pinterest_audience_sync/) |  |   | Sí |  |
| [Snapchat]({{site.baseurl}}/partners/canvas_steps/snapchat_audience_sync/) | N/A |   | Sí |  |
| [TikTok]({{site.baseurl}}/partners/canvas_steps/tiktok_audience_sync/) |  |   | Sí | {::nomarkdown}<ul><li></li><li></li></ul>{:/} |
