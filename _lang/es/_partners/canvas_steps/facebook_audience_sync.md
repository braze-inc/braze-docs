...
El límite de velocidad de la API de marketing de Facebook establece no más de ~190.000 solicitudes de API para cada cuenta publicitaria en un periodo de tiempo de una hora. Si un cliente Braze alcanza este límite de velocidad, Braze Canvas reintentará la sincronización durante un máximo de ~13 horas. Si la sincronización no es posible, estos usuarios aparecen en la métrica Usuarios erróneos.
...
![Un ejemplo de las condiciones que hay que aceptar para las audiencias personalizadas de la lista de clientes.][24]{: style="max-width:85%;"}
![Un ejemplo de las condiciones que debes aceptar para las herramientas de empresa de Facebook.][25]{: style="max-width:85%;"}
...
![Una lista de componentes para añadir al Canvas.][18]{: style="max-width:35%;"} ![El componente Sincronización de la audiencia.][20]{: style="max-width:28%;"}
...
!["Configurar Sincronización de Audiencias" con opciones para elegir un socio.][19]{: style="max-width:80%;"}
...
![Configuración de la sincronización de la audiencia para la audiencia de "carrito abandonado" con la información de correo electrónico, teléfono, nombre y apellidos para que coincida.]({% image_buster /assets/img/audience_sync/fb_sync.png %})
...
![Un mensaje de éxito de que se ha creado la audiencia "abandoned_cart".]({% image_buster /assets/img/audience_sync/fb_sync2.png %})
...
Una vez normalizados los datos del correo electrónico, Braze realiza un hash con SHA256.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Ve a <b>Integraciones de socios</b> > <b>Facebook</b> y desconecta y vuelve a conectar tu cuenta. Consulta esta <a href='/docs/partners/canvas_steps/facebook_audience_sync/#audit-your-facebook-account'>sección</a> de solución de problemas esta sección de solución de problemas para conocer los pasos adicionales para auditar tu cuenta de Facebook.</td>
    </tr>
    <tr>
      <td><b>Tamaño de la audiencia demasiado bajo</b></td>
      <td>Este error puede producirse si has creado un paso de Sincronización de audiencias que elimina usuarios de tus audiencias. Si el tamaño de tu audiencia se acerca a cero, la red puede marcar que el tamaño de la audiencia es demasiado bajo para servir.</td>
      <td> Utiliza una estrategia de Sincronización de Audiencias que añada y elimine usuarios con regularidad sin agotar por completo el tamaño de la audiencia.</td>
    </tr>
    <tr>
...
- TOS de audiencia personalizada basada en el valor:
  - Si tu cuenta publicitaria está vinculada a la cuenta de Business Manager de tu empresa, debes aceptar las condiciones de servicio en tu cuenta de Business Manager aquí: `https://business.facebook.com/customaudiences/value_based/tos.php?act=<ACCOUNT_ID>&business_id=<BUSINESS_ID>`.
  - Si tu cuenta publicitaria está vinculada a tu cuenta personal (no asociada a ninguna empresa), debes aceptar las CDS aquí: `https://business.facebook.com/customaudiences/value_based/tos.php?act=<ACCOUNT_ID>`
...
4. Lee y selecciona **Aceptar** para las Condiciones de la audiencia personalizada. Te recomendamos que confirmes para qué cuenta se están firmando las condiciones de los servicios utilizando el desplegable de la parte superior de las condiciones.
...
{:start="5"}
5\. Debes seleccionar **Aceptar** para las condiciones de los servicios. Después, verás este mensaje: "Has aceptado estas condiciones de servicio en nombre de Braze".
