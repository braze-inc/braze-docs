...
![Página de tecnología de Snapchat en Braze que incluye una sección de resumen y otra de sincronización de la audiencia de Snapchat con el botón Snapchat Conectado.][1]{: style="max-width:80%;"}
...
![Una lista de las cuentas publicitarias disponibles que puedes conectar a Snapchat.][2]{: style="max-width:80%;"}
...
![Una versión actualizada de la página de socios tecnológicos de Snapchat que muestra las cuentas de anuncios conectadas correctamente.][3]{: style="max-width:80%;"}
...
Añade un componente en tu Canvas y selecciona **Sincronizar audiencia**.
...
![Detalles de la audiencia de una determinada audiencia de Snapchat que incluye el nombre de la audiencia, el tipo de audiencia, el tamaño de la audiencia y la renovación de la audiencia en días.][9]
...
Puedes desconectar y volver a conectar tu cuenta de Snapchat en la página del socio de Snapchat. Asegúrate con tu administrador de Snapchat Business Manager de que tienes los permisos adecuados para la cuenta publicitaria con la que deseas sincronizar.
{% enddetails %}

{% details ¿Por qué no se puede iniciar mi Canvas? %}
Asegúrate de que tu cuenta de anuncios de Snapchat se conecta correctamente a Braze en la página del socio de Snapchat. Asegúrate de haber seleccionado una cuenta de publicidad, introducido un nombre para la nueva audiencia y seleccionado los campos que coincidan
{% enddetails %}

{% details ¿Cómo sé si los usuarios se han emparejado después de pasar usuarios a Snapchat? %}
Snapchat no proporciona esta información para sus políticas de privacidad de datos.
{% enddetails %}

{% details ¿Cuántas audiencias puede soportar Snapchat? %}
...
Tendrás que entrar en tu cuenta de anuncios de Snapchat y eliminar las audiencias que ya no utilices.
{% enddetails %}
