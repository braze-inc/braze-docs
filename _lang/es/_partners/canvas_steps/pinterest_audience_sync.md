...
![Página de tecnología de Pinterest en Braze que incluye una sección de resumen y una sección de sincronización de audiencia de Pinterest con el botón de Pinterest conectado.][1]{: style="max-width:80%;"}
...
Una vez que hayas seleccionado confirmar, se te redirigirá de nuevo a Braze para que selecciones las cuentas de anuncios de Pinterest que deseas sincronizar. 
...
![Detalles de la audiencia de una determinada audiencia de Pinterest que incluye el nombre de la audiencia, el ID de la audiencia, el tipo de audiencia y el tamaño de la audiencia.][11]
...
Sólo tienes que desconectar y volver a conectar tu cuenta de Pinterest en la página del socio de Pinterest. Asegúrate con tu administrador de Pinterest Business Hub de que tienes los permisos adecuados para la cuenta de anuncios que deseas sincronizar.
{% enddetails %}

{% details ¿Por qué no se puede iniciar mi Canvas? %}
Asegúrate de que tu cuenta de Pinterest se conecta correctamente a Braze en la página del socio de Pinterest.
...
{% details ¿Cómo sé si los usuarios han coincidido después de pasar usuarios a Pinterest? %}
Pinterest no proporciona esta información para sus propias políticas de privacidad de datos.
{% enddetails %}

{% details ¿Cuánto tardarán mis audiencias en poblar Pinterest? %}
