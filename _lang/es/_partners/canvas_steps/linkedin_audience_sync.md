...
![La página de tecnología de LinkedIn en Braze incluye una sección de resumen y otra de sincronización de audiencia de LinkedIn con el botón LinkedIn conectado.][3]{: style="max-width:75%;"}
...
![Se selecciona "Braze Self Service" como cuenta publicitaria a conectar.][7]{: style="max-width:75%;"}
...
![Una cuenta de LinkedIn conectada correctamente.][6]{: style="max-width:75%;"}
...
![Una audiencia de entrada con el filtro "El seguimiento de anuncios habilitado es verdadero".][5]{: style="max-width:75%;"}
...
![Un Canvas con una audiencia de entrada de "opted_in_marketing" es igual a "true".][4]{: style="max-width:75%;"}
...
![El editor de Canvas con la lista de componentes disponibles.][2]{: style="max-width:35%;"} ![El componente de Sincronización de Audiencias seleccionado.][1]{: style="max-width:29%;"}

### Paso 4: Configuración de la sincronización

Selecciona **LinkedIn** como socio de Sincronización de audiencia deseado.

![Los detalles de "Configurar sincronización de audiencia" con los múltiples socios a elegir.][9]{: style="max-width:70%;"}
...
![Sincronización de la audiencia con LinkedIn con Braze seleccionada como cuenta publicitaria.][11]
...
![Página de LinkedIn que muestra las siguientes métricas para la audiencia dada.][8]
...
{% details ¿Cuánto tardarán en poblarse los tamaños de audiencia en LinkedIn? %}
Hay un retraso de hasta 48 horas para ver las audiencias dentro de tu cuenta de LinkedIn.
{% enddetails %}

{% details ¿Cuál es el tamaño mínimo de audiencia para que LinkedIn lo incluya en tu cuenta de publicidad?  %}
...
Confirma que tu cuenta publicitaria de LinkedIn se ha conectado correctamente a Braze en la página del socio de LinkedIn.
Asegúrate de haber seleccionado una cuenta de publicidad, introducido un nombre para la nueva audiencia y seleccionado los campos que coincidan.
{% enddetails %}

{% details ¿Cómo sé si los usuarios se han emparejado después de pasar los usuarios a LinkedIn? %}
- ¿Cómo sé si los usuarios se han emparejado después de pasar los usuarios a LinkedIn?
LinkedIn proporciona información sobre las tasas de coincidencia en su panel. Puedes consultarlo en LinkedIn, en la sección **Audiencias**. 
- Además, puedes revisar la tasa de coincidencia de tu audiencia de LinkedIn en la página de detalles del paso en Canvas de tu paso de sincronización de audiencia.
{% enddetails %} 

{% details ¿A cuántas audiencias puede dar soporte LinkedIn? %}
Actualmente, no hay límite en el número de audiencias en tu cuenta de anuncios de LinkedIn.
{% enddetails %}

{% details ¿Por qué un segmento está atascado en estado CONSTRUIDO y no se actualiza? %}
