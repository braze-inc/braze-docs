...
![La página de la tecnología TikTok en Braze incluye una sección de resumen y otra de sincronización de la audiencia de TikTok con el botón TikTok conectado.][1]{: style="max-width:75%;"}
...
A continuación, selecciona la cuenta de anuncios de TikTok deseada. En el menú desplegable **Elegir un público nuevo o existente**, escriba el nombre de un público nuevo o existente.
...
![Página de TikTok que muestra las siguientes métricas para la audiencia dada.][5]
...
Asegúrate de que tu cuenta de TikTok se conecta correctamente a Braze en la página de socios de TikTok.
Asegúrese de haber seleccionado una cuenta de anuncios, introducido un nombre para el nuevo público y seleccionado los campos que deben coincidir.
{% enddetails %}

{% details ¿Cómo sé si los usuarios han coincidido después de pasar usuarios a TikTok? %}
TikTok no proporciona esta información para sus políticas de privacidad de datos.
{% enddetails %}

{% details ¿Cuánto tardarán mis audiencias en aparecer en TikTok? %}
...
{% details ¿Cuál es el número máximo de audiencias que puedo tener en mi cuenta de TikTok ads? %}
400
{% enddetails %}
