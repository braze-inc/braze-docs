...
Los [bloques de contenido]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/content_blocks/) que se utilizan exclusivamente en el editor de arrastrar&y soltar tienen una funcionalidad similar a los bloques de contenido que se utilizan en diferentes canales. Son una ubicación centralizada para guardar información a la que se puede hacer referencia en diversas campañas de correo electrónico. Esto puede incluir agrupar cabeceras de correo electrónico, llamadas promocionales y más, todo en una fila reutilizable.
