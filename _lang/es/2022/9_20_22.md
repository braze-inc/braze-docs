...
## Líquido 5
Para los usuarios empresariales existentes, Liquid 5 ya está disponible. Más información sobre las [novedades de Liquid 5]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/liquid#whats-new-with-liquid-5).
...
- [SDK de Android 23.1.0-23.12](https://github.com/braze-inc/braze-android-sdk/blob/master/CHANGELOG.md)
...
- [SDK de SWIFT 5.3.0-5.4.0](https://github.com/braze-inc/braze-swift-sdk/blob/main/CHANGELOG.md#540)
