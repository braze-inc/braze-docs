...
Con el nuevo [editor de arrastrar&y soltar para mensajes dentro de la aplicación]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop), puedes crear mensajes completamente personalizados sin necesidad de saber HTML. El editor de arrastrar&y soltar se implementará para todos los clientes en los próximos meses. Si deseas solicitar el acceso antes, ponte en contacto con tu administrador del éxito del cliente.
