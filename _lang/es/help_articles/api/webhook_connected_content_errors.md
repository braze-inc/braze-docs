...
2. Selecciona **Errores de contenido conectado** y **Errores de webhook** en la sección **Campañas de Canvas & **.
...
{% alert note %}
Las solicitudes de contenido conectado no se incluyen en estos eventos de fallo del webhook.
{% endalert %}
