...
Echa un vistazo a este nuevo filtro en nuestra biblioteca de filtros de]({{site.baseurl }}/user_guide/engagement_tools/segments/segmentation_filters/) segmentación.
