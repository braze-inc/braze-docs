...
## Eventos de &Currents  campos

Además de algunas correcciones en la sección, se ha añadido un]({{ site.baseurl}}/user_guide/data_and_analytics/braze_currents/message_engagement_events/#subscription-events) nuevo [Evento de suscripción a la página Eventos de interacción con mensajes. 
...
{% alert important %}
Para aprovechar estas actualizaciones, tendrás que editar la configuración de tu conector Currents y habilitar los eventos que quieras utilizar. Si tienes alguna pregunta, ponte en contacto con tu director de cuentas.
{% endalert %}
