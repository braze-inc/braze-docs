...
Braze se basa en una arquitectura de datos de transmisión que aprovecha Snowflake, Kafka, MongoDB y Redis. Los datos de muchos orígenes de datos se pueden cargar en Braze a través de SDK y API. La plataforma puede manejar cualquier dato en tiempo real, independientemente de cómo esté anidado o estructurado. Los datos en Braze se almacenan en el perfil de usuario. 
...
### Desglose de los orígenes de datos
...
#### Características basadas en MongoDB
- Eventos personalizados (rastreados por SDK y API)
...
- [Paquete de predicción]({{site.baseurl}}/user_guide/brazeai/predictive_suite/)
- [Rutas personalizadas]({{site.baseurl}}/user_guide/engagement_tools/canvas/canvas_components/experiment_step/personalized_paths/) y [variantes personalizadas]({{site.baseurl}}/user_guide/engagement_tools/testing/multivariant_testing/optimizations/#personalized-variant)
- [Recomendaciones de artículos personalizadas mediante IA]({{site.baseurl}}/user_guide/brazeai/recommendations/creating_recommendations/ai/)
...
### Orígenes de datos backend a través de la API de Braze
...
### Orígenes de datos frontend a través del SDK de Braze
...
### Conexión directa con el almacén a través de la ingesta de datos de Braze Cloud.
