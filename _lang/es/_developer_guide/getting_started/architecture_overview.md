...
Braze se basa en una arquitectura de datos de transmisión que aprovecha Snowflake, Kafka, MongoDB y Redis. Los datos de muchas fuentes pueden cargarse en Braze a través del SDK y la API. La plataforma puede manejar cualquier dato en tiempo real, independientemente de cómo esté anidado o estructurado. Los datos en Braze se almacenan en el perfil de usuario. 
...
![Braze importa fuentes de datos backend desde la API, fuentes de datos frontend desde el SDK, datos de almacén de datos desde la ingesta de datos en la nube de Braze y desde las integraciones de los socios. Estos datos se exportan a través de la API Braze ]({% image_buster /assets/img/getting-started/import-export.png %}){: style="display:block;margin:auto;" }
...
### Desglose del origen de datos

Braze utiliza diferentes sistemas de almacenamiento de datos para varias características. Comprender qué características utilizan qué orígenes de datos es importante para la gestión de datos y la solución de problemas.

#### Características de MongoDB
- Eventos personalizados (seguidos por SDK y API)
- Atributos personalizados
- Perfiles de usuario
- Eventos de compra
- La mayoría de las características de segmentación y selección de objetivos

#### Características impulsadas por Snowflake
- [Extensiones de segmentos SQL]({{site.baseurl}}/user_guide/engagement_tools/segments/sql_segments/)
- [Suite de predicción]({{site.baseurl}}/user_guide/brazeai/predictive_suite/)
- [Caminos personalizados]({{site.baseurl}}/user_guide/engagement_tools/canvas/canvas_components/experiment_step/personalized_paths/) y [variante personalizada]({{site.baseurl}}/user_guide/engagement_tools/testing/multivariant_testing/optimizations/#personalized-variant)
- [Recomendaciones de artículos personalizadas con IA]({{site.baseurl}}/user_guide/brazeai/recommendations/creating_recommendations/ai/)
...
{% alert important %}
**Consideraciones sobre la eliminación de datos:** Los eventos personalizados se almacenan en MongoDB y son independientes de los datos de Snowflake. Si necesitas eliminar datos de eventos personalizados erróneos, debes tratarlos en MongoDB. Las características impulsadas por Snowflake (como las extensiones de segmento SQL y otras características impulsadas por Snowflake) utilizan datos de Snowflake, que se manejan por separado. Eliminar datos de un sistema no los elimina automáticamente del otro.
{% endalert %}
...
### Fuentes de datos frontend a través de Braze SDK
...
### Conexión directa al almacén mediante la ingesta de datos en la nube Braze
