---
nav_title: Acerca de los Conmutadores de características
article_title: Acerca de los Conmutadores de características
page_order: 1
...
# Acerca de las banderas de características
...
¿Buscas pasos sobre cómo crear una feature flag en Braze? Consulta [Crear banderas de características]({{site.baseurl}}/developer_guide/platform_wide/feature_flags/create/).
...
## Utilizar indicadores de características

Utiliza las banderas de características para:

- [Introducir despliegues graduales](#gradual-rollouts)
- [Controla a distancia las variables de la aplicación](#remotely-control-app-variables)
- [Sincronizar el despliegue de características y la mensajería](#message-coordination)
- [Experimentar con nuevas características](#feature-experimentation)
- [Segmenta a los usuarios por feature flags](#segmentation)
...
Para desplegar gradualmente esta característica, podemos [crear]({{site.baseurl}}/developer_guide/platform_wide/feature_flags/create/) una bandera de característica llamada "Widget de chat en vivo".
...
La siguiente tabla describe las limitaciones que se aplican a nivel de bandera de característica. Para adquirir la versión de pago de las banderas de características, ponte en contacto con tu administrador de cuentas Braze o solicita una actualización en el panel Braze.

| Área de limitación                                                                                                   | Versión gratuita     | Versión de pago      |
| :---------------------------------------------------------------------------------------------------------------- | :--------------- | ----------------- |
...
### Banderas de características activas
