---
nav_title: Personalizar estilos de tarjetas
article_title: Personalizar los estilos de las tarjetas de contenido
page_order: 1
...
# Personalizar los estilos de las tarjetas de contenido

> Las tarjetas de contenido Braze tienen un aspecto predeterminado. Este artículo trata de las opciones de estilo de tus tarjetas de contenido para ayudarte a que coincidan con la identidad de tu marca. Para obtener un resumen básico de los tipos de opciones de personalización que tienes con las tarjetas de contenido, consulta [Resumen de la personalización]({{site.baseurl}}/developer_guide/customization_guides/customization_overview). 
...
Aquí tienes algunas recetas para casos de uso comunes de personalización.
