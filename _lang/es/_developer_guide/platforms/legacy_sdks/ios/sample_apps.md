...
Hay varias aplicaciones de prueba disponibles en el [repositorio GitHub del SDK de iOS](https://github.com/appboy/appboy-ios-sdk). Sigue estas instrucciones para crear y ejecutar nuestras aplicaciones de prueba.
...
Las notificaciones push para la aplicación de prueba iOS requieren una configuración adicional. Consulta nuestra [integración iOS Push]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/integration/) para más detalles.
