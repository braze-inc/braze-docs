...
<br>
{% alert important %}
¿Buscas la guía básica de integración del desarrollador de la tarjeta de contenido? Encuéntralo [here]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/content_cards/integration/).
{% endalert %}
