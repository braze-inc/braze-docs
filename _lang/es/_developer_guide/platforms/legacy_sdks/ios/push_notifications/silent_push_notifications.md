...
Habilitar el modo en segundo plano para las notificaciones remotas es necesario para el [seguimiento de la desinstalación]({{site.baseurl}}/developer_guide/analytics/tracking_uninstalls/?sdktab=swift).
