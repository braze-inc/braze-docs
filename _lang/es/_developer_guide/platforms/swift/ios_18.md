...
![Una captura de pantalla de ejemplo de un resumen de vista previa de una notificación push.]({% image_buster /assets/img/apple/apple_intelligence/notification_preview_summary.png %})
