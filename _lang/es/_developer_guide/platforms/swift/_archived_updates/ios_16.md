...
2. ¡Nuestro SDK Swift de Braze admite una nueva [ característica push primer "sin código]({{site.baseurl}}/user_guide/message_building_by_channel/push/best_practices/push_primer_messages/)"!
