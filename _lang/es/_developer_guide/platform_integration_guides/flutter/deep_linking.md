...
article_title: Vinculación en profundidad para Flutter
platform: Flutter
page_order: 6
description: "En este artículo se explica cómo implementar la vinculación en profundidad para tus aplicaciones Flutter en Android e iOS."

---

# Vínculos profundos

> Aprende a implementar vínculos profundos en tu aplicación para iOS o Android utilizando Flutter. Si quieres ver una aplicación de ejemplo, consulta [GitHub: Ejemplo de SDK de Flutter de Braze](https://github.com/braze-inc/braze-flutter-sdk/tree/master/example). Para obtener información general sobre la vinculación en profundidad, consulta nuestras [Preguntas frecuentes sobre la vinculación en profundidad]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/deep_linking_to_in-app_content/#what-is-deep-linking).

## Requisitos previos

Antes de que puedas implementar la vinculación en profundidad en tu aplicación Flutter, tendrás que configurar la vinculación en profundidad en la capa nativa [de Android]({{site.baseurl}}/developer_guide/platform_integration_guides/android/advanced_use_cases/deep_linking/) o [iOS]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/advanced_use_cases/linking/).
