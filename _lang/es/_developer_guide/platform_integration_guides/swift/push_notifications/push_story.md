...
article_title: Integración de historias push para iOS
platform: Swift
page_order: 27
description: "Este artículo muestra cómo configurar Historias push de iOS para el SDK Swift."
channel:
  - push
...
> [Las historias push]({{site.baseurl}}/user_guide/message_building_by_channel/push/advanced_push_options/push_stories/) permiten a los especialistas en marketing utilizar la función de carrusel de fotos para crear una secuencia de páginas dentro de una notificación push. Estas páginas constan de una imagen, una acción de clic, un título y una descripción. 

Configurar Historias push para tu aplicación iOS requiere pasos adicionales más allá de la integración de las notificaciones push estándar, que se describen en este artículo.
...
Asegúrate de haber seguido el [tutorial de integración de notificaciones push]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/push_notifications/integration/) para habilitar push en tu aplicación. Como parte de esta tarea, deberías haber implementado el framework `UNNotification`, que es necesario para esta característica.
...
Después de seguir [la guía de integración de Swift Package Manager]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/initial_sdk_setup/installation_methods/swift_package_manager/), añade `BrazePushStory` a tu `Notification Content Extension`:
