...
**Datos de uso**: pueden incluir los datos de sesión de Braze, así como cualquier evento o recopilación de atributos que utilices para medir la interacción con el producto.
