---
nav_title: Guía de actualización a Android 13
...
# Guía de actualización a Android 13
...
Para prepararte para Android 13, actualiza tu SDK de Braze a la [última versión (v21.0.0+)](https://github.com/braze-inc/braze-android-sdk/blob/master/CHANGELOG.md#2300). Si lo haces, tendrás acceso a nuestra nueva [ característica push primer "sin código"]({{site.baseurl}}/user_guide/message_building_by_channel/push/push_primer_messages/).
...
Para empezar a utilizar nuestra nueva [ característica push primer "sin código"]({{site.baseurl}}/user_guide/message_building_by_channel/push/push_primer_messages/), actualiza tu SDK de Android a la [última versión (v23.0.0+)](https://github.com/braze-inc/braze-android-sdk/blob/master/CHANGELOG.md#2300).
