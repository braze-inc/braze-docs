...
article_title: Configuración de ID de usuario para Android y FireOS
platform: 
  - Android
  - FireOS
page_order: 1
description: "Este artículo de referencia muestra cómo configurar ID de usuario en tu aplicación Android o FireOS, las convenciones sugeridas para nombrar ID de usuario y algunas buenas prácticas."
