---
nav_title: Cuestionario de privacidad de Google Play
article_title: Respuestas a las preguntas sobre privacidad de Google Play Store
page_order: 9
platform: 
  - Android
  - FireOS
description: "Este artículo de referencia explica cómo responder a las preguntas sobre la privacidad de Google Play."
...
Para obtener más información sobre otros datos de dispositivo que Braze recopila y que pueden quedar fuera del ámbito de las directrices de seguridad de datos de Google Play, consulta nuestro [resumen de almacenamiento de Android]({{site.baseurl}}/developer_guide/platform_integration_guides/android/storage) y nuestras [opciones de recopilación de datos del SDK]({{site.baseurl}}/user_guide/data_and_analytics/user_data_collection/sdk_data_collection/#minimum-integration).
