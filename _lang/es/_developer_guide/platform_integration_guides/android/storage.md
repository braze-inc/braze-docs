...
article_title: Almacenamiento para Android y FireOS
platform: 
  - Android
  - FireOS
page_order: 9
page_type: reference
description: "En este artículo de referencia se describen las propiedades a nivel de dispositivo capturadas por el SDK para Android de Braze."
...
Visita nuestro artículo [Recopilación de datos de SDK]({{site.baseurl}}/user_guide/data_and_analytics/user_data_collection/sdk_data_collection/) para obtener más información sobre las propiedades del dispositivo recopiladas automáticamente.
