...
platform: iOS
page_order: 4
description: "Este artículo trata del registro de eventos personalizados mediante balizas Gimbal para iOS."
...
Una vez que tengas tus balizas Gimbal configuradas e integradas en tu aplicación, podrás registrar eventos personalizados, como el inicio o fin de una visita o el avistamiento de una baliza. También puedes registrar propiedades de estos eventos, como el nombre del lugar o el tiempo de permanencia.
