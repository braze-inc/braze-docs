...
article_title: Tarjetas de contenido para Unity
platform: 
  - Unity
  - iOS
  - Android
...
page_order: 4
description: "En este artículo de referencia se cubren las directrices de implementación de la tarjeta de contenido para la plataforma Unity, como la visualización y el análisis de tarjetas y la analítica."

---

# Integración de la tarjeta de contenido

> En este artículo de referencia se cubren las directrices de implementación de la tarjeta de contenido para la plataforma Unity, como la visualización y el análisis de tarjetas y la analítica.
...
El análisis sintáctico de las tarjetas de contenido requiere un análisis sintáctico Json, consulta el siguiente ejemplo para obtener más detalles:
