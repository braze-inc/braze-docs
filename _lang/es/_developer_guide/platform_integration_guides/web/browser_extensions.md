...
{% alert tip %}
Antes de empezar, asegúrate de haber leído la [guía de configuración inicial del SDK]({{site.baseurl}}/developer_guide/platform_integration_guides/web/initial_sdk_setup/) Web para saber más sobre nuestra integración de JavaScript en general.  <br><br>También puedes marcar la [referencia del SDK de](https://js.appboycdn.com/web-sdk/latest/doc/modules/braze.html) JavaScript para obtener información detallada sobre los distintos métodos y opciones de configuración del SDK.
{% endalert %}

Para integrar el SDK Web de Braze, primero tendrás que descargar una copia de la biblioteca JavaScript más reciente. Esto puede hacerse utilizando NPM o descargándolo directamente [del CDN de Braze](https://js.appboycdn.com/web-sdk/latest/braze.min.js).
