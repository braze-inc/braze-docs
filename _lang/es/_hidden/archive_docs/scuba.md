...
![Seleccionar la propiedad actor como atributo personalizado.]({% image_buster /assets/img/scuba/analytics/select_property.png %})
...
![Elegir un funcionamiento y un valor para la selección de ]({% image_buster /assets/img/scuba/analytics/operator_end.png %})
