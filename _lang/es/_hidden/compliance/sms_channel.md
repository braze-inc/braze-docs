---
nav_title: Documentación de conformidad de los servicios de mensajería móvil
article_title: Documentación de conformidad para servicios de mensajería móvil
...
Por **"Agregadores",** **"Operadores"** o **"Intermediarios de mensajes móviles"** se entenderá terceros intermediarios (i) que transmiten mensajes móviles entre proveedores de mensajes móviles y operadores; (ii) que son proveedores de servicios inalámbricos (e.g., T-Mobile, AT&T, etc.); y/o (iii) que participan en las transmisiones de mensajes RCS desde proveedores de mensajes móviles a usuarios finales.
