...
- Para los usuarios finales que tengan un ID externo dentro de los Servicios Braze, puedes utilizar ese ID para eliminar los datos de ese usuario final.
- Para los usuarios finales anónimos que no tengan un identificador externo dentro de los servicios Braze, puedes recuperar el identificador del dispositivo de ese usuario final utilizando el SDK de Braze y puedes utilizar el identificador del dispositivo para encontrar el perfil de usuario final asociado a ese dispositivo. A continuación, puedes utilizar la API de eliminación de usuarios para eliminar el perfil asociado a ese usuario final.
