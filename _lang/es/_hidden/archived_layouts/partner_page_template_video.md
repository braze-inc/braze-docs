...
|---|---|---|---|
|Clave de API REST del espacio de trabajo Braze | Plataforma Braze | **Configuración** > Página de **configuración de la aplicación**  | Esta descripción debería indicarte qué hacer con la clave de API REST del espacio de trabajo. |
