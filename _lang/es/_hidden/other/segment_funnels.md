...
![Ejemplo de embudo de segmentos con los siguientes filtros: "Último uso de estas aplicaciones hace menos de 30 días", "Último artículo añadido a la lista de espera hace menos de 30 días" y "Última compra hace menos de 30 días" para llegar a 4.302 usuarios.]({% image_buster /assets/img_archive/Wish_List_2.png %})
...
Este caso de uso aprovecha el filtro "Push en primer plano habilitado para la aplicación" para dirigirse a los usuarios de iOS o Android que han optado por el push.
...
Este caso de uso aprovecha el filtro "Push en primer plano habilitado" para dirigirse a los usuarios que han optado por el push.

![]({% image_buster /assets/img/seg_filter_examples/both.png %})

### Grupo de control global de audiencia habilitada para push

Este caso de uso aprovecha el filtro "Push en primer plano habilitado" y "N.º de contenedor aleatorio" para dirigirse a los usuarios que forman parte del grupo de control global que han optado por el push.
