...
<div>
    <div class="container-fluid" id="main-container">
      <div class="row main-form">
        ...
        <div class="steps">
            <div class="step active">Detalles básicos</div>
...
<div class='gpt-text'>Generando... </div>
<div class='gpt-text1'>Respuesta generada para ti </div>
                 </div>
...
<div class="form-container1"  style="display:none;">
 <div id="step3" >
<div id="firefox_warning" style="display:none;">Para los usuarios de Firefox, autoriza este sitio o comprueba tu <a href="https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Privacy/Tracking_Protection?utm_source=mozilla&utm_medium=firefox-console-errors&utm_campaign=default" target="_blank">configuración de protección contra el seguimiento</a>, o puede que no se envíe tu ticket.</div>

<div id="ticket_mainform" class="container">
    <form  id="ticket_form">
      <div id="step3">
        <h2>¿No encuentras lo que necesitas? Ponte en contacto con nuestro equipo de soporte.</h2>
        <!-- Row 1 -->
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="ticket_topic" class="required">¿En qué podemos ayudarte? </label>
              <select id="ticket_topic" name="00N0V000009G0MG" class="form-control"></select>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="ticket_category" class="required">Categoría </label>
