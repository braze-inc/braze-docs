...
Registra tu `BroadcastReceiver` personalizado para escuchar las intenciones push Braze abiertas y recibidas en tu [`AndroidManifest.xml`][71]:
...
- Debería subclasificar [`BroadcastReceiver`][53] y anular `onReceive()`.
