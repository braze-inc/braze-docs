...
En este ejemplo, configuraremos el canal webhook Braze para enviar SMS y MMS a tus usuarios, a través de la [API de envío de mensajes][20] de Twilio. Para tu comodidad, en el panel se incluye una plantilla de webhook de Twilio.
...
![Cuerpo del webhook][29]

## Encabezados de solicitud y método

Twilio requiere dos encabezados de solicitud, el Content-Type de la solicitud y un encabezado [Autenticación básica HTTP][32]. Añádelos a tu webhook haciendo clic en el icono de engranaje situado junto al compositor del webhook y, a continuación, haciendo clic dos veces en *Añadir nuevo par*.
