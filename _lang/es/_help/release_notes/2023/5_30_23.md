...
Hemos actualizado la navegación de Braze para ayudarte a crear y acceder a tus contenidos de forma más rápida y eficaz. Ahora las características están organizadas en categorías intuitivas familiares y relevantes para el flujo de trabajo de un especialista en marketing en Braze. Durante los próximos meses, podrás alternar entre la experiencia de navegación antigua y la nueva. Para más información sobre lo que ha cambiado, consulta la [navegación Braze]({{site.baseurl}}/navigation).

## Eventos de New Currents

Los siguientes eventos de WhatsApp Currents se han publicado recientemente y se han añadido a los glosarios de [eventos de interacción de mensajes]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/message_engagement_events):
...
### Regal - Mensajería
Al integrar [Regal]({{site.baseurl}}/partners/message_orchestration/additional_channels/messaging/regal/) y Braze, puedes crear una experiencia más coherente y personalizada en todos tus puntos de intervención con el cliente.
...
### Sendbird - Mensajería
La integración de Braze y [Sendbird]({{site.baseurl}}/partners/message_orchestration/additional_channels/messaging/sendbird) permite a los usuarios de Braze:
