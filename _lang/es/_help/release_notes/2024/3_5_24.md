...
Puedes utilizar [el archivado de mensajes]({{site.baseurl}}/user_guide/data_and_analytics/export_braze_data/message_archiving/) para guardar una copia de los mensajes enviados a los usuarios con fines de archivado o cumplimiento en tu contenedor de AWS S3, Azure Blob Storage o Google Cloud Storage.
