...
Ahora puedes utilizar [los informes de interacción][72] para agregar métricas de una campaña en periodos de tiempo específicos. Por ejemplo, puedes exportar el número total de aperturas de un trimestre, o el número total de clics de toda la vida de una campaña o Canvas. Esto es todo lo que tienes que hacer:
...
Se ha actualizado [la página de perfil de usuario][73].
...
Hemos añadido un nuevo [punto final de la API][71], /raw_data/status, que te permite consultar si un día determinado se ha cargado en la Exportación de Eventos sin Procesar. Puedes utilizarla para comprobar si los datos brutos de un día concreto están disponibles, para ayudar a la depuración y automatización.
