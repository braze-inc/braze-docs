...
Ahora puedes especificar un evento de conversión para "correo electrónico abierto de campaña" o "correo electrónico clicado de campaña". Más información sobre [los tipos de entrega de las campañas][16].

## Exportación CSV con grupo de control
Al exportar un CSV de una campaña de usuarios, ahora puedes incluir grupos de control en los datos. Más información sobre la [exportación de datos del panel][17].

## Correos electrónicos de bienvenida y de doble adhesión voluntaria
Ahora puedes utilizar un desencadenante basado en la acción "Dirección de correo electrónico añadida" de nueva creación, que facilita el envío de correos electrónicos de doble adhesión o de bienvenida cuando un usuario añade por primera vez su dirección de correo electrónico. Más información sobre [las mejores prácticas de correo electrónico][18].
