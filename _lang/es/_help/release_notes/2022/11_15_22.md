...
En este nuevo artículo se cubren los matices de la integración de los [mensajes dentro de la aplicación y las tarjetas de contenido en tvOS]({{site.baseurl}}/developer_guide/platform_integration_guides/tvos/in-app_messaging), que están disponibles a través del SDK Swift de Braze.
