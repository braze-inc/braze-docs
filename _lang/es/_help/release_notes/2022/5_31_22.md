...
La integración de Braze y [Shopify]({{site.baseurl}}/partners/message_orchestration/channel_extensions/ecommerce/shopify/shopify/) se ha ampliado para ofrecer el retraso del pago abandonado, la configuración de un identificador de producto preferido y varios eventos nuevos de Shopify, como `shopify_paid_order`, `shopify_partially_fulfilled_order`, `shopify_fulfilled_order`, `shopify_cancelled_order` y `shopify_created_refund`. 
