...
| `Something went wrong. Translation IDs are mismatched or translated text exceeds limits.`| Se trata de un error generalizado. Ponte en contacto con [el soporte de Braze]({{site.baseurl}}/user_guide/administrative/access_braze/support) para obtener más ayuda. |
