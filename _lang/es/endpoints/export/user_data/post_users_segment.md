...
Si ves `object_prefix` en la respuesta de tu API y ninguna URL para descargar los datos, significa que ya tienes un contenedor de S3 de Amazon configurado para este punto final. Cualquier dato exportado utilizando este endpoint irá directamente a tu contenedor de S3.
