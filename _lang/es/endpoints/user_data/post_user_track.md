---
nav_title: "PUBLICAR: Rastrear usuarios"
article_title: "PUBLICAR: Seguimiento de usuarios"
search_tag: Endpoint
page_order: 4
layout: api_page
page_type: reference
...
Los límites actuales basados en la ingesta esperada se pueden encontrar en el panel en **Configuración** > **APIs e identificadores** > **Panel de uso de API**. Podemos modificar los límites de velocidad para proteger la estabilidad del sistema o permitir un mayor caudal de datos en tu cuenta. Ponte en contacto con el soporte de Braze o con tu administrador del éxito del cliente si tienes preguntas o dudas sobre el límite de solicitudes por hora o por segundo y las necesidades de tu empresa.

### Cabeceras de límite de velocidad para usuarios activos al mes CY 24-25

Todas las respuestas sin límite de tasa (como las que no son`429`) contendrán las siguientes cabeceras de respuesta HTTP que indican al cliente el estado de la ventana de límite de velocidad por hora. Te recomendamos que utilices estos encabezados para gestionar tu tasa de solicitud:
