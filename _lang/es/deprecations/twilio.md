...
Twilio requiere dos encabezados de solicitud: el encabezado de tipo de contenido y el encabezado [HTTP Basic Authentication](https://en.wikipedia.org/wiki/Basic_access_authentication#Client_side). Añádelos a tu webhook haciendo clic en el icono de engranaje situado junto al compositor del webhook y, a continuación, haciendo clic dos veces en *Añadir nuevo par*.
