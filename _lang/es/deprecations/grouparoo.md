...
nav_title: Grouparoo
page_order: 1
description: "Este artículo describe la colaboración entre Braze y Grouparoo, una herramienta ETL inversa de código abierto que se utiliza para potenciar las herramientas de marketing, ventas y asistencia técnica con datos procedentes de tu almacén de datos."
page_type: update
...
> [Grouparoo](https://www.grouparoo.com/) es una herramienta ETL inversa de código abierto que sincroniza los datos de tu almacén de datos con las herramientas de marketing, ventas y asistencia técnica. Su interfaz de usuario centrada en modelos habilita a los miembros del equipo sin conocimientos técnicos para que configuren y programen sincronizaciones de datos.

La integración de Braze y Grouparoo sincroniza los datos del almacén con Braze. Las programaciones de sincronización automática mantienen las comunicaciones con los clientes actualizadas con información reciente.
...
- **Sincronización**: Añade, actualiza y elimina usuarios de la empresa según sea necesario. Esta opción busca nuevos registros, cambios en registros existentes y eliminaciones.
- **Adición**: Añade y actualiza los usuarios de la empresa según sea necesario, pero no elimines a nadie. Esta opción busca nuevos usuarios para añadir a Braze y cambios en los usuarios existentes de la empresa, pero no realiza un seguimiento de las eliminaciones.
...
![Ejemplo de campos de asignación de propiedades. El ID de usuario de Grouparoo está mapeado aexternal_id.correo electrónico, firstName y lastName están configurados como equivalentes a «correo electrónico» y"first_name", los campos"last_name" de Grouparoo.]({% image_buster /assets/img/grouparoo/mapping.png %}){: style="max-width:80%;"}
...
![En "Grupos de suscripción Braze" de la ventana de configuración de destino de Grouparoo, el grupo Grouparoo "Alto valor con compra reciente de automóvil" se añadirá al grupo de suscripción Braze "Alto valor con compra reciente de automóvil".]({% image_buster /assets/img/grouparoo/lists.png %}){: style="max-width:80%;"}
