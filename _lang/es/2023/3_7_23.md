...
En el editor de arrastrar&y soltar para mensajes dentro de la aplicación, ahora puedes restablecer rápidamente los estilos a su estilo predeterminado después de realizar cambios. Para más información, consulta [Restablecer los estilos predeterminados]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop/create/#resetting-styles-to-default).
...
La integración de [Sisu Data]({{site.baseurl}}/partners/data_and_analytics/business_intelligence/sisu_data/) y Braze te permite comprender en todas las campañas o a nivel de campaña por qué están cambiando las métricas (por ejemplo, la tarifa abierta, la tasa de clics, la tasa de conversión, etc.) y qué impulsa los resultados más óptimos. Una vez identificados estos segmentos, los usuarios de la empresa pueden materializar los resultados en su almacén de datos o enviarlos directamente desde Sisu a Braze para reorientar la interacción con los usuarios y volver a captar su interés.
