...
Los usuarios de la empresa ahora pueden descargar archivos CSV de los usuarios que han sido importados recientemente. Esto te da más visibilidad en la sincronización de datos de tus sistemas. Más información sobre [la importación de CSV]({{site.baseurl}}/user_guide/data/user_data_collection/user_import/).
