...
nav_title: Grouparoo
page_order: 1
description: "Este artículo describe la asociación entre Braze y Grouparoo, una herramienta ETL inversa de código abierto utilizada para potenciar las herramientas de marketing, ventas y asistencia con datos de tu almacén de datos."
page_type: update
...
> [Grouparoo](https://www.grouparoo.com/) es una herramienta ETL inversa de código abierto que sincroniza los datos de tu almacén con las herramientas de marketing, ventas y soporte. Su interfaz de usuario centrada en el modelo habilita a los miembros no técnicos del equipo a configurar y programar sincronizaciones de datos.
...
![Ejemplo de campos de asignación de propiedades. El ID de usuario de Grouparoo está mapeado con el correo electrónico external_id., el nombre y los apellidos están configurados como campos equivalentes de "correo electrónico", "first_name", y "last_name" de grouparoo.]({% image_buster /assets/img/grouparoo/mapping.png %}){: style="max-width:80%;"}
