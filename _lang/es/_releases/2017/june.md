...
Hemos actualizado la API externa para que admita el campo collapse_id para Apple push, dándote la posibilidad de enviar mensajes a tus clientes con precisión. Más información sobre [la API de mensajería Braze]({{site.baseurl}}/api/endpoints/messaging/).
