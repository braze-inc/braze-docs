...
El Asistente AI Liquid es un asistente de chat impulsado por BrazeAI<sup>TM</sup> que te ayuda a generar el Liquid que necesitas para personalizar el contenido de los mensajes. Puedes generar Liquid a partir de plantillas, recibir sugerencias personalizadas de Liquid y optimizar el Liquid existente con la ayuda de BrazeAI<sup>TM</sup>. El Asistente AI Liquid también proporciona anotaciones que explican el Liquid utilizado, para que puedas aumentar tu comprensión de Liquid y aprender a escribir el tuyo propio.
