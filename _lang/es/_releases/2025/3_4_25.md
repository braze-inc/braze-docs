...
description: "Este artículo contiene notas de la versión de marzo de 4, 2025."
page_order: 10
page_type: reference
---
...
Utiliza los pasos de Contexto para crear o actualizar un conjunto de variables que representen el contexto de un usuario (o información sobre el comportamiento de ese usuario) a medida que se desplaza por un Canvas.
