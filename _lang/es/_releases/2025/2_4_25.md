...
Para que te resulte más fácil encontrar lo que buscas, hemos separado los artículos que antes estaban anidados en "Datos & Análisis" en [Datos]({{site.baseurl}}/user_guide/data) y [Análisis]({{site.baseurl}}/user_guide/analytics). 
...
* [POST: Crear campos de catálogo
* [DELETE: Borrar campo de catálogo
* [DELETE: Borrar selección de catálogo
* [POST: Crear selección de catálogo
