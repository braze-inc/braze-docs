...
# Lanzamiento del 4 de febrero de 2025
...
#### SDK de Braze para Unreal Engine
Hemos migrado y reescrito todo el contenido del README del repositorio GitHub del SDK de Braze para Unreal Engine en su [sección dedicada en Braze Docs]({{site.baseurl}}/developer_guide/sdk_integration/?sdktab=unreal%20engine).

## Flexibilidad de los datos

### Dashboard de uso de la API

{% multi_lang_include release_type.md release="General availability" %}

El [dashboard de uso de la API]({{site.baseurl}}/user_guide/analytics/dashboard/api_usage_dashboard) te permite monitorizar el tráfico entrante de la API REST en Braze para comprender las tendencias de uso de nuestras API REST y solucionar posibles problemas.
...
* [DELETE: Eliminar campo de catálogo]({{site.baseurl}}/api/endpoints/catalogs/catalog_fields/asynchronous/delete_catalog_field)
* [DELETE: Eliminar selección de catálogo]({{site.baseurl}}/api/endpoints/catalogs/catalog_selections/asynchronous/delete_catalog_selection)
...
### Utilizar una dirección de correo electrónico para desencadenar campañas o Canvas

{% multi_lang_include release_type.md release="General availability" %}

Ahora puedes especificar un destinatario por dirección de correo electrónico para desencadenar tus [campañas]({{site.baseurl}}/user_guide/engagement_tools/messaging_fundamentals/targeting_users/) y [Canvas]({{site.baseurl}}/user_guide/engagement_tools/canvas/create_a_canvas/create_a_canvas/?tab=target%20audience#step-2c-set-your-target-entry-audience).
...
Hemos añadido [pasos sobre cómo obtener una traza SAML]({{site.baseurl}}/user_guide/administrative/access_braze/single_sign_on/set_up#obtaining-a-saml-trace), que te ayuda a resolver problemas sobre SAML SSO con Soporte de forma más eficiente.
 
### Centros de datos específicos para cada región
Como Braze está creciendo para dar servicio a nuevas áreas, hemos añadido un [artículo sobre los centros de datos de Braze]({{site.baseurl}}/user_guide/data/data_centers) para aclarar nuestro enfoque operativo.
...
Después de crear una selección, puedes [ver lo que devolvería una selección]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/catalogs/selections/#test-and-preview) para un usuario aleatorio o para un usuario concreto.

### Crear plantillas de elementos del catálogo que incluyan Liquid 

{% multi_lang_include release_type.md release="General availability" %}

Puedes [crear plantillas de elementos del catálogo que incluyan Liquid]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/catalogs/using_catalogs/#using-liquid).
...
Una forma en que los especialistas en marketing B2B pueden utilizar Braze es mediante una integración con Salesforce Sales Cloud. Lee más sobre cómo implementar este [caso de uso]({{site.baseurl}}/user_guide/getting_started/b2b_use_cases/b2b_salesforce_sales_cloud).
...
[Trustpilot]({{site.baseurl}}/partners/trustpilot/) es una plataforma de reseñas en línea que permite a tus clientes compartir sus opiniones y te permite administrar y responder a las reseñas.
