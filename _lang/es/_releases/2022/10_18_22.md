...
Los [bloques]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/content_blocks/) de contenido utilizados exclusivamente en el editor de arrastrar y soltar son similares en funcionalidad a los bloques de contenido utilizados en los distintos canales. Son una ubicación centralizada para guardar información a la que se puede hacer referencia en diversas campañas de correo electrónico. Esto puede incluir agrupar cabeceras de correo electrónico, llamadas promocionales y más, todo en una fila reutilizable.
