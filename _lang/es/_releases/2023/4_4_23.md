...
{% alert important %}
El editor SQL está en acceso anticipado. Si estás interesado en participar en el acceso anticipado, ponte en contacto con tu administrador del éxito del cliente.
{% endalert %}
...
## Eventos de New Currents: users_campaigns_abort y users_canvas_abort
...
[El relleno histórico de Shopify]({{site.baseurl}}/partners/ecommerce/shopify_legacy/shopify_features/shopify_backfill) permite a Braze importar todos los clientes, pedidos y eventos de compra de los últimos 90 días anteriores a tu conexión de integración con Shopify.
