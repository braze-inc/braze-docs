...
# Versión del 19 de septiembre de 2023
...
## Transformación de datos de Braze

[La transformación de datos de Braze]({{site.baseurl}}/user_guide/data/data_transformation/overview/) te permite construir y gestionar integraciones webhook para automatizar el flujo de datos desde plataformas externas a los perfiles de usuario de Braze. Estos datos de usuario recién integrados pueden alimentar casos de uso de marketing aún más sofisticados.

## Comentar en Canvas

[Los comentarios en Canvas]({{site.baseurl}}/user_guide/engagement_tools/canvas/create_a_canvas/canvas_comments/) pueden ser un gran espacio de colaboración para que tu equipo de marketing identifique, discuta y revise los detalles más sutiles de tus Canvas. Mientras construyes un Canvas, puedes hacer y gestionar comentarios para identificar aquellas áreas que pueden requerir comentarios adicionales de tus colegas.
...
La capacidad de entrega del correo electrónico es la clave del éxito de una campaña. Con el Centro de capacidad de entrega en el dashboard de Braze, puedes ver tus dominios por reputación de IP o errores de entrega para descubrir y solucionar posibles problemas de capacidad de entrega del correo electrónico.
...
Los desarrolladores pueden evitar que los mensajes dentro de la aplicación adopten el estilo de modo oscuro cuando el dispositivo del usuario tenga activado el modo oscuro. Para saber cómo implementarlo, consulta la siguiente documentación por plataforma:
...
## Nuevos campos para el archivado de mensajes
...
Para los mensajes dentro de la aplicación, puedes utilizar los siguientes atributos de la aplicación dentro de Liquid. Los valores se basan en qué clave de API de SDK utilizan tus aplicaciones para solicitar mensajería:
...
- [Android SDK 28.0.0](https://github.com/braze-inc/braze-android-sdk/blob/master/CHANGELOG.md#2800)
    - Se actualizó la versión mínima del SDK a 21 (Lollipop).
...
- [SDK de Roku 2.0.0](https://github.com/braze-inc/braze-roku-sdk/blob/main/CHANGELOG.md#200)
    - `getFeatureFlag` devolverá no válido cuando el conmutador de características no exista.
    - `BrazeTask` ahora observa `BrazeFeatureFlagsUpdated` para saber cuándo las actualizaciones de los conmutadores de características tienen éxito o fracasan. Los valores de los datos no siempre serán diferentes.