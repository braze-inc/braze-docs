...
Ahora puedes crear y actualizar [plantillas de correo electrónico a través de la API]({{site.baseurl}}/developer_guide/rest_api/email_templates/#email-templates). Cada plantilla tendrá un icono **email_template_id** al que se puede hacer referencia en otras llamadas a la API.
