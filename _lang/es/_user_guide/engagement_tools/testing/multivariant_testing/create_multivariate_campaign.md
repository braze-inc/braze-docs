...
![El menú desplegable al seleccionar el botón "Crear campaña" para elegir entre multicanal o canal único.][2]{: style="max-width:25%;float:right;margin-left:15px;" }
...
![Seleccionando "Añadir variante" para una campaña.][3]
