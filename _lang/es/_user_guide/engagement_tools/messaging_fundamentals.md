...
tool: 
    - Campaigns
    - Canvas
description: "En esta página de inicio encontrarás artículos sobre los fundamentos de la mensajería con campañas y Lienzos. Aquí encontrarás recursos para utilizar estratégicamente los eventos de conversión y determinar el tipo de entrega al redactar tus mensajes, así como para utilizar el flujo de trabajo de aprobación y comprender los estados al gestionar tus mensajes."

guide_featured_title: "Composición"
