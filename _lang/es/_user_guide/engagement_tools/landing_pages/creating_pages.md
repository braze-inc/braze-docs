...
{% alert important %}
Si configuras un botón con la opción **Enviar formulario al hacer clic** habilitada y utilizas **Comportamiento al hacer clic** para abrir una URL Web en una pestaña nueva, el bloqueador de ventanas emergentes integrado de Safari de iOS puede impedir que funcione la navegación. Esto ocurre porque el envío del formulario seguido de la apertura de una nueva pestaña se trata como una ventana emergente.<br><br>Para evitar este problema, configura los botones de envío de formularios para que abran la URL resultante en la misma pestaña (no en una pestaña nueva). Los botones sin envío de formulario pueden abrir URL en pestañas nuevas sin problemas.
{% endalert %}
