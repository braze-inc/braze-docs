...
- **Actualización completa:** Escribe un segmento SQL con datos Snowflake o cualquier [origen de datos conectado a CDI]({{site.baseurl}}/cdi_segment_extensions/) que recalcule toda la audiencia al actualizar manualmente. La mejor opción cuando necesitas una actualización total de la vista de tu audiencia.
...
![Extensión de segmento denominada "Extensión de compradores online - 90 días".]({% image_buster /assets/img/segment/segment_extension2.png %})
