...
`webhook_failure_source` | `null,`&nbsp;`string` | Indica si un error fue creado por Braze o por el punto de conexión. El campo de origen puede ser External Endpoint, Treat no status code to host unreachable
