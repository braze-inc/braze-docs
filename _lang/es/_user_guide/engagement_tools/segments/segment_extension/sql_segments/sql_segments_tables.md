...
Tabla | Descripción
------|------------
[CATALOGS_ITEMS_SHARED](#CATALOGS_ITEMS_SHARED) | Elementos del catálogo no eliminados
...
[USERS_BEHAVIORS_LIVEACTIVITY_PUSHTOSTARTTOKENCHANGE_SHARED](#USERS_BEHAVIORS_LIVEACTIVITY_PUSHTOSTARTTOKENCHANGE_SHARED) | Cuando cambia un token de notificaciones push de inicio automático de actividad en vivo
[USERS_BEHAVIORS_LIVEACTIVITY_UPDATETOKENCHANGE_SHARED](#USERS_BEHAVIORS_LIVEACTIVITY_UPDATETOKENCHANGE_SHARED) | Cuando cambia un token de actualización en vivo
...
[USERS_MESSAGES_BANNER_ABORT_SHARED](#USERS_MESSAGES_BANNER_ABORT_SHARED) | Un mensaje publicitario programado originalmente fue cancelado por alguna razón.
[USERS_MESSAGES_BANNER_CLICK_SHARED](#USERS_MESSAGES_BANNER_CLICK_SHARED) | Cuando un usuario hace un clic en un banner
...
[USERS_MESSAGES_EMAIL_DEFERRAL_SHARED](#USERS_MESSAGES_EMAIL_DEFERRAL_SHARED) | Cuando un correo electrónico se aplaza
...
[USERS_MESSAGES_LINE_ABORT_SHARED](#USERS_MESSAGES_LINE_ABORT_SHARED) | Cuando no se puede entregar un mensaje programado de LINE, antes de enviarlo a LINE
[USERS_MESSAGES_LINE_CLICK_SHARED](#USERS_MESSAGES_LINE_CLICK_SHARED) | Cuando un usuario hace un clic en un enlace en un mensaje de LINE
...
[USERS_MESSAGES_NEWSFEEDCARD_ABORT_SHARED](#USERS_MESSAGES_NEWSFEEDCARD_ABORT_SHARED) | Un mensaje de la tarjeta de canal de noticias programado originalmente se canceló por algún motivo.
...
[USERS_MESSAGES_RCS_ABORT_SHARED](#USERS_MESSAGES_RCS_ABORT_SHARED) | Cuando se interrumpe un envío RCS debido a un error detectado en Braze y el mensaje se descarta.
[USERS_MESSAGES_RCS_CLICK_SHARED](#USERS_MESSAGES_RCS_CLICK_SHARED) | Cuando el usuario final interactúa con un mensaje RCS tocando o haciendo clic en un elemento de la interfaz de usuario.
[USERS_MESSAGES_RCS_DELIVERY_SHARED](#USERS_MESSAGES_RCS_DELIVERY_SHARED) | Cuando un mensaje RCS se entrega correctamente al dispositivo móvil de un usuario final.
...
[USERS_MESSAGES_RCS_READ_SHARED](#USERS_MESSAGES_RCS_READ_SHARED) | Cuando el usuario final abre un mensaje RCS en tu dispositivo
...
[USERS_MESSAGES_RCS_SEND_SHARED](#USERS_MESSAGES_RCS_SEND_SHARED) | Cuando se envía un mensaje RCS desde los sistemas de Braze a los socios de entrega de última milla.
...
[USERS_MESSAGES_WEBHOOK_FAILURE_SHARED](#USERS_MESSAGES_WEBHOOK_FAILURE_SHARED) | Cuando se entrega un mensaje webhook, pero falla con una respuesta de error desde el punto final.
...
`item_id` | `string` | ID BSON del artículo del catálogo
...
`sf_created_at` | `timestamp`, `null` | cuando este evento fue recogido por Snowpipe
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
`time` | `int` | Marca de tiempo unix en la que ocurrió el evento.
`app_group_id` | `null,` `string` | ID BSON del grupo de aplicaciones al que pertenece este usuario.
`activity_attributes_type` | `null,` `string` | Tipo de atributo Actividad en vivo
`push_to_start_token` | `null,` `string` | Envío de token de inicio de actividad en vivo
`device_id` | `null,` `string` | ID del dispositivo en el que se ha producido el evento
`sdk_version` | `null,` `string` | Versión del SDK Braze en uso durante el evento
`ios_push_token_apns_gateway` | `null, int` | Puerta de enlace APNS del token de notificaciones push, solo se aplica a tokens de notificaciones push iOS, 1 para desarrollo, 2 para producción.
`push_token_state_change_type` | `null,` `string` | Descripción del tipo de cambio de estado del token de notificaciones push.
`app_group_api_id` | `null,` `string` | ID de API del grupo de aplicaciones al que pertenece este usuario.
`app_api_id` | `null,` `string` | ID de API de la aplicación en la que se ha producido este evento
`sf_created_at` | `timestamp`, `null` | cuando este evento fue recogido por Snowpipe
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
`platform` | `null,` `string` | Plataforma del dispositivo
`app_group_id` | `null,` `string` | ID BSON del grupo de aplicaciones al que pertenece este usuario.
`push_token` | `null,` `string` | Envía el token del evento.
`push_token_created_at` | `null, int` | Marca de tiempo UNIX en la que se creó el token de notificaciones push.
`push_token_updated_at` | `null, int` | Marca de tiempo unix en la que se actualizó por última vez el token de notificaciones push.
`push_token_foreground_push_disabled` | `null, boolean` | Indicador de push en primer plano desactivado del token de notificaciones push
`push_token_device_id` | `null,` `string` | Identificador del dispositivo del token de notificaciones push
`push_token_provisionally_opted_in` | `null, boolean` | Bandera de adhesión voluntaria al token de notificaciones push
`ios_push_token_apns_gateway` | `null, int` | Puerta de enlace APNS del token de notificaciones push, solo se aplica a tokens de notificaciones push iOS, 1 para desarrollo, 2 para producción.
`web_push_token_public_key` | `null,` `string` | Clave pública del token de notificaciones push, solo se aplica a los tokens de notificaciones push web.
`web_push_token_user_auth` | `null,` `string` | Autenticación de usuario del token de notificaciones push, solo se aplica a los tokens de notificaciones push web.
`web_push_token_vapid_public_key` | `null,` `string` | Clave pública VAPID del token de notificaciones push, solo se aplica a los tokens de notificaciones push web.
`push_token_state_change_type` | `null,` `string` | Descripción del tipo de cambio de estado del token de notificaciones push.
`app_group_api_id` | `null,` `string` | ID de API del grupo de aplicaciones al que pertenece este usuario.
`app_api_id` | `null,` `string` | ID de API de la aplicación en la que se ha producido este evento
`sf_created_at` | `timestamp`, `null` | cuando este evento fue recogido por Snowpipe
...
`external_user_id` | `null,` `string` | [PII] ID externo del usuario
`email_address` | `null,` `string` | Dirección de correo electrónico [PII] del usuario
`state_change_source` | `null,` `string` | fuente del cambio de estado (REST, SDK, Dashboard, etc.)
`subscription_status` | `string` | Estado de la suscripción: «Suscriptor», «Cancelación de suscripción» u «Adhesión voluntaria»
...
`app_group_id` | `null,` `string` | ID BSON del grupo de aplicaciones al que pertenece este usuario.
`channel_identifier` | `null,` `string` | [PII] El identificador del usuario en el canal al que pertenece el evento.
`sf_created_at` | `timestamp`, `null` | cuando este evento fue recogido por Snowpipe
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
| `is_canvas_entry`                      | `boolean`, `null`   | Si se trata de dar la entrada en un Canvas        |
| `exit_reason`                          | `string`, `null`    | Si se trata de una salida, la razón por la que el usuario salió del lienzo durante el paso en Canvas.                  |
| `canvas_entry_id`                      | `string`, `null`    | Identificador único para esta instancia de un usuario en Canvas.  |
| `next_step_id`                         | `string`, `null`    | BSON ID del siguiente paso en el lienzo de Canvas |
| `next_step_api_id`                     | `string`, `null`    | ID de API del siguiente paso en Canvas |
...
| `conversion_behavior_index` | `int`, `null`       | Tipo de conversión realizada por el usuario, siendo "0" una conversión primaria y "1" una conversión secundaria. |
| `sf_created_at`             | `timestamp`, `null` | Cuando este evento fue recogido por el Snowpipe                                                                   |
| `experiment_split_api_id` | `string`, `null` | ID de API del experimento en el que se inscribió el usuario. |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
`browser` | `null,` `string` | Navegador del dispositivo: extraído deuser_agent  , en el que se produjo la apertura.
`ad_id` | `null,` `string` | [PII] Identificador publicitario
...
`abort_log` | `null,` `string` | Mensaje de registro que describe los detalles de la interrupción (hasta 128 caracteres).
`banner_placement_id` | `null,` `string` | ID de ubicación del banner personalizado por el cliente
`sf_created_at` | `timestamp`, `null` | cuando este evento fue recogido por Snowpipe
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
`language` | `null,` `string` | [PII] Idioma del usuario
`abort_type` | `null,` `string` | Tipo de aborto, uno de ['liquid_abort_message', 'quiet_hours', 'rate_limit']
`abort_log` | `null,` `string` | Mensaje de registro que describe los detalles de la interrupción (máximo 2000 caracteres).
`app_group_id` | `null,` `string` | ID BSON del grupo de aplicaciones al que pertenece este usuario.
`sf_created_at` | `timestamp`, `null` | cuando este evento fue recogido por Snowpipe
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
`content_card_id` | `string` | ID de la tarjeta que generó este evento
`app_group_id` | `null,` `string` | ID BSON del grupo de aplicaciones al que pertenece este usuario.
`message_extras` | `null,` `string` | [PII] Una cadena JSON de los pares clave-valor etiquetados durante la representación líquida.
`sf_created_at` | `timestamp`, `null` | cuando este evento fue recogido por Snowpipe
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
`timezone` | `null,` `string` | Zona horaria del usuario
`language` | `null,` `string` | [PII] Idioma del usuario
`email_address` | `string` | Dirección de correo electrónico [PII] del usuario
...
`ip_pool` | `null,` `string` | Grupo de IP desde el que se realizó el envío del correo electrónico
`bounce_reason` | `null,` `string` | [PII] El código de motivo SMTP y el mensaje fácil de entender que se recibió para este evento de rebote.
...
`suspected_bot_click_reason` | `null, object` | Por qué este evento fue clasificado como un bot
`sf_created_at` | `timestamp`, `null` | cuando este evento fue recogido por Snowpipe
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
`campaign_api_id` | `null,` `string` | API ID de la campaña a la que pertenece este evento
`message_variation_api_id` | `null,` `string` | API ID de la variación de mensaje que recibió este usuario
`canvas_id` | `null,` `string` | BSON ID del Canvas al que pertenece este evento
`canvas_api_id` | `null,` `string` | API ID del Canvas al que pertenece este evento
`canvas_variation_api_id` | `null,` `string` | API ID de la variación de Canvas a la que pertenece este evento
`canvas_step_api_id` | `null,` `string` | API ID del paso Canvas al que pertenece este evento
`canvas_step_message_variation_api_id` | `null,` `string` | API ID de la variación del mensaje del paso Canvas que recibió este usuario
...
`from_domain` | `null,` `string` | Dominio de envío del correo electrónico
`ip_pool` | `null,` `string` | Grupo de direcciones IP desde el que se envió el correo electrónico.
`sending_ip` | `null,` `string` | Dirección IP desde la que se envió el correo electrónico
`timezone` | `null,` `string` | Zona horaria del usuario
`deferral_reason` | `null,` `string` | [PII] El código de motivo SMTP y el mensaje fácil de entender que se recibió para este evento de aplazamiento.
...
`email_address` | `string` | Dirección de correo electrónico [PII] del usuario
`ip_pool` | `null,` `string` | Grupo de IP desde el que se realizó el envío del correo electrónico
`message_extras` | `null,` `string` | [PII] Una cadena JSON de los pares clave-valor etiquetados durante la representación de Liquid.
`esp` | `null,` `string` | ESP relacionado con el evento (SparkPost, SendGrid o Amazon SES)
`from_domain` | `null,` `string` | Dominio de envío del correo electrónico
`sf_created_at` | `timestamp`, `null` | Cuando este evento fue recogido por el Snowpipe
`app_group_id` | `null,` `string` | ID BSON del grupo de aplicaciones al que pertenece este usuario.
...
`canvas_step_message_variation_api_id` | `null,` `string` | API ID de la variación del mensaje del paso Canvas que recibió este usuario
`canvas_variation_api_id` | `null,` `string` | API ID de la variación de Canvas a la que pertenece este evento
`feature_flag_id_name` | `null,` `string` | El identificador de implementación de la bandera de característica
`message_variation_api_id` | `null,` `string` | API ID de la variación de mensaje que recibió este usuario
`external_user_id` | `null,` `string` | [PII] ID externo del usuario
`device_id` | `null,` `string` | ID del dispositivo en el que se ha producido el evento
`time` | `int` | Marca de tiempo unix en la que ocurrió el evento.
...
`app_group_id` | `null,` `string` | ID BSON del grupo de aplicaciones al que pertenece este usuario.
`message_extras` | `null,` `string` | [PII] Una cadena JSON de los pares clave-valor etiquetados durante la representación líquida.
`locale_key` | `null,` `string` | [PII] La clave correspondiente a las traducciones (por ejemplo, «en-us») utilizadas para redactar este mensaje (nula predeterminada).
`sf_created_at` | `timestamp`, `null` | cuando este evento fue recogido por Snowpipe
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
`device_id` | `null,` `string` | ID del dispositivo en el que se ha producido el evento
`dispatch_id` | `null,` `string` | ID del envío al que pertenece este mensaje
`line_channel_id` | `null,` `string` | El ID del canal de LINE al que se envió o desde el que se recibió el mensaje.
`line_channel_name` | `null,` `string` | El nombre del canal de LINE al que se envió o desde el que se recibió el mensaje.
`message_variation_api_id` | `null,` `string` | API ID de la variación de mensaje que recibió este usuario
`native_line_id` | `null,` `string` | [PII] El ID de línea del usuario desde el que se envió o recibió el mensaje.
`send_id` | `null,` `string` | ID de envío del mensaje al que pertenece este mensaje
`subscription_group_api_id` | `string` | ID API del grupo de suscripción
`timezone` | `null,` `string` | Zona horaria del usuario
...
`line_channel_id` | `null,` `string` | El ID del canal de LINE al que se envió o desde el que se recibió el mensaje.
`line_channel_name` | `null,` `string` | El nombre del canal de LINE al que se envió o desde el que se recibió el mensaje.
`media_id` | `null,` `string` | El ID generado por LINE que se puede utilizar para recuperar los medios entrantes de LINE.
...
`push_to_start_token` | `null,` `string` | Envío de token de inicio de actividad en vivo
`update_token` | `null,` `string` | Token de actualización de actividad en vivo
`live_activity_event_type` | `null,` `string` | Tipo de evento de actividad en vivo. Uno de ['inicio', 'actualización', 'fin']
`live_activity_event_outcome` | `null,` `string` | Resultado del evento de actividad en vivo
`app_group_api_id` | `null,` `string` | ID de API del grupo de aplicaciones al que pertenece este usuario.
`app_api_id` | `null,` `string` | ID de API de la aplicación en la que se ha producido este evento
`sf_created_at` | `timestamp`, `null` | cuando este evento fue recogido por Snowpipe
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
`language` | `null,` `string` | [PII] Idioma del usuario
`platform` | `null,` `string` | Plataforma del dispositivo
`ad_id` | `null,` `string` | [PII] ID publicitario del dispositivo al que intentamos realizar una entrega.
...
`carrier` | `null,` `string` | Operador del dispositivo
`browser` | `null,` `string` | Navegador del dispositivo
`button_string` | `null,` `string` | Identificador(button_string)del botón de notificación push en el que se ha hecho clic. null si no procede de un clic en un botón.
`button_action_type` | `null,` `string` | Tipo de acción del botón de notificación push. Uno de [URI,DEEP_LINK,NONE, CLOSE]. null si no proviene de un clic en un botón.
...
`send_id` | `null,` `string` | ID de envío del mensaje al que pertenece este mensaje
`short_url` | `null,` `string` | URL acortada en la que se hizo clic
`suspected_bot_click_reason` | `null,` `string` | Por qué este evento fue clasificado como un bot
`user_agent` | `null,` `string` | Agente de usuario en el que se produjo el informe de spam
`user_phone_number` | `null,` `string` | [PII] El número de teléfono del usuario desde el que se recibió el mensaje.
`message_variation_api_id` | `null,` `string` | API ID de la variación de mensaje que recibió este usuario
`canvas_variation_api_id` | `null,` `string` | API ID de la variación de Canvas a la que pertenece este evento
`canvas_step_api_id` | `null,` `string` | API ID del paso Canvas al que pertenece este evento
`canvas_step_message_variation_api_id` | `null,` `string` | API ID de la variación del mensaje del paso Canvas que recibió este usuario
`interaction_type` | `null,` `string` | El tipo de interacción que generó el clic. Ejemplos de valores de cadena: URL del texto, Respuesta, OpenURL
`element_label` | `null,` `string` | Detalles opcionales sobre el elemento en el que se ha realizado un clic, como el texto de una respuesta sugerida o un botón.
`element_type` | `null,` `string` | Especifica si uninteraction_type  que es común en las sugerencias y los botones proviene de una sugerencia o de un botón. Ejemplos: Sugerencia, Botón
`campaign_api_id` | `null,` `string` | API ID de la campaña a la que pertenece este evento
`url` | `null,` `string` | URL en la que ha hecho clic el usuario
`subscription_group_api_id` | `string` | ID API del grupo de suscripción
`canvas_variation_name` | `null,` `string` | Nombre de la variación de Canvas que recibió este usuario
...
`send_id` | `null,` `string` | ID de envío del mensaje al que pertenece este mensaje
`subscription_group_api_id` | `string` | ID API del grupo de suscripción
`to_phone_number` | `null,` `string` | [PII] Número de teléfono del usuario que recibe el mensaje ene.164formato (por ejemplo, +14155552671).
`message_variation_api_id` | `null,` `string` | API ID de la variación de mensaje que recibió este usuario
`canvas_variation_api_id` | `null,` `string` | API ID de la variación de Canvas a la que pertenece este evento
`canvas_step_api_id` | `null,` `string` | API ID del paso Canvas al que pertenece este evento
`canvas_step_message_variation_api_id` | `null,` `string` | API ID de la variación del mensaje del paso Canvas que recibió este usuario
...
`time` | `int` | Marca de tiempo unix en la que ocurrió el evento.
`user_id` | `string` | ID de usuario de Braze del usuario que realizó este evento.
`action` | `null,` `string` | Medidas tomadas en respuesta a este mensaje. (por ejemplo, suscrito, cancelado la suscripción o ninguna).
`campaign_name` | `null,` `string` | Nombre de la campaña
`canvas_id` | `null,` `string` | BSON ID del Canvas al que pertenece este evento
`canvas_name` | `null,` `string` | Nombre del Canvas
`canvas_step_name` | `null,` `string` | Nombre del paso en Canvas
...
`from_rcs_sender` | `null,` `string` | El ID del remitente RCS o el nombre del agente utilizado para enviar el mensaje.
`is_sms_fallback` | `null, boolean` | Indica si se intentó la alternativa por SMS para este mensaje RCS rechazado. Está vinculado/emparejado al evento de entrega de SMS.
`message_variation_name` | `null,` `string` | Nombre de la variación del mensaje
...
`canvas_step_name` | `null,` `string` | Nombre del paso en Canvas
`canvas_variation_name` | `null,` `string` | Nombre de la variación de Canvas que recibió este usuario
`category` | `null,` `string` | Nombre de la categoría de palabras clave, que solo se rellena para los mensajes de respuesta automática: «adhesión voluntaria», «opt-out», «help» o valor personalizado.
`device_id` | `null,` `string` | ID del dispositivo en el que se ha producido el evento
`dispatch_id` | `null,` `string` | ID del envío al que pertenece este mensaje
`from_rcs_sender` | `null,` `string` | El ID del remitente RCS o el nombre del agente utilizado para enviar el mensaje.
`message_extras` | `null,` `string` | Una cadena JSON de los pares clave-valor etiquetados durante la representación líquida.
`message_variation_name` | `null,` `string` | Nombre de la variación del mensaje
`send_id` | `null,` `string` | ID de envío del mensaje al que pertenece este mensaje
`subscription_group_api_id` | `string` | ID API del grupo de suscripción
`to_phone_number` | `null,` `string` | [PII] Número de teléfono del usuario que recibe el mensaje ene.164formato (por ejemplo, +14155552671).
...
------|------|------------
`id` | `string` | ID global único para este evento
`user_id` | `null,` `string` | ID de Braze del usuario al que se dirigeshort_url,  nulo si  no short_urlse utilizó el seguimiento de clics del usuario.
`external_user_id` | `null,` `string` | [PII] ID externo del usuario al que se dirigeshort_url  si existe, nulo sishort_url  no utilizó el seguimiento de clics del usuario.
`app_group_api_id` | `null,` `string` | ID de API del espacio de trabajo utilizado para generar short_url
`time` | `int` | Marca de tiempo unix en la queshort_urlse hizo un clic
`timezone` | `null,` `string` | Zona horaria del usuario
`campaign_id` | `null,` `string` | Se generó el ID deshort_url Braze de la campaña para la cual se creó, nulo si no procede de una campaña.
`campaign_api_id` | `null,` `string` | Se generó el ID short_urlde API de la campaña  para la que se creó, nulo si no procede de una campaña.
`message_variation_api_id` | `null,` `string` | Se generó el ID de API de la variación del mensaje  parashort_url el que se generó, nulo si no procede de una campaña.
`canvas_id` | `null,` `string` | Se generó el ID short_urlde Braze del Canvas, nulo si no procede de un Canvas.
`canvas_api_id` | `null,` `string` | Se generó el IDshort_url de API del Canvas para, nulo si no es de un Canvas.
`canvas_variation_api_id` | `null,` `string` | Se generó el ID de API de la variación de Canvas  parashort_url la que se generó, nulo si no es de un Canvas.
`canvas_step_api_id` | `null,` `string` | Se generó el IDshort_url de API del paso en Canvas, nulo si no procede de Canvas.
`canvas_step_message_variation_api_id` | `null,` `string` | Se generó el ID deshort_url API de la variación del mensaje del paso en Canvas, nulo si no procede de Canvas.
`url` | `string` | URL original contenida en el mensaje al que te redirige short_url
`short_url` | `string` | URL acortada en la que se ha hecho clic
`user_agent` | `null,` `string` | agente de usuario solicitante short_url
...
`dispatch_id` | `null,` `string` | ID del envío al que pertenece este mensaje
`external_user_id` | `null,` `string` | [PII] ID externo del usuario
`host` | `null,` `string` | El host de la solicitud.
`id` | `string` | ID global único para este evento
`message_variation_api_id` | `null,` `string` | API ID de la variación de mensaje que recibió este usuario
`raw_response` | `null,` `string` | Respuesta sin procesar truncada desde el punto final
`retry_count` | `null, int` | El número de reintentos realizados.
`send_id` | `null,` `string` | ID de envío del mensaje al que pertenece este mensaje
`time` | `int` | Marca de tiempo unix en la que ocurrió el evento.
`url_path` | `null,` `string` | La ruta de la URL que se solicita.
`user_id` | `string` | ID de usuario de Braze del usuario que realizó este evento.
`webhook_duration` | `null, int` | Duración total de esta solicitud en milisegundos.
`webhook_failure_source` | `null,` `string` | Para saber si un error ha sido creado por Braze o por el propio punto final. El campo de origen podría ser «Punto final externo», «No tratar ningún código de estado» para el host inaccesible.
...
`template_name` | `null,` `string` | [PII] Nombre de la plantilla en el administrador de WhatsApp. Presente si envías un mensaje de plantilla
...
`flow_id` | `null,` `string` | El ID único del flujo en el administrador de WhatsApp. Presente si el usuario está respondiendo a un flujo de WhatsApp.
`flow_response_json` | `null,` `string` | [PII] Los valores del formulario que el usuario respondió. Presente si el usuario está respondiendo a un flujo de WhatsApp.
`message_id` | `null,` `string` | El ID único generado por Meta para este mensaje.
`in_reply_to` | `null,` `string` | Elmessage_id  del mensaje al que respondía este mensaje.
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
