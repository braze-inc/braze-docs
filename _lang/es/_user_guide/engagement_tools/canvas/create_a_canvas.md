---
nav_title: Construir lienzos
article_title: Construir lienzos
page_order: 1
layout: dev_guide
guide_top_header: "Construir lienzos"
guide_top_text: "Los artículos de esta sección te guiarán en la creación y lanzamiento rápido de un Canvas multidimensional, desde la ideación hasta la ejecución para tus usuarios. Con su intuitiva interfaz de arrastrar y soltar y su espacio para la colaboración, puedes aprovechar este entorno de programación visual para impulsar los mejores resultados para tus objetivos de interacción con los clientes."

page_type: landing
description: "En esta página encontrarás recursos que te ayudarán a crear y poner en marcha un Canvas multidimensional, como por ejemplo cómo crear un Canvas, criterios de salida, propiedades de entrada al Canvas y mucho más."
tool: Canvas
...
guide_featured_list:
  ...
  - name: Crear una plantilla de Canvas
  ...
  - name: Tarjetas de contenido en Canvas
