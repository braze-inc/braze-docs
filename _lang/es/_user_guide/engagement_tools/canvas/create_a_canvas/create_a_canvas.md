...
Elija el tipo de evento de conversión y, a continuación, seleccione las conversiones que desea registrar.  
...
### Paso 2b: Determina tu horario de entrada en Canvas
...
Los controles de entrada determinan si se permite a los usuarios volver a entrar en un lienzo.  
...
![La página "Horas tranquilas" muestra una casilla para habilitar las horas tranquilas. Si se habilita, se puede establecer la hora de inicio, la hora de finalización y el comportamiento de alternativa.][50]
...
Las `canvas_entry_properties` se configuran en el paso Horario de entrada de la creación de un Canvas e indican el desencadenante que introduce a un usuario en un Canvas. Estas propiedades también pueden acceder a las propiedades de las cargas útiles de entrada en los lienzos activados por API.  
...
La Selección Inteligente para Canvas optimiza sus resultados de Canvas realizando ajustes graduales en tiempo real de la distribución de usuarios clasificados en cada variante.  

Por esta razón, la Selección Inteligente funciona mejor en Lienzos en los que entran nuevos usuarios con frecuencia.

## Paso 5: Guarda e inicia tu Canvas
