...
{% tabs local %}
  ...
  {% endtab %}
  {% tab Resumen %}
    Aquí encontrarás el resumen de los datos de tu Canvas. 

  {% endtab %}
{% endtabs %}

####  Empieza con lo básico de Canvas
...
####  Determina tu horario de entrada en Canvas
...
####  Configura tu audiencia objetivo de entrada
...
####  Selecciona tu configuración de envío

Seleccione **Configuración de envío** para editar los ajustes de suscripción, activar la limitación de velocidad y activar las horas de silencio. 
...
![La página "Horas tranquilas" muestra una casilla para habilitar las horas tranquilas. 
...
3. Crea el generador de números aleatorios.  Establezca el número resultante como una variable Liquid dentro de su campaña webhook.<br><br>
...
Las funciones de selección inteligente ya están disponibles en los lienzos multivariantes.  Esta distribución se basa en las métricas de rendimiento de cada variante para maximizar el número total esperado de conversiones.
...
![La opción "Intelligent Selection" está habilitada en la página "Editar distribución de variantes". A medida que analiza y optimiza el Canvas, muestra una barra horizontal a través de la página dividida en varias secciones, cada una de las cuales varía en color y tamaño. 
