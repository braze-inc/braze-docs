...
> Braze Canvas ofrece varias plantillas preconstruidas adaptadas específicamente a los especialistas en marketing de comercio electrónico, lo que facilita la aplicación de estrategias esenciales. Esta página ofrece algunas plantillas clave que puedes utilizar para mejorar tus recorridos del cliente.

{% alert note %}
Braze reconoce que la planificación de datos lleva tiempo. Animamos a nuestros clientes a que familiaricen a sus equipos de desarrolladores y empiecen ya a enviar eventos de comercio electrónico. Aunque algunas características pueden no estar disponibles inmediatamente con los eventos recomendados para el comercio electrónico, puedes esperar la introducción de nuevos productos a lo largo de 2025 que mejorarán tus capacidades de comercio electrónico.
{% endalert %}
...
4. Selecciona **Aplicar plantilla** para la plantilla que quieras utilizar.<br><br>![La página "Plantillas Canvas" se abre en la pestaña "Plantillas Braze" y muestra una lista de las plantillas utilizadas recientemente y de las plantillas Braze seleccionables.][2]{: style="max-width:80%;"}
...
![Una plantilla Canvas "Exploración abandonada" aplicada con "Reglas de entrada" ampliadas.][3]
...
- Audiencia objetivo 
    ...
    - Criterios de salida 
        - Realiza `ecommerce.cart_updated`, `ecommerce.checkout started`, o `ecommerce.order_placed`<br><br>![Controles de entrada y criterios de salida del Canvas.]({% image_buster /assets/img/ecommerce/abandoned_browse_entry_exit.png %})<br><br> 
- Enviar configuración 
    - Usuarios suscritos o con adhesión voluntaria 
- Paso de retardo
    - 1 hora de retraso
- Paso de mensaje 
...
![Una plantilla Canvas "Carrito abandonado" aplicada con "Reglas de entrada" ampliadas.][4]
...
![Una plantilla Canvas "Pago Abandonado" aplicada con "Reglas de entrada" ampliadas.][5]
...
![Una plantilla Canvas de "Confirmación de pedido" aplicada con "Reglas de entrada" ampliadas.][6]
...
Para casos de uso de informes más avanzados, puedes utilizar el [Generador de consultas]({{site.baseurl}}/user_guide/data_and_analytics/query_builder/) Braze para generar informes personalizados. 
