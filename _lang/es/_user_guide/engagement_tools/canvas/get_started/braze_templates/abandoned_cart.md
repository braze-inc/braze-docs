...
![Evento de conversión primaria - A con el tipo de conversión "Realiza compra" con el nombre de producto "Enorme plato de papel". 
...
![Una vista previa del mensaje SMS que recibirán los usuarios: "¡Hola, te has dejado el enorme plato de papel en el carrito! Completa tu compra ahora e intensifica tu juego de alojamiento. 
