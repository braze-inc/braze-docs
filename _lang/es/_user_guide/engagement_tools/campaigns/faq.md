...
Las campañas multivariantes y los lienzos con múltiples variantes son una buena forma de empezar. Por ejemplo, puede realizar una [campaña multivariante]({{site.baseurl}}/user_guide/engagement_tools/testing/multivariant_testing/) para probar un mensaje con diferentes copias o líneas de asunto. 
...
Por ejemplo, si está previsto que una campaña se entregue a las 19:00 UTC, empezamos a poner en cola los envíos de la campaña en cuanto se identifica una zona horaria (como Samoa).  

Otro ejemplo: cree dos campañas programadas para enviarse el mismo día, una por la mañana y otra por la tarde, y añada un filtro para que los usuarios sólo puedan recibir la segunda campaña si ya han recibido la primera. Con la entrega en zona horaria local, es posible que algunos usuarios no reciban la segunda campaña. 

### ¿Cómo programar una campaña de zona horaria local?



Braze recomienda encarecidamente que todas las campañas en zonas horarias locales se programen con 24 horas de antelación.  Sin embargo, puedes programar estas campañas con menos de 24 horas de antelación si es necesario. Ten en cuenta que Braze no enviará mensajes a los usuarios que hayan incumplido la hora de envío en más de 1 hora. 
...
Si has permitido que los usuarios vuelvan a ser elegibles para la campaña, volverán a recibirla a la hora original (17:00 h). 
...
Esto puede ocurrir cuando una campaña está programada para lanzarse en el momento exacto en que se actualizó.  En lugar de programar la campaña para la misma hora, seleccione **Enviar en cuanto se lance la campaña**.
...
Para asegurarse de que las campañas funcionan como se desea, recomendamos detener la campaña actual (esto cancelará cualquier mensaje en cola).  Es posible que tenga que excluir de esta campaña a los usuarios que ya hayan recibido la primera campaña.
...
Las campañas API se utilizan para realizar un seguimiento de los mensajes que se envían a través de la API.  
...
| Pros | Contras | 
| ---- | ---- |
| \- No consume puntos de datos<br><br>\- Los elementos de personalización se incluyen en las propiedades de la carga útil JSON | \- No permite crear un segmento de usuarios elegibles para el mensaje en las propiedades de la carga útil JSON.<br><br>|
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
