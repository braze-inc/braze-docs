...
1. Seleccione el tipo general de evento que desea utilizar:
  - **Abre la aplicación**: Se considera que un usuario se ha convertido cuando abre cualquiera de las aplicaciones que especifiques (por defecto, todas las aplicaciones del área de trabajo).
