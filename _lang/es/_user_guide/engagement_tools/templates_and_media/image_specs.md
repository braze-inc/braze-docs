...
Siempre debe [previsualizar y probar sus mensajes]({{site.baseurl}}/user_guide/engagement_tools/campaigns/testing_and_more/sending_test_messages/) en una variedad de dispositivos para confirmar que las áreas más importantes de su imagen y mensaje aparecen como se espera.
