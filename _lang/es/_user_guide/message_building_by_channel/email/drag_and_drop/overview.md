...
{% alert tip %}
¿Necesitas ayuda para crear textos impactantes?  
...
- **Seleccionar usuario:** Puede seleccionar un usuario concreto en función de su dirección de correo electrónico o de su ID externo. 
