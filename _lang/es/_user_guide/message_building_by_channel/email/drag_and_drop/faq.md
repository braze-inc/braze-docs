...
No puedes editar el relleno para las vistas móvil y Web exclusivamente, de modo que cualquier edición se refleje en ambas vistas. Sin embargo, puedes añadir una lógica CSS en el editor HTML que establezca el relleno en función de los distintos tamaños de pantalla. Esto no es compatible con el editor de arrastrar y soltar, así que puedes exportar el archivo HTML y utilizar el editor HTML en su lugar.
...
No, el editor de arrastrar y soltar no permite añadir archivos adjuntos a tus correos electrónicos.
