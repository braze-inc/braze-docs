...
page_order: 7
page_type: reference
description: "Este artículo de referencia trata de los posibles escollos de la entregabilidad del correo electrónico, las trampas del spam y cómo evitarlas."
channel: email
...
| Denuncias de spam | Cuando su correo electrónico es marcado como spam por un cliente. |
...
Estas trampas pueden evitarse si se establece un proceso de opt-in confirmado. Al enviar un correo electrónico de confirmación inicial y pedir a los clientes que verifiquen que desean recibir sus mensajes, se asegura de que los destinatarios desean recibir noticias suyas y de que está enviando mensajes a direcciones reales y válidas. He aquí otras formas de evitar las trampas de spam:
...
3. **Nunca compre listas de correo electrónico.** 
