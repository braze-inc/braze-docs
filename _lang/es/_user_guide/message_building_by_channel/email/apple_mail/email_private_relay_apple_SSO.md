---
nav_title: Envío por correo electrónico a Apple Private Relay
...
# Envío por correo electrónico a Apple Private Relay
...
Para enviar correos electrónicos a la retransmisión privada de correo electrónico de Apple, registra tus dominios de envío en Apple. Si no configuras tus dominios con Apple, los correos electrónicos enviados a direcciones de retransmisión resultarán rebotados.

Si un usuario decide desactivar el envío por correo electrónico al correo de retransmisión de tu aplicación, Braze recibirá la información de rebotes de correo electrónico como de costumbre. Estos usuarios pueden administrar aplicaciones que utilizan el inicio de sesión con Apple desde la página de configuración de su ID de Apple (consulta [la documentación de Apple).](https://support.apple.com/en-us/HT210426)

## Envío por correo electrónico para SendGrid

Si utilizas SendGrid como proveedor de correo electrónico, puedes enviar correos electrónicos a Apple sin realizar cambios en los DNS. 
...
Si tu dirección "De" deseada es una dirección `abmail`, inclúyela en tu subdominio. Por ejemplo, utiliza `abmail.docs.braze.com` en lugar de `docs.braze.com`.

## Envío por correo electrónico para SparkPost

Para configurar el Apple Private Relay para SparkPost, sigue estos pasos: 
