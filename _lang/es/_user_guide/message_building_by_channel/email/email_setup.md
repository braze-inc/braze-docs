...
| Grupos de IP | Se trata de una configuración opcional que se utiliza para separar la reputación de los distintos tipos de correo electrónico (como "promocional" y "transaccional") para evitar que la reputación de uno afecte al otro y favorecer una mayor entregabilidad. | El equipo de Incorporación configurará los grupos por ti. |
