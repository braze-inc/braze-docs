...
> La característica de doble adhesión voluntaria te permite exigir a los usuarios que confirmen explícitamente su intención de adhesión voluntaria antes de que puedan recibir mensajes SMS, MMS o RCS. Esto te ayuda a adaptar tu enfoque a los usuarios que probablemente estén comprometidos o estén comprometidos con el canal, y a seguir las mejores prácticas de cumplimiento.
...
![Captura de pantalla de un mensaje SMS entrante en el que un usuario envía "JOIN" y recibe la respuesta "Reply Y to confirm you want to JOIN our SMS program. 3msg/semana, envía un mensaje de texto a STOP en cualquier momento para PARAR, luego envía un mensaje de texto a "Y".]({% image_buster /assets/img/double_opt_in_inbound.png %}){:style="max-width:40%;"}
...
![Los campos configurables tienen dos secciones, Adhesión voluntaria y Confirmación de adhesión voluntaria doble, cada una con los campos Palabras clave y Mensaje de respuesta.]({% image_buster /assets/img/double_opt_in_fields.png %})
