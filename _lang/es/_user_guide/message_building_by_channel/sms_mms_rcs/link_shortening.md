...
Cuando el acortamiento de enlaces está activado, la tabla de **rendimientoSMS/MMS/RCS ** incluye una columna titulada **Clics totales** que muestra un recuento de eventos de clic por variante y una tasa de clics asociada. Para más detalles sobre las métricas, consulta [Rendimiento de los mensajes]({{site.baseurl}}/sms_mms_rcs_reporting/).
