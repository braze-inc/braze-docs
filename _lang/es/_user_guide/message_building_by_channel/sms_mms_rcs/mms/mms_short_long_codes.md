...
Actualmente, se admiten MMS para códigos abreviados de EE. UU. (números de 5-6 dígitos), códigos largos de EE. UU. y CA (números de 10 dígitos) y números de cliente de EE. UU. y Canadá. Algunos proveedores de servicios admiten MMS para números gratuitos. 

Es posible enviar MMS a números fuera de EE.UU. y Canadá, pero los mensajes MMS se convertirán en un mensaje SMS con un enlace al activo multimedia. Para más información, consulte [Códigos cortos y largos]({{site.baseurl}}/user_guide/message_building_by_channel/sms_mms_rcs/short_and_long_codes/).
