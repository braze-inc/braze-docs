...
El aspecto final de los mensajes de derecha a izquierda depende en gran medida de cómo los presten los proveedores de servicios. 
...
{% alert tip %}
¿Te interesa la reorientación por SMS? Visita nuestro [artículo sobre reorientación]({{site.baseurl}}/user_guide/message_building_by_channel/sms/campaign/retargeting/) por SMS para saber más.
{% endalert %}

#### Elegir eventos de conversión

 Tiene la opción de permitir una ventana de hasta 30 días durante la cual se contabilizará una conversión si el usuario realiza la acción especificada.
...
A continuación, consulta [los informes de SMS]({{site.baseurl}}/user_guide/message_building_by_channel/sms/sms_campaign_analytics/) para saber cómo puedes acceder a los resultados de tus campañas por SMS.
