...
page_order: 0
description: "Esta página explica cómo dar la bienvenida a los nuevos usuarios, guiarles a través de las ventajas e impulsar la acción mediante una llamada a la acción convincente."
---
...
Para empezar a crear tu flujo de incorporación, utiliza la sección **Páginas** para añadir o eliminar mensajes a tu flujo. Cuando tengas el número deseado de mensajes, selecciona los botones de cada página. Después, utiliza el menú lateral para seleccionar a dónde van los usuarios cuando seleccionan el botón: si salen del flujo o van al siguiente mensaje.

Comprueba que tus mensajes están conectados en orden secuencial para que los usuarios se muevan por el flujo correctamente. Para saber cómo hacerlo, consulta [Conectar páginas juntos]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop/create/?tab=adding%20pages#step-3a-connect-pages-together).

### Paso 4: Estiliza tu mensaje

Personaliza el aspecto de tu flujo de incorporación utilizando [los componentes de]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop/style_settings/#message-components) arrastrar y soltar de [los mensajes dentro de la aplicación]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop/style_settings/#message-components).
