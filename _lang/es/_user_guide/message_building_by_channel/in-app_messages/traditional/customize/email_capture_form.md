...
> Los mensajes de captura de correo electrónico te permiten pedir fácilmente a los usuarios de tu sitio que envíen su dirección de correo electrónico, tras lo cual estará disponible dentro de su perfil de usuario para utilizarla en todas tus campañas de mensajería.
...
- Para los [usuarios anónimos]({{site.baseurl}}/user_guide/data_and_analytics/user_data_collection/user_profile_lifecycle/#anonymous-user-profiles) que aún no tienen una cuenta, la dirección de correo electrónico estará en vivo en el perfil de usuario anónimo vinculado al dispositivo del usuario.
- Si ya existe una dirección de correo electrónico en el perfil de usuario, la dirección de correo electrónico existente se sobrescribirá con la nueva dirección de correo electrónico introducida.
- Si el usuario conocido tiene una dirección de correo electrónico marcada como [rebotada duramente]({{site.baseurl}}/help/help_articles/email/email_bounces#email-bounces), comprobaremos si la dirección de correo electrónico recién introducida difiere de la que figura en su perfil de Braze. Si la dirección de correo electrónico proporcionada es diferente, se actualizará la dirección de correo electrónico y se eliminará el estado de rebote duro. 
- Si un usuario introduce una dirección de correo electrónico no válida, verá un mensaje de error: "Introduce un correo electrónico válido".
...
Para más información, consulta el [ciclo de vida del perfil de usuario]({{site.baseurl}}/user_guide/data/user_data_collection/user_profile_lifecycle/).

{% enddetails %}

## Paso 1: Crea una campaña de mensajes dentro de la aplicación

Para acceder a esta opción, debes crear una campaña de mensajería dentro de la aplicación. A partir de ahí, dependiendo de tu caso de uso, establece **Enviar a** en **Navegadores Web**, **Aplicaciones Móviles** o **Ambas Aplicaciones Móviles & Navegadores Web**, y luego selecciona **Formulario de captura de correo electrónico** como **Tipo de mensaje**.
...
A continuación, personaliza tu formulario como necesites. Puedes personalizar las siguientes características para tu formulario de captura de correo electrónico:

- Cabecera, cuerpo y texto del botón de envío
- Una imagen opcional
- Un enlace opcional a las "Condiciones del servicio".
- Diferentes colores para la cabecera y el cuerpo del texto, los botones y el fondo
- Pares clave-valor
- Estilo para el texto del encabezado y del cuerpo, botones, color del borde del botón, fondo y superposición

\![Compositor para formulario de captura de correo electrónico.]({% image_buster /assets/img/email_capture.png %})

Si necesitas una mayor personalización, elige **Código personalizado** para tu **Tipo de mensaje**. Puedes utilizar esta [plantilla modal de captura de correo electrónico](https://github.com/braze-inc/in-app-message-templates/tree/master/braze-templates/5-email-capture-modal) del repositorio [Braze Templates](https://github.com/braze-inc/in-app-message-templates/tree/master/braze-templates) de GitHub como código de inicio.
...
Si lo deseas, también puedes combinar los dos filtros utilizando la lógica `AND`. Esto hace que el formulario sólo aparezca a los usuarios a los que les falte tanto una dirección de correo electrónico como un ID externo de usuario, lo que es ideal para captar nuevos clientes potenciales o solicitar la creación de una cuenta.
