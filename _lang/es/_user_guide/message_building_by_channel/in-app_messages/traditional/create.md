...
2.  Tenga en cuenta que los mensajes in-app no están disponibles en las campañas multicanal.
...
|---|---|---|
| | Aplícalo desde la galería de plantillas de mensajes de la aplicación. |   |
