...
![Dos pantallas de móvil una al lado de la otra. El primero es un mensaje in-app que pide al usuario que valore la aplicación en la App Store. 
...
![Dos mensajes in-app uno al lado del otro. La primera anima al usuario a valorar la aplicación preguntándole si tiene un momento para hacerlo. 
