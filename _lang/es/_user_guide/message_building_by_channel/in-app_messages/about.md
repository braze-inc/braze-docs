...
| Campañas altamente personalizadas | Coloque mensajes en la aplicación como lo primero que ven sus clientes cuando entran en su aplicación o sitio web. 
...
Además de estas plantillas de mensajes listas para usar, también puedes personalizar aún más tu mensajería utilizando mensajes HTML personalizados dentro de la aplicación, modales web con CSS o formularios web de captura de correo electrónico. 

## Más recursos

 Esta guía abarca cuestiones de segmentación, contenido y conversión que debe tener en cuenta a la hora de crear mensajes dentro de la aplicación.
