...
### GIF y vídeos
 ...
 Para obtener más información sobre el vídeo en los mensajes in-app, consulte nuestra [documentación de personalización]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/customize/#video).
