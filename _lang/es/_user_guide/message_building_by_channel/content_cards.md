...
## [![Curso de Braze ]({% image_buster /assets/img/bl_icon3.png %})](https://learning.braze.com/content-cards){: style="float:right;width:120px;border:0;" class="noimgborder"}[Learning](https://learning.braze.com/content-cards) Ventajas de utilizar tarjetas de contenido
