...
guide_top_text: "Los mensajes push son una forma probada de llegar a sus clientes a través del móvil o la web. Son útiles para conducir a un usuario a un lugar concreto, pero debes utilizarlos con prudencia. Lea cualquiera de los siguientes artículos o consulte nuestro curso [Push Braze Learning course](https://learning.braze.com/messaging-channels-push) para saber a quién puede enviar un push, cómo enviarlo y qué funciones avanzadas de push ofrece Braze."
...
- name: Creación de un mensaje push
