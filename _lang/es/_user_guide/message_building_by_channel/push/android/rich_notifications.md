...
- Las imágenes de notificaciones ampliadas de Android deben tener una proporción de 2:1, pero no tienen límite de tamaño.
...
- El SDK de Braze para Android debe estar habilitado para que la imagen se pueda renderizar.
...
Añade el **texto resumen** que deseas que aparezca antes de la imagen en la notificación.

![Una notificación push enriquecida de una aplicación de comida para mascotas llamada Dog que indica que es hora de pedir más comida para Spot, con un texto resumen.]({% image_buster /assets/img_archive/android_rich_summarytext.png %})

### Paso 3: Añadir medios

Añade tu imagen en el campo **Imagen de notificación de Android** en el creador de mensajes. Las imágenes pueden cargarse directamente a través del panel de control o especificando una URL de contenido alojada en otro lugar.
...
![La sección de imágenes de notificaciones de Android, donde puedes añadir una imagen o introducir la URL de una imagen.]({% image_buster /assets/img_archive/android_rich_image.png %})
