...
>  Los usuarios pueden controlar los aspectos de sus notificaciones (por ejemplo, la repetición, los ajustes de ruido/vibración, la exclusión voluntaria, etc.) en función de los canales individuales.
...
5\. Introduzca el nombre y el ID del canal de notificación que desea añadir.<br><br><br><br>
...
3. Seleccione **Gestionar canales de notificación** después de ampliar las opciones de canales de notificación. <br><br><br><br>
