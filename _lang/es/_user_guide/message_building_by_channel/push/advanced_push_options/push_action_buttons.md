...
{% alert note %}
 En concreto, es necesario configurar las categorías de iOS o seleccionar entre determinadas opciones de botones predeterminados. Para las integraciones de Android, estos botones funcionarán automáticamente.
{% endalert %}
...
2.  Puede seleccionar una de las siguientes acciones disponibles:
  - Abrir aplicación
