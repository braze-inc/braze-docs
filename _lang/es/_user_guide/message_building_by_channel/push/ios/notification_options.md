...
Crea tu campaña push para iOS, luego ve a la pestaña **de configuración** y abre el menú desplegable **del grupo de notificaciones**.

![La pestaña «Configuración» con un menú desplegable «Grupo de notificaciones» que seleccionaba el valor «Cupones».]({% image_buster /assets/img_archive/notification_group_dropdown.png %}){: style="max-width:50%;" }
...
![Página de configuración de notificaciones de iOS que muestra las notificaciones habilitadas para su entrega inmediata y con notificaciones urgentes habilitadas.]({% image_buster /assets/img/ios/ios15-notification-settings.png %}){: style="max-width:40%"}
