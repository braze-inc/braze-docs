...
![LINE creador de mensajes con un mensaje de texto que contiene una URL larga: https://braze.com/docs/user_guide/message_building_by_channel/line/create/]({% image_buster /assets/img/line/click_tracking_text_message.png %})
...
![Creador de mensajes LINE con un mensaje basado en tarjetas con dos botones que tienen cada uno una URL.]({% image_buster /assets/img/line/card_based_message_click_tracking.png %})
