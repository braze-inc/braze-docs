...
1. En LINE, ve a la pestaña **API de mensajería** y edita la **configuración de tu Webhook**:
   ...
   - Activa **Usar webhook** y **Reenviar webhook**. <br><br> 
...
1. Crea un Canvas basado en acciones que se base en un cambio de estado de suscripción y se desencadene cuando un usuario se suscriba a tu canal de LINE.<br>
...
4\. (Opcional) Crea una campaña basada en acciones o Canvas que se desencadene cuando se identifique al usuario de LINE para enviarle su código de cupón. <br>
...
1. Configure un Canvas que devuelva el ID de usuario Braze de un usuario en una palabra desencadenante específica. <br><br>Ejemplo de desencadenante <br><br><br><br>Ejemplo de mensaje<br><br><br><br>
