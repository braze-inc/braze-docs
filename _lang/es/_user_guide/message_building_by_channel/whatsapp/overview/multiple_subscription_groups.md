...
![Sección de integración de mensajería WhatsApp con opciones para añadir una cuenta de empresa o añadir un grupo y un número de suscripción.]({% image_buster /assets/img/whatsapp/multiple_wabas.png %})
