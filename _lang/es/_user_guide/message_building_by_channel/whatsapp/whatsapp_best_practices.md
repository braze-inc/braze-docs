...
![Hilo de mensajes de WhatsApp con opciones para bloquear o denunciar a una empresa]({% image_buster /assets/img/whatsapp/whatsapp_block_report.png %}){: style="max-width:30%;"}
...
![Mensaje de WhatsApp con un pie de página indicando que hay que responder STOP para darse de baja del canal]({% image_buster /assets/img/whatsapp/whatsapp_unsubscribe.png %}){: style="max-width:35%;"}
