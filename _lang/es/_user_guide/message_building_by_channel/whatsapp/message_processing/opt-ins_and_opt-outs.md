...
1. Cree una plantilla de mensaje con la respuesta rápida "marketing opt-out".<br><br><br><br><br>
...
{: start="2"}
2\. En el Lienzo, cree un paso **Configurar Actualización de Usuario** y para **Acción** seleccione **Editor JSON Avanzado**. <br><br><br><br>
...
{: start="4"}
4\. Añade un paso de mensaje de WhatsApp posterior. <br><br>
