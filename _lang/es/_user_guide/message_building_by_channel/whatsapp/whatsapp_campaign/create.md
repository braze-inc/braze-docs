...
Si añades texto en un idioma escrito de derecha a izquierda, ten en cuenta que el aspecto final de los mensajes escritos de derecha a izquierda depende en gran medida de cómo los rendericen los proveedores de servicios. 
...
{% alert tip %}
{% raw %}
Si piensa utilizar Liquid, asegúrese de incluir un valor predeterminado para la personalización elegida, de modo que en caso de que el perfil de usuario del destinatario esté incompleto, no reciba el mensaje. 
{% endraw %}
{% endalert %}
...
#### Elegir eventos de conversión
 ...
 Puede permitir una ventana de hasta 30 días durante la cual se contabilizará una conversión si el usuario realiza la acción especificada.
...
| Audio |   |  |
| Documentos |  |  |
| Video | Solo admite el códec de video H.264 y el códec de audio AAC.  |  |
|  |   |  |
...
| Botón de cancelación de marketing |   |
