...
{% alert tip %}
Le recomendamos encarecidamente que consulte nuestro curso gratuito [Braze Foundations for](https://learning.braze.com/page/braze-foundations-for-everyone) Everyone junto con estos artículos. No se necesita ningún nombre de usuario o cuenta especial para este curso. Si eres desarrollador y buscas un resumen técnico de Braze, consulta también [Introducción para desarrolladores]({{site.baseurl}}/developer_guide/platform_wide/getting_started/platform_overview).
{% endalert %}
