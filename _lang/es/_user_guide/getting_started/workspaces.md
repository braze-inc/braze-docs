...
Los espacios de trabajo tienen definiciones independientes de acceso y permiso de usuario. 

#### Conectores de corriente

 Los conectores Currents se incluyen con determinados paquetes Braze, y es posible que haya recibido uno inicialmente, suponiendo un único espacio de trabajo.
...
#### Perfiles de usuario
 ...
 Sin embargo, los perfiles de usuario también son un gran recurso para solucionar problemas y realizar pruebas, ya que se puede acceder fácilmente a información sobre el historial de participación de un usuario, su pertenencia a un segmento, su dispositivo y su sistema operativo.
...
<table>
    ...
    <tr>
        ...
        <td> SMS, mensajes dentro de la aplicación, correo electrónico, plantillas de correo electrónico y bloques de contenido. <br><br>Puede duplicar segmentos, campañas y lienzos para reutilizar el contenido de una aplicación a otra.</td>
        <td>N/A</td>
    </tr>
    <tr>
        <td>Análisis</td>
...
Una vez que hayas determinado tu plan de espacio de trabajo, es hora de crear tu espacio de trabajo y añadir instancias de aplicaciones. 
