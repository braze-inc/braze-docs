...
* El [punto final de tu SDK]({{site.baseurl}}/user_guide/administrative/access_braze/sdk_endpoints/)
  * Braze ya no proporciona puntos finales personalizados, así que utiliza los puntos finales SDK predefinidos. 
...
Colabora con tu ingeniero para asegurarte de que todo funciona correctamente. 
