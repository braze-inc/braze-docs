...
- Debes tener al menos un [catálogo]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/catalogs/) para utilizar cualquiera de los tipos de recomendación descritos a continuación.
