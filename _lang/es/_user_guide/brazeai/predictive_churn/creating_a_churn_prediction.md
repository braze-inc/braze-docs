...
La ventana de abandono se evalúa remontándose al número de días transcurridos desde el último día en que se ejecutó el modelo, de modo que si la ventana de abandono es de 15 días y el último modelo se ejecutó el 1 de diciembre, el modelo analiza del 16 al 30 de noviembre para comprender la actividad de los usuarios para la elegibilidad de la audiencia y la formación.
...
- **Los que corren el riesgo de no comprar como definición de abandono**<br>Quizá quieras centrarte en los clientes que han estado navegando o buscando, o que han interactuado con tu aplicación más recientemente. Tal vez una intervención adecuada con descuentos evite que este grupo más comprometido abandone.
