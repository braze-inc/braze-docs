---
nav_title: Crear una predicción de evento
article_title: Crear una predicción de evento
page_order: 1.1
description: "Este artículo explica cómo crear una predicción de eventos en el panel de Braze."

---

# Crear una predicción de evento
...
Selecciona la **frecuencia máxima de actualizaciones** que te resulte útil. Por ejemplo, si estás haciendo una predicción de compras y planeas enviar una promoción semanal, configura la frecuencia de actualización en **Semanal** en el día y la hora que elijas.
