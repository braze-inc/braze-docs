...
"No hay suficientes usuarios que abandonen de la audiencia de predicción seleccionada en los últimos 7 días para construir la predicción de forma fiable".
...
Si tu modelo tiene una [calidad de predicción]({{site.baseurl}}/user_guide/brazeai/predictive_suite/predictive_churn/prediction_analytics/prediction_quality/) del 40% o superior, ¡estás en un buen lugar! Pero si la calidad de tu predicción desciende al 39% o menos, puede que tengas que editar las definiciones de tus audiencias de abandono y predicción para que sean más específicas o tengan ventanas temporales diferentes. 
