...
«No hay suficientes usuarios que abandonan la aplicación para elaborar una predicción fiable».

![Requisitos de datos de predicción que muestran 31 usuarios que han abandonado la compañía en el pasado (cumple el requisito) y 0 usuarios que no han abandonado la compañía en el pasado (por debajo del mínimo). Un mensaje de advertencia indica que no hay suficientes usuarios que no abandonan para crear la predicción.]({% image_buster /assets/img/churn/audience_size_error.png %})
