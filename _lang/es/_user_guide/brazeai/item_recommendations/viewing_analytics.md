...
# Análisis de recomendaciones de artículos
...
| **Tipo de recomendación** | El porcentaje de usuarios que recibirán recomendaciones de personalización o más recientes frente a la alternativa de los artículos más populares. La alternativa se envía a los usuarios que no tienen datos suficientes para generar una recomendación personalizada o más reciente. |
...
| Métrica              | Descripción |
| ------------------- | ---------- |
| **Elementos personalizados**<br><br>**Elementos más recientes** | Esta columna enumera cada artículo del catálogo en orden descendente de los más recomendados a los usuarios. Esta columna también muestra a cuántos usuarios asignó el modelo cada elemento.<br><br>Se mostrarán los artículos **personalizados** o **los más recientes,** dependiendo del [tipo]({{site.baseurl}}/user_guide/brazeai/recommendations/) de [recomendación]({{site.baseurl}}/user_guide/brazeai/recommendations/). |
