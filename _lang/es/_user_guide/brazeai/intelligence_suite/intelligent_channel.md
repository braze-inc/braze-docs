...
Para habilitar el filtro de canal inteligente, selecciona el filtro **Intelligent Channel** en la página **Audiencias objetivo** al crear una campaña de correo electrónico, notificación push web o push móvil.
...
Cuando el usuario tiene datos suficientes para que se determine una clasificación, pero se vuelve inalcanzable en su canal de mayor interacción, el usuario "se caerá" y no recibirá ningún mensaje. Los usuarios que no son alcanzables en canales específicos deben segmentarse por separado.
