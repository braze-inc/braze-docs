...
> Con Predictive Churn, puedes definir qué significa el abandono para tu empresa e identificar a los usuarios que quieres retener. Cuando creas una predicción, Braze entrena un modelo de aprendizaje automático que utiliza [árboles de decisión potenciados por gradiente](https://en.wikipedia.org/wiki/Gradient_boosting) para reconocer a los usuarios de riesgo mediante el análisis de patrones de comportamiento pasado, tanto de los usuarios que abandonaron como de los que no.
