...
La actualización de las puntuaciones de riesgo de la audiencia de predicción puede hacerse con la [frecuencia que elijas]({{site.baseurl}}/user_guide/brazeai/predictive_churn/creating_a_churn_prediction/#step-4-choose-the-update-frequency-for-churn-prediction). De este modo, puedes ponerte en contacto con los usuarios que corren el riesgo de abandonar antes de que lo hagan y evitar que ocurra en primer lugar. Utilizando hasta tres predicciones activas, puedes aprovechar Predictive Churn para adaptar modelos individuales que te ayuden a evitar el abandono en segmentos específicos de tus usuarios que consideres más valiosos.
