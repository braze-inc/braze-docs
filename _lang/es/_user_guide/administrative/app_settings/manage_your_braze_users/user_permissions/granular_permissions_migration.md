...
2. Si tu empresa ha automatizado el aprovisionamiento de usuarios mediante SCIM o herramientas de cumplimiento que se basan en [cadenas de permisos]({{site.baseurl}}/scim_api_appendix/), actualízalas para que se ajusten a la nueva estructura granular. 
...
## Mapeado de permisos heredados a permisos granulares

Esta tabla muestra cómo se mapea cada permiso heredado a los permisos granulares. Consulta esta tabla mientras actualizas tus permisos. Por ejemplo, para conceder a un usuario el mismo acceso que el permiso heredado «Administrar configuración del correo electrónico», ese usuario debe tener los permisos granulares «Ver configuración del correo electrónico» y «Editar configuración del correo electrónico».
...
| Espacio de trabajo | Acceder a campañas, Canvas, tarjetas, bloques de contenido, conmutadores de características, segmentos, biblioteca multimedia, ubicaciones, códigos promocionales y centros de preferencias | Ver campañas<br>Editar campañas<br>Archivar campañas<br>Ver Canvas<br>Editar Canvas<br>Archivar Canvas<br>Ver reglas de limitación de frecuencia<br>Editar reglas de limitación de frecuencia<br>Ver priorización de mensajes<br>Editar priorización de mensajes<br>Ver bloques de contenido<br>Ver conmutadores de características<br>Editar conmutadores de características<br>Archivar conmutadores de características<br>Ver segmentos<br>Editar segmentos<br>Editar grupo de control global<br>Ver plantillas IAM<br>Editar plantillas IAM<br>Archivar plantillas IAM<br>Ver plantillas de correo electrónico<br>Editar plantillas de correo electrónico<br>Archivar plantillas de correo electrónico<br>Ver plantillas de webhook<br>Editar plantillas de webhook<br>Archivar plantillas de webhook<br>Ver plantillas de enlaces de correo electrónico<br>Editar plantillas de enlaces de correo electrónico<br>Ver activos de la biblioteca multimedia<br>Ver ubicaciones<br>Editar ubicaciones<br>Archivar ubicaciones<br>Ver códigos promocionales<br>Editar códigos promocionales<br>Exportar códigos promocionales<br>Ver centros de preferencias<br>Editar centros de preferencias<br>Editar informes<br>Ver plantillas de banners<br>Ver configuración de localización<br>Utilizar Operator<br>Ver agentes de Decisioning Studio<br>Ver evento de conversión de Decisioning Studio |
| Espacio de trabajo | Acceder a la consola para desarrolladores | Ver claves de API<br>Editar claves de API<br>Ver grupos internos<br>Editar grupos internos<br>Eliminar grupos internos<br>Ver registro de actividad de mensajes<br>Ver registro de usuarios del evento<br>Ver identificadores de API<br>Ver dashboard de uso de la API<br>Ver límites de la API<br>Ver alertas de uso de la API<br>Editar alertas de uso de la API<br>Ver depurador del SDK<br>Editar depurador del SDK |
...
| Espacio de trabajo | Lanzar y administrar bloques de contenido | Editar bloques de contenido<br>Archivar bloques de contenido<br>Lanzar bloques de contenido |
| Espacio de trabajo | Administrar la biblioteca multimedia | Editar activos de la biblioteca multimedia<br>Eliminar activos de la biblioteca multimedia |
| Espacio de trabajo | Lanzar centros de preferencias | Lanzar centros de preferencias |
| Espacio de trabajo | Administrar aplicaciones | Ver configuración de la aplicación<br>Editar configuración de la aplicación<br>Ver configuración push<br>Editar configuración push<br>Editar plantillas de banners<br>Archivar plantillas de banners |
| Espacio de trabajo | Administrar permisos del dashboard de catálogos | Ver catálogos<br>Editar catálogos<br>Exportar catálogos<br>Eliminar catálogos |
| Espacio de trabajo | Administrar usuarios del dashboard | Editar usuarios del dashboard |
| Espacio de trabajo | Administrar configuración del correo electrónico | Ver configuración del correo electrónico<br>Editar configuración del correo electrónico |
| Espacio de trabajo | Administrar eventos, atributos, compras | Ver atributos personalizados<br>Editar atributos personalizados<br>Bloquear atributos personalizados<br>Eliminar atributos personalizados<br>Exportar atributos personalizados<br>Ver eventos personalizados<br>Editar eventos personalizados<br>Bloquear eventos personalizados<br>Eliminar eventos personalizados<br>Exportar eventos personalizados<br>Editar segmentación de propiedades de eventos personalizados<br>Ver productos<br>Editar productos<br>Bloquear productos<br>Editar segmentación de propiedades de compra |
| Espacio de trabajo | Administrar integraciones externas | Editar socios tecnológicos<br>Editar ingesta de datos en la nube |
| Espacio de trabajo | Administrar configuración multilingüe | Editar configuración de localización<br>Eliminar configuración de localización |
| Espacio de trabajo | Administrar grupos de suscripción | Editar suscripciones |
| Espacio de trabajo | Administrar etiquetas | Ver etiquetas<br>Editar etiquetas<br>Eliminar etiquetas |
| Espacio de trabajo | Administrar equipos | Ver equipos<br>Editar equipos<br>Archivar equipos |
...
| Espacio de trabajo | Administrar cifrado de datos de usuario | Editar cifrado a nivel de campo del identificador |
...
| Espacio de trabajo | Ver integraciones de Currents | Ver integraciones de Currents |
...
| Espacio de trabajo | Crear borradores de páginas de inicio | Editar borradores de páginas de inicio |
| Espacio de trabajo | Acceder a páginas de inicio | Ver páginas de inicio |
| Espacio de trabajo | Crear y editar plantillas de páginas de inicio | Editar plantillas de páginas de inicio |
...
### ¿Puedo optar por no participar en la migración o revertirla?
