...
Los administradores tienen acceso a todas las funciones y la posibilidad de modificar cualquier configuración de la empresa. 
...
Puede dar a un usuario permisos diferentes para cada espacio de trabajo al que pertenezca en Braze. 
...
## Exportación de permisos de usuario
 ...
 En breve le enviaremos un archivo CSV a su dirección de correo electrónico.
...
|Espacio de trabajo|Acceda a Campañas, Lienzos, Tarjetas, Bloques de contenido, Banderas de características, Segmentos, Mediateca, Ubicaciones, Códigos de promoción y Centros de preferencias.| Sin embargo, los usuarios con este permiso no pueden pausar ni editar los contenidos en directo existentes.|
...
|Espacio de trabajo|Aprobar y denegar Canvas|Permite a los usuarios aprobar o denegar lienzos. |
...
|Espacio de trabajo|Administrar integraciones externas||
...
|Espacio de trabajo|Ver PII|Permite a los usuarios ver los campos de información de identificación personal (PII) definidos por tu empresa dentro del panel. Los usuarios también pueden ver los campos PII en la pestaña **Vista previa como usuario** de las vistas previas de los mensajes.<br><br>|
|Espacio de trabajo|Ver perfiles de usuarios que cumplen las reglas de PII|Permite a los usuarios ver los perfiles de usuario que contienen campos que tu empresa ha definido como información de identificación personal (PII), pero redacta los campos PII.<br><br> |
