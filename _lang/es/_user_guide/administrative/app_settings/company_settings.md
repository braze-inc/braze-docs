...
{% alert warning %}
Cualquier modificación realizada en la sección **Configuración del administrador** se aplicará a todas las cuentas de usuario Braze asociadas a su empresa.
{% endalert %}
