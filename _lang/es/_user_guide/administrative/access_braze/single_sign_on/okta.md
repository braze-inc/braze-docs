...
Desde tu panel de administración de Okta, Okta te proporciona una URL de destino (URL de inicio de sesión) y un certificado `x.509`, que debes introducir en la página de **configuración de seguridad** de tu cuenta Braze.
