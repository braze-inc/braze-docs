...
page_type: landing
description: "En esta página encontrarás artículos sobre el inicio de sesión único (SSO). Aquí puedes encontrar ayuda para configurar los proveedores de identidad admitidos o para realizar una configuración personalizada."
