...
# Portal de productos ![Menú de recursos en el panel de control de Braze]({% image_buster /assets/img/portal.png %}){: style="float:right;max-width:33%;margin-left:15px;margin-top:15px;"}
