...
Para configurar el seguimiento de desinstalación de tu aplicación iOS, utiliza un [método de utilidad][iOS docs]. Para tu aplicación Android, utiliza [`isUninstallTrackingPush()`][8]. Cuando Braze detecta una desinstalación, ya sea a partir del seguimiento de desinstalaciones o de la entrega normal de campañas push, registraremos la mejor hora estimada de la desinstalación en el usuario. Este tiempo se almacena en el perfil del usuario como un atributo estándar y puede utilizarse para definir un segmento de usuarios para las campañas de recuperación.
