---
nav_title: Portal de privacidad
article_title: Portal de privacidad
page_order: 60
layout: dev_guide
search_rank: 3
guide_top_header: "Portal de privacidad Braze"
guide_top_text: "> Bienvenido al Portal de Privacidad de Braze. Aquí encontrará todo tipo de información útil sobre cómo Braze puede ayudarle a ser un buen custodio de los datos de sus clientes y, lo que es más importante, permitirle tomar medidas para cumplir las normas de protección de datos pertinentes para su empresa. Hemos reunido información y enlaces a documentación que pueden ayudarle a utilizar los Servicios Braze de conformidad con las leyes y reglamentos aplicables en materia de protección de datos."
...
guide_featured_title: "Uso de Braze"
guide_featured_list:
- name: Asistencia técnica en materia de protección de datos para las solicitudes de los interesados
  link: /docs/dp-technical-assistance/
  image: /assets/img/braze_icons/settings-01.svg
- name: Píxel de apertura de correo electrónico y seguimiento de clics
  link: /docs/user_guide/data_and_analytics/tracking/email_tracking#open-pixel-and-click-tracking-overview
  image: /assets/img/braze_icons/mail-01.svg
- name: Suscripciones por correo electrónico
...
- name: Centro de preferencias de correo electrónico
  link: /docs/user_guide/message_building_by_channel/email/preference_center
  image: /assets/img/braze_icons/list.svg
- name: Grupos de suscripción de SMS
...
- name: Recopilación de datos predeterminada y mínima del SDK
  ...
  image: /assets/img/braze_icons/settings-01.svg
- name: Consideraciones sobre la privacidad de datos en la sincronización de audiencias de Canvas
  link: /docs/partners/canvas_steps/overview#data-privacy-considerations
  image: /assets/img/braze_icons/fingerprint-03.svg
- name: Conservación de datos Braze
...
- name: Preguntas frecuentes sobre el RGPD
...
- name: Aviso sobre marco de privacidad de datos
...
- name: Certificaciones de seguridad Braze
...
{% alert important %}
**Aviso legal**<br>
La información aquí facilitada tiene únicamente fines educativos y no debe interpretarse como asesoramiento jurídico. Braze anima a todos nuestros clientes a buscar su propio asesoramiento legal sobre el uso de Braze en cumplimiento de las leyes y normativas de protección de datos.
{% endalert %}
