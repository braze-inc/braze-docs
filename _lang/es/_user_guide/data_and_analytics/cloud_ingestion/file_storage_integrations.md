...
description: "Este artículo de referencia trata sobre la ingesta de datos en la nube de Braze y cómo sincronizar datos relevantes de S3 a Braze"
page_order: 3
page_type: reference
...
> En este artículo se explica cómo configurar la compatibilidad con Cloud Data Ingestion y sincronizar los datos relevantes de S3 con Braze.
...
Asegúrate de anotar el ARN y la URL del SQS, ya que lo utilizarás con frecuencia durante esta configuración.
...
{% alert note %}
Los archivos añadidos al contenedor de S3 de origen no deben superar los 512 MB. Los archivos de más de 512 MB provocarán un error y no se sincronizarán con Braze.
{% endalert %}
