...
page_order: 2.5
page_type: reference
description: "Este artículo de referencia muestra cómo puede utilizar las plantillas de informes del Generador de consultas para desglosar las métricas de rendimiento de campañas, Canvas, variantes y pasos por segmentos."
tool: 
  - Segments
  - Reports
...
1. En **el Generador de consultas**, elija crear un nuevo informe SQL a través de una plantilla. 
2. Filtra las plantillas por aquellas en las que las métricas incluyan "desgloses por segmentos", que son:
