...
En tu cuenta del panel, ve a **Análisis** > **Informes de interacción**. Haga clic en **\+ Crear nuevo informe**.

{% alert note %}
Si utiliza la [navegación anterior]({{site.baseurl}}/navigation), encontrará **los Informes de compromiso** en **Datos**.
{% endalert %}
...
El paso **Añadir estadísticas** le muestra las estadísticas de los tipos de campañas o Lienzos que haya seleccionado. Por ejemplo, si ha seleccionado mensajes de correo electrónico, sólo verá las estadísticas pertinentes de correo electrónico. Si ha elegido una combinación de correo electrónico y push, verá las estadísticas de esos dos canales.
...
Por defecto, los datos mostrados en los informes de compromiso son diarios (1 día). Si desea ver estos datos en diferentes intervalos, puede elegir un número explícito de días o semanas para agregar los datos para el informe. Así, en lugar de ver las métricas diarias, puede ver su compromiso por semana, mes, trimestre, etc. Si una agregación centrada en el tiempo no es suficiente, también puede optar por exportar los datos a nivel de campaña o de lienzo.
...
- **Enviar a una hora determinada:** Esta opción le permite elegir con qué frecuencia desea recibir este informe. Puede elegir enviar este informe cada determinado número de días, semanas o meses. También puede definir cuándo dejar de enviar el informe.

![engagement_reports_schedule_report][5]{: style="max-width:65%;" }

### Paso 5: Revisión y lanzamiento

El último paso de la configuración de su informe muestra una vista general de las opciones configuradas. Revise su informe y, cuando esté satisfecho, haga clic en **Iniciar informe**.

### Paso 6: Compruebe su correo electrónico  

Recibirá un correo electrónico con enlaces a sus informes en el momento u horario que elija. **Estos enlaces caducan una hora después del envío del informe.** Al hacer clic en los enlaces proporcionados, descargará automáticamente un archivo ZIP que contiene sus archivos CSV, uno para todas las campañas.
