...
page_order: 2
page_type: reference
description: "Este artículo de referencia explica la sección de segmentos del panel de control de Braze e incluye un resumen de las estadísticas proporcionadas."
tool: 
  - Segments
  - Reports
...
> Este artículo de referencia explica la sección de segmentos del panel de control de Braze e incluye un resumen de las estadísticas proporcionadas.

## Acceder a datos sobre tus segmentos y membresía

La página **Segmentos** de su cuadro de mandos Braze contiene un resumen de todos sus segmentos y le permite examinar datos detallados de cada uno de ellos. En esta página, busque y haga clic en el nombre de un segmento para editar y ver sus datos. Para saber cómo crear un segmento, consulte [Creación de un segmento][3].

![Página de segmentos][1]

Tras hacer clic en el nombre de un segmento, podrá ver las estadísticas y los filtros del mismo. Puede editar su segmento añadiendo o eliminando filtros. Asegúrate de guardar los cambios.

![Datos de los segmentos][2]

Cuando active [seguimiento analítico para un segmento][9], Braze le permitirá ver las sesiones, los eventos personalizados y los ingresos a lo largo del tiempo por este segmento.

### Estadísticas de los segmentos

Verá las siguientes estadísticas de segmentos, que se actualizan en tiempo real a medida que añade o elimina filtros:
...
## Datos de resultados por segmento

Utilice [las plantillas de informes del Generador de consultas]({{site.baseurl}}/user_guide/data_and_analytics/reporting/data_by_segments/) para desglosar las métricas de rendimiento de las campañas, Canvas, variantes y pasos por segmentos.

## Creación de un informe de desglose de segmentos mediante Query Builder

Para crear un informe a partir de una plantilla de [Generador de consultas]({{site.baseurl}}/user_guide/data_and_analytics/query_builder/), vaya al **Generador de consultas** y haga lo siguiente:
...
5. (opcional) Edite directamente el SQL en la plantilla.
6. Haga clic en **Ejecutar consulta**. Los resultados se mostrarán en una tabla.
...
2. La función de datos de rendimiento por segmento está activada. Durante la fase de acceso anticipado, iremos extendiendo gradualmente esta función a los clientes. 

No podrá acceder a datos de periodos de tiempo anteriores a la activación de esta función para su empresa. Por ejemplo, si el seguimiento analítico se activa para el segmento A el 1 de octubre y esta función se activa para su empresa el 2 de octubre, sólo podrá ver los datos del segmento A para las campañas y los lienzos que registraron métricas después del 2 de octubre. 
