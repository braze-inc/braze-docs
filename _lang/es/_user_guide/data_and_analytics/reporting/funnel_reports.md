...
page_order: 6
page_type: reference
description: "Este artículo de referencia explica las ventajas de los informes de embudo, cómo configurarlos y cómo interpretarlos."
tool: Reports
---

# Informes de embudo

> Los informes de embudo ofrecen un informe visual que le permite analizar los recorridos que realizan sus clientes tras recibir una campaña o Canvas. ![Informe del embudo 2][2]{: style="float:right;max-width:15%;margin-bottom:15px; border: 0"}
...
![Informe del embudo 1][1]{: style="max-width:80%;"}

## Configuración del informe de embudo

![Informe del embudo 5][5]{: style="float:right;max-width:40%;border:0;margin-left:15px;"}
...
- La página **Detalles del Canvas** de un Canvas concreto, a través del botón **Analizar variantes** 
...
Puede seleccionar un marco temporal para su informe (dentro de los últimos 6 meses), y refinar los datos para ver los usuarios que, al entrar en la campaña o Canvas, completaron los eventos del embudo dentro de una ventana establecida (máximo de 30 días). En el siguiente ejemplo, su embudo buscaría usuarios que recibieron esta campaña o Canvas en los últimos 7 días y completaron el embudo en 3 días.

{% alert note %}
Si establece la ventana para completar el embudo en 1 día, entonces el evento del embudo debe producirse en las 24 horas siguientes a la recepción del mensaje. Sin embargo, si selecciona varios días, la ventana de tiempo se cuenta como días naturales en la zona horaria de la empresa.
{% endalert %}

![Informe del embudo 5][6]{: style="max-width:90%;"}
...
![Informe del embudo 3][3]{: style="max-width:80%;"}
...
Tras hacer clic en **Crear informe**, el informe del embudo puede tardar varios minutos en generarse. Durante este tiempo, puedes navegar desde el informe a otras páginas del panel. Recibirás una notificación en el salpicadero cuando tu informe esté listo.
