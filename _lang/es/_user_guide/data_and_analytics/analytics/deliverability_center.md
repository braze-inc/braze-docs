...
> El Centro de entregabilidad proporciona más información sobre el rendimiento del correo electrónico, ya que admite el uso de [Gmail Postmaster Tools][1] para realizar un seguimiento de los correos electrónicos enviados y recopilar datos sobre el dominio de envío.
...
5. Seleccione **Siguiente**. <br>![][9]
6. Una vez añadido el registro TXT a las DNS, vuelva al panel de Google Postmaster Tools y seleccione **Verificar**. Este paso confirma que eres el propietario del dominio, por lo que podrás acceder a las métricas de entregabilidad de Gmail en tu cuenta de Postmaster. <br> ![][10]
...
Antes de configurar el Centro de entregabilidad, comprueba que tus dominios se hayan [añadido a las Herramientas para postmasters de Gmail][4].
...
2. Seleccione la pestaña **Centro de entregabilidad**. <br>![][3]
...
| Tasa de reputación | Definición |
| ----- | ---------- |
| Alta | Tiene un buen historial de quejas por correo no deseado muy bajo. Cumple las directrices de envío de Gmail. Los correos electrónicos rara vez se filtran a la carpeta de spam. Tiene un buen historial con una tasa de correo no deseado muy baja. Cumple las [directrices de remitente de Gmail][2]. |
...
Para más ideas sobre cómo mejorar la capacidad de entrega, lee [Fallas de la capacidad de entrega y trampas de correo no deseado][6]. No olvide consultar nuestras [Prácticas recomendadas de correo electrónico][7] para conocer los aspectos que debe comprobar antes de enviar una campaña de correo electrónico.
...
Los accesos trampa de spam son el número de mensajes enviados a "cuentas trampa", que son cuentas mantenidas por Outlook.com que no solicitan ningún correo. Es probable que los mensajes enviados a estas cuentas trampa se consideren spam, por lo que es importante controlar esta métrica para asegurarse de que es baja, lo que significa que los mensajes no se envían a estas cuentas y, en su lugar, se envían a cuentas reales.
