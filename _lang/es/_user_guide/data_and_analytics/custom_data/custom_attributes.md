...
page_order: 10
page_type: reference
description: "Este artículo de referencia describe los atributos personalizados y explica los distintos tipos de datos de atributos personalizados."
search_rank: 1
---
...
> Los atributos personalizados son una colección de rasgos únicos de sus usuarios. Los atributos personalizados son los mejores para almacenar atributos sobre sus usuarios, o información sobre acciones de poco valor dentro de su aplicación. 

Cuando se almacenan en Braze, estas características pueden utilizarse para crear segmentos de audiencia y personalizar los mensajes mediante Liquid. Debe tener en cuenta que no almacenamos información de series temporales para los atributos personalizados, por lo que no podrá obtener ningún gráfico basado en ellos como puede hacer con los eventos personalizados.
...
Los atributos personalizados se pueden bloquear individualmente mediante el menú de acciones, o se pueden seleccionar hasta 10 atributos y bloquearlos en bloque. Si bloquea un atributo personalizado, no se recopilarán datos relativos a ese atributo, los datos existentes no estarán disponibles a menos que se reactiven y los atributos bloqueados no aparecerán en filtros ni gráficos. Además, si el atributo está siendo referenciado por filtros o activadores en otras áreas del cuadro de mandos de Braze, aparecerá un modal de advertencia explicando que todas las instancias de los filtros o activadores que lo referencian serán eliminadas y archivadas.
...
El informe de uso enumera todos los Canvases, campañas y segmentos que utilizan un atributo personalizado específico. Esta lista no incluye usos de Liquid. 

Puede ver hasta 10 informes de uso a la vez seleccionando las casillas de verificación situadas junto a los atributos personalizados respectivos y, a continuación, seleccionando **Ver informe de uso**.
...
- [Android y FireOS]({{site.baseurl}}/developer_guide/platform_integration_guides/android/analytics/setting_custom_attributes/)
...
- [Matrices](#arrays)
- [Tiempo](#time)
- [Objetos]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_attributes/nested_custom_attribute_support/)
- [Matrices de objetos]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_attributes/array_of_objects/)
...
Puede utilizar atributos personalizados anidados para enviar objetos como tipo de datos para atributos personalizados. Para más información, consulta [Atributos personalizados anidados]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_attributes/nested_custom_attribute_support/).

### Matrices de objetos

Utilice una matriz de objetos para agrupar atributos relacionados. Para más detalles, consulte nuestro artículo sobre [Array de objetos]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_attributes/array_of_objects/).
