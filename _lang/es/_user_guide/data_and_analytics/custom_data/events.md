...
> Conoce los diferentes eventos de Braze y su finalidad.

Braze aprovecha diferentes tipos de eventos para proporcionar un conocimiento exhaustivo del comportamiento de los usuarios y de su compromiso con la marca. Cada tipo de acto tiene una finalidad única:
...
Mediante el seguimiento de estos diferentes tipos de eventos, puede obtener un conocimiento más profundo de sus usuarios, lo que puede informar sus estrategias de marketing, ayudarle a optimizar su aplicación y permitirle proporcionar una experiencia de usuario más personalizada. Manos a la obra.
...
Para saber más, visite nuestro artículo dedicado a [los eventos de compra]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/purchase_events/).

{% details Ejemplo de aplicación %}

Tenga en cuenta que la implementación real de los eventos de compra requerirá algunos conocimientos técnicos, ya que implica la integración del SDK de Braze con su aplicación. Su gestor de éxito de clientes guiará a su equipo a través de este proceso como parte de su incorporación, pero los pasos generales son los siguientes:

1. **Integrar el SDK Braze:** Antes de registrar cualquier evento, tendrás que integrar el SDK de Braze en tu aplicación.
...
Para más información, visite nuestro artículo dedicado a [los eventos personalizados]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_events/).
...
1. **Integrar el SDK Braze:** Antes de poder registrar cualquier evento, tendrás que integrar el SDK de Braze en tu aplicación.
