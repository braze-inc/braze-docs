...
Póngase en contacto con su gestor de cuenta o abra un [ticket de asistencia]({{site.baseurl}}/braze_support/) si necesita acceder a derechos de eventos adicionales. Si no encuentra lo que necesita en este artículo, consulte nuestra [Biblioteca de eventos de comportamiento del cliente]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/customer_behavior_events/) o nuestros [ejemplos de datos de muestra Currents](https://github.com/Appboy/currents-examples/tree/master/sample-data).
...
## Eventos de lectura de WhatsApp

{% apitags %}
WhatsApp, Leer
{% endapitags %}

Este evento se produce cuando el usuario final lee un mensaje de WhatsApp.
...
## Eventos de entrega de WhatsApp

{% apitags %}
WhatsApp, Entrega
{% endapitags %}

Este evento se produce cuando un mensaje de WhatsApp enviado llega correctamente al dispositivo del usuario final.
...
## Eventos de envío de WhatsApp

{% apitags %}
WhatsApp, Envíos
{% endapitags %}

Este evento se produce cuando una solicitud de envío se ha comunicado correctamente entre Braze y WhatsApp. Sin embargo, esto no significa que el mensaje haya sido recibido por el usuario final.
...
## Eventos de mensajes anulados de WhatsApp

{% apitags %}
WhatsApp, Cancelar
{% endapitags %}

Este evento se produce si se ha abortado un mensaje de WhatsApp basado en Abortos líquidos, Horas de silencio, etc.
...
## Eventos recibidos de entrada de WhatsApp

{% apitags %}
WhatsApp, EntradaRecibida
{% endapitags %}
...
## Eventos de mensaje de cancelación de tarjeta de contenido

{% apitags %}
Abortar, Tarjetas de contenido
{% endapitags %}

Este evento ocurre si un mensaje de Tarjeta de Contenido fue abortado basado en Abortados Líquidos, Horas Silenciosas, etc.
...
## Eventos de mensajes de cancelación de correo electrónico

{% apitags %}
Abortar, Correo electrónico
{% endapitags %}

Este evento ocurre si un mensaje de correo electrónico fue abortado basado en Abortados Líquidos, Horas Silenciosas, etc.
...
## Eventos de cancelación de notificaciones push

{% apitags %}
Abortar, Empujar
{% endapitags %}

Este evento se produce si se ha abortado un mensaje de notificación push basado en Liquid aborts, Quiet Hours, etc.
...
## Eventos de mensajes anulados de SMS

{% apitags %}
Abortar, SMS
{% endapitags %}

Este evento ocurre si un mensaje SMS fue abortado basado en Abortos Líquidos, Horas Silenciosas, etc.
...
## Eventos de mensaje de cancelación de webhook

{% apitags %}
Abortar, Webhooks
{% endapitags %}

Este evento ocurre si un mensaje webhook fue abortado basado en Liquid aborts o Quiet Hours.
...
## Eventos de salida del lienzo realizados
...
## Eventos de audiencia coincidentes con la salida del lienzo
...
{% api %}
## Experimentar eventos de entrada dividida

{% apitags %}
Experimentar Paso, Lienzo
{% endapitags %}
...
## Experimentar eventos de conversión

{% apitags %}
Experimentar Paso, Lienzo
{% endapitags %}

Este evento se produce cuando un usuario convierte para un paso del experimento Canvas.
...
- Para `ad_id`, `ad_id_type`, y `ad_tracking_enabled`, necesitas recopilar explícitamente el IDFA de publicidad de iOS y el ID de publicidad de Google de Android a través de los SDK nativos. Más información sobre esta configuración para [iOS]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/analytics/swift_idfv/) y [Android]({{site.baseurl}}/developer_guide/platform_integration_guides/android/initial_sdk_setup/optional_gaid_collection/#optional-google-advertising-id).
- Si utilizas Kafka para la ingesta de datos [de Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/), ponte en contacto con tu administrador del éxito del cliente para habilitar el envío de `ad_id`.
...
## Notificaciones push en los eventos en primer plano de iOS
...
## Eventos de envío de correo electrónico

{% apitags %}
Correo electrónico, Envíos
{% endapitags %}

Este evento se produce cuando una solicitud de envío de correo electrónico se ha comunicado correctamente entre Braze y SendGrid. Aunque esto no significa que el correo electrónico se haya recibido en la bandeja de entrada del usuario final.
...
## Eventos de entrega por correo electrónico
...
## Eventos abiertos por correo electrónico
...
## Eventos de clics por correo electrónico
...
## Evento de rebote de correo electrónico
...
## Evento de rebote blando de correo electrónico
...
## Eventos de spam por correo electrónico
...
## Eventos de cancelar suscripción por correo electrónico
...
{% alert important %}
El evento `Unsubscribe` es en realidad un evento de clic especializado que se dispara cuando el usuario hace clic en el enlace de cancelación de suscripción del correo electrónico (ya sea un enlace de cancelación de suscripción normal dentro del cuerpo o pie de página del correo electrónico, o utilizando el [encabezado de cancelación de suscripción de la lista]({{site.baseurl}}/user_guide/administrative/app_settings/manage_app_group/email_settings#include-a-list-unsubscribe-header)), no cuando el usuario cambia el estado a cancelado. Si el cambio de estado de suscripción se envía a través de la API, o mediante un enlace personalizado (no de Braze) para darse de baja, no desencadenará un evento en Currents.
{% endalert %}
...
## Eventos de impresión de mensajes en la aplicación
...
{% alert note %}
El campo `message_extras` estará activo el 4 de abril de 2024.
{% endalert %}
...
Este evento se produce cuando un usuario hace clic en un mensaje in-app.
...
{% api %}
## Eventos de envío de tarjetas de contenido
...
{% api %}
## Eventos de clic de la tarjeta de contenido
...
{% api %}
## Eventos de descarte de tarjeta de contenido
...
## Envío de SMS a eventos del operador
...
## Eventos de rechazo de SMS

{% apitags %}
SMS, Rechazo
{% endapitags %}

Este evento se produce cuando un envío de SMS es rechazado por el operador, esto puede ocurrir por varias razones. Utilice este evento y los códigos de error proporcionados para ayudar a solucionar problemas con la entrega de SMS.
...
## Eventos de fallos en la entrega de SMS
...
## Eventos de impresión de las banderas de características

{% apitags %}
FeatureFlags, Impresión
{% endapitags %}
...
## Eventos de conversión de campaña
...
## Eventos de conversión de lienzos
...
## Eventos de entrada en el lienzo
...
{% apitags %}
CanvasStep, Progresión
{% endapitags %}

Este evento se produce cuando un usuario avanza por un paso en Canvas con algún resultado. Actualmente, sólo los pasos divididos -Rutas de audiencia, División de decisiones, Rutas de acción, Experimento- y los resultados Avanzar generan eventos de Progresión de pasos.
{% tabs %}
{% tab Mixpanel %}
```json
...
{% api %}
## Eventos de inscripción en el grupo de control de la campaña
...
## Eventos de cambio de estado global
