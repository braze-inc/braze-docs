...
Muchos de nuestros paquetes profesionales y empresariales ya incluyen un conector Currents. Si estás interesado en utilizar Currents, ponte en contacto con tu director de cuentas. Su gestor de cuenta y nuestros especialistas en datos pueden ayudarle a [configurar e integrar Currents]({{site.baseurl}}/user_guide/data/braze_currents/setting_up_currents/).
