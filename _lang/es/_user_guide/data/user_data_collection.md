---
nav_title: Recogida de datos de los usuarios
article_title: Recogida de datos de los usuarios
page_order: 3.5
layout: dev_guide
guide_top_header: "Recogida de datos de los usuarios"
...
page_type: landing
description: "En esta página encontrarás artículos sobre la recopilación de datos de usuario. Aquí encontrará recursos sobre definiciones de archivo, importación de usuarios, ciclo de vida del perfil de usuario, casos de uso, mejores prácticas y mucho más."
...
guide_featured_list:
  ...
  - name: Buenas prácticas de recopilación de datos
...
{% alert important %}
Braze prohibirá o bloqueará a los usuarios ("usuarios ficticios") con más de 5 millones de sesiones y dejará de ingerir sus eventos SDK porque suelen ser el resultado de una mala integración. Si descubre que esto le ha ocurrido a un usuario legítimo, póngase en contacto con su gestor de cuenta Braze.
{% endalert %}
