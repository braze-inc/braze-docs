...
||"Entregado" después de que el proveedor de SMS reciba la confirmación del operador de origen y del dispositivo de destino.|
||Recibido en el momento de la visualización en función de la acción de activación definida.|
...
|||
|-------|-------|
|| Los correos electrónicos AMP incluyen clics registrados tanto en versión HTML como en texto plano. Este número puede estar inflado artificialmente por las herramientas anti-spam.|
|||
...
|||
|-------|-----------------------|
|Tarjetas de contenido| Esto puede incrementarse varias veces para el mismo usuario.|
|Mensajes dentro de la aplicación| Aunque el usuario utilice varios dispositivos, sólo lo verá en el primer dispositivo al que se dirija. Esto supone que el perfil tiene dispositivos consolidados y que un usuario tiene un ID de usuario con el que ha iniciado sesión en todos los dispositivos. |
...
Dado que un espectador puede ser un destinatario único cada día, debes esperar que sea superior a <i>Impresiones únicas</i>. <br><br> 
