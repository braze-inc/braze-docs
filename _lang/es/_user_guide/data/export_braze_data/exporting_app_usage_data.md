...
![Período de tiempo y campos de aplicación en el panel de Inicio.][1]{: style="max-width:60%;"}
...
![Gráfico de rendimiento a lo largo del tiempo en el panel de inicio.][2]
...
- Impresiones de noticias por fecha
