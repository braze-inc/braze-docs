...
Si aún no lo has hecho, conecta un contenedor de almacenamiento en la nube a Braze. 
...
![La página Archivado de mensajes tiene tres canales para seleccionar: 
...
Cuando un mensaje se envía fuera de una campaña o Canvas, el ID de la campaña en el nombre del archivo será "no asociado". 
