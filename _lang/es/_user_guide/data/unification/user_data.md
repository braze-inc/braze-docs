...
guide_top_text: "Antes de completar tu implementación de Braze, asegúrate de mantener una conversación entre tu equipo de marketing y tu equipo de desarrollo sobre tus objetivos de marketing. Resulta útil tener en cuenta esos objetivos y trabajar hacia atrás a partir de ellos a la hora de decidir qué datos rastrear y cómo rastrear esos datos con Braze."

page_type: landing
description: "En esta página encontrarás artículos sobre la recopilación de datos de usuario. Aquí encontrarás recursos sobre definiciones de archivo, importación de usuarios, ciclo de vida del perfil de usuario, casos de uso, mejores prácticas y mucho más."
