...
Esta página muestra los pasos de sincronización y origen que actualmente están en acceso anticipado (EA). Para los pasos e imágenes de la experiencia de disponibilidad general, consulta [Experiencia de disponibilidad general](#experiencia-de-disponibilidad-general).
