...
{% api %}
## Eventos de cambio de token de notificaciones push de actividad en vivo
...
{% api %}
## Eventos de cambio de token de actualización de actividad en vivo
...
{% api %}
## Eventos de cambio de estado del token de notificaciones push
