...
> ¡Braze utiliza Corrientes! Así es, nos gusta nuestro propio producto lo suficiente como para utilizarlo junto con algunos de [nuestros socios]({{site.baseurl}}/user_guide/data/braze_currents/available_partners/).
