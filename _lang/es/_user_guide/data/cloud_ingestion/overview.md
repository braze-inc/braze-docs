...
Tu sincronización CDI podría tener datos duplicados si algún campo de `UPDATED_AT` está exactamente a la misma hora que tu hora de sincronización anterior.  
...
| Tamaño de la carga útil           | Cada fila puede contener una carga útil de hasta 1 MB.  |
