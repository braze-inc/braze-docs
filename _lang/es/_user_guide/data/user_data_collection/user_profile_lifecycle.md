...
### Actualización de alias de usuario
 ...
 El alias de usuario será entonces visible al exportar los datos de ese usuario.
...
## Caso de uso avanzado
 ...
 Sin embargo, los alias de usuario no pueden configurarse a través de la API para un perfil de usuario desconocido existente.
...
Todos los ID de usuario se pueden utilizar para encontrar e identificar usuarios dentro de su cuadro de mandos para realizar pruebas. 
