...
{% alert important %}
Las matrices, los tokens de notificaciones push y los tipos de datos de eventos personalizados no son compatibles con la importación de usuarios.
...
Los tiempos de ejecución estimados para un archivo con 1.000.000 de filas deberían rondar los cinco minutos. Consulte [Importación de atributos de usuario CSV a Braze]({{site.baseurl}}/user_guide/data/cloud_ingestion/) para obtener más información.
...
![Un grupo de filtros con el filtro "Actualizado/Importado de CSV" que incluye un archivo CSV titulado "Diversión en la temporada de Halloween".][5]
...
-  Si hay columnas ID externas duplicadas, esto puede provocar filas mal formadas o no importadas, aunque las filas estén formateadas correctamente.  Compruebe si hay ID externos duplicados en su CSV. Si es así, elimine los duplicados e intente cargarlos de nuevo.
