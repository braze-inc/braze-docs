...
Después de crear un [catálogo]({{site.baseurl}}/user_guide/data/activation/catalogs/), puede seguir haciendo referencia a los datos de su catálogo incorporando selecciones en sus campañas o recomendaciones Braze.
...
![Ajustes de filtro para la selección de catálogos en los que el atributo se establece en un atributo personalizado de Liquid.]({% image_buster /assets/img_archive/catalog_selections7.png %})
...
![Una tarjeta de contenido con una imagen de stroganoff de ternera y una lista de dos recomendaciones de comidas que incluyen ternera, basada en la última categoría consultada por el usuario.]({% image_buster /assets/img_archive/catalog_selections5.png %}){: style="max-width:90%;"}
