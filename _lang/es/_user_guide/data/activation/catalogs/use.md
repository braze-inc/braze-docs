...
{% alert tip %}
Echa un vistazo a [las selecciones]({{site.baseurl}}/user_guide/data/activation/catalogs/selections/) para crear grupos de datos y recibir mensajes más personalizados.
{% endalert %}
...
![Compositor de tarjetas de contenido con la etiqueta Liquid del catálogo utilizada en el campo de imagen.]({% image_buster /assets/img_archive/catalog_image_link1.png %})
