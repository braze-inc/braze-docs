...
![El modal Añadir Personalización con Extras de Mensaje seleccionado como tipo de personalización.]({% image_buster /assets/img_archive/message_extras1.png %}){: style="max-width:35%;"}
