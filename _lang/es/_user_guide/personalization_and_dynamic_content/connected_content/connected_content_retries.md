...
> Dado que Connected Content depende de la recepción de datos de las API, existe la posibilidad de que una API no esté disponible de forma intermitente mientras Braze realiza la llamada. En este caso, Braze admite la lógica de reintento para reintentar la solicitud utilizando un backoff exponencial. 
