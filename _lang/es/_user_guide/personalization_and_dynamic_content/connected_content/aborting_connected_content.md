...
> Utilizando la plantilla Liquid, tienes la opción de abortar mensajes con lógica condicional. 
...
{% alert important %}
Braze no cuenta los mensajes abortados en el recuento de envíos de su cuenta Braze o en Currents.
{% endalert %}
