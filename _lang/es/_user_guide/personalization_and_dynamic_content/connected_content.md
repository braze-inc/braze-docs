...
guide_top_text: "Braze Connected Content amplía la personalización del marketing para impulsar el compromiso de los clientes y las conversiones. Esta función le permite insertar cualquier información accesible a través de la API directamente en los mensajes que envíe a los usuarios. Connected Content permite extraer contenidos directamente de su servidor web o de API de acceso público. También puede utilizar nuestras funciones de contenido conectado con nuestros socios tecnológicos, como <b><a href='/docs/partners/data_augmentation/contextual_location/accuweather/'>AccuWeather</a></b> y <b><a href='/docs/partners/channel_extensions/localization/transifex/'>Transifex</a></b>.<br><br>Además de los artículos enumerados a continuación, recomendamos consultar nuestros <b><a href='https://learning.braze.com/connected-content'>Contenido conectado</a></b> Curso Braze Learning."
description: "En esta página encontrarás todo lo relacionado con Connected Content. Aquí puedes encontrar artículos sobre cómo realizar llamadas a la API, variables locales de Contenido conectado, anular contenido y mucho más."
