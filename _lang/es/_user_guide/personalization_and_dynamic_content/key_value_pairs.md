...
Los casos de uso de los pares clave-valor personalizados incluyen, entre otros, el mantenimiento de métricas internas y la configuración del contexto de la interfaz de usuario.  Si prefieres utilizar otra clave, confirma que tu aplicación puede manejar esta clave personalizada.
...
Las notificaciones push de Android pueden personalizarse aún más con las opciones de mensajes de FCM.  Estos valores pueden especificarse en la pestaña **Configuración** al crear un mensaje push. 
...
Los profesionales del marketing deben comprobar que las notificaciones push silenciosas desencadenan el comportamiento esperado antes de enviarlas a los usuarios de su aplicación. 
...
Tanto SparkPost como SendGrid admiten pares clave-valor en los correos electrónicos.  SendGrid permite adjuntar un número ilimitado de pares clave-valor de hasta 10.000 bytes de datos. 
