...
## Novo editor de arrastar & soltar para mensagens no app

Com o novo [editor de arrastar & soltar para mensagens no app]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop), você pode criar mensagens totalmente personalizadas e customizadas sem precisar saber HTML. O editor de arrastar & soltar está sendo implementado para todos os clientes nos próximos meses. Se quiser solicitar acesso mais cedo, entre em contato com seu gerente de sucesso do cliente.

## Atualizações no editor de arrastar & soltar para e-mail

### Novos blocos do editor

Dois novos blocos de editor foram adicionados ao editor de arrastar & soltar para e-mail: [Blocos de parágrafos]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/dnd_editor_blocks/#paragraph) e [blocos de listas]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/dnd_editor_blocks/#list).
...
Esse recurso está atualmente em acesso antecipado. Se você estiver interessado em participar do acesso antecipado, entre em contato com seu gerente de sucesso do cliente.
