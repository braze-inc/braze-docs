...
## Atributos HTML para links no editor de Arrastar & Soltar para e-mail
Agora você pode [adicionar atributos de HTML]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/overview/#creative-details/) a qualquer URL nos blocos de editor `Image`, `Button` ou `Text` no editor de Arrastar & Soltar para e-mail. Com os atributos personalizados, você pode facilmente anexar informações adicionais às tags HTML nos e-mails. Isso pode ser especialmente útil para personalização, segmentação e estilização de mensagens. 
...
## Novo bloco de vídeo
Um novo bloco de conteúdo para [vídeo]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/dnd_editor_blocks/#video) foi adicionado ao editor de Arrastar & Soltar para e-mail.
...
Para saber mais, entre em contato com o gerente de sucesso do cliente.
...
A integração entre [ThoughtSpot]({{site.baseurl}}/partners/data_and_analytics/business_intelligence/thoughtspot/) e o Braze aproveita os blocos TML da ThoughtSpot, que permitem que os usuários da empresa acelerem a análise de dados de comportamento do usuário com modelos pré-construídos de planilhas e modelos. Essa integração ativa a capacidade de os usuários pesquisarem ilimitadamente os dados de interação do Braze e descobrirem insights práticos. 
