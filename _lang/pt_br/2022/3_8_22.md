...
A integração Braze e [Grouparoo]({{site.baseurl}}/help/release_notes/deprecations/grouparoo) sincroniza dados do armazém com o Braze. Os horários de sincronização automática mantêm as comunicações com os clientes atualizadas com informações recentes.
