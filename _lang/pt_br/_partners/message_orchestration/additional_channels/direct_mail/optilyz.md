...
Para integrar com a optilyz, use a [API da optilyz][2] para enviar dados do destinatário para o webhook da Braze.
...
![Os cabeçalhos de solicitação e o método HTTP mostrados no construtor de webhooks do Braze.][6]{: style="max-width:50%"}

#### Corpo da solicitação

No corpo da solicitação a seguir, você pode usar qualquer tag de personalização Liquid e criar um modelo de solicitação personalizado de acordo com a [documentação da API][2] da optilyz.
...
![Uma imagem do código do corpo da solicitação e da URL do webhook mostrada na guia de composição do criador de webhooks do Braze.][5]
...
![Diferentes campos de teste disponíveis na guia de teste do construtor de webhooks do Braze.][7]
