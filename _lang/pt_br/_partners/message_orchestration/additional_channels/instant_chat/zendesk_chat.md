...
![Um exemplo de SMS sem formatação.][2]{: style="max-width:40%;"}
...
![Um exemplo de SMS com formatação.][3]{: style="max-width:70%;"}
...
![Entrega disparada por API][4]{: style="max-width:70%;"}

Por fim, em **Controles de entrega**, ative a reelegibilidade.

![Reelegibilidade ativada em "Controles de entrega".][5]
...
![Responda via SMS Braze.][6]{: style="max-width:70%;"}
...
![Responda via corpo JSON do SMS Braze.][7]{: style="max-width:70%;"}
...
![Criação de tickets resolvidos no Zendesk.][9]{: style="max-width:70%;"}
...
![Corpo JSON do ticket resolvido.][10]{: style="max-width:70%;"}
...
![Um exemplo de categoria de palavra-chave SMS no Braze.][11]{: style="max-width:70%;"}
...
![Um exemplo de solicitação com os dois cabeçalhos necessários.][12]{: style="max-width:70%;"}
...
![A página "Schedule Delivery" (Agendar entrega) da primeira campanha de webhook.][13]

Em **Controles de entrega**, ative a reelegibilidade.

![Reelegibilidade selecionada em "Controles de entrega" para a primeira campanha de webhook.][14]
