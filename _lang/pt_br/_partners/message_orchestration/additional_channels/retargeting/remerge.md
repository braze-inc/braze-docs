...
- Defina o nome do evento. Este nome aparecerá no seu dashboard da [remerge.io][65].
...
![O URL do webhook e a prévia da mensagem mostrados no construtor de webhook da Braze.][67]
...
![Os cabeçalhos da solicitação, o método HTTP e a prévia da mensagem mostrados no construtor de webhook da Braze.][68]
