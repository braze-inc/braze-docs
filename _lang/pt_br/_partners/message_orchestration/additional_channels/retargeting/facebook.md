...
{: start="2"}
2\. No módulo "Exportar público do Facebook", clique em **Conectar ao Facebook**. <br><br>![Página de parceiros de tecnologia do Facebook na plataforma Braze.][6]{: style="max-width:70%;"}
...
1. Na página **Segments (Segmentos** ), clique na engrenagem ao lado do segmento que você deseja exportar.
2. Clique em **Export as Facebook Audience (Exportar como público do Facebook**). <br><br>![Uma lista de segmentos de Braze. Para o primeiro segmento, o símbolo de configuração é selecionado, e o botão "Exportar como público do Facebook" é exibido.][11]

{: start="3"}
3\. Se ainda não tiver ativado o Facebook na Braze, você verá uma indicação para acessar a página de parceiros de tecnologia do Facebook no dashboard. Se já tiver ativado o Facebook por meio de **Technology Partners** > **Facebook**, poderá selecionar o campo de usuário a ser exportado, e será exibido um menu suspenso para selecionar sua conta de anúncios do Facebook. <br><br> Há três campos de usuário possíveis que podem ser exportados:  
- E-mail
- IDFA do dispositivo
- Número de telefone
...
{: start="4"}
4\. Depois de selecionar o campo do usuário, clique em **Exportar**. Assim como as exportações CSV, você receberá um e-mail quando o segmento terminar de ser exportado para o Facebook.
