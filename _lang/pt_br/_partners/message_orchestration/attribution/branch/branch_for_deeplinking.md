...
A integração entre a Braze e a Branch permite oferecer melhores experiências aos seus clientes, pois você pode [atribuir]({{site.baseurl}}/partners/message_orchestration/attribution/branch/branch_for_attribution/) adequadamente o início da jornada do usuário e conectá-los por deep linking ao local pretendido.
