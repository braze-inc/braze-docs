...
A integração entre a Branch e a Braze ajudam a entender exatamente quando e onde aconteceu a aquisição de um usuário e a personalizar a jornada de cada um por meio de atribuição e [deeplinking]({{site.baseurl}}/partners/message_orchestration/attribution/branch/branch_for_deeplinking/).
