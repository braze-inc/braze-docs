...
| Requisito | Descrição |
|---|---|
| Conta Vizbee | É necessário ter uma conta [Vizbee][1] para aproveitar essa parceria. É necessário registrar seu app na Vizbee e ter um ID da Vizbee atribuída. |
...
Siga as instruções do [Guia de integração SDKs][2] da Vizbee para configurar sua integração com a Braze. Aqui você pode encontrar orientações sobre deep linking do celular para a TV, instalações de apps de TV e atribuição de visualizações. 
