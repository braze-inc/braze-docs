...
description: "Este artigo de referência descreve a parceria entre o Braze e a Antavo, um programa de fidelidade de última geração que vai além de recompensar compras."
...
| Chave da API REST do Braze   | Uma chave da API REST da Braze com permissões `users.track`.<br><br>Para criar uma nova chave de API no dashboard do Braze, vá para **Configurações** > **Chaves de API** e clique em **Criar nova chave de API**.  |
...
![Conecte a tela da Braze na Antavo com o URL da instância, o token da API e o identificador do app.][1]
...
![Página de campos de sincronização na Antavo.][2]
...
![Perfil do Braze mostrando diferentes atributos personalizados.][3]
...
Use eventos sincronizados do Antavo para inserir membros de fidelidade em telas Braze baseadas em ações. A integração pode sincronizar qualquer evento do Antavo (incluindo eventos de compra) que aparecem no Braze como eventos personalizados.
