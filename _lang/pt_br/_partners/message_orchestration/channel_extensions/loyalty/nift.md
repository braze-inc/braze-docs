...
Visite seu [Nift dashboard][2], navegue até **Contas** > **Integrações** > **Braze**, e clique em **Conectar**.
...
![Página de integração do serviço Nift solicitando a chave de API da Braze e o URL do dashboard da Braze.][5]
