...
> [O Kognitiv Inspire][1] é um sistema de tecnologia de fidelidade que ajuda a desbloquear experiências inigualáveis do cliente por meio de programas de fidelidade orientados por resultados que ampliam o engajamento do cliente, aumentam os gastos e celebram o comportamento leal.
...
| Requisito | Descrição |
|---|---|
| Conta Kognitiv | É necessário ter uma conta [Kognitiv][1] para aproveitar essa parceria. |
