...
|-----------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| Uma conta Friendbuy   | Uma [conta Friendbuy][1] é necessária para aproveitar esta parceria.                                                              |
...
Na [Friendbuy][1], acesse **Developer Center** (Centro de desenvolvimento) > **Integrations** (Integrações) e, no cartão de integração da Braze, selecione **Add integration** (Adicionar integração).

![O cartão de integração Braze no Friendbuy.][100]{: style="max-width:75%;"}

No formulário, insira seu endpoint REST e chave de API e selecione **Install Integration** (Instalar integração).

![O formulário de integração do Friendbuy.][101]{: style="max-width:55%;"}

Volte à sua [conta da Friendbuy][1] e atualize a página. Se a sua integração foi bem-sucedida, você verá uma mensagem como esta:

![integração instalada][102]{: style="max-width:55%;"}
