...
> [O Yotpo](https://www.yotpo.com/), a principal plataforma de marketing de comércio eletrônico, ajuda milhares de marcas com visão de futuro a acelerar o crescimento direto ao consumidor. A abordagem de plataforma única do Yotpo integra soluções baseadas em dados para avaliações, fidelidade, marketing por SMS e muito mais, capacitando as marcas a criar experiências mais inteligentes e de maior conversão para os clientes.
