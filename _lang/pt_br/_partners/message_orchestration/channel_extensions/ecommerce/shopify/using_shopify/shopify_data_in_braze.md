...
**Tipo**: [Evento personalizado]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_events/)
...
**Evento**: Compra<br>
**Tipo**: [Evento de compra da Braze]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/purchase_events/)
...
Você pode filtrar os eventos do Shopify com todos os [filtros personalizados existentes]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_events/) na Segmentação. 

![Página de detalhes do segmento para um segmento Shopify_Test com o filtro para o evento personalizado "shopify_checkouts_abandon" destacado.][12]{: style="max-width:80%;"}

Além disso, você também pode usar o filtro de amplitude de compra do Braze para criar segmentos de usuários com base em:
...
![Filtro de segmentação para usuários que fizeram uma compra pela primeira vez após 17 de outubro de 2020.][13]

![Pesquisa de um ID de produto específico como um filtro de segmentação.][14]
...
![Canva baseada em ação que entra nos usuários que realizam o evento personalizado "shopify_checkouts_abandon".][5]

Com o suporte a objetos aninhados para propriedades de eventos personalizados, os clientes agora podem disparar campanhas e Canvas usando uma propriedade de evento aninhada. A seguir, um exemplo de como disparar uma campanha usando um produto específico do evento personalizado `shopify_created_order`. Use `list_items[].product_id` para indexar sua lista de itens e acessar o ID do produto.

![Campanha baseada em ação que envia aos usuários que realizam o evento personalizado "shopify_created_order" em que a propriedade aninhada "product_id" é igual a um número específico.][26]
