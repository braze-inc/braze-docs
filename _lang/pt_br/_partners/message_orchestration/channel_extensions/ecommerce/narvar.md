...
Para cada evento de notificação, o Narvar inicia uma solicitação ao endpoint do Braze [`/messaging/send`]({{site.baseurl}}/api/endpoints/messaging) para entregar uma mensagem push a cada consumidor com aceitação.
