...
![A galeria de modelos do IAM Studio mostra modelos diferentes, como "modal de slide de carrossel", "modal de ícone simples", "modal de imagem completa" e muito mais.][1]
...
{% tabs local %}
{% tab Fontes %}
![A interface de usuário do IAM Studio mostra as opções para adicionar Liquid. Essas opções incluem a criação de uma presença personalizada.]({% image_buster /assets/img/iam_studio/iam_custom_font.png %})
{% endtab %}
{% tab Liquid %}
