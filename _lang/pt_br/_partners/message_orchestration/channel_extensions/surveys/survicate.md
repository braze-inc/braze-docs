...
![Um exemplo da aparência de uma pesquisa HTML incorporada (primeira pergunta) em um e-mail do Braze.][2]{: style="float:right;max-width:40%;border:0; margin-left:8px;"}
...
![Quatro opções para criar uma pesquisa: começar do zero, usar um modelo, criação assistida por IA e importar perguntas.][4]
...
![A Braze é selecionada como respondente.][5]
...
![Campos para inserir a chave de API do espaço de trabalho e a URL da instância do Braze.][3]
