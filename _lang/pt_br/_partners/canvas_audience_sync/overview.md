...
| [Pinterest]({{site.baseurl}}/partners/canvas_audience_sync/pinterest_audience_sync/) | Entre 24 e 48 horas | O Pinterest processa 7 consultas por segundo e 1,9K usuários por solicitação. O Braze agrupa usuários a cada 5 segundos. | Sim | Os públicos do Pinterest exigem pelo menos 100 usuários. |
