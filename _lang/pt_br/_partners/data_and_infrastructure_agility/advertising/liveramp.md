...
Para obter um passo a passo completo, consulte o [guia de integração do Snowflake com a Braze]({{site.baseurl}}/partners/data_and_infrastructure_agility/data_warehouses/snowflake/).
...
Os registros de eventos do Braze contêm identificadores que podem ser usados no app nativo do LiveRamp. Para obter uma lista completa dos identificadores disponíveis para cada tipo de evento, baixe o [Braze Event Schemas and Identifiers (Esquemas e identificadores de eventos do Braze](https://www.braze.com/docs/assets/download_file/data-sharing-raw-table-schemas.txt)).
