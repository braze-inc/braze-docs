...
A integração bidirecional entre o Braze e o Amplitude permite [sincronizar suas coortes]({{site.baseurl}}/partners/data_and_infrastructure_agility/analytics/amplitude/amplitude_audiences/), características de usuários e eventos do Amplitude no Braze, bem como aproveitar o Braze Currents para exportar seus eventos do Braze para o Amplitude a fim de realizar análises mais profundas dos dados de seu produto e marketing.
...
Entre em contato com o gerente da sua conta ou abra um [ticket de suporte][support] se precisar de acesso a direitos de eventos adicionais.
