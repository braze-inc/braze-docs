...
> Este artigo descreve como enviar automaticamente eventos de engajamento da Braze para o Heap para análise. Para saber mais sobre a integração do Heap e suas outras funcionalidades, como [a sincronização de coortes do Heap]({{site.baseurl}}/partners/data_and_infrastructure_agility/cohort_import/heap/#data-import-integration) com a Braze, consulte o [artigo principal sobre o Heap]({{site.baseurl}}/partners/data_and_infrastructure_agility/cohort_import/heap/).
