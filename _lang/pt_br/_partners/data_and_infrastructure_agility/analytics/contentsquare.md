...
{% alert note %}
Se estiver usando a [navegação mais antiga]({{site.baseurl}}/navigation), poderá encontrar essa página em **Manage Settings** > **Custom Events** (Gerenciar configurações > Eventos personalizados).
{% endalert %}

![Dados do Contentsquare Live Signals na guia de eventos personalizados da Braze][1]
