...
> Este artigo descreve como fazer a importação de coortes de usuários da AppsFlyer para o Braze usando a integração de [públicos da AppsFlyer][2]. Para saber mais sobre a integração da AppsFlyer e suas outras funcionalidades, como a atribuição móvel, consulte o [artigo principal da AppsFlyer][3].
...
![A página de configuração da conexão do parceiro da plataforma AppsFlyer para o público. A parte inferior das imagens mostra que a caixa do ID externo da Braze está marcada.][6]{: style="max-width:80%;"}
...
![Filtro de atribuições do usuário "Coortes da AppsFlyer" selecionado.][7]
