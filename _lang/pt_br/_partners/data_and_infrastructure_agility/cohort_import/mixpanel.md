...
> Este artigo descreve como fazer a importação de coortes de usuários do [Mixpanel](https://mixpanel.com/) para o Braze. Para saber mais sobre a integração do Mixpanel e suas outras funcionalidades, consulte o [artigo principal do Mixpanel]({{site.baseurl}}/partners/data_and_infrastructure_agility/analytics/mixpanel_for_currents/).
