...
> Este artigo descreve como fazer a importação de coortes de usuários do [Kubit](https://kubit.ai/) para o Braze. Para saber mais sobre a integração do Kubit e suas outras funcionalidades, consulte o [artigo principal do Kubit]({{site.baseurl}}/partners/data_and_infrastructure_agility/analytics/kubit/).
