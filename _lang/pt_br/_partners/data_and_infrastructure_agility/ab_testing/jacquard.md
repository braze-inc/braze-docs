...
> [A Jacquard][1] reúne inteligência artificial, linguística computacional e um espírito de centralização no cliente para ajudar a implementar a linguagem da marca, em escala, em canais personalizados de acordo com a voz da sua marca.
...
| Requisito | Descrição |
|---|---|
| Conta Jacquard | É necessário ter uma [conta Jacquard][1] para aproveitar essa parceria. |
