...
![Sincronização do segmento Optimizely Braze.][2]
...
![Campos de mapas de segmentos Optimizely e Braze.][3]
...
![Salvar mapas de campo do segmento do Braze de forma otimizada][4]
...
![Mapas de campo de exclusão de segmento de Braze de forma otimizada][5]
...
4. Na seção **Inscrição**, é possível sincronizar dados de clientes que correspondem a um segmento ou sincronizar dados de clientes que disparam um evento (como quando o ODP registra que um cliente abre um e-mail):
   - **Clientes que correspondem a um segmento:** Selecione o segmento desejado e, em seguida, selecione **Next**.<br><br>![Segmento de seleção da Optimizely][6]
   - **Clientes que disparam um evento:** Expanda a lista suspensa **Filter (Filtro** ) e selecione o evento ODP a ser usado como disparador para essa sincronização de dados com o Braze. Em seguida, expanda **Automation Rules** e ajuste conforme desejado. <br><br>![Evento de gatilho da Optimizely][7]
