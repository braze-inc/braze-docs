...
> [O Zapier][1] é uma ferramenta da Web de automação que permite compartilhar dados entre apps da Web e, em seguida, usar essas informações para automatizar ações. 

A parceria entre a Braze e a Zapier usa a API e os [webhooks][3] da Braze para se conectar a aplicativos de terceiros, como Google Workplace, Slack, Salesforce, WordPress etc., para automatizar várias ações.
...
| endpoint REST do Braze | Sua URL de endpoint REST. Seu endpoint dependerá da [URL do Braze para sua instância][0]. |
