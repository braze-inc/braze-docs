...
> [O Hightouch][1] é uma plataforma moderna de integração de dados que o capacita a sincronizar dados de clientes, produtos ou proprietários de seu data warehouse ou data lake com qualquer app de sua escolha, tudo sem a assistência das equipes de TI ou de engenharia.
...
Essa integração também permite a [importação de coortes de usuários para o Braze]({{site.baseurl}}/partners/data_and_infrastructure_agility/cohort_import/hightouch/), enviando campanhas direcionadas com base em dados que podem existir apenas em seu data warehouse.
...
| Ponto de extremidade REST do Braze  | Sua URL de endpoint REST. Seu endpoint dependerá do [URL do Braze para sua instância][2].<br><br>O Hightouch requer o nome do cluster em que sua instância do Braze está localizada. Por exemplo, se seu endpoint da Braze for `https://rest.iad-01.braze.com`, você só precisará de `iad-01`.|
...
3. Forneça seu endpoint REST da Braze (excluindo "https://rest.") e sua chave da API REST da Braze.<br><br>![][3]
...
Daqui a [4]: https://hightouch.io/docs/destinations/braze/
