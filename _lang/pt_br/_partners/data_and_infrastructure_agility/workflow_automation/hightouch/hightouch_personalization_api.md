...
A API de Personalização da Hightouch fornece um endpoint REST para usar na sua configuração do Braze.  Os dados expostos pela API podem representar dados de clientes, produtos ou qualquer outro objeto. 
