...
{% alert note %}
Os limites de frequência variam de acordo com o fluxo. Acesse a [tabela de limites de frequência](https://www.braze.com/docs/api/api_limits/#rate-limits-by-request-type) para saber mais.
{% endalert %}
