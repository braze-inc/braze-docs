...
| Ponto de extremidade REST do Braze | Você precisa saber qual é o [URL do endpoint REST][1]. Seu endpoint de API corresponde ao URL do dashboard de sua instância do Braze. <br><br> Por exemplo, se o URL do dashboard for `https://dashboard-03.braze.com`, seu endpoint será `dashboard-03`. |
