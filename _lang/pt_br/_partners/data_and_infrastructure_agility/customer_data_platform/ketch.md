...
4. Adicione a chave de API da Braze e forneça o endpoint da API. Note que o [endpoint da API](https://www.braze.com/docs/api/basics/#endpoints) é baseado em qual instância da Braze sua organização usa.
...
![ID do grupo de inscrições da Braze.][1]
