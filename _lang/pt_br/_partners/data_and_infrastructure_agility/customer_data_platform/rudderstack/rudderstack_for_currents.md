...
O Braze suporta a exportação de todos os dados listados nos [glossários de eventos Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents) para o RudderStack.
