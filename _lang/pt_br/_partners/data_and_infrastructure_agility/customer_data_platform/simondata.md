...
> [A Simon Data][1] é uma plataforma de dados do cliente (CDP) amigável aos profissionais de marketing e confiável para as equipes de dados. Ao transformar seu data warehouse em uma potência de marketing, a Simon gera resultados de negócios e uma experiência superior para o cliente.
...
![Tela de integração no Simon Data][8]{: style="max-width:70%"}

### Adicionar ações do Braze a fluxos ou jornadas no Simon

Depois de autenticar sua conta Braze na Simon, você poderá adicionar ações da Braze a [fluxos][4] e [jornadas][5].
...
![Menu suspenso mostrando a lista de ações Braze disponíveis na Simon Data.][9]{: style="max-width:60%"}
...
![Seleção de características de sincronização em Simon Data.][10]
