...
Arraste as atribuições do Redpoint CDP para a coluna **Attribute (Atributo** ). Defina cada **valor de linha do cabeçalho** como o Braze [atribuição do usuário][17]] correspondente. 
...
![Um modelo de exportação de amostra com `external_id` e os atributos do nome de saída.][8]{: style="max-width:75%;"}
...
![A guia de opções mostra o formato de data definido como aaaa-MM-dd.][16]{: style="max-width:75%;"}
