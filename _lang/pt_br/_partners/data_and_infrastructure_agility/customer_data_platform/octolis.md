...
> A [Octolis][0] é uma poderosa plataforma de ativação de dados (ou plataforma de dados do cliente headless). Sobreposto a um banco de dados de sua propriedade, o Octolis é uma maneira fácil de unificar, preparar, pontuar e sincronizar dados em suas ferramentas de negócios.
...
Para obter mais informações, consulte a seção [Como começar][4] da Octolis.

### Etapa 1: Conecte o Octolis às suas fontes de dados

Para enviar dados para a Braze, confirme se você criou pelo menos um [público][5]. Um público combina várias fontes de dados, aplica-as às etapas de preparação e adiciona campos computados.
...
| Campo | Descrição |
| --- | --- |
| Para onde você deseja sincronizar o público? |  |
