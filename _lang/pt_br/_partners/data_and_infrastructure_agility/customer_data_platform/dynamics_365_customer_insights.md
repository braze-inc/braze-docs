...
2.  Se esse nome de seção não aparecer, isso significa que não há conexões desse tipo disponíveis para você.
3. 
4. Na seção **Data matching**, no campo **e-mail**, selecione o campo que representa o endereço de e-mail de um cliente.  
  a. 
  b. 
5.  
...
### Usando esta integração
  ...
  Por exemplo, `"Segment_API_Identifier": "0000-0000-0000"`

  Depois que o segmento é criado, você pode selecioná-lo como um filtro de público ao criar uma campanha ou canva.
