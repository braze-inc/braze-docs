...
A integração entre a Braze e o mParticle permite que você controle com praticidade o fluxo de informações entre os dois sistemas. Com [Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/), você também pode conectar dados ao mParticle para torná-los acionáveis em todo o growth stack. 
...
![A primeira caixa de diálogo de integração, solicitando que você forneça um nome de configuração, determine um status de feed e selecione uma plataforma act-as.][2]{: style="max-width:40%;"}  ![A segunda caixa de diálogo de integração mostra a chave de servidor para servidor e o segredo de servidor para servidor.][3]{: style="max-width:37%;"}
