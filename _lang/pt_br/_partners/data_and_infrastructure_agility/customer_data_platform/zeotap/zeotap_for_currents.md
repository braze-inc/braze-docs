...
| Currents | Para exportar dados de volta para Zeotap, você precisa ter o [Braze Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/) configurado para sua conta. |
...
2. Selecione **Create New Current (Criar New Current)** e **Custom Currents Export (Exportar Currents Export)**.<br><br>![O botão "Criar Novo Corrente" com um menu suspenso que contém "Exportação de Correntes Personalizadas".][3]{: style="max-width:60%;"}<br><br>
