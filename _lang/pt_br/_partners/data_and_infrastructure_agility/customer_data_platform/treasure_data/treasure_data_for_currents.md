...
> [O Treasure Data][1] é uma plataforma de dados do cliente (CDP) que coleta e encaminha informações de várias fontes para uma variedade de outros locais em sua pilha de marketing.
...
| Requisito | Descrição |
| ----------- | ----------- |
| Treasure Data | É necessário ter uma [conta do Treasure Data][0] para usar a parceria. |
| Currents | Para exportar dados de volta para o Treasure Data, você precisa ter o [Braze Currents][2] configurado em sua conta. |
...
O Braze oferece suporte à exportação de todos os dados listados nos [glossários de eventos Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents) (incluindo todas as propriedades nos eventos de [engajamento com mensagens]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/message_engagement_events/) e de [comportamento do cliente]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/customer_behavior_events/)) para o Treasure Data.
