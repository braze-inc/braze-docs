...
{% alert important %}
O Tealium AudienceStreams e o EventStream oferecem ações de conector com e sem lote.  Entre em contato com [suporte]({{site.baseurl}}/braze_support/) da Braze ou com seu gerente de sucesso do cliente se tiver alguma dúvida.
{% endalert %}
...
| [Endpoint REST da Braze][6] | Seu URL do ponto de extremidade REST. Seu endpoint dependerá da [URL do Braze para sua instância]({{site.baseurl}}/api/basics/#endpoints). |
...
Visite o [Tealium][1] para obter uma lista completa dos tipos de dados disponíveis.
