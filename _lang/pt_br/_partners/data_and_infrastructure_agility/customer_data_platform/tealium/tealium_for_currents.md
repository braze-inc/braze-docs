...
A Braze oferece suporte à exportação de todos os dados listados nos [glossários de eventos do Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents) (incluindo todas as propriedades dos eventos de [engajamento com mensagem]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/message_engagement_events/) e de [comportamento do cliente]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/customer_behavior_events/)) para a Tealium.
