...
![Mapeamentos de destino: IdentityMap:IDFA mapeado para IdentityMap:external_id, IdentityMap:GAID mapeados para IdentityMap:external_id, IdentityMap:Email mapeado para IdentityMap:external_id, xdm:mobilePhone.number mapeados para CustomAttribute:PhoneNumber, xdm:person.name.lastName mapeado para CustomAtrribute:LastName, xdm:person.name.firstName mapeado para CustomAttribute:FirstName][12]
