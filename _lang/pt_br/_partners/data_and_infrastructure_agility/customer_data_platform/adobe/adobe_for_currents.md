...
A integração Braze e Adobe permite que você controle de forma contínua o fluxo de informações entre os dois sistemas. Com [Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/), você também pode conectar dados ao Adobe para torná-los acionáveis em toda a growth stack. 
...
3. Fazer upload do [Braze Currents sample file](https://github.com/Appboy/currents-examples/blob/master/sample-data/Adobe/adobe_examples.json).<br><br>![Adobe "Adicionar página de dados".][2]<br><br>
...
5. Configure o mapeamento para seus dados e resolva os problemas.
    ...
    - Selecione **Campo de destino do mapa** ao lado do novo campo de origem e mapeie-o para **timestamp** no nível raiz do esquema. <br><br>![Página "Adicionar dados" da Adobe com mapeamentos.][3]<br><br>
...
{: start="7"}
7\. Selecione **Próximo**, revise os detalhes do seu fluxo de dados e, em seguida, selecione **Concluir**.<br><br>![Página "Adicionar dados" da Adobe sem erros de mapeamento.][4]
