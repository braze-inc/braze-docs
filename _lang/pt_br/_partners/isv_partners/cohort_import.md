...
Para obter mais informações sobre a solução de problemas, consulte [Erros & Responses]({{site.baseurl}}/api/errors/), que aborda os vários erros e respostas do servidor que podem surgir ao usar a API do Braze.
