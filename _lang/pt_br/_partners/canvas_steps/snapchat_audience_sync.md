...
![Página de tecnologia do Snapchat no Braze que inclui uma seção de Visão geral e uma seção de sincronização do público do Snapchat com o botão Snapchat conectado.][1]{: style="max-width:80%;"}
...
![Uma lista de contas de anúncios disponíveis que você pode conectar ao Snapchat.][2]{: style="max-width:80%;"}
...
![Uma versão atualizada da página de parceiros de tecnologia do Snapchat mostrando as contas de anúncios conectadas com sucesso.][3]{: style="max-width:80%;"}
...
![Detalhes do público de um determinado público do Snapchat, com nome, tipo, tamanho e retenção em dias do público.][9]
...
Você pode desconectar e reconectar sua conta do Snapchat na página de parceiros do Snapchat. Verifique com seu administrador do Snapchat Business Manager se você tem as permissões apropriadas para a conta de anúncios com a qual deseja sincronizar.
{% enddetails %}

{% details Por que meu canva não pode ser iniciado? %}
Certifique-se de que sua conta de anúncios do Snapchat se conecte com sucesso ao Braze na página de parceiros do Snapchat. Certifique-se de ter selecionado uma conta de anúncios, inserido um nome para o novo público e selecionado os campos correspondentes
{% enddetails %}

{% details Como posso saber se os usuários foram correspondidos depois de passá-los para o Snapchat? %}
O Snapchat não fornece essas informações para suas políticas de privacidade de dados.
{% enddetails %}

{% details O Snapchat aceita quantos públicos? %}
No momento, você só pode ter 1.000 públicos na sua conta do Snapchat.
Se você violar esse limite, a Braze avisará que não pode criar novos públicos.
Será necessário acessar sua conta de anúncios do Snapchat e remover os públicos que não estiver mais usando.
{% enddetails %}
