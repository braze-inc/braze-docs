...
![Uma conta do LinkedIn conectada com sucesso.][6]{: style="max-width:75%;"}
...
![Um público de entrada com o filtro "Rastreamento de Anúncios Habilitado é verdadeiro".][5]{: style="max-width:75%;"}
...
![Um canva com um público de entrada onde "opted_in_marketing" é igual a "true".][4]{: style="max-width:75%;"}
...
![O canva editor com a lista de componentes disponíveis.][2]{: style="max-width:35%;"} ![O componente de Sincronização de Público selecionado.][1]{: style="max-width:29%;"}

### Etapa 4: Configuração de sincronização

Selecione **LinkedIn** como o parceiro desejado do Audience Sync.

![Os detalhes de "Configurar a Sincronização de Público" com os vários parceiros para escolher.][9]{: style="max-width:70%;"}
...
![Sincronização de Público com LinkedIn com Braze selecionado como a conta de anúncio.][11]
...
![Página do LinkedIn listando as seguintes métricas para o público em questão.][8]
...
{% details Quanto tempo levará para que os tamanhos do público sejam preenchidos no LinkedIn? %}
Pode haver uma demora de até 48 horas para visualizar os públicos em sua conta do LinkedIn.
{% enddetails %}

{% details Qual é o tamanho mínimo do público para o LinkedIn preencher sua conta de anúncios?  %}
...
Confirme se sua conta de anúncios do LinkedIn foi conectada com sucesso à Braze na página de parceiros do LinkedIn.
Certifique-se de ter selecionado uma conta de anúncios, inserido um nome para o novo público e selecionado os campos para correspondência.
{% enddetails %}

{% details Como posso saber se houve correspondência entre os usuários depois de passá-los para o LinkedIn? %}
- Como posso saber se houve correspondência entre os usuários depois de passá-los para o LinkedIn?
O LinkedIn fornece informações sobre as taxas de correspondência em seu dashboard. Você pode revisá-lo no LinkedIn na seção **Públicos**. 
- Além disso, você pode revisar a taxa de correspondência para o seu público do LinkedIn na página de detalhes da etapa do canva, na etapa do Audience Sync.
{% enddetails %} 

{% details Quantos públicos o LinkedIn aceita? %}
Atualmente, não há limite para o número de públicos em sua conta de anúncios do LinkedIn.
{% enddetails %}

{% details Por que um segmento está preso no status COMPILANDO e não é atualizado? %}
