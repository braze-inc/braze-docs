...
| Destino |  | Limite de taxa |  | Dicas |
| --- | --- | --- | --- | --- |
| [Criteo]({{site.baseurl}}/partners/canvas_steps/criteo_audience_sync) |  |   | Sim | {::nomarkdown}<ul><li></li><li></li></ul>{:/} |
|  |  |  | Sim | {::nomarkdown}<ul><li></li><li></li></ul>{:/} |
|  |  |  | Não | {::nomarkdown}<ul><li> </li><li></li><li></li></ul>{:/} |
| [LinkedIn]({{site.baseurl}}/partners/canvas_steps/linkedin_audience_sync) |  |   |  | {::nomarkdown}<ul><li></li><li></li></ul>{:/} |
| [Pinterest]({{site.baseurl}}/partners/canvas_steps/pinterest_audience_sync/) |  |   | Sim |  |
| [Snapchat]({{site.baseurl}}/partners/canvas_steps/snapchat_audience_sync/) | N/D |   | Sim |  |
| [TikTok]({{site.baseurl}}/partners/canvas_steps/tiktok_audience_sync/) |  |   | Sim | {::nomarkdown}<ul><li></li><li></li></ul>{:/} |
