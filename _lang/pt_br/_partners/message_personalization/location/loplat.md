...
| Requisito | Descrição |
| --- | --- |
| conta loplat X | É necessário ter uma conta do loplat X para aproveitar essa integração.<br><br>Envie um e-mail para [support@loplat.com][3] para solicitar uma conta do loplat X. |
...
- [Alerta de promoção de duty-free][2]
...
Integre o SDK da loplat e o SDK da Braze ao seu app usando as etapas fornecidas na documentação da [integração loplat-Braze][4].
...
3. Acesse o loplat X e crie uma campanha seguindo as instruções do [guia do usuário do loplat X][5].
...
1. Crie uma campanha da loplat X seguindo as instruções do [Guia de usuário da loplat X][6].
