...
![Uma imagem do console da Pilgrim solicitando o ID do grupo, o ID do aplicativo Android e o ID do aplicativo iOS.]({% image_buster /assets/img_archive/pilgrim-dev-console.png %}){: style="float:right;max-width:40%;margin-left:15px;"}
...
![Uma campanha baseada em ações na etapa de entrega mostrando "chegada" selecionada como a opção "realizar evento personalizado", onde "tipoDeLocal" é igual a "casa".]({% image_buster /assets/img_archive/action-based-campaign.png %})
...
![Uma campanha baseada em ações na etapa de usuários-alvo mostrando "last_location" igual a "Lugar de Pizza".]({% image_buster /assets/img_archive/last-location-segment.png %})
