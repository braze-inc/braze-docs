...
Com os clientes atualizados e os atributos associados, a Peak enviará esses dados para a Braze usando o [`/user/track` endpoint][1], com o cabeçalho [bulk]({{site.baseurl}}/api/endpoints/user_data/post_user_track/#making-bulk-updates).
