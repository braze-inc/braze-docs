...
Antes de configurar a Braze para enviar mensagens personalizadas aos usuários, revise os componentes relevantes necessários para um site de comércio eletrônico típico, usando a arquitetura da Retail Demo Store como exemplo.
