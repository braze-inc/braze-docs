...
| Chave de API de fidelidade do Yotpo | Esta chave de API e identificador globalmente único (GUID) serão implementados dentro do snippet de código do Conteúdo Conectado.<br><br>Para saber mais, consulte [encontrando sua fidelidade & chave de API e GUID de referências](https://support.yotpo.com/en/article/finding-your-loyalty-referrals-api-key-and-guid)|
...
![Inspecione e procure por yotpo-main para encontrar a variável de ID do produto de dados]({% image_buster /assets/img/yotpo/image1.png %})
...
![Substitua YOTPO-API-KEY por sua chave de API do Yotpo Reviews]({% image_buster /assets/img/yotpo/image2.png %})
