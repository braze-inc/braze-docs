...
| [Encurtamento de links]({{site.baseurl}}/user_guide/message_building_by_channel/sms/campaign/link_shortening/) | Confirme se o encurtamento de links está ativado. | 
...
Depois que os usuários salvarem a sua marca como um contato, seja por meio de um [cartão de contato]({{site.baseurl}}/user_guide/message_building_by_channel/sms/mms/contact_card/) ou outro método, eles poderão ver os prompts **Tap to Load Preview** e os links do Movable Ink.
