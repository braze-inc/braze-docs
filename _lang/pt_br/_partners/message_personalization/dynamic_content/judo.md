...
![Uma imagem da aparência do dashboard ao selecionar o tipo de mensagem "Código personalizado".][2]
...
![Uma imagem mostrando o código de validação de formulário adicionado à etapa de criador de sua campanha.][3]

### Etapa 2: Defina um par de valores-chave para o Judo
![Esta imagem mostra o par chave-valor necessário para essa integração, sendo que a "chave" é "judo-experience" e o "valor" é o seu link da Judo.][4]{: style="float:right;max-width:50%;margin-left:15px;"}
