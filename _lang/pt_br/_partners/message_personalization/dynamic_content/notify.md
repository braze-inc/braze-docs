...
> [Notify](https://notifyai.io/) é uma solução de software impulsionada por IA que se integra perfeitamente com ferramentas de gestão de relacionamento com o cliente para aprimorar estratégias de marketing e facilitar o engajamento em múltiplos canais.
...
Crie uma [campanha acionada por API](https://www.braze.com/docs/user_guide/engagement_tools/campaigns/building_campaigns/delivery_types/api_triggered_delivery) no Braze. Então, compartilhe a campanha `api_identifier` com o Notify.
