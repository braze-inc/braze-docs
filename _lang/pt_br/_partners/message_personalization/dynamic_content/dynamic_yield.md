...
Em seguida, selecione **Create Experience Block (Criar bloco de experiência)** para criar um bloco de conteúdo dinâmico ou de recomendações a ser incorporado em um modelo de e-mail do Braze.<br>![][8]

### Etapa 2: elabore seu envio de mensagens

A imagem a seguir mostra um e-mail do zero no construtor.<br>![][6]
...
2. Selecione um modelo para a primeira variação. Agora você pode definir variáveis de design e conteúdo. Salve a variação quando terminar. <br>![][4]<br><br> 
3. Defina o público no painel Conteúdo dinâmico.<br>![][5]<br><br> 
...
2. Digite o token relevante da Braze que insere o CUID e o ID de e-mail do usuário.<br>![][3]
...
2. Em seguida, clique em **Copiar para a área de transferência**.<br>![][1]<br><br> 
