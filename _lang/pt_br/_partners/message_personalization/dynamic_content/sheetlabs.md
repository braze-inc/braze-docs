...
Consulte o [Sheetlabs][3] para obter mais informações sobre esses casos de uso.
...
Nesse ponto, você deve ser capaz de acessar sua API com um link como:<br> [`https://sheetlabs.com/ACME/email1_translations?country=en`][4].
