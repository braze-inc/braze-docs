...
O valor em tempo real dos dados do Resumo da Sessão da Fullstory é melhor aproveitado por meio do Conteúdo Conectado. Ao usar o conteúdo conectado em uma etapa do Canvas Context, é possível armazenar os dados do Fullstory durante toda a jornada do usuário no Canvas para uso em qualquer etapa subsequente do Canvas. Isso também evita a necessidade de gravar esses dados em um perfil de usuário do Braze por meio de eventos ou atributos personalizados. 
