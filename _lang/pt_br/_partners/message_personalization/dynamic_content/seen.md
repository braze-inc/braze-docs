...
nav_title: VISTO
article_title: VISTO
description: "Os vídeos personalizados da SEEN ajudaram as empresas a obter atenção e engajamento inigualáveis durante toda a jornada do cliente."
alias: /partners/seen/
page_type: partner
search_tag: Partner
---
...
> Os vídeos personalizados [da SEEN](https://seen.io/) ajudaram as empresas a obter atenção e engajamento inigualáveis durante toda a jornada do cliente. Personalize vídeos com o SEEN em três etapas simples:<br>1\. Crie um vídeo com base em seus dados.<br>2\. Personalize-o em escala na nuvem.<br>3\. Distribua-o onde ele funciona melhor.

## Casos de uso

O SEEN oferece personalização automatizada de vídeo em toda a jornada do cliente. Os usos comuns incluem integração, fidelidade, inscrições-se/conversão e recuperação/anti-churn.
...
Se tudo estiver funcionando como planejado, acesse o Braze e defina a taxa de envio da campanha para 10 **mensagens por minuto**. Isso garante que você não excederá o limite de frequência do SEEN de 1.000 chamadas por hora.
...
2. Abra a ferramenta [Transformação de dados](https://www.braze.com/docs/user_guide/data_and_analytics/data_transformation/creating_a_transformation/#prerequisites) em **Configurações de dados** e selecione **Criar transformação**.
...
{: start="6"}
6\. Envie uma carga útil de teste para o endpoint fornecido. Se quiser usar a carga útil de retorno de chamada definida na [documentação do SEEN](https://docs.seen.io/api-documentation/ntRoJJ3rXoHzFXhA94JiHB/callbacks/k9DEbcgkq3Vr2pxbHyPQbp), você mesmo poderá enviá-la via [Postman](https://www.postman.com/) ou outro serviço semelhante:
...
8\. Se tudo funcionou como planejado, selecione **Save** and **Activate**( **Salvar** e **ativar**).
