...
Crie uma [campanha de mensagens]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/create/) no app com código personalizado no Braze e defina o **Tipo de mensagem** como **Código personalizado**.
