...
![A página de configuração da conexão do parceiro da plataforma AppsFlyer para o público. A parte inferior das imagens mostra que a caixa do ID externo da Braze está marcada.]({% image_buster /assets/img/appsflyer_audiences/appsflyer_braze_connection.png %}){: style="max-width:80%;"}
...
![Filtro de atribuições do usuário "Coortes da AppsFlyer" selecionado.]({% image_buster /assets/img/appsflyer_audiences/appsflyer_cohorts_as_filter.png %})
