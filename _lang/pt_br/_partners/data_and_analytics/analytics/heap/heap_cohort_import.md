...
| Braze Currents | Para exportar dados do Braze para o Heap, você precisa [Braze Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/#access-currents) habilitado em sua conta. |
...
![No criador de segmentos da Braze, o filtro de atribuições do usuário "Coorte do Heap" está definido como "inclui" e "Coorte de teste do Heap".]({% image_buster /assets/img/heap/heap1.png %}){: style="max-width:90%;"}
...
![No criador de campanhas da Braze, na etapa de direcionamento, o filtro "Direcionar por segmento de usuários" fica definido como "Coorte do Heap".]({% image_buster /assets/img/heap/heap3.png %}){: style="max-width:90%;"}
