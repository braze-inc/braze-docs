...
# Conecte LiveRamp, Snowflake e Braze
...
{% alert note %}
Se você tiver questões ou problemas mais específicos, entre em contato com [martech@liveramp.com](mailto:martech@liveramp.com).
{% endalert %}
