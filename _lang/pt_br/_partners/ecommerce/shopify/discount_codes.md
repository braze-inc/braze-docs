...
# Envie códigos de desconto exclusivos por meio da Shopify
...
| Requisito | Descrição |
| --- | --- |
| Configurar uma loja da Shopify | Confirme que você já configurou [uma loja Shopify com o Braze]({{site.baseurl}}/shopify_overview/). |
...
![Um fluxograma que mostra a remoção do cabeçalho de linha "Promo" em um arquivo CSV][3].{: style="max-width:60%;"}
