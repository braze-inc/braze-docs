...
description: "Essa landing page inclui todos os parceiros Braze. Use-o para explorar a documentação técnica que ajudará a implementar os parceiros de tecnologia no seu SDK da Braze."
...
- name: Envio de e-mail para o amor
...
- name: Sincronização do público do Google
