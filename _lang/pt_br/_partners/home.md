...
partner_top_text: "Bem-vindo à nossa lista de Alloys (nossos aliados - nossos melhores amigos - nossos parceiros)! Use-a para explorar a documentação técnica que ajudará a implementar os parceiros de tecnologia no seu SDK da Braze. <br> <br>  Se você está procurando informações sobre como participar dos nossos Firebrands, uma comunidade de pessoas inovadoras que usam a Braze para modernizar a experiência do cliente e o marketing, confira nossa página de informações <a href='https://brazefirebrands.splashthat.com/'>aqui</a>."
description: "Essa landing page inclui todos os parceiros da Braze. Use-a para explorar a documentação técnica que ajudará a implementar os parceiros de tecnologia no seu SDK da Braze."
