{% tabs %}
{% tab Android %}
Por padrão, o [SDK](https://github.com/braze-inc/braze-android-sdk) nativo [do Braze para Android](https://github.com/braze-inc/braze-android-sdk) não oferece suporte a GIFs animados para cartões de conteúdo; no entanto, você pode usar uma biblioteca de imagens de terceiros para exibir GIFs. Para saber mais, consulte [Cartões de conteúdo do Android: GIFs]({{site.baseurl}}/developer_guide/platform_integration_guides/android/content_cards/GIFs/).
{% endtab %}
