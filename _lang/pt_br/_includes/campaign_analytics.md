...
Procurando definições para os termos e métricas listados em seu relatório? Consulte
  {% if include.channel == "email" %}[]({{site.baseurl}}/user_guide/message_building_by_channel/email/reporting_and_analytics/analytics_glossary/)Glossário de Análise de Dados por E-mail]({{site.baseurl}}/user_guide/message_building_by_channel/email/reporting_and_analytics/analytics_glossary/)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md métrica='Mensagens Enviadas' %} <br><br>
        ...
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md métrica='Total de Impressões' %} Isso pode aumentar várias vezes para o mesmo usuário.</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unique-impressions">Impressões únicas</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Impressões Únicas' %} <span style="white-space: nowrap">Esta contagem</span> não incrementa na segunda vez que um usuário visualiza um cartão.</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unique-recipients">Destinatários únicos</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Destinatários Únicos' %} <br><br> Porque um espectador pode ser um destinatário único a cada dia, você deve esperar que isso seja maior do que <i>Impressões Únicas</i>.</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unique-clicks">Cliques únicos projetados</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Cliques Únicos' %} Isso inclui cliques em links de cancelar inscrição fornecidos pela Braze.</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unique-dismissals">Descartes únicos</a></td>
            <td>{% multi_lang_include metrics.md métrica='descartes únicos' %}</td>
        </tr>
    </tbody>
</table>
...
Como outro exemplo, suponha que você veja FIVE _Impressões Únicas_ em uma campanha de cartão de conteúdo mostrando 150.000 _Mensagens Enviadas_. Isso significa que o cartão foi disponibilizado (no backend) para um público de 150.000 usuários, mas apenas cinco dispositivos de usuários realizaram todas as seguintes etapas após o envio ocorrer:
...
<table>
    ...
    <tbody>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unique-clicks">Cliques únicos projetados</a></td>
            <td class="no-split">
                {% multi_lang_include metrics.md metric='Cliques Únicos' %} Isso é monitorado ao longo de um período de sete dias para e-mail e medido por <a href='https://braze.com/docs/help/help_articles/data/dispatch_id/'>dispatch_id</a>. Isto inclui cliques em links de cancelar inscrição fornecidos pelo Braze. Este número deve estar entre 5–10%. Qualquer coisa acima de 10% é excepcional!
            </td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unique-opens">Aberturas únicas projetadas</a></td>
            <td class="no-split">
                {% multi_lang_include metrics.md métrica='Aberturas Únicas' %} Para e-mail, isso é rastreado ao longo de um período de 7 dias. Este número deve estar entre 10% e 20%. Qualquer coisa acima de 20% é excepcional!
            </td>
        </tr>
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md métrica='Taxa de Clique para Abertura' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#spam">Taxa de spam</a></td>
            <td class="no-split">
                {% multi_lang_include metrics.md métrica='Spam' %} Se essa métrica for maior que 0,08, isso pode ser um sinal de que o texto da sua mensagem é muito comercial, ou você deve reconsiderar seus métodos de coleta de endereços de e-mail (para confirmar que você está enviando mensagens para aqueles que estão interessados em sua correspondência).
            </td>
        </tr>
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md métrica='Cancelamento de inscrição ou Unsub' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#other-opens">Outras aberturas</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Outras Aberturas' %}</td>
        </tr>
        <tr>
            ...
            <td class="no-split"> {% multi_lang_include metrics.md métrica='Aberturas Reais Estimadas' %} Veja a seção a seguir para saber mais.</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#machine-opens">Aberturas por máquina</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='aberturas por máquina' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#bounces">Bounces</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='bounces' %}</td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#body-clicks">Cliques no corpo</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Cliques no Corpo' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#button-1-clicks">Cliques no botão 1</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Cliques no Botão 1' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#button-2-clicks">Cliques no botão 2</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Cliques no Botão 2' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unique-impressions">Impressões únicas</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Impressões Únicas' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#total-impressions">Total de impressões</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Total de Impressões' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#conversions-b-c-d">Conversões (B, C, D)</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Conversões (B, C, D)' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#total-conversions">Conversões totais</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Total de Conversões' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#conversion-rate">Taxa de conversão</a></td>
            <td>{% multi_lang_include metrics.md métrica='Taxa de Conversão' %}</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#bounces">Bounces</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Bounces' %} Veja <a href="#bounced-push">Notificações por push com bounce</a>.</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#direct-opens">Aberturas diretas</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='aberturas diretas' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#opens">Aberturas</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Aberturas' %}</td>
        </tr>
    </tbody>
</table>
...
> A entrega de notificações é um "melhor esforço" de APNs. Não se destina a entregar dados ao seu app, apenas a notificar o usuário de que há novos dados disponíveis. A distinção importante é que exibiremos quantas mensagens entregamos com sucesso a APNs, não necessariamente quantos APNs entregaram com sucesso aos dispositivos.

#### Notificações por push devolvidas {#bounced-push}

##### serviço de Notificações por Push da Apple

Os bounces ocorrem nos APNs quando uma notificação por push tenta ser entregue a um dispositivo que não tem o app pretendido instalado. APNs também têm o direito de mudar tokens para dispositivos de forma arbitrária. Se você tentar enviar para o dispositivo de um usuário cujo token por push mudou entre o momento em que registramos anteriormente seu token (como no início de cada sessão, quando registramos um usuário para um token por push) e o momento do envio, isso causaria um bounce.
...
<table>
    ...
    <tbody>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unique-recipients">Destinatários únicos</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Destinatários Únicos' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#sends">Envios</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Envios' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#errors">Erros</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Erros' %}</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md métrica='Entregas' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#reads">Leituras</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Leituras' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#failures">Falhas</a></td>
            <td class="no-split">{% multi_lang_include metrics.md métrica='Falhas' %}</td>
        </tr>
    </tbody>
</table>
...
Métricas adicionais podem ser acessadas por meio do painel [WhatsApp Manager](https://www.facebook.com/business/help/683499390267496?content_id=NZUBj7XjkYjYuWx), embora seja necessário a [confirmação do seu acesso](https://www.facebook.com/business/help/218116047387456) para acessar todos os insights disponíveis. 

{% endif %}

### Desempenho histórico

O **Desempenho Histórico** painel permite que você visualize as métricas do painel **Desempenho de Mensagens** como um gráfico ao longo do tempo. Use os filtros na parte superior do painel para modificar as estatísticas e canais mostrados no gráfico. O intervalo de tempo deste gráfico sempre refletirá o intervalo de tempo especificado no topo da página. 
...
{% alert note %}
Se você optar por enviar apenas para usuários que podem ver a versão mais recente do Braze das mensagens no aplicativo (Geração 3), seu **público** não se ajusta para refletir sua escolha.
{% endalert %}
...
O **Correlation de Conversão** painel oferece a você insight sobre quais atributos e comportamentos dos usuários ajudam ou prejudicam os resultados que você definiu para as campanhas. Para saber mais, consulte [Correlação de conversão]({{site.baseurl}}/user_guide/engagement_tools/testing/conversion_correlation/).
