...
![Exemplo de diagrama de um agente do Decisioning Studio para e-mails de referência.]({% image_buster /assets/img/offerfit/example_use_cases_referral_email.png %})
...
A equipe trabalhará em conjunto com você para definir o escopo, projetar e construir o seu agente de decisão. Se ainda não o fez, [entre em contato conosco](https://www.braze.com/get-started/) para começar.
