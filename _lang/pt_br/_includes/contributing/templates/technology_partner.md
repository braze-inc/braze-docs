Você pode usar esse modelo para criar a documentação do parceiro de tecnologia. Para obter um exemplo, consulte [Análise de dados Scuba]({{site.baseurl}}/partners/data_and_infrastructure_agility/analytics/scuba/).
