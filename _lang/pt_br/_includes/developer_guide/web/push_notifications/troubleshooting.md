...
- Alguns navegadores, como o Firefox, não exibem imagens em notificações por push. Para obter detalhes sobre a compatibilidade com navegadores, consulte a [documentação MDN para imagens de notificação](https://developer.mozilla.org/en-US/docs/Web/API/Notification/image).
