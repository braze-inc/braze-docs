...
### Solicitando políticas de processamento
...
{% tab manual %}
Quando o valor do enum `RequestPolicy` é `manual`, ele realiza a mesma ação que o processamento automático de solicitações, exceto:
