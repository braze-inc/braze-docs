...
Ao executar um teste A/B em mensagens no app, sua análise de dados pode parecer mostrar uma distribuição de variantes mais alta entre uma variante e outra, mesmo que elas tenham uma divisão percentual uniforme. Por exemplo, considere o seguinte gráfico de *Destinatários Únicos* para a Variante A e a Variante C.
