...
![A página 'Alvo' em um experimento de feature flag com 'Recebido Variant de Feature Flag' destacado na barra de pesquisa do grupo de filtros.]({% image_buster /assets/img/feature_flags/variant-filter-dropdown.png %}){: style="max-width:70%"}
