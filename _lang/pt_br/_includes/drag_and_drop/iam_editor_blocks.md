## Uso de blocos do editor de mensagens no app
...
| Captura de telefone | Insere um campo de formulário para números de telefone. Quando enviado, o usuário é inscrito no [grupo de inscrições do]({{site.baseurl}}/whatsapp_subscription_groups/) [SMS]({{site.baseurl}}/sms_rcs_subscription_groups/) ou do [WhatsApp]({{site.baseurl}}/whatsapp_subscription_groups/). |
...
| Propriedade | Descrição |
| --- | --- |
| Grupo de inscrições | O [grupo de inscrições]({{site.baseurl}}/whatsapp_subscription_groups/) [de SMS]({{site.baseurl}}/sms_rcs_subscription_groups/) ou [WhatsApp]({{site.baseurl}}/whatsapp_subscription_groups/) no qual o usuário será inscrito ao coletar seu número de telefone, com uma opção para coletar números de todos os países |
| Alinhamento de texto | Move o texto para ser alinhado à esquerda, ao centro, à direita ou justificado |
...
| Comportamento ao clicar | Determina a ação quando o usuário clica no botão, como fechar a mensagem, abrir o URL da Internet, fazer um link profundo em uma página específica do app, acessar outra página ou [solicitar permissão por push]({{site.baseurl}}/push_primer/). |
...
Para obter especificações de imagem, consulte nossas [especificações de imagem de mensagem no app]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/image_specs/#in-app-messages).
...
| Comportamento ao clicar | Determina a ação quando o usuário clica na imagem, como fechar a mensagem, abrir o URL da Internet, fazer um link profundo em uma página específica do app, acessar outra página ou [solicitar permissão push]({{site.baseurl}}/push_primer/). |
