...
{% tabs local %}
  ...
  {% endtab %}
  {% tab Resumo %}
    Aqui, você encontrará o resumo dos detalhes do seu Canva. 

  {% endtab %}
{% endtabs %}

####  Comece com o básico do canva
...
####  Determine seu cronograma de entrada no Canva
...
####  Defina seu público-alvo de entrada
...
####  Selecione suas configurações de envio

Selecione **Send Settings (Configurações de envio** ) para editar suas configurações de inscrição, ativar o limite de frequência e ativar o Horário de silêncio. 
...
![A página "Quiet Hours" exibe uma caixa de seleção para ativar o horário de silêncio. 
...
3. Crie o gerador de números aleatórios.  Defina o número resultante como uma variável Liquid em sua campanha de webhook.<br><br>
...
Os recursos de Seleção Inteligente agora estão disponíveis em Canvas multivariantes.  Essa distribuição é baseada nas métricas de performance de cada variante para maximizar o número total esperado de conversões.
...
![A opção "Intelligent Selection" (Seleção inteligente) está ativada na página "Edit Variant Distribution" (Editar distribuição de variantes). Ao analisar e otimizar o Canva, ele exibe uma barra horizontal na página que é dividida em várias seções, cada uma variando em cor e tamanho. 
