...
![Dois exemplos de detalhes de performance para componentes do canva. À esquerda, são mostrados os detalhes de performance de uma jornada de usuário com um componente do canva. 
