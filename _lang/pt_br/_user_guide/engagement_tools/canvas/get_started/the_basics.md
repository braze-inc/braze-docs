---
nav_title: Noções básicas de canvas
...
{% tabs %}
  ...
  ![Um exemplo de um Canva com uma etapa de divisão de decisão em duas jornadas de usuário diferentes, dependendo se o usuário está ativado para push.]({% image_buster /assets/img/canvas_intro/canvas_intro.gif %})
