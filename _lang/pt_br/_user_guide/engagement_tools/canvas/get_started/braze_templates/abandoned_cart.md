...
![Evento de conversão primária - Um evento com o tipo de conversão "Faz compra" com o nome do produto "Enormous Paper Plate". 
...
![Uma prévia da mensagem SMS que os usuários receberão: "Olá, você deixou o enorme prato de papel no carrinho! Conclua sua compra agora e dê uma etapa em seu jogo de hospedagem. 
