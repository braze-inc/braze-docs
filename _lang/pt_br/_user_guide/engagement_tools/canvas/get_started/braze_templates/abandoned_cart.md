...
![Uma tela baseada em ação que direciona os usuários que abandonaram o carrinho, com a janela de entrada em 15 de outubro de 2024, às 15h20, no fuso local dos usuários.]({% image_buster /assets/img/canvas_templates/abandoned_intent2.png %})
...
!["Segmento de compradores on-line - 90 dias" como o segmento de usuários a ser direcionado para essa tela.]({% image_buster /assets/img/canvas_templates/abandoned_intent3.png %})
...
![Critérios de saída que determinam que os usuários que fizerem uma compra específica para o enormous paper plate sairão do Canva.]({% image_buster /assets/img/canvas_templates/abandoned_intent4.png %})
...
![Grupo de ação "Made purchase" que sairá do Canva se o usuário comprar o enorme prato de papel.]({% image_buster /assets/img/canvas_templates/abandoned_intent5.png %})
...
![Uma prévia da mensagem SMS que os usuários receberão: "Olá, você deixou o enorme prato de papel no carrinho! Conclua sua compra agora e dê uma etapa em seu jogo de hospedagem. Use o código MYPLATE no checkout para obter 20% de desconto em seu pedido!]({% image_buster /assets/img/canvas_templates/abandoned_intent6.png %})
