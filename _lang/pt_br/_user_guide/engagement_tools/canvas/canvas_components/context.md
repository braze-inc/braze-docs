...
Agora, é possível usar a variável de contexto em qualquer lugar que use o Liquid, como nas etapas de Mensagem e Atualização do usuário, selecionando **Adicionar personalização**. Para obter um passo a passo completo, consulte [Uso de variáveis de contexto](#using-context-variables).
