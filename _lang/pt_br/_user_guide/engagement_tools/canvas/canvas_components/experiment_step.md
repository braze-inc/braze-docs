...
![Uma etapa da jornada experimental que se divide em jornada 1, jornada 2 e Controle.][0]{: style="float:right;max-width:50%;margin-left:15px;"}
...
## Criar uma jornada experimental
...
![Configurações de Experimento onde você pode adicionar jornadas e distribuir a porcentagem de usuários em cada jornada.][1]
...
![Adicionando etapas a cada jornada que se divide de um componente de jornada experimental.][3]{: style="max-width:75%"}
...
- [Jornada vencedora][WP_analytics]
- [Jornadas personalizadas][PP_analytics]
