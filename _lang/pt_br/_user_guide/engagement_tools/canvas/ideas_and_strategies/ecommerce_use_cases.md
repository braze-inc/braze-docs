...
Na página Tela, selecione **Usar um modelo de tela** > **Modelos de Braze** e, em seguida, aplique o modelo **Abandoned browse**. 
...
- Público alvo 
    ...
    - Controles de entrada
        - Os usuários são elegíveis para entrar novamente neste Canvas após a conclusão da duração total do Canvas
    - Critérios de saída 
...
Como os eventos recomendados são eventos personalizados mais opinativos, você pode pesquisar os nomes de eventos de comércio eletrônico recomendados selecionando qualquer [filtro de evento personalizado]({{site.baseurl}}/user_guide/data/custom_data/custom_events/#segmentation-filters).
