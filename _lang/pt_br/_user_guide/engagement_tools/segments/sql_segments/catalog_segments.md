...
{: start="2"}
2\. O editor SQL é preenchido automaticamente com um modelo. <br><br>Esse modelo une os dados de eventos do usuário com os dados do catálogo para segmentar os usuários que se engajaram com determinados itens do catálogo.
