...
tool: Campaigns
page_type: landing
description: "Esta landing page contém recursos para a criação de suas campanhas. Aqui, você pode encontrar recursos sobre como criar uma campanha, funcionalidades com base no tempo, agendamento de campanhas, direcionamento, conversão e muito mais."
