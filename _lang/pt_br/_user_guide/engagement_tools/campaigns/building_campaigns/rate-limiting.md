...
#### Definição de um limite máximo de usuários
 ...
 Isso serve como uma verificação independente dos filtros da campanha, permitindo que você segmente livremente os usuários sem se preocupar com o excesso de spam.
...
#### Limite de frequência e novas tentativas do Connected Content
 ...
 Vamos considerar o cenário de envio de 75.000 mensagens com um limite de frequência de 10.000 por minuto. Imagine que, no primeiro minuto, a chamada falhe ou esteja lenta e envie apenas 4.000 mensagens.
