...
Selecione um evento de exceção que desqualificará os usuários para receberem essa campanha. Isso só pode ser feito se a mensagem disparada for enviada após uma postergação.  Se um usuário concluir o evento de gatilho, mas depois concluir o evento de exceção antes do envio das mensagens devido à postergação, ele não receberá a campanha. 
...
![][31]
 ...
 Se optar pela reelegibilidade dos usuários, eles poderão receber a campanha sempre que concluírem o evento de gatilho, desde que se qualifiquem durante o período de tempo especificado.
