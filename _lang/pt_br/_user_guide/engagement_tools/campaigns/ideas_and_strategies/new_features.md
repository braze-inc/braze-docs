...
![O painel Opções de direcionamento na etapa Usuários-alvo no fluxo de trabalho de criação de campanhas. 
...
*  O filtro Número da versão do app usa `versionCode` porque é garantido que ele seja incrementado a cada lançamento da loja de aplicativos.
