...
Todas as imagens carregadas na biblioteca de mídia devem ter menos de 5 MB.  Para recomendações específicas de imagens por canal de envio de mensagens, consulte as seguintes seções.
