...
![Menu suspenso Configurações expandido que mostra três opções: 
...
![Painel Blocos de conteúdo salvos em que o menu suspenso de configurações para "Test_32" é expandido para mostrar três opções: 
