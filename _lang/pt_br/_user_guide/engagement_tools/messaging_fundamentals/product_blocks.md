...
![Opções de layout para orientação e alinhamento do produto, máximo de produtos por linha e espaçamento entre produtos.]({% image_buster /assets/img/product_blocks/layout_options.png %}){: style="max-width:50%;"}
...
Para usar os blocos de produtos do tipo arrastar e soltar, você precisa configurar um catálogo do Braze que inclua valores de campo específicos. Esses campos serão usados na configuração do bloco do produto. Certifique-se de que seu catálogo inclua os seguintes campos:
...
![Bloco de produto com um lado do dólar anexado ao preço do item.]({% image_buster /assets/img/product_blocks/liquid.png %}){: style="max-width:45%;"}
