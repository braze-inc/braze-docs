---
nav_title: Envio de mensagens da direita para a esquerda
article_title: Criação de mensagens da direita para a esquerda
page_order: 1
page_type: reference
description: "Esta página aborda as práticas recomendadas para o envio de mensagens no Braze que são lidas da direita para a esquerda."
---
...
- **Aparência no dashboard do Braze:** Quando uma mensagem aparece no dispositivo de um usuário, sua aparência é amplamente determinada pelo sistema operacional e pelas configurações de idioma do dispositivo, o que significa que o que você vê no dashboard nem sempre é 100% preciso.
...
4. Verifique a formatação e o alinhamento do texto. Se estiver criando uma mensagem de e-mail do tipo arrastar e soltar ou HTML, poderá fazer isso no criador de mensagens. Caso contrário, você precisará usar um processador de texto separado.<br><br>![Menu do editor de arrastar e soltar de e-mail com botão para alternar o alinhamento do texto entre direita para esquerda e esquerda para direita.]({% image_buster /assets/img/rtl_button.png %}){: style="max-width:50%;"}
