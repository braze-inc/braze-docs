...
![Filtros adicionais para uma mensagem direcionada a usuários que abriram um app pela última vez no dia, que nunca receberam uma campanha ou etapa do Canva e que fizeram uma compra há menos de 30 dias.]({% image_buster /assets/img_archive/additional_filters.png %}){: style="max-width:70%;"}
{% endtab %}
