...
![A seção "Total Population" (População total) com contagens estimadas de usuários acessíveis em cada canal direcionado.]({% image_buster /assets/img_archive/multi_channel_footer.png %})
