...
| Interrompido | Campanhas e telas interrompidas são pausadas, mas você ainda pode editá-las. Para continuar, selecione o menu <i class="fas fa-ellipsis-vertical"></i> e, em seguida, **Resume (Continuar**). Para saber mais, consulte [Comportamento do Canva interrompido](#stopped-canvas-behavior). |
