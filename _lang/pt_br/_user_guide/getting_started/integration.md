...
| Cartões de conteúdo | Para começar com [Content Cards]({{site.baseurl}}/user_guide/message_building_by_channel/content_cards/about/), entre em contato com seu gerente de sucesso do cliente da Braze. |
