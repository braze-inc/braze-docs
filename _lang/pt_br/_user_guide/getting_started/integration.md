...
* Seu [endpoint de SDK]({{site.baseurl}}/user_guide/administrative/access_braze/sdk_endpoints/)
  * A Braze não fornece mais endpoints personalizados, portanto, use os endpoints predefinidos do SDK. 
...
Trabalhe em conjunto com seu engenheiro para garantir que tudo esteja funcionando. 
