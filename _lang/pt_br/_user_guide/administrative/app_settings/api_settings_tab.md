...
Para integrar-se à nossa API, você pode pesquisar os identificadores relacionados a quaisquer segmentos, campanhas, cartões de conteúdo e outros que deseja acessar na API externa do Braze.  Depois de selecionar qualquer um deles, o identificador será exibido abaixo do menu suspenso.
