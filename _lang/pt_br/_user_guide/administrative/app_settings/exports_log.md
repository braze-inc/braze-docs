...
![Os registros de exportação com uma lista de exportações concluídas.][1]
...
![O registro de exportação mostra uma exportação pendente e a opção de "Cancelar exportação".][2]
...
![Uma janela suspensa com o link para compartilhar a página.][3]{: style="max-width:45%;"}
