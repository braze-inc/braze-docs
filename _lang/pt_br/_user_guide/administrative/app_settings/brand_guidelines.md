...
page_order: 1
page_type: reference
description: "Este artigo de referência descreve como criar, gerenciar e usar diretrizes da marca que podem ser aplicadas às suas mensagens através do assistente de copywriting IA."
---
...
![A janela "Criar diretriz da marca" com campos para inserir o nome, descrição, personalidade, exclusões e tom.]({% image_buster /assets/img/guidelines_create.png %})
...
{% alert important %}
Você pode mudar o idioma de saída independentemente do idioma do seu texto, mas nem Braze nem OpenAI garantem a qualidade da tradução. Sempre teste e verifique as traduções antes de usá-las.
{% endalert %}
...
![A página "Diretrizes da Marca" filtrada para diretrizes de marca arquivadas.]({% image_buster /assets/img/unarchive_brand_guideline.png %})
...
!["Assistente de copywriting IA com "Alertas Importantes!!" selecionado como a diretriz da marca.]({% image_buster /assets/img/guidelines_ai_assistant.png %})
