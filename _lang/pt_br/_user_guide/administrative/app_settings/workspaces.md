...
Antes de começar, certifique-se de ter trabalhado com sua equipe e com o gerente de integração do Braze para determinar a melhor configuração de espaço de trabalho para o seu caso de uso.  
...
#### 
 ...
 As validações de entrega conferem se o seu público atende aos critérios de entrega no envio da mensagem. Lembre-se de especificar validações de entrega para cada etapa da mensagem para garantir que ela seja entregue ao aplicativo correto. Não há necessidade de segmentar no nível de entrada.

{% details Expandir as etapas do fluxo de trabalho original do Canva %}

{% alert important %}
A partir de 28 de fevereiro de 2023, não será mais possível criar ou duplicar canvas usando o editor original. Esse conteúdo está disponível como referência para entender os segmentos e o direcionamento no editor original.<br><br> 
{% endalert %}
