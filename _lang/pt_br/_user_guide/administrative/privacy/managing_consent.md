...
- **Equipes:**  Isso envolve adicionar um atributo personalizado a todos os perfis de usuário para indicar seu status de consentimento, data de consentimento ou ambos. Em seguida, é necessário migrar todas as campanhas e Canvas para a equipe designada e ajustar as permissões de usuário no dashboard de acordo.
