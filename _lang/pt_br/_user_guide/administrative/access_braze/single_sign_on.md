...
guide_top_text: "O logon único (SSO) oferece às empresas uma maneira segura e centralizada de controlar o acesso ao dashboard do Braze. Em resumo, um único conjunto de credenciais pode ser usado para acessar diferentes aplicativos, inclusive a Braze. <br> <br> A Braze oferece suporte ao SAML SSO, que suporta os mais recentes padrões do setor Security Assertion Markup Language (SAML 2.0), e também oferece suporte ao Azure Active Directory, Okta e OneLogin."
