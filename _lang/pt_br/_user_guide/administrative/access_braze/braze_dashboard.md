...
> O dashboard do Braze é seu espaço de trabalho central para criar, gerenciar e analisar o engajamento do cliente. Acesse-o em [dashboard.braze.com](https://dashboard.braze.com/) ou [dashboard.braze.eu](https://dashboard.braze.eu/).
...
Ao registrar-se, o dashboard fornece uma visão centralizada de suas ferramentas e dados de engajamento:

- **Página inicial:** Mostra seu [conteúdo editado recentemente](#pick-up-where-you-left-off) e as principais métricas de performance em um relance
- **Navegação à esquerda:** Organiza as ferramentas por função (envio de mensagens, público, análise de dados, configurações)
- **Cabeçalho global:** Oferece acesso rápido à pesquisa, ao suporte, às configurações de idioma, às notificações e à sua conta

Sua experiência no dashboard é organizada por [espaços de trabalho]({{site.baseurl}}/user_guide/getting_started/workspaces), que ajudam a gerenciar o conteúdo de diferentes marcas, regiões ou equipes. Você pode [alternar entre os espaços de trabalho](#workspace-switcher) a qualquer momento na navegação lateral.
...
Para alternar entre espaços de trabalho, selecione a lista suspensa de espaços de trabalho na parte superior da navegação lateral e escolha o espaço de trabalho que deseja acessar. Você também pode [adicionar espaços de trabalho favoritos](#adding-favorite-workspaces) para ter acesso mais rápido aos que usa com mais frequência.
...
Por padrão, a pesquisa inclui itens ativos, de rascunho e arquivados. Use o botão de alternância **Mostrar somente ativos e rascunhos** para restringir seus resultados.
...
O dashboard do Braze inclui vários recursos para ajudá-lo a trabalhar com mais eficiência e acessar rapidamente as ferramentas e o conteúdo que você mais usa.

### Continuar de onde parou

Na página **inicial**, o dashboard exibe suas campanhas, Canvas e segmentos recentemente editados ou criados. Isso facilita o retorno ao trabalho em andamento sem necessidade de pesquisa. Cada item inclui tags que mostram o tipo e o status do conteúdo (como rascunho, ativo ou parado).
...
Para saber mais, consulte [Home dashboard]({{site.baseurl}}/user_guide/data_and_analytics/analytics/home_dashboard/#pick-up-where-you-left-off).

### Adicionar espaços de trabalho favoritos

Se você trabalha em vários espaços de trabalho, pode marcar os mais usados como favoritos para acesso mais rápido. Para adicionar espaços de trabalho favoritos, [acesse as configurações do seu perfil](#accessing-your-profile-settings), localize o campo **Espaços de trabalho favoritos** na seção **Perfil da conta** e selecione os espaços de trabalho que deseja adicionar como favoritos. Seus espaços de trabalho favoritos aparecerão na parte superior do alternador de espaços de trabalho para acesso rápido.
...
Na página de perfil, você pode atualizar suas configurações de e-mail, configurar a autenticação de dois fatores, visualizar suas chaves de API e gerenciar outros detalhes da conta.
...
### Principais tarefas e próximas etapas

- **Criar campanhas**: [Criar uma campanha]({{site.baseurl}}/user_guide/engagement_tools/campaigns/building_campaigns/creating_campaign/)
- **Crie jornadas**: [Construir uma tela]({{site.baseurl}}/user_guide/engagement_tools/canvas/create_a_canvas/create_a_canvas/)
- **Definir o público**: [Criar um segmento]({{site.baseurl}}/user_guide/engagement_tools/segments/creating_a_segment/)
- **Revisar a performance**: [Visão geral da análise de dados]({{site.baseurl}}/user_guide/data_and_analytics/analytics/understanding_your_app_usage_data/)
- **Configurar definições**: [Configurações do app]({{site.baseurl}}/user_guide/administrative/app_settings/)
