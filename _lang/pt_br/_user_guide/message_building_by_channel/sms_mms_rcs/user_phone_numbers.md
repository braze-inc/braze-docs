...
- **Números internacionais:** Todos os números internacionais devem começar com `+`, seguido pelo código do país e, em seguida, o número do telefone. Por exemplo, `+442071838750`.
