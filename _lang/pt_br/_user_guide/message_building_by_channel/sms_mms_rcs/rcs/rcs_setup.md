...
> Este artigo cobre os requisitos necessários para configurar seu canal RCS.
...
Para ser elegível para enviar RCS com Braze, sua empresa deve atender a três critérios previamente:
...
## Etapa 2: Registrar um remetente verificado de RCS
...
O cronograma para aprovação da operadora varia de país para país e também pode variar dentro de um país. Tenha em mente que o mercado de RCS ainda está em sua infância, então os processos de operadoras e agregadores estão evoluindo rapidamente. Nos Estados Unidos, a Braze estima que o tempo de resposta para aprovação da operadora para um remetente verificado por RCS geralmente fica na faixa de 4 a 6 semanas, com um remetente de teste geralmente aprovado em uma semana.
