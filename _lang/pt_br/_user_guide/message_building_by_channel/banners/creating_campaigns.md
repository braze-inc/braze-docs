...
Escolha uma data e hora de início para sua campanha de banner. Por padrão, os Banners duram indefinidamente. Você pode alterar isso selecionando **End Time** e especificando uma data e hora de término.
