...
A aparência final das mensagens da direita para a esquerda depende muito de como os prestadores de serviço as processam. 
...
{% alert tip %}
Tem interesse em redirecionamento por SMS? Acesse nosso [artigo sobre redirecionamento]({{site.baseurl}}/user_guide/message_building_by_channel/sms/campaign/retargeting/) de SMS para saber mais.
{% endalert %}
...
Em seguida, confira [os relatórios de SMS]({{site.baseurl}}/user_guide/message_building_by_channel/sms/sms_campaign_analytics/) para saber como acessar os resultados de suas campanhas de SMS.
