---
nav_title: Calculadora de Cópia e Segmento de Mensagens
article_title: Calculadora de Cópia e Segmento de Mensagens SMS
page_order: 5
description: "Este artigo de referência aborda o que é um segmento de SMS, como eles são contados para faturamento, bem como coisas a serem lembradas ao criar cópias de mensagens SMS."
page_type: reference
tool:
  - Testing Tools
channel:
...
# Calculadora de cópia e segmentação de mensagens

> Mensagens SMS na Braze são cobradas por segmento de mensagem. Compreender o que define um segmento e como essas mensagens serão divididas é fundamental para entender como você será cobrado por mensagens e ajudará a prevenir cobranças acidentais.
...
- **Compatível com a modelagem Liquid, Conteúdo Conectado, emojis e links**
    ...
    - Links podem fazer uso de muitos caracteres, resultando em mais segmentos de mensagem do que o pretendido. Embora o uso de encurtadores de links seja possível, eles são melhores usados com códigos curtos. Visite nosso [FAQ de SMS]({{site.baseurl}}/user_guide/message_building_by_channel/sms/faqs/) para saber mais.<br><br>
- **Testes**
