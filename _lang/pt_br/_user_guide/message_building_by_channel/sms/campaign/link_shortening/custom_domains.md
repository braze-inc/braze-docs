...
> Esta página aborda como usar domínios personalizados com [encurtamento de links]({{site.baseurl}}/user_guide/message_building_by_channel/sms/campaign/link_shortening/) para personalizar a aparência de seus URLs encurtados e apresentar uma imagem de marca consistente. 
...
Depois de configurados, os domínios personalizados podem ser atribuídos a um ou vários grupos de inscrições de SMS. 
