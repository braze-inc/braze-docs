...
Braze recomenda que você também use o recurso de [aceitação dupla por SMS]({{site.baseurl}}/user_guide/message_building_by_channel/sms/keywords/sms_double_opt_in/). Este recurso funciona automaticamente com o formulário de captura de número de telefone {mensagem no app}, solicitando que os usuários confirmem sua intenção após enviar seu número de telefone através do formulário.
