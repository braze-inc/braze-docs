...
![E-mail de integração enviado pela LivingSocial que dá as boas-vindas aos novos usuários.][26]{: style="max-width:70%;"}
...
![E-mail promocional enviado pela Ideeli que notifica os usuários sobre uma oferta por tempo limitado. Um grande banner contém o texto "Termina à meia-noite EDT." Promoção relâmpago de 6 horas. Depressa! Essas descobertas incríveis não vão durar muito."][27]{: style="max-width:70%;"}
...
![Exemplo de e-mail social da Hailo que notifica seus usuários para participarem de um desafio de fotos.][30]{: style="max-width:70%;"}
...
![Exemplo de e-mail focado em atualização do Allrecipes que notifica seus usuários sobre um novo recurso. O topo do e-mail diz "Too." Muitos. Senhas. Cansado de senhas? Nós também." O corpo do e-mail direciona os usuários a fazer login com o Facebook ou Google Plus, com um chamado para ação de "Veja Como".][31]{: style="max-width:70%;"}
