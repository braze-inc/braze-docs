...
![Texto de pré-cabeçalho em uma caixa de entrada do Gmail com o texto "Brand. Novo. 
...
Certifique-se de limitar o tamanho de seu e-mail.  Tente manter o tamanho de seu e-mail abaixo de 25 KB apenas para texto ou 60 KB com imagens. Recomendamos enfaticamente que você use nosso carregador de imagens para hospedar imagens e fazer referência a essas imagens pelo endereço `href`.
