...
### Etapa 3: Faça o upload do seu modelo
 ...
 Consulte a seção [Pré-requisitos](#upload-requirements) para garantir que seu modelo atenda aos requisitos de fazer upload.
...
### Etapa 4: Conclua e salve seu modelo
 ...
 Agora você está pronto para usar este modelo em qualquer campanha ou canva que escolher!
