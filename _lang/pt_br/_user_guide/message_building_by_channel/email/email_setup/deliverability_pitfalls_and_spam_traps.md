...
Essas armadilhas podem ser evitadas se você configurar um processo de aceitação confirmada. Ao enviar um e-mail inicial de aceitação e pedir aos clientes que verifiquem se desejam receber suas mensagens, você garante que os destinatários queiram receber notícias suas e que você esteja enviando para endereços reais e válidos. Aqui estão outras maneiras de evitar armadilhas de spam:

1. Envie um e-mail de aceitação dupla. Esse é um e-mail que exigirá que os usuários confirmem suas opções de inscrição clicando em um link.
2. Como prática recomendada, implemente uma [política de sunsetting]({{site.baseurl}}/user_guide/message_building_by_channel/email/best_practices/sunset_policies/).
