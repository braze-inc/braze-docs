...
O rótulo final do domínio deve ser um domínio de nível superior (TLD) válido, que é determinado por qualquer coisa após o ponto final (.).  O validador de e-mail do Braze verifica apenas se a sintaxe do e-mail está correta de acordo com a expressão regular listada nesta seção. Ele não captura erros de digitação ou endereços que não existem.
