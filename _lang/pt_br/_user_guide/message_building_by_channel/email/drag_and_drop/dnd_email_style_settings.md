...
![Seção Configurações de estilo global de e-mail na guia Configurações do editor de arrastar e soltar do editor de e-mail.]({% image_buster /assets/img_archive/dnd_global_style_settings.png %})
...
![Opções básicas de estilo que incluem opções para editar o e-mail e as cores de fundo do conteúdo, o nome da fonte padrão e a cor padrão do link.]({% image_buster /assets/img_archive/dnd_basic_styling.png %}) 
...
![Título Configurações de estilo para um cabeçalho principal e um cabeçalho secundário alinhados ao centro.]({% image_buster /assets/img_archive/dnd_title_styling.png %})
...
Essa configuração será a pré-configurada para todos os blocos de conteúdo futuros. Os blocos de conteúdo existentes não serão atualizados. Você pode definir que todos os blocos de conteúdo sejam definidos em 100%, aderindo à largura em que um bloco de conteúdo é inserido, ou definir um valor de pixel específico.

Recomendamos combinar a largura do bloco de conteúdo com a largura do modelo de e-mail.
