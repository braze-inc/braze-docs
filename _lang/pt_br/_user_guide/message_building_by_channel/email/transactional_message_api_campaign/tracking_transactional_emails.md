---
nav\_title: Rastreamento de e-mails de transação article\_title: Rastreamento de e-mails de transação page\_order: 1 description: "Este artigo de referência aborda como configurar o rastreamento em tempo real para campanhas de e-mail de transação." page\_type: reference tool: - Campaigns channel: email
...
{% multi\_lang\_include http\_event\_postback.md %}
