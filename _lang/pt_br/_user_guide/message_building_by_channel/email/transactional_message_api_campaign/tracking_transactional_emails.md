---
nav_title: Rastrear e-mails de transação
...
# Rastrear e-mails de transação

> Esta página descreve como configurar o rastreamento em tempo real para [campanhas de e-mail de transação]({{site.baseurl}}/user_guide/message_building_by_channel/email/transactional_message_api_campaign/). Para saber mais sobre o endpoint em si, consulte [Enviar e-mails de transação usando a entrega disparada por API]({{site.baseurl}}/api/endpoints/messaging/send_messages/post_send_transactional_message/).
