...
{% multi_lang_include metrics.md metric='Mensagens enviadas' %} Essa métrica é fornecida pelo Braze.
...
{% multi_lang_include metrics.md métrica='Deliveries %' %}
...
{% multi_lang_include metrics.md métrica='Bounces' %} 
...
{% multi_lang_include metrics.md metric='Unique Clicks' %} Isso é rastreado em um período de sete dias para <a href='/docs/help/help_articles/data/dispatch_id/'>envio</a> de e-mail e medido por <a href='/docs/help/help_articles/data/dispatch_id/'>dispatch_id</a>. Isso inclui cliques em links de cancelamento de inscrição fornecidos pela Braze.
...
<span class="calculation-line">
    Cálculo:
    <ul>
        <li><b><i>Cancelar inscrição</i> ou <i>Cancelar inscrição</i>:</b> Contagem</li>
        <li><b><i>% de cancelamentos</i> <i>de inscrição</i> ou <i>taxa de cancelamento de inscrição</i>:</b> (Cancelamentos de inscrição) / (Entregas)</li>
    </ul>
</span>
{:/}
...
{% multi_lang_include metrics.md metric='Conversões primárias (A) ou Evento de conversão primária' %} Para e-mail, push e webhooks, começamos a rastrear as conversões após o envio inicial.
