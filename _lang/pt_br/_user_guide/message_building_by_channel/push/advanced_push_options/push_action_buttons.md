...
{% alert note %}
 Em particular, você precisa configurar Categorias do iOS ou selecionar entre certas opções de botões padrão. Para integrações com Android, esses botões funcionarão automaticamente.
{% endalert %}
...
2.  Você pode selecionar entre as seguintes ações disponíveis:
  - Abrir app
