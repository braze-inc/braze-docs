...
- Para garantir que seu aplicativo possa enviar notificações [por push][1], siga as instruções [de integração de push do iOS][1], pois o desenvolvedor precisará adicionar uma extensão de serviço ao seu aplicativo.
