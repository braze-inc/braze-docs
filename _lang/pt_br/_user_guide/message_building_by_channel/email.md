...
- name: Rodapé de e-mail personalizado
...
- name: Proteção de privacidade de e-mail do Apple Mail
  link: /docs/user_guide/message_building_by_channel/email/apple_mail/mpp/
  image: /assets/img/braze_icons/apple.svg
- name: Glossário de análise de dados de e-mail
