...
- Um `external_id`, um [número de telefone]({{site.baseurl}}/user_guide/message_building_by_channel/whatsapp/user_phone_numbers/) e um status de inscrição atualizado para cada usuário. 
