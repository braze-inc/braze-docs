...
O rastreamento de cliques permite medir quando alguém toca em um link na sua mensagem do WhatsApp, o que lhe dá uma visão clara de qual conteúdo está gerando engajamento. O Braze encurta seus URLs, adiciona rastreamento nos bastidores e registra os eventos de cliques à medida que eles acontecem.
