...
{% alert tip %}
{% raw %}
Se planeja usar o Liquid, certifique-se de incluir um valor padrão para a personalização escolhida para que, caso o perfil de usuário do destinatário esteja incompleto, ele não receba uma mensagem. 
{% endraw %}
{% endalert %}
...
#### Selecionar eventos de conversão
 ...
 É possível permitir um período de até 30 dias durante o qual uma conversão será contada se o usuário realizar a ação especificada.
...
| Áudio |   |  |
| Documentos |  |  |
| Vídeo | Somente o codec de vídeo H.264 e o codec de áudio AAC são compatíveis.  |  |
|  |   |  |
...
| Botão de cancelamento de inscrição para comunicações de marketing |   |
