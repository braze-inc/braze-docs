...
### GIFs e vídeos
 ...
 Para saber mais sobre vídeos em mensagens no app, consulte nossa [documentação de personalização]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/customize/#video).
