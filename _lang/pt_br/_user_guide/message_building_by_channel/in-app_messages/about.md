---
nav_title: "Sobre as mensagens no app"
article_title: Sobre as mensagens no app
page_order: 0
page_type: reference
description: "Este artigo de referência oferece uma breve visão geral das mensagens no app, dos possíveis casos de uso e dos tipos de mensagens padrão."
channel:
  - in-app messages
search_rank: 4.9
---

# [![Curso do Braze Learning]({% image_buster /assets/img/bl_icon3.png %}](https://learning.braze.com/messaging-channels-in-app-in-browser) ){: style="float:right;width:120px;border:0;" class="noimgborder"}Sobre mensagens no app
...
| Campanhas altamente personalizadas | Coloque as mensagens no app como a primeira coisa que seus clientes veem quando entram em seu aplicativo ou site. 
...
![Mensagem no app em slideup que aparece na parte inferior da tela do aplicativo. O slideup inclui uma imagem de ícone e uma mensagem breve.]({% image_buster /assets/img/slideup-behavior.gif %}){: style="border:0px;"}
...
Além desses modelos de mensagens prontos para uso, você também pode personalizar ainda mais seu envio de mensagens usando mensagens no app em HTML personalizado, modais da Web com CSS ou formulários de captura de e-mail na Web. 

## Mais recursos

 Este guia aborda questões de direcionamento, conteúdo e conversão que você deve considerar ao criar mensagens no app.
