...
![O editor de mensagens no app com o modelo de um formulário de envio de e-mail com uma oferta especial.][img1]
...
Personalize a aparência de sua oferta especial usando os [componentes de mensagem no app][3] do tipo arrastar e soltar.
