...
2.  Observe que as mensagens no app não estão disponíveis em campanhas de vários canais.
...
Precisa de ajuda para criar mensagens da direita para a esquerda em idiomas como árabe e hebraico? 
...
|---|---|---|
| | Aplique a partir da galeria de modelos de mensagens no app. |   |
