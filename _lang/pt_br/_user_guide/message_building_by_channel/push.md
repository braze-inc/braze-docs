...
guide_top_text: "As mensagens push são uma forma testada e comprovada de alcançar seus clientes via mobile ou web. Eles são úteis para conduzir um usuário a um local específico, mas você deve usá-los com sabedoria. Leia qualquer um dos artigos a seguir ou confira nosso [curso Push Braze Learning] (https://learning.braze.com/messaging-channels-push) para saber para quem você pode enviar um push, como enviá-lo e quais recursos avançados de push o Braze oferece."
...
- name: Como criar uma mensagem de push
