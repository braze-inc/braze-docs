...
Quando você ativa o [rastreamento de análise de dados para um segmento][9], o Braze permite que você visualize sessões, eventos personalizados e receita ao longo do tempo por esse segmento.
