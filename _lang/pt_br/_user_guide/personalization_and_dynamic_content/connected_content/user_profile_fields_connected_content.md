...
{% endraw %}
 ...
 Isso ocorre porque a Braze precisa saber quais campos recuperar do usuário antes de fazermos a chamada de Conteúdo Conectado.

 O pré-processador Liquid saberá pegar o atributo "language" do usuário para tê-lo pronto para a modelagem da resposta.
...
{% endraw %}
 ...
 Se a própria resposta de Connected Content tiver mais tags de Connected Content ou quaisquer tags de catálogo, o Braze não renderizará novamente essas tags adicionais.
