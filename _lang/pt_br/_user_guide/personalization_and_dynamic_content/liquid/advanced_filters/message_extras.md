...
![Um exemplo de pares de chave-valor para a tag de extras de mensagens. O campo de título diz "Seus novos favoritos". A mensagem lê pares de chave-valor para a tag de extras da mensagem e a frase a seguir: 
