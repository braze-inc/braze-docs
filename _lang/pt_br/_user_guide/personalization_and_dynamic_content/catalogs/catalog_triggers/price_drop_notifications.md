...
3. Se as configurações do catálogo global não foram configuradas, você será solicitado a configurar os eventos personalizados e propriedades que serão usados para disparar notificações. <br><br> 
...
3. Defina a **Regra de queda de preço**. Esta é a lógica usada para determinar se uma notificação deve ser enviada. 
