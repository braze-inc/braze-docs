...
- 
- As seleções são ótimas para refinar as recomendações dos dados do catálogo da Braze. 
...
![O modal Add Personalization com as seguintes seleções: 
...
![Um exemplo de uma seleção para um serviço de entrega de refeições com dois filtros: um que identifica um tipo de produto como uma refeição e outro que identifica a categoria como a mais recentemente visualizada. 
