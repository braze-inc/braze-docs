...
Sua sincronização do CDI pode ter dados duplicados se algum campo do `UPDATED_AT` estiver exatamente no mesmo horário da sincronização anterior.  
...
| Tamanho da carga útil           | Cada linha pode conter uma carga útil de até 1 MB.  |
