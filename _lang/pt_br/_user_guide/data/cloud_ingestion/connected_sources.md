...
Para saber mais sobre como criar um segmento com esta fonte, consulte os [segmentos CDI]({{site.baseurl}}/user_guide/engagement_tools/segments/segment_extension/cdi_segments/).
...
4. Selecione o aplicativo (service principal) que acabou de criar e navegue até **Certificados e segredos > + Novo segredo do cliente**
...
Depois que a fonte é criada, você pode usá-la para criar um ou mais segmentos CDI. Para saber mais sobre como criar um segmento com esta fonte, consulte a [documentação dos Segmentos CDI]({{site.baseurl}}/user_guide/engagement_tools/segments/segment_extension/cdi_segments/).
