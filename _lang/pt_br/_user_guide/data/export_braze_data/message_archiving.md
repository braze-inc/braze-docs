...
Se ainda não tiver feito isso, conecte um bucket de armazenamento em nuvem à Braze. 
...
![A página de Arquivamento de mensagens tem três canais para seleção: 
...
Quando uma mensagem é enviada fora de uma campanha ou do Canva, a ID da campanha no nome do arquivo será "desassociada". 
