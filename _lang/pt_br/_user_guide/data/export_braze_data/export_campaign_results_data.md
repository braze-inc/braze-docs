...
A saída CSV contém dados de perfil de usuários para cada destinatário da campanha. O Braze gerará o relatório em segundo plano e o enviará por e-mail para o usuário que estiver conectado no momento.
 ...
 Caso contrário, o link enviado por e-mail expirará em algumas horas.

 Além desses campos de dados, se você escolher "Export All Recipient Data" (Exportar todos os dados do destinatário), o arquivo exportado também conterá os seguintes dados de cada usuário:
