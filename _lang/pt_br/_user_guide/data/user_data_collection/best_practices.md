...
![Diagrama que mostra o processo de atualização de um perfil de usuário somente de alias. Um usuário envia seu endereço de e-mail e um atributo personalizado, seu código postal, em uma landing page de marketing. Uma seta apontando da coleção da landing page para um perfil de usuário somente de alias mostra uma solicitação da Braze API para o endpoint Track user (Rastrear usuário), com o corpo da solicitação contendo o nome do alias do usuário, o rótulo do alias, o e-mail e o código postal. 
