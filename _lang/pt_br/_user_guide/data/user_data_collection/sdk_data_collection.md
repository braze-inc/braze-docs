...
| País |   | Este atributo é usado para direcionar mensagens com base na localização. |
...
| Início da sessão e fim da sessão | Quando o usuário começa a usar seu app ou site integrado | O SDK do Braze relata dados de sessão usados pelo dashboard do Braze para calcular o engajamento do usuário e outras análise de dados integrais para entender seus usuários.  |
