...
### Atualização de aliases de usuário
 ...
 O alias do usuário ficará visível ao exportar os dados desse usuário.
...
## Caso de uso avançado
 ...
 No entanto, os aliases de usuário não podem ser definidos por meio da API para um perfil de usuário desconhecido existente.
...
Todos os IDs de usuário podem ser usados para encontrar e identificar usuários no dashboard para testes. 
