...
Você pode usar objetos aninhados—objetos que estão dentro de outro objeto—para enviar dados JSON aninhados como propriedades de eventos personalizados e compras. 
...
## Etapa 2: Use o objeto aninhado
  ...
  Consulte as seguintes seções para exemplos de uso:
