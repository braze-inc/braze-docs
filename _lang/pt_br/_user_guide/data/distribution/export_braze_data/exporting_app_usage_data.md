---
nav_title: Exportar análise de dados
...
![Campos período e app na página inicial do dashboard.]({% image_buster /assets/img_archive/home_dashboard_select_date.png %}){: style="max-width:60%;"}
...
![Gráfico Performance ao longo do tempo no dashboard da Página inicial.]({% image_buster /assets/img_archive/home_dashboard_export.png %})
