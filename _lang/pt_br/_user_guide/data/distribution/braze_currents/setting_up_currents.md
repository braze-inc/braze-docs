...
{% alert important %}
É importante manter suas chaves/tokens de parceiro e detalhes de autenticação atualizados; se as credenciais do conector expirarem, o conector deixará de enviar eventos. Se isso persistir por mais de **5 dias**, os eventos do conector serão descartados e os dados serão perdidos permanentemente.
{% endalert %}
