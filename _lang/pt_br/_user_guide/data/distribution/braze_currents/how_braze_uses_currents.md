...
O S3 fornece opções de armazenamento e roteamento flexíveis para mover, pivotar e analisar dados. Não transformamos dados no S3 porque mantemos uma estrutura específica para isso.
