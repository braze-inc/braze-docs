...
Esta página mostra as etapas de sincronização e origem que estão atualmente em Acesso Antecipado (EA). Para etapas e imagens da experiência geralmente disponível, consulte [Experiência de disponibilidade geral](#general-availability-experience).
