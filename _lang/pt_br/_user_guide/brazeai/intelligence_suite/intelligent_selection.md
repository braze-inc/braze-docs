...
Uma variante que pareça ter um desempenho melhor do que outras será enviada a mais usuários, enquanto as variantes com desempenho inferior serão direcionadas a menos usuários. Cada ajuste é feito usando um [algoritmo estatístico](https://en.wikipedia.org/wiki/Multi-armed_bandit) que garante que o Braze está ajustando para diferenças reais de performance e não apenas por acaso.
...
- Você definiu um evento de conversão para medir a performance entre as variantes.
