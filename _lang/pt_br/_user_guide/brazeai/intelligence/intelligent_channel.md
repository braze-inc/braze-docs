...
Em vez de deixar a Braze escolher o melhor canal para um usuário, você também pode filtrar os usuários com base na probabilidade de eles abrirem ou não uma mensagem em um canal específico que você escolher. 
