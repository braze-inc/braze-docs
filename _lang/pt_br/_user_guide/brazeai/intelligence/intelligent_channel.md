---
nav_title: Filtro Canal Inteligente
...
Para ativar o filtro Canal Inteligente, selecione o filtro **Canal Inteligente** na página **Direcionar usuários** ao criar uma campanha de e-mail, web push ou mobile push.

{% alert important %}
Para calcular a taxa de engajamento do canal de SMS, ative o [encurtamento de links de SMS]({{site.baseurl}}/user_guide/message_building_by_channel/sms/campaign/link_shortening/#overview/) com rastreamento avançado e rastreamento de cliques.
{% endalert %}
