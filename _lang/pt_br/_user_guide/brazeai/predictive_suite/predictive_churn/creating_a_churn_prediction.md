...
![Churn Definition (Definição de rotatividade), em que um usuário é considerado churn se não iniciar uma sessão em 7 dias][1]
...
![Cronograma de atualização da previsão definido para diariamente às 17 horas.][2]
