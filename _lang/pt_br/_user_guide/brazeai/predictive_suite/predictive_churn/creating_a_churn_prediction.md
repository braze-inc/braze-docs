...
- **Aqueles que correm o risco de não comprar como uma definição de churn**<br>Você pode querer se concentrar em clientes que têm navegado ou pesquisado, ou interagido com seu app mais recentemente. Talvez a intervenção correta de desconto impeça esse grupo mais engajado de churn.
