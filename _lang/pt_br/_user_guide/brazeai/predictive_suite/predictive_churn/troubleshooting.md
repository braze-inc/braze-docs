...
![Requisitos de dados de previsão mostrando 31 churners passados (atende ao requisito) e 0 não-churners passados (abaixo do mínimo). Uma mensagem de aviso indica que não há não-churners suficientes para construir a previsão.]({% image_buster /assets/img/churn/audience_size_error.png %})
