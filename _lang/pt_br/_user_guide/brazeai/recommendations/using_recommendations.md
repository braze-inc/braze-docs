...
## Uso de recomendações em seu envio de mensagens
...
Você pode escrever código Liquid personalizado fazendo referência ao objeto `product_recommendation` de um catálogo. Ele contém todos os dados de recomendação do produto gerados dinamicamente para esse catálogo, estruturados como um vetor de objetos, em que cada objeto representa um item recomendado.
