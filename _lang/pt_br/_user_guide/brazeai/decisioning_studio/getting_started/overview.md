...
page_order: 1
page_type: reference
description: "Esta referência fornece uma visão geral das etapas envolvidas na configuração do Decisioning Studio, incluindo a conexão de fontes de dados, a configuração da orquestração e o projeto do agente de decisão."
---
...
- [Projetando agentes de decisão]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/getting_started/designing_decisioning_agents/)