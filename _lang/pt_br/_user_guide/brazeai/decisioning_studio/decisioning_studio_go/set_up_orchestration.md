...
{% alert note %}
Se o seu experimentador tiver um modelo básico, prossiga para a etapa 2. Se o seu experimentador tiver dois ou mais modelos básicos, pule para [Etapa 3: Adicione uma divisão de disparo ao seu fluxo](#step-3-add-a-trigger-split-to-your-flow).
{% endalert %}
...
9\. No nó do e-mail, atualize o modo de **Rascunho** para **Ativo**.
...
10\. No nó do e-mail, atualize o modo de **Rascunho** para **Ativo**.
...
6\. Defina a **linha de assunto** como {% raw %}`{{event.SubjectLine}}`{% endraw %} e desmarque a caixa de seleção **Ignorar perfis enviados recentemente por e-mail**.
