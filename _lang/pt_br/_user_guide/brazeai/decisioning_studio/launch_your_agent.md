...
For detailed requirements on preparing these critical feedback data assets, see [Preparing your data]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/preparing_your_data/).
