...
## Sobre a biblioteca de mídia

A biblioteca de mídia permite que você gerencie seus ativos em um único local centralizado. Para acessar sua biblioteca de mídia do Braze, acesse **Modelos** > **Biblioteca de mídia**. Para saber mais, consulte [Biblioteca de mídia]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/media_library/).

## Geração de uma imagem

1. Acesse sua biblioteca de mídia e selecione <i class="fas fa-wand-magic-sparkles"></i> **IA Image Generator**.
