---
nav_title: Exportação de dados do Braze
article_title: Exportação de dados do Braze
page_order: 6
layout: dev_guide
guide_top_header: "Exportação de dados do Braze"
...
page_type: landing
description: "Essa landing page contém recursos sobre a exportação de dados do Braze, como a exportação de resultados de campanhas e do Canvas, dados de segmentos, visão geral e dados de receita, entre outros."
tool: Reports

guide_featured_title: "Artigos populares"

guide_featured_list:
  - name: Exportar resultados da campanha
    link: /docs/user_guide/data_and_analytics/export_braze_data/export_campaign_results_data/
    image: /assets/img/braze_icons/bar-chart-01.svg
  - name: Exportar resultados do Canvas
    link: /docs/user_guide/data_and_analytics/export_braze_data/export_canvas_data/
    image: /assets/img/braze_icons/palette.svg
  - name: Exportar dados do segmento
...
guide_menu_list:
  ...
  - name: Solução de problemas de exportação
...
guide_menu_list2:
  ...
  - name: Como o Braze usa Currents
