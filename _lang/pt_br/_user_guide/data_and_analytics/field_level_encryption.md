...
No dashboard do Braze, acesse **Data Settings** > **Field-Level Encryption**( **Configurações de dados** > **Criptografia em nível de campo**). Para suas configurações do AWS KMS, digite o seguinte:
