...
page_type: reference
description: "Este artigo de referência aborda a página Relatório de receita."
tool: Reports
---
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md metric='Valor do tempo de vida por usuário' %}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md metric='Receita diária por usuário' %}</td>
        </tr>
    </tbody>
</table>
