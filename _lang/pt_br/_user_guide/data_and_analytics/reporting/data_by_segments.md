...
page_order: 2.5
page_type: reference
description: "Este artigo de referência mostra como você pode usar os modelos de relatório do Query Builder para detalhar as métricas de performance de campanhas, Canvas, variantes e etapas de segmentos."
tool: 
  - Segments
  - Reports
...
1. No **Criador de consultas**, escolha criar um novo relatório SQL por meio de um modelo. 
2. Filtre modelos para aqueles em que as métricas incluem "detalhamentos de segmentos", que são:
...
Atualmente, esse relatório extrai métricas apenas do canal de e-mail. Quaisquer dados de receita ou compra de outros canais além de e-mails não serão refletidos no relatório. 
