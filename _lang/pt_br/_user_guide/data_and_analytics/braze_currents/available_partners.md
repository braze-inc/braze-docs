...
> Esta página descreve os casos de uso dos parceiros de dados que você pode usar para se integrar ao Braze Currents.
...
Estamos tão confiantes no poder do Currents e dos data warehouses juntos que [nós mesmos os usamos]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/how_braze_uses_currents/)!
