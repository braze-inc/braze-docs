...
{% alert note %}
  Dependendo da sua integração com o Currents, pode haver diferentes eventos que devem ser configurados (como [eventos de engajamento com mensagens ou envio de mensagens]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/message_engagement_events/) e [eventos de comportamento do usuário ou do cliente]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/customer_behavior_events/)). Você também pode escrever um script para parte ou todo esse processo.
{% endalert %}
