...
{% alert note %}
Se estiver usando a [navegação mais antiga]({{site.baseurl}}/navigation), poderá encontrar a página do relatório **Eventos personalizados** em **Dados**.
{% endalert %}
...
- Eventos personalizados por data
