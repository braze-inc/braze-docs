...
Esse gráfico de barras mostra as contagens absolutas de cada [evento de engajamento]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/message_engagement_events) com base no canal selecionado. A contagem de conversões será definida de acordo com o método de atribuição selecionado.
