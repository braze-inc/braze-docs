...
{% multi_lang_include metrics.md metric='Taxa de cliques para abertura' %}
...
{% multi_lang_include metrics.md metric='Entregas confirmadas' %} Como cliente Braze, as entregas são cobradas em sua cota de SMS. 
...
{% multi_lang_include metrics.md metric='Botão da página de confirmação' %}
...
{% multi_lang_include metrics.md metric='Retiradas da página de confirmação' %}
...
{% multi_lang_include metrics.md metric='Enviável por e-mail' %}
...
{% multi_lang_include metrics.md metric='Aberturas por influência' %}
...
{% multi_lang_include metrics.md metric='Valor do tempo de vida por usuário' %}
...
{% multi_lang_include metrics.md metric='Receita diária por usuário' %}
...
{% multi_lang_include metrics.md metric='Rejeições' %} Como cliente do Braze, as rejeições são cobradas em sua cota de SMS.
...
{% multi_lang_include metrics.md metric='Mensagens enviadas' %} Essa métrica é fornecida pelo Braze. Observe que, ao lançar uma campanha programada, essa métrica incluirá todas as mensagens enviadas, independentemente de já terem sido enviadas devido ao limite de frequência.
...
{% multi_lang_include metrics.md metric='Envia para a operadora' %} 
...
{% multi_lang_include metrics.md metric='Demissões de páginas de pesquisa' %}
...
{% multi_lang_include metrics.md metric='Envios de pesquisa' %}
...
{% multi_lang_include metrics.md metric='Cancelamento de inscrição ou cancelamento de assinatura' %}

{::nomarkdown}
<span class="calculation-line">
    Cálculo:
    <ul>
        <li>Cancelamento <i>de inscrição</i> ou <i>Unsub</i>: Contagem</li>
        <li><i>% de cancelamentos</i> <i>de inscrição</i> ou <i>taxa de cancelamento de inscrição</i>: (Cancelamentos de inscrição) / (Entregas)</li>
    </ul>
</span>
{:/}
...
{% multi_lang_include metrics.md metric='Cancelamentos inscrição' %}
