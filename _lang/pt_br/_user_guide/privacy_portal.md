...
layout: dev_guide
search_rank: 3
guide_top_header: "Portal de privacidade do Braze"
guide_top_text: "> Bem-vindo ao Portal de Privacidade Braze. Aqui você encontrará todos os tipos de informações úteis sobre como o Braze pode ajudá-lo a ser um bom guardião dos dados de seus clientes e, o que é mais importante, ativar medidas para cumprir as regras de proteção de dados relevantes para a sua empresa. Reunimos informações e links para documentação que podem ajudá-lo a usar os Serviços Braze em conformidade com as leis e os regulamentos de proteção de dados aplicáveis."
...
- name: Grupos de inscrição de SMS
...
- name: Coleta de dados padrão e mínima do SDK
  ...
  image: /assets/img/braze_icons/settings-01.svg
- name: Considerações sobre privacidade de dados do Canva Audience Sync
...
- name: Certificados de segurança do Braze
