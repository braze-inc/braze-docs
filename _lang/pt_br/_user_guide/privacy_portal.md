---
nav_title: Portal de privacidade
article_title: Portal de privacidade
page_order: 60
layout: dev_guide
search_rank: 3
guide_top_header: "Portal de Privacidade Braze"
guide_top_text: "> Bem-vindo ao Portal de Privacidade Braze. Aqui você encontrará todos os tipos de informações úteis sobre como o Braze pode ajudá-lo a ser um bom guardião dos dados de seus clientes e, o que é mais importante, permitir que você tome medidas para cumprir as regras de proteção de dados relevantes para a sua empresa. Reunimos informações e links para documentação que podem ajudá-lo a usar os Serviços Braze em conformidade com as leis e os regulamentos de proteção de dados aplicáveis."
...
guide_featured_title: "Uso de brasagem"
guide_featured_list:
...
- name: Retenção de dados do Braze
...
- name: Perguntas frequentes sobre o GDPR
...
As informações fornecidas aqui têm apenas fins educacionais e não devem ser interpretadas como aconselhamento jurídico. A Braze incentiva todos os nossos clientes a buscarem seu próprio aconselhamento jurídico sobre o uso da Braze em conformidade com as leis e regulamentos de proteção de dados.
{% endalert %}
