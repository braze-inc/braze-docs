...
> O Braze Pilot suporta links profundos de mensagens do Braze para partes específicas do aplicativo Pilot. Isso permite que você crie casos de uso de engajamento, direcionando os usuários para várias partes do aplicativo Pilot. Você também pode usar parâmetros opcionais de links profundos para personalizar o conteúdo em páginas específicas do aplicativo para o usuário. Para mais informações sobre links profundos, veja [Links profundos para conteúdo no aplicativo]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/deep_linking_to_in-app_content/#what-is-deep-linking).

## Geral

Estes são os links profundos para as principais páginas de navegação no aplicativo Pilot. 
...
Estes são os links profundos para o aplicativo da marca fictícia Steppington no Pilot.
...
### Links profundos sem parâmetros
...
### Links profundos com parâmetros
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Uma string representando qual ícone usar.</td>
            <td>Não</td>
        ...
        <tr>
            ...
            <td>Informações sobre o treino a serem colocadas sobre o botão de início do treino.</td>
            <td>Sim</td>
            <td></td>
            <td>String</td>
            <td>Este%20treino%20é%20incrível%21</td>
        </tr>
        <tr>
            <td><code>workout</code></td>
            <td>O nome do treino. Enviado no <code>st_completed_class</code> evento.</td>
            <td>Sim</td>
            <td></td>
            <td>Número</td>
            <td>Corrida%20de%205k</td>
        </tr>
        <tr>
            <td><code>calories</code></td>
            <td>O número de calorias a ser exibido na tela do treino ativo. Enviado no <code>st_completed_class</code> evento.</td>
            <td>Não</td>
        ...
        <tr>
            ...
            <td>A duração do treino. Enviado no <code>st_completed_class</code> evento.</td>
            <td>Não</td>
            <td></td>
            <td>Número</td>
            <td>25</td>
...
| `YOGA_HOME` | ![Um ícone de pessoa em uma pose de yoga.]({% image_buster /assets/img/braze_pilot/yoga_home_icon.png %}){:style="max-width:30%"} |
...
Esses são os links diretos para o aplicativo da marca fictícia PantsLabyrinth no Pilot.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Uma string representando o tamanho do item.</td>
            <td>Não</td>
            <td>M</td>
            <td>String</td>
            <td>Grande</td>
        ...
        <tr>
            ...
            <td>Uma lista de cores em hexadecimais separadas por vírgulas. Estas são as cores disponíveis para o item.</td>
            <td>Não</td>
            <td>#000000</td>
            <td>String</td>
            <td>#0000FF,#FF0000</td>
        ...
        <tr>
            ...
            <td>Uma lista das strings de cores separadas por vírgulas. Representa as cores em texto.</td>
            <td>Não</td>
            <td>Preto</td>
            <td>String</td>
            <td>Azul, Vermelho</td>
        ...
        <tr>
            ...
            <td>O índice selecionado da cor a ser escolhida no seletor de cores quando o usuário chegar na tela. Se nenhum valor for usado, ele terá a primeira cor selecionada.</td>
            <td>Não</td>
            <td>0</td>
            <td>Número</td>
            <td>1</td>
...
| `thumbnail` | A URL da miniatura que será exibida antes do filme. | Sim | String | `https://picsum.photos/400` |
