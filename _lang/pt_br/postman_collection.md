...
3. Dê um nome a este ambiente (por exemplo, "Solicitações de API da Braze") e adicione chaves para `instance_url` e `api_key` com valores correspondentes à sua [Braze instance]({{site.baseurl}}/developer_guide/rest_api/basics/#endpoints) e [Braze REST API Key]({{site.baseurl}}/api/api_key/).
4. Clique em **Salvar**.
