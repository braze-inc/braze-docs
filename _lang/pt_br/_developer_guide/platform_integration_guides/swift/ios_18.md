---
nav_title: Guia de atualização do iOS 18
article_title: Guia de atualização do iOS 18
page_order: 7
platform: 
  - iOS
...
O [Live Activities](https://www.braze.com/docs/developer_guide/platform_integration_guides/swift/live_activities/live_activities) será compatível com o watchOS 11. Nenhuma configuração adicional é necessária; no entanto, a Apple oferece a opção de personalizar a interface do relógio.
