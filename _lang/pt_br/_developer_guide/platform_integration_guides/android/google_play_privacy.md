---
nav_title: Questionário de privacidade do Google Play
article_title: Respostas para perguntas sobre a privacidade da Google Play Store
page_order: 9
platform: 
  - Android
  - FireOS
description: "Este artigo de referência aborda como responder a perguntas sobre a privacidade do Google Play."
...
Para saber mais sobre outros dados de dispositivos que o Braze coleta e que podem estar fora do escopo das diretrizes de segurança de dados do Google Play, consulte nossa [visão geral do armazenamento Android]({{site.baseurl}}/developer_guide/platform_integration_guides/android/storage) e nossas [opções de coleta de dados SDK]({{site.baseurl}}/user_guide/data_and_analytics/user_data_collection/sdk_data_collection/#minimum-integration).
