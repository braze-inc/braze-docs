---
nav_title: Integrações de TV e OTT
article_title: Integrações de TV e OTT
page_order: 15
...
Para saber mais, visite o [guia de integração do Fire OS]({{site.baseurl}}/developer_guide/platform_integration_guides/android/initial_sdk_setup/android_sdk_integration/).
...
Para saber mais, visite o [guia de integração da Web Smart TV]({{site.baseurl}}/developer_guide/platform_integration_guides/web/smart_tvs/).
...
Para saber mais, acesse o [guia de integração do Roku]({{site.baseurl}}/developer_guide/platform_integration_guides/roku/in-app_messaging/overview/).
...
**Android SDK**
- [Customização de mensagem no app](https://www.braze.com/docs/developer_guide/platform_integration_guides/android/in-app_messaging/customization/custom_listeners/)
- [Personalização de Cartões de Conteúdo](https://www.braze.com/docs/developer_guide/platform_integration_guides/android/content_cards/implementation_guide/)
...
**SDK para Web**
- [Customização de mensagem no app](https://www.braze.com/docs/developer_guide/platform_integration_guides/web/in-app_messaging/customization/key_value_pairs)
- [Personalização de Cartões de Conteúdo](https://www.braze.com/docs/developer_guide/platform_integration_guides/web/content_cards/customization/custom_ui/)
