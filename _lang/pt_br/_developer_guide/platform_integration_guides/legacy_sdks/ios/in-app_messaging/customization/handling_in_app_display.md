...
Você pode usar o método delegado `beforeInAppMessageDisplayed:` para adicionar a lógica de exibição de mensagens no app, personalizar as mensagens no app antes que o Braze as exiba ou recusar totalmente a lógica de exibição de mensagens no app e a interface do usuário do Braze.
