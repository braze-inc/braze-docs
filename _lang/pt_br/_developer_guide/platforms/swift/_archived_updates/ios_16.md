---
nav_title: guia de atualização do iOS 16
...
2. Nosso SDK SWIFT da Braze suporta um novo recurso de primer de push ["sem código"]({{site.baseurl}}/user_guide/message_building_by_channel/push/best_practices/push_primer_messages/)!
