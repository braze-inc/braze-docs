...
> A partir do [Braze Swift SDK 8.0.0](https://github.com/braze-inc/braze-swift-sdk/blob/main/CHANGELOG.md#800), é possível usar a Braze com o [visionOS](https://developer.apple.com/visionos/), a plataforma de computação espacial da Apple para o Apple Vision Pro. Para ver um exemplo de app do visionOS utilizando a Braze, consulte [Apps de amostra]({{site.baseurl}}/developer_guide/references/?tab=swift).
