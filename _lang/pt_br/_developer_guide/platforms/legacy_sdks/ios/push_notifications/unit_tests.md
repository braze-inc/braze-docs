...
Usando o mesmo método que você usou inicialmente para [instalar o SDK da Braze]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/initial_sdk_setup/overview/), confira se a mesma instalação do SDK também está disponível para o direcionamento de seus testes de unidade. Por exemplo, usando o CocoaPods:
