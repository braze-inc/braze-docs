...
![A caixa de seleção geofence localizada nas páginas de configurações do Braze.]({% image_buster /assets/img_archive/enable-geofences-app-settings-page.png %})
