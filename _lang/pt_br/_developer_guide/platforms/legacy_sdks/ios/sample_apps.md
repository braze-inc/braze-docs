...
As notificações por push para o aplicativo de teste iOS exigem configuração adicional. Consulte nossa [integração com o iOS Push]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/integration/) para obter detalhes.
