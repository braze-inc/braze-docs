...
![Um cartão de conteúdo clássico. Um cartão de conteúdo clássico mostra uma imagem no centro do cartão com as palavras "Obrigado por baixar o Braze Demo" embaixo.]({% image_buster /assets/img/interface3.png %}){: style="max-width:18%;margin-left:15px;"}
