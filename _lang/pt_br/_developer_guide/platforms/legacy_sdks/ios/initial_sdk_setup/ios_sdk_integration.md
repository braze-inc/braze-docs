...
Em seguida, registre-se para receber notificações por push. Este guia pressupõe que você tenha configurado [suas credenciais push corretamente]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/integration/) no portal do desenvolvedor da Apple e no projeto Xcode. 
...
- [Guia de implementação de notificações por push avançadas]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/implementation_guide/)
- [Guia de implementação de mensagens no app avançadas]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/in-app_messaging/implementation_guide/)
- [Guia de implementação do cartão de conteúdo avançado]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/content_cards/implementation_guide/)
