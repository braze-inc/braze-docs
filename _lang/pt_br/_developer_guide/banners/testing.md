---
nav_title: Testar Banners
article_title: Testar Banners
page_order: 2
...
Antes de testar mensagens de Banner no Braze, você precisará criar uma [campanha de Banner no Braze]({{site.baseurl}}/user_guide/message_building_by_channel/banners/create/). Além disso, verifique se o local que você deseja testar já está [colocado em seu app ou site]({{site.baseurl}}/developer_guide/banners/placements). 
