...
description: "Saiba mais sobre como personalizar Cartões de Conteúdo para o SDK do Braze."
layout: dev_guide

guide_top_header: "Personalizando Cartões de Conteúdo"
guide_top_text: "> Saiba mais sobre como personalizar Cartões de Conteúdo para o SDK do Braze."

guide_featured_title: "Artigos nesta seção"
guide_featured_list:
- name: Personalizando Estilo do Cartão
  link: /docs/developer_guide/content_cards/customizing_cards/style/
  image: /assets/img/braze_icons/edit-03.svg
- name: Personalização do comportamento do cartão
  link: /docs/developer_guide/content_cards/customizing_cards/behavior/
  image: /assets/img/braze_icons/sliders-01.svg
- name: Personalizando Feed do Cartão
