...
Para saber mais, consulte [Armazenamento]({{site.baseurl}}/developer_guide/platforms/swift/storage/) na documentação do Swift SDK.
...
{% alert tip %}
Se você tiver um app iOS, confirme se está usando o [Swift SDK]({{site.baseurl}}/developer_guide/platforms/swift/sdk_integration/) em vez do antigo [Objective-C iOS SDK]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/initial_sdk_setup/overview/) se a **Versão do Live SDK** for igual ou superior a 5.0.0, que foi a primeira versão lançada do Swift SDK.
{% endalert %}
