...
A API do Braze fornece [pontos de extremidade]({{site.baseurl}}/api/endpoints/export) que permitem exportar análises agregadas de forma programática, bem como exportar dados de usuários individuais. Esses dados podem ser exportados para públicos e segmentos de qualquer tamanho. 
