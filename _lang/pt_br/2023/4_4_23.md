...
![Uma série de trilhas de navegação do Guia do usuário > Criação de mensagens por canal > Mensagens no app > Modelos > Pesquisa simples]({% image_buster /assets/img/doc-breadcrumbs.png %}){: style="max-width:55%"}
...
{% alert important %}
O editor SQL está em acesso antecipado. Se você estiver interessado em participar do acesso antecipado, entre em contato com seu gerente de sucesso do cliente.
{% endalert %}
...
## Eventos do New Currents: users_campaigns_abort e users_canvas_abort
...
[O Backfill Histórico do Shopify]({{site.baseurl}}/partners/ecommerce/shopify_legacy/shopify_features/shopify_backfill) permite que o Braze importe todos os clientes, pedidos e eventos de compra dos últimos 90 dias anteriores à sua conexão de integração com o Shopify.
