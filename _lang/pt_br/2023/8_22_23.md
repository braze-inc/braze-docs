...
{% multi_lang_include early_access_beta_alert.md feature='A capacidade de mesclar usuários por e-mail e usar o `/users/merge` endpoint com identificadores incompatíveis' %}
