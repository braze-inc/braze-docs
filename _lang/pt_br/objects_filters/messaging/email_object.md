...
- Para obter mais informações e práticas recomendadas sobre pré-cabeçalhos, consulte nosso artigo de ajuda sobre [estilo de corpo de e-mail]({{site.baseurl}}/user_guide/message_building_by_channel/email/best_practices/guidelines_and_tips/#body-styling).
...
![Seção API Identifier de um modelo de e-mail em HTML.]({% image_buster /assets/img_archive/email_template_id.png %}){: style="max-width:70%;"} 
