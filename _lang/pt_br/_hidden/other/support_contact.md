...
<div>
    <div class="container-fluid" id="main-container">
      <div class="row main-form">
          <div class="col" >
              <h1 class="h1">Precisa de ajuda? </h1>
...
<div class="form-container1"  style="display:none;">
 <div id="step3" >
<div id="firefox_warning" style="display:none;">Para usuários do Firefox, permita a lista deste site ou verifique suas <a href="https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Privacy/Tracking_Protection?utm_source=mozilla&utm_medium=firefox-console-errors&utm_campaign=default" target="_blank">Configurações de Proteção contra Rastreamento</a>, ou seu ticket pode não ser enviado.</div>

<div id="ticket_mainform" class="container">
    <form  id="ticket_form">
      <div id="step3">
        <h2>Não está encontrando o que precisa? Entre em contato com nossa equipe de suporte.</h2>
        <!-- Row 1 -->
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="ticket_topic" class="required">Em que podemos ajudá-lo? </label>
              <select id="ticket_topic" name="00N0V000009G0MG" class="form-control"></select>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="ticket_category" class="required">Categoria </label>
