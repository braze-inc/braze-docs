---
nav_title: Créditos de mensagens - Sigma
...
# Créditos do envio de mensagens - Sigma (Confidencial)

> Créditos de mensagem é a estrutura de envio de mensagens entre canais da Braze para nossas ofertas nativas de SMS, MMS e WhatsApp. Os Créditos de Mensagem proporcionam uma experiência flexível e transparente ao aproveitar os canais de envio de mensagens da Braze. Os créditos dão acesso a qualquer um dos canais apresentados na tabela desta página.
...
Em outras palavras, os créditos por mensagens do WhatsApp serão calculados com base nas iniciações de conversa, e os créditos tanto para mensagens SMS quanto MMS serão calculados com base nos segmentos enviados.
<br><br>
...
| **Créditos por 1 envio** | Número exato de Crédito de Mensagem para enviar uma mensagem<br> (créditos por mensagem = taxa de crédito do canal x multiplicador de destino) |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }


## Tabela de proporção de crédito para créditos de mensagens - Sigma
...
{% alert note %}
A partir de 1º de novembro de 2024, conversas do tipo serviço são gratuitas e não serão descontadas das allotments de créditos comprados.
{% endalert %}
