---
nav_title: Créditos de mensagens - Gamma
...
# Créditos do envio de mensagens - Gamma (Confidencial)
...
|---------|-------------------------------------------------|
| **Taxa de crédito do canal** | Valor do crédito de linha de base para cada canal |
...
## Tabela de proporção de crédito para créditos de mensagens - Gamma
...
<table>
    ...
    <tr>
        <th><b>Canal</b></th>
        <th><b>Taxa de crédito do canal</b></th>
        <th><b>Destino</b></th>
