...
_Esta integração é mantida pela Scuba Análise de Dados._
...
![Criação de um novo segmento no Braze.]({% image_buster /assets/img/scuba/analytics/segment_name.png %})
...
![Selecionar o filtro "Atributo personalizado" em "Detalhes do segmento".]({% image_buster /assets/img/scuba/analytics/filter_attribute.png %})
...
![Escolha de uma operação e de um valor para o ]({% image_buster /assets/img/scuba/analytics/operator_end.png %})
