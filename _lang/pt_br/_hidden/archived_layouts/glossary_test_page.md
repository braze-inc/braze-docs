...
glossary_top_header: "Modelo de Glossário"
glossary_top_text: "Esta é uma página de Glossário de teste."
...
glossaries:
  - name: Termo 1
    ...
    description: Definição do termo 1.
    calculation: Calculation / Of Term 1
    tags:
      - All
  - name: Termo 2
    description: Definição do termo 2.
    calculation: (Number of Terms) / (Unique Terms)
    tags:
      - Tag 1
  - name: Termo 3
    description: Definição do termo 3.
    calculation: Count
    tags:
      - Tag 2
  - name: Termo 4
    description: Definição do termo 4.
    calculation: Count
    tags:
      - Tag 1
      - Tag 3
