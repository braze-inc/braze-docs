...
{% comment %}
Sobre este layout:
Esse layout é para guias de início rápido, guias passo a passo de produtos ou recursos e guias passo a passo de solução de problemas sem um vídeo. Este tutorial terá um TOC que mostra todos os níveis de cabeçalho.
Tutoriais:
...
{% endcomment %}
# Como dar um título a este tutorial
