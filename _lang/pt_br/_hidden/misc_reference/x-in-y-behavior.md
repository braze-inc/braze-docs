...
![Cronograma da campanha]({% image_buster /assets/img/campaign-schuedule-example.png %})
...
`Send in 1 Calendar days at 11:05 am company time` ou `send in 1 Calendar days at 11:05 am local time` adicionaria o dia `1` ao dia do calendário atual no fuso horário da empresa ou no fuso local, respectivamente, e agendaria a mensagem para as próximas 11h05 no horário da empresa.
