...
page_type: solution
description: "Este artigo de ajuda cobre mensagens de erro comuns relacionadas a push para iOS e Android, e orienta você através de possíveis soluções."
channel: push
platform:
- iOS
- Android
...
Confira estas mensagens de erro comuns para push envio de mensagens:
...
### Push devolvido: Erro ao enviar para token por push inválido
...
- O token por push não está sendo enviado para nós corretamente em `[[Appboy sharedInstance] registerPushToken:]`
	- Verifique o token no **Registro de Atividade de Mensagens**. Deve geralmente parecer uma longa sequência de letras e números. (e.g `6e407a9be8d07f0cdeb9e714733a89445f57a89ec890d63867c482a483506fa6`) Se não parecer, verifique o código envolvido no envio de erros de token por push do Braze.<br><br>
