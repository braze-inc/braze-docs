---
nav_title: Opções de filtro alteradas
article_title: Opções de filtro alteradas
page_order: 0

page_type: solution
description: "Este artigo de ajuda aborda o que significa quando as opções de filtro para seus atributos personalizados são alteradas."
tool: Segments
---
...
_Última atualização em 5 de maio de 2021_
