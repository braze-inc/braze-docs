---
nav_title: Como lidar com aumentos nas taxas de cliques
article_title: Como lidar com aumentos nas taxas de cliques
page_order: 1

page_type: solution
description: "Este artigo de ajuda o orienta sobre como lidar com o aumento das taxas de cliques em seus e-mails."
channel: email
---
...
Em última análise, depois que um e-mail deixa nossos servidores, temos visibilidade limitada do que acontece em seguida, mas aqui estão nossas recomendações para gerenciar o NHI que afeta seus resultados:
...
6. Adicione um link oculto em suas campanhas de e-mail. Esse link seria algo que um ser humano não perceberia, como um texto branco sobre branco ou um sinal de pontuação. Como os bots tendem a clicar em todos os links, é possível concluir que os usuários que geram eventos de clique no link invisível são, na verdade, o resultado do NHI, portanto, a abertura ou o clique não indica necessariamente um engajamento positivo.