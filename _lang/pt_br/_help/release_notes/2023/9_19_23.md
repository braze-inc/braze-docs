...
O [Braze Data Transformation]({{site.baseurl}}/user_guide/data_and_analytics/data_transformation/overview/) permite que você crie e gerencie integrações de webhook para automatizar o fluxo de dados de plataformas externas para os perfis de usuários do Braze. Esses dados de usuários recém-integrados podem, então, alimentar casos de uso de marketing ainda mais sofisticados.
...
O [Centro de Entregabilidade]({{site.baseurl}}/user_guide/data_and_analytics/analytics/deliverability_center) fornece mais insights sobre sua performance de e-mail, apoiando o uso das Ferramentas do Postmaster do Gmail para rastrear dados sobre e-mails enviados e coletar dados sobre seu domínio de envio. 
...
- [Rápido]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/in-app_messaging/customization/setting_delegates/#disabling-dark-mode)
