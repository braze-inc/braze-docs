...
- [Swift SDK 7.0.0](https://github.com/braze-inc/braze-swift-sdk/blob/main/CHANGELOG.md)
    - A configuração `useUUIDAsDeviceId` agora está ativada por padrão.
        - Para saber mais sobre os impactos, consulte a seção [Coleta de IDFV - Swift]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/initial_sdk_setup/swift_idfv/).
