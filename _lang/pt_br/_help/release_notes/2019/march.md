...
noindex: true
page_type: update
description: "Este artigo contém notas de versão para março de 2019."
---

# Março de 2019

## Mensagens no app - Geração 3

A Braze tem o orgulho de anunciar que fizemos melhorias na aparência e na sensação de nossas mensagens no app para aderir às melhores práticas de UX e UI mais recentes. Nas mensagens mais recentes no app, você pode esperar que seus usuários interajam com mensagens com:
- Tamanhos de fonte maiores
- Espaçamento refinado
- Um novo ativo próximo `x`
...
## Atualização do arquivo de Blocos de Conteúdo

Agora você pode arquivar e desarquivar [Blocos de Conteúdo]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/content_blocks/#archiving-content-blocks).

## Adição de parceiro Inkit

Agora você pode usar [Inkit]({{site.baseurl}}/partners/inkit/) como um modelo de webhook pré-desenhado ou criar uma nova campanha de webhook.
