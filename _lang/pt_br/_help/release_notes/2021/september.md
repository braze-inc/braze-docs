...
Os guias do desenvolvedor do Android e do FireOS foram mesclados em um único local. Artigos dedicados ao FireOS estarão disponíveis nesta [nova seção do Android]({{site.baseurl}}/developer_guide/platform_integration_guides/android/push_notifications/fireos/integration/).

## Atualizações nos relatórios de funil e retenção

[Relatórios de funil]({{site.baseurl}}/user_guide/engagement_tools/canvas/canvas_funnel_reports/) e [relatórios de retenção]({{site.baseurl}}/user_guide/engagement_tools/campaigns/testing_and_more/retention_reports/) agora estão disponíveis para campanhas de SMS.
