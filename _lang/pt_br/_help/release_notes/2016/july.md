...
Adicionamos uma coluna que indica a variação da mensagem recebida à exportação CSV dos destinatários da campanha. Saiba mais sobre como [exportar dados]({{site.baseurl}}/user_guide/data_and_analytics/exporting_dashboard_data/#exporting-dashboard-data) do Braze.
