...
noindex: true
page_type: update
description: "Este artigo contém notas de versão para novembro de 2020."
---
 
# Novembro de 2020

## A parceria com a Tealium está ativa

[O Tealium]({{site.baseurl}}/partners/data_and_infrastructure_agility/customer_data_platform/tealium/#about-tealium) é um hub de dados que facilita a conexão de dados móveis, da Web e alternativos de fontes de terceiros. Quando conectado ao Braze, o Tealium ativa um fluxo de dados de eventos personalizados, atributos de usuários e compras para ação de dados em tempo real.

## Portal do Produto Braze

O [Portal do Produto Braze]({{site.baseurl}}/user_guide/administrative/access_braze/portal/#product-portal-) contém o roteiro de produtos Braze e a oportunidade para os usuários enviarem ideias. Você também pode ver quais recursos foram lançados recentemente. O portal do produto pode ser encontrado no dashboard da Braze em **Recursos**.
