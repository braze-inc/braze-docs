...
Você já se perguntou quando e como deve coletar dados de usuários ao lidar com usuários conhecidos e desconhecidos? Sabemos que o ciclo de vida de um perfil de usuário no Braze pode ser um pouco confuso, então reunimos algumas [melhores práticas de coleta de dados]({{site.baseurl}}/user_guide/data_and_analytics/user_data_collection/best_practices/) para ajudar a esclarecer diferentes métodos e melhores práticas para coletar dados de usuários novos e existentes.
