---
nav_title: "POST: Atualizar o status do grupo de inscrições dos usuários"
...
Se você quiser ver exemplos ou testar este endpoint para **Grupos de Inscrição de SMS e RCS**:
...
```
\* Grupos de inscrição de SMS e RCS: Somente `external_id` ou `phone` são aceitos.
