...
layout: api_page
page_type: reference
description: "Este artigo traz informações sobre o endpoint da Braze \"Procurar o ID de recurso de uma conta de usuário existente no dashboard.\""
---

{% api %}
# Procure uma conta de usuário existente no dashboard pelo ID de recurso
{% apimethod get %}
/scim/v2/Users/{id}
{% endapimethod %}
