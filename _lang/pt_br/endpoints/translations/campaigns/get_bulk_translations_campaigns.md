---
nav_title: "OBTER: Exibir todas as traduções para uma campanha"
article_title: "OBTER: Exibir Todas as Traduções para uma Campanha"
search_tag: Endpoint
page_order: 1

layout: api_page
page_type: reference
description: "Este artigo descreve detalhes sobre o endpoint Exibir todas as traduções para uma campanha."
---

{% api %}
# Exibir todas as traduções para uma campanha
{% apimethod get %}
...
| `MULTI_LANGUAGE_NOT_ENABLED_ON_MESSAGE` | Apenas campanhas de e-mail, push e mensagens in-app ou mensagens de Canvas com e-mails podem ser traduzidas.             |
| `UNSUPPORTED_CHANNEL`                   | Apenas campanhas de e-mail, push ou mensagens in-app ou mensagens de Canvas podem ser traduzidas. |
