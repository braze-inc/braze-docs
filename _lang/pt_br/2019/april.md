...
## Novos eventos do Currents & campos

Além de algumas correções na seção, um novo [Evento de Inscrição]({{ site.baseurl}}/user_guide/data_and_analytics/braze_currents/message_engagement_events/#subscription-events) foi adicionado à página de Eventos de Engajamento com Mensagens. 
