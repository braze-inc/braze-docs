...
{% alert important %}
O editor SQL está em acesso antecipado. Se estiver interessado em participar do acesso antecipado, entre em contato com o gerente de sucesso do cliente.
{% endalert %}
...
## Eventos New Currents: users_campaigns_abort e users_canvas_abort
