...
{% include early_access_beta_alert.md feature='A capacidade de mesclar usuários por e-mail e usar o ponto de extremidade `/users/merge` com identificadores incompatíveis' %}
