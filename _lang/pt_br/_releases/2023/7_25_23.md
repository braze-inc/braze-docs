...
## BrazeAI<sup>TM</sup>
O BrazeAI<sup>TM</sup> oferece uma coleção de ferramentas acessíveis e fáceis de usar que reduzem as barreiras de entrada para a criatividade, a personalização e a otimização de sua estratégia de engajamento. Saiba mais sobre os recursos e capacidades do BrazeAI<sup>TM</sup> em nossa [documentação]({{site.baseurl}}/user_guide/brazeai/).
