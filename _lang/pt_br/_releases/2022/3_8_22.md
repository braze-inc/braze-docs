...
A integração entre o Braze e [o Grouparoo]({{site.baseurl}}/help/release_notes/deprecations/grouparoo) sincroniza os dados do warehouse com o Braze. As programações de sincronização automática mantêm as comunicações com os clientes atualizadas com informações atualizadas.
