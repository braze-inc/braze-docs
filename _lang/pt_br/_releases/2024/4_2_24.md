...
Com o BrazeAI<sup>TM</sup>, agora você pode calcular os produtos mais populares ou criar recomendações personalizadas de IA para um catálogo específico. Para saber mais, consulte [Sobre recomendações de itens]({{site.baseurl}}/user_guide/brazeai/recommendations/about_item_recommendations/).

### Controle de qualidade do conteúdo das mensagens no app

{% multi_lang_include release_type.md release="General availability" %}

Anteriormente, você podia realizar a garantia de qualidade em seu conteúdo de SMS e notificações por push usando o BrazeAI<sup>TM</sup> no dashboard do Braze. Agora, você também pode fazer o [controle de qualidade do conteúdo das mensagens no app]({{site.baseurl}}/user_guide/brazeai/generative_ai/ai_content_qa/).
