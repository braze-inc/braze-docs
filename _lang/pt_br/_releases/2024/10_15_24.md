...
Os [objetos de propriedade de evento]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_events/custom_event_properties/) que contêm valores de vetor ou objeto agora podem ter uma carga útil de propriedade de evento de até 100 KB.
...
{% include field_level_encryption_pii_description.md link='user_guide/data/infrastructure/field_level_encryption/' %}
