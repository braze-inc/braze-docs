...
# Versão de 23 de julho de 2024

## Atualizações do Braze Docs

### Diátaxis e documentos da Braze

Estamos no processo de padronizar nossa documentação usando uma estrutura chamada [Diátaxis](https://diataxis.fr/). Isso nos ajuda a organizar o conteúdo por finalidade — tutoriais, guias práticos, referência e explicação — para que você encontre o tipo certo de informação mais rapidamente.
...
Adicionamos exemplos para o endpoint `/catalogs` usando campos de array. Para ver os exemplos, confira o seguinte:
...
O [LINE](https://www.lycbiz.com/sites/default/files/media/jp/download/LINE%20Business%20Guide_202310-202403.pdf) é o app de envio de mensagens mais popular do Japão, com mais de 95 milhões de usuários ativos mensais. Você pode integrar suas contas LINE com a Braze para aproveitar seus dados de clientes primários e zero-party para enviar mensagens LINE atraentes para os clientes certos com base em suas preferências, comportamentos e interações entre canais. Para começar, consulte o [LINE]({{site.baseurl}}/line).
...
### Assistente de IA para Liquid

{% multi_lang_include release_type.md release="Beta" %}

O Assistente de IA para Liquid é um assistente de chat desenvolvido pela BrazeAI<sup>TM</sup> que ajuda a gerar o Liquid de que você precisa para personalizar o conteúdo das mensagens. Você pode gerar Liquid a partir de modelos, receber sugestões personalizadas de Liquid e otimizar o Liquid existente com o suporte da BrazeAI<sup>TM</sup>. O Assistente de IA para Liquid também fornece anotações que explicam o Liquid usado, para que você possa aumentar sua compreensão do Liquid e aprender a escrever o seu próprio.

Para começar, consulte [Assistente de IA para Liquid]({{site.baseurl}}/user_guide/brazeai/generative_ai/ai_liquid).
...
### Atualização dos documentos da Xamarin
