...
![Caixa de seleção Desinstalar rastreamento]({% image_buster /assets/img_archive/uninstall_tracking_checkbox.png %})
...
![Limite de impressão da IAM]({% image_buster /assets/img_archive/approx_limit_for_IAM.png %})
