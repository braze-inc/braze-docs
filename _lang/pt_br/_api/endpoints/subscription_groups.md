...
article_title: Pontos de extremidade do grupo de inscrições
page_order: 7
layout: dev_guide

#Required
description: "Esta landing page explica e lista os endpoints dos grupos de inscrições para e-mail e SMS do Braze."
page_type: landing
search_tag: Endpoint
...
guide_featured_list:
  - name: "OBTER: Listar o status do grupo de inscrições do usuário"
    link: /docs/api/endpoints/subscription_groups/get_list_user_subscription_group_status/
    image: /assets/img/braze_icons/users-01.svg
  - name: "OBTER: Listar os grupos de inscrições do usuário"
