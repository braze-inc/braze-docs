...
| `created_from`        | String          | Método usado para criar o perfil do usuário (por exemplo, SDK, API REST ou importação de CSV).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `gender`              | String          | Gênero do usuário. Os valores possíveis são:<br><br>- `M`: masculino<br>- `F`: feminino<br>- `O`: outros<br>- `N`: não aplicável<br>- `P`: prefere não dizer<br>- `nil`: desconhecido                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `total_revenue`       | Float           | Receita total atribuída a esse usuário. A receita total é calculada com base nas compras que o usuário fez durante os períodos de conversão das campanhas e Canvas que recebeu.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
Se você vir `object_prefix` na sua resposta da API e nenhuma URL para baixar os dados, isso significa que você já tem um bucket S3 da Amazon configurado para esse endpoint. Qualquer dado exportado usando esse endpoint vai diretamente para o seu bucket S3.
