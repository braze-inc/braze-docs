---
nav_title: "OBTER: Ver todas as traduções de uma tela"
article_title: "OBTER: Ver todas as traduções de uma tela"
search_tag: Endpoint
page_order: 1

layout: api_page
page_type: reference
description: "Este artigo descreve detalhes sobre as traduções View all para um ponto de extremidade do Canva."
---

{% api %}
# Ver todas as traduções de um Canva
{% apimethod get %}
/canvas/translations
{% endapimethod %}
