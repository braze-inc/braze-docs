---
nav_title: "OBTER: Exibir a tradução e a localização específicas do modelo de e-mail"
article_title: "OBTER: Exibir a tradução e a localização específicas do modelo de e-mail"
search_tag: Endpoint
page_order: 2

layout: api_page
page_type: reference
description: "Este artigo descreve detalhes sobre a tradução e a localização específicas da visualização para o ponto de extremidade do modelo de e-mail."
---
...
> Use esse ponto de extremidade para visualizar uma tradução e localização específicas para o ponto de extremidade de modelo de e-mail de um [modelo de e-mail]({{site.baseurl}}/user_guide/message_building_by_channel/email/templates).
