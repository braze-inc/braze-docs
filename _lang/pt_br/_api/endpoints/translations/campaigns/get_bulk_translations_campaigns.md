---
nav_title: "OBTER: Ver todas as traduções para uma campanha"
article_title: "OBTER: Ver todas as traduções para uma campanha"
search_tag: Endpoint
page_order: 1

layout: api_page
page_type: reference
description: "Este artigo descreve detalhes sobre o endpoint Ver todas as traduções para uma campanha."
---
...
| `MULTI_LANGUAGE_NOT_ENABLED_ON_MESSAGE` | Apenas campanhas de e-mail, push e mensagens in-app ou mensagens Canvas com e-mails podem ser traduzidas.             |
| `UNSUPPORTED_CHANNEL`                   | Apenas campanhas de e-mail, push ou mensagens in-app ou mensagens Canvas podem ser traduzidas. |
