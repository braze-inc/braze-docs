---
nav_title: "OBTER: Exibir tradução para uma campanha"
...
> Use esse ponto de extremidade para visualizar uma mensagem de campanha traduzida e ver como essa mensagem se parece para um usuário.

{% alert important %}
A visualização de uma mensagem de campanha traduzida via API está atualmente em acesso antecipado. Entre em contato com seu gerente de conta Braze se estiver interessado em participar do acesso antecipado.
{% endalert %}
