---
nav_title: "OBTER: Exibir traduções para uma campanha"
article_title: "OBTER: Exibir traduções para uma campanha"
search_tag: Endpoint
page_order: 1

layout: api_page
page_type: reference
description: "Este artigo descreve detalhes sobre o endpoint Exibir traduções para uma campanha."
---

{% api %}
# Exibir traduções para uma campanha
{% apimethod get %}
...
{% alert important %}
A visualização de traduções para mensagens de campanha via API está atualmente em acesso antecipado. Entre em contato com seu gerente de conta Braze se estiver interessado em participar do acesso antecipado.
{% endalert %}
