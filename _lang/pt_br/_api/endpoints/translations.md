...
guide_menu_list2:
  ...
  - name: "OBTER: Exibir localização e tradução específicas"
    ...
    image: /assets/img/braze_icons/target-04.svg
  - name: "OBTER: Ver todas as traduções e localizações"
...
Nossos endpoints de tradução trabalham com [composição multilíngue]({{site.baseurl}}/user_guide/administrative/app_settings/multi_language_settings/), em que uma mensagem pode ter versões diferentes que podem ser renderizadas dependendo do usuário que recebe a mensagem.

### Pré-requisitos

Antes de usar esses endpoints, você deve [adicionar suas localizações]({{site.baseurl}}/user_guide/administrative/app_settings/multi_language_settings/#add-a-locale).

### Como testar suas traduções

Há duas maneiras de validar o suporte à tradução usando a API e o dashboard do Braze em campanhas, Canvas (incluindo etapas individuais) e modelos de e-mail:
