...
description: "Essa landing page lista os endpoints de autenticação do SDK do Braze."
page_type: landing

guide_top_header: "Endpoints de autenticação do SDK"
guide_top_text: "Use esses endpoints para criar e gerenciar chaves de autenticação do SDK para seu app. As chaves de autenticação do SDK permitem que você autentique com segurança suas instâncias do SDK móvel com o Braze."

guide_featured_title: ""
guide_featured_list:
  - name: "POST: Criar chave de autenticação do SDK"
