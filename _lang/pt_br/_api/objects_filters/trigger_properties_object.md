...
Observe que, embora as propriedades de disparo possam ser modeladas em mensagens, elas não são armazenadas automaticamente no perfil do usuário por padrão.
