...
| [`/preference_center/v1/{preferenceCenterExternalId}/url/{userId}`][26]<br>[`/preference_center/v1/list`][27]<br>[`/preference_center/v1/{preferenceCenterExternalId}`][28]                                                                            | 1.000 solicitações por minuto.                                                                                                                                                                                                                                                                                                                                                 |
| [`/preference_center/v1`][29]<br>[`/preference_center/v1/{preferenceCenterExternalId}`][30]                                                                                                                                                            | 10 solicitações por minuto.                                                                                                                                                                                                                                                                                                                                                    |
...
| [`/catalogs/{catalog_name}/fields/{field_name}`][51]<br>[`/catalogs/{catalog_name}/fields`][52]<br>[`/catalogs/{catalog_name}/selections/{selection_name}`][49]<br>[`/catalogs/{catalog_name}/selections`][50] | 50 solicitações por minuto compartilhadas entre os endpoints. |
...
| [`/cdi/integrations`][46]                                                                                                                                                                                                                              | 50 solicitações por minuto.                                                                                                                                                                                                                                                                                                                                                                   |
| [`/cdi/integrations/{integration_id}/sync`][47]                                                                                                                                                                                                        | 20 solicitações por minuto.                                                                                                                                                                                                                                                                                                                                                                   |
| [`/cdi/integrations/{integration_id}/job_sync_status`][48]                                                                                                                                                                                             | 100 solicitações por minuto.                                                                                                                                                                                                                                                                                                                                                                  |
...
Cada solicitação `/users/track` pode conter até 75 objetos de evento, 75 objetos de atribuição e 75 objetos de compra. Cada objeto (evento, atributo e vetores de compra) pode atualizar um usuário. No total, isso significa que até 225 usuários podem ser atualizados em uma única chamada. Além disso, um único perfil de usuário pode ser atualizado por vários objetos.
