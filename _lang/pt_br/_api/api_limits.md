...
Consulte o seguinte para os limites de taxa da API padrão de diferentes tipos de solicitação. Esses limites padrão podem ser aumentados mediante solicitação. Entre em contato com seu gerente de sucesso do cliente para saber mais.
...
### Agrupando solicitações para o endpoint de usuários de rastreamento {#batch-user-track}
...
{% alert tip %}
Você pode usar o [painel de uso da API]({{site.baseurl}}/user_guide/analytics/dashboard/api_usage_dashboard/) para visualizar e comparar o tráfego de entrada em relação aos seus limites de taxa.
{% endalert %}
