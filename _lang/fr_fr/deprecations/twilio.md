---
nav_title: Partenariat avec Twilio
...
![Méthode du webhook]({% image_buster /assets/img_archive/Webhook_Method.png %})
...
![Prévisualisation dans le Webhook]({% image_buster /assets/img_archive/Webhook_Preview.png %})
