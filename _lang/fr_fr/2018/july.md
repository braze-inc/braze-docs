...
Cette fonctionnalité n’est pas encore disponible pour tous les clients. Veuillez contacter votre gestionnaire de compte si vous souhaitez activer cette fonctionnalité pour votre compte Braze.

## Ajout de l’option de fuseau horaire dans Canvas : Heure locale

Vous pouvez désormais choisir d’envoyer un message à l’heure locale de votre entreprise ou à l’heure locale de votre utilisateur. Lorsque vous créez votre étape de Canvas, sélectionnez simplement Programmé, puis « au prochain » ou « dans ». Ensuite, vous pourrez choisir entre « l’heure de l’entreprise » et « l’heure locale de l’utilisateur ».

## Alertes de campagne

Les campagnes Braze vous permettent désormais de définir des paramètres pour le nombre d’envois dans une campagne, et de recevoir des notifications si votre campagne dépasse ou tombe sous les nombres d’envois que vous aviez choisis. Cliquez sur la campagne que vous souhaitez surveiller, puis identifiez le premier bloc **Surveillance de la campagne**. Cliquez sur **Définir une alerte**, puis définissez et enregistrez votre alerte ! 
