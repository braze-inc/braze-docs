...
## Événements de données S3 et Azure pour les utilisateurs anonymes
 ...
 Les clients qui exportent des données vers Amazon S3 et Microsoft Azure peuvent désormais inclure des événements d’utilisateurs anonymes. Cette fonctionnalité sera activée par défaut pour toutes les nouvelles intégrations, mais restera désactivée pour toutes les intégrations existantes. Si vous avez des questions, veuillez contacter votre gestionnaire de compte ou ouvrir un [ticket d'assistance]({{site.baseurl}}/braze_support/).
