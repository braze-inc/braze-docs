...
Vous pouvez désormais utiliser LinkedIn avec Braze [Audience Sync]({{site.baseurl}}/partners/canvas_audience_sync/), un outil qui vous aide à étendre la portée de vos campagnes à de nombreuses technologies sociales et publicitaires de premier plan. Pour participer à la version bêta, veuillez contacter votre gestionnaire de réussite Braze.
...
|Avant|Après|
|------|-----|
|![Ancienne navigation pour le Guide du développeur Braze.]({% image_buster /assets/img/release_notes/developer_guide_improvements/old_navigation.png %})|![Nouvelle navigation pour le Guide du développeur Braze.]({% image_buster /assets/img/release_notes/developer_guide_improvements/new_navigation.png %})|
