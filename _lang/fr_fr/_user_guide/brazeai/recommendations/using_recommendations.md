...
L'objet `product_recommendation` contient des recommandations de produits générées de manière dynamique. Pour y accéder dans Liquid, vous devez d'abord affecter les données à une variable avant de les utiliser dans votre message.
