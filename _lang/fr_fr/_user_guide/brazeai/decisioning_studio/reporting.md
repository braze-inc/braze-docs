...
![L'arborescence des inducteurs du rapport de performance montre un diagramme hiérarchique qui mappe les inducteurs de valeur clés aux indicateurs cibles. Le diagramme présente plusieurs nœuds connectés, chacun libellé avec un nom de facteur ou d'indicateur, illustrant la façon dont les différents facteurs contribuent aux performances globales.]({% image_buster /assets/img/decisioning_studio/reporting_performance_drivertree.png %})
...
![Rapport sur les préférences des agents montrant un diagramme à barres comparant la fréquence à laquelle différentes options de recommandation ont été sélectionnées au cours d'une période donnée. Le graphique affiche plusieurs barres colorées, chacune représentant une option de recommandation de la banque d'actions, l'axe des ordonnées représentant le pourcentage de fois où l'option a été choisie et l'axe des abscisses énumérant les noms des options.]({% image_buster /assets/img/decisioning_studio/reporting_insights_agent_preferences.png %})
...
![Rapport de diagnostic sortant montrant un graphique linéaire qui suit le volume quotidien de recommandations générées et activées pour différents groupes d'audience. Le graphique affiche deux lignes intitulées Generated (Générées) et Activated (Activées), l'axe des ordonnées représentant le nombre de recommandations et l'axe des abscisses les dates. Une légende identifie chaque ligne par sa couleur. L'interface comprend des filtres déroulants pour la plage de dates et la sélection de l'audience au-dessus du graphique.]({% image_buster /assets/img/decisioning_studio/reporting_diagnostics_outbound.png %})
...
![Rapport de diagnostic entrant présentant un graphique linéaire suivant le nombre de fichiers quotidiens et la taille moyenne des fichiers pour les ressources de données livrées à BrazeAI™. Le graphique affiche deux lignes intitulées File count (Nombre de fichiers) et Average file size (Taille moyenne des fichiers) en Mo, l'axe des ordonnées représentant les valeurs et l'axe des abscisses les dates. Au-dessus du graphique se trouvent des filtres déroulants pour la sélection de la plage de dates et des ressources de données.]( {% image_buster /assets/img/decisioning_studio/reporting_diagnostics_inbound.png %} )
