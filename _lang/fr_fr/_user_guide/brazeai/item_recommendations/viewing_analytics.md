...
![Indicateurs de l'audience des recommandations indiquant la précision (25,3 %), la couverture (54,3 %) et les types de recommandations répartis entre les articles personnalisés et les articles les plus populaires.]({% image_buster /assets/img/item_recs_analytics_1.png %})
