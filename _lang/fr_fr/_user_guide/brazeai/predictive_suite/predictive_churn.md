...
description: "Cette page d'accueil présente Predictive Churn, un outil de la Predictive Suite de Braze qui vous permet de définir ce que signifie le taux d'attrition pour votre entreprise, ainsi que les utilisateurs que vous souhaitez retenir."
page_order: 8
