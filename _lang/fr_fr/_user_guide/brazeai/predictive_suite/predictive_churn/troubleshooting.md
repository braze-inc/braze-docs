...
![Les données de prédictions montrent 31 désabonnés passés (conforme aux exigences) et 0 non désabonné passé (inférieur au minimum). Un message d'avertissement indique qu'il n'y a pas suffisamment de non-désabonnés pour créer la prédiction.]({% image_buster /assets/img/churn/audience_size_error.png %})
