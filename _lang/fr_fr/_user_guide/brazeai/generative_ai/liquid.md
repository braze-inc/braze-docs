...
![Compositeur de messages avec l'assistant de l'intelligence artificielle.]({% image_buster /assets/img/ai_liquid/ai_assistant_icon.png %}){: style="max-width:50%;"}
...
![Exemple de sortie de l'invite « Utiliser l’activité de l’appli ».]({% image_buster /assets/img/ai_liquid/use_app_activity.png %}){: style="max-width:45%;"}
{% endtab %}
...
![Exemple de sortie de l'invite "Inspirez-moi".]({% image_buster /assets/img/ai_liquid/inspire_me.png %}){: style="max-width:45%;"}
{% endtab %}
...
![Exemple de sortie de l'invite « Améliorer mon Liquid ».]({% image_buster /assets/img/ai_liquid/improve_my_liquid.png %}){: style="max-width:45%;"}
{% endtab %}
{% endtabs %}
