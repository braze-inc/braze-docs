---
nav_title: Drapeaux de fonctionnalité
article_title: Drapeaux de fonctionnalité
page_order: 8
page_type: reference
...
Les propriétés d'une étape du canvas peuvent être modifiées après le lancement, et même après qu'un utilisateur a franchi l'étape. Les utilisateurs recevront toujours une version dynamique et en temps réel de l'indicateur de fonctionnalité, au lieu de l'ancienne version enregistrée.
