...
Sinon, si vous souhaitez utiliser la diffusion selon l’heure locale, utilisez une fenêtre d’expérience de 24 à 48 heures ou plus. De cette manière, les utilisateurs des premiers fuseaux horaires entrent dans le Canvas et déclenchent le démarrage de l'expérience, mais il reste encore beaucoup de temps dans la fenêtre d'expérience. Les utilisateurs situés dans des fuseaux horaires plus éloignés disposent encore de suffisamment de temps pour entrer dans le Canvas et l'étape des chemins d'expérience avec des chemins d'expérience gagnants et éventuellement se convertir avant l'expiration de la fenêtre d'expérience.
