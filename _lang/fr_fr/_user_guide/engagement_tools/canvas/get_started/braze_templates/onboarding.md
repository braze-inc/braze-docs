...
\![Événement de conversion principal - A avec le type de conversion "Effectue un événement personnalisé" avec le nom de l'événement personnalisé "Cliquez sur l'e-mail". Le délai de conversion est de 4 jours.]({% image_buster /assets/img/canvas_templates/onboarding1.png %})
...
#### Ciblez plus d'utilisateurs avec les parcours d'audience
