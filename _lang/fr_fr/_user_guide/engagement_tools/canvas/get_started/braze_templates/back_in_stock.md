...
!["Attribuer des événements de conversion" pour le type d'événement de conversion de l'achat du produit Classic Straight Leg avec un délai de conversion de 7 jours.]({% image_buster /assets/img/canvas_templates/back_in_stock_2.png %})
...
![" Audience cible " étape avec le segment " Favorisés - Jeans classiques à jambe droite ".]({% image_buster /assets/img/canvas_templates/back_in_stock_5.png %})
...
![Section "Contrôles d'entrée" avec une case à cocher pour permettre aux utilisateurs d'entrer à nouveau dans ce Canvas avec une durée maximale du Canvas.]({% image_buster /assets/img/canvas_templates/back_in_stock_6.png %})
...
![" Envoyer les paramètres " étape de ciblage des utilisateurs abonnés ou ayant opté pour le service.]({% image_buster /assets/img/canvas_templates/back_in_stock_8.png %})
