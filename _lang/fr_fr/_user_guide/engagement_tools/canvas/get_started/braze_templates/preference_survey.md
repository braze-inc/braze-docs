...
- Un e-mail de suivi qui comprend des conseils pour démarrer avec l'appli pour les utilisateurs qui ont onboardé.
...
![Section "Fenêtre d'entrée" avec l'heure de début le 30 janvier 2025 à 12 heures.]({% image_buster /assets/img/canvas_templates/preference_survey4.png %}){: style="max-width:90%;"}
...
![La section "Paramètres d'envoi" contient les paramètres d'abonnement pour les utilisateurs abonnés ou bénéficiant d'un abonnement avec les heures calmes activées entre 12 heures et 20 heures.]({% image_buster /assets/img/canvas_templates/preference_survey6.png %}){: style="max-width:90%;"}
