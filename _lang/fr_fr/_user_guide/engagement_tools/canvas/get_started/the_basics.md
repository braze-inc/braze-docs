...
{% tabs %}
  ...
  ![Exemple d'un canvas avec une étape de l'arbre décisionnel en deux parcours utilisateur différents selon que l'utilisateur est activé ou non pour le push.]({% image_buster /assets/img/canvas_intro/canvas_intro.gif %})
