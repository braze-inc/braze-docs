...
![Exemple de parcours utilisateur Canvas avec une étape de l'arbre décisionnel suivie d'étapes de délai et de message.]({% image_buster /assets/img/canvas_intro/canvas_intro.gif %}){: style="float:right;max-width:55%;margin-left:15px;"}
