...
1. Sélectionnez le type général d’événement que vous souhaitez utiliser :
  - **Ouvre l'application**: Un utilisateur est considéré comme converti lorsqu'il ouvre l'une des applications que vous spécifiez (par défaut, toutes les applications de l'espace de travail).
