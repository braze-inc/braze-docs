...
![Critères de segmentation pour les utilisateurs qui ont effectué un événement personnalisé plus de 2 fois dans la plage de dates allant du 1er mars 2025 au 31 mars 2025.]({% image_buster /assets/img/segment/segment_extension1.png %})
...
![Segmentation basée sur les objets temporels.]({% image_buster /assets/img/segment/property4.png %})
...
![Segmenter en fonction de propriétés de l’événement imbriqué.]({% image_buster /assets/img/segment/nested_segment_extensions.png %})
...
![La section "Filtres" avec un filtre déroulant affichant "Braze Segment Extensions".]({% image_buster /assets/img/segment/segment_extension7.png %})
...
Lorsque vous utilisez l'extension **simple** Segment Extensions, vous pouvez sélectionner un événement personnalisé, un événement d'achat ou une interaction de canal. Toutefois, vous pouvez combiner plusieurs extensions de segments à l'aide d'un ET ou d'un OU lors de la création du segment par défaut.
