...
| Champ d'application | Description | Recommandations |
| --- | --- |
| Titre du site | Le titre qui s'affiche sur l'onglet du navigateur. | Utilisez jusqu'à 60 caractères. |
| Méta description | Un extrait de code qui s'affiche dans les résultats de recherche. | Utilisez entre 140 et 160 caractères.|
...
L'éditeur utilise deux types de composants pour la composition des pages d'atterrissage : les blocs de base et les blocs de formulaire. Tous les blocs doivent être placés en rangée.

La section 'Créer' contenant les 'Lignes' et les 'Blocs de formulaires'.]({% image_buster /assets/img/landing_pages/dnd.png %}){: style="max-width:35%;"}
...
| Entretoise      | Un bloc invisible qui ajoute un espacement vertical entre les éléments pour améliorer la mise en page et la lisibilité. |
...
| Type de bloc     | Description |
|---------------|-------------|
| Capture d'e-mail | Un champ de formulaire pour les adresses e-mail. Une fois soumise, l'adresse e-mail est ajoutée au profil de l'utilisateur dans Braze. |
| Capture du téléphone | Un champ de formulaire pour les numéros de téléphone. Une fois soumis, l'utilisateur est abonné à votre groupe d'abonnement SMS ou WhatsApp. |
...
Un menu déroulant avec des options permettant d'enregistrer, de modifier et de supprimer une page d'atterrissage.]({% image_buster /assets/img/landing_pages/manage-lp-template.png %}){: style="max-width:60%;"}
