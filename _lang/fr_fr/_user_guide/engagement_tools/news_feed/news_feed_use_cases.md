...
- [Création de liens profonds][1] en utilisant des URL personnalisées pour diriger les utilisateurs vers n'importe quelle ressource hébergée dans votre application.
...
{% alert note %}
Braze recommande aux clients qui utilisent notre outil Fil d’actualité de passer à notre canal de communication de cartes de contenu qui est plus flexible, personnalisable et fiable. Il est également plus facile à trouver et utiliser dans le produit Braze. Contactez votre gestionnaire de compte Braze pour plus d’informations.
{% endalert %}
