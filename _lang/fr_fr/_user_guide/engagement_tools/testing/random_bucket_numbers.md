---
nav_title: Numéro de compartiment aléatoire
article_title: Numéro de compartiment aléatoire
page_order: 2
page_type: reference
description: "Cet article traite du concept des numéros de compartiment aléatoire et de la manière dont vous pouvez les utiliser pour créer des variantes et des groupes de contrôle."
page_type: reference
tool:
  - Campaign
  - Canvas
...
> Un numéro de compartiment aléatoire est un attribut de l'utilisateur qui peut être utilisé pour créer des segments uniformément distribués d'utilisateurs aléatoires. 

## Aperçu

Lorsqu'un profil utilisateur est créé dans Braze, cet utilisateur se voit automatiquement attribuer un numéro de compartiment aléatoire compris entre 0 et 9999 (inclus). Vous pouvez utiliser ces segments pour tester l'efficacité de plusieurs campagnes ou Canvases sur des groupes d'utilisateurs au fil du temps.

### Utilisation du groupe de contrôle global

Les numéros de compartiment aléatoire sont utilisés dans votre groupe de contrôle global, un groupe d'utilisateurs qui ne reçoit aucune campagne ni aucune toile. Braze sélectionne de manière aléatoire plusieurs plages de numéros de compartiment aléatoire et inclut les utilisateurs de ces compartiments sélectionnés. Des numéros de compartiment aléatoires sont attribués sans pondération ni prise en compte des numéros récemment attribués. 
...
### Quand utiliser des numéros de compartiment aléatoire ?
...
## Créer des segments à l'aide de numéros de compartiment aléatoires
...
\![Un filtre de segmentation pour des numéros de compartiment aléatoires ne dépassant pas "3000".]({% image_buster /assets/img_archive/random_buckets_filterexample.png %})

Vous pouvez utiliser ce type de segmentation si vous souhaitez effectuer un essai de trois variantes différentes et inclure un groupe de contrôle. Examinez l'exemple de plan suivant pour la création de segments de taille égale pour trois variantes et un groupe de contrôle :

- Les numéros de compartiment 0 à 2499 correspondent au segmentation de contrôle
...
Selon le nombre de segments que vous souhaitez et la répartition des utilisateurs au sein de chaque segment, votre plan peut se présenter différemment.
