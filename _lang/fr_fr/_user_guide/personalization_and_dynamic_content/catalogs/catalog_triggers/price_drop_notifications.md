...
![Paramètres du catalogue qui montrent que la fonctionnalité de baisse des prix est activée. La règle de la baisse des prix est une modification de trois pour cent du prix initial.]({% image_buster /assets/img/price_drop_notifications.png %})
