---
nav_title: Utiliser les API publiques
...
# Utiliser les API publiques pour le contenu connecté

> Il existe une variété d’API publiques pouvant être utilisées pour le Contenu connecté. Les API publiques vous permettent d’insérer des données personnalisées dans les messages. Cette page compile une liste d'API publiques qui pourraient être utilisées pour le contenu connecté. Cependant, il existe beaucoup d’API disponibles, offrant une grande variété de contenus connectés potentiels.  

Contactez-nous à l’adresse [success@braze.com](mailto:success@braze.com) pour nous indiquer si vous avez une API à partager !
...
| [Recherche d'articles dans le NYT][8] | Fournit des données d’articles du NYT qui comprennent le titre, le sujet, l’URL, la date, le résumé, etc. |
| [API The Guardian][9] | Fournit des données d’articles du Guardian qui comprennent le titre, le sujet, l’URL, la date, le résumé, etc.|
...
| [Nutritionix Worlds][43] | Fournit des données nutritionnelles vérifiées. |
| [USDA Nutrients][45] | Donne accès à la base de données nationale des nutriments. |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
...
| [Songkick][22] | Fournit des informations musicales en direct avec le nom des artistes, des lieux, des sites, etc. |
...
| [Lever et coucher du soleil][39] | Fournit les heures de coucher de soleil et de lever du soleil pour une latitude et une longitude donnée. |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
