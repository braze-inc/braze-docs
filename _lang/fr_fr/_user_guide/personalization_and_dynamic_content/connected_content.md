...
guide_top_text: "Braze Connected Content développe la personnalisation du marketing pour stimuler l'engagement des clients et les conversions. Cette fonctionnalité vous permet d’insérer toute information accessible via API directement dans les messages que vous envoyez aux utilisateurs. Le contenu connecté permet d’extraire du contenu directement à partir de votre serveur Web ou des API accessibles au public. Vous pouvez également utiliser nos capacités de contenu connecté avec nos partenaires technologiques, tels que <b><a href='/docs/partners/data_augmentation/contextual_location/accuweather/'>Accuweather</a></b> et <b><a href='/docs/partners/channel_extensions/localization/transifex/'>Transifex</a></b>.<br><br>En plus des articles suivants, nous vous recommandons de consulter notre cours d’apprentissage Braze <b><a href='https://learning.braze.com/connected-content'>Contenu connecté</a></b>."
...
guide_featured_list:
- name: Création d’un appel API de contenu connecté
...
- name: Mise en cache des réponses au contenu connecté
  link: /docs/user_guide/personalization_and_dynamic_content/connected_content/local_connected_content_variables/
...
- name: Résolution des problèmes des demandes de contenu connecté 
  link: /docs/help/help_articles/api/webhook_connected_content_errors/
  image: /assets/img/braze_icons/check-square-broken.svg
- name: Utiliser les API publiques
