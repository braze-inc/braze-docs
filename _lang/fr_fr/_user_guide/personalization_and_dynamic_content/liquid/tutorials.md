...
{: start="6"}
6\.  Formons une équation (environ 6 mois * 30,44 jours * 24 heures * 60 minutes * 60 secondes) et affectons-la à la variable `six_months`. Nous utiliserons `times` pour spécifier la multiplication des unités de temps.
