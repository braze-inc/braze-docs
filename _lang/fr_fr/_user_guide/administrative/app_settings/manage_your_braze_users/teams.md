...
L’option Teams (Équipes) n’est pas disponible sur tous les contrats Braze. Pour accéder à cette fonctionnalité, contactez votre gestionnaire de compte Braze ou [contactez-nous](mailto:success@braze.com) pour une consultation.
...
## Attribuer des étiquettes à l'équipe {#tags-and-filters}
...
![La liste déroulante de l'étiquette de l'équipe de campagne qui n'affiche que l'étiquette de l'équipe de "développement".]({% image_buster /assets/img_archive/team_permissions_scenario1.gif %})
...
![Liste déroulante des étiquettes d'équipe de campagne avec plusieurs tags d'équipe]({% image_buster /assets/img_archive/team_permissions_scenario2.gif %})
...
Sélectionnez un ou plusieurs Teams à archiver. Si le Teams n'est associé à aucun objet au sein de Braze, Braze archive immédiatement le Teams. Si l'équipe est associée à un objet, Braze vous propose de supprimer l'équipe après le processus d'archivage ou de la remplacer.
