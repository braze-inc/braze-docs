...
|Espace de travail|Approuver et refuser des campagnes|Permet aux utilisateurs d'approuver ou de refuser des campagnes.  Ce paramètre es actuellement disponible en accès anticipé. Contactez votre gestionnaire de compte si vous souhaitez participer à l'accès anticipé.|
