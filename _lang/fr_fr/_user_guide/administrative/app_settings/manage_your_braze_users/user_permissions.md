...
Sous **Espaces de travail**, choisissez un ou plusieurs espaces de travail dans la liste déroulante. Ensuite, sous **Autorisations**, choisissez une ou plusieurs autorisations dans la liste déroulante. Braze attribue ces autorisations uniquement pour les espaces de travail que vous avez sélectionnés. En option, vous pouvez sélectionner **Activer l'accès administrateur** si vous souhaitez leur donner toutes les autorisations pour cet espace de travail.

Lorsque vous avez terminé, sélectionnez **Mettre à jour l'utilisateur**.

![Sélection manuelle des autorisations au niveau de l'espace de travail dans Braze.]({% image_buster /assets/img/braze_permissions/workspace_level_permissions_individual.png %})

{% endsubtab %}
{% subtab Assign permission set %}

Sous **Espaces de travail**, choisissez un ou plusieurs espaces de travail dans la liste déroulante. Ensuite, sous **Jeux de permissions**, choisissez un jeu de permissions. Braze attribue ces autorisations uniquement pour les espaces de travail que vous avez sélectionnés.
...
|Espace de travail|Exporter les données utilisateur|Permet aux utilisateurs d'exporter leurs données utilisateur à partir des segments, des campagnes et des Canevas. Cette autorisation comprend des informations sensibles sur les utilisateurs, telles que les noms, les adresses e-mail et d'autres informations personnelles identifiables (IPI) collectées. Pour exporter des CSV à partir du tableau de bord, vous devez disposer de cette autorisation et de l'autorisation "Voir les IIP".|
...
|Espace de travail|Gérer les équipes|Permet aux utilisateurs de gérer des **Teams internes**. La possibilité de sélectionner cette autorisation dépend de votre contrat avec Braze.<br><br>Cela correspond à l'ancienne autorisation `MANAGE_TERRITORIES`.|
