...
![Les journaux d'exportation contiennent une liste des exportations terminées.]({% image_buster /assets/img/export_logs.png %})
...
![Le journal des exportations montre une exportation en cours et l'option "Annuler l'exportation".]({% image_buster /assets/img/export_logs_cancel.png %})
