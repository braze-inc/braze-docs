...
Pour récupérer votre clé d'accès secrète et votre ID de clé d'accès, vous devrez créer un utilisateur IAM en suivant les instructions fournies dans [la section Configuration de votre compte AWS](https://docs.aws.amazon.com/IAM/latest/UserGuide/getting-started-account-iam.html#create-an-admin).
...
![Une page récapitulative pour un rôle intitulé « liyu-chen-test ».]({% image_buster /assets/img/security_export/credentials1.png %})
...
![La page « Téléchargement des événements de sécurité » avec le compte Braze et les ID externes Braze renseignés.]({% image_buster /assets/img/security_export/security_event_download1.png %})
...
![Une page présentant une liste de politiques et un bouton « Créer une politique ».]({% image_buster /assets/img/security_export/policies.png %})
...
![Une page qui vous permet de consulter votre politique et, si vous le souhaitez, d'ajouter des autorisations.]({% image_buster /assets/img/security_export/specify_permissions.png %})

{: start="5"}
5\. Donnez un nom et une description à la politique, puis sélectionnez **Créer une politique.**

![Une page pour examiner et créer votre politique.]({% image_buster /assets/img/security_export/review_and_create.png %})
...
![La page « Téléchargement des événements de sécurité » avec le compte Braze et les ID externes Braze renseignés.]({% image_buster /assets/img/security_export/security_event_download2.png %})

4. Dans la console AWS, veuillez vous rendre dans la section **IAM** (Identity and Access Management) > **Rôles** > **Créer un rôle**. 
...
![Une page proposant des options pour sélectionner un type d'entité de confiance et fournir des informations sur votre compte AWS.]({% image_buster /assets/img/security_export/select_trusted_entity.png %})
...
![Une liste des politiques avec des colonnes indiquant leur type et leur description.]({% image_buster /assets/img/security_export/add_permissions.png %})

{: start="3"}
3\. Donnez un nom et une description au rôle, puis sélectionnez **Créer un rôle**.

![Champs permettant de fournir des détails sur les rôles, tels que le nom, la description, la politique de confiance, les autorisations et les tags.]({% image_buster /assets/img/security_export/name_review_create.png %})
...
![La page récapitulative d'un rôle intitulé « security-event-export-olaf ».]({% image_buster /assets/img/security_export/credentials2.png %})
...
![Section « Téléchargement des événements de sécurité » avec la possibilité de basculer sur « Exporter vers AWS S3 ».]({% image_buster /assets/img/security_export/security_event_download3.png %})
