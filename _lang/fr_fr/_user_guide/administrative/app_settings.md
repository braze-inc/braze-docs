...
guide_top_text: "C'est ici que vous trouverez les rubriques relatives aux paramètres globaux de votre espace de travail."

page_type: landing
description: "Cette page d'atterrissage répertorie les sujets liés aux paramètres de l'application et de l'espace de travail."

guide_featured_title: "Configuration et essais"
guide_featured_list:
  - name: "Gestion de l'espace de travail"
...
guide_menu_list:
  ...
  - name: Préférences des e-mails
    ...
    image: /assets/img/braze_icons/mail-01.svg
  - name: Paramètres de durée de vie des notifications push
