...
{% multi_lang_include metrics.md indicateurs='AMP Clics' %}
...
{% multi_lang_include metrics.md metric='AMP Opens' (Ouvertures AMP) %}
...
{% multi_lang_include metrics.md indicateurs='Audience' %}
...
{% multi_lang_include metrics.md indicateurs="Body Click" (clics sur le corps) %}
...
{% multi_lang_include metrics.md indicateurs='Clics sur le bouton 1' %}
...
{% multi_lang_include metrics.md indicateurs='Bouton 2 Clics' %}
...
{% multi_lang_include metrics.md metric='Choix soumis' %}
...
{% multi_lang_include metrics.md metric='Click-to-Open Rate' (taux de clics d'ouverture) %}
...
{% multi_lang_include metrics.md indicateurs='Confiance' %}
...
{% multi_lang_include metrics.md metric= 'Bouton de la page de confirmation' %}
...
{% multi_lang_include metrics.md metric='Confirmation Page Dismissals' (indicateurs) %}
...
{% multi_lang_include metrics.md metric='Total des conversions' %}
...
{% multi_lang_include metrics.md metric='Taux de conversion' %}
...
{% multi_lang_include metrics.md metric="Fenêtre de conversion %}
...
{% multi_lang_include metrics.md metric='Delivery Failures' (échecs de réception/distribution) %}
...
{% multi_lang_include metrics.md indicateurs='Direct Opens' (ouvertures directes) %}
...
{% multi_lang_include metrics.md indicateurs='Emailable' %}
...
{% multi_lang_include metrics.md metric='Estimation des ouvertures réelles' %}
...
{% multi_lang_include metrics.md metric= 'Ouvertures influencées' %}
...
{% multi_lang_include metrics.md metric='Lifetime Revenue' (chiffre d'affaires à vie) %}
...
{% multi_lang_include metrics.md metric='Lifetime Value Per User' (valeur vie client par utilisateur) %}
...
{% multi_lang_include metrics.md metric='Chiffre d'affaires quotidien moyen' %}
...
{% multi_lang_include metrics.md indicateurs="Achats quotidiens %}
...
{% multi_lang_include metrics.md metric='Daily Revenue Per User' (Chiffre d'affaires quotidien par utilisateur) %}
...
{% multi_lang_include metrics.md indicateurs="Ouvertures %}
...
{% multi_lang_include metrics.md indicateurs='Pending Retry' (tentatives en attente) %}
...
{% multi_lang_include metrics.md metric='Reads' (indicateurs) %}
...
{% multi_lang_include metrics.md indicateurs='Reçu' %} 
...
{% multi_lang_include metrics.md indicateurs='Chiffre d'affaires' %}
...
{% multi_lang_include metrics.md indicateurs='Sent' %}
...
{% multi_lang_include metrics.md metric='Sends to Carrier' (Envoie au transporteur) %} 
...
{% multi_lang_include metrics.md indicateurs='Spam' %}
...
{% multi_lang_include metrics.md metric='Survey Page Dismissals' (indicateurs de rejet des pages de l'enquête) %}
...
{% multi_lang_include metrics.md metric='Survey Submissions' (indicateurs) %}
...
{% multi_lang_include metrics.md indicateurs='Total des licenciements' %}
...
{% multi_lang_include metrics.md metric='Unique Recipients' (destinataires uniques) %}
...
{% multi_lang_include metrics.md metric= 'Unsubscribers or Unsub' (abonnés ou désabonnés) %}
...
{% multi_lang_include metrics.md metric= 'Désabonnements' %}
...
{% multi_lang_include metrics.md indicateurs='Variation' %}
