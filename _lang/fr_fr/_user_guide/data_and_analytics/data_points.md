...
Pour plus d'informations sur les composants du tableau de bord des points de données, consultez [Facturation]({{site.baseurl}}/user_guide/onboarding_with_braze/subscription_and_usage/).
