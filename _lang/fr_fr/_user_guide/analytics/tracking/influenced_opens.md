...
![Statistiques sur les ouvertures influencées sur la page Campaign Details (Détails de la campagne) d’une campagne]({% image_buster /assets/img_archive/Influenced_Opens2.png %})
