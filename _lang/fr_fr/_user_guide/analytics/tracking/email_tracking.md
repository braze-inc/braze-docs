...
![Champs d’ouverture d’e-mail et de pixel de suivi des clics dans l’onglet Engagement d’un profil utilisateur]({% image_buster /assets/img_archive/open_click_user_profile.png %}){: style="max-width:60%;"}
