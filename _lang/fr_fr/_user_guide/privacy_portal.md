...
article_title: Portail de la protection de la vie privée
page_order: 60
layout: dev_guide
search_rank: 3
guide_top_header: "Portail de la protection de la vie privée de Braze"
guide_top_text: "> Bienvenue sur le portail de la protection de la vie privée de Braze. Vous y trouverez toutes sortes d'informations utiles sur la manière dont Braze peut vous aider à être de bons gardiens des données de vos clients et, surtout, vous permettre de prendre des mesures pour vous conformer aux règles de protection des données qui s'appliquent à votre entreprise. Nous avons rassemblé des informations et des liens vers des documents susceptibles de vous aider à utiliser les services de Braze dans le respect des lois et réglementations applicables en matière de protection des données."
...
guide_featured_title: "Utilisation de la Braze"
guide_featured_list:
- name: Assistance technique en matière de protection des données pour les demandes des personnes concernées
  link: /docs/dp-technical-assistance/
  image: /assets/img/braze_icons/settings-01.svg
- name: "Pixel d'ouverture des e-mails et suivi des clics"
  link: /docs/user_guide/data_and_analytics/tracking/email_tracking#open-pixel-and-click-tracking-overview
  image: /assets/img/braze_icons/mail-01.svg
- name: Abonnements aux e-mails
...
- name: Centre de préférences e-mail
...
- name: "Archivage de l'utilisateur"
  ...
  image: /assets/img/braze_icons/users-01.svg
- name: Ressources supplémentaires sur la protection de la vie privée
  link: https://www.braze.com/resources/search?section%5B%5D=articles&q=privacy
  image: /assets/img/braze_icons/book-closed.svg

guide_menu_title: "Legal"
guide_menu_list:
- name: Addendum sur le traitement des données (PDF)
