...
layout: dev_guide
search_rank: 3
guide_top_header: "Portail de confidentialité de Braze"
...
guide_featured_title: "Utilisation de Braze"
guide_featured_list:
...
- name: Centre de préférence des e-mails
...
- name: Collecte de données par défaut et minimale du SDK
  ...
  image: /assets/img/braze_icons/settings-01.svg
- name: Confidentialité des données relative à la synchronisation d’audience de Canvas
...
- name: Addendum sur le traitement des données (PDF)
  ...
  image: /assets/img/braze_icons/briefcase-02.svg
- name: FAQ concernant l’addendum sur le traitement des données
...
- name: Communication concernant le cadre de protection des données
