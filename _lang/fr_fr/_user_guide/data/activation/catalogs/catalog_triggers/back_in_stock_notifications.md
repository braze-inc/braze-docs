...
![Paramètres du catalogue qui montrent la fonctionnalité de retour en stock activée. Les règles de notification prévoient d'avertir un millier d'utilisateurs toutes les dix minutes.]({% image_buster /assets/img/back_in_stock_settings.png %})
