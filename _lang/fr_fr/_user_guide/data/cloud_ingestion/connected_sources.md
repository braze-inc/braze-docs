...
Pour plus d'informations sur la création d'un segment avec cette source, reportez-vous à la section [Segments CDI.]({{site.baseurl}}/user_guide/engagement_tools/segments/segment_extension/cdi_segments/)
...
Une fois la source créée, vous pouvez l'utiliser pour créer une ou plusieurs segmentations CDI. Pour plus d'informations sur la création d'un segment avec cette source, reportez-vous à la [documentation CDI Segments]({{site.baseurl}}/user_guide/engagement_tools/segments/segment_extension/cdi_segments/).
