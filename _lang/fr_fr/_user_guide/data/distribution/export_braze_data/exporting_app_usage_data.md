...
# Exporter les analyses/analytiques de l'utilisation (si utilisée)
...
![Champs de période et des applications dans le tableau de bord d'accueil.]({% image_buster /assets/img_archive/home_dashboard_select_date.png %}){: style="max-width:60%;"}
...
![Graphique de performance au fil du temps sur le tableau de bord d'accueil.]({% image_buster /assets/img_archive/home_dashboard_export.png %})
