...
Pour le HTML, vous pouvez également utiliser les filtres Braze Liquid (`strip_html`) afin d'extraire le texte rendu du HTML. Par exemple :
...
### Import d'utilisateurs Lambda CSV
...
### Ingestion de données dans le nuage
