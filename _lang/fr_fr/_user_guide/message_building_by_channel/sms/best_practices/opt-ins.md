...
Braze vous recommande d'utiliser également la fonctionnalité de [double abonnement par SMS]({{site.baseurl}}/user_guide/message_building_by_channel/sms/keywords/sms_double_opt_in/). Cette fonctionnalité fonctionne automatiquement avec le formulaire de capture du numéro de téléphone par message in-app, invitant les utilisateurs à confirmer leur intention après avoir soumis leur numéro de téléphone via le formulaire.
