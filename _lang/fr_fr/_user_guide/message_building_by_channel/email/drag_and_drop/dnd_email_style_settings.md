...
![La section Paramètres de style global de l'e-mail dans l'onglet Paramètres de l'éditeur par glisser-déposer.]({% image_buster /assets/img_archive/dnd_global_style_settings.png %})
...
![Options de style de base qui comprennent des options pour modifier les couleurs d’arrière-plan et de contenu de l’e-mail, le nom de police par défaut et la couleur du lien par défaut.]({% image_buster /assets/img_archive/dnd_basic_styling.png %}) 
...
![Exemple de "Arial" comme police de secours avec "Sans-serif" comme famille de polices.]({% image_buster /assets/img_archive/dnd_fallbacks.png %})
...
Ici, vous pouvez ajuster les styles de vos titres d’e-mail en modifiant la taille de police, la couleur de police et l’alignement du texte. 
...
![La largeur du bloc de contenu est fixée à 600px.]({% image_buster /assets/img_archive/dnd_content_block_width_update.png %})
