...
1. [Créez votre campagne par e-mail][7] et sélectionnez l'**Éditeur HTML** comme expérience d'édition.
2. Allez dans la section **Contenu** de l'éditeur HTML et sélectionnez l'onglet **Promotion Gmail**.
3. Remplissez les champs sous **Information de base**, puis cliquez sur **Générer le code HTML**. Cela aidera à générer le script pour votre carte d'onglet Promo Gmail dans la section **Copiez et collez le code HTML dans `<Head>`**. <br> ![Exemple de création d’une carte.][2]
4. Choisissez d'inclure ou non une offre de réduction, des cartes de promotion ou les deux pour votre carte de promotion Gmail. <br> ![Options permettant d'inclure une offre de réduction et des cartes de promotion.][10]{: style="max-width:50%;"}
...
![Options pour spécifier la valeur de l'offre, le code et la date et l'heure de début d'une offre de réduction.][11]{: style="max-width:50%;"}
...
![Exemple de carrousel de produits d'une entreprise nommée Motto avec l'objet d'e-mail « Nos chaussettes les plus vendues sont en solde », avec trois images de chaussettes et leurs prix réduits.][9]{: style="max-width:40%;"}
...
En général, respectez ces [bonnes pratiques recommandées par Gmail][8]. 
...
Il y a [5]: https://developers.google.com/gmail/promotab/overview#preview_your_annotations
[6]: {% image_buster /assets/img/gmail_preview.png %}
[7]: {{site.baseurl}}/user_guide/message_building_by_ (en anglais)channel/email/html_editor/creating_an_email_campaign/
Il y a [8]: https://developers.google.com/gmail/promotab/best-practices
