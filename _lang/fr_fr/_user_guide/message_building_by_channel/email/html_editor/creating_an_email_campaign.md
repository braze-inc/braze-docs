...
{% alert tip %}
Nous vous recommandons de sélectionner une expérience d’édition par campagne par e-mail. Par exemple, choisissez l'**éditeur** **HTML Classic** ou **Block** dans une même campagne d'e-mail plutôt que de passer d'un éditeur à l'autre.
{% endalert %}
