...
#### Étape 1d : Ajouter le droit du domaine
...
- `appID`: Créé en combinant l'**ID de** l'**équipe de** votre application (allez sur `https://developer.apple.com/account/#/membership/` pour obtenir l'ID de l'équipe) et l'**identifiant de l'offre groupée**. Dans l'exemple ci-dessus, "JHGFJHHYX" est l'ID de l'équipe et "com.facebook.ios" est l'ID de l'offre groupée.
...
#### Vérifier les définitions des domaines
