...
| --------------| ----------- |
| Activation de l'AMP pour l'e-mail |  |
...
### 
 ...
 Le processus d'inscription implique l'envoi d'un e-mail HTML AMP de test pour obtenir l'approbation.  
