...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md metric='AMP Opens' (Ouvertures AMP) %}</td>
        </tr>
        <tr>
            <td class="no-split">Clics AMP</td>
            <td class="no-split">{% multi_lang_include metrics.md indicateurs='AMP Clics' %}</td>
        </tr>
    </tbody>
</table>
