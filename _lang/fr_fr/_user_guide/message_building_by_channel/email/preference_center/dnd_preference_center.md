...
> En utilisant l'éditeur de glisser-déposer, vous pouvez créer et personnaliser un centre de préférences pour aider à gérer quels utilisateurs reçoivent certains types de communication. Vous pouvez avoir jusqu'à 100 centres de préférences par espace de travail.
...
![Options permettant de personnaliser les propriétés de votre colonne, notamment la couleur d'arrière-plan, le style de bordure, le rayon de la bordure et le remplissage.]({% image_buster /assets/img/preference_center/preference_center7.png %}){: style="max-width:45%;"}
...
![Option permettant de sélectionner des blocs, notamment le titre, le paragraphe, le bouton, l'image et l'espaceur.]({% image_buster /assets/img/preference_center/preference_center8.png %}){: style="max-width:45%;"}
...
![L'option Copier le code Liquid dans la ligne d'un centre de préférences.]({% image_buster /assets/img/preference_center/preference_center10.png %}){: style="max-width:75%;"}
