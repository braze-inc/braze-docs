...
* [les groupes d'abonnement SMS :]({{site.baseurl}}/sms_rcs_subscription_groups/) Groupes d'abonnement et méthodes et statuts d'abonnement/de désabonnement.
