...
> Veuillez utiliser cette page pour résoudre les problèmes liés au canal de communication Push.
...
## Les clics s'ouvrent de manière inattendue dans l'application
...
1. À côté de votre URL dans le navigateur Chrome, veuillez sélectionner l'icône du curseur **Afficher les informations sur le site**.
2. Sous **Notifications**, veuillez sélectionner **Réinitialiser l'autorisation**.
...
6\. Veuillez sélectionner **Effacer les données du site**.
7\. Chrome vous demandera de recharger la page pour appliquer les paramètres mis à jour. Veuillez sélectionner **« Recharger** ».
...
2. Dans **les paramètres du site**, veuillez appuyer sur **Effacer&  Réinitialiser**.
...
4. Veuillez vérifier que les notifications sont configurées pour **demander confirmation avant l'envoi (recommandé)**.
...
1. À côté de l'URL de votre site, veuillez sélectionner<i class="fa-solid fa-circle-info" alt="info icon"></i>ou<i class="fas fa-lock" alt="lock icon"></i>.
...
4. Dans la boîte de dialogue permettant de confirmer votre choix, veuillez sélectionner **OK**.
...
4. Veuillez sélectionner **Supprimer** pour supprimer les autorisations de notification pour le site.
5. Ensuite, allez dans **Confidentialité** > **Gérer les données du site web.**
6. Sélectionnez votre site dans la liste.
7. Veuillez sélectionner **Supprimer** ou, pour supprimer toutes les données du site, sélectionnez **Tout supprimer**.
