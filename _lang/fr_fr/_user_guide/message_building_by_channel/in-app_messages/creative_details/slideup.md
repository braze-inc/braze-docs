...
![Message in-app contextuel tel qu'il apparaît sur l'écran d'une tablette. Le message apparaît en bas au milieu de l'écran et n'occupe pas toute la largeur de l'écran.]({% image_buster /assets/img/slideup-tablet.png %}){: style="border: none;"}
