...
![L'éditeur de messages in-app avec le modèle d'annonce de produit.][img1]
...
Personnalisez l'aspect et la convivialité de votre annonce de produit à l'aide des [composants de message in-app à][3] glisser-déposer.
