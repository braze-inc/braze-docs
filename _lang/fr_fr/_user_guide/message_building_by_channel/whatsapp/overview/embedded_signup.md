...
- Si vous intégrez WhatsApp à votre espace de travail, sélectionnez **Commencer l'intégration**. <br><br>![La page partenaire de WhatsApp avec un bouton pour commencer l'intégration.]({% image_buster /assets/img/whatsapp/whatsapp1.png %}){: style="max-width:80%;"}<br><br>
...
1. Dans la fenêtre de connexion à Meta (Facebook), sélectionnez **Se connecter en tant que** ou **Continuer**. <br><br>![Fenêtre de connexion à Meta.]({% image_buster /assets/img/whatsapp/login_screen.png %}){: style="max-width:60%;"}<br><br>
