...
# Intégrer Braze et WhatsApp à un système d'intelligence artificielle ou de communication externe.
...
3. Dans le champ **Webhook URL**, saisissez le point d'extrémité API (URL) du système externe qui recevra le message.
