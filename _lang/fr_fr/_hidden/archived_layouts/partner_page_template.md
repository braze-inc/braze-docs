...
|---|---|---|---|
|Clé de l'API REST de l'espace de travail de Braze | Plateforme Braze | Page **Paramètres** > **Clé API**  | Cette description devrait vous indiquer comment procéder avec la clé API REST de l'espace de travail. |
