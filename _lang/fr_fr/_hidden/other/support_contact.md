...
<div>
    <div class="container-fluid" id="main-container">
      <div class="row main-form">
        ...
        <div class="steps">
            <div class="step active">Détails de base</div>
...
<div class='gpt-text'>Génération en cours... </div>
<div class='gpt-text1'>Réponse générée pour vous </div>
                 </div>
    ...
    <form  id="ticket_form">
      <div id="step3">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="ticket_topic" class="required">Que pouvons-nous faire pour vous ? </label>
              <select id="ticket_topic" name="00N0V000009G0MG" class="form-control"></select>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="ticket_category" class="required">Catégorie </label>
