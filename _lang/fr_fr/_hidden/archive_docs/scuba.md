...
![Sélectionnez le filtre "Attribut personnalisé" sous "Détails du segment".]({% image_buster /assets/img/scuba/analytics/filter_attribute.png %})
...
![Choisir une opération et une valeur pour le ]({% image_buster /assets/img/scuba/analytics/operator_end.png %}) sélectionné
