...
Les entreprises peuvent utiliser Okta pour contrôler l'accès à Braze et autoriser ou exiger de leurs utilisateurs internes qu'ils se connectent à l'aide de leurs identifiants Okta. Pour accéder à ce nouveau produit, contactez votre gestionnaire de satisfaction client, votre gestionnaire de compte ou ouvrez un [ticket d'assistance]({{site.baseurl}}/braze_support/).
