...
Nous avons ajouté un nouveau [endpoint API]({{site.baseurl}}/developer_guide/rest_api/api_network_connectivity_issues/#whitelisting-brazes-api-endpoint-ip-ranges) qui/raw_data/status, vous permet de vérifier si une journée donnée a été chargée dans l'exportation d'événements bruts. Vous pouvez l’utiliser pour vérifier si les données brutes d’un jour particulier sont disponibles, pour faciliter le débogage et l’automatisation.
