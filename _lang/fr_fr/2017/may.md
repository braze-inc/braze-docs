...
Nous avons regroupé tous [les modèles]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/) et toutes les images sous l'onglet **Modèles&  Médias** dans Braze afin de rationaliser votre processus marketing. La page **Modèles&  Médias** contient également des modèles de liens.
