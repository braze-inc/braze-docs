...
Les utilisateurs de l'entreprise peuvent désormais télécharger des fichiers CSV des utilisateurs récemment importés. Cela vous donne plus de visibilité sur la synchronisation des données dans vos systèmes. En savoir plus sur l'[importation de fichiers CSV.]({{site.baseurl}}/user_guide/data/user_data_collection/user_import/)
