...
Les utilisateurs rencontrant des difficultés pour se connecter via l'authentification à deux facteurs peuvent contacter les administrateurs de leur entreprise afin de [réinitialiser leur authentification à deux facteurs]({{site.baseurl}}/user_guide/administrative/app_settings/company_settings/security_settings/#user-authetication-reset).
...
### Transcend - Conformité en matière& de confidentialité des données
