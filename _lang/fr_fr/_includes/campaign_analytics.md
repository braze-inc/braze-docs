...
Une fois que vous avez lancé votre campagne, vous pouvez revenir à la page des détails de cette campagne pour afficher les indicateurs clés. Accédez à la page des **campagnes** et sélectionnez votre campagne pour ouvrir la page des détails. Pour les cartes de contenu {% if include.channel == "Content Card" %} {% elsif include.channel == "email" %} e-mail {% elsif include.channel == "in-app message" %}messages in-app {% elsif include.channel == "push" %}messages push {% elsif include.channel == "SMS" %}messages SMS {% elsif include.channel == "whatsapp" %}messages WhatsApp {% elsif include.channel == "webhook" %}webhooks {% endif %}envoyés dans Canvas, reportez-vous à [Canvas analytics]({{site.baseurl}}/user_guide/engagement_tools/canvas/testing_canvases/measuring_and_testing_with_canvas_analytics/).

{% alert tip %}
Vous recherchez des définitions pour les termes et les indicateurs répertoriés dans votre rapport ? Consultez notre
  {% if include.channel == "email" %}[Glossaire de l'analyse/analytique des e-mails (si utilisé comme adjectif)]({{site.baseurl}}/user_guide/message_building_by_channel/email/reporting_and_analytics/analytics_glossary/)
  {% elsif include.channel == "Content Card" %}[Glossaire des indicateurs de rapport]({{site.baseurl}}/user_guide/data_and_analytics/report_metrics/) et filtre par cartes de contenu
  ...
  {% elsif include.channel == "push" %}[Glossaire des indicateurs de rapport]({{site.baseurl}}/user_guide/data_and_analytics/report_metrics/) et filtre par Push
  ...
  {% elsif include.channel == "whatsapp" %}[Glossaire des indicateurs de rapport]({{site.baseurl}}/user_guide/data_and_analytics/report_metrics/) et filtre par WhatsApp
  {% elsif include.channel == "webhook" %}[Report Metrics Glossaire]({{site.baseurl}}/user_guide/data_and_analytics/report_metrics/) et filtre par webhook{% endif %}.
{% endalert %}
...
{% alert note %}
Le canal WhatsApp comprend le taux de lecture. Cette mesure n'est fournie que pour les utilisateurs ayant activé les indicateurs de lecture, ce qui peut varier.
{% endalert %}
{% endif %}
...
![Carte de contenu message analyse/analytique des cartes]({% image_buster /assets/img/cc-message-performance.png %})
...
![Analyse/analytique des performances des messages e-mail]({% image_buster /assets/img_archive/email_message_performance.png %})
...
![Analyse/analytique des messages in-app]({% image_buster /assets/img_archive/iam_message_performance.png %})
...
![Analyse/analytique de la performance des messages envoyés]({% image_buster /assets/img_archive/push_message_performance.png %})
...
![Panneau de performance SMS/MMS comprenant un tableau d'indicateurs pour un groupe de contrôle, la variante 1 et la variante 2.]({% image_buster /assets/img_archive/sms_message_performance.png %})
...
![Panneau de performance du webhook comprenant un tableau d'indicateurs pour un groupe de contrôle et la variante 1.]({% image_buster /assets/img/webhook_message_performance.png %})
...
![Panneau de performance WhatsApp comprenant un tableau d'indicateurs pour la variante 1.]({% image_buster /assets/img/whatsapp_message_performance.png %})
...
Voici une description de certaines indicateurs clés que vous pouvez voir lors de l’examen des performances de vos messages. Pour obtenir les définitions complètes de tous les indicateurs des cartes de contenu, reportez-vous au [glossaire des indicateurs de rapport][1] et filtrez par carte de contenu.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md metric= "Messages envoyés %} <br><br>
                ...
                <ul>
                    <li><b>Au moment du lancement ou de l'entrée en scène :</b> Le nombre de cartes créées et disponibles pour être vues. Le fait que les utilisateurs aient consulté ou non la carte n’est pas comptabilisé.</li>
        ...
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md metric='Unique Clicks' %} Ceci inclut les clics sur les liens de désinscription fournis par Braze.</td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="no-split">
                {% multi_lang_include metrics.md metric='Unique Opens' %} Pour les e-mails, le suivi se fait sur une période de 7 jours. Ce nombre doit être compris entre 10 et 20 %. Tout ce qui est supérieur à 20 % est exceptionnel !
            </td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#click-to-open-rate">Taux de Click-to-Open</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='Click-to-Open Rate' (taux de clics d'ouverture) %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#spam">Taux de courriers indésirables</a></td>
            <td class="no-split">
                {% multi_lang_include metrics.md metric='Spam' %} Si cette métrique est supérieure à 0,08, cela peut être le signe que votre message est trop vendeur ou que vous devriez revoir vos indicateurs de collecte d'adresses e-mail (pour confirmer que vous envoyez des messages à ceux qui sont intéressés par votre correspondance).
            </td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unsubscribers-or-unsub">Désabonnés</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric= 'Unsubscribers or Unsub' (abonnés ou désabonnés) %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#other-opens">Autre ouverture</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric= "Autres ouvertures %}</td>
        </tr>
        <tr>
            ...
            <td class="no-split"> {% multi_lang_include metrics.md metric='Estimated Real Opens' %} Voir la section suivante pour plus d'indicateurs.</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#machine-opens">Ouverture automatique</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric= 'Machine Opens' (Ouvertures de machines) %}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md metric='échec d'envoi définitif' %}</td>
        </tr>
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md metric='échec provisoire d'envoi' %}</td>
        </tr>
    </tbody>
</table>

##### Estimation du taux d'ouverture réel {#estimated-real-open-rate}
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md indicateurs='Body Clicks' (clics sur le corps) %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#button-1-clicks">Clics Boutons 1</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='Clics sur le bouton 1' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#button-2-clicks">Clics Boutons 2</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='Bouton 2 Clics' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unique-impressions">Impressions uniques</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='Impressions uniques' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#total-impressions">Impressions totales</a></td>
        ...
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md metric='Total des conversions' %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#conversion-rate">Taux de conversion</a></td>
            <td>{% multi_lang_include metrics.md metric='Taux de conversion' %}</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#bounces">Rebonds</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='Bounces' %} Voir les <a href="#bounced-push">notifications push rebondies</a>.</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#direct-opens">Ouvertures directes</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='Direct Opens' (ouvertures directes) %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#opens">Ouvertures</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric="Ouvertures %}</td>
        </tr>
    </tbody>
</table>

Les désabonnements par push ne sont pas pris en compte en tant qu'indicateurs dans l'analyse/analytique de la campagne. Reportez-vous à la section [Suivi des désabonnements en mode push]({{site.baseurl}}/help/help_articles/push/push_unsubscribes) pour savoir comment effectuer un suivi manuel de cette mesure.
...
#### Notifications push rebondissantes {#bounced-push}

##### Service de notification push d’Apple

Les rebonds se produisent dans les APN lorsqu’une notification push tente de délivrer une notification à un appareil sur lesquels l’application prévue n’est pas installée. Les APN ont également le droit de modifier les jetons pour les appareils arbitrairement. Si vous tentez d'envoyer un message à l'appareil d'un utilisateur dont le jeton a été modifié entre le moment où nous avons enregistré son jeton (par exemple au début de chaque session lorsque nous enregistrons un utilisateur pour un jeton) et le moment de l'envoi, cela entraînera un rebond.

Si un utilisateur désactive la notification push dans les paramètres de l’appareil lors de la prochaine ouverture d’application, le SDK détecte que le push a été désactivé et informe Braze. À ce stade, nous allons mettre à jour l’état de l’opération push de Activé à Désactivé. Lorsqu’un utilisateur désactivé reçoit une campagne push avant d’avoir une nouvelle session, la campagne s’affiche avec succès et apparaît comme livrée. Il n’y aura pas de rebond de push pour cet utilisateur. Lors d'une session ultérieure, lorsque vous tentez d'envoyer un push à l'utilisateur, Braze sait déjà si nous disposons d'un jeton de premier plan et aucune notification n'est donc envoyée.
...
Voici quelques indicateurs clés de webhook que vous pouvez voir dans votre analyse/analytique (si utilisé comme un webhook métrique). Pour voir les définitions complètes de tous les indicateurs webhook utilisés dans Braze, reportez-vous à notre [Glossaire des indicateurs de rapport.][1]
...
<table>
    ...
    <tbody>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#unique-recipients">Destinataires uniques</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='Unique Recipients' (destinataires uniques) %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#sends">Envois</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric="Envois %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#errors">Erreurs</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='Erreurs' %}</td>
        </tr>
    </tbody>
</table>
...
Voici quelques indicateurs WhatsApp clés que vous pouvez voir dans vos analyses/analytiques. Pour consulter les définitions complètes de tous les indicateurs WhatsApp utilisés dans Braze, reportez-vous à notre [Glossaire des indicateurs de rapport.][1]
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="no-split">{% multi_lang_include metrics.md metric= "Réception/distribution %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#reads">Lectures</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='Reads' (indicateurs) %}</td>
        </tr>
        <tr>
            <td class="no-split"><a href="/docs/user_guide/data_and_analytics/report_metrics/#failures">Échecs</a></td>
            <td class="no-split">{% multi_lang_include metrics.md metric='Défaillances' %}</td>
        </tr>
    </tbody>
</table>
...
![Un graphique du panneau Performances historiques avec des exemples de statistiques pour un e-mail de février 2021 à mai 2022.]({% image_buster /assets/img/cc-historical-performance.png %})
...
### Analyse/analytique (si utilisée comme anjective)
