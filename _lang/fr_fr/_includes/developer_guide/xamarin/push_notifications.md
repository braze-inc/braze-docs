...
Consultez les [instructions d'intégration de Swift]({{site.baseurl}}/developer_guide/push_notifications/?sdktab=swift) pour obtenir des informations sur la configuration de votre application avec push et le stockage de vos identifiants sur notre serveur. Reportez-vous à l'exemple d'application [iOS MAUI](https://github.com/braze-inc/braze-xamarin-sdk/tree/master/appboy-component/samples/ios-net-maui/BrazeiOSMauiSampleApp) pour plus de détails.
