...
- Assurez-vous que le paramètre [Notification Priority]({{ site.baseurl }}/developer_guide/platform_integration_guides/android/push_notifications/fireos/customization/advanced_settings/#notification-display-priority) ] est défini sur `HIGH` dans votre campagne.
