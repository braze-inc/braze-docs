...
Pour utiliser l'intégration standard Shopify, veuillez vous référer à [la configuration de l'intégration standard Shopify]({{site.baseurl}}/shopify_standard_integration/).
{% endtab %}
...
Pour utiliser l'intégration personnalisée Shopify, veuillez vous référer à [la configuration de l'intégration personnalisée Shopify]({{site.baseurl}}/shopify_custom_integration/).
{% endtab %}
{% endtabs %}
...
Vous pouvez associer[`message_extras`]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/liquid/advanced_filters/message_extras/)[des codes de]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/promotion_codes/) [promotion]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/promotion_codes/) afin d'envoyer des informations relatives à ces codes à Currents. Veuillez utiliser `capture`l'étiquette pour enregistrer le code de promotion dans une variable, puis référencer cette variable dans `message_extras`:
