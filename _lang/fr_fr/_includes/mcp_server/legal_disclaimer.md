...
Le [protocole MCP (Model Context Protocol)](https://modelcontextprotocol.io/docs/getting-started/intro) est un protocole open source récemment introduit qui pourrait présenter des problèmes de sécurité ou des vulnérabilités à l'heure actuelle.
...
Pour toute assistance ou clarification, veuillez contacter l'[Assistance Braze]({{site.baseurl}}/user_guide/administrative/access_braze/support).