Vous pouvez utiliser ce modèle pour créer la documentation du partenaire technologique. Pour un exemple, voir [Scuba Analytics]({{site.baseurl}}/partners/data_and_infrastructure_agility/analytics/scuba/).
