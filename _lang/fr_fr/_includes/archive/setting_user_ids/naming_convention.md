...
Si vous constatez que vos ID comprennent des noms, des adresses e-mail, des horodatages ou des incréments, nous vous suggérons d'utiliser une nouvelle méthode de dénomination plus sûre afin que vos ID ne soient pas aussi faciles à deviner ou à usurper. Si vous choisissez de l'inclure dans vos ID d'utilisateur, nous **vous recommandons vivement d'** ajouter notre fonctionnalité d'[authentification SDK]({{site.baseurl}}/developer_guide/authentication/) pour empêcher l'usurpation d'identité.
