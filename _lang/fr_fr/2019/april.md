...
## Événements& New Currents

En plus de quelques corrections apportées à cette section, un nouvel événement [Abonnement]]({{ site.baseurl}}/user_guide/data_and_analytics/braze_currents/message_engagement_events/#subscription-events) a été ajouté à la page Événements d'engagement liés aux messages. 
...
{% alert important %}
Pour profiter de ces mises à jour, vous devrez modifier les paramètres de vos connecteurs Currents et activer les événements que vous souhaitez utiliser. Veuillez contacter votre gestionnaire de compte si vous avez des questions.
{% endalert %}
