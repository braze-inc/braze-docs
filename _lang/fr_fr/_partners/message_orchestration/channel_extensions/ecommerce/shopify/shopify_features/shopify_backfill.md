...
- Pour « Effectuer un achat » et « Effectuer un événement personnalisé », vous pouvez mettre à jour la [durée de début]({{site.baseurl}}/user_guide/engagement_tools/campaigns/building_campaigns/delivery_types/triggered_delivery/?redirected=true#step-4-assign-duration) à toute date et heure après que votre boutique Shopify a été connectée dans Braze. Les événements passés avant cette nouvelle heure de début ne déclencheront aucun message. 
