...
{% alert note %}
Si vous êtes un client existant de Braze avec des campagnes actives ou des Canvas, consultez le [backfill historique de Shopify]({{site.baseurl}}/shopify_features#historical-backfill) pour obtenir des informations importantes. Pour savoir quelles données clients spécifiques sont renseignées, reportez-vous aux [fonctionnalités de Shopify]({{site.baseurl}}/shopify_features/#shopify-data).
{% endalert %}
...
| Identificateur de Braze | Descriptif |
| --- | --- |
