...
Pour plus d'informations sur les données collectées par les SDK de Braze, consultez la rubrique [Collecte de données des SDK]({{site.baseurl}}/user_guide/data_and_analytics/user_data_collection/sdk_data_collection/). 
