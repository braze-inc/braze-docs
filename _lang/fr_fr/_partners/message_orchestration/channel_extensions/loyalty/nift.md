...
Rendez-vous sur votre [tableau de bord Nift][2], naviguez vers **Comptes** > **Intégrations** > **Braze**, et cliquez sur **Connecter**.
...
![Page d'intégration du service Nift demandant à l'utilisateur la clé API de Braze et l'URL du tableau de bord de Braze.][5]
