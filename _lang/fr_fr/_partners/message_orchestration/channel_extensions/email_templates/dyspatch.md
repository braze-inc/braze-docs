...
| ----------- | ----------- |
| Compte Dyspatch | Un [compte Dyspatch][3] avec un [rôle de propriétaire ou d'administrateur][4] est requis pour profiter de ce partenariat. |
...
Dans le champ **Rechercher les exports par**, vous pouvez choisir la manière dont vous souhaitez gérer la localisation. Ce champ vous permet de [localiser vos modèles d'e-mails et de][6] les exporter vers Braze pour envoyer facilement des e-mails personnalisés par langue ou par région. 
