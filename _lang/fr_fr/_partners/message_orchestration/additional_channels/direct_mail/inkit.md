...
![Une sélection de modèles de webhook préconçus disponibles dans l'onglet Modèles de webhook de la section Modèles et médias.][7]
...
![Code du corps de la requête et URL du webhook affichés dans l'onglet de composition du générateur de webhooks Braze.][5]
...
Votre texte brut sera automatiquement mis en évidence s'il s'agit d'une balise Braze applicable. Les valeurs `street`, `unit`,`state` et `zip` doivent être définies en tant qu’[attributs personnalisés][3] pour envoyer ce webhook.
