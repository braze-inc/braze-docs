...
> [Regal.io][6] est la solution de vente par téléphone et SMS conçue pour favoriser les conversations afin que vous puissiez atteindre vos objectifs de croissance beaucoup plus rapidement.
...
#### Événements
Le [guide des webhooks de reporting][7] de Regal comprend la liste complète des événements de reporting qu'ils publient. Ce guide contient également les définitions des propriétés et des exemples de charges utiles.

### Étape 3 : Transformez les événements Regal en événements Braze

La fonctionnalité de [transformation des données de]({{site.baseurl}}/data_transformation) Braze vous permet de mapper les événements Regal entrants dans le format nécessaire pour être ajoutés en tant qu'attributs, événements ou achats dans Braze.
...
- Braze ne prend pas en charge les numéros de téléphone comme identifiant. Pour les utiliser comme identifiants, il est possible de les définir comme [alias d'utilisateur][8] dans Braze.
