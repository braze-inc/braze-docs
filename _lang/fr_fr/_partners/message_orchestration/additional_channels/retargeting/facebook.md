...
{: start="2"}
2\. Dans le module d'exportation de l'audience Facebook, sélectionnez **Connecter Facebook**. <br><br>![Page des partenaires technologiques Facebook dans la plateforme Braze.][6]{: style="max-width:70%;"}
...
2. Sélectionnez **Données utilisateur**, puis sélectionnez **Exporter en tant qu'audience Facebook.** <br><br>![La section " Détails du segment " d'un segment dont les " Données utilisateur " sont sélectionnées pour afficher une liste déroulante d'options comprenant " Exporter en tant qu'audience Facebook ".][11]
