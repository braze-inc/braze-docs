...
2. Quikly effectue une recherche d'utilisateur à l'aide de l'[endpoint Exporter le profil utilisateur par identifiant]({{site.baseurl}}/api/endpoints/export/user_data/post_users_identifier/) pour voir s'il existe un profil utilisateur avec un `email_address` donné. 
