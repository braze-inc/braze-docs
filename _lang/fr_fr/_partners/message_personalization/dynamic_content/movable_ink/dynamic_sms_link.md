...
| [Raccourcissement de lien]({{site.baseurl}}/user_guide/message_building_by_channel/sms/campaign/link_shortening/) | Confirmez que le raccourcissement des liens est activé. | 
