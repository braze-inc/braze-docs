...
Ensuite, sélectionnez **Créer un bloc d'expérience** pour concevoir un bloc de contenu dynamique ou de recommandations à intégrer dans un modèle d'e-mail Braze.<br>![]({% image_buster /assets/img/dynamic_yield/dynamic_yield7.png %})

### Étape 2 : Rédigez le brouillon de votre message

L'image suivante montre un e-mail créé à partir de zéro dans le générateur.<br>![]({% image_buster /assets/img/dynamic_yield/dynamic_yield5.png %})
...
2. Sélectionnez un modèle pour la première variation. Vous pouvez maintenant définir des variables de conception et de contenu. Enregistrer la variation une fois terminée. <br>![]({% image_buster /assets/img/dynamic_yield/dynamic_yield3.png %})<br><br> 
3. Définissez l'audience dans le volet de contenu dynamique.<br>![]({% image_buster /assets/img/dynamic_yield/dynamic_yield4.png %})<br><br> 
...
2. Entrez le jeton pertinent de Braze qui insère le l’identifiant unique du client et l'ID d’e-mail de l'utilisateur.<br>![]({% image_buster /assets/img/dynamic_yield/dynamic_yield2_new.png %})
...
2. Ensuite, cliquez sur **Copier dans le presse-papiers**.<br>![]({% image_buster /assets/img/dynamic_yield/dynamic_yield.png %})<br><br> 
