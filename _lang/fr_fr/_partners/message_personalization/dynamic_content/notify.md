...
> [Notify](https://notifyai.io/) est une solution logicielle basée sur l'intelligence artificielle qui s'intègre de façon fluide aux outils de gestion de la relation client afin d'améliorer les stratégies marketing et de faciliter l'engagement sur plusieurs canaux.
...
Créez une [campagne déclenchée par l'API](https://www.braze.com/docs/user_guide/engagement_tools/campaigns/building_campaigns/delivery_types/api_triggered_delivery) dans Braze. Partagez ensuite la campagne `api_identifier` avec Notify.
