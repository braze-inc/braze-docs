...
![Une image de ce à quoi ressemble le tableau de bord lors de la sélection du type de message "Code personnalisé".][2]
...
![Une image montrant le code de validation de formulaire ajouté à l'étape de composition de votre campagne.][3]

### Étape 2 : Définir une paire clé-valeur pour Judo
![Cette image montre la seule paire clé-valeur nécessaire pour cette intégration avec la "clé" étant "judo-experience", et la "valeur" étant votre lien Judo.][4]{: style="float:right;max-width:50%;margin-left:15px;"}
