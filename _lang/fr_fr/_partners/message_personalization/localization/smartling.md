...
| Endpoint REST de Braze | [L'URL de votre endpoint REST.]({{site.baseurl}}/api/basics/#endpoints) Votre endpoint dépendra de l'URL de Braze pour votre instance. |
...
1. Dans [Smartling](https://dashboard.smartling.com/), créez un type de projet [connecteur Braze](https://help.smartling.com/hc/en-us/articles/115003074093) dans votre compte Smartling.
...
Reportez-vous à la [documentation](https://help.smartling.com/hc/en-us/articles/13248549217435) de Smartling pour plus de détails sur la configuration du connecteur.
...
![Configuration de la langue du connecteur.]({% image_buster /assets/img/smartling/smartling-braze-settings.png %})

### Étape 2 : Envoyer le contenu à Smartling

Une fois que le connecteur Braze a été connecté et configuré, vous trouverez le contenu Braze dans l'onglet **Braze** de votre projet Smartling. Consultez la [documentation](https://help.smartling.com/hc/en-us/articles/13248577069979) de Smartling pour en savoir plus.
...
![Liste des blocs de contenu.]({% image_buster /assets/img/smartling/smartling-content-blocks-list.png %})
