...
![La page technologique LinkedIn dans Braze comprend une section Aperçu et une section LinkedIn Audience Sync avec le bouton LinkedIn connecté.][3]{: style="max-width:75%;"}
...
!["Braze Self Service" est sélectionné comme compte publicitaire à connecter.][7]{: style="max-width:75%;"}
...
![Un compte LinkedIn connecté avec succès.][6]{: style="max-width:75%;"}
...
![Une audience avec le filtre "Ad Tracking Enabled is true".][5]{: style="max-width:75%;"}
...
![Un canvas dont l'audience d'entrée est "opted_in_marketing" est égal à "true".][4]{: style="max-width:75%;"}
...
![L'éditeur de canvas avec la liste des composants disponibles.][2]{: style="max-width:35%;"} ![Le composant Audience Sync sélectionné.][1]{: style="max-width:29%;"}

### Étape 4 : Configurer une synchronisation

Sélectionnez **LinkedIn** comme partenaire souhaité pour la synchronisation d’audience.

![Les détails de la "Configuration de la synchronisation de l'audience" avec les multiples partenaires à choisir.][9]{: style="max-width:70%;"}
...
![Synchronisation de l'audience sur LinkedIn avec Braze sélectionné comme compte publicitaire.][11]
...
![Page LinkedIn présentant les indicateurs suivants pour l'audience donnée.][8]
