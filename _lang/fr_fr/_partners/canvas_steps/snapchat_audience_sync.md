...
![Liste des comptes publicitaires disponibles que vous pouvez connecter à Snapchat.][2]{: style="max-width:80%;"}
...
![Une version mise à jour de la page des partenaires technologiques de Snapchat montrant que les comptes publicitaires se sont connectés avec succès.][3]{: style="max-width:80%;"}
...
![Détails de l'audience pour une audience Snapchat donnée qui comprend le nom de l'audience, le type d'audience, la taille de l'audience et la rétention de l'audience en jours.][9]
