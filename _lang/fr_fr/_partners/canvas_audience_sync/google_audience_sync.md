...
![Le menu pour sélectionner un composant Canvas dans l'éditeur.]({% image_buster /assets/img/audience_sync/audience_sync3.png %}){: style="max-width:35%;"} ![L'étape Audience Sync ajoutée au parcours de l'utilisateur.]({% image_buster /assets/img/audience_sync/audience_sync5.png %}){: style="max-width:28%;"}
...
Lorsqu'un client est sur le point d'atteindre la limite de débit de l'API Google Ads, Google fournit à Braze des informations sur les recommandations de réessai. Si un client de Braze atteint sa limite de débit, Braze the Canvas tentera à nouveau la synchronisation pendant environ 13 heures. Si la synchronisation n'est pas possible, ces utilisateurs sont répertoriés sous les indicateurs Users Errored.
