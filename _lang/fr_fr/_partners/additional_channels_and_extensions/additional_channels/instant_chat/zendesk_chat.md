...
![Un exemple de SMS sans formatage.]({% image_buster /assets/img/zendesk/instant_chat/chat2.png %}){: style="max-width:40%;"}
...
![Résolu ticket set up in Zendesk.]({% image_buster /assets/img/zendesk/instant_chat/chat9.png %}){: style="max-width:70%;"}
...
![Un exemple de demande avec les deux en-têtes requis.]({% image_buster /assets/img/zendesk/instant_chat/chat12.png %}){: style="max-width:70%;"}
...
![La page "Planifier la distribution" pour la première campagne webhook.]({% image_buster /assets/img/zendesk/instant_chat/chat13.png %})
