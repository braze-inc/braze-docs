...
![Ajouter le bouton d'intégration]({% image_buster /assets/img/knak/integration-setup-step-2-add-new-integration.png %})
...
![Intégration de Knak 1]({% image_buster /assets/img/knak/integration-post-step-1-sync.png %})

Ensuite, vérifiez le nom de l'e-mail et cliquez sur **Synchroniser**.

![Intégration de Knak 2]({% image_buster /assets/img/knak/integration-post-step-2-asset-name.png %})
