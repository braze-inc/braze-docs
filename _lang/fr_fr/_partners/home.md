...
partner_top_text: "Bienvenue sur notre liste d'Alloys (nos alliés, nos meilleurs amis, nos partenaires) ! Utilisez-la pour explorer la documentation technique qui vous aidera à intégrer les partenaires technologiques dans le SDK Braze. <br> <br>  Si vous souhaitez en savoir plus sur notre communauté Firebrands, un réseau de pionniers et d'innovateurs qui utilisent Braze pour moderniser leur expérience client et leur marketing, consultez notre page d'information <a href='https://brazefirebrands.splashthat.com/'>ici</a>."
description: "Cette page d'accueil répertorie tous les partenaires de Braze. Utilisez-la pour explorer la documentation technique qui vous aidera à intégrer les partenaires technologiques dans le SDK Braze."
