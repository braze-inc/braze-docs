...
7. Enfin, mappez les champs de données du Census aux champs équivalents de Braze.<br>![Mappage de Census]({% image_buster /assets/img/census/census_3.png %}){: style="max-width:80%;"}<br><br>
