...
![Optimizely Braze segmentation sync.]({% image_buster /assets/img/optimizely/image2_syncsegment.png %})
...
Vous pouvez également supprimer tous les mappages de champs de données qui ne sont pas nécessaires. Procédez comme suit dans l'ODP :
