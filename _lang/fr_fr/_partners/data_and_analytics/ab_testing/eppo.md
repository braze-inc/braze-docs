...
Pour toute question concernant l'implémentation de Braze Currents, le partage de données Snowflake ou la configuration de campagnes multivariées, contactez votre gestionnaire satisfaction client Braze.
