...
1. Dans Adobe Experience Platform, allez dans **Schémas** > sélectionnez **Créer un schéma** > sélectionnez **Événement d'expérience** > sélectionnez **Suivant.**<br><br>![Page Adobe Schemas pour le schéma appelé "Braze Currents Walk-Through".]({% image_buster /assets/img/adobe/currents_sources.png %})<br><br>
...
3. Téléchargez le [fichier d'échantillons Braze Currents](https://github.com/Appboy/currents-examples/blob/master/sample-data/Adobe/adobe_examples.json).<br><br>![Adobe "Ajouter une page de données".]({% image_buster /assets/img/adobe/currents_add_data.png %})<br><br>
