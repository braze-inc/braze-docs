...
- Synchronisez les audiences de Tealium avec [AudienceStream]({{site.baseurl}}/partners/data_and_analytics/customer_data_platform/tealium/tealium_audience_stream/) vers Braze pour les utiliser dans la personnalisation des campagnes et des Canvases de Braze ou la création de segments.
