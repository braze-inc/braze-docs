...
> [Zapier](https://zapier.com/) est un outil Web d'automatisation qui vous permet de partager des données entre des applications Web, puis d'utiliser ces informations pour automatiser les actions. 
