...
| `PERIOD_START`          | La période de démarrage en tant que date compatible avec BQL. Pour plus d'informations, consultez la section [Syntaxe et utilisation de BQL](https://docs.scuba.io/guides/bql-syntax-and-usage).                                                                                                 |
| `PERIOD_END`            | La période de fin en tant que date compatible avec BQL. Pour plus d'informations, consultez la section [Syntaxe et utilisation de BQL](https://docs.scuba.io/guides/bql-syntax-and-usage).                                                                                                   |
...
![Création d'un nouveau segment en Braze.]({% image_buster /assets/img/scuba/analytics/segment_name.png %})

### Étape 2 : Recherchez et sélectionnez l'attribut Scuba

Sous **Détails du segment** > **Filtres**, sélectionnez **Attributs personnalisés**.

![Sélection du filtre "Attribut personnalisé" sous "Détails du segment".]({% image_buster /assets/img/scuba/analytics/filter_attribute.png %})
...
![Choix d'une valeur de fonctionnement et d'une valeur pour le site ] sélectionné ({% image_buster /assets/img/scuba/analytics/operator_end.png %})
