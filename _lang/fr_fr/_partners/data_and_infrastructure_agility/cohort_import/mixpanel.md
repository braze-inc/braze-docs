...
> Cet article décrit comment importer des cohortes d'utilisateurs de [Mixpanel](https://mixpanel.com/) vers Braze. Pour plus d'informations sur l'intégration de Mixpanel et de ses autres fonctionnalités, consultez l'article sur [Mixpanel]({{site.baseurl}}/partners/data_and_infrastructure_agility/analytics/mixpanel_for_currents/).
