...
Braze permet d'exporter vers Rudderstack toutes les données figurant dans les [glossaires des événements de Braze Currents]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents).
