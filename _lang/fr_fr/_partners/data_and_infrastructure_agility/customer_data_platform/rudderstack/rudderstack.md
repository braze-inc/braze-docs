...
En utilisant l'[API eCommerce de RudderStack][20] pour appeler la méthode de suivi d'un événement portant le nom `Order Completed`, RudderStack envoie les produits répertoriés dans cet événement à Braze en tant que [`purchases`][21].
