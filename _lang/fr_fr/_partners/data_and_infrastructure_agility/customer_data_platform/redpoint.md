...
Faites glisser les attributs CDP de Redpoint dans la colonne **Attribut**. Définissez chaque **valeur de ligne d'en-tête** sur l'attribut utilisateur Braze correspondant][17]. 
...
![Un exemple de modèle d'export avec les attributs `external_id` et le nom de sortie.][8]{: style="max-width:75%;"}
...
![L'onglet des options montrant le format de date défini sur aaaa-MM-jj.][16]{: style="max-width:75%;"}
