...
> [Jacquard][1] réunit l'intelligence artificielle, la linguistique informatique et un esprit centré sur le client pour aider à déployer le langage de la marque à grande échelle, sur des canaux personnalisés aux couleurs de votre marque.
...
|---|---|
| Compte Jacquard | Un [compte Jacquard][1] est nécessaire pour bénéficier de ce partenariat. |
