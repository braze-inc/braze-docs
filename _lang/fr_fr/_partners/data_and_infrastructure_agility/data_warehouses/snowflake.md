...
Pour en savoir plus sur le partage de données de Snowflake, consultez la rubrique [Introduction au partage sécurisé de données](https://docs.snowflake.net/manuals/user-guide/data-sharing-intro.html#how-does-secure-data-sharing-work).
...
| Exigence | Descriptif |
| ----------- | ----------- |
| Accès par Braze | Pour accéder à cette fonctionnalité dans Braze, vous devez contacter votre gestionnaire de compte ou de satisfaction client Braze. |
...
Benchmarks, [un outil de données créé par](https://www.braze.com/perspectives/benchmarks) Braze, permet aux prospects et aux clients de Braze de se situer par rapport aux meilleurs acteurs de leur secteur en comparant leurs indicateurs à ceux de Braze.
