...
1. Allez dans le **centre de confidentialité** dans Transcend et sélectionnez **Voir votre centre de confidentialité.**<br><br>
2. Dans votre **centre de confidentialité**, sélectionnez **Prendre le contrôle**, puis **Télécharger mes données.** Saisissez votre e-mail ou connectez-vous pour vous authentifier avant de soumettre la requête.<br><br>
