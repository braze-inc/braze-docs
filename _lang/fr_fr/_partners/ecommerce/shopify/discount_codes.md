...
# Envoyez des codes de réduction uniques via Shopify
...
![Les options de configuration d'un ensemble d'escomptes][1]
...
![Barre de recherche avec un menu déroulant affichant l'ensemble des remises et une rangée de boutons à sélectionner][2].{: style="max-width:70%;"}
