---
nav_title: Aperçu de Shopify (Legacy)
article_title: "Aperçu de Shopify (Legacy)"
...
| Implémentation du SDK Web Braze | Pour suivre le comportement sur site et les utilisateurs anonymes, vous devez implémenter le SDK Web Braze soit via notre intégration Shopify par défaut, soit manuellement. <br><br>Pour plus d'informations sur vos options de mise en œuvre, consultez [Mise en œuvre du SDK Web sur votre site Shopify]({{site.baseurl}}/partners/ecommerce/shopify_legacy/getting_started_shopify). |
