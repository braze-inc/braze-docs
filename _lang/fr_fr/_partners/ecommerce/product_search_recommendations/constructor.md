...
Vous pouvez utiliser l'URL de l'API de découverte hors site de Constructor pour rendre les images des produits et diriger les utilisateurs vers la page détaillée du produit appropriée. Vous trouverez ci-dessous une description de la structure de l'endpoint et un exemple d'utilisation :
