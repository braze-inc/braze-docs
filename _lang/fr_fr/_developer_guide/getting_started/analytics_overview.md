---
nav_title: Présentation des analyses
article_title: Présentation des analyses
page_order: 4
...
Référez-vous à notre cas d'application [de Taxi/Ride-Sharing](#example-case) à la fin de ce guide pour un exemple de ce processus.
...
Par exemple, si une application de commerce électronique souhaite envoyer un message à un utilisateur lorsqu'il abandonne son panier, elle pourrait en outre améliorer son audience cible et permettre une personnalisation accrue de la campagne en ajoutant une propriété d'événement personnalisé de la "valeur des messages" des paniers des utilisateurs.
