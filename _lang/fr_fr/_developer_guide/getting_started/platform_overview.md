...
<br>
<br>
Pour en savoir plus sur la personnalisation des canaux de communication, consultez la page suivante : [Pour commencer : Aperçu de la personnalisation]({{site.baseurl}}/developer_guide/getting_started/customization_overview).
