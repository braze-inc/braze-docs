...
Pour plus de détails sur l'utilisation, reportez-vous à la rubrique [Stockage]({{site.baseurl}}/developer_guide/platforms/swift/storage/) dans la documentation du SDK Swift.
