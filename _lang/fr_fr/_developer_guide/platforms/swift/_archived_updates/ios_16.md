...
2. Notre SDK Braze Swift prend en charge une nouvelle fonctionnalité de ["push primer" sans code]({{site.baseurl}}/user_guide/message_building_by_channel/push/best_practices/push_primer_messages/) !
