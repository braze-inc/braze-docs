...
Avant d'utiliser Google Tag Manager, veillez à suivre notre [configuration initiale du SDK]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/initial_sdk_setup/overview/).
