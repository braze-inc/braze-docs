...
Si vous implémentez un carrousel comme flux secondaire de cartes de contenu, reportez-vous à la section [Utilisation de plusieurs flux de cartes de contenu]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/content_cards/multiple_feeds/) pour vous assurer que vous triez les cartes dans le flux approprié en fonction des paires clé-valeur.
