...
Pour en savoir plus sur les propriétés de l'appareil collectées automatiquement, consultez notre [collecte de données SDK]({{site.baseurl}}/user_guide/data/user_data_collection/sdk_data_collection/). 
