...
L'activation du mode arrière-plan pour les notifications à distance est nécessaire pour le [suivi de la désinstallation]({{site.baseurl}}/developer_guide/analytics/tracking_uninstalls/?sdktab=swift).
