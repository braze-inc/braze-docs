...
Plusieurs applications de test sont disponibles dans le [référentiel GitHub du SDK iOS](https://github.com/appboy/appboy-ios-sdk). Suivez ces instructions pour concevoir et exécuter nos applications de test.
...
Les notifications push pour l’application de test iOS nécessitent une configuration supplémentaire. Reportez-vous à notre [intégration iOS Push]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/integration/) pour plus de détails.
