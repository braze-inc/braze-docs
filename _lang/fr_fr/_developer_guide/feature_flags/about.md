...
Vous cherchez les étapes permettant de créer un indicateur de fonctionnalité dans Braze ? Reportez-vous à la section [Création de drapeaux de fonctionnalité]({{site.baseurl}}/developer_guide/platform_wide/feature_flags/create/).
...
## Utilisation des drapeaux de fonctionnalité

Les indicateurs de fonctionnalité vous permettent de :

- [Introduire des déploiements progressifs](#gradual-rollouts)
- [Contrôle à distance des variables d’application](#remotely-control-app-variables)
- [Synchroniser le déploiement des fonctionnalités et l'envoi des messages](#message-coordination)
- [Expérimenter de nouvelles fonctionnalités](#feature-experimentation)
- [Segmentation des utilisateurs en fonction de leurs fonctionnalités](#segmentation)
...
Pour déployer progressivement cette fonctionnalité, nous pouvons [créer]({{site.baseurl}}/developer_guide/platform_wide/feature_flags/create/) un indicateur de fonctionnalité nommé « Widget d’assistance en direct ».
...
Dans le code de notre application, nous n'afficherons le bouton **Start Live Chat** que lorsque le drapeau de la fonctionnalité Braze sera activé :
...
Le tableau suivant décrit les limitations qui s'appliquent au niveau d'un indicateur de fonctionnalité. Pour acheter la version payante des indicateurs de fonctionnalités, contactez votre gestionnaire de compte Braze ou demandez une mise à niveau dans le tableau de bord de Braze.

| Zone de limitation                                                                                                   | Version gratuite     | Version payante      |
| :---------------------------------------------------------------------------------------------------------------- | :--------------- | ----------------- |
| [Drapeaux de fonctionnalité active](#active-feature-flags)                                                                     | 10 par espace de travail | 110 par espace de travail |
...
### Drapeaux de fonctionnalité active
