...
Si une notification push n’est pas transmise, consultez la [console de développement]({{site.baseurl}}/developer_guide/platform_integration_guides/android/push_notifications/android/troubleshooting/#utilizing-the-push-error-logs) pour vous assurer qu'elle n'a pas été rejetée. Vous trouverez ci-dessous une description des erreurs fréquentes susceptibles d'être consignées dans la console de développement :
