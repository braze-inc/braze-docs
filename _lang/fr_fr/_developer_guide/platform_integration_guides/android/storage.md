...
Visitez notre [article sur la collecte de données SDK]({{site.baseurl}}/user_guide/data_and_analytics/user_data_collection/sdk_data_collection/) pour en savoir plus sur les propriétés des appareils collectées automatiquement.
