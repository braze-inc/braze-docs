...
Pour utiliser pleinement notre stratégie de synchronisation de géorepérage, vous devez avoir [les notifications push en arrière-plan]({{site.baseurl}}/developer_guide/platform_integration_guides/ios/push_notifications/silent_push_notifications/#use-silent-remote-notifications-to-trigger-background-work) activées en plus de compléter l'intégration push standard.
