...
L'intégration de Braze et [Grouparoo]({{site.baseurl}}/help/release_notes/deprecations/grouparoo) synchronise les données de l'entrepôt avec Braze. La planification de synchronisation automatique permet de maintenir les communications avec les clients à jour grâce à des informations actualisées.
