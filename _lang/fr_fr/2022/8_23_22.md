...
Braze a mis à jour la prise en charge de Liquid jusqu'à et y compris **Liquid 5 de Shopify.** Pour les nouveaux utilisateurs professionnels, Liquid 5 est désormais disponible. Pour les utilisateurs professionnels existants, Liquid 5 est actuellement en accès anticipé. Découvrez les [nouveautés du Liquid 5.]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/liquid#whats-new-with-liquid-5)
