...
## Nouvel éditeur par&glisser-déposer pour les messages in-app

Grâce au nouvel [éditeur par&glisser-déposer pour les messages in-app]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop), vous pouvez créer des messages entièrement personnalisés sans avoir besoin de connaître le langage HTML. L'éditeur par&glisser-déposer sera déployé auprès de tous nos clients au cours des prochains mois. Si vous souhaitez demander un accès plus rapidement, veuillez contacter votre gestionnaire de la satisfaction client.

## Mises à jour de l'éditeur par&glisser-déposer pour les e-mails

### Nouveaux blocs d’éditeur

Deux nouveaux blocs éditeurs ont été ajoutés à l'éditeur par&glisser-déposer pour les e-mails : [Blocs de paragraphes]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/dnd_editor_blocks/#paragraph) et [blocs de listes]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/dnd_editor_blocks/#list).
...
Cette fonctionnalité est actuellement disponible en accès anticipé. Si vous souhaitez participer à l'accès anticipé, veuillez contacter votre gestionnaire de la satisfaction client.
...
- [SDK Swift iOS 5.6.0-5.6.2](https://github.com/braze-inc/braze-swift-sdk/blob/main/CHANGELOG.md#562)
