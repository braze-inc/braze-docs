...
Ce nouvel article couvre les nuances de l'intégration des [messages in-app et des cartes de contenu sur tvOS]({{site.baseurl}}/developer_guide/platform_integration_guides/tvos/in-app_messaging), qui sont disponibles via le SDK Swift de Braze.
