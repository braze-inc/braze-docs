...
Nous avons ajouté une prise en charge des grandes images pour les notifications push Web sur Chrome pour Windows et Android afin de vous permettre de créer des expériences client riches et engageantes. En savoir plus sur le [web push.][58]
...
Nous avons mis à jour l'[aperçu d'Android][51] pour refléter les versions plus récentes d'Android depuis Android N.
