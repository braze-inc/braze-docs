...
Vous pouvez maintenant enregistrer des messages webhook comme modèles pour une réutilisation facile ou commencer par un modèle préconfiguré pour des plateformes telles que SMS avec Twilio ou des chatbots comme Facebook Messenger. En savoir plus sur [la création d'un webhook][26].

## Plusieurs adresses e-mail dans les rapports d'engagement

[Les rapports d'engagement][25] peuvent désormais être envoyés à plusieurs adresses e-mail.
