...
Ce [guide de mise à niveau iOS 15]({{site.baseurl}}/developer_guide/platform_integration_guides/ios/ios_15/) présente les changements introduits dans iOS 15 (WWDC21) et les étapes de mise à niveau requises pour votre intégration SDK iOS de Braze.

## Guide de mise à niveau Android 12

Ce [guide de mise à niveau Android 12]({{site.baseurl}}/developer_guide/platform_integration_guides/android/android_12/) décrit les modifications pertinentes introduites dans Android 12 (2021) et les étapes de mise à niveau requises pour votre intégration SDK Android de Braze.
...
Tous les clients qui ont actuellement et/ou utilisent des codes longs américains pour envoyer à des clients américains doivent enregistrer leurs codes longs pour 10DLC. Pour en savoir plus sur les spécificités du 10DLC et les raisons pour lesquelles il est nécessaire, consultez notre article dédié au [10DLC]({{site.baseurl}}/user_guide/message_building_by_channel/sms/phone_numbers/10dlc/).
