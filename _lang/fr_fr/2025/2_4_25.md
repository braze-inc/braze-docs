...
Afin de faciliter votre recherche, nous avons séparé les articles précédemment regroupés sous « Analyse des &données » en deux catégories distinctes : [Données]({{site.baseurl}}/user_guide/data) et [Analyse]({{site.baseurl}}/user_guide/analytics). 
