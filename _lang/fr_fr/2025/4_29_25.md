...
- [Braze Swift SDK 12.0.0](https://github.com/braze-inc/braze-swift-sdk/blob/main/CHANGELOG.md#1200)
    - Les XCFrameworks statiques distribués incluent désormais leurs ressources directement au lieu de s'appuyer sur des bundles de ressources externes.
        - Lorsque vous effectuez manuellement l'intégration des XCFrameworks statiques, il est nécessaire de sélectionner l'option *Embed&Sign* pour chaque XCFramework dans la section *Frameworks, Libraries, and Embedded Content* des *paramètres généraux* de votre cible.
