...
Vous pouvez désormais créer et mettre à jour des [modèles d'e-mail via l'API]({{site.baseurl}}/developer_guide/rest_api/email_templates/#email-templates). Chaque modèle aura un **email_template_id qui peut être référencé dans d’autres appels API.
