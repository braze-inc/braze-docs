...
## BrazeAI<sup>TM</sup>
BrazeAI<sup>TM</sup> alimente une collection d'outils accessibles et faciles à utiliser qui favorisent et simplifient la créativité, la personnalisation et l'optimisation de votre stratégie d'engagement. Pour en savoir plus sur les fonctionnalités de BrazeAI<sup>TM</sup>, consultez notre [documentation]({{site.baseurl}}/user_guide/brazeai/).
