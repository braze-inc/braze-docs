...
{% include early_access_beta_alert.md feature="La possibilité de fusionner les utilisateurs par e-mail et d'utiliser le endpoint `/users/merge` avec des identifiants non concordants" %}
