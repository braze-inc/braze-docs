...
Pour vous permettre de trouver plus facilement ce que vous cherchez, nous avons séparé les articles qui se trouvaient auparavant sous "Data & Analytics" en " &Data& and [Analytics]({{site.baseurl}}/user_guide/data)". 
