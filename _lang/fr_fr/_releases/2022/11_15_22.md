...
Avec le nouvel [éditeur par glisser-déposer pour les messages in]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop)-app, vous pouvez créer des messages in-app entièrement personnalisés sans avoir besoin de connaître le langage HTML. L’éditeur Drag & Drop sera déployé pour tous les clients au cours des prochains mois. Si vous souhaitez demander l'accès plus tôt, contactez votre gestionnaire de satisfaction client.
