...
L'intégration de Braze et [Grouparoo]({{site.baseurl}}/help/release_notes/deprecations/grouparoo) synchronise les données de l'entrepôt avec Braze. Les planifications de synchronisation automatique permettent d'actualiser les communications avec les clients.
