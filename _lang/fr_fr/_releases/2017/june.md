...
Nous avons mis à jour l’API externe pour prendre en charge le champ collapse_id pour les notifications push Apple, et vous permettre de communiquer avec précision vos clients. En savoir plus sur l'[API d'envoi de messages de Braze]({{site.baseurl}}/api/endpoints/messaging/).
