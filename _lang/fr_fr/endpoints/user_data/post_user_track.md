...
### En-têtes de limite de débit pour les utilisateurs actifs par mois CY 24-25

Toutes les réponses non limitées par le débit (telles que non`429`) contiendront les en-têtes de réponse HTTP suivants, qui indiquent au client l'état de la fenêtre de limite du débit horaire. Nous vous recommandons d'utiliser ces en-têtes pour gérer votre taux de demande :
