...
| `Something went wrong. Translation IDs are mismatched or translated text exceeds limits.`| Il s'agit là d'une erreur fourre-tout. Contactez le [service d'assistance de Braze]({{site.baseurl}}/user_guide/administrative/access_braze/support) pour obtenir de l'aide. |
