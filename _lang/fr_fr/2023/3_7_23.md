...
L'intégration de [Sisu Data]({{site.baseurl}}/partners/data_and_analytics/business_intelligence/sisu_data/) et de Braze vous permet de comprendre sur l'ensemble des campagnes ou au niveau d'une campagne pourquoi les indicateurs (par exemple, le taux d'ouverture, le taux de clics, le taux de conversion, etc.) évoluent et ce qui favorise les résultats les plus optimaux. Une fois ces segments identifiés, les utilisateurs de l'entreprise peuvent concrétiser les résultats dans leur entrepôt de données ou les envoyer directement depuis Sisu vers Braze afin de recibler et de réaliser le réengagement des utilisateurs.
