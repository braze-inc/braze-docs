...
{%  multi_lang_includeearly_access_beta_alert.md fonctionnalité='La possibilité de fusionner des utilisateurs par e-mail et d'utiliser `/users/merge`l'endpoint avec des identifiants non correspondants' %}
...
- [SDK Xamarin 2.0.0-2.0.1](https://github.com/braze-inc/braze-xamarin-sdk/blob/master/CHANGELOG.md)
...
- [SDK React native 6.0.0-6.0.2](https://github.com/braze-inc/braze-react-native-sdk/blob/master/CHANGELOG.md)
