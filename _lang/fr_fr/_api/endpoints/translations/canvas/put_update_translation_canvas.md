...
> Utilisez cet endpoint pour mettre à jour plusieurs traductions pour un Canvas. Veuillez consulter [la section Locales dans les messages]({{site.baseurl}}/user_guide/engagement_tools/messaging_fundamentals/localization/locales/) pour plus d'informations sur les fonctionnalités de traduction.
