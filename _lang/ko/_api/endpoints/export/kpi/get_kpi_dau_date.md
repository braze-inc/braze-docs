---
nav_title: "GET: 날짜별로 일일 활성 사용자 내보내기"
article_title: "GET: 날짜별로 일일 활성 사용자 내보내기"
search_tag: Endpoint
page_order: 4
layout: api_page
page_type: reference
description: "이 문서에서는 일일 활성 사용자 내보내기 Braze 엔드포인트에 대한 세부 정보를 간략하게 설명합니다."

---
{% api %}
# 일일 활성 사용자를 날짜별로 내보내기
{% apimethod get %}
/kpi/dau/data_series
{% endapimethod %}
...
| 매개변수| 필수 | 데이터 유형 | 설명 |
| -------- | -------- | --------- | ----------- |
| `length`| 필수 | 정수 | 반환된 시계열에 포함할 `ending_at` 이전 최대 일수입니다. 1에서 100(포함) 사이여야 합니다. |
