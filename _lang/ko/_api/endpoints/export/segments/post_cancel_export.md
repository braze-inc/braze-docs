---
nav_title: "POST: 세그먼트별로 수출 취소하기"
article_title: "POST: 세그먼트별로 수출 취소하기"
search_tag: Endpoint
page_order: 4
layout: api_page
page_type: reference
description: "이 문서에서는 세그먼트별 수출 취소에 대한 자세한 내용을 Braze 엔드포인트별로 설명합니다."
...
> 이 엔드포인트를 사용하여 지정된 세그먼트 ID로 진행 중인 모든 내보내기를 취소할 수 있습니다.
...
| 매개변수 | 필수 | 데이터 유형 | 설명 |
| --------- | ---------| --------- | ----------- |
| `segment_id` | Required | 문자열 | `segment_id` 에서 진행 중인 수출을 취소할 수 있습니다. |
