...
> 이 엔드포인트를 사용하여 캔버스에 대한 번역된 메시지를 미리 볼 수 있습니다. 번역 기능에 대한 자세한 내용은 [메시징의 로캘을]({{site.baseurl}}/user_guide/engagement_tools/messaging_fundamentals/localization/locales/) 참조하세요.
