---
nav_title: "GET: 이메일 템플릿의 모든 번역 및 현지화 보기"
...
layout: api_page
page_type: reference
description: "이 문서에서는 이메일 템플릿 엔드포인트에 대한 모든 번역 및 로케일 보기의 세부정보를 설명합니다."
---

{% api %}
# 이메일 템플릿에 대한 모든 번역 및 로케일 보기
{% apimethod get %}
/템플릿/이메일/번역/
{% endapimethod %}

> 이 엔드포인트를 사용하여 [이메일 템플릿]({{site.baseurl}}/user_guide/message_building_by_channel/email/templates)에 대한 모든 번역 및 로케일을 볼 수 있습니다. 번역 기능에 대한 자세한 내용은 [메시징의 로캘을]({{site.baseurl}}/user_guide/engagement_tools/messaging_fundamentals/localization/locales/) 참조하세요.
