...
layout: api_page
page_type: reference
description: "이 문서에서는 캠페인 엔드포인트의 번역 보기에 대한 자세한 내용을 설명합니다."
---
...
{% alert important %}
API를 통한 캠페인 메시지 번역 보기는 현재 얼리 액세스 중입니다. 얼리 액세스에 참여하려면 Braze 계정 매니저에게 문의하세요.
{% endalert %}
...
| 매개변수 | 필수 | 데이터 유형 | 설명 |
| --------- | ---------| --------- | ----------- |
|`campaign_id`| 캠페인 번역에 필요 | 문자열 | 캠페인의 ID입니다. |
