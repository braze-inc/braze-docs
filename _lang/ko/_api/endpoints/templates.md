---
nav_title: 템플릿
article_title: 템플릿 엔드포인트
page_order: 8
layout: dev_guide

search_tag: Endpoint
description: "이 랜딩 페이지에서는 이메일 및 이메일 콘텐츠 블록에 대한 Braze 템플릿 엔드포인트를 설명하고 나열합니다."
page_type: landing

guide_top_header: "템플릿 엔드포인트"
guide_top_text: "템플릿 엔드포인트를 사용하여 이메일 및 콘텐츠 블록용 템플릿을 만들고 관리할 수 있습니다. <br><br> 이메일 및 콘텐츠 블록용 템플릿을 만드는 방법에 대한 자세한 지침을 찾고 계신가요? <a href='/docs/user_guide/message_building_by_channel/email/templates/'>이메일 템플릿</a> 전용 <a href='/docs/user_guide/message_building_by_channel/email/templates/'>섹션과</a> <a href='/docs/user_guide/engagement_tools/templates_and_media/content_blocks/'>콘텐츠 블록 문서를</a> 확인하세요."

guide_featured_title: "이메일 템플릿 엔드포인트"
guide_featured_list:
  - name: "GET: 사용 가능한 이메일 템플릿 목록"
    link: /docs/api/endpoints/templates/email_templates/get_list_email_templates/
    image: /assets/img/braze_icons/mail-01.svg
  - name: "GET: 이메일 템플릿 정보 보기"
    link: /docs/api/endpoints/templates/email_templates/get_see_email_template_information/
    image: /assets/img/braze_icons/copy-04.svg
  - name: "POST: 이메일 템플릿 생성"
    link: /docs/api/endpoints/templates/email_templates/post_create_email_template/
    image: /assets/img/braze_icons/mail-01.svg
  - name: "POST: 이메일 템플릿 업데이트"
