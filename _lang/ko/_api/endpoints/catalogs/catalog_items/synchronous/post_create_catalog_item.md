---
nav_title: "POST: 카탈로그 항목 만들기"
article_title: "POST: 카탈로그 항목 만들기"
search_tag: Endpoint
page_order: 5
...
| 매개 변수 | 필수 | 데이터형 | 설명 |
|---|---|---|---|
| `items` | 필수 | 배열 | item 개체를 포함하는 배열입니다. 항목 개체에는 `id` 필드를 제외한 카탈로그의 모든 필드가 포함되어야 합니다. 요청당 하나의 항목 개체만 허용됩니다. |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4}
...
이 엔드포인트에 대한 세 가지 상태 코드 응답은 `201`, `400`, 및 `404`입니다.
