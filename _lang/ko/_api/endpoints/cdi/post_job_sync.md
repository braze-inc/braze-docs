...
{% alert note %}
이 엔드포인트를 사용하려면 `cdi.integration_sync` 권한으로 API 키를 생성해야 합니다.
{% endalert %}
...
| 매개변수 | 필수 | 데이터 유형 | 설명 |
|---|---|---|---|
| `integration_id` | Required | 문자열 | 통합 ID. 이는 Braze 대시보드에서 통합을 볼 때 URL에서 확인할 수 있습니다. URL 형식은 `https://[instance].braze.com/integrations/cloud_data_ingestion/[integration_id]` 입니다. |
