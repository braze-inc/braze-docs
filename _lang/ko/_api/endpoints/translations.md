...
guide_top_text: "캠페인, 캔버스 및 콘텐츠 블록에서 번역을 관리하고 업데이트하려면 Braze 번역 엔드포인트를 사용하십시오."
...
API 및 Braze 대시보드를 사용하여 캠페인, 캔버스(개별 단계 포함), 콘텐츠 블록 및 이메일 템플릿에서 번역 지원을 검증할 수 있는 두 가지 방법이 있습니다:
