---
nav_title: 카탈로그
article_title: 카탈로그 엔드포인트
page_order: 0
layout: dev_guide

search_tag: Endpoint
description: "이 랜딩 페이지에는 Braze 카탈로그 엔드포인트가 나열되어 있습니다."
page_type: landing

guide_top_header: "카탈로그 엔드포인트"
guide_top_text: "Braze 카탈로그 엔드포인트를 사용하여 카탈로그 및 카탈로그 항목 세부 정보를 추가, 편집 및 관리할 수 있습니다. 카탈로그를 대량으로 변경하려면 비동기 카탈로그 엔드포인트를 사용하세요. <br><br> 카탈로그 제작에 대한 지침을 찾고 계신가요? <a href='/docs/user_guide/personalization_and_dynamic_content/catalog/'>카탈로그 생성 및 사용에</a> 대한 도움말을 확인하세요."

guide_featured_title: "카탈로그 관리 엔드포인트"
guide_featured_list:
  - name: "DELETE: 카탈로그 삭제"
