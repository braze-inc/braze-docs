...
|`campaign_id`| 선택 사항* | 문자열 | 자세한 내용은 [캠페인 식별자를]({{site.baseurl}}/api/identifier_types/#campaign-identifier/) 참조하세요. <br><br>\*Braze 대시보드에서 캠페인 측정기준(예: _전송_, _클릭_ 또는 _바운스_)을 추적하려는 경우 필수입니다. |
