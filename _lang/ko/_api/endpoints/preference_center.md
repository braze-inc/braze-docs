...
guide_top_text: "이 섹션의 엔드포인트를 사용하여 사용자의 구독 상태 및 구독 그룹 상태를 표시할 수 있는 Braze 호스팅 웹사이트인 환경설정 센터를 구축할 수 있습니다. 개발자 팀은 HTML 및 CSS를 사용하여 페이지의 스타일이 브랜드 가이드라인과 일치하도록 환경설정 센터를 구축할 수 있습니다.<br><br>환경설정 센터를 만들고 사용자 지정하는 방법에 대한 자세한 내용은 <a href='/docs/user_guide/message_building_by_channel/email/preference_center/overview/'>환경설정 센터 개요</a>를 참조하세요."
