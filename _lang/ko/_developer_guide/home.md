...
guide_top_text: "개발자는 여기에서 Braze SDK에 대해 알아야 할 모든 것을 찾을 수 있습니다. 각 SDK는 자체 공개 GitHub 리포지토리에서 호스팅되며, 여기에는 Braze 기능을 테스트하거나 자체 애플리케이션과 함께 구현하는 데 사용할 수 있는 완전히 빌드 가능한 샘플 앱이 포함되어 있습니다. 자세히 알아보려면 <a href='https://www.braze.com/docs/developer_guide/references/'>참조, 리포지토리 및 샘플 앱을 참조하세요</a>.<br><br>Braze로 빌드하는 다른 개발자들과 교류하고, 배우고, 영감을 얻고 싶으신가요? <a href='https://www.braze.com/dev-portal'>Braze 개발자 커뮤니티에</a> 가입하세요!"
