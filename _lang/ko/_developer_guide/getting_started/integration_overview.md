...
### 2024-2025년 월간 활성 사용자, 전체 MAU, 웹 MAU 및 모바일 MAU  

2024-2025년 월간 활성 사용자, 전체 MAU, 웹 MAU 및 모바일 MAU를 구매한 고객의 경우, Braze는 세션, 사용자 속성, 이벤트 및 기타 사용자 프로필 데이터를 업데이트하는 데 사용되는 API 요청에 대해 서버 측 속도 제한을 적용합니다. 이는 플랫폼의 안정성을 보장하고 빠르고 안정적인 서비스를 유지하기 위한 것입니다. 
...
* 지속적인 요청량을 제어하는 안정적인 속도 제한은 버스트 윈도우보다 긴 롤링 윈도우(예: 몇 분) 동안 지속되며, 버스트 제한과 시간당 속도 제한 사이의 지속적인 트래픽을 부드럽게 하는 데 도움이 됩니다.
...
더 높은 Braze 속도 제한이 필요한 경우, Braze 지원팀 또는 고객 성공 매니저에게 연락하고 다음 세부정보를 포함하세요:
