...
자세한 사용법은 Swift SDK 설명서의 [스토리지]({{site.baseurl}}/developer_guide/platforms/swift/storage/)를 참조하세요.
...
{% alert tip %}
iOS 앱이 있는 경우 **라이브 SDK 버전**이 Swift SDK의 첫 번째 릴리스 버전인 5.0.0 이상이면 기존 [Objective-C iOS SDK]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/initial_sdk_setup/overview/) 대신 [Swift SDK]({{site.baseurl}}/developer_guide/platforms/swift/sdk_integration/)를 사용 중임을 확인할 수 있습니다.
{% endalert %}
