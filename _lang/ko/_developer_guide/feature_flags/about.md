...
Braze에서 기능 플래그를 만드는 방법에 대한 단계를 찾고 계신가요? [기능 플래그 만들기를]({{site.baseurl}}/developer_guide/platform_wide/feature_flags/create/) 참조하세요.
...
기능 플래그를 사용하려면 다음을 수행합니다.

- [점진적 롤아웃 도입](#gradual-rollouts)
- [앱 변수 원격 제어](#remotely-control-app-variables)
- [기능 롤아웃 및 메시징 동기화](#message-coordination)
- [새로운 기능으로 실험](#feature-experimentation)
- [기능 플래그별 사용자 세분화](#segmentation)
...
이 기능을 점진적으로 롤아웃하려면 '실시간 채팅 위젯'이라는 기능 플래그를 [생성]({{site.baseurl}}/developer_guide/platform_wide/feature_flags/create/)하면 됩니다.
...
다음 표에서는 기능 플래그 수준에서 적용되는 제한 사항에 대해 설명합니다. 유료 버전의 기능 플래그를 구매하려면 Braze 계정 매니저에게 문의하거나 Braze 대시보드에서 업그레이드를 요청합니다.
