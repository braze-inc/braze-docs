---
nav_title: 스토리지
article_title: Android 및 FireOS용 스토리지
platform: 
  - Android
  - FireOS
page_order: 9
page_type: reference
description: "이 참조 문서에서는 Braze Android SDK에서 캡처한 기기 수준의 속성정보를 설명합니다."
...
자동으로 수집된 기기 속성정보에 대한 자세한 내용은 [SDK 데이터 수집]({{site.baseurl}}/user_guide/data_and_analytics/user_data_collection/sdk_data_collection/) 문서를 참조하세요.
