...
platform: 
  ...
  - FireOS
page_order: 3
description: "이 참조 문서에서는 Android 또는 FireOS 애플리케이션에 네트워크 오프라인 모드를 통합하는 방법에 대해 설명합니다."

---

# 네트워크 오프라인 모드

> [네트워크 오프라인 모드는][1] 런타임 중 언제든지 Braze SDK의 아웃바운드 네트워크 요청을 일시 중지하거나 재개할 수 있는 옵션 기능입니다. 오프라인 상태에서도 이벤트는 손실되지 않습니다. 이 참조 문서에서는 이 모드를 통합하는 방법에 대해 설명합니다.
