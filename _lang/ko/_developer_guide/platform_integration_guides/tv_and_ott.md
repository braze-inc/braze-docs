---
nav_title: TV 및 OTT 통합
article_title: TV 및 OTT 통합
page_order: 15
...
> 기술이 새로운 플랫폼과 기기로 발전함에 따라 Braze를 사용한 메시징도 발전할 수 있습니다! Braze는 다양한 TV 운영 체제 및 "OTT" 셋톱박스를 위한 다양한 참여 채널을 제공합니다.
...
자세한 내용은 [Fire OS 통합 가이드를]({{site.baseurl}}/developer_guide/platform_integration_guides/android/initial_sdk_setup/android_sdk_integration/) 참조하세요.
...
- 인앱 메시지 
  - TV와 같은 비터치 환경에서 HTML 메시지를 표시하려면 `com.braze.configuration.BrazeConfig.Builder.setIsTouchModeRequiredForHtmlInAppMessages` 을 `false` 으로 설정하세요( [Android SDK v23.1.0부터](https://github.com/braze-inc/braze-android-sdk/blob/master/CHANGELOG.md#2310) 사용 가능).
- \* 푸시 알림(수동 통합 필요)
  - Android TV에서는 기본적으로 푸시 알림이 지원되지 않습니다. 그 이유를 알아보려면 Google의 [디자인 가이드라인을](https://designguidelines.withgoogle.com/android-tv/patterns/notifications.html) 참조하세요. 그러나 **이를 위해 푸시 알림 UI를 수동으로 통합**할 수도 있습니다. 설정 방법에 대한 [설명서를]({{site.baseurl}}/developer_guide/platform_integration_guides/android/push_notifications/android/android_tv_push/) 참조하세요.

자세한 내용은 [Android SDK 통합 가이드를]({{site.baseurl}}/developer_guide/platform_integration_guides/android/initial_sdk_setup/android_sdk_integration/) 참조하세요.
...
자세한 내용은 [웹 스마트 TV 통합 가이드를]({{site.baseurl}}/developer_guide/platform_integration_guides/web/smart_tvs/) 참조하세요.
...
자세한 내용은 [Roku 통합 가이드를]({{site.baseurl}}/developer_guide/platform_integration_guides/roku/in-app_messaging/overview/) 참조하세요.
...
**Android SDK**
- [인앱 메시지 사용자 지정](https://www.braze.com/docs/developer_guide/platform_integration_guides/android/in-app_messaging/customization/custom_listeners/)
- [콘텐츠 카드 사용자 지정](https://www.braze.com/docs/developer_guide/platform_integration_guides/android/content_cards/implementation_guide/)
...
**웹 SDK**
- [인앱 메시지 사용자 지정](https://www.braze.com/docs/developer_guide/platform_integration_guides/web/in-app_messaging/customization/key_value_pairs)
- [콘텐츠 카드 사용자 지정](https://www.braze.com/docs/developer_guide/platform_integration_guides/web/content_cards/customization/custom_ui/)
