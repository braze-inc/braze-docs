...
page_order: 2
nav_title: 사용자 정의
article_title: iOS 인앱 메시지 커스터마이징
layout: dev_guide
...
guide_top_text: "모든 Braze 인앱 메시지 유형은 메시지, 이미지, <a href='http://fortawesome.github.io/Font-Awesome/'>Font Awesome</a> 아이콘, 클릭 동작, 분석, 편집 가능한 스타일링, 커스텀 디스플레이 옵션 및 커스텀 전달 옵션에 걸쳐 매우 커스터마이즈할 수 있습니다. 여러 옵션은 <a href='/docs/user_guide/message_building_by_channel/in-app_messages/create/'>대시보드 내에서</a> 인앱 메시지별로 구성할 수 있습니다. Braze는 다양한 사용 사례와 요구를 충족시키기 위해 여러 수준의 고급 맞춤 설정을 추가로 제공합니다."
description: "이 랜딩 페이지는 Braze iOS 소프트웨어 개발 키트 인앱 메시지 커스텀 옵션을 다룹니다. 여기에는 대리자 설정, 방향 커스터마이징, 커스텀 디스플레이 처리 등이 포함됩니다."
