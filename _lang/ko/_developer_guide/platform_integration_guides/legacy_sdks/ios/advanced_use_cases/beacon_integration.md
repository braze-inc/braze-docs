...
platform: iOS
page_order: 4
description: "이 문서에서는 iOS용 Gimbal 비콘을 사용하여 커스텀 이벤트를 로깅하는 방법을 다룹니다."
...
Gimbal 비콘이 설정되어 있고 앱에 통합되어 있으면 방문 시작 또는 방문 종료, 비콘 확인과 같은 사용자 지정 이벤트를 기록할 수 있습니다. 장소 이름이나 체류 시간과 같은 이벤트의 속성을 기록할 수도 있습니다.
