...
매년 iOS 베타를 테스트하는 과정에서 특정 UI 탐색 막대가 불투명하지 않고 투명하게 표시되는 Apple의 변경 사항을 확인했습니다. iOS 15에서 콘텐츠 카드에 Braze의 기본 UI를 사용하거나 별도의 브라우저 앱이 아닌 앱 내에서 웹 딥링크를 열 때 이러한 현상이 나타납니다.
