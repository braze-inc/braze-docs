...
platform: Swift
page_order: 4
description: "이 참조 문서에서는 Swift SDK에서 인앱 구매 및 매출을 추적하고 구매 속성정보를 할당하는 방법을 보여줍니다."
...
자세한 내용은 [iOS 클래스 문서로그구매](https://braze-inc.github.io/braze-swift-sdk/documentation/brazekit/braze/logpurchase(productid:currency:price:quantity:properties:fileid:line:) "문서를") 참조하세요.

### 수량 추가
고객이 한 번의 결제에서 동일한 제품을 여러 번 구매하는 경우 구매에 수량을 추가할 수 있습니다. 수량을 `Int` 으로 전달하면 됩니다.
