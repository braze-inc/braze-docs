---
nav_title: 딥링킹
article_title: Flutter용 딥링크
platform: Flutter
page_order: 6
description: "이 문서에서는 Android 및 iOS에서 Flutter 앱용 딥링킹을 구현하는 방법을 다룹니다."

---

# 딥링킹

> Flutter를 사용하여 iOS 또는 Android 앱에 딥링크를 구현하는 방법을 알아보세요. 샘플 앱을 확인하려면 다음을 참조하세요. [GitHub: Braze Flutter SDK 예제](https://github.com/braze-inc/braze-flutter-sdk/tree/master/example). 딥링킹에 대한 일반적인 정보는 [딥링킹 FAQ]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/deep_linking_to_in-app_content/#what-is-deep-linking)를 참조하세요.

## 전제 조건

Flutter 앱에 딥링킹을 구현하려면 먼저 기본 [Android]({{site.baseurl}}/developer_guide/platform_integration_guides/android/advanced_use_cases/deep_linking/) 또는 [iOS]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/advanced_use_cases/linking/) 레이어에서 딥링킹을 설정해야 합니다.
