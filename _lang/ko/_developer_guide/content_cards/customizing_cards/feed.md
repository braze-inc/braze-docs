---
nav_title: 피드
article_title: 콘텐츠 카드에 대한 피드 커스텀하기
page_order: 3
...
{% alert important %}
Braze 소프트웨어 개발 키트에는 성능/성과 및 안정성을 위한 속도 제한도 적용됩니다. 자동화된 테스트를 실행하거나 수동 QA를 수행할 때 이 점을 염두에 두세요. 자세한 내용은 [Braze 소프트웨어 개발 키트 요금 한도를]({{site.baseurl}}/developer_guide/sdk_integration/rate_limits/) 참조하세요.
{% endalert %}
