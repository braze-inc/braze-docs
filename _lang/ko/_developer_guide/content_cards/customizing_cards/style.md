...
![기본 글꼴과 사각형 모서리가 있는 콘텐츠 카드와 둥근 모서리와 곡선 글꼴이 있는 콘텐츠 카드 두 개가 있습니다.]({% image_buster/assets/img/content_cards/content-card-customization-attributes.png %})
...
두 가지 방법 중 하나로 스타일링을 적용할 수 있습니다. 첫 번째는 [`ContentCardListStyling`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.jetpackcompose.contentcards.styling/-content-card-list-styling/index.html) 와 [`ContentCardStyling`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.jetpackcompose.contentcards.styling/-content-card-styling/index.html) 를 [`ContentCardsList`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.jetpackcompose.contentcards/-content-cards-list.html)를 전달하는 것입니다:
...
두 번째는 예시와 같이 [`BrazeStyle`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.jetpackcompose/-braze-style.html) 를 사용하여 다음 예시와 같이 Braze 컴포넌트에 대한 글로벌 스타일링을 만드는 것입니다:
...
{% endtab %}
{% tab Jetpack Compose %}
기본 글꼴을 프로그래밍 방식으로 변경하려면 기본 글꼴의 [`titleTextStyle`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.jetpackcompose.contentcards.styling/-content-card-styling/index.html#715371549%2FProperties%2F-1725759721)`ContentCardStyling` 를 설정할 수 있습니다.

특정 카드 유형에 대해 `titleTextStyle` 을 설정하여 설정할 수도 있습니다. [`BrazeShortNewsContentCardStyling`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.jetpackcompose.contentcards.styling/-braze-short-news-content-card-styling/index.html) 로 설정하고 이를 [`shortNewsContentCardStyle`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.jetpackcompose.contentcards.styling/-content-card-styling/index.html#8580250%2FProperties%2F-1725759721) 의 `ContentCardStyling` 으로 전달할 수도 있습니다.
...
기본 고정 아이콘을 변경하려면 기본 고정 아이콘의 [`pinnedResourceId`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.jetpackcompose.contentcards.styling/-content-card-styling/index.html#794044424%2FProperties%2F-1725759721)`ContentCardStyling` 을 설정할 수 있습니다.  예를 들어, 다음과 같습니다.
...
![두 개의 콘텐츠 카드가 나란히 표시됩니다. 첫 번째 카드에서 하단에 파란색 선이 있고 이는 열람하지 않았음을 나타냅니다. 두 번째 카드에는 파란색 선이 없으며 이는 이미 열람했음을 나타냅니다.]({% image_buster /assets/img/braze-content-cards-seen-unseen-behavior.png %})
...
읽지 않은 표시줄의 색상을 변경하려면 다음 값을 수정합니다. [`unreadIndicatorColor`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.jetpackcompose.contentcards.styling/-content-card-styling/index.html#-1669590042%2FProperties%2F-1725759721)`ContentCardStyling` 의 값을 수정합니다:
