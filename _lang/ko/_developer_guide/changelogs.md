...
guide_top_text: "각 SDK에 대한 다음 체인지로그는 Braze 설명서 또는 개별 GitHub 리포지토리에서 확인할 수 있습니다."
description: "이 랜딩 페이지에는 Braze 설명서 내 각 SDK 및 개별 GitHub 리포지토리에서 사용할 수 있는 체인지로그가 나열되어 있습니다."
