...
!['소프트웨어 개발 키트 디버거'가 강조 표시된 '설정 및 테스트' 섹션입니다.]({% image_buster /assets/img/sdk_debugger/select_sdk_debugger.png %})
...
![디버깅 세션에 '세션 종료' 버튼이 표시됩니다.]({% image_buster /assets/img/sdk_debugger/close_debugging_session.png %}){: style="max-width:85%;"}
...
![세션이 끝난 후 '내보내기 로그' 및 '복사 세션 ID'가 표시된 디버깅 페이지가 표시됩니다.]({% image_buster /assets/img/sdk_debugger/copy_id_and_export_logs.png %})
