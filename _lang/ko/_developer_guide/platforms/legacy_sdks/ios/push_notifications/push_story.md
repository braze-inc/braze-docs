...
다음으로 푸시 스토리 메시지에 버튼이 표시되는 데 필요한 [작업 버튼]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/customization/action_buttons/) 통합 단계를 참조하세요.
