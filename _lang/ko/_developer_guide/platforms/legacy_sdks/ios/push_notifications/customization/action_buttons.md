...
![푸시 메시지를 아래로 당겨서 두 개의 사용자 지정 가능한 작업 버튼을 표시하는 GIF입니다.]({% image_buster /assets/img_archive/iOS8Action.gif %})
...
Braze는 [기본 푸시 카테고리]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/customization/action_buttons/) 세트를 제공하는 것 외에도 사용자 지정 알림 카테고리 및 작업을 지원합니다. 애플리케이션에 카테고리를 등록한 후 Braze 대시보드를 사용하여 사용자에게 알림 카테고리를 보낼 수 있습니다.
