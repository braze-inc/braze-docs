---
nav_title: 기타 소프트웨어 개발 키트 사용자 정의
...
Swift SDK v5.7.0부터는 IDFV 필드를 선택적으로 비활성화할 수 있으며, 대신 Braze에서 임의의 UUID를 기기 ID로 설정합니다. 자세한 내용은 [IDFV 수집]({{site.baseurl}}/developer_guide/analytics/managing_data_collection/?sdktab=swift)을 참조하십시오.

## 선택적 IDFA 수집

IDFA 수집은 Braze SDK 내에서 선택 사항이며 기본값으로 비활성화되어 있습니다. IDFA 수집은 Braze 내에서 [통합의 설치 속성]({{site.baseurl}}/partners/message_orchestration/attribution/adjust/)을 사용하려는 경우에만 필요합니다. IDFA를 저장하려는 경우 무료로 저장하도록 지원하므로 추가 작업 없이 출시 즉시 이러한 옵션을 활용할 수 있습니다.
