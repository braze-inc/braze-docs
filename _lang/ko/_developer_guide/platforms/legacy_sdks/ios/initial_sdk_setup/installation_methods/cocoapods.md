...
CocoaPods와 관련된 문제가 있는 경우 CocoaPods [문제 해결 가이드를](http://guides.cocoapods.org/using/troubleshooting.html) 참조하세요.

{% alert note %}
`rake` 실행 파일을 덮어쓰라는 메시지가 표시되면 자세한 내용은 [시작하기](http://guides.cocoapods.org/using/getting-started.html) 지침( CocoaPods.org )을 참조하세요.
{% endalert %}
...
![Appboy 예제 폴더가 확장되어 새로운 \`AppbpyExample.workspace\`가 표시됩니다.]({% image_buster /assets/img_archive/podsworkspace.png %})

## 다음 단계

[통합을 완료하려면]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/initial_sdk_setup/completing_integration/) 지침을 따르세요.
