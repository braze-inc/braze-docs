...
다음으로 푸시 알림을 등록합니다. 이 가이드에서는는 Apple 개발자 포털 및 Xcode 프로젝트에서 [푸시 자격 증명을 올바르게 설정]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/integration/)했다고 가정합니다. 
...
- [고급 콘텐츠 카드 구현 가이드]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/content_cards/implementation_guide/)
