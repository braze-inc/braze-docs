...
## 테스트 애플리케이션 빌드
여러 테스트 애플리케이션은 [iOS SDK GitHub 리포지토리](https://github.com/appboy/appboy-ios-sdk) 내에서 사용할 수 있습니다. 이 지침을 따라 테스트 애플리케이션을 구축하고 실행하십시오.
...
푸시 알림은 iOS 테스트 애플리케이션에 추가 구성이 필요합니다. 자세한 내용은 [iOS 푸시 통합]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/push_notifications/integration/)을 참조하십시오.
