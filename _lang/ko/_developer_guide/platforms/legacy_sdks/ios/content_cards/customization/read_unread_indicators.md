---
nav_title: 열람 및 미열람 표시기
article_title: iOS용 콘텐츠 카드 열람 및 미열람 표시기
platform: iOS
page_order: 4
...
![두 개의 콘텐츠 카드가 나란히 표시됩니다. 왼쪽 카드 하단에 파란색 선이 있으며, 이는 아직 열람하지 않았음을 나타냅니다. 오른쪽 카드에는 파란색 선이 없으며, 이는 이미 열람했음을 나타냅니다.]({% image_buster /assets/img/braze-content-cards-seen-unseen-behavior.png %}){: style="max-width:80%"}
