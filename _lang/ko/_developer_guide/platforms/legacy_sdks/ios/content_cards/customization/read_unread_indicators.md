...
![두 개의 콘텐츠 카드가 나란히 표시됩니다. 왼쪽 카드에서 하단에 파란색 선이 있고 이는 열람하지 않았음을 나타냅니다. 오른쪽 카드에는 파란 선이 없으며, 이는 이미 보았음을 나타냅니다.]({% image_buster /assets/img/braze-content-cards-seen-unseen-behavior.png %}){: style="max-width:80%"}
