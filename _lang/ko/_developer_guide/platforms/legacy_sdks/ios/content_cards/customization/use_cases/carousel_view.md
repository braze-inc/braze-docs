...
캐러셀을 보조 콘텐츠 카드 피드로 구현하는 경우 [여러 콘텐츠 카드 피드 사용]({{site.baseurl}}/developer_guide/platforms/legacy_sdks/ios/content_cards/multiple_feeds/)을 참조하여 키-값 페어에 따라 카드를 올바른 피드로 정렬하는 방법을 알아봅니다.
