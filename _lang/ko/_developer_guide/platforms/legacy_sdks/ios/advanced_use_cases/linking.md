...
Braze 통합은 인앱 메시지 및 푸시 캠페인을 통해 사용자를 유도하는 모든 기존 링크가 ATS 요건을 충족하도록 함으로써 ATS 요건을 충족할 수 있습니다. ATS 제한을 우회하는 방법이 있지만, 링크된 모든 URL이 ATS 규정을 준수하는지 확인하는 것이 좋습니다. Apple은 애플리케이션 보안을 점점 더 강조하고 있기 때문에 다음과 같은 ATS 예외 허용 접근 방식은 Apple에서 지원이 보장되지 않습니다.
