---
nav_title: 커스텀 트리거링
article_title: iOS용 인앱 메시지 트리거 커스텀하기
platform: iOS
page_order: 7
...
![커스텀 이벤트를 수행하는 사용자에게 전달될 실행 기반 전달 인앱 메시지 캠페인 "server_event".]({% image_buster /assets/img_archive/iosServerSentPush.png %})입니다.
...
!["campaign_name" 이 "인앱 메시지 이름 예시"와 같은 커스텀 이벤트 "인앱 메시지 트리거"를 수행하는 사용자에게 전달되는 실행 기반 전달 인앱 메시지 캠페인입니다.]({% image_buster /assets/img_archive/iosIAMeventTrigger.png %})
