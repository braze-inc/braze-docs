...
![메시지 작성기에 두 개의 키-값 페어가 있습니다. 첫 번째 키-값 페어는 "attribute_key"를 "즐겨찾는 팀"으로 설정하고, 두 번째는 "view_type"을 "픽커"로 설정합니다.]({% image_buster /assets/img/iam_implementation/dashboard2.png %}){: style="max-width:65%;"}
...
![메시지 작성기에 세 개의 키-값 페어가 있습니다. 첫 번째 키-값 페어 "attribute_key"는 "푸시 태그"로 설정되고, 두 번째 "subtitle_text"은 "알림 활성화는 또한..."으로 설정되며, 세 번째 "view_type"는 "table_list".]({% image_buster /assets/img/iam_implementation/dashboard3.png %}){: style="max-width:65%;"}
