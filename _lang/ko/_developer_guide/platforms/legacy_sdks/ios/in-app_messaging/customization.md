...
page_order: 2
nav_title: 사용자 지정
article_title: iOS 인앱 메시지 사용자 지정
layout: dev_guide
...
guide_top_header: "iOS 인앱 메시지 커스터마이징"
guide_top_text: "모든 Braze 인앱 메시지 유형은 메시지, 이미지, <a href='http://fortawesome.github.io/Font-Awesome/'>Font Awesome</a> 아이콘, 클릭 동작, 분석, 편집 가능한 스타일링, 커스텀 디스플레이 옵션 및 커스텀 전달 옵션에 걸쳐 매우 커스터마이즈할 수 있습니다. 여러 옵션을 <a href='/docs/user_guide/message_building_by_channel/in-app_messages/create/'>대시보드 내</a>에서 인앱 메시지별로 구성할 수 있습니다. Braze는 다양한 사용 사례와 요구 사항을 충족시키기 위해 여러 수준의 고급 사용자 지정 설정을 추가로 제공합니다."
description: "이 랜딩 페이지는 Braze iOS SDK 인앱 메시지 사용자 지정 옵션을 다룹니다. 여기에는 위임 설정, 방향 사용자 지정, 커스텀 디스플레이 처리 등이 포함됩니다."
