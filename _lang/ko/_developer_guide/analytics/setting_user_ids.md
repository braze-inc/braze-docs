...
대신 Google 태그 관리자를 사용하려면 **사용자 태그 유형 변경**을 사용하여 [`changeUser` 메서드](https://js.appboycdn.com/web-sdk/latest/doc/modules/braze.html#changeuser)를 호출할 수 있습니다. 사용자가 로그인하거나 고유한 `external_id` 식별자로 식별될 때마다 사용합니다.
