...
기본적으로 Braze는 다음과 같은 디바이스 수준 속성을 수집하여 디바이스, 언어, 시간대를 기반으로 메시지를 맞춤 설정할 수 있도록 합니다:
...
모든 쿠키를 비활성화하려면 웹 SDK를 초기화할 때 [`noCookies`](https://js.appboycdn.com/web-sdk/latest/doc/modules/braze.html#initializationoptions) 옵션을 사용합니다. 이렇게 하면 하위 도메인 간에 이동하는 익명 사용자를 연결할 수 없으며 각 하위 도메인에 새로운 사용자가 생성됩니다.
