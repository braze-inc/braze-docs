...
hide_toc: true
layout: dev_guide
guide_top_header: "인앱 메시지 튜토리얼"
guide_top_text: "> 이들은 Braze SDK를 위한 인앱 메시지 튜토리얼로, 단계별로 스크롤 가능한 코드가 포함되어 있습니다. 전체 목록은 <a href='/docs/developer_guide/tutorials/'>Braze SDK 튜토리얼</a>을 참조하세요."
