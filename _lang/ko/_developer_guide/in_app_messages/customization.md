...
article_title: Braze SDK에 대한 앱 내 메시지 사용자 정의
page_order: 0.1
...
> Braze SDK의 인앱 메시지를 사용자 지정하는 방법을 알아보세요. 고급 스타일링 기술에 대한 튜토리얼을 확인하세요 [키-값 쌍을 사용하여 메시지 스타일링 사용자 정의]({{site.baseurl}}/developer_guide/in_app_messages/tutorials/customizing_message_styling).
