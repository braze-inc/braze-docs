...
모든 클러스터에서 사용할 수 있는 새로운 Braze Facebook Audience Export 프로세스는 명확한 통합 단계로 워크플로를 간소화합니다. 더 이상 OAuth 리디렉션 URI를 화이트리스트에 추가하여 커스텀 오디언스를 전송하거나 Facebook 앱 설정을 조정하여 통합할 필요가 없습니다.
