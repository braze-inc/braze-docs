...
## 1단계: Create a Braze website app {#step-1}
...
## 2단계: Add subdomain and environmental variables {#step-2}
...
## 4단계: Add a Shopify Account Login event 
...
## 5단계: Add tracking for Product Viewed and Cart Updated events
...
## 6단계: Install the Braze Shopify integration

### 6.1단계: Shopify 스토어 연결
...
### 6.4단계: Historical backfill (optional)
...
### 6.5단계: Custom data tracking setup (advanced) 
...
- **콘텐츠 카드:** For enabling Content Cards for inbox or website banner use cases, refer to [Content Cards]({{site.baseurl}}/developer_guide/content_cards/).
