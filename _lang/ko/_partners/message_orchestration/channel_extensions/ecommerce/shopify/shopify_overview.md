...
| Braze 웹 SDK 구현 | 현장 행동 및 익명 사용자를 추적하려면 기본 Shopify 통합을 통해 또는 수동으로 Braze 웹 SDK를 구현해야 합니다. <br><br>구현 옵션에 대한 자세한 내용은 [Shopify 사이트에서 웹 SDK 구현]({{site.baseurl}}//partners/message_orchestration/channel_extensions/ecommerce/shopify/getting_started_shopify/#implement-web-sdk)을 참조하세요. |
