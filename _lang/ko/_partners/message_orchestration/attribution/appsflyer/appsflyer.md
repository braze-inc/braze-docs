...
1. AppsFlyer의 왼쪽 표시줄에서 **통합 파트너** 페이지로 이동합니다. 다음으로, **Braze**를 검색하고 Braze 로고를 클릭하여 구성 창을 엽니다.
2. **연동** 탭에서 **파트너 활성화를 켭니다**.
3. Braze의 대시보드에서 찾은 데이터 가져오기 키와 REST 엔드포인트를 입력합니다. 
