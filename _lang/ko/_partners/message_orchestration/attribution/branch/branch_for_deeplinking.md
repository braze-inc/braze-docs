...
Braze와 Branch 통합을 통해 사용자의 여정 초반에 올바르게 [기여도]({{site.baseurl}}/partners/advertising_technologies/attribution/branch_for_attribution/)를 평가하고 딥링크를 통해 원하는 위치로 연결하여 고객에게 더 나은 경험을 제공할 수 있습니다.

통화 링크(`href=tel:`)를 포함하는 경우,
...
[유니버설 링크 및 앱 링크]({{site.baseurl}}/help/help_articles/email/universal_links/)에 대한 설명서를 참조하십시오
또는 [Branch 설명서](https://docs.branch.io/pages/integrations/braze/)를 참조하여 Braze를 통해 발송된 이메일에서 딥링킹을 설정합니다.
