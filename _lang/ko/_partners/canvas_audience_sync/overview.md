...
| [Pinterest]({{site.baseurl}}/partners/canvas_audience_sync/pinterest_audience_sync/) | Between 24 and 48 hours | Pinterest processes 7 queries per second and 1.9K users per request. Braze batches users every 5 seconds. | Yes | Pinterest audiences require at least 100 users. |
