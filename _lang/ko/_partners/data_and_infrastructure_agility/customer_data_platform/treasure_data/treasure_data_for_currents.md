...
Braze는 [커런츠 이벤트 용어집에]({{site.baseurl}}/user_guide/data/braze_currents/) 나열된 모든 데이터( [메시지 참여]({{site.baseurl}}/user_guide/data/braze_currents/event_glossary/message_engagement_events/) 및 [고객 행동]({{site.baseurl}}/user_guide/data/braze_currents/event_glossary/customer_behavior_events/) 이벤트의 모든 속성 포함)를 트레저 데이터로 내보낼 수 있도록 지원합니다.
