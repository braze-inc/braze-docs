...
브레이즈와 어도비 통합을 통해 두 시스템 간의 정보 흐름을 원활하게 제어할 수 있습니다. [커런츠]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/)를 사용하면 데이터를 Adobe에 연결하여 전체 성장 스택에서 실행 가능하게 만들 수 있습니다. 
