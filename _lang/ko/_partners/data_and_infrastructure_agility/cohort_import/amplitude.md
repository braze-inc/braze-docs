...
코호트 동기화는 일회성 동기화로 설정하거나, 매일 또는 매시간으로 예약하거나, 매분 업데이트되는 실시간으로도 설정할 수 있습니다. 비즈니스 요구 사항에 적합한 옵션을 선택하면서도 [데이터 포인트]({{site.baseurl}}/user_guide/onboarding_with_braze/data_points/)를 신중하게 소비하는 것을 잊지 마세요.
