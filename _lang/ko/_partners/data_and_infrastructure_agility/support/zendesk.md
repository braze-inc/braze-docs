...
- 웹훅에 대한 베어러 토큰 인증 방법을 선택하고 [Braze API 키](https://www.braze.com/docs/api/basics/#creating-and-managing-rest-api-keys)를 제공하십시오.
  - 사용 중인 API 키에 웹훅이 사용하는 Braze 엔드포인트에 대한 [올바른 권한](https://www.braze.com/docs/api/basics/#rest-api-key-permissions)이 있는지 확인하세요.<br><br>
