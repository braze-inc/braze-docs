...
Braze의 이벤트 로그에는 LiveRamp 기본 앱 내에서 사용할 수 있는 식별자가 포함되어 있습니다. 각 이벤트 유형에 사용 가능한 식별자의 전체 목록을 보려면 [Braze 이벤트 스키마 및 식별자](https://www.braze.com/docs/assets/download_file/data-sharing-raw-table-schemas.txt)를 다운로드합니다.
