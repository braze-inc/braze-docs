...
Hightouch의 개인화 API는 Braze 구성 내에서 사용할 수 있는 REST 엔드포인트를 제공합니다. 특히 Braze의 연결된 콘텐츠 오퍼링을 사용하여 개인화 API에 GET 요청을 보내 특정 식별자와 관련된 모든 정보를 검색할 수 있습니다. 이 API를 통해 공개되는 데이터는 고객, 제품 또는 기타 오브젝트 데이터를 나타낼 수 있습니다. 
