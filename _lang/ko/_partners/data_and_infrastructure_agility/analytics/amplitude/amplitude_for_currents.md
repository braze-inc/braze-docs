...
Braze는 Amplitude로 커런츠 [사용자 행동]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/customer_behavior_events/) 및 [메시지 인게이지먼트]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/message_engagement_events/) 이벤트 용어집에 나열된 다음 데이터 내보내기를 지원합니다.
