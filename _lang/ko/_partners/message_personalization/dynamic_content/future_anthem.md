...
> 리얼 머니 게임 업계를 위한 퓨처 앤썸의 올인원 제품인 Amplifier AI는 콘텐츠 개인화, 실시간 경험, 역동적인 오디언스를 제공합니다. Amplifier AI는 스포츠, 카지노, 복권 전반에 걸쳐 원활하게 작동하므로 고객은 좋아하는 게임, 좋아하는 팀, 참여 점수, 다음 베팅 추천, 다음 베팅 예상 등 업계별 플레이어 속성을 통해 Braze의 플레이어 프로필을 향상시킬 수 있습니다.
...
| Braze REST 엔드포인트      | 인스턴스와 일치하는 Braze [REST 엔드포인트](https://www.braze.com/docs/developer_guide/rest_api/basics/#endpoints) (예: `rest.iad-01.com`). |
