...
> [알림](https://notifyai.io/)은 고객 관계 관리 도구와 원활하게 통합되어 마케팅 전략을 향상시키고 여러 채널에서 참여를 촉진하는 AI 기반 소프트웨어 솔루션입니다.
...
Braze에서 [API 트리거 캠페인](https://www.braze.com/docs/user_guide/engagement_tools/campaigns/building_campaigns/delivery_types/api_triggered_delivery)을 생성합니다. 그런 다음, Notify와 함께 캠페인 `api_identifier`를 공유하세요.
