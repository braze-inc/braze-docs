...
다음 예제는 Retail Demo Store라고 하는 완전한 기능을 갖춘 이커머스 사이트 예제에 배포됩니다. 이 튜토리얼의 리소스와 코드는 [AWS 샘플 리테일 데모 스토어](https://github.com/aws-samples/retail-demo-store/)에 게시되어 있습니다. 이 참조 아키텍처 구현을 사용하여 Amazon Personalize를 자체 환경에 구현하는 개요로 사용할 수 있습니다.
...
Braze를 사용하여 사용자에게 개인화된 메시지를 보내기 전에 Retail Demo Store 아키텍처를 예로 들어 일반적인 전자상거래 웹사이트에 필요한 관련 구성 요소를 검토하십시오.
