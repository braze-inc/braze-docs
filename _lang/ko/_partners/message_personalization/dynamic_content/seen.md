...
Braze에서 새 [웹훅 캠페인을](https://www.braze.com/docs/user_guide/message_building_by_channel/webhooks) 만듭니다. 캠페인에 이름을 지정한 다음 다음 표를 참조하여 웹훅을 작성하세요:
...
2. **데이터 설정에서** [데이터 변환을](https://www.braze.com/docs/user_guide/data_and_analytics/data_transformation/creating_a_transformation/#prerequisites) 열고 **변환 만들기를** 선택합니다.
