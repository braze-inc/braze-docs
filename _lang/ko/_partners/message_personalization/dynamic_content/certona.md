...
description: "이 참조 문서에서는 고객 생애주기 전반에 걸쳐 개인화를 제공하는 실시간 옴니채널 개인화 솔루션인 Certona와 Braze 간의 파트너십을 간략히 설명합니다. Braze의 연결된 콘텐츠 파트너인 Certona를 사용하면 멀티채널 캠페인에 콘텐츠 추천을 쉽게 삽입할 수 있습니다."
page_type: partner
search_tag: Partner
