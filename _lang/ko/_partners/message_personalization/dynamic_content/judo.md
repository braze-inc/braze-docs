...
마지막으로 캠페인 트리거를 설정하고 **배달** 및 **타겟 사용자** 섹션의 세그먼트를 통해 사용자를 선택하여 캠페인을 완료합니다. Braze 인앱 메시지의 다양한 구성 요소에 대해서는 인앱 메시지 [문서를]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/create/) 참조하세요.
