...
| Braze REST API 키 | A Braze REST API key with the following permissions:<br>- `users.track`<br>- `campaigns.trigger.send`<br>- `campaigns.list`<br>- `canvas.trigger.send`<br>- `canvas.list`<br><br>Braze 대시보드의 **설정** > **API 키**에서 생성할 수 있습니다. |
