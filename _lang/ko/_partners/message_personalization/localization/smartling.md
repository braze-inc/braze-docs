...
![스마트링 프로젝트 언어의 Braze 연결.]({% image_buster /assets/img/smartling/image3_project_languages.png %})
...
메시징에 번역 태그를 추가하는 방법은 [Braze의 안내를]({{site.baseurl}}/user_guide/message_building_by_channel/email/using_locales/?tab%3Dhtml%2520editor#prerequisites) 참조하세요:
