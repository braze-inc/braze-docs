...
## Currents 및 Snowflake 데이터 공유 message_extras Liquid 태그
...
### Sendbird - 메시징
Braze 및 [Sendbird]({{site.baseurl}}/partners/additional_channels_and_extensions/additional_channels/instant_chat/sendbird/) 통합을 통해 회사 사용자는 다음을 수행할 수 있습니다:
