...
<div>
    <div class="container-fluid" id="main-container">
      <div class="row main-form">
          <div class="col" >
              <h1 class="h1">도움이 필요하세요? </h1>
              <div class="gradient-line"></div>
          </div>
   </div>
        <div class="main-border">
        <div class="steps">
            <div class="step active">기본 정보</div>
...
<div class='gpt-text'>생성 중... </div>
<div class='gpt-text1'>당신을 위한 생성된 답변 </div>
                 </div>
...
<div class="form-container1"  style="display:none;">
 <div id="step3" >
<div id="firefox_warning" style="display:none;">Firefox 사용자의 경우 이 사이트를 허용 목록에 추가하거나 <a href="https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Privacy/Tracking_Protection?utm_source=mozilla&utm_medium=firefox-console-errors&utm_campaign=default" target="_blank">추적 기술 방지 설정</a>을 확인하지 않으면 티켓이 제출되지 않을 수 있습니다.</div>

<div id="ticket_mainform" class="container">
    <form  id="ticket_form">
      <div id="step3">
        <h2>필요한 것을 찾지 못하셨나요? 우리 지원 팀에 문의하세요.</h2>
        <!-- Row 1 -->
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="ticket_topic" class="required">무엇을 도와드릴까요? </label>
              <select id="ticket_topic" name="00N0V000009G0MG" class="form-control"></select>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="ticket_category" class="required">카테고리 </label>
