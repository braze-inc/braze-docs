...
{% alert important %}
이 페이지의 BrazeAI 권장 사항은 BrazeAI Decisioning Studio™에는 적용되지 않습니다. BrazeAI Decisioning Studio™에서 개인 데이터와 관련된 개인정보 보호 권한 요청을 관리하려면 계정 매니저에게 문의하세요.
{% endalert %}
...
- Braze 서비스 내에서 external_id 아이디를 가진 최종 사용자의 경우, 해당 아이디를 사용하여 해당 최종 사용자의 데이터를 삭제할 수 있습니다.
- Braze 서비스 내에 external_id 주소가 없는 익명 사용자의 경우, Braze 소프트웨어 개발 키트를 사용하여 해당 최종 사용자의 기기 식별자를 검색할 수 있으며 기기 식별자를 사용하여 해당 기기와 연결된 최종 사용자 프로필을 찾을 수 있습니다. 그런 다음 사용자 삭제 API를 사용하여 해당 최종사용자와 연결된 프로필을 삭제할 수 있습니다.
...
<tbody>
  <tr>
    ...
    <ul>
        <li>속성 USERS_BEHAVIORS_CUSTOMEVENT</li>
        <li>속성 USERS_BEHAVIORS_PURCHASE</li>
        <li>MESSAGE_EXTRAS 에 대한:</li>
            <ul>
