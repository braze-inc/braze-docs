...
![다음 필터를 사용한 세그먼트 퍼널 예시입니다: "마지막으로 이 앱을 사용한 지 30일 미만", "마지막으로 대기자 명단에 추가한 지 30일 미만", "마지막으로 구매한 지 30일 미만" 사용자 수가 4,302명에 달했습니다.]({% image_buster /assets/img_archive/Wish_List_2.png %})
...
![다음 필터를 사용하여 이메일용 세그먼트 퍼널 예시를 만듭니다: '마지막으로 구매한 지 30일 미만', '마지막으로 사용한 앱이 30일 미만', '포그라운드 푸시 인에이블먼트가 사실', '이메일 구독 상태가 옵트인'이라는 조건으로 2,799명의 사용자에게 도달했습니다.]({% image_buster /assets/img_archive/Wish_List_Email.png %})

### iOS 또는 Android 푸시 옵트인

이 사용 사례는 '앱에 대해 포그라운드 푸시 활성화' 필터를 활용하여 푸시를 옵트인한 iOS 또는 Android 사용자를 타겟팅합니다.
...
이 사용 사례는 '포그라운드 푸시 사용' 필터를 활용하여 푸시를 옵트인한 사용자를 타겟팅합니다.

![]({% image_buster /assets/img/seg_filter_examples/both.png %})

### 푸시 지원 오디언스의 글로벌 제어 그룹

이 사용 사례는 '포그라운드 푸시 사용' 및 '랜덤 버킷 #' 필터를 활용하여 푸시를 옵트인한 글로벌 컨트롤 그룹에 속한 사용자를 타겟팅합니다.
