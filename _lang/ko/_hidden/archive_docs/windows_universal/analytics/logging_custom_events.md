...
Braze에서 커스텀 이벤트를 기록하여 앱의 사용 패턴에 대해 자세히 알아보고 대시보드에서 사용자의 작업에 따라 사용자를 세분화할 수 있습니다. 또한 [이벤트 이름 지정 규칙]({{site.baseurl}}/user_guide/data/custom_data/event_naming_conventions/)을 숙지하는 것이 좋습니다.
