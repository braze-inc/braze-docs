...
Braze는 [Baidu Cloud Push]({% image_buster /assets/img_archive/baidu_app_console.png %})을 사용하여 Android 장치에 푸시 알림을 보낼 수 있습니다. Baidu 클라우드 푸시를 사용하더라도 Baidu 앱 스토어를 통해 앱을 배포할 필요가 **없음**을 유의하세요.

## 1단계: Baidu 계정을 생성하세요

Baidu 계정을 만들려면 [Baidu 포털](https://www.baidu.com/)을 방문하고 **로그인** (로그인)을 클릭하여 로그인하거나 새 계정을 만들 수 있는 대화 상자를 표시합니다.
...
다음으로, Baidu 개발자로 등록해야 합니다. 먼저 [Baidu 개발자 포털을](http://developer.baidu.com/) 방문하여 **注册** (새 개발자 계정 만들기)을 선택하여 등록을 시작합니다.
...
Baidu에 애플리케이션을 등록하려면 [프로젝트 포털을](http://developer.baidu.com/console#app/project) 방문하여 **创建工程** (프로젝트 만들기)를 클릭하세요.
...
[Baidu 푸시 SDK 포털을](http://developer.baidu.com/wiki/index.php?title=docs/cplat/push/sdk/clientsdk) 방문하여 최신 Baidu 클라우드 푸시 Android SDK를 다운로드하세요.
...
`onNotificationClicked` 을 Baidu 수신자로 호출할 때마다 수신자는 `customContentString` 을 포함하는 [의도를](http://developer.android.com/reference/android/content/Intent.html) 애플리케이션에 보내야 합니다. 귀하의 애플리케이션은 `customContentString`을(를) 사용하여 클릭을 Braze에 기록합니다.
...
- [Baidu 푸시 소프트웨어 개발 키트 포털](http://developer.baidu.com/wiki/index.php?title=docs/cplat/push/sdk/clientsdk)
- [Baidu 통합 문서](http://developer.baidu.com/wiki/index.php?title=docs/frontia/guide-android/overview)
