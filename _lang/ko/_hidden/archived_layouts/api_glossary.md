...
{% api %}
## 3 캠페인 트리거 전송
{% apimethod post %}캠페인/트리거/전송{% endapimethod %}
...
| ---| --- |
| 국가 | (문자열) 국가 코드는 [ISO-3166-1 alpha-2 표준][17]에 따라 Braze에 전달되어야 합니다. |
| current_location | (객체) 형식은 {"longitude": -73.991443, "latitude": 40.753824} |
...
| 언어 | (문자열) 언어는 [ISO-639-1 표준][24]에 따라 Braze에 전달되어야 합니다. <br>[허용되는 언어 목록](/docs/user_guide/data_and_analytics/user_data_collection/language_codes/)|
| last_name | (문자열) |
