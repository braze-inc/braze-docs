...
guide_top_header: "이미지를 사용한 다중 섹션 랜딩 페이지"
guide_top_text: "다중 섹션 랜딩 페이지는 일반적으로 주제별로 섹션 내 페이지를 구분하여 큰 섹션을 구성하는 데 유용합니다. 이 특정 템플릿은 페이지 하단에 추가 정보를 추가할 수 없지만 두 개 이상의 버튼 섹션을 가질 수 있는 'dev_guide' 레이아웃 YAML 매개변수('layout: dev_guide')를 사용하며, 이 매개변수는 페이지 하단에 추가 정보를 추가할 수 없습니다."

guide_featured_title: "섹션 1"
guide_featured_list:
  - name: 예제 1
