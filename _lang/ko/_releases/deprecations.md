...
- [Android용 맞춤형 푸시 브로드캐스트 수신기]({{site.baseurl}}/releases/deprecations/custom_broadcast_receiver/)
- [Eclipse SDK 설정]({{site.baseurl}}/releases/deprecations/eclipse_setup_deprecated/)
- [TLS 1.0 및 1.1 사용 중단]({{site.baseurl}}/releases/deprecations/tls_deprecation/)
- [Twilio 웹훅 통합]({{site.baseurl}}/releases/deprecations/twilio/)
- [파트너십 최적화]({{site.baseurl}}/releases/deprecations/apptimize/)
- [Grouparoo 파트너십]({{site.baseurl}}/releases/deprecations/grouparoo)
- [Shopify `checkout.liquid` 사용 중단]({{site.baseurl}}/releases/deprecations/shopify_checkout/)
...
현재 [Braze와 함께 Apptimize]({{site.baseurl}}/releases/deprecations/apptimize)를 사용 중인 경우 서비스 중단은 발생하지 않습니다. 여전히 Apptimize 커스텀 속성을 Braze 고객 프로필에 설정할 수 있습니다. 그러나 파트너와의 공식적인 에스컬레이션 지원은 제공되지 않습니다.
