...
이메일 주소 또는 지정된 날짜 범위로 하드 바운스를 가져올 수 있는 /email/hard_bounces,, 예약된 캠페인 및 예약 입력 캔버스가 시작될 다음 시간을 가져올 수 있는 /messages/scheduled_broadcasts, 등 새로운 API 엔드포인트가 노출되었습니다. 이러한 새로운 엔드포인트를 통해 캠페인을 더욱 맞춤화하고 최적화할 수 있습니다. [API 엔드포인트]({{site.baseurl}}/developer_guide/rest_api/basics/#what-is-a-rest-api)에 대해 자세히 알아보세요.
