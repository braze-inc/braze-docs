...
## 익명 사용자의 S3 및 Azure 데이터 이벤트
 ...
 이제 Amazon S3 및 Microsoft Azure로 데이터를 내보내는 고객은 익명 사용자의 이벤트를 포함할 수 있습니다. 이 기능은 새로 생성된 모든 통합에 대해 기본적으로 켜짐으로 설정되지만 기존 통합에 대해서는 꺼진 상태로 유지됩니다. 궁금한 점이 있으면 계정 매니저에게 문의하거나 [지원 티켓을]({{site.baseurl}}/braze_support/) 개설하세요.
