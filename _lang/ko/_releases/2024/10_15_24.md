...
이제 배열 또는 개체 값을 포함하는 [이벤트 속성 개체는]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_events/custom_event_properties/) 최대 100KB의 이벤트 속성 페이로드를 가질 수 있습니다.
