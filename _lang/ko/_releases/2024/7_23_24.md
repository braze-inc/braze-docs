...
AI 리퀴드 어시스턴트는 메시지 콘텐츠를 개인화하는 데 필요한 리퀴드를 생성하는 데 도움을 주는 BrazeAI<sup>TM</sup> 기반의 채팅 도우미입니다. 템플릿에서 리퀴드를 생성하고, 맞춤화된 리퀴드 제안을 받고, BrazeAI<sup>TM</sup>의 지원을 받아 기존 리퀴드를 최적화할 수 있습니다. AI Liquid 도우미는 사용된 Liquid를 설명하는 주석도 제공하므로 Liquid에 대한 이해를 높이고 직접 작성하는 방법을 배울 수 있습니다.
...
[버전 4.0.0](https://github.com/braze-inc/braze-xamarin-sdk/releases/tag/4.0.0)부터 Braze Xamarin SDK는 Swift SDK 바인딩을 사용하므로 코드 스니펫과 참조 자료를 업데이트했습니다. 또한 읽고 이해하기 쉽도록 섹션을 재구성했습니다. 자세한 내용은 [Xamarin 문서를]({{site.baseurl}}/developer_guide/sdk_integration/?sdktab=.net%20maui%20(xamarin)) 참조하세요.
