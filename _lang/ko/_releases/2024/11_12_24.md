...
이제 최고의 소셜 및 광고 기술로 캠페인의 도달 범위를 확장하는 데 도움이 되는 도구인 [Braze Audience Sync와]({{site.baseurl}}/partners/canvas_audience_sync/) 함께 LinkedIn을 사용할 수 있습니다. 베타 버전에 참여하려면 Braze 성공 매니저에게 문의하세요.
