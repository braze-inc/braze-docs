...
[이메일 메시지 작성 중]({{site.baseurl}}/user_guide/message_building_by_channel/email/html_editor/#step-3-compose-your-email)에는 일반 텍스트 탭에서 HTML에서 다시 생성 아이콘을 선택하여 자동 동기화로 되돌릴 수 있으며, 이는 일반 텍스트가 동기화되지 않을 때만 나타납니다.
