...
이제 이메일용 드래그 앤 드롭 편집기에서 `Image`, `Button` 또는 `Text` 편집기 블록 내의 모든 URL에 [HTML 속성을 추가]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/#creative-details/)할 수 있습니다. 사용자 지정 속성을 사용하면 이메일의 HTML 태그에 추가 정보를 쉽게 추가할 수 있습니다. 이는 메시지 개인화, 세분화 및 스타일링에 특히 유용할 수 있습니다. 
