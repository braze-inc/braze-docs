...
드래그 앤 드롭 편집기에서 독점적으로 사용되는 [콘텐츠 블록]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/content_blocks/)은(는) 다양한 채널에서 사용되는 콘텐츠 블록과 기능적으로 유사합니다. 다양한 이메일 캠페인에서 참조할 수 있는 정보를 보관할 수 있는 중앙 집중식 위치입니다. 이것은 이메일 헤더, 프로모션 호출 등을 하나의 재사용 가능한 행으로 그룹화하는 것을 포함할 수 있습니다.
