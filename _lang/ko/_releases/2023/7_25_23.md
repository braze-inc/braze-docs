...
## 이메일 프리헤더 뒤 공백 
새로운 **프리헤더 뒤에 공백 추가** 확인란은 이메일 프리헤더에 있는 이메일 본문의 텍스트 또는 HTML을 숨깁니다. 이메일 헤더 추가에 대한 자세한 내용은 [이메일 만들기]({{site.baseurl}}/user_guide/message_building_by_channel/email/html_editor/#step-3-compose-your-email)에서 확인하세요.
