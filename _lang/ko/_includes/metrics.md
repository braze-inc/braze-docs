...
<i>주요 전환(A)</i> 또는 <i>주요 전환 이벤트</i>는 메시지를 받거나 본 후 정의된 이벤트를 수행하는 고유 사용자 수입니다. 이 메시지는 Braze 캠페인에서 발송됩니다. 이 이벤트는 캠페인을 설정할 때 선택되며, 보고 및 최적화를 위한 주요 성공 지표로 사용됩니다.
{% endif %}
...
<i>고유 클릭 수</i>는 메시지 내의 링크를 최소한 한 번 클릭한 수신자의 고유 수이며, <a href='https://braze.com/docs/help/help_articles/data/dispatch_id/'>dispatch_id</a>에 의해 측정됩니다.
{% endif %}
