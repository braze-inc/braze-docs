...
[모델 컨텍스트 프로토콜(MCP)](https://modelcontextprotocol.io/docs/getting-started/intro)은 새로 도입된 오픈 소스 프로토콜로, 현재 보안 문제나 취약점에 노출될 수 있습니다.
...
도움이나 추가 설명이 필요하시면 [Braze 고객지원]({{site.baseurl}}/user_guide/administrative/access_braze/support)으로 문의해 주세요.