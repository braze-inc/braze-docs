...
![추천 이메일을 위한 의사결정 스튜디오 에이전트의 예시 다이어그램.]({% image_buster /assets/img/offerfit/example_use_cases_referral_email.png %})
...
AI 전문가 서비스 팀은 고객과 긴밀히 협력하여 의사 결정 에이전트의 범위 설정, 설계 및 구축을 지원합니다. 아직 연락하지 않으셨다면, [저희에게 연락하세요](https://www.braze.com/get-started/) 시작하세요.
...
다음으로, AI 전문가 서비스 팀이 고객 참여 플랫폼 설정을 도와드릴 것입니다. 의사결정 스튜디오는 Braze와 함께 가장 잘 작동하지만, 다양한 다른 플랫폼도 지원됩니다—추가 리소스에 대해서는 AI 전문가 서비스 팀에 문의하세요.
