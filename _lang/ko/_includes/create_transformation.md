...
![편집 환경을 위해 '템플릿 사용' 또는 '처음부터 시작'을 선택할 수 있는 옵션이 있는 변환 세부 정보입니다.]({% image_buster /assets/img/data_transformation/data_transformation10.png %}){: style="max-width:80%;"}
...
![웹훅 세부 정보 및 변환 코드의 예시입니다.]({% image_buster /assets/img/typeform/data_transformation_typeform.png %})
