{% tab Android %}
Braze는 메시지, 이미지, [폰트 어썸](https://fontawesome.com/icons?d=gallery&p=2) 아이콘, 클릭 액션, 분석, 색 구성표 등으로 각각 사용자 지정할 수 있는 여러 가지 기본 인앱 메시지 유형을 제공합니다.

이들의 기본 동작과 특성은 서브클래스의 [`IInAppMessage`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.models.inappmessage/-i-in-app-message/index.html) 라는 서브클래스의 [`InAppMessageBase`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.models.inappmessage/-in-app-message-base/index.html)`IInAppMessage` 에는 하위 인터페이스도 포함되어 있습니다, [`IInAppMessageImmersive`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.models.inappmessage/-i-in-app-message-immersive/index.html)라는 하위 인터페이스도 포함되어 있어 앱에 닫기, 클릭 액션 및 분석 [버튼을](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.models.inappmessage/-message-button/index.html) 추가할 수 있습니다.

{% alert important %}
버튼 텍스트를 추가하기 전에 클릭 동작이 추가되면 버튼이 포함된 인앱 메시지의 최종 페이로드에 `clickAction` 메시지가 포함됩니다.
{% endalert %}
...
이 메시지 유형은 [`InAppMessageImmersiveBase`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.models.inappmessage/-in-app-message-immersive-base/index.html)의 하위 클래스이며, `IInAppMessageImmersive` 을 구현하는 추상 클래스로 로컬에서 생성된 인앱 메시지에 사용자 지정 기능을 추가할 수 있는 옵션을 제공합니다.
...
이 메시지 유형은 [`InAppMessageImmersiveBase`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.models.inappmessage/-in-app-message-immersive-base/index.html)을 확장하여 로컬에서 생성된 인앱 메시지에 사용자 지정 기능을 추가할 수 있는 옵션을 제공합니다.
...
이러한 메시지 인스턴스는 [`InAppMessageHtml`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.models.inappmessage/-in-app-message-html/index.html)의 인스턴스이며 `IInAppMessage` 서브클래스를 구현합니다: [`IInAppMessageHtml`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze.models.inappmessage/-i-in-app-message-html/index.html).

Android 인앱 메시지는 HTML 내에서 Braze 웹 SDK의 메서드를 호출하기 위해 JavaScript `brazeBridge` 인터페이스를 지원합니다. 자세한 내용은 <a href="{{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/best_practices/">모범 사례</a>를 참조하세요.
...
{% alert tip %}
앱에 대한 사용자 지정 인앱 메시지 보기를 정의할 수도 있습니다. 전체 안내는 [사용자 지정 공장 설정을]({{site.baseurl}}/developer_guide/in_app_messages/customization#android_setting-custom-factories) 참조하세요.
{% endalert %}
{% endtab %}