{% multi_lang_include developer_guide/prerequisites/react_native.md %} [푸시 알림]({{site.baseurl}}/developer_guide/push_notifications/?sdktab=react%20native)도 [설정]({{site.baseurl}}/developer_guide/push_notifications/?sdktab=react%20native)해야 합니다.
