...
{% tabs local %}
{% tab automatic %}
기본값으로 열거형 `RequestPolicy`값은 로 설정됩니다`automatic`. 설정 시, 인앱 메시지 및 기타 Braze 기능에 사용자 데이터가 필요할 때 즉시 서버 요청이 수행됩니다.
