...
이제 데이터가 Braze로 전송되면 소프트웨어 개발 키트에서 IP 주소를 사용하여 사용자의 국가를 자동으로 감지할 수 있습니다. 자세한 내용은 [setLastKnownLocation()을](https://js.appboycdn.com/web-sdk/latest/doc/classes/braze.user.html#setlastknownlocation) 참조하세요.
