...
2022년 4월부터 Android 개발자는 [데이터](https://support.google.com/googleplay/android-developer/answer/10787469) 프라이버시 및 보안 관행을 공개하기 위해 Google Play의 [데이터 안전 양식을](https://support.google.com/googleplay/android-developer/answer/10787469) 작성해야 합니다. 이 가이드는 Braze가 앱 데이터를 처리하는 방법에 대한 정보와 함께 이 새 양식을 작성하는 방법에 대한 지침을 제공합니다. 
...
Android 소프트웨어 개발 키트에서 데이터 추적 활동을 비활성화하려면 방법 [`disableSDK()`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze/-braze/-companion/disable-sdk.html). 이렇게 하면 모든 네트워크 연결이 취소되어 Braze 소프트웨어 개발 키트에서 더 이상 데이터를 Braze 서버로 전달하지 않습니다.

## 이전에 저장된 데이터 지우기

메서드 [`wipeData()`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze/-braze/-companion/wipe-data.html) 메서드를 사용하여 기기에 저장된 모든 클라이언트 측 데이터를 완전히 지울 수 있습니다.

## 데이터 추적 재개하기

데이터 수집을 재개하려면 다음과 같이 [`enableSDK()`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze/-braze/-companion/enable-sdk.html) 메서드를 사용할 수 있습니다. 이전에 삭제한 데이터는 복원되지 않는다는 점에 유의하세요.
