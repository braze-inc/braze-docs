...
푸시를 사용해 애플리케이션을 설정하고 서버에 자격 증명을 저장하는 방법은 [Swift 통합 지침]({{site.baseurl}}/developer_guide/push_notifications/?sdktab=swift)을 참조하세요. 자세한 내용은 [iOS MAUI](https://github.com/braze-inc/braze-xamarin-sdk/tree/master/appboy-component/samples/ios-net-maui/BrazeiOSMauiSampleApp) 샘플 애플리케이션을 참조하세요.
