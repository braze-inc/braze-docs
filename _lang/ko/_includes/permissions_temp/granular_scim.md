...
| API 사용 알림 보기 | `view_api_usage_alerts` |
...
| Teams 보기 | `view_teams` |
| Teams 편집 | `edit_teams` |
| Teams 아카이브 | `archive_teams` |
| 커스텀 속성 보기 | `view_custom_attributes` |
| 커스텀 속성 편집 | `edit_custom_attributes` |
| 커스텀 속성 차단 목록 | `blocklist_custom_attributes` |
| 커스텀 속성 삭제 | `delete_custom_attributes` |
| 커스텀 속성 내보내기 | `export_custom_attributes` |
| 커스텀 이벤트 보기	 | `view_custom_events` |
| 커스텀 이벤트 편집 | `edit_custom_events` |
| 커스텀 이벤트 차단 목록 | `blocklist_custom_events` |
| 커스텀 이벤트 삭제 | `delete_custom_events` |
| 커스텀 이벤트 내보내기 | `export_custom_events` |
| 커스텀 이벤트 속성정보 세분화 편집 | `edit_custom_event_property_segmentation` |
| 제품 보기 | `view_products` |
| 제품 편집	 | `edit_products` |
| 제품 차단 목록 | `blocklist_products` |
| 구매 등록정보 세분화 편집 | `edit_purchase_property_segmentation` |
| 태그 보기 | `view_tags` |
| 태그 편집 | `edit_tags` |
| 태그 삭제 | `delete_tags` |
...
| WhatsApp 설정 보기 | `view_whatsapp_settings` |
