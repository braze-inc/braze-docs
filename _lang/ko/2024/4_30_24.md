...
[저스트인타임 프로비저닝은]({{site.baseurl}}/user_guide/administrative/access_braze/single_sign_on/saml_jit) SAML SSO와 연동되어 신규 회사 사용자가 첫 로그인 시 Braze 계정을 생성할 수 있도록 합니다. 이로써 관리자가 신규 회사 사용자를 위해 수동으로 계정을 생성하고, 권한을 선택하며, 작업 공간에 할당한 후 계정 활성화를 기다릴 필요가 없어집니다.
