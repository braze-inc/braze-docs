...
noindex: true
page_type: update
description: "이 문서에는 2019년 3월의 릴리스 노트가 포함되어 있습니다."
---
...
Braze는 최신 UX 및 UI 모범 사례를 준수하기 위해 인앱 메시지의 모양과 느낌을 개선했음을 발표하게 되어 자랑스럽게 생각합니다. 최신 인앱 메시지에서는 사용자가 메시지와 상호 작용할 수 있는 대상을 기대할 수 있습니다.
- 더 큰 글꼴 크기
- 세련된 간격
- 새 닫기 `x` 자산
...
이제 [콘텐츠 블록]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/content_blocks/#archiving-content-blocks)을 아카이브하고 아카이브 해제할 수 있습니다.

## Inkit 파트너 추가

이제 [Inkit]({{site.baseurl}}/partners/inkit/)을 미리 디자인된 웹훅 템플릿으로 사용하거나 새 웹훅 캠페인을 만들 수 있습니다.
