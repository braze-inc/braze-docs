...
![겹치지 않는 고정 스크롤 막대 예시][3]

_마지막 업데이트: 2019년 3월 27일_

{% comment %}
문제를 일으킬 수 있는 한 줄의 긴 코드가 있는 곳에 삽입하세요:
_스크롤 막대 때문에 코드가 보이지 않나요? [이]({{site.baseurl}}/help/help_articles/docs/scroll_bar_overlap/) 문제를 해결하는 방법은 [여기에서]({{site.baseurl}}/help/help_articles/docs/scroll_bar_overlap/) 확인하세요._
{% endcomment %}
