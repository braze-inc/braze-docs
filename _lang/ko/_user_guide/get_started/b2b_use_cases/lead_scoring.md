...
2. 캔버스에 "리드 스코어링 캔버스"와 같은 관련 이름을 지정하고, 더 나은 검색을 위해 "리드 관리"와 같은 태그를 지정하세요.<br><br>![캔버스 이름을 “리드 스코어링 캔버스”로 하고 태그를 “리드 관리”로 하여 캔버스를 만드는 1단계입니다.]({% image_buster /assets/img/b2b/step_1_simple.png %}){: style="max-width:80%;"}
...
![“액션 기반” 입력 일정 및 사용자 정의 속성 “리드 점수” 변경 및 이메일 주소 추가의 액션 기반 옵션으로 캔버스를 만드는 2단계입니다.]({% image_buster /assets/img/b2b/step_2_simple.png %}){: style="max-width:80%;"}
...
![옵션을 사용하여 세그먼트 및 필터를 선택하여 항목 오디언스를 좁히는 캔버스 생성의 3단계입니다.]({% image_buster /assets/img/b2b/step_3_simple.png %}){: style="max-width:80%;"}

#### Step 3b: 캔버스 재사용 자격 설정
...
![“입력 제어” 섹션에는 “지정된 기간”에서 0초 동안 사용자가 이 캔버스를 다시 입력할 수 있도록 선택할 수 있습니다.]({% image_buster /assets/img/b2b/entry_controls_simple.png %}){: style="max-width:80%;"}
...
![메시지 전송 옵션 설정을 위한 캔버스 생성의 4단계입니다.]({% image_buster /assets/img/b2b/step_4_simple.png %}){: style="max-width:80%;"}
...
![더하기 아이콘으로 열린 메뉴에 "작업 경로"가 표시된 캔버스가 있습니다.]({% image_buster /assets/img/b2b/action_paths_simple.png %}){: style="max-width:60%;"}
...
![행동 그룹을 포함하는 행동 경로: - 1점, 5점, 10점 추가 - 1점, 10점 차감 - "기타 모든 경우"]({% image_buster /assets/img/b2b/action_paths_selected_simple.png %}){: style="max-width:20%;"}
...
![“모든 앱에서 세션 시작” 및 “커스텀 이벤트 수행” 트리거로 포인트를 추가하기 위한 작업 그룹.]({% image_buster /assets/img/b2b/action_groups_simple.png %}){: style="max-width:80%;"}

#### 4d 단계: 사용자 업데이트 단계 추가

각 행동 경로 아래에 생성된 각 캔버스 경로에 사용자 업데이트 단계를 추가하세요. 

![캔버스 행동 경로를 표시하고 각 행동 그룹에 대한 분기된 사용자 업데이트 경로를 표시합니다.]({% image_buster /assets/img/b2b/user_update_paths_simple.png %}){: style="max-width:80%;"}
...
![필터가 "MQL“lead_status”"이 아닌 웹훅 타겟팅 옵션입니다.]({% image_buster /assets/img/b2b/step_3_webhook.png %}){: style="max-width:80%;"}
