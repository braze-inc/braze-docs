...
매트릭스가 핵심 채널을 강조하지만, 조정 가능합니다: SMS와 WhatsApp은 예를 들어, 멀티미디어 형식을 활용할 때 풍부한 콘텐츠로 확장되는 높은 긴급성 도구입니다. 이 매트릭스를 활용하는 방법에 대해 더 알아보려면, [크로스채널 메시징](https://learning.braze.com/cross-channel-messaging)에 대한 Braze 학습 과정을 확인하세요.
