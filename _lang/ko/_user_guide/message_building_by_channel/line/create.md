...
세그먼트에서 더 많은 오디언스를 선택하고 [필터]({{site.baseurl}}/user_guide/engagement_tools/segments/segmentation_filters/)를 사용하여 해당 세그먼트를 더 좁힐 수 있습니다. 해당 대략적인 세그먼트 인구가 어떻게 생겼는지의 스냅샷을 자동으로 받습니다. 메시지가 전송되기 전에 정확한 세그먼트 멤버십이 항상 계산된다는 점을 명심하세요.
