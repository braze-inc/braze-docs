...
- **일반적인 SMS 캠페인 지표:** <br>*전송*, *배송업체로 전송*, *배송 실패*, *배송 확인*, *거부*, *옵트아웃* 및 *도움말을* 확인할 수 있습니다. <br>이러한 SMS 측정기준 및 기타 정보에 대해서는 [SMS reporting][1]을 참조하십시오. *이동통신사로 전송*은 더 이상 사용되지 않지만 이미 해당 기능이 있는 사용자에게는 계속 지원됩니다.
