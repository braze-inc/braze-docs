...
> 이 페이지에서는 [링크 단축이]({{site.baseurl}}/user_guide/message_building_by_channel/sms/campaign/link_shortening/) 포함된 사용자 정의 도메인을 사용하여 단축 URL의 모양과 느낌을 맞춤화하고 일관된 브랜드 이미지를 표현하는 방법을 설명합니다. 
...
사용자 지정 도메인을 구성한 후에는 하나 또는 여러 개의 SMS 수신 그룹에 사용자 지정 도메인을 할당할 수 있습니다. 
