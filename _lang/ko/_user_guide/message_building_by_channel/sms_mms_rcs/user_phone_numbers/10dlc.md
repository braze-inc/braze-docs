...
2019년 이후, 통신사들은 상업적 메시징을 위해 10DLC를 채택하기 시작했으며, Verizon과 AT&T이 현재 10DLC를 지원하고 있으며, 모든 주요 통신사들이 곧 따를 것으로 예상합니다. 단기적으로는 불편을 초래할 수 있지만, 장기적으로는 원치 않는 메시지로부터 소비자를 보호하면서 전달률을 높일 수 있습니다. 
