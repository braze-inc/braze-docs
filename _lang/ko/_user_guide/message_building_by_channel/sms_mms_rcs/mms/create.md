---
nav_title: MMS 캠페인 생성
article_title: MMS 캠페인 생성
page_order: 2
...
> 이 문서에는 SMS 작성기의 일부인 MMS 구성에 대한 정보가 포함되어 있습니다. SMS/MMS 작성기에 대한 자세한 내용은 [SMS 작성기를]({{site.baseurl}}/user_guide/message_building_by_channel/sms_mms_rcs/sms/create/) 참조하세요.
...
![메시지를 작성할 "작성" 탭.]({% image_buster /assets/img/sms/mms_composer.png %}){: style="max-width:80%;"}
...
!["헬스장 갈 준비 됐어... 집에서?"라는 메시지의 예시. 미리 보기에는 텍스트로 전송된 메시지와 이미지가 표시됩니다.]({% image_buster /assets/img/sms/mms_preview.png %})
