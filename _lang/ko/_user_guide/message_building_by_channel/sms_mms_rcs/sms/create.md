...
You can add a contact card to your SMS message to make it easy for your customers to add your business and contact information to their contacts. 이러한 카드에 회사 이름, 전화번호, 주소, 이메일, 작은 사진 등의 공통 속성을 지정할 수 있습니다. 자세한 내용은 [연락처 카드에서]({{site.baseurl}}/user_guide/message_building_by_channel/sms_mms_rcs/mms/contact_card/) 확인하세요.
