...
# [![Braze 학습 과정]({% image_buster /assets/img/bl_icon3.png %})](https://learning.braze.com/messaging-channels-sms){: style="float:right;width:120px;border:0;" class="noimgborder"}SMS에 대하여
...
| 트랜잭션 메시지 | SMS 메시지는 주문 확인 및 배송 정보와 같은 거래 알림을 전송하는 효율적인 방법으로, 필요한 모든 정보를 한 곳에서 편리하게 확인할 수 있습니다. 트랜잭션 메시지를 보낼 때 준수해야 하는 법적 가이드라인이 있다는 점에 유의하세요. 이 지침이 확실하지 않은 경우, 내부 법무 팀에 문의하세요.|
