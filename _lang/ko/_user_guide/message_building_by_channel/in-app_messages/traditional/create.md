...
| 푸시 권한 요청 | 기본 푸시 권한을 표시합니다. [푸시 프라이밍]({{site.baseurl}}/user_guide/message_building_by_channel/push/push_primer_messages/)에 대해 자세히 알아보고 푸시 사용자를 프라이밍하기 위한 [모범 사례]({{site.baseurl}}/user_guide/message_building_by_channel/push/users_and_subscriptions/#best-practices)를 살펴보세요. |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
...
캔버스 전용 인앱 메시징 옵션에 대한 자세한 내용은 [캔버스의 인앱 메시지]({{site.baseurl}}/user_guide/engagement_tools/canvas/create_a_canvas/in-app_messages_in_canvas/)를 참조하세요.
