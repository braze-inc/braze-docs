...
guide_top_text: "표준 인앱 메시지 템플릿 외에도 Braze는 커스텀 HTML, 커스텀 CSS가 포함된 모달, 이메일 캡처 양식, 동영상 등을 사용할 수 있는 맞춤형 메시징 템플릿도 제공합니다."
description: "이 랜딩 페이지에서는 커스텀 HTML, 커스텀 CSS가 포함된 모달, 동영상, 이메일 캡처 양식 등을 사용할 수 있는 맞춤형 인앱 메시지 템플릿을 다룹니다."
