...
> 다크 모드는 사용자가 시스템 전체에 색상을 설정할 수 있는 기능을 제공합니다( [Android 10](https://developer.android.com/guide/topics/ui/look-and-feel/darktheme) 및 [iOS 13](https://developer.apple.com/documentation/appkit/supporting_dark_mode_in_your_interface/)에 도입됨). '어두운' 테마는 배터리 수명을 절약하고 사용자의 눈의 피로를 줄이는 동시에 앱 개발자에게 사용자가 선호하는 어두운 색상 테마를 더 쉽게 구현할 수 있는 방법을 제공하기 위한 것입니다.
