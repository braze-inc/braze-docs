...
page_order: 5
description: "이 참고 문서에서는 다크 모드 테마를 설정하는 방법과 호환성 고려 사항을 포함하여 Braze 인앱 메시지 다크 모드 지원에 대해 설명합니다."
channel:
  - in-app messages
...
> 다크 모드는 사용자가 시스템 전체에 색상을 설정할 수 있는 기능을 제공합니다( [Android 10](https://developer.android.com/guide/topics/ui/look-and-feel/darktheme) 및 [iOS 13](https://developer.apple.com/documentation/appkit/supporting_dark_mode_in_your_interface/)에 도입됨). '어두운' 테마는 배터리 수명을 절약하고 사용자의 눈의 피로를 줄이는 동시에 앱 개발자에게 어두운 색상의 테마를 구현할 수 있는 방법을 제공하기 위한 것입니다.

Braze 인앱 메시지는 대체 다크 테마를 추가하여 사용자의 선호도에 따라 적절한 색상 메시지를 전달하고 앱 디자인과의 일관성을 유지할 수 있도록 지원합니다.
...
[인앱 메시지를 만들]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/traditional/create/) 때 **디자인** 탭에 있는 다크 모드를 사용하면 기기에서 다크 모드로 설정된 사용자를 위해 대체 색상 테마를 추가할 수 있습니다.

![인앱 메시지를 작성할 때 스타일 탭에서 라이트 모드 스타일과 다크 모드 스타일 간에 전환할 수 있습니다.]({% image_buster /assets/img_archive/iam-dark-mode.gif %})
...
- 사용자는 iOS 기기 버전 13 이상 또는 Android 기기 버전 10 이상을 사용 중이어야 합니다.
...
HTML 인앱 메시지에 대한 다크 및 라이트 테마를 만들려면 [`prefers-color-scheme`](https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-color-scheme) CSS 미디어 기능을 사용하여 사용자의 선호도를 감지할 수 있습니다.
