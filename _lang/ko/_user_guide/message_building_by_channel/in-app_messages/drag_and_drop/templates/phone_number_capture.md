...
드래그 앤 드롭 인앱 메시지를 만들 때, 템플릿으로 **SMS 가입** (이것은 RCS 가입을 수용합니다) 또는 **WhatsApp 가입**를 선택한 다음 **메시지 구축**을 선택하세요. 이 템플릿은 모바일 앱과 웹 브라우저 모두에서 지원됩니다.
...
![커스텀 폰트를 업로드하고 선택하는 워크플로우.]({% image_buster /assets/img_archive/dnd_iam_phone_capture_custom_font.gif %})
