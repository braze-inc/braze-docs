...
{% alert tip %}
[WhatsApp 매니저](https://business.facebook.com/wa/manage/phone-numbers/) 내의 **전화번호** > **메시지 링크**에서 WhatsApp 채널에 가입할 수 있는 URL 또는 QR 코드를 구축할 수 있습니다.<br>![WhatsApp QR 코드 작성기.]({% image_buster /assets/img/whatsapp/whatsapp115.png %}){: style="max-width:55%;"}
{% endalert %}
...
![WhatsApp 수신 메시지를 보내는 사용자에게 들어가는 액션 기반 캔버스 진입 단계.]({% image_buster /assets/img/whatsapp/whatsapp116.png %}){: style="max-width:85%;"}
...
![메시지 본문이 "STOP" 또는 "NO MESSAGE"인 WhatsApp 수신 메시지를 보내는 메시지 단계.]({% image_buster /assets/img/whatsapp/whatsapp117.png %}){: style="max-width:85%;"}
...
1. "마케팅 옵트아웃" 빠른 응답과 함께 메시지 템플릿을 만드세요.<br>!["마케팅 옵트아웃"의 바닥글 옵션이 있는 메시지 템플릿]({% image_buster /assets/img/whatsapp/whatsapp121.png %})<br><br>![마케팅 옵트아웃 버튼을 구성하는 섹션.]({% image_buster /assets/img/whatsapp/whatsapp122.png %})<br><br>
...
{: start="4"}
4\. WhatsApp 메시지 단계를 추가합니다. <br><br>![캔버스 내의 사용자 업데이트 단계.]({% image_buster /assets/img/whatsapp/message_step.png %}){: style="max-width:25%;"}
