...
page_order: 0
description: "이 참조 문서는 Braze가 Infobip WhatsApp 비즈니스 관리자에 접근할 수 있도록 하는 내 WhatsApp 커넥터 설정을 위한 단계별 안내를 제공합니다."
page_type: reference
channel:
  - WhatsApp
---
...
> 내 WhatsApp(BYO) 커넥터는 Braze와 Infobip 간의 파트너십을 제공하며, Infobip WhatsApp 비즈니스 관리자(WABA)에 대한 Braze의 접근을 허용합니다. 이를 통해 Braze를 사용하여 세분화, 개인화 및 캠페인 오케스트레이션을 하면서 Infobip과 직접 메시징 비용을 관리하고 지불할 수 있습니다. Braze는 아웃바운드 메시지, 인바운드 메시지 처리, WhatsApp 흐름 및 분석과 같은 WhatsApp 채널이 제공하는 모든 기존 기능을 유지합니다.
...
| Phone number | 편의를 위해 [Infobip을 통해 전화번호를 확보할 것을 권장합니다.](https://www.infobip.com/docs/numbers/getting-started) |
