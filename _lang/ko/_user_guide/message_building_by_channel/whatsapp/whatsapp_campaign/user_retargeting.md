...
![2025년 4월 22일에 마지막으로 받은 WhatsApp 메시지를 필터링합니다.]({% image_buster /assets/img/whatsapp/whatsapp23.png %}){: style="max-width:75%"}
...
![WhatsApp 캠페인 수신을 위한 필터입니다.]({% image_buster /assets/img/whatsapp/whatsapp22.png %}){: style="max-width:75%"}
...
![WhatsApp 메시지를 읽었는지 필터링합니다.]({% image_buster /assets/img/whatsapp/whatsapp21.png %}){: style="max-width:75%"}
...
![WhatsApp 단계 읽기를 위한 필터.]({% image_buster /assets/img/whatsapp/whatsapp20.png %}){: style="max-width:75%"}

**캠페인 또는 캔버스 어트리뷰션으로 필터링**<br>
사용자가 특정 WhatsApp 캠페인 또는 캔버스 구성 요소 또는 태그를 열거나 읽은 경우 필터링합니다.

![특정 WhatsApp 메시지를 열기 위한 필터입니다.]({% image_buster /assets/img/whatsapp/whatsapp19.png %}){: style="max-width:75%"}
