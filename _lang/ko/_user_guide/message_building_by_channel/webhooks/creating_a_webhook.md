...
원시 텍스트 옵션을 사용하면 모든 형식의 본문이 예상되는 엔드포인트에 대한 요청을 유연하게 작성할 수 있습니다. 예를 들어, 이 기능을 사용하여 요청이 XML 형식일 것으로 예상되는 엔드포인트에 대한 요청을 작성할 수 있습니다. Liquid를 사용한 [개인화][15] 및 [국제화는][16] 모두 원시 텍스트에서 지원됩니다.
