...
article_title: 배너로 콘텐츠 카드의 저지연성 향상
page_order: 10
...
`requestContentCardsRefresh` 메소드를 호출하여 너무 자주 새로고침하면 요금이 제한될 수 있습니다. 앱의 요금이 일시적으로 제한되는 경우, 사용자의 앱 참여율이 중요한 시기나 필요할 때 카드를 새로고침하지 못할 수 있습니다.
