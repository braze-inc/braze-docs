...
![]({% image_buster /assets/img/red-dress.gif %}){: height="400px"}  ![iPhone 홈 화면의 스톱워치에서 다음과 같은 푸시 메시지 예시: "안녕하세요! 이것은 iOS 푸시입니다."]({% image_buster /assets/img/ios_push.png %}){: height="400px"}

푸시 알림의 더 많은 예시를 보려면 [사례 연구를](https://www.braze.com/customers) 확인하세요.
