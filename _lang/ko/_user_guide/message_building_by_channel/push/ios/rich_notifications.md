...
iOS용 리치 푸시 알림을 만들기 전에 다음 세부 사항에 유의하세요:
...
- 미디어 제한 및 사양은 [Apple의 문서를][2] 참조하세요.
...
iOS 15에서는 시간 민감 및 중요 표시가 타임스탬프 없이 제목을 새 줄로 밀어내어 조금 더 많은 공간을 확보할 수 있습니다.
...
![푸시 알림의 요약 텍스트 예시입니다.][4]{: style="max-width:70%;" }
...
![이미지를 추가하거나 이미지 URL을 입력할 수 있는 확장된 알림 이미지 섹션입니다.][5]{: style="max-width:70%;" }
