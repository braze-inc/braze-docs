...
푸시는 구독하거나 옵트인한 사용자에게만 보낼 수 있습니다. **사용자 프로필** 섹션의 [참여][1] 탭에서 사용자 프로필을 확인하여 테스트 중인 워크스페이스에 대해 푸시 등록이 되어 있는지 확인합니다. 여러 앱에 등록되어 있는 경우 **푸시 등록 대상** 필드에서 해당 앱을 확인할 수 있습니다:
...
![사용자 조회 섹션에 검색 필드가 있습니다.][14]{: style="max-width:80%;"}
...
내부 사용자를 대상으로 푸시 전송을 테스트할 때는 푸시 알림을 받으려는 사용자가 현재 관련 앱에 로그인되어 있는지 확인하세요. 이로 인해 사용자가 푸시를 받지 못하거나 세그먼트에 맞지 않는 푸시를 받게 될 수 있습니다.
