...
> 이 페이지를 사용하여 푸시 메시징 채널의 문제를 해결하십시오.
...
1. Chrome 브라우저에서 URL 옆에 있는 **사이트 정보 보기** 슬라이더 아이콘을 선택하십시오.
2. **알림** 아래에서 **권한 재설정**을 선택하십시오.
...
6\. **사이트 데이터 지우기**를 선택하십시오.
7\. Chrome은 업데이트된 설정을 적용하기 위해 페이지를 새로 고치도록 요청할 것입니다. **새로 고침**을 선택하십시오.
...
4. 알림이 **전송 전에 요청(권장)**으로 설정되어 있는지 확인하십시오.
...
1. 사이트 URL 옆에서 <i class="fa-solid fa-circle-info" alt="info icon"></i> 또는 <i class="fas fa-lock" alt="lock icon"></i>을 선택하십시오.
...
4. 선택을 확인하는 대화 상자에서 **확인**을 선택하십시오.
...
3. 목록에서 사이트를 선택하세요.
4. 사이트에 대한 알림 권한을 삭제하려면 **제거**을 선택하십시오.
5. 그런 다음, **개인정보 보호** > **웹사이트 데이터 관리**로 이동합니다.
6. 목록에서 사이트를 선택하세요.
7. **제거**을 선택하거나 모든 사이트 데이터를 제거하려면 **모두 제거**를 선택하십시오.
8. **완료**을 선택하십시오.
