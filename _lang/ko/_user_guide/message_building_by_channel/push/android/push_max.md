...
![Android 푸시 전달 가능성 섹션의 배달 예약 단계에서 '푸시 최대로 보내기' 옵션을 선택합니다.]({% image_buster /assets/img_archive/push_max_campaigns.png %})
...
기본적으로 TTL은 최대인 28일로 설정되어 있습니다. **설정** > **워크스페이스 설정** > **푸시 설정에서** 모든 새 Android 푸시 메시지의 기본값 TTL을 낮추거나, Android 푸시 알림을 작성할 때 **설정** 탭에서 메시지별로 일 단위로 일수를 구성할 수 있습니다.

![유지 시간 필드를 28일로 설정합니다.]({% image_buster /assets/img_archive/time_to_live.png %}){: style="max-width:60%"}
