...
그런 다음 세그먼트 또는 필터를 선택하여 [사용자를 타겟팅합니다]({{site.baseurl}}/user_guide/engagement_tools/messaging_fundamentals/targeting_users/). Braze는 이메일을 통해 도달할 수 있는 사용자 수를 포함하여 세그먼트 인구의 라이브 프리뷰를 보여줍니다. 정확한 세그먼트 멤버십은 전송 직전에 계산됩니다.
