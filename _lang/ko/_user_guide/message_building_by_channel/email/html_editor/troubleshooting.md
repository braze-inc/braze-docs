...
## HTML이 테스트 이메일에서 올바르게 렌더링되지 않습니다.
...
일부 브라우저 확장 프로그램은 이메일 편집기에서 문제를 일으킬 수 있습니다. 하나의 예는 [Grammarly](https://chrome.google.com/webstore/detail/grammarly-for-chrome/kbfnbcaeplbcioakkpcpgfkobkghlhen?hl=en)가 Google Chrome과 함께 사용될 때입니다. 이 확장 프로그램 중 하나를 사용 중인 경우 다음 중 하나를 수행해야 합니다. 
...
받은편지함 비전의 미리보기와 Braze로 전송된 내용이 일치하지 않는 경우가 있습니다. 이것은 Braze 및 기타 도구에 의해 수행되는 CSS 인라인 차이로 인해 발생할 수 있습니다. 이 경우일 수 있다고 의심되면 CSS를 비활성화하세요.
