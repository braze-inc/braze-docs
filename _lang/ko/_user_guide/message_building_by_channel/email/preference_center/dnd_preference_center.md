...
> 드래그 앤 드롭 편집기를 사용하여 사용자가 특정 유형의 커뮤니케이션을 수신하는지 관리하는 데 도움이 되는 환경 설정 센터를 만들고 사용자 지정할 수 있습니다. 작업 공간당 최대 100개의 환경설정 센터를 만들 수 있습니다.
...
![이름, 설명, 유형, 상태, 마지막으로 편집한 날짜, 사용자가 만든 사용자 지정 환경설정 센터 목록입니다.]({% image_buster /assets/img/preference_center/preference_center1.png %})
...
![환경 설정 센터용 리퀴드의 예입니다.]({% image_buster /assets/img/preference_center/preference_center2.png %})
...
블록은 메시지에 사용할 수 있는 다양한 유형의 콘텐츠를 나타냅니다. 기존 행 세그먼트 안에 하나를 끌어다 놓으면 셀 너비에 맞게 자동 조정됩니다.
...
![사용자의 기본 설정을 알리는 확인 페이지의 예가 업데이트되었습니다.]({% image_buster /assets/img/preference_center/preference_center9.png %}){: style="max-width:65%;"}
...
![환경설정 센터의 행에 있는 액체 복사 옵션입니다.]({% image_buster /assets/img/preference_center/preference_center10.png %}){: style="max-width:75%;"}
...
![문제를 저장하는 중 문제가 발생했습니다. 다시 시도해 주세요."]({% image_buster /assets/img/preference_center/preference_center11.png %}){: style="max-width:55%;"}
