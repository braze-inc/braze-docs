...
발신자는 사서함 공급자에게 서명 또는 인증 검사에 실패한 메일을 처리하는 방법을 알려줍니다. 실패는 스푸핑을 나타낼 수 있습니다. 실패한 메일을 거부하거나 격리하고 자동화된 보고서를 보내도록 서비스 제공업체에 지시할 수 있습니다. 이를 통해 스패머를 식별하고, 악성 이메일을 차단하고, 오탐을 최소화하고, 인증 보고의 투명성을 개선할 수 있습니다.
