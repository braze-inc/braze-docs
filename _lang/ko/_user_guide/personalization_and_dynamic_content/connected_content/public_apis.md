...
|	 API 	| 설명 |
| --------- | --- |
| [OpenWeatherMap][7] | 현재 날씨 데이터, 5일 및 16일 일기 예보, 과거 데이터를 제공합니다. |
| [NYT 기사 검색][8] | 헤드라인, 주제, URL, 날짜, 초록 등이 포함된 NYT 기사 데이터를 제공합니다. |
| [The Guardian API][9] | 헤드라인, 주제, URL, 날짜, 초록 등이 포함된 Guardian 기사 데이터를 제공합니다.|
...
| [Eventbrite][19] | 다양한 공개 이벤트에 대한 데이터를 제공합니다. |
| [Eventful][20] | 다양한 공개 이벤트에 대한 데이터 제공 |
| [Ticketmaster][38] | 공개 이벤트, 장소 및 가격에 대한 데이터 제공 |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
...
|  api  | 설명 |
| --------- | --- |
| [Barchart OnDemand][36] | 다양한 주식, 선물, 외환 데이터를 제공합니다. |
| [CoinDesk][37] | 다양한 암호화폐 데이터를 제공합니다. |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
...
|  api  | 설명 |
| --------- | --- |
| [AirVisual][42] | 대기질 및 날씨 데이터를 제공합니다. |
| [Nutritionix Worlds][43] | 검증된 영양 데이터를 제공합니다. |
| [USDA Nutrients][45] | 국가 영양소 데이터베이스에 액세스할 수 있습니다. |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
...
| [Bandsintown][13] | 지역 콘서트 정보를 제공하고 라이브 음악 이벤트를 추천합니다. |
| [Songkick][22] | 아티스트, 공연장, 위치 등의 라이브 음악 정보를 제공합니다. |
| [Discogs][21] | 아티스트, 레이블, 음반에 대한 정보를 제공합니다. |
{: .reset-td-br-1 .reset-td-br-2 role="presentation" }
