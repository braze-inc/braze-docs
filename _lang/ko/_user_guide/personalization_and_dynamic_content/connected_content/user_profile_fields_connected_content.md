...
{% endraw %}
 ...
 이는 Braze가 연결된 콘텐츠 호출을 수행하기 전에 사용자로부터 어떤 필드를 검색할지 알아야 하기 때문입니다.

 Liquid 전처리기는 사용자로부터 "언어" 속성을 가져와 응답 템플릿을 준비할 수 있도록 합니다.
...
{% endraw %}
 ...
 If the Connected Content response itself has more Connected Content tags or any catalog tags, Braze will not re-render those additional tags.
