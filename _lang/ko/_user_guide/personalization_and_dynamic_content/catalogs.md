...
-  호텔 숙소와 편의시설, 객실 유형 및 가격을 가져온 다음, 선택한 기본 설정에 따라 사용자에게 프로모션을 전송하세요.
...
카탈로그는 데이터 저장 기능입니다. 여기에는 개인화를 위해 메시지에서 참조할 수 있는 대규모 데이터 세트가 포함되어 있습니다. 실제로 데이터를 참조하기 위해서는 [Liquid]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/liquid/)를 템플릿 언어로 사용하게 됩니다. 
