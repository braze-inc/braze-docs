...
카탈로그 품목의 재고가 0이어야 사용자가 성공적으로 구독할 수 있습니다. 아이템의 인벤토리 수량이 인벤토리 규칙을 충족하면 해당 아이템을 구독한 모든 사용자(구독 이벤트를 수행한 사용자)를 조회하여 캠페인이나 캔버스를 트리거하는 데 사용할 수 있는 Braze 사용자 지정 이벤트를 보냅니다.
