...
| 국가 |   | 이 속성은 위치를 기준으로 메시지를 타겟팅하는 데 사용됩니다. |
...
| 세션 시작 및 세션 종료 | 사용자가 통합된 앱 또는 사이트를 사용하기 시작할 때 | Braze SDK는 사용자 인게이지먼트를 계산하기 위해 Braze 대시보드에서 사용하는 세션 데이터 및 사용자를 이해하는 데 핵심적인 기타 분석을 보고합니다.  |
...
디바이스 수준 속성(디바이스 무선 통신사, 시간대, 해상도 등) 추적에 대해 자세히 알아보려면 플랫폼별 설명서를 참조하세요: 
