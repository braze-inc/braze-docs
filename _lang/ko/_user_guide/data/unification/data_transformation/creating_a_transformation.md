...
![웹훅을 Braze 고객 프로필에 매핑하는 데이터 변환 코드의 예시입니다.]({% image_buster /assets/img/data_transformation/data_transformation11.png %})
...
- Transformation code is accepted in the JavaScript programming language. if/else 로직과 같은 모든 표준 자바스크립트 제어 흐름이 지원됩니다.
