...
!['사용자 삭제' 탭의 '삭제 기록 상세 정보' 창입니다.]({% image_buster /assets/img/audience_management/deleting_users/deletion_record_details.png %}){: style="max-width:55%;"}
...
사용자 세그먼트를 삭제하도록 요청하면 **삭제 대기 중이라는** [세그먼트 필터가]({{site.baseurl}}/user_guide/engagement_tools/segments/managing_segments/#filters) 자동으로 생성됩니다. 다음과 같은 용도로 사용할 수 있습니다:
