...
이 페이지에서는 현재 조기 액세스(EA) 중인 동기화 및 소스 단계를 보여줍니다. 일반 제공 환경의 단계는 [일반 제공 환경](#general-availability-experience)을 참조하세요.
...
{: start="7"}
6. 4단계에서 만든 정책을 역할에 연결합니다. 검색창에서 정책을 검색하고 정책 옆의 체크 표시를 선택하여 연결합니다. 완료되면 **다음**을 선택합니다.
