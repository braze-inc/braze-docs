...
{% alert important %}
[계정 개체는](https://braze.com/unlisted_docs/account_opportunity_object/) 베타 버전이며 이 기능을 사용하려면 [계정 개체가](https://braze.com/unlisted_docs/account_opportunity_object/) 필요합니다. Contact your Braze account manager if you’re interested in participating in the beta.
{% endalert %}
...
- 동기화 이름 위에 마우스를 올려놓고 관련 작업을 선택하면 동기화를 새로고침, 재개 또는 일시정지할 수 있습니다.
