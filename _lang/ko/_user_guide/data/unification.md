---
nav_title: 데이터 통합
article_title: 데이터 통합
page_order: 1
layout: dev_guide
guide_top_header: "데이터 통합"
guide_top_text: "> 사용자 데이터를 Braze에서 한곳으로 통합하세요. 데이터 소스에 관계없이 모든 데이터를 통합하여 사용자의 행동, 선호도, 행동 등 사용자를 완벽하게 파악할 수 있습니다."
page_type: landing
description: "이 섹션에는 Braze 데이터 플랫폼의 데이터 통합과 관련된 문서가 포함되어 있습니다."
