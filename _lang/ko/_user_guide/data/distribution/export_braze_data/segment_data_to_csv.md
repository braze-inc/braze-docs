...
![기본 세그먼트 페이지의 설정 드롭다운을 클릭합니다.]({% image_buster /assets/img_archive/csvexport2.png %})
...
[무작위 버킷 번호를]({{site.baseurl}}/user_guide/engagement_tools/testing/random_bucket_numbers/) 사용하여 사용자 기반을 여러 세그먼트로 나눈 다음 내보내기 후에 결합할 수도 있습니다. 예를 들어, 세그먼트를 두 개의 다른 세그먼트로 나누어야 하는 경우 다음 필터를 사용하여 수행할 수 있습니다:
