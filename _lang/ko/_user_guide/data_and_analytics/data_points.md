...
데이터 포인트 대시보드 구성 요소에 대한 자세한 내용은 [결제]({{site.baseurl}}/user_guide/onboarding_with_braze/subscription_and_usage/)를 참조하세요.
...
중첩 커스텀 속성은 다른 속성의 속성으로서 속성 집합을 정의하는 객체를 의미합니다. 객체의 모든 키는 데이터 포인트로 계산됩니다.
