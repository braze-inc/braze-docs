...
이 막대 그래프는 선택한 채널을 기준으로 각 [인게이지먼트 이벤트]({{site.baseurl}}/user_guide/data_and_analytics/braze_currents/event_glossary/message_engagement_events)의 절대 개수를 보여줍니다. 전환 수는 선택한 어트리뷰션 방법에 따라 정의됩니다.
