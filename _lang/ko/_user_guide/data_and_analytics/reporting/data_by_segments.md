...
page_order: 2.5
page_type: reference
description: "이 참조 문서에서는 Query 빌더 보고서 템플릿을 사용하여 캠페인, 캔버스, 배리언트 및 단계를 세그먼트별로 성능/성과 측정기준을 분류하는 방법을 보여줍니다."
tool: 
  - Segments
  - Reports
...
2. 측정기준에 "세그먼트 분석"이 포함된 템플릿을 필터링합니다, 이는 다음과 같습니다.
