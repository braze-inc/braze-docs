...
> Braze 데이터 변환을 사용하면 웹훅 통합을 구축 및 관리하여 외부 플랫폼에서 Braze로 데이터 흐름을 자동화할 수 있습니다. 이렇게 새롭게 통합된 사용자 데이터는 더욱 정교한 마케팅 사용 사례를 뒷받침할 수 있습니다. Braze 데이터 트랜스포메이션은 코딩 경험이 거의 없더라도 데이터 통합을 신속하게 처리할 수 있으며, 팀이 수동 API 호출, 타사 통합 도구 또는 고객 데이터 플랫폼에 의존하는 것을 대체할 수 있도록 도와줍니다.
