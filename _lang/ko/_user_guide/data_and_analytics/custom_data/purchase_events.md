...
구매 이벤트 속성을 사용하면 트리거 조건에 대한 추가 자격을 부여하고, 메시징의 개인화를 강화하며, 원시 데이터 내보내기를 통해 보다 정교한 분석을 생성하는 데 사용할 수 있는 구매에 대한 속성을 설정할 수 있습니다. 속성 값 유형(문자열, 숫자, 부울, 날짜)은 플랫폼마다 다르며 키-값 쌍으로 할당되는 경우가 많습니다.
