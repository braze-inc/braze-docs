...
| 세션 시작 및 세션 종료 | 사용자가 통합된 앱 또는 사이트를 사용하기 시작할 때 | Braze SDK는 사용자 인게이지먼트를 계산하기 위해 Braze 대시보드에서 사용하는 세션 데이터 및 사용자를 이해하는 데 핵심적인 기타 분석을 보고합니다. 세션 시작 및 세션 종료가 앱 또는 사이트에 의해 호출되는 정확한 시점은 개발자([Android]({{site.baseurl}}/developer_guide/platform_integration_guides/android/analytics/tracking_sessions/), [iOS]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/analytics/tracking_sessions/), [웹]({{site.baseurl}}/developer_guide/platform_integration_guides/web/analytics/tracking_sessions/))에 의해 구성할 수 있습니다. |
