...
모델의 [예측 품질]({{site.baseurl}}/user_guide/brazeai/predictive_suite/predictive_churn/prediction_analytics/prediction_quality/)이 40% 이상이면, 좋은 결과입니다! 하지만 예측 품질이 39% 이하로 떨어지면 고객이탈 및 예측 오디언스 정의를 보다 구체적으로 하거나 다른 시간 창을 가져야 할 수 있습니다. 
