...
![예측 데이터 요구 사항은 31명의 과거 이탈 고객(요구 사항 충족)과 0명의 과거 비이탈 고객(최소 기준 미달)을 보여줍니다. 경고 메시지는 예측을 구축하기에 충분한 비이탈 고객이 없음을 나타냅니다.]({% image_buster /assets/img/churn/audience_size_error.png %})
