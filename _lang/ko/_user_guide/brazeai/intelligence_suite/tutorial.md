...
article_title: 인텔리전스 제품군 튜토리얼
page_order: 10
search_rank: 12
description: "Braze 인텔리전스 제품군을 처음 사용하시나요? 이 튜토리얼부터 시작하세요."
tool:
  - Dashboard
---
...
> Braze 인텔리전스 스위트를 처음 사용하시나요? 이 튜토리얼부터 시작하세요! 자세한 내용은 [인텔리전스]({{site.baseurl}}/user_guide/brazeai/intelligence/) 제품군을 참조하세요.
...
### 1단계: 알림을 보낼 시기를 위해 Intelligent Timing을 사용하세요
...
![Intelligent Timing 전달 설정 메시지 단계.]({% image_buster /assets/img/intelligence_suite1.png %})

### 2단계: 지능형 선택을 사용하여 프로모션을 선택하세요
...
![캔버스의 A/B 테스트 섹션에서 지능형 선택이 활성화되었습니다.]({% image_buster /assets/img_archive/canvas_intelligent_selection.png %})
