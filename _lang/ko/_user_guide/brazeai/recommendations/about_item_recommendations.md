---
nav_title: 항목 추천에 대하여
article_title: 항목 추천에 대하여
...
예를 들어, 테크 이커머스 플랫폼은 필터를 사용하여 최근 카탈로그에 추가된 품목을 타겟팅하여 테크 매니아에게 최신 전자기기나 예정된 선주문에 대한 알림을 제공할 수 있습니다.
...
사용자가 최근에 더 자주 구매한 항목을 강조 표시합니다. 예를 들어, 이커머스 비즈니스는 사용자가 다음 시즌을 준비하면서 비축하기 시작하는 시즌 상품을 추천할 수 있습니다. 
