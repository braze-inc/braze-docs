...
![콘텐츠 카드 캠페인에서의 예제 메시지 작성기입니다.]({% image_buster /assets/img/recs/content_card_preview.png %})
...
![작성기에서의 클릭 시 동작 블록의 예입니다.]({% image_buster /assets/img/recs/on_click_behavior.png %}){: style="max-width:60%;"}<br><br>
...
![예제 최종 호출에 의해 생성된 레스토랑 목록의 렌더링입니다.]({% image_buster /assets/img/recs/sample_response.png %}){: style="max-width:30%;"}
{% endtab %}
{% endtabs %}
