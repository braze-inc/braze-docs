...
Braze가 최적의 전송 시간을 계산할 수 있는 참여 데이터가 충분하지 않은 오디언스의 사용자에게 보낼 메시징의 대체 시간을 선택합니다. {% multi_lang_include brazeai/intelligent_suite/fallback_time.md %}
...
사용자 데이터를 사용할 수 없는 경우 Intelligent Timing은 메시지 설정에서 대체 시간을 사용합니다. 
