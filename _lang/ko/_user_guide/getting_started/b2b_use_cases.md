...
page_order: 11
layout: dev_guide
guide_top_header: "B2B 사용 사례"
guide_top_text: "Braze는 잠재 고객 확보 전략부터 제품 주도 판매 및 성장 이니셔티브, 이탈 방지까지 잠재 고객과 고객을 참여시킬 수 있는 전례 없는 방법을 제공하는 강력한 고객 참여 제품군을 보유하고 있습니다.<br><br>이 섹션에서는 초기 데이터 모델 생성, 계정 기반 세분화, 리드 스코어링과 같은 운영 캠페인 등 B2B(기업 간 거래) 사용 사례를 위해 Braze를 설정하는 방법을 설명합니다."
description: "Braze를 사용하여 B2B 사용 사례를 지원할 수 있는 다양한 방법을 확인하세요."

guide_featured_title: "주요 사용 사례"
guide_featured_list:
  - name: B2B 데이터 모델
