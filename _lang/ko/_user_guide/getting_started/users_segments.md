...
- **사용자 식별자:** 각 고객 프로필은 `external_id`라는 사용자 ID로 고유하게 식별됩니다. 이 식별자를 통해 Braze는 다양한 채널과 디바이스에서 사용자 데이터를 추적하고 연결하여 브랜드와 각 사용자의 상호 작용을 통합적으로 파악할 수 있습니다. [익명 사용자 프로필]({{site.baseurl}}/user_guide/getting_started/users_segments/anonymous_users/) (로그인하지 않고 웹사이트나 애플리케이션을 방문하는 사용자)에는 `external_id` 이 없지만 대체 식별자로 [사용자 별칭을]({{site.baseurl}}/user_guide/getting_started/users_segments/anonymous_users/#assigning-user-aliases) 할당할 수 있습니다.
...
[커스텀 속성]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_attributes/)은 특정 비즈니스 요구 사항에 따라 정의하는 속성입니다. 이를 통해 앱이나 비즈니스에 고유한 정보를 추적할 수 있습니다. 
...
[데이터 포인트]({{site.baseurl}}/user_guide/data_and_analytics/data_points/)에 대해 자세히 알아보려면 전용 문서를 방문하세요.
