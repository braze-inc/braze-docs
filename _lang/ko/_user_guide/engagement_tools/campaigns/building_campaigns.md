...
layout: dev_guide
guide_top_header: "캠페인 구축하기"
guide_top_text: "이 랜딩 페이지에는 캠페인 구축에 대한 리소스가 있습니다. <a href='/docs/user_guide/engagement_tools/segments/'>세그먼트를</a> 생성한 후에는 여기에 있는 리소스를 사용하여 캠페인을 설정하고 사용 가능한 다양한 옵션에 대해 알아보세요.<br><br><a href='https://learning.braze.com/campaign-setup-delivery-targeting-conversions'>캠페인 설정</a> Braze 학습 과정도 꼭 확인해 보시기 바랍니다."
page_order: 2
