...
layout: dev_guide
page_order: 0
guide_top_header: "캠페인 만들기"
guide_top_text: "이제 Braze에서 캠페인의 기본 사항을 이해했으니, 어떤 종류의 메시지를 보낼지 결정하는 데 도움이 되는 다양한 <a href='/docs/user_guide/message_building_by_channel/'>메시지 채널을</a> 확인해 보세요. 다음 목록에서 메시징 채널을 선택하여 해당 유형의 단일 채널 메시징 캠페인을 만들고 작성하는 방법을 알아보거나 멀티채널 캠페인을 만들어 유형을 결합하는 방법을 알아보세요.<br><br><a href='https://learning.braze.com/campaign-setup-delivery-targeting-conversions'>캠페인 설정</a> 브레이즈 학습 과정도 꼭 확인해 보시기 바랍니다!"
page_type: landing
description: "이 랜딩 페이지에는 다양한 Braze 메시징 채널에 대한 캠페인을 만드는 방법에 대한 문서 링크가 포함되어 있습니다."

search_rank: 1
guide_featured_title: "캠페인 유형 선택"
guide_featured_list:
- name: 콘텐츠 카드 캠페인
