...
{% alert note %}
[이전 탐색]({{site.baseurl}}/navigation)을 사용하는 경우 **인게이지먼트** > **캠페인** > **캘린더**를 선택합니다.
{% endalert %}
...
보고서에서 해당 날짜에 커서를 올려놓으면 보고서에서 특정 날짜의 메시징 분석을 볼 수 있습니다.
...
<i class="fa-solid fa-chevron-left" style="color: #2e7487;"></i> **이전 달 보기** 또는 <i class="fa-solid fa-chevron-right" style="color: #2e7487;"></i> **다음 달 보기**를 선택하여 월을 변경할 수 있습니다. 현재 월로 돌아가려면 **오늘을** 선택합니다.
...
- **빨간색:** 단일 채널 예약 캠페인.
- **파란색:** 멀티채널 예약 캠페인.
- **금색:** 중지된 캠페인은 기록 참조를 위해 캘린더에 포함됩니다.
