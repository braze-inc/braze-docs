...
이미 앱에서 활동 중인 사용자에게 다가가는 것은 지속적인 앱 사용자로 구성된 로열티 높은 팔로워를 구축하는 데 강력한 도구가 될 수 있습니다. 파워 유저를 조금만 맞춤화하면 이들을 앱의 전도사로 만들 수 있습니다.
...
![작성 단계의 캠페인에 iOS 리치 알림이 포함된 캠페인이 표시됩니다. "저희와 함께 쇼핑해 주셔서 다시 한 번 감사드립니다! 감사의 마음을 전하기 위해 다음 구매 시 무료 배송 서비스를 제공합니다."]({% image_buster /assets/img/congratulations_push.jpg %})
