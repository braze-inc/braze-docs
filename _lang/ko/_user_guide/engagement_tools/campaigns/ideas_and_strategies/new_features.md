...
![캠페인 구축 워크플로우의 타겟 사용자 단계에 있는 타겟팅 옵션 패널입니다. 추가 필터 섹션에는 "Android 스톱워치(Android)의 최신 앱 버전 번호가 3.7.0(134.0.0.0) 미만"이라는 필터가 포함되어 있습니다.]({% image_buster /assets/img_archive/new_app_version.png %}){: style="max-width:90%;"}
