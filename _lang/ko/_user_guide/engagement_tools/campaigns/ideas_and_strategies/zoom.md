...
![이메일 메시지에 Liquid 템플릿을 사용하여 이름, 성, 이메일 주소 및 도시를 포함합니다.]({% image_buster /assets/img/zoom/zoom1.png %})
...
1. 푸시 캠페인 만들기<br><br>
	...
	![버튼이 클릭될 때 웨비나로 연결합니다.]({% image_buster /assets/img/zoom/zoom2.png %})<br><br>
...
2. 인앱 메시지 또는 버튼 클릭으로 트리거되는 웹훅 캠페인을 생성합니다.<br><br>
	...
	![특정 캠페인에 대한 버튼을 클릭한 사용자에게 전송될 행동 기반 캠페인입니다.]({% image_buster /assets/img/zoom/zoom6.png %})<br><br>
...
1. 인앱 메시지 캠페인 만들기<br><br>
	...
	![버튼이 클릭될 때 웨비나로 연결합니다.]({% image_buster /assets/img/zoom/zoom3.png %})<br><br>
...
2. 인앱 메시지 또는 버튼 클릭으로 트리거되는 웹훅 캠페인을 생성합니다.<br><br>
	...
	![특정 캠페인에 대한 버튼을 클릭한 사용자에게 전송될 행동 기반 캠페인입니다.]({% image_buster /assets/img/zoom/zoom5.png %})<br><br>
