...
[사용자 지정 이벤트 속성으로]({{site.baseurl}}/user_guide/data/custom_data/custom_events/custom_event_properties/) 개인화된 캠페인을 테스트하는 것은 앞서 설명한 다른 유형의 캠페인을 테스트하는 것과 약간 다릅니다. 
...
3. 페이지 하단에 커스텀 이벤트 속성을 추가하고 상단 상자에 사용자 ID 또는 이메일 주소를 추가합니다.
