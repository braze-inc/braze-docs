...
**대상** 아래의 **세그먼트** 페이지로 이동하여 현재 모든 사용자 세그먼트를 확인합니다. 이 페이지에서 새 세그먼트를 만들고 이름을 지정할 수 있습니다. To get started, select **Create Segment** and give your segment a name.

![모달을 사용하여 세그먼트를 만듭니다.]({% image_buster /assets/img_archive/createsegment2.png %}){: style="max-width:70%;"}
...
![원 안의 가장 최근 위치를 필터링합니다.]({% image_buster /assets/img_archive/filter_recent_location.png %})
...
![뉴저지와 뉴욕 사이의 도시를 원형으로 표시한 윤곽선입니다.]({% image_buster /assets/img_archive/location_circle.png %}){: style="max-width:70%;"}
...
![선택한 다각형 지역으로서 뉴욕주의 윤곽선입니다.]({% image_buster /assets/img_archive/create_polygon.png %}){: style="max-width:70%;"}
