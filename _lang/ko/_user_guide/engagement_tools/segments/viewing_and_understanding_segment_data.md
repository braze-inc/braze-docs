...
Braze 대시보드의 **세그먼트** 페이지에는 모든 세그먼트에 대한 요약이 포함되어 있으며 각 세그먼트에 대한 자세한 데이터를 살펴볼 수 있습니다. 이 페이지에서 세그먼트의 이름을 검색하고 선택하여 해당 데이터를 편집하고 확인합니다. 세그먼트를 만드는 방법을 알아보려면 [세그먼트 만들기를]({{site.baseurl}}/user_guide/engagement_tools/segments/creating_a_segment/#creating-a-segment) 확인하세요.
