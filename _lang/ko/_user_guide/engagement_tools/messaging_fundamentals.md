...
layout: dev_guide
page_order: 0
guide_top_header: "메시징 기초(Messaging Fundamentals)"
guide_top_text: ">에서는 <a href='/docs/user_guide/getting_started/campaigns_canvases'>캠페인 또는 캔버스를</a> 사용하여 메시지를 작성, 전송 및 관리할 수 있습니다. 이 두 가지 메시징 방법 모두 구성(메시지 설정)과 관리(메시지 관리)에 대한 몇 가지 공통된 메시징 기본 사항이 있습니다."
page_type: landing
tool: 
    - Campaigns
    - Canvas
description: "이 랜딩 페이지에서는 캠페인과 캔버스를 통한 메시징의 기본에 대한 글을 확인할 수 있습니다. 여기에서는 전환 이벤트를 전략적으로 활용하고 메시지를 작성할 때 전달 유형을 결정하는 방법, 메시지를 관리할 때 승인 워크플로우를 사용하고 상태를 이해하는 방법에 대한 리소스를 찾을 수 있습니다."

guide_featured_title: "구성"
