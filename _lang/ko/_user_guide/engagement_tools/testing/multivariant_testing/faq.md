---
nav\_title: FAQ article\_title: 다변량 및 A/B 테스트 FAQ page\_order: 21 페이지 유형: 참조 참조\_헤더: H2 설명: "이 문서에서는 Braze를 사용한 다변량 및 A/B 테스트에 대한 FAQ를 다룹니다."
---
...
현재 Braze는 대조군이 있는 A/B 테스트에서 속도 제한을 지원하지 않습니다. 이는 비율 제한이 변종과 같은 방식으로 대조군에는 적용되지 않아 편향이 발생하기 때문입니다. 대신 분석 및 캠페인 성과에 따라 각 변형을 수신할 사용자의 비율을 자동으로 조정하는 [지능형 선택을]({{site.baseurl}}/user_guide/intelligence/intelligent_selection/) 사용하는 것이 좋습니다.
