...
여러 템플릿을 복제하려면 템플릿 이름 옆의 체크박스를 선택하면 됩니다. 먼저 템플릿을 선택한 다음 **복제를** 선택합니다.

중복된 템플릿은 **마지막 편집** 열을 정렬하여 찾을 수 있습니다. 기본값으로, 새 템플릿은 `Copy of ORIGINAL_TEMPLATE_NAME`로 명명됩니다.

{% endraw %}

![템플릿이 마지막으로 편집된 시간별로 정렬된 세 개의 템플릿과 복사된 템플릿이 목록 맨 위에 표시됩니다.]({% image_buster /assets/img/duplicate_multiple_template.gif %})
