...
[브레이즈에 도메인을 연결하면](#connecting-your-domain-to-braze) 모든 랜딩 페이지의 기본 도메인으로 사용됩니다. 예를 들어, 서브도메인 `forms.example.com`을 연결하면 랜딩 페이지 URL은 이제 `forms.example.com/holiday-sale`이 됩니다.
