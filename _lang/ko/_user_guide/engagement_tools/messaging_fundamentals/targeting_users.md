...
![두 개의 세그먼트가 포함된 메시지에 대한 타겟팅 옵션에 30일 전 마지막 구매에 대한 추가 필터가 있습니다.]({% image_buster /assets/img_archive/target_segmenter.png %}){: style="max-width:90%;"}
{% endtab %}
...
!['총 인구수' 섹션에는 각 대상 채널에서 도달 가능한 사용자 수에 대한 추정치가 표시됩니다.]({% image_buster /assets/img_archive/multi_channel_footer.png %})
