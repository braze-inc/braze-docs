...
{% alert note %}
Braze는 데이터 계획에는 시간이 걸린다는 사실을 잘 알고 있습니다. 지금 바로 개발팀에 이커머스 이벤트 전송 방법을 숙지하고 시작하시길 권장합니다. 일부 기능은 전자상거래 추천 이벤트에서 즉시 사용할 수 없지만, 2025년에 전자상거래 기능을 향상시킬 새로운 제품이 출시될 예정이니 기대해도 좋습니다.
{% endalert %}
