...
guide_top_text: "다양한 아이디어와 전략으로 캔버스를 테스트하고 확인하는 방법에 대해 자세히 알아보세요."
page_order: 5

tool: Canvas
page_type: landing
description: "이 랜딩 페이지에는 모범 사례, 출시 전/후 체크리스트, 캔버스 플로우 출시에 대한 안내 등 캔버스 아이디어와 전략이 담겨 있습니다."
