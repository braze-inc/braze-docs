...
guide_top_text: "캔버스를 시작했으면 이제 편안히 앉아 데이터가 들어오는 것을 지켜볼 차례입니다. 캔버스를 변경하거나 보관해야 하는 경우 다음 문서를 참조하여 도움을 받으세요."

page_type: landing
description: "이 랜딩 페이지에는 캔버스 보관, 복제, 실행 후 변경 등 캔버스 관리에 대한 문서가 있습니다."
tool: Canvas
