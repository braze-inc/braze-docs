...
사용자 업데이트 단계에서는 속성 값을 늘리거나 줄일 수 있습니다. 속성을 선택하고 **증분** **기준** 또는 **감산을** 선택한 다음 숫자를 입력합니다. 
...
`shopping_cart` 속성은 모든 품목의 총 비용, 장바구니의 총 품목 수, 장바구니에 선물이 포함된 경우 등 다양한 사용자 지정 이벤트의 총합을 전달합니다. 다음과 같이 보일 수 있습니다:
