...
!["연간 봄 프로모션에 사용"이라는 설명이 포함된 "연간 세일 캔버스 템플릿"이라는 이름의 캔버스 템플릿 예시입니다.]({% image_buster /assets/img/canvas_template_example.png %})
...
사용 가능한 캔버스 템플릿 목록은 [캔버스 템플릿을]({{site.baseurl}}/canvas_templates/templates/) 참조하세요. 전자상거래 캔버스 템플릿 사용에 대한 자세한 내용은 [전자상거래 추천 이벤트 사용 방법을]({{site.baseurl}}/ecommerce_use_cases/) 참조하세요.
