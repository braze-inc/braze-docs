---
nav_title: Braze 템플릿 사용하기
article_title: Braze 템플릿 사용
page_order: 2
layout: dev_guide
guide_top_header: "Braze 템플릿 사용"
guide_top_text: "<a href='/docs/user_guide/engagement_tools/canvas/create_a_canvas/canvas_templates/' target='_blank'>Braze 캔버스 템플릿으로</a> 마케팅 캠페인의 잠재력을 최대한 활용하세요. 이러한 템플릿은 효과적인 사용자 여정을 만들기 위한 간소화된 접근 방식을 제공하여 중요한 순간에 사용자의 참여를 유도할 수 있도록 합니다. 다음 사용 사례 문서를 살펴보고 마케팅 목표를 위해 캔버스 템플릿을 어떻게 구축할 수 있는지 알아보세요."

page_type: landing
description: "이 랜딩 페이지에서는 기능 도입을 위한 사용자 타겟팅부터 온보딩 사용자를 위한 메시징 개인화까지, 사용 사례에 맞게 Braze 캔버스 템플릿을 커스텀하고 활용하는 방법을 안내하는 문서가 마련되어 있습니다."
tool: Canvas
