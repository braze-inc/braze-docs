...
사용자가 이메일 주소를 변경할 때 자동으로 다시 구독할 수 있습니다. 예를 들어, 이전에 탈퇴한 워크스페이스 사용자가 이메일 주소를 Braze의 탈퇴 목록에 없는 주소로 변경하면 자동으로 다시 구독됩니다.
...
{% details 왜 내 환경 설정 센터를 작성할 때 오류 메시지 "이메일 본문에 탈퇴 링크가 포함되어 있지 않습니다"가 표시되나요? %}
