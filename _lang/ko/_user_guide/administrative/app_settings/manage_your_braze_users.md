...
page_order: 23
page_type: reference
description: "이 페이지에서는 사용자 추가 및 삭제, 사용자 권한 설정, Teams 만들기, 회사 설정 관리와 같은 회사 사용자 관리에 대해 설명합니다."
---
...
사용자를 일시 중지하면 계정이 비활성 상태가 되어 더 이상 로그인할 수 없지만 계정과 관련된 데이터는 보존됩니다. 관리자만 회사 사용자를 일시 정지하거나 일시 정지 해제할 수 있습니다.
...
이후 삭제된 사용자와 동일한 이메일 주소로 새 대시보드 사용자가 생성되는 경우, 삭제된 사용자가 만든 자산을 새 사용자와 다시 연결하지 않습니다. 새 대시보드 사용자는 백지 상태에서 시작하며 대시보드의 기존 자산을 만든 사람으로 인정받지 못합니다.
