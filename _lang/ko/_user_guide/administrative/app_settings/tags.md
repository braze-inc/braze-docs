...
![캠페인 분석 페이지에 표시되는 태그.]({% image_buster /assets/img_archive/tag_details_page.png %}){: style="max-width:60%;" }
...
![중첩 태그를 만듭니다.]({% image_buster /assets/img_archive/tag_nested.png %}){: style="max-width:70%;" }
