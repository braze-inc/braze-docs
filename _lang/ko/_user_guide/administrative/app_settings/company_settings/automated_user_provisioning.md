...
{% alert note %}
[이전 탐색]({{site.baseurl}}/navigation)을 사용하는 경우 계정 드롭다운을 선택하고 **회사 설정** > **자동화된 사용자 프로비저닝**으로 이동합니다.
{% endalert %}
...
1. 새 대시보드 개발자를 추가할 기본 작업 영역을 선택합니다. [사용자 만들기 SCIM API 호출](/docs/post_create_user_account/)에서 워크스페이스를 지정하지 않으면 여기에 워크스페이스가 추가됩니다.
