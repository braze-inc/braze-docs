...
> Braze 관리자는 다양한 사용자 역할과 권한으로 회사 사용자를 Teams로 그룹화할 수 있습니다. 이렇게 하면 편집할 수 있는 콘텐츠 유형을 분리하여 서로 관련이 없는 여러 회사 사용자 그룹이 하나의 작업 공간에서 함께 작업할 수 있습니다.
...
회사 수준의 권한인 '회사 설정을 관리할 수 있음'을 가진 Braze 관리자 및 제한된 사용자는 제한된 액세스 권한을 가진 회사 사용자에게 팀 수준의 권한을 할당할 수 있습니다. 팀에 배정된 회사 사용자는 팀을 만들 때 정의된 대로 사용자 언어, 위치, 커스텀 속성 등 특정 팀에서 사용할 수 있는 데이터만 읽거나 쓸 수 있도록 제한됩니다.
...
!["Swifty & Droidboy" 작업 영역에 대한 권한 세트입니다.]({% image_buster /assets/img/team_level_permissions.png %})
