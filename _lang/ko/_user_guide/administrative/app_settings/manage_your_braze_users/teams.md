...
> As a Braze admin, you can group your company users into Teams with varying user roles and permissions. 이렇게 하면 편집할 수 있는 콘텐츠 유형을 분리하여 서로 관련이 없는 여러 회사 사용자 그룹이 하나의 작업 공간에서 함께 작업할 수 있습니다.
