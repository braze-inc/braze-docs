...
계약에서 월간 순 방문자 수(MUV)를 사용하다가 월간 활성 사용자 수(MAU)만 사용하는 계약으로 변경하는 경우, 이전 데이터는 여전히 MUV 그래프에 표시되고 새 데이터는 MAU 그래프에만 표시됩니다. 예를 들어, 10월에 계약이 종료되는 경우 MUV 그래프에는 9월 말까지 데이터가 표시됩니다.
