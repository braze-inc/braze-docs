---
nav\_title: 브랜드 가이드라인 article\_title: 브랜드 가이드라인 페이지\_주문: 1 페이지\_유형: 참조 설명: "이 참조 문서에서는 AI 카피라이팅 도우미를 통해 메시지에 적용할 수 있는 브랜드 가이드라인을 만들고, 관리하고, 사용하는 방법에 대해 설명합니다."
---
...
| **특성** | **정의** | **예시** | --------------------------|--------------------------------------------------------------------------------------|--------------------------------------------------------------------| | 평판 | 시장에서 브랜드가 어떻게 인식되기를 원하는가. | 업계에서 가장 신뢰할 수 있고 고객 중심적인 브랜드로 알려져 있습니다. | 성격 특성 | 브랜드의 성격을 설명하는 인간적인 특성. | 친근하고 접근하기 쉬우며 항상 긍정적인 브랜드입니다. | 가치관 | 브랜드의 행동과 결정을 이끄는 핵심 가치. | 지속 가능성, 투명성, 커뮤니티를 중요하게 생각합니다. | 차별성 | 경쟁사와 차별화되는 브랜드만의 고유한 특성. | 그 이상의 개인화된 고객 서비스를 제공함으로써 차별화합니다. | 브랜드 보이스 | 브랜드가 사용하는 커뮤니케이션 톤과 스타일. | 캐주얼하면서도 유익한 정보를 제공하며, 너무 형식적이지 않으면서도 명확성을 보장합니다. | 브랜드 원형 | 브랜드의 페르소나(영웅, 창조자 등)를 대표하는 원형입니다. | 항상 새로운 도전과 모험을 추구하는 '탐험가' 원형을 구현합니다. | {: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 role="presentation" }
...
{% 경고 중요 %} 사본의 언어에 관계없이 출력 언어를 변경할 수 있지만 Braze나 OpenAI는 번역 품질을 보장하지 않습니다. 번역을 사용하기 전에 항상 번역을 테스트하고 확인하세요. {% endalert %}
