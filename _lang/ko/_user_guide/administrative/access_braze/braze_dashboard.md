...
글로벌 헤더는 화면 상단에서 거의 항상 보입니다. 필수 도구 및 설정에 빠르게 접근할 수 있도록 해줍니다. 포함된 항목은 다음과 같습니다:
...
Braze 대시보드는 색상 대비에 대한 WCAG AA 기준을 충족하는 브랜드 색상을 사용합니다. 이는 모든 사용자에게 포괄적인 경험을 지원하며 접근성 모범 사례와 일치합니다.
