...
!["매출 보고서" 페이지에 "매출"을 매개변수로 설정한 "시간 경과에 따른 실적" 그래프가 표시됩니다.]({% image_buster /assets/img/revenue_report.png %})
...
{% alert note %}
환율이 없는 통화에 대한 매출을 기록하면 Braze는 이를 미화 0.00달러의 구매로 기록합니다.
{% endalert %}
...
!["제품 분석" 테이블에는 "제품 이름", "구매한 제품", "매출" 열이 표시됩니다.]({% image_buster /assets/img/revenue_report_product_breakdown.png %})
