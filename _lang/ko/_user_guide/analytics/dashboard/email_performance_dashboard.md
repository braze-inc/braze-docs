...
**인게이지먼트 시간** 보고서는 사용자가 이메일에 인게이지먼트하는 시기에 대한 데이터를 표시합니다. 이것은 고객의 인게이지먼트가 가장 높은 요일이나 시간을 파악하는 데 도움이 될 수 있습니다. 이러한 통찰력을 통해 메시지를 보내는 최적의 날이나 시간을 실험하여 더 높은 참여를 유도할 수 있습니다. 
