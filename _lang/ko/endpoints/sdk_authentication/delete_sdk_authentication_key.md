...
layout: api_page
page_type: reference
description: "이 문서에서는 SDK 인증 키 Braze 엔드포인트 삭제에 대한 자세한 내용을 설명합니다."
---
...
이 엔드포인트를 사용하려면 `sdk_authentication.delete` 권한이 있는 [API 키]({{site.baseurl}}/api/basics#rest-api-key/)가 필요합니다.
