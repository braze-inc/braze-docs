...
layout: api_page
page_type: reference
description: "이 문서에서는 콘텐츠 블록 만들기 Braze 엔드포인트에 대한 자세한 내용을 설명합니다."
...
| 매개변수 | 필수 | 데이터 유형 | 설명 |
|---|---|---|---|
| `name` | Required | 문자열 | 콘텐츠 블록의 이름입니다. 100자 미만이어야 합니다. |
| `description` | Optional | 문자열 | 콘텐츠 블록에 대한 설명입니다. 250자 미만이어야 합니다. |
| `content` | Required | 문자열 | 콘텐츠 블록 내의 HTML 또는 텍스트 콘텐츠. |
