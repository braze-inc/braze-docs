...
## 새로운 드래그 & 드롭 편집기 인앱 메시지용

새로운 [드래그 & 드롭 편집기]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/drag_and_drop)를 사용하면 HTML을 알 필요 없이 완전히 커스텀되고 개인화된 인앱 메시지를 만들 수 있습니다. 드래그 & 드롭 편집기는 향후 몇 달 동안 모든 고객에게 출시될 예정입니다. 접근을 더 빨리 요청하고 싶다면, 고객 성공 매니저에게 연락하세요.

## 이메일을 위한 드래그 & 드롭 편집기 업데이트

### 새 편집기 블록

이메일을 위한 드래그 & 드롭 편집기에 두 개의 새로운 편집기 블록이 추가되었습니다: [문단 블록]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/dnd_editor_blocks/#paragraph) 및 [목록 블록]({{site.baseurl}}/user_guide/message_building_by_channel/email/drag_and_drop/dnd_editor_blocks/#list).
