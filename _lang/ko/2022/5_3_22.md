...
2022년 4월부터 Android 개발자는 개인정보 보호 및 보안 관행을 공개하기 위해 Google Play의 [데이터 안전 양식][4]을 작성해야 합니다. [이 가이드]({{site.baseurl}}/developer_guide/platform_integration_guides/android/google_play_privacy#google-play-privacy-questionnaire)는 Braze가 앱 데이터를 처리하는 방법에 대한 정보와 함께 이 새 양식을 작성하는 방법에 대한 지침을 제공합니다. 
