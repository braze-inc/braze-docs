...
Braze는 Shopify의 **Liquid 5**까지 Liquid에 대한 지원을 업데이트했습니다. 새로운 회사 사용자에게 Liquid 5가 일반적으로 제공됩니다. 기존 회사 사용자에게 Liquid 5는 초기 액세스 상태입니다. [Liquid 5의 새로운 기능]({{site.baseurl}}/user_guide/personalization_and_dynamic_content/liquid#whats-new-with-liquid-5)에 대해 자세히 알아보세요.
