...
|`{{most_recently_used_device.${id}}}` | This is Braze’s device identifier. On iOS, this can be the Apple Identifier for Vendor (IDFV) or a UUID. For Android and other platforms, it is Braze’s device identifier, a randomly generated GUID. |
...
|Tag | Description |
|------------------|---|
| `{{targeted_device.${id}}}` | This is Braze’s device identifier. On iOS, this can be the Apple Identifier for Vendor (IDFV) or a UUID. For Android and other platforms, it is Braze’s device identifier, a randomly generated GUID. |
