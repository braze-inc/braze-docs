...
You can use [Query Builder]({{site.baseurl}}/user_guide/data_and_analytics/query_builder/) or your own database warehouse to query for specific abort messages that are triggered when Liquid logic causes a message to abort.
