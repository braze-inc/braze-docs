...
For example, if the "message" event property in the example below could potentially contain characters that break the JSON format, add the `json_escape` filter like in this example:
