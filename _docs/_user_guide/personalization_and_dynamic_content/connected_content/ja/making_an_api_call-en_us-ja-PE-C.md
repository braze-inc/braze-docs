...
]({% image_buster /assets/img/connected_content/basic_auth_mgmt.png %})Braze ダッシュボードの「コネクテッドコンテンツ」の設定。()
...
]({% image_buster /assets/img/connected_content/basic_auth_token.png %})名前、ユーザー名、パスワードを入力するオプションがある [新しい認証情報の作成] ウィンドウ。{: style="max-width:60%"}()
