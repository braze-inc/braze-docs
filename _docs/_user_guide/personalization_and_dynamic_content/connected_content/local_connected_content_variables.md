...
To prevent Connected Content from caching the value it returns from a GET request, you can use the `:no_cache` configuration. Responses from hosts internal to Braze will still be cached, however.
