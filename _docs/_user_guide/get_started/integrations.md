...
{% alert note %} 
Note that the contents of this article don't apply to email. Check that out in the [Email setup]({{site.baseurl}}/user_guide/channels/email/email_setup/) section.
{% endalert %}
...
| Email | This is an entirely different process. Check out the [Email Setup]({{site.baseurl}}/user_guide/channels/email/email_setup/) section for more details on integration. |
...
2. Define your custom data requirements ([custom attributes]({{site.baseurl}}/user_guide/data/activation/attributes/custom_attributes/), [custom events]({{site.baseurl}}/user_guide/data/activation/events/custom_events/), etc.).
3. From there, discuss how that data should be tracked (triggered through the SDK, etc.).
4. Define how many [workspaces]({{site.baseurl}}/user_guide/administer/global/create_and_manage_workspaces/) you need. Your engineers will need to know how to [test and configure]({{site.baseurl}}/user_guide/get_started/workspaces/) these workspaces.

Once you discover all of this information, share it with your engineer. They'll take that information and implement your [custom data]({{site.baseurl}}/user_guide/data/activation/custom_data/managing_custom_data/). You might even need to [import some users]({{site.baseurl}}/user_guide/audience/manage_audience/import_users/). You should also be aware of [event naming conventions]({{site.baseurl}}/user_guide/data/activation/events/event_naming_conventions/).
