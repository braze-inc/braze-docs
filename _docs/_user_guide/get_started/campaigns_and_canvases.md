...
Your Canvas can have any combination of [messages]({{site.baseurl}}/user_guide/messaging/canvas/canvas_components/message_step/), [delays]({{site.baseurl}}/user_guide/messaging/canvas/canvas_components/delay_step/), [experiments]({{site.baseurl}}/user_guide/messaging/canvas/canvas_components/experiment_step/), and more. You can send on any supported messaging channel, and even [integrate with social and ad platforms]({{site.baseurl}}/partners/canvas_audience_sync/overview/) such as Facebook, Google, or TikTok.
