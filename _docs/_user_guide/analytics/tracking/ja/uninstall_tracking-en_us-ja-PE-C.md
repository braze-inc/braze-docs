...
]({% image_buster /assets/img_archive/Uninstall_Segment.png %} "Uninstall Segment")セグメントのアンインストール。
...
]({% image_buster /assets/img_archive/campaign_level_uninstall_tracking.png %})キャンペーンレベルでのアンインストール。()
