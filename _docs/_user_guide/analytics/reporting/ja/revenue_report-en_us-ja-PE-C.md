...
]({% image_buster /assets/img/revenue_report.png %})パラメーターとして [収益] を設定した [経時的なパフォーマンス] グラフを表示している [収益レポート] ページ。()
...
]({% image_buster /assets/img/revenue_report_product_breakdown.png %})「製品名」、「購入数」、「収益」の各列を示す [製品の内訳] のテーブル。()
