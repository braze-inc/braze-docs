...
]({% image_buster /assets/img/cloud_ingestion/fabric_1.png %})ユーザーが SQL 接続文字列を取得する必要がある Microsoft Azure の [Fabric Console] ページ。
...
Braze ダッシュボードの Redshift 用 [新しいインポート同期を作成] ページ、ステップ3に設定「接続を設定します」]({% image_buster /assets/img/cloud_ingestion/ingestion_6.png %})
...
Braze ダッシュボードの BigQuery 用 [新しいインポート同期を作成] ページ、ステップ3に設定「接続を設定します」]({% image_buster /assets/img/cloud_ingestion/ingestion_11.png %})
...
Braze ダッシュボードの BigQuery 用 [新しいインポート同期を作成] ページ、ステップ3に設定同期の詳細を設定]({% image_buster /assets/img/cloud_ingestion/ingestion_12.png %})
...
Braze ダッシュボードの Databricks 用 [新しいインポート同期を作成] ページ、ステップ3に設定「接続を設定します」]({% image_buster /assets/img/cloud_ingestion/ingestion_16.png %})
...
Braze ダッシュボードの Databricks 用 [新しいインポート同期を作成] ページ、ステップ3に設定同期の詳細を設定]({% image_buster /assets/img/cloud_ingestion/ingestion_12.png %})
...
Braze ダッシュボードの Microsoft Fabric 用 [新しいインポート同期を作成] ページ、ステップ4に設定同期の詳細を設定]({% image_buster /assets/img/cloud_ingestion/fabric_setup_2.png %})
...
Braze ダッシュボードの Microsoft Fabric 用 [新しいインポート同期を作成] ページ、ステップ4に設定通知設定を指定]({% image_buster /assets/img/cloud_ingestion/fabric_setup_3.png %})
...
]({% image_buster /assets/img/cloud_ingestion/ingestion_5.png %})Braze ダッシュボードの Snowflake 用 [データインポート] ページで、縦の省略記号メニューから [今すぐ同期] オプションが表示されている状態()

{% endtab %}
{% tab Redshift %}
有効にすると、セットアップ時に設定したスケジュールで同期が実行される。通常のテストスケジュール以外で同期を実行したい場合や、最新のデータを取得したい場合は、「**今すぐ同期**」を選択する。この実行は、定期的にスケジュールされている将来の同期には影響しません。

]({% image_buster /assets/img/cloud_ingestion/ingestion_10.png %})「Braze ダッシュボードの Redshift 用 [データインポート] ページで、縦の省略記号メニューから [今すぐ同期] オプションが表示されている状態()
...
]({% image_buster /assets/img/cloud_ingestion/ingestion_15.png %})Braze ダッシュボードの BigQuery 用 [データインポート] ページで、縦の省略記号メニューから [今すぐ同期] オプションが表示されている状態()
...
]({% image_buster /assets/img/cloud_ingestion/ingestion_18.png %})Braze ダッシュボードの Databricks 用 [データインポート] ページで、縦の省略記号メニューから [今すぐ同期] オプションが表示されている状態()
