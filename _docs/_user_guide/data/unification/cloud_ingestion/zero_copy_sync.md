...
* The query results from your source table are temporarily stored in Braze during processing. They are also exported to your configured storage for 30 days so you can view exactly what was synced.
