...
Formulas can be accessed in the statistics panels on the [Home]({{site.baseurl}}/user_guide/analytics/dashboards/home/), [Revenue Report]({{site.baseurl}}/user_guide/analytics/reports/revenue_report/), and [Custom Events Report]({{site.baseurl}}/user_guide/data/activation/events/custom_events/) pages in the dashboard. To view this panel, go to the **Performance Over Time** chart, change the **Statistics For** dropdown to **KPI Formulas**, and then select at least one KPI formula to populate the chart.
