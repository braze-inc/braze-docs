...
2. Using our message templates and [personalization features]({{site.baseurl}}/user_guide/messaging/design_and_edit/personalize/overview#personalized-messaging) to drag the unique promotion code attribute into messaging directed at users.
