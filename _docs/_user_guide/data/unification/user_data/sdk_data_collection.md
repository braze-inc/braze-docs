...
| Language                | Android, iOS, Web | Device or browser language, taken from the device locale                                                            | This attribute is used to translate messages to a user’s preferred language. It's based on the device locale, unless the language attribute has been updated through the REST API.                                                                                            |
