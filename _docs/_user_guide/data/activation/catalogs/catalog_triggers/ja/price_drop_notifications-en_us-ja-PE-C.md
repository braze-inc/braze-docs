...
2. **値下げ**トグルを選択する。
3. グローバルカタログ設定が設定されていない場合は、通知のトリガーに使用するカスタムイベントとプロパティを設定するように求められます。<br><br> ]({% image_buster /assets/img/catalog_settings_drawer.png %})カタログ設定ドロワー。{: style="max-width:70%;"}()
