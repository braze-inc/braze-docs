...
]({% image_buster /assets/img/purchase_filter_example.gif %})厳密に 3 回購入したユーザーのフィルター適用{: style="max-width:80%;"} ()
...
]({% image_buster /assets/img/purchase2.png %})ブランド名が HeadphoneMart に等しいヘッドフォンを購入したユーザーにキャンペーンを送信するアクションベースの配信設定{: style="max-width:80%;margin-left:15px;"}()
