...
To learn more, visit our dedicated [purchase events]({{site.baseurl}}/user_guide/data/activation/events/purchase_events/) article.
...
To learn more, visit our dedicated [custom events]({{site.baseurl}}/user_guide/data/activation/events/custom_events/) article.
