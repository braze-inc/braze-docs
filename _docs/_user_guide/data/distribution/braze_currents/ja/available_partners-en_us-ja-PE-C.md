...
## データウェアハウスストレージ
[]({% image_buster /assets/img/bl_icon3.png %})ブレイズ・ラーニング・コース{: style="float:right;width:120px;border:0;" class="noimgborder"}()](https://learning.braze.com/introduction-to-data-warehouses)
