...
| Number of rows         | By default, each sync run can sync up to 500 million rows. Any syncs with more than 500 million new rows will be stopped. Please contact your CSM or Braze support if you need to request a higher limit.                                                             |
