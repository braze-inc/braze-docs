...
description: "This article will cover how the BrazeAI<sup>TM</sup> Liquid Assistant works and how you can use it to generate Liquid snippets for your messaging."
page_type: reference
page_order: 5
---
...
With the BrazeAI<sup>TM</sup> Liquid Assistant, you can generate Liquid from templates, receive personalized Liquid suggestions, and optimize existing Liquid with the support of BrazeAI<sup>TM</sup>. The BrazeAI<sup>TM</sup> Liquid Assistant also provides annotations explaining the Liquid used, so you can increase your understanding of Liquid and learn to write your own.
...
While using the BrazeAI<sup>TM</sup> Liquid Assistant, you may see a variety of prompts to help you get started with Liquid. Some of the prompts are listed below.
