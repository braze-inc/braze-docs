...
{% alert note %}
Campaigns and Canvas Steps that ignore [Frequency Capping](https://www.braze.com/docs/user_guide/engagement_tools/campaigns/testing_and_more/rate-limiting/#delivery-rules) will not be accounted for by the Intelligent Channel and cannot contribute to the data requirements above.
{% endalert %}
