...
{% alert tip %}
Make sure to [add your colleagues to Braze]({{site.baseurl}}/user_guide/administer/global/user_management/manage_braze_users/) so they can explore the platform with you.
{% endalert %}
