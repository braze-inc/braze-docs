...
{% alert tip %}
We get that custom attributes can be confusing. For more on using custom attributes in your messaging strategies, check out our [Custom Events and Attributes](http://learning.braze.com/custom-events-and-attributes) Braze Learning course!
{% endalert %}
