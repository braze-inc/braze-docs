...
For example, to build a segment that targets users with a date attribute between 24 and 48 hours in the future, filters of: "in more than 1 day in the future" & "in less than 2 days in the future" should be applied.
