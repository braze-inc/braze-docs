...
{% alert tip %}
For more on using custom events in your messaging strategies, check out our [Custom Events and Attributes](http://learning.braze.com/custom-events-and-attributes) Braze Learning course!
{% endalert %}
