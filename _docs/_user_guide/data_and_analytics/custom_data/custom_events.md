...
Note that `canvas_entry_properties` can only be used in in-app messages in Canvas Flow and the original Canvas editor with persistent entry properties enabled.
