...
| Payload size           | Each row can contain a payload of size up to 1 MB. Payloads greater than 1 MB will be rejected with the error "Payload was greater than 1MB" logged along with the associated external ID and truncated payload. |
