---
nav_title: CDI for BigQuery
article_title: Braze Cloud Data Ingestion for BigQuery
description: "This reference article covers Braze Cloud Data Ingestion and how to sync relevant user data from your Google BigQuery integration."
page_order: 3
page_type: reference

---

# Cloud Data Ingestion for BigQuery
...
New Cloud Data Ingestion integrations require some setup on the Braze side and in your BigQuery instance. Follow these steps to set up the integration:  
...
If you have network policies in place, you will need to give Braze network access to to your Redshift instance. Allow access from the below IPs that correspond to the region of your Braze dashboard.  
...
1. **Add BigQuery connection information and source table**<br>
Upload the JSON key and provide a name for the service account, then input the details of your source table.<br>![][1]<br><br>
...
[1]: {% image_buster /assets/img/cloud_ingestion/ingestion_11.png %}
[2]: {% image_buster /assets/img/cloud_ingestion/ingestion_12.png %}
[3]: {% image_buster /assets/img/cloud_ingestion/ingestion_13.png %}
[4]: {% image_buster /assets/img/cloud_ingestion/ingestion_14.png %}
[5]: {% image_buster /assets/img/cloud_ingestion/ingestion_15.png %}
