...
5. Select **Next**. <br>![]({% image_buster /assets/img_archive/domain_authentication.png %})
6. After the TXT record is added to the DNS, return to the Google Postmaster Tools dashboard and select **Verify**. This step confirms you own the domain, so you'll be able to access Gmail deliverability metrics in your Postmaster account. <br> ![]({% image_buster /assets/img_archive/domain_verification.png %})
...
2. Select the **Deliverability Center** tab. <br>![]({% image_buster /assets/img_archive/deliverability_center1.png %})
...
![]({% image_buster /assets/img_archive/deliverability_center2.png %})
...
![]({% image_buster /assets/img_archive/deliverability_center_msnds.png %})
