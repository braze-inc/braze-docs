...
| OS               | Android, iOS, Web  | The user's operating system (Android OS version, iOS version, etc.) | This attribute is used to ensure messages are compatible with the user's device. |
