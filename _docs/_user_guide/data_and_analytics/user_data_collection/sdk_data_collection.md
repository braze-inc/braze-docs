...
| IDFV | iOS | Device identifier. IDFV collection is now optional on our [Swift SDK](https://github.com/braze-inc/braze-swift-sdk) | Used to differentiate users' devices, and ensure messages are sent to the correct intended device. |
