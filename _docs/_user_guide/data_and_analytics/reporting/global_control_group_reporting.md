...
{% alert note %}
If you are using our [updated navigation]({{site.baseurl}}/navigation), **Global Control** is now **Global Control Group Report** and can be found under **Analytics** > **Reports** > **Global Control Group Report**.
{% endalert %}
