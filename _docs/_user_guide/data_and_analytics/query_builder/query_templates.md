...
| Email delivery metrics by day | This report provides metrics for the messages sent on each day, such as how many emails were sent, delivered, soft bounced, and hard bounced. <br><br> All metrics are unique throughout the reporting period. For example, if a welcome email soft bounced one time on November 21, two times on November 22, and was never delivered: {::nomarkdown} <ul><li> The <i>Soft Bounces</i> metric for November 21 increases by one.</li><li> The <i>Soft Bounces</i> metric for November 22 is not affected. </li></ul>{:/} ![]({% image_buster /assets/img_archive/email_delivery_day.png %})|
|  Email engagement metrics by segment | This report provides metrics for the messages sent to each segment, such as how many emails were sent, delivered, soft bounced, and hard bounced. <br><br> All metrics are unique throughout the reporting period. For example, if a welcome email soft bounced one time on November 21, two times on November 22, and was never delivered: {::nomarkdown} <ul><li> The <i>Soft Bounces</i> metric for November 21 increases by one. </li><li> The <i>Soft Bounces</i> metric for November 22 is not affected.</li></ul>{:/} ![]({% image_buster /assets/img_archive/email_engagement_segment.png %}) |
| Email engagement metrics for variants or steps, by segment | This report provides metrics for the variants or Canvas steps of the messages sent to each segment. These metrics include how many emails were sent, delivered, soft bounced, and hard bounced. <br><br> All metrics are unique throughout the reporting period. For example, if a welcome email soft bounced one time on Nov 21, two times on Nov 22, and was never delivered: {::nomarkdown} <ul><li> The <i>Soft Bounces</i> metric for Nov 21 increases by one. </li> <li> The <i>Soft Bounces</i> metric for Nov 22 is not affected.</li></ul> {:/} |
