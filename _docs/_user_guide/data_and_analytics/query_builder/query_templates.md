...
| Email subscription group opt-ins and opt-outs | This report shows the number of unique user opt-ins and opt-outs of any email subscription group each week. <br><br> ![]({% image_buster /assets/img_archive/query_builder_q2.png %}){: style="max-width:70%;"} |
