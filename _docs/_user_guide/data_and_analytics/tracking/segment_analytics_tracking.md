...
Braze also provides the ability to view data on [Custom events over time for segments]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/custom_events/#analytics) by navigating to **Analytics** > **Custom Events Report**.
