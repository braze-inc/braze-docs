...
You should always [preview and test your messages]({{site.baseurl}}/user_guide/messaging/campaigns/test_campaigns/sending_test_messages/) on a variety of devices to confirm that the most important areas of your image and message appear as expected.
