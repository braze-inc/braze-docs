...
{% alert important %}
Campaign approval is not supported for [API campaigns]({{site.baseurl}}/api/api_campaigns) and [Transactional Email campaigns]({{site.baseurl}}/user_guide/channels/transactional_email/create_a_transactional_email/).
{% endalert %}
