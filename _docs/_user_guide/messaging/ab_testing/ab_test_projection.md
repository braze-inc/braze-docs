...
{% alert note %}
For [quick push campaigns]({{site.baseurl}}/user_guide/channels/push/create_a_push_message/quick_push_messages/), A/B testing is supported when you select multiple platforms.
{% endalert %}
