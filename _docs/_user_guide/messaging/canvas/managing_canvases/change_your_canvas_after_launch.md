...
- When a Canvas is [automatically stopped]({{site.baseurl}}/user_guide/messaging/messaging_fundamentals/statuses/#available-statuses), the post-launch drafts of the Canvas are also deleted.
