...
Customize the look and feel of your email sign-up form and confirmation page using the drag-and-drop [in-app message components]({{site.baseurl}}/user_guide/channels/in_app_messages/drag_and_drop/style_settings/#message-components).
