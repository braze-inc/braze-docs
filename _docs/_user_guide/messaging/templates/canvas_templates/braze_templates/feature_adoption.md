...
To successfully use this template, you'll need to a [custom event]({{site.baseurl}}/user_guide/data/activation/events/custom_events/) that references when users have used the feature.
