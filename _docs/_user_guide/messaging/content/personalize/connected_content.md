...
guide_featured_list:
- name: Making a Connected Content API Call
  link: /docs/user_guide/messaging/content/personalize/connected_content/making_an_api_call/
  image: /assets/img/braze_icons/navigation-pointer-01.svg
- name: Local Connected Content Variables
  link: /docs/user_guide/messaging/content/personalize/connected_content/local_connected_content_variables/
  image: /assets/img/braze_icons/server-01.svg
- name: Caching Connected Content Responses
  link: /docs/user_guide/messaging/content/personalize/connected_content/caching_responses/
  image: /assets/img/braze_icons/edit-05.svg
- name: Aborting Connected Content
  link: /docs/user_guide/messaging/content/personalize/connected_content/aborting_connected_content/
  image: /assets/img/braze_icons/stop-circle.svg
- name: Pulling User Profile Data
  link: /docs/user_guide/messaging/content/personalize/connected_content/user_profile_fields_connected_content/
  image: /assets/img/braze_icons/users-01.svg
- name: Connected Content Retries
  link: /docs/user_guide/messaging/content/personalize/connected_content/connected_content_retries/
...
- name: Using Public APIs
  link: /docs/user_guide/messaging/content/personalize/connected_content/public_apis/
