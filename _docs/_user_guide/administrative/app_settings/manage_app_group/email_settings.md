...
{% alert important %} 
Appending a BCC address to your campaign or Canvas step will result in your billable emails for the campaign or Canvas step being doubled as Braze sends one message to your user and one to your BCC address. Please contact your Customer Success Manager or open a support ticket to enable this feature. 
{% endalert %}
