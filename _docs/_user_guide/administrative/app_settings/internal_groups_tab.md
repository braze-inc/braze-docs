...
{% alert note %}
If you have a recurring campaign and any one of the variants are updated, you can choose to send again to only the updated variants or all variants, or turn off Seed Group sending upon update.
{% endalert %}
