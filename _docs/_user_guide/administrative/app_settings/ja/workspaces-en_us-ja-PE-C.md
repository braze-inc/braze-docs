...
]({% image_buster /assets/img/workspaces/workspace_create.png %})ワークスペースのドロップダウンに [ワークスペースを作成] ボタンがある。{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/workspaces/workspace_name.png %})「Upon Voyage US-Staging」という名前の「ワークスペースを作成」モーダル。{: style="max-width:60%" }()

アプリインスタンスの追加を開始するための [**アプリ設定**] ページが表示されます。このページには、[**設定**] > [**アプリ設定**] からいつでもアクセスできます。

]({% image_buster /assets/img/workspaces/workspace_empty_state.png %})Upon Voyage USの "アプリ設定 "ページ - アプリを追加するボタンがあるステージングワークスペース()
...
]({% image_buster /assets/img/workspaces/workspace_add_app.png %})アプリの詳細を選択するためのオプションがある「新規アプリを Upon Voyage US - Staging に追加」モーダル{: style="max-width:60%" }()
...
]({% image_buster /assets/img/workspaces/app_api_key.png %})Upon Voyage iOSアプリの設定ページ。APIキーとSDKエンドポイントのフィールドがある。()
...
]({% image_buster /assets/img/workspaces/app_live_sdk_version.png %})フィールド値が「5.4.0」で、新しいバージョンが利用可能であることを示すアイコンが表示された [ライブ SDK バージョン] セクション。()
...
]({% image_buster /assets/img/workspaces/workspace_favorites.png %})ワークスペースのドロップダウンに「お気に入りワークスペース」のタブがある。{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/workspaces/workspace_rename.gif %})ワークスペース名の隣に表示される鉛筆アイコン{: style="max-width:50%;"}()
...
]({% image_buster /assets/img/workspaces/workspace_delete.png %})ワークスペースを削除するボタンと、アプリを削除するゴミ箱アイコンがあるアプリ設定ページ()
