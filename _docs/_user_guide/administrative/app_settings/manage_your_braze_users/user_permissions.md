...
<!-- Determine if this can be removed? Or added to the relevant description. -->
{% alert important %}
...
|Company|Create and delete workspaces|Gives a user the ability to create and delete workspaces.|
|Company|Manage company settings|Gives a user the ability to modify any company setting.|
