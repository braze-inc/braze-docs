...
![BCC Address section of the Email Settings tab with an BCC address using Liquid.]({% image_buster /assets/img/email_settings/dynamic_bcc.png %}){: style="max-width:80%;" }
