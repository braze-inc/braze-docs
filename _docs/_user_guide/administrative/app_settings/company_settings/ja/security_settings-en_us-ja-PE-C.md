...
]({% image_buster /assets/img/remember_me.png %})[このアカウントを 30 日間記憶する] チェックボックス{: style="float:right;max-width:50%;margin-left:15px;"}()
...
]({% image_buster /assets/img/elevated_access.png %})Elevated アクセスのトグル。()
