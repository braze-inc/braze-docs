...
{% alert note %}
**Row limit**: The 10,000-row limit applies only to the manual CSV report download from the dashboard. Security event exports to S3 aren't subject to this row limit.
{% endalert %}
