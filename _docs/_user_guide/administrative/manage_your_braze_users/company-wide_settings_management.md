...
| Campaign Interaction Expiration | Notifies recipients about any Campaign that is due for campaign interaction data expiration, along with any information about Segments, Campaigns, or Canvases that reference it in a retargeting filter and were used to send a message in the previous 30 days. 
 Email |
