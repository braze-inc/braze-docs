...
To create and manage internal groups, you need the [Access Dev Console permission]({{site.baseurl}}/user_guide/administer/global/user_management/permissions/#limited-and-team-role-permissions) for your workspace.
