...
]({% image_buster /assets/img/zoom/zoom1.png %})メールメッセージ (名、姓、メールアドレス、および市区町村を含めるために使用される Liquid テンプレート付き)。()
...
1. プッシュキャンペーンを作成します。<br><br>
	...
	]({% image_buster /assets/img/zoom/zoom2.png %})ボタンをクリックしたときのウェビナーへのリンク()<br><br>
...
2. アプリ内メッセージやボタンクリックによってトリガーされる Webhook キャンペーンを作成します。<br><br>
	...
	]({% image_buster /assets/img/zoom/zoom6.png %})特定のキャンペーンのボタンをクリックしたユーザーに送信されるアクションベースのキャンペーン。()<br><br>
...
1. アプリ内メッセージキャンペーンを作成する<br><br>
	...
	]({% image_buster /assets/img/zoom/zoom3.png %})ボタンをクリックしたときのウェビナーへのリンク()<br><br>
...
2. アプリ内メッセージやボタンクリックによってトリガーされる Webhook キャンペーンを作成します。<br><br>
	...
	]({% image_buster /assets/img/zoom/zoom5.png %})指定したキャンペーンのボタンをクリックしたユーザーに送信されるアクションベースのキャンペーン。()<br><br>
