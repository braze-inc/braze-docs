...
You can edit individual fields from a random or existing user to help test dynamic content within your message. Click the **Edit** button to convert the selected user into a custom user you can modify.
