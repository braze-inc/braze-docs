...
![The "Reachable users" panel with exact statistics calculated and an expanded breakdown dropdown.]({% image_buster /assets/img_archive/reachable_users_breakdown.png %})
