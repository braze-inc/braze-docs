...
For example, let's say your workspace contains 100 million users and your segment has about 700 users. It's possible that on some days, 0 users are in the segment and 0 users land in the random bucket range used for the historical membership estimate, resulting in a one-day membership count of 0.
