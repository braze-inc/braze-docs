...
The Braze web SDK is initialized immediately if a user navigates to the landing page through a link generated by a {% raw %}`{% landing_page_url %}`{% endraw %} Liquid tag in a Braze message.
