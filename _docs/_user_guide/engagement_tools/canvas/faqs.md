...
If a user has entered a Canvas step with an in-app message before the Canvas was stopped, they will still receive the in-app message since in-app messages send upon the next session start.
