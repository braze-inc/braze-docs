...
Want to sync up with your brand's first-party user data? Leverage the available audience sync options for [Facebook]({{site.baseurl}}/partners/canvas_steps/facebook_audience_sync) and [Google]({{site.baseurl}}/partners/canvas_steps/google_audience_sync).
