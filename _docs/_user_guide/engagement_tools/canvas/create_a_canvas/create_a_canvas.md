...
{% alert note %}
Custom event properties can be referenced only in the first step of a Canvas.<br><br>Make sure to use `{{canvas_entry_properties.${property_name}}}` if referencing event properties in the first step.
{% endalert %}
