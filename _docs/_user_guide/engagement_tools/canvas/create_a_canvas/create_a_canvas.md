...
{% tabs local %}
  {% tab Scheduled Delivery %}
    ...
    If you select a monthly recurring schedule, note that there are certain months where the date might not exist. For example, let's say you set a Canvas to send monthly on the 31st. In this scenario, Braze sends on the last day of that month, such as April 30 since April 31 doesn't exist.
