...
page_order: 3
description: "This reference article covers the different aspects of canvas that can be changed after the inital launch."
page_type: reference
tool:
  - Canvas
  - Dashboard
...
> This reference article covers the different aspects of canvas that can be changed after inital launch.
