...
- A user can be eligible for up to 10 in-app messages within the same Canvas step. For example, if a Canvas allows re-entry and a user enters the Canvas 11 times, they will only see 10 in-app messages if none have expired.
