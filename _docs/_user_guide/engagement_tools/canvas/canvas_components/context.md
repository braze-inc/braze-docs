...
> Use Context steps to create or update a set of data representing the context of a user as they move through a Canvas. Each Context variable includes a name, data type, and a value that can include Liquid. By setting Context as part of your user journey, you can do things like delay messages or filter users based on Context variables.
