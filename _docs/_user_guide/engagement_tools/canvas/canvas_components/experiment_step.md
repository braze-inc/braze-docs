...
To create Experiment Paths, first add a step to your Canvas. For Canvas Flow, drag and drop the component from the sidebar, or click the <i class="fas fa-plus-circle"></i> plus button at the bottom of a step and select **Experiment Paths**. For the original Canvas editor, use the dropdown at the top of the new full step in your workflow to select **Experiment Paths**.
