...
]({% image_buster /assets/img/audience_path/audience_path.png %})エンゲージメント・ユーザーとそれ以外のユーザーという2つのグループを持つオーディエンスパス{: style="float:right;max-width:45%;margin-left:15px;margin-top:15px;"}()
...
]({% image_buster /assets/img/audience_path/audience_path5.png %})メッセージステップの後に24時間の遅延とオーディエンスパスを示すキャンバス。{: style="float:right;max-width:40%;margin-left:15px;"}()
...
]({% image_buster /assets/img/audience_path/audience_path3.png %})アジア料理が好き」、「ラテン料理が好き」、「ヨーロッパ料理が好き」、「それ以外」のグループを持つ拡張オーディエンスパス。()

オーディエンスパスステップの完了後、各オーディエンスグループは個別の分岐を持ちます。オーディエンスパスを使用してオーディエンスをさらに絞り込むことも、標準のキャンバスステップを使用してキャンバスのジャーニーを続けることもできます。 

]({% image_buster /assets/img/audience_path/audience_path4.png %}){: style="max-width:50%"}() エンゲージメントによって異なるグループを持つ2つのオーディエンスパス。
...
]({% image_buster /assets/img_archive/user_lookup.png %})ユーザー検索」セクション{: style="max-width:70%"}()
...
]({% image_buster /assets/img/audience_path/audience_path2.png %})ビッグブランドの靴が好き」、「ビッグブランドが好き」、「それ以外」のグループを持つオーディエンスパス。{: style="float:right;max-width:50%;margin-left:15px;margin-bottom:15px;"}()
