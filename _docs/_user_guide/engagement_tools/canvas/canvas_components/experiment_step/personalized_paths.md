...
![]({% image_buster /assets/img/experiment_step/experiment_personalized_path.png %}){: style="max-width:75%;" }
...
![]({% image_buster /assets/img/experiment_step/experiment_personalized_settings.png %}){: style="max-width:75%;" }
