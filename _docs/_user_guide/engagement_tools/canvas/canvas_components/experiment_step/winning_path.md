...
![]({% image_buster /assets/img/experiment_step/experiment_winning_settings.png %})
...
![Percentages specified in the experiment distribution]({% image_buster /assets/img/experiment_step/experiment_path_distribution.png %})
