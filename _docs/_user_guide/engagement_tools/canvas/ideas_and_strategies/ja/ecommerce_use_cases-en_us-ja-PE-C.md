...
4. 使用するテンプレートの [**テンプレートを適用**] を選択します。<br><br>]({% image_buster /assets/img_archive/apply_template.png %})[Braze テンプレート] タブが開いており、最近使用したテンプレートと選択可能な Braze テンプレートのリストが表示されている [キャンバステンプレート] ページ。{: style="max-width:80%;"}()
...
]({% image_buster /assets/img_archive/abandoned_browse.png %})適用された「閲覧の放棄」キャンバステンプレートで [エントリルール] が展開されている。()
...
- エントリスケジュール 
    ...
    - 開始時刻は、キャンバステンプレートを作成するときです<br><br>]({% image_buster /assets/img/ecommerce/abandoned_browse_entry.png %})キャンバスの [アクションベースのオプション]。()<br><br> 
- ターゲットオーディエンス 
    - エントリオーディエンス 
        - メールが**空白ではない**
    ...
    - 終了条件 
        - `ecommerce.cart_updated`、`ecommerce.checkout_started`、または `ecommerce.order_placed` を実行する<br><br>]({% image_buster /assets/img/ecommerce/abandoned_browse_entry_exit.png %})キャンバスのエントリコントロールと終了条件。()<br><br> 
- 送信設定 
    - 登録済みまたはオプトイン済みのユーザー 
- 遅延ステップ
    - 1時間遅延
...
]({% image_buster /assets/img_archive/abandoned_cart.png %})適用された「カート放棄」キャンバステンプレートで [エントリルール] が展開されている。()
...
- エントリスケジュール 
    ...
    - 開始時刻は、キャンバステンプレートを作成するときです<br><br>]({% image_buster /assets/img/ecommerce/abandoned_cart_entry.png %})キャンバスの [アクションベースのオプション]。()<br><br> 
- ターゲットオーディエンス 
    - エントリオーディエンス 
    ...
    - 終了条件 
        - `ecommerce.cart_updated`、`ecommerce.checkout_started`、または `ecommerce.order_placed` を実行する<br><br>]({% image_buster /assets/img/ecommerce/abandoned_cart_entry_exit.png %})キャンバスのエントリコントロールと終了条件。()<br><br> 
- 送信設定 
    - 登録済みまたはオプトイン済みのユーザー 
- 遅延ステップ
     - 4時間遅延
...
]({% image_buster /assets/img_archive/abandoned_checkout.png %})適用された「購入手続き放棄」キャンバステンプレートで [エントリルール] が展開されている。()
...
- エントリスケジュール 
    ...
    - 開始時刻は、キャンバステンプレートを作成するときです<br><br>]({% image_buster /assets/img/ecommerce/abandoned_checkout_entry.png %})キャンバスの [アクションベースのオプション]。()
- ターゲットオーディエンス 
    - エントリオーディエンス 
        - これらのアプリを**1回以上**使用したことがある 
        - メールが**空白ではない**
    - 入力コントロール
        - ユーザーのキャンバスへのエントリが即時に可能になります。
        - 終了条件 
            - `ecommerce.order_placed` イベントを実行します<br><br>]({% image_buster /assets/img/ecommerce/abandoned_checkout_entry_exit.png %})キャンバスのエントリコントロールと終了条件。()<br><br>
- 送信設定 
    - 登録済みまたはオプトイン済みのユーザー 
- 遅延ステップ
    - 4時間遅延
...
]({% image_buster /assets/img_archive/order_confirmation_feedback.png %})適用された「注文確認」キャンバステンプレートで [エントリルール] が展開されている。()
...
- エントリスケジュール 
    ...
    - 開始時刻は、キャンバステンプレートを作成するときです<br><br>]({% image_buster /assets/img/ecommerce/feedback_entry.png %})キャンバスの [アクションベースのオプション]。()<br><br>
- ターゲットオーディエンス 
    - エントリオーディエンス 
        - これらのアプリを**1回以上**使用したことがある 
        - メールが**空白ではない**
    - 入力コントロール
        - ユーザーのキャンバスへのエントリが即時に可能になります。
    - 終了条件 
        - 該当しない<br><br>]({% image_buster /assets/img/ecommerce/feedback_entry_exit.png %})キャンバスの追加のフィルターとエントリコントロール。()<br><br>
- 送信設定 
    - 登録済みまたはオプトイン済みのユーザー 
- メッセージステップ 
    - Liquid のテンプレート作成の例を使用して、メールテンプレートと HTML ブロックを確認し、あらかじめ用意されているテンプレートでメッセージに製品を追加します。独自のメールテンプレートを使用する場合は、次のセクションに示すように、[液体変数](#message-personalization) を参照することもできます。
...
]({% image_buster /assets/img_archive/ecommerce_filters.png %})「e コマース」フィルターを示すセグメントフィルターのドロップダウン。{: style="max-width:80%"}()
