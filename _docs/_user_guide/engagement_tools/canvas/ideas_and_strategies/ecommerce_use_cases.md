...
To gain insights into the trends related to orders placed from your launched Canvases, set up a [Conversions dashboard]({{site.baseurl}}/user_guide/analytics/dashboard/conversions_dashboard/) and specify your Canvases.
