...
{% alert important %}
We use asynchronous processing to maximize speed and flexibility. This means that when API calls are sent to us separately, we cannot guarantee that they will be processed in the order they were sent.
{% endalert %}
