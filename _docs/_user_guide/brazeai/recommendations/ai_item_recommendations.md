...
- The field can be inside an array of products, or the field can end with an array of ids. They will automatically be flattened, as if there were multiple events with the same timestamp.
