---
nav_title: Types and Use Cases
article_title: Item recommendation types and use cases
page_order: 20
description: "Learn about the different ways you can suggest items that your customers are interested in, and get inspiration for common use cases for creating recommendation engines using Braze."
---

# Item recommendation types and use cases

> Learn about the different ways you can suggest items that your customers are interested in, and get inspiration for common use cases for creating recommendation engines using Braze.
