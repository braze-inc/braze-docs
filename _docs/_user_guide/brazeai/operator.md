---
nav_title: Operator
article_title: BrazeAI Operator<sup>TM</sup>
page_order: 8
layout: dev_guide
alias: /operator/
guide_top_header: "BrazeAI Operator<sup>TM</sup>"
guide_top_text: "BrazeAI Operator<sup>TM</sup> is Braze's AI assistant built into the dashboard. Operator helps get things done—answering questions, walking through setup, troubleshooting issues, and brainstorming ideas."
