---
nav_title: Choose your features
article_title: Choose your features for Decisioning Studio
page_order: 7
page_type: reference
...
- **Granularity:** All features should be aggregated to the customer level. See [Use Braze external ID]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/prepare_data/braze_external_id/) for guidance on what "customer level" means in practice.
