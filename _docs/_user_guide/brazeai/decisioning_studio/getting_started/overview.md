...
page_order: 1
page_type: reference
description: "This reference gives an overview of the steps involved in setting up Decisioning Studio, including connecting data sources, setting up orchestration, and designing your decisioning agent."
---
...
Configure your decisioning agents to define what outcomes you want to maximize and what actions the agent can take to achieve them. See [Designing Decisioning Agents]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/getting_started/designing_decisioning_agents/) for detailed guidance on agent design.
...
- [Designing Decisioning Agents]({{site.baseurl}}/user_guide/brazeai/decisioning_studio/getting_started/designing_decisioning_agents/)