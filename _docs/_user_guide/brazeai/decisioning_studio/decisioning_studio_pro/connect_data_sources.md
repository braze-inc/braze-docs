...
These patterns require more engineering effort, but are sometimes preferable depending on your current Braze configuration. Talk with AI Decisioning Services to learn more.
...
1. Ensure customer profile data is available in Klaviyo profiles
...
Now that you've connected your data sources, proceed to set up orchestration:
