...
[ファネルレポートでは]({{site.baseurl}}/user_guide/analytics/reporting/funnel_reports/)、特にパーソナライズされたメッセージを受け取った低インテントのユーザーにおいて、主要ステップでの離脱が明らかに減少していることも示されている。より多くのユーザーが開封し、クリックし、アップグレードしていることが、意図に基づいたターゲティングの価値を証明している。
