...
- **Flexible setup:** Use a Braze-provided LLM or connect your own [model provider]({{site.baseurl}}/partners/ai_model_providers) (such as OpenAI, Anthropic, or Google Gemini).
