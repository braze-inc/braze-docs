...
Agents are configured with instructions (system prompts) that define how they behave. When an agent runs, it uses your instructions along with any data you pass in to generate a response. It can't access user data beyond what is provided by the selected context and instructions.
