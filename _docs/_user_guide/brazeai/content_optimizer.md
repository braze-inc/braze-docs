...
When the step first launches, Content Optimizer sends variants randomly to collect initial performance data. This exploration phase lasts up to 48 hours, after which the algorithm begins shifting traffic toward higher-performing content combinations. During this period, each variant has a roughly equal chance of being sent.
