...
- name: Link Aliasing
  link: /docs/user_guide/channels/email/templates/link_aliasing/
  image: /assets/img/braze_icons/link-03.svg
- name: Create an Email Campaign
  link: /docs/user_guide/channels/email/html_editor/creating_an_email_campaign/
...
- name: Preference Center
  link: /docs/user_guide/channels/email/preference_center/
  image: /assets/img/braze_icons/list.svg
- name: CSS Inlining
  link: /docs/user_guide/channels/email/html_editor/css_inline/
  image: /assets/img/braze_icons/align-left.svg
- name: Custom Email Footer
  link: /docs/user_guide/channels/email/customize/custom_email_footer/
  image: /assets/img/braze_icons/message-check-circle.svg
- name: Inbox Vision
  link: /docs/user_guide/channels/email/inbox_vision/
...
- name: Gmail Promotion Tool
  link: /docs/user_guide/channels/email/html_editor/gmail_promotions_tab/
...
- name: Frequently Asked Questions
  link: /docs/user_guide/channels/email/faq/
