...
* If a user's most recently used device is not [push enabled]({{site.baseurl}}/user_guide/channels/push/push_setup/push_subscription_states/#foreground-push-enabled), the message will not send at all.
