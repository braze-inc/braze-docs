...
Then, finish setting up your push campaign as normal. See [Creating a push campaign]({{site.baseurl}}/user_guide/channels/push/create_a_push_message/) for more details.
