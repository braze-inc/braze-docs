...
The LINE performance table includes the column **Total Clicks** that shows a count of click events per variant and an associated click rate. For more details on LINE metrics, refer to [LINE message performance]({{site.baseurl}}/user_guide/channels/line/reporting).
