...
guide_featured_list:
- name: Modal
  link: /docs/user_guide/channels/in_app_messages/creative_details/modal/
  image: /assets/img/braze_icons/layout-alt-01.svg
- name: Slideup
  link: /docs/user_guide/channels/in_app_messages/creative_details/slideup/
  image: /assets/img/braze_icons/arrow-circle-broken-up.svg
- name: "Fullscreen"
  link: /docs/user_guide/channels/in_app_messages/creative_details/fullscreen/
...
- For fullscreen messages, follow our guidelines for [image safe zone]({{site.baseurl}}/user_guide/channels/in_app_messages/creative_details/fullscreen/#image-safe-zone).
...
[Further details for fullscreens]({{site.baseurl}}/user_guide/channels/in_app_messages/creative_details/fullscreen)
...
[Further details for modals]({{site.baseurl}}/user_guide/channels/in_app_messages/creative_details/modal)
...
[Further details for slideups]({{site.baseurl}}/user_guide/channels/in_app_messages/creative_details/slideup)
...
Braze currently supports GIFs for Web (included), [Android]({{site.baseurl}}/developer_guide/in_app_messages/gifs/?sdktab=android), and iOS (included) in-app messaging, given that it has been enabled during the desired platform integration. For more on video in in-app messages, see our [Customization documentation]({{site.baseurl}}/user_guide/channels/in_app_messages/customize/#video).

## Additional considerations

Braze in-app messages have both global and individual creative specifications. For more information about fully customizing in-app messages, go to our [Customization]({{site.baseurl}}/user_guide/channels/in_app_messages/traditional/customize/) page.
