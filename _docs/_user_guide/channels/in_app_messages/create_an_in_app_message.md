...
- For a list of available editor blocks and their properties, refer to [Editor blocks]({{site.baseurl}}/user_guide/channels/in_app_messages/drag_and_drop/editor_blocks/).
