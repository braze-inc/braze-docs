...
Dark Mode, located in the **Design** tab when [creating an in-app message]({{site.baseurl}}/user_guide/channels/in_app_messages/traditional/create/), lets you add an alternate color theme for users who are in Dark Mode on their device.
