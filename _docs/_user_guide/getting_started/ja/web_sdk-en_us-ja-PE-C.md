...
]({% image_buster /assets/img_archive/web_push_macbook.png %})Web ブラウザーに表示されるプッシュ{: style="float:right;max-width:45%;margin-left:20px;border:0;"}()
...
]({% image_buster /assets/img_archive/web-users-segment.png %})Web アプリが強調表示されている [セグメントの詳細]ページ{:style="max-width:60%"}()
