...
]({% image_buster /assets/img/line/line_composer.png %})プレビューにメッセージが表示された LINE 作成画面。()
...
]({% image_buster /assets/img/line/test_preview.png %})[テスト] タブには、テストメッセージのプレビューが表示されます。()
