...
]({% image_buster /assets/img/whatsapp/whatsapp1.png %})統合を開始するボタンが付いたWhatsAppパートナーページ。{: style="max-width:70%;"}()

開いたウィンドウで [**次へ**] を選択し、[**統合を開始**] ボタンが表示されるまで続けます。ボタンを選択し、統合プロセスを開始します。

]({% image_buster /assets/img/whatsapp/instructions.png %})BrazeとWhatsAppの接続方法。{: style="max-width:50%;"}()
