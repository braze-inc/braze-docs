...
]({% image_buster /assets/img/whatsapp/whatsapp_block_report.png %})WhatsApp のメッセージスレッドには、企業をブロックしたり報告したりするオプションが用意されている。{: style="max-width:30%;"}()
...
]({% image_buster /assets/img/whatsapp/whatsapp_unsubscribe.png %})チャネルを購読解除するには STOP を返信するように、と記載されたフッターを持つ WhatsApp メッセージ{: style="max-width:35%;"}()
