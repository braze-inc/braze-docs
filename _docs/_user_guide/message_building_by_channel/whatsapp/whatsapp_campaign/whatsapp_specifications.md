---
nav_title: WhatsApp specifications
...
**Applies to:** Template headers, response media messages, image messages
...
**Applies to:** Template headers (document format), response media messages, document messages
...
|---|---|---|---|
| Image | JPEG, PNG | 5 MB | Yes (1,024 chars) |
| Video | MP4, 3GPP | 16 MB | Yes (1,024 chars) |
