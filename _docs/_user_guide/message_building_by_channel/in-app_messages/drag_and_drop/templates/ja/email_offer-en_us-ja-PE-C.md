...
]({% image_buster /assets/img/drag_and_drop/templates/email_capture_offer.png %})特別なオファー()を含むメールサインアップフォームのテンプレートを含むアプリ内メッセージエディタ
...
]({% image_buster /assets/img/drag_and_drop/templates/email_capture_field_offer.png %})メールキャプチャ要素をカスタマイズするためのサイドメニューを持つアプリ内メッセージエディタ。()
