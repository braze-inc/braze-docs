...
<tbody>
  <tr>
    ...
    <td>Big and bold! Use when you want to make sure users see your content, such as your most critical campaigns, important notifications, or massive promotions.<br><br>Note that when delivering through the web SDK, portrait and landscape messages won't display on a mobile browser if the orientation of the device doesn't match the orientation of the message.</td>
  </tr>
  <tr>
