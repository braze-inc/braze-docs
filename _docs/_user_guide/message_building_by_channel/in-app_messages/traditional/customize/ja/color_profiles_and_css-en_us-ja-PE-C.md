...
テンプレートを[複製]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/managing_templates/)および[アーカイブ]({{site.baseurl}}/user_guide/engagement_tools/templates_and_media/managing_templates/)することもできます！テンプレートおよびクリエイティブコンテンツの作成と管理の詳細については、「テンプレートとメディア」を参照してください。
