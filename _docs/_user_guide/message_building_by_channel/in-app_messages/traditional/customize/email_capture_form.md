...
- If the known user already has an email address on their profile but it has hard bounced, if the newly entered email address differs to what's already on their Braze profile the hard bounce status will be removed when the updated email address is saved. 
