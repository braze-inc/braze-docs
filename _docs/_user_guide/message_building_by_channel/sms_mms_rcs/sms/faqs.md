...
For a keyword to be recognized within a sentence, (for example, "please stop texting me"), you must use a Liquid statement in the message to recognize the specific word. Event properties have a character limit of 256; otherwise, there is no character limit.
