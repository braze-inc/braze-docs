...
{% alert important %}
User phone numbers are displayed in Braze as a string of digits. If you import a number that contains non-digits (such as `,`, `-`, or `(`) other than the leading {% raw %}`+`{% endraw %}, the non-digits will be removed when rendered in Braze. For example, importing `+1 (724) 123-4567` will show as `+17241234567`.
{% endalert %}
