...
> Contact cards (sometimes known as vCard or Virtual Contact Files (VCF)) are a standardized file format for sending business and contact information that you can import into address books or contact books.

{% alert note %}
Sending a Contact Card is charged as an MMS so ensure you understand your volumes and consumption rates when creating Contact Cards.
{% endalert %}
