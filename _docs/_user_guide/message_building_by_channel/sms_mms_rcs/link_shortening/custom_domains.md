...
After receiving confirmation from your customer success manager, update your DNS settings with the A records provided to you for your custom domain. For example, for `sms.yourbrand.com`, you'd create A records pointing to the IPs. Ensure these are the only A records for the domain. 
