...
Braze will retry webhook sends for up to 24 hours. When retrying, Braze will make five attempts using exponential backoff for a period of approximately 30 minutes before aborting the individual webhook call.
