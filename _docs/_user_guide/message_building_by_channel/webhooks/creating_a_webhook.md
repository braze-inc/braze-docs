...
{% alert important %}
If you change the HTTP request method to GET in the Webhook Composer, the request body form will be hidden, and any previously entered content will be lost.
{% endalert %}
