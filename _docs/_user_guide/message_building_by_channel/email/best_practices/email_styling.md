...
{% alert note %}
Preheader can reference Liquid in the email body, and vice versa. This is because the preheader text is part of the email body when messages are sent to recipients.
{% endalert %}
