...
This method sets up one sending domain, one tracking domain, and one IP for your company. To add additional domains or IPs, consult the Braze Onboarding team (method 1).
