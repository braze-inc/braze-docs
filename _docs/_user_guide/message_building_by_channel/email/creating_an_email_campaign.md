...
![Image that shows the Drag & Drop Editor or HTML editor for your email editing experience.][3]{: style="max-width:75%" }
...
![Image that shows the Email Variants panel for composing your email.][14]{: style="max-width:75%" }
...
![Image that shows the Test Send option and an example email preview.][15]
