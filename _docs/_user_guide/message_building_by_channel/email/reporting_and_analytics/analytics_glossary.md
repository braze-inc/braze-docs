...
glossaries:
  ...
  - name: "Bounces % or Bounce Rate"
    description: The percentage of messages that were hard bounced by the intended recipients. This could occur because the email address is invalid, does not exist, or deactivated.
