...
glossaries:
  ...
  - name: "Machine Opens"
    description: Includes the proportion of “opens” that are affected by Apple's Mail Privacy Protection (MPP) for iOS 15. For example, if a user opens an email using the Mail app on an Apple device, this will be logged as a "Machine Opens". Additionally, if a user This metric is tracked starting November 11, 2021 for Sendgrid and December 2, 2021 for Sparkpost.
    calculation: Count
  - name: "Other Opens"
