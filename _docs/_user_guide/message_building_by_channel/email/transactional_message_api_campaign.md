...
{% alert note %}
Transactional Email is only available as part of select Braze packages. Please reach out to your Braze Customer Success Manager or open a support ticket for more details.
{% endalert %}
