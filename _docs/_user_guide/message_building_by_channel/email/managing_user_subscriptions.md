...
![An example "Subscription Group Timeseries" graph dated from December 2nd through 11th. The graph shows an approximate 10 million increase in the number of users from the 6th to the 7th.][10]
