...
{% alert note %}
The Preference Center has a checkbox that will allow your users to unsubscribe from all emails. Note that you will not be available to save these preferences if sent as a test message.
{% endalert %}
