...
To edit your global style settings, go to **Settings** > **Email Preferences** > **Drag-and-Drop Email Preferences**. After editing the styles in the drag-and-drop email editor, select **Save**. To further customize your email campaigns and Canvases, check out how you can incorporate [drag-and-drop editor blocks][8].

![Email Global Style Settings section in the Drag-And-Drop Email Editor Settings tab.][1]
...
![An example of "Arial" as a fallback font with "Sans-serif" as the font family.][11]
...
![Title Styling settings for a center-aligned main header and secondary header.][9]
...
![Paragraph Styling settings for text with 14pt font.][7]
...
![List Styling settings for a bulleted list.][10]
...
![Button Styling settings for a rectangular button with a blue background.][12]
...
![Email template width set to 600px.][13]
...
![Content Block width set to 600px.][14]
