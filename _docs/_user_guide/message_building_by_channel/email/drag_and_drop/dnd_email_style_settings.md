...
- CORS must be enabled on the server that provides the custom font. This is usually handled by your IT team.
...
2. For the **Font Name** field, enter the same font name as your custom font source file. Ensure that the name is capitalized and spaced correctly. 
