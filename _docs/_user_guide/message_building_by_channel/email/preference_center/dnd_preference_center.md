...
![An example of Liquid for a preference center.][2]
...
![An example of a preference center with the options to subscribe to all messages, marketing, newsletter, and weekly emails, or to unsubscribe from all.][3]{: style="max-width:38%;"} ![][4]{: style="max-width:45%;"}
...
![An example of common style settings for text, buttons, and links.][5]{: style="max-width:45%;"}
...
![An example of a confirmation page to communicate the user's preferences have been updated.][9]{: style="max-width:65%;"}
...
![The Copy Liquid option in the row of a preference center.][10]{: style="max-width:75%;"}
