...
]({% image_buster /assets/img_archive/universal_links_1b.png %})
...
]({% image_buster /assets/img/text_click_tracking_off.png %})テキストリンクのカスタム属性。{: style="max-width:60%;"}()
...
]({% image_buster /assets/img/button_click_tracking_off.png %})ボタンのカスタム属性。{: style="max-width:60%;"}()
