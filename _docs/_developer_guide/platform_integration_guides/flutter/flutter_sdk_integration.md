...
Before following these steps, install and set up the [Flutter SDK][5]. Ensure your machine is running the minimum required Flutter and Dart versions [noted here][7].
