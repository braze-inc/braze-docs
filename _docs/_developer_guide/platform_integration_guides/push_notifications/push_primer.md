...
> **Platform Notice:** This article only applies to iOS. You do not need to request permission to send push notifications to Android users.
...
This guide shows the steps developers must make to integrate Push Priming for iOS.
