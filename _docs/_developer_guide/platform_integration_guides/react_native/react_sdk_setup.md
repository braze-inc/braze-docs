...
{% alert note %}
For an alternative integration method that does not use the native Objective-C and Kotlin layers, you may use the Braze Expo plugin by following the setup instructions [here]({{site.baseurl}}/developer_guide/platform_integration_guides/react_native/expo).
{% endalert %}
