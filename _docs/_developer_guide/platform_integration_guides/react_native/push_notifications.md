...
If you do not have an existing push key or certificate from Apple or want to generate a new one, follow [step 1 of the iOS integration instructions]({{site.baseurl}}/docs/platform_integration_guides/swift/push_notifications/integration/#step-1-configure-push-notifications) to generate a new push key and upload it to the Braze dashboard.
