...
- [Push notifications]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/push_notifications/) successfully integrated in your app
...
As seen in the example, you may also include an image in your push notification. To do this, you must integrate [rich notifications]({{site.baseurl}}/developer_guide/platform_integration_guides/swift/push_notifications/rich/), set the notification style in your campaign to Rich Notification, and include a rich push image.
