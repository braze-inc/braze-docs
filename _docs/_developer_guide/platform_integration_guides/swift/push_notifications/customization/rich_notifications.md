...
Rich notifications are push notifications with images, gifs, and video. To enable this functionality, clients must create a `Service Extension`, a type of extension that enables modification of a push payload before it is displayed.
