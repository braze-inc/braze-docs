...
{% alert important %}
The Swift SDK does not provide animated GIF support out of the box. Support can be added by wrapping a third party or your own view in an instance of GIFViewProvider.
