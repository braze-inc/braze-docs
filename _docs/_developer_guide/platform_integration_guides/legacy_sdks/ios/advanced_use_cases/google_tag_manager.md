...
Before using Google Tag Manager, be sure to first follow our [initial SDK setup]({{site.baseurl}}/developer_guide/platform_integration_guides/ios/initial_sdk_setup/).
