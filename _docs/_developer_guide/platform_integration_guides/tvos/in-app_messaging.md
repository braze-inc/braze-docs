...
1. Create a new iOS app under **Manage Settings** in the Braze dashboard for your tvOS app. Do not choose tvOS from the checkbox list; doing so will prohibit you from leveraging Content Cards or in-app messages.<br>![][1]{: style="width:70%"}<br><br>
