...
To set a custom pinned icon, create a `png` image asset named `icon_pinned` and place it in your `drawable` folders. You will need to place an image in each `drawable` resolution you support, e.g. `drawable-hdpi`.
