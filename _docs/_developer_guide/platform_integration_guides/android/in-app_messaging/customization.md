...
- [`beforeInAppMessageViewOpened`][92] - Called just before the in-app message is added to the actviity's view. The in-app message is not yet visible to the user at this time.
