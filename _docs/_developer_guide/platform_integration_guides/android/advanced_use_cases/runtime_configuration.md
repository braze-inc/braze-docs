...
>[Runtime configuration][1] is an optional way to configure your app at runtime in place of a `braze.xml`. This reference article covers how to set up runtime confiuration.
