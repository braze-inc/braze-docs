...
- Based on our testing, Apple will no longer displaying the provisional authorization dialog and instead setting users' as "authorized". [Learn More](#push-authorization)
