...
|------|--------|---|
|Xcode 12|**Upgrade to iOS SDK v3.27 or above**|Customers using Xcode 12 must use v3.27.0+ for compatibility. If you experience any issues or questions related to our iOS 14 compatibility, open a new [Github Issue][2].|
