...
{% alert note %}
Note that there is a known issue for this integration method on SDK versions `3.24.0` and `3.24.1`. For these versions, please use the dependency-free integration instead.
{% endalert %}
