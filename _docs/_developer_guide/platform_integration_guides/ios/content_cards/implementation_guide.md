...
![An interactive Content Card showing a 50% promotion appear in the botton left corner of the screen. Once clicked, a promotion will be applied to the cart.][6]{: style="border:0;"}{: style="float:right;max-width:45%;border:0;margin-left:15px;"} 
