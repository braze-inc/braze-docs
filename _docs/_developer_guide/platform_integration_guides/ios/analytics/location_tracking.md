...
__Note:__ In order for location tracking to work in iOS 14 for users who give Approximate Location permission, you must update your SDK version to `3.26.1`.
