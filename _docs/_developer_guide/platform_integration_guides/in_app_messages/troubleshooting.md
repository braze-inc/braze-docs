...
This article covers potential troubleshooting topics for your in-app message implementation.

> Unless otherwise noted, the troubleshooting details on this page apply to Android, FireOS, iOS, and Web.
...
### Impressions or Click Analytics Aren't Being Logged
...
![Session Start][troubleshooting_iams_10]{: style="max-width:75%;"}
...
| Issue | Troubleshoot |
| --- | --- |
| Your segment does not contain your user. | Check your user's [Engagement tab][troubleshooting_iams_6] to see if the correct segment appears under Segments. |
| Your user has previously received the in-app message and was not re-eligible to receive it again. | Check the [campaign re-eligibility settings][troubleshooting_iams_7] under the Delivery tab of the Campaign Composer and make sure the re-eligibility settings align with your testing setup. |
| Your user hit the frequency cap for the campaign. | Check the campaign [frequency cap settings][troubleshooting_iams_8] and make sure they align with your testing setup. |
...
- Triggered in-app messages are rate-limited based on the [minimum time interval between triggers](#minimum-time-interval-between-triggers), which defaults to 30 seconds.
