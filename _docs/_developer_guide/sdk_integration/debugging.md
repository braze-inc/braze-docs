...
To use the Braze SDK debugger, you'll need `View PII` and `View User Profiles PII Compliant` permissions. To download your debugging session logs, you'll also need `Export User Data` permissions. Additionally, your Braze SDK needs to meet or point to the following minimum versions: 
