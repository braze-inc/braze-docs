...
#### Step 2.2: Set the current user's JWT token
...
Supply the JWT Token when calling [`changeUser`](https://braze-inc.github.io/braze-android-sdk/kdoc/braze-android-sdk/com.braze/-i-braze/change-user.html):
