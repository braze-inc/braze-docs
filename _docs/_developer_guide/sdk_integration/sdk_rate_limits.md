...
- **Fair usage**: Limits are adapted to ensure fair resource allocation across all customers
...
If you find yourself running into rate limit issues, we encourage mindful consideration of when, how, and how frequently you employ the Braze SDK. Consider whether your integration patterns are designed to provide value to your users and analytics, rather than simply maximizing data collection.
...
4. **Use case value**: Are your SDK calls providing value to your users and analytics?
