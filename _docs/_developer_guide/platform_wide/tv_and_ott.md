...
Push notifications are not supported natively on Android TV. For more information why, see Google's [Design Guidelines][5]. You may however, __do a manual integration of push notification UI to achieve this__. See our [Android TV push][6] documentation for guidance on how to set this up.
