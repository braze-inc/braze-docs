...
{% alert important %}
Platforms that support in-app messages or Content Cards through headless UI **do not** include any default UI or views. You need to build your own custom UI (such as in-app message UIs) and then use the SDK-provided data models to populate those UIs.
{% endalert %}
