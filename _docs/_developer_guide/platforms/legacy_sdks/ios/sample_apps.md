...
Several test applications are available within the [iOS SDK GitHub repository](https://github.com/appboy/appboy-ios-sdk "Appboy iOS GitHub Repository"). Follow these instructions to build and run our test applications.
