...
If you are looking for a complete list of supported languages you may attribute to your users in their profiles, see our [user language list]({{site.baseurl}}/user_guide/data/unification/user_data/language_codes/).
