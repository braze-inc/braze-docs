...
{% alert warning %}
Make sure to update the URL to match the [API SDK endpoint]({{site.baseurl}}/user_guide/administrative/access_braze/sdk_endpoints/) for your chosen `baseUrl` initialization option.
{% endalert %}
|URL|Information|
|---|-----------|
