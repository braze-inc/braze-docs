...
Braze is a customer engagement platform. Braze helps you listen to your users, understand their actions and behaviors, and then act on them. The Braze platform has three primary components: the SDK, the dashboard, and the REST API.
