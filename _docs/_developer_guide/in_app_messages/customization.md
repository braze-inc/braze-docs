...
> Learn how to customize in-app messages for the Braze SDK. For advanced styling techniques, refer to our [Tutorial: Customizing message styling using key-value pairs]({{site.baseurl}}/developer_guide/in_app_messages/tutorials/customizing_message_styling).
