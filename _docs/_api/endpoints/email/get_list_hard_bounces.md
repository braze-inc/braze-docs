...
{% alert important %}
Looking for the `api_key` parameter? As of April 2020, Braze is changing how we read API keys to be more secure. Now API keys must be passed through the REST Authorization Header. Please see Sample Response below for an example, 
{% endalert %}
