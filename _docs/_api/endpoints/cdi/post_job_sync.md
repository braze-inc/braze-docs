...
You can find your `integration_id` by going to **Data Settings** > **Cloud Data Ingestion** and selecting your sync. The `integration_id` appears in the URL of the sync details page. For example, in the URL `https://dashboard-01.braze.com/integrations/cloud_data_ingestion/00000000-0000-0000-0000-000000000000`, the `integration_id` is `00000000-0000-0000-0000-000000000000`.
## Example request
