...
|---|---|---|---|
| `integration_id` | Required | String | Integration ID. See [Find your integration ID](#find-integration-id) for details. |
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 role="presentation" }

### Find your integration ID {#find-integration-id}
