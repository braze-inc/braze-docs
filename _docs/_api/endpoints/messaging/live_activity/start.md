...
```json
{
   ...
   "activity_attributes": "(required, string) The initial content state for the activity type (i.e. the sports team names which don't change)",
...
## Request parameters (todo: update to match above)
