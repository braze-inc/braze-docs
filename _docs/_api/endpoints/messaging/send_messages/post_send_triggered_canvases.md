...
|`context`| Optional | Object | This includes Canvas entry properties. Personalization key-value pairs apply to all users in this request. The context object has a maximum size limit of 50 KB. |
