...
| `The campaign is archived. Unarchive the campaign in order for trigger requests will take effect.` | The campaign ID provided corresponds to an archived campaign. |
