...
{% alert important %}
This endpoint is currently in **limited beta** . Although we're not adding new customers to the beta right now, let your Braze account manager if you think this feature could be useful for your Braze integration.
{% endalert %}
