...
{% alert note %}
Braze processes the data passed through API at face value, and customers should only pass deltas (changing data) to minimize unnecessary data point logging. To learn more, refer to [Data points]({{site.baseurl}}/user_guide/data/data_points/). 
{% endalert %}
