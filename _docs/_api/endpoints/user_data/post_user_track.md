...
Current limits based on expected ingestion can be found in the dashboard under Settings > APIs and Identifiers > API limits. We may modify rate limits to protect system stability or allow for increased data throughput on your account. Please contact Braze Technical Support or your CSM for questions or concerns regarding hourly or per-second request limit and the needs of your business.
