...
```json
{
   ...
   "emails_to_identify": (optional, array of string) User emails for the users to identify,
   "phone_numbers_to_identify": (optional, array of string) User phone numbers for the users to identify,
