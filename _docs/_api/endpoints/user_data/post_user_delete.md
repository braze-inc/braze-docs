...
{% alert warning %}
Deleting user profiles cannot be undone. It will permanently remove users which may cause discrepancies in your data. Learn more about what happens when you [delete a user profile using API]({{site.baseurl}}/help/help_articles/api/delete_user/) in our Help documentation.
{% endalert %}
