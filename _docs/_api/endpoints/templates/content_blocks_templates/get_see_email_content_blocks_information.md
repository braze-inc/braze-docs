...
| Include Inclusion Data—error | Check that `include_inclusion_data` is not blank. This must be set to either `true` or `false`. See [request parameters](#request-parameters) for details. |
