...
endpoint: users by identifier
endpoint_url: /users/export/ids
method: post
description: use to export data from any user profile by specifying a form of the user identifier.
response_details:
...
query_example: https://rest.iad-01.braze.com/users/export/ids?api_key=123a45b6-cd78-9e01-g234-hi56j7k8l9m0&external_id=user123
...
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/User%20export%20%20user%20ids%20example
errors:
glossary_tags: export, user_data, post_method
...
endpoint: users by segment
endpoint_url: /users/export/segment
method: post
description: use to export all the users within a segment.
response_details:
...
query_example: https://rest.iad-01.braze.com/users/export/segment?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&segment_id=485938a-4db8-4057-8b7e-483032820
...
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/User%20export%20%20segment%20id%20example
errors: AccessDenied
glossary_tags: email, export, user_data, post_method
...
endpoint: segment export
endpoint_url: /segments/list
method: get
description: use to export a list of segments.

parameters:
    api_key: (required, string) App Group REST API Key,
    page: (integer) the page of segments to return, defaults to 0 (returns the first set of up to 100)
    sort_direction: (string) Pass in the value `desc` to sort by creation time from newest to oldest. Pass in `asc` to sort from oldest to newest. If `sort_direction` is not included, the default order is oldest to newest.

request_body_example: https://rest.iad-01.braze.com/segments/list?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&page=1
...
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Segment%20export%20%20list%20example
errors:
glossary_tags: email, export, get_method
...
endpoint: segment analytics
endpoint_url: /segments/data_series
method: get
description: use to retrieve a daily series of the size of a segment over time for a segment with analytics tracking enabled.
...
parameters:
    ...
    ending_at: (datetime) point in time when the data series should end - defaults to time of the request

request_body_example: https://rest.iad-01.braze.com/segments/data_series?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&segment_id=3bbc4555-8fa0-4c9b-a5c0-4505edf3e064&length=7&ending_at=2014-12-10T23:59:59-05:00
...
endpoint: segment details
endpoint_url: /segments/details
method: get
description: to retrieve relevant information on the segment, which can be identified by the `segment_id`.

parameters:
    api_key: (required, string) app Group REST API Key,
    segment_id: (required, string) segment API Identifier

request_body_example: https://rest.iad-01.braze.com/segments/details?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&segment_id=3bbc4555-8fa0-4c9b-a5c0-4505edf3e064
...
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Segment%20export%20%20details%20example
errors:
glossary_tags: email, export, get_method
...
endpoint_url: /campaigns/list
method: get
description: use to export a list of campaigns.

parameters:
    api_key: (required, string) app Group REST API Key,
    page: (integer) the page of campaigns to return (defaults to 0 and returns the first set of up to 100),
    include_archived: (boolean) whether or not to include archived campaigns (defaults to false),
    sort_direction: (string) Pass in the value `desc` to sort by creation time from newest to oldest. Pass in `asc` to sort from oldest to newest. If sort_direction is not included, the default order is oldest to newest.

request_body_example: https://rest.iad-01.braze.com/campaigns/list?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&page=1&include_archived=true
...
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Campaign%20export%20%20list%20example
errors: AccessDenied
glossary_tags: email, export, get_method
...
endpoint_url: /campaigns/data_series
method: get
description: use to retrieve a daily series of various stats for a campaign over time.

parameters:
    api_key: (required, string) app Group REST API Key,
    segment_id: (required, string) segment API Identifier

request_body_example: https://rest.iad-01.braze.com/campaigns/data_series?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&campaign_id=3bbc4555-8fa0-4c9b-a5c0-4505edf3e064&length=7&ending_at=2014-12-10T23:59:59-05:00
...
```
GET https://YOUR_REST_API_URL/sends/data_series //?? endpoint not in swagger..old??

endpoint: send analytics
endpoint_url:
method:
description:
parameters:
...
endpoint_url: /campaigns/details
method: get
description: use to retrieve relevant information on the campaign, which can be identified by the `campaign_id`.

parameters:
    api_key: (required, string) app Group REST API Key,
    campaign_id: (required, string) campaign API Identifier

request_body_example: https://rest.iad-01.braze.com/campaigns/details?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&campaign_id=3bbc4555-8fa0-4c9b-a5c0-4505edf3e064

response_body_parameters:
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Campaign%20export%20%20details%20example
errors:
glossary_tags: email, export, get_method
...
endpoint_url: /canvas/list
method: get
description: use to export a list of Canvases, including the name, Canvas API Identifier and associated Tags.

parameters:
    api_key: (required, string) app Group REST API Key,
    page: (integer) the page of Canvases to return (defaults to 0 and returns the first set of up to 100),
    include_archived: (boolean) whether or not to include archived Canvases, defaults to false,
    sort_direction: (string) Pass in the value `desc` to sort by creation time from newest to oldest. Pass in `asc` to sort from oldest to newest. If sort_direction is not included, the default order is oldest to newest.

request_body_example: https://rest.iad-01.braze.com/canvas/list?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&page=1&sort_direction=desc
...
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Canvas%20export%20%20list%20example
errors:
glossary_tags: email, export, get_method
...
endpoint_url: /canvas/details
method: get
description: use to export metadata about a Canvas

parameters:
    api_key: (required, string) App Group REST API Key
    canvas_id: (required, string) Canvas API Identifier

request_body_example: https://rest.iad-01.braze.com/canvas/details?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&canvas_id=284942a-4db7-3057-1b7e-4dn348923

response_body_parameters:
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Canvas%20export%20%20details%20example
errors:
glossary_tags: email, export, get_method
...
## Canvas Details API Response Parameters
```json
{
  "created_at": (string) date created as ISO 8601 date,
...
endpoint: canvas data series
endpoint_url: /canvas/data_series
method: get
description: use to export time series data for a Canvas.

parameters:
    api_key: (required, string) App Group REST API Key
    canvas_id: (required, string) Canvas API Identifier

request_body_example: https://rest.iad-01.braze.com/canvas/data_series?canvas_id=canvas%20identifier&ending_at=2018-06-28T23%3A59%3A59-5%3A00&length=10&include_variant_breakdown=true&include_step_breakdown=true&include_deleted_step_data=true

response_body_parameters: 
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Canvas%20export%20%20data%20series%20example
errors:
glossary_tags: email, export, get_method
...
endpoint: canvas data summary
endpoint_url: /canvas/data_summary
method: get
description: use to export rollups of time series data for a Canvas, providing a concise summary
of a Canvas' results.

parameters:
    api_key: (required, string) App Group REST API Key,
    canvas_id: (required, string) Canvas API Identifier,
    ending_at: (datetime) date on which the data export should end (defaults to time of the request),
    starting_at: (datetime) date on which the data export should begin (either length or starting_at required),
    length: (integer) max number of days before ending_at to include in the returned series (must be between 1 and 14 inclusive - either length or starting_at required),
    include_variant_breakdown: (boolean) whether or not to include variant stats (defaults to false),
    include_step_breakdown: (boolean) whether or not to include step stats (defaults to false),
    include_deleted_step_data: (boolean) whether or not to include step stats for deleted steps (defaults to false)

request_body_example: https://rest.iad-01.braze.com/canvas/data_summary?canvas_id=canvas%20identifier&ending_at=2018-06-28T23%3A59%3A59-5%3A00&length=5&include_variant_breakdown=true&include_step_breakdown=true&include_deleted_step_data=true

response_body_parameters:
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Canvas%20export%20%20data%20summary%20example
errors:
glossary_tags: email, export, get_method
...
```yaml
GET https://YOUR_REST_API_URL/feed/list //??endpoint not in swagger..old?

endpoint: news feed list
endpoint_url: /feed/list
method: get
description: use to export a list of News Feed cards, each of which will include it's name and Card API Identifier.

parameters:

request_body_example: https://rest.iad-01.braze.com/feed/list?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&page=1&include_archived=true
...
```yaml
GET https://YOUR_REST_API_URL/feed/data_series //??endpoint not in swagger..old?
...
```yaml 
GET https://YOUR_REST_API_URL/feed/details //??endpoint not in swagger..old?
...
endpoint: monthly active users
endpoint_url: /kpi/mau/data_series
method: get
description: use to retrieve a daily series of the total number of unique active users over a 30 day rolling window.

parameters:
    api_key: (required, string) App Group REST API Key,
    length: (integer) max number of days before ending_at to include in the returned series (must be between 1 and 100 inclusive),
    ending_at: (datetime) point in time when the data series should end (defaults to time of the request),
    app_id: (string) app API Identifier (if excluded results for all apps in app group will be returned)

request_body_example: https://rest.iad-01.braze.com/kpi/mau/data_series?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&length=7&ending_at=2014-12-10T23:59:59-05:00
...
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Kpi%20export%20%20mau%20example
errors:
...
endpoint_url: /kpi/dau/data_series
method: get
description: use to retrieve a daily series of the total number of unique active users on each date.

parameters:

request_body_example: https://rest.iad-01.braze.com/kpi/dau/data_series?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&length=7&ending_at=2014-12-10T23:59:59-05:00
...
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Kpi%20export%20%20dau%20example
errors:
glossary_tags: email, get_method
...
endpoint: new users
endpoint_url: /kpi/new_users/data_series
method: get
description: use to retrieve a daily series of the total number of new users on each date.

parameters:

request_body_example: https://rest.iad-01.braze.com/kpi/new_users/data_series?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&length=7&ending_at=2014-12-10T23:59:59-05:00
...
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Kpi%20export%20%20new%20users%20example
errors:
glossary_tags: email, get_method
...
endpoint: uninstalls
endpoint_url: /kpi/uninstalls/data_series
method: get
description: use to retrieve a daily series of the total number of uninstalls on each date.

parameters:
    api_key: (string) App Group REST API Key,
    length: (integer) max number of days before ending_at to include in the returned series (must be between 1 and 100 inclusive),
    ending_at: (datetime) point in time when the data series should end (defaults to time of the request),
    app_id: (string) app API Identifier (if excluded, results for all apps in app group will be returned)

request_body_example: https://rest.iad-01.braze.com/kpi/uninstalls/data_series?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&length=7&ending_at=2014-12-10T23:59:59-05:00

response_body_parameters:
    message: (required, string) the status of the export returns 'success' when completed without errors,
    data:
        time: (string) date as ISO 8601 date,
        uninstalls: (int) app API Identifier; if excluded, results for all apps in app group will be returned
...
endpoint: sessions series
endpoint_url: /sessions/data_series
method: get
description: use to retrieve a series of the number of sessions for your app over a designated time period.

parameters:
    api_key: (string) App Group REST API Key,
    length: (integer) max number of days before ending_at to include in the returned series (must be between 1 and 100 inclusive),
    unit: (string) unit of time between data points - can be 'day' or 'hour' (defaults to 'day'),
    ending_at: (datetime) point in time when the data series should end (defaults to time of the request),
    app_id: (string) App API Identifier retrieved from the Developer Console to limit analytics to a specific app,
    segment_id: (string) Segment API Identifier indicating the analytics enabled segment for which sessions should be returned
...
link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Session%20analytics%20export%20%20session%20series%20example
...
endpoint: custom events list
endpoint_url: /events/list
method: get
description: to export a list of custom events that have been recorded for your app. The event names are returned in groups of 250, sorted alphabetically.

parameters:
    api_key: (required, string) App Group REST API Key,
    page: (integer) the page of event names to return, defaults to 0 (returns the first set of up to 250)

request_body_example: https://rest.iad-01.braze.com/events/list?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&page=1
response_body_parameters:
    message: (required, string) the status of the export returns 'success' when completed without errors,
    events: event array

link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Custom%20events%20analytics%20export%20%20list%20example
...
endpoint: custom events list
endpoint_url: /events/data_series
method: get
description: use to retrieve a series of the number of occurrences of a custom event in your app over a designated time period.

parameters:
    api_key: (required, string) App Group REST API Key,
    event: (required, string) the name of the custom event for which to return analytics,
    length: (integer) max number of units (days or hours) before ending_at to include in the returned series (must be between 1 and 100 inclusive) unit of time between data points (can be 'day' or 'hour'; defaults to 'day'),
    unit: (string) unit of time between data points (can be 'day' or 'hour'; defaults to 'day'),
    ending_at: (datetime) point in time when the data series should end (defaults to time of the request),
    app_id: (string) App API Identifier retrieved from the Developer Console to limit analytics to a specific app,
    segment_id: (string)

request_body_example: https://rest.iad-01.braze.com/events/data_series?api_key=75480f9a-4db8-4057-8b7e-4d59bfd73709&event=Event%20A&length=24&unit=hour&ending_at=2014-12-10T23:59:59-05:00&app_id=3bbc4555-8fa0-4c9b-a5c0-4505edf3e064

response_body_parameters:
    message: (required, string) the status of the export returns 'success' when completed without errors,
    data:
        time: (string) point in time - as ISO 8601 extended when unit is 'hour' and as ISO 8601 date when unit is 'day',
        count: (int) Segment API Identifier indicating the analytics enabled segment for which event analytics should be returned

link_to_swagger: https://www.braze.com/docs/api/interactive/#/operations/Export/Custom%20events%20analytics%20export%20%20series%20example
