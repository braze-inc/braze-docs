...
> Use this endpoint to view all the default translation sources for a campaign's translation tags. These are the values with the `{% translation id %} source {% endtranslation %}`
