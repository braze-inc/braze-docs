...
> Use this endpoint to update multiple translations for a campaign. [Learn more]({{ site.baseurl }}/user_guide/engagement_tools/messaging_fundamentals/localization/locales/) about translations feature.
