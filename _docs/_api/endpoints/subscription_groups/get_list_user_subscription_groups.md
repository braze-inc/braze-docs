...
> Use this endpoint to list and get the subscription groups with history of a certain user.
...
Only subscription groups that have had a subscription status update in a user's history will be included in a succesful response. This means that newly created subscription groups, for example, will not be listed.
