...
| `custom_attributes_to_export` | Optional | Array of strings | Name of specific custom attribute. Attribute names are located by navigating to **Manage Settings** > **Custom Attributes**. |
