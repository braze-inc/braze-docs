...
This endpoint allows you to retrieve a daily series of the size of a segment over time for a segment. Please note that these segment sizes are estimates.
