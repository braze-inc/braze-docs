...
- **The campaign or Canvas** being triggered (the `campaign_id` or `canvas_id` in your API request)
- **The audience** being targeted (the Segments/Filters, or for API campaigns, the `segment_id` in your API request)
- **The Connected Audience** filters (the `audience` object in the API request, if specified)
