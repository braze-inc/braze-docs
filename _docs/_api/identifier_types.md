...
A Card API Identifier or Card ID is a key generated by Braze for a given News Feed Card within the Dashboard. Card IDs are unique to each <a href="https://www.braze.com/docs/user_guide/engagement_tools/news_feed/">News Feed</a> Card and can be used to reference Cards through the API. 
