...
| country | (string) We require that country codes be passed to Braze in the [ISO-3166-1 alpha-2 standard][17]. Our API will make a best effort to map countries recieved in different formats. "Australia" to "AU" for example. If we are unable to match the input to a given [ISO-3166-1 alpha-2 standard][17] the country value will be set to NULL |
