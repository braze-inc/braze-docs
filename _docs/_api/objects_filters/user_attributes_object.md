...
| Floats | Float custom attributes are numbers with a decimal point. For example, you can use floats to store user ratings for products or services. |
...
| Strings | String custom attributes are sequences of characters used to store text data. For example, you can use strings to store user names, email addresses, or preferences. |
