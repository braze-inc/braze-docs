...
|---|---|
|Requests to the `/users/track` endpoint|Default of 50,000 API requests per minute for Dashboard companies created after June 2, 2020 and default of Unlimited API requests for Dashboard companies created before then. Though this is subject to change as noted below. |
