...
guide_top_text: "The following help articles provide troubleshoooting information for common issues with in-app messages. <br><br> For more information on customization and use cases, check out the articles in the <a href='/docs/api/basics/'>In-App Messages</a> section!"
