...
To change the data type of a custom attribute or event, from the Braze Dashboard, navigate to __Manage App Group__ and select the either the __Custom Attributes__ or __Custom Events__ Tab. 
