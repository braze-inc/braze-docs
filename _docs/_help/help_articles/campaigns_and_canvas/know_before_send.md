...
- **Triggering**: By default, in-app messages are triggered by events logged by the SDK. If you want to trigger in-app messages by server-sent events, you can also achieve this through these guides for [iOS]({{site.baseurl}}/developer_guide/platforms/swift/in_app_messages/customization/message_triggers/) and [Android]({{site.baseurl}}/developer_guide/platforms/android/in_app_messages/customization/).
