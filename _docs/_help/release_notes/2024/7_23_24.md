---
nav_title: July 23, 2024 release
description: "This article contains release notes for July 23, 2024 release."
page_order: 5
page_type: reference
---
...
### New PR template for Braze Docs
...
Braze removes personally identifiable information (PII) from all events data that is older than two years old. If you use Snowflake data sharing, you may choose to retain the full events data in your environment by storing a copy in your Snowflake account before the retention policy is applied. To learn more, see [Snowflake data retention]({{site.baseurl}}/partners/data_and_infrastructure_agility/data_warehouses/snowflake/data_retention/).

<!-- Josh: This one hasn't been reviewed and merged yet, so you may need to delete this H3 section if it's not merged in time. Thanks! --> 
### LiveRamp
 
Learn how to connect LiveRamp, Snowflake, and Braze, so you can create highly personalized and relevant marketing campaigns by reducing the time to insights, breaking down data silos, and optimizing customer engagement. To learn more, see [Connecting LiveRamp, Snowflake, and Braze]({{site.baseurl}}/partners/data_and_infrastructure_agility/advertising/liveramp).
 
## SDK updates
 
The following SDK updates have been released. Breaking updates are listed below; all other updates can be found by checking the corresponding SDK changelogs.
 
- [Braze Web SDK](https://github.com/braze-inc/braze-web-sdk/blob/master/CHANGELOG.md)
