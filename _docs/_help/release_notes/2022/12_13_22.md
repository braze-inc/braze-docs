...
The [Shopify integration]({{site.baseurl}}/partners/message_orchestration/channel_extensions/ecommerce/shopify/shopify_overview/) now allows you to collect email and SMS opt-ins from your Shopify store and assign them to a subscription group in Braze.
