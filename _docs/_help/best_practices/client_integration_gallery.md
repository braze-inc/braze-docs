...
glossaries:
  - name: "Use an Engaging Email to Share New Product Features with Your Users!"
    image: assets/img/iHeart_Trials+NPP_Email.png
  ...
  - name: "Share Trends with Your Users in an Email!"
    ...
    image: assets/img/SoundCloud Go_Product Rec_Email.png
    tags:
      - Media & Entertainment
  - name: "Learn About Your Users With an In-App Message!"
    ...
    image: assets/img/iHeart_Priming_IAM.png
    tags:
      - Media & Entertainment
  - name: "Verify Info through Email!"
    image: assets/img/Ibotta_Onboarding+Confirmation_Email.PNG
 ...
 - name: "Increase Engagement with Push Action Buttons"
    image: assets/img/Ibotta_Voucher+Refer_Push_Action Buttons.png
    description: "<a href='https://home.ibotta.com/'>Ibotta</a> <br> <br> This rich push notification offers users the chance to refer their friends. It has [push action buttons]({{site.baseurl}}/user_guide/message_building_by_channel/push/push_action_buttons/) so they can use a social media account or email to make the referral in a single click. It also includes a colorful image and text that entices users to make referrals. The icon to close is an example of a best-practice! Users can easily close the message whenever they want."
    tags:
      - Retail & eCommerce Industry
      - Financial Services & Insurance
 - name: "Send Important Information Instantly"
    image: assets/img/Clarity_Alerts_Push.png
...
- name: "Send Real-Time Order Updates with a Push Notification!"
    image: assets/img/Deliveroo_Delivery Update_Push_Coming Home.png
...
- name: "Send Real-Time Updates and Offers with Push Notifications!"
    image: assets/img/Deliveroo_Delivery Updates+VoucherPush.png
...
- name: "Use Email to Share Cool New Product Features!"
    image: assets/img/Venmo_PCM+NPP_Email.png
...
- name: "Use Push Notification to Engage Users With Partnership Collaborations!"
    image: assets/img/Lyft_PCM+Alerts_Push.png
...
- name: "Bring Lapsing Users Back with a Targeted Push Notification!"
    image: assets/img/Viber_Alerts+Voucher_Viber_Push.jpg
...
- name: "Use Weather Data to Send Personalized Push Messages!"
    image: assets/img/MyTaxi_Alerts_Push.jpg
...
- name: "Bring Users Back with a Personalized Push!"
    image: assets/img/Hinge _Alerts_Push.png
...
- name: "Multi-Channel Onboarding Campaigns Nurture the User From the Get-Go!"
    image: assets/img/mytaxi_Priming_IAM+EMAIL.png
...
- name: "Keep Users Informed with In-App Messages!"
    image: assets/img/Gett_Customer Survey_IAM.jpg
...
- name: "Show Users You Care With Milestone Emails!"
    image: assets/img/Lyft_Milestone_Email.png
...
- name: "Use Weather Data to Send Personalized Emails!"
    image: assets/img/GrubHub_Alerts_Email.PNG
...
- name: "Solicit Feedback to Improve Your Product in an Email!"
    image: assets/img/Lyft_Customer Survey_Email.png
...
- name: "Use a Web Push to Show Off a New Product!"
    image: assets/img/B_H_NPP_Web Push.png
...
- name: "Drive Traffic with an In-Browser Message"
    image: assets/img/UO_Alerts_Web IBM.png
...
- name: "Have an Alert? Use a Web IBM!"
    image: assets/img/Westwing_Alerts_Web IBM.png
...
- name: "Simplicity is key! Reach your customer through a web IBM!"
    image: assets/img/UO_IBM_Mobile Web.jpg
...
- name: "Send Users a Promo Through an IBM!"
    image: assets/img/iHeart IBM Promotional.png
    description: "<a href='https://www.iheart.com/'>iHeartRadio</a> <br> <br> This in-browser message for a desktop site offers users a special discount. It clearly shows the special price and has a button so readers can claim it. This message is also great because it includes details about how the price will change after the promotion ends – a good practice for keeping customers informed. This message also an X that makes it easier for a reader to dismiss the message and continue browsing."
    tags:
      - Media & Entertainment
- name: "Newsfeed is a Great Place to Host Promotions!"
    image: assets/img/Domino_s_Voucher_Newsfeed_Coupon.png
...
- name: "Use Newsfeed to Showcase Products for Sale!"
    image: assets/img/Souq_Newsfeed_Beauty Week.jpg
...
- name: "Test Different Colors and Features for Increased Engagement!"
    image: assets/img/Ibotta Onboarding+Voucher Email Green.png
...
- name: "Nurture a Relationship with Your Users from the Beginning with an IAM!"
    image: assets/img/Ibotta_Onboarding+NUT_IAM.PNG
    description: "<a href='https://home.ibotta.com/'>Ibotta</a> <br> <br> In-app messages contribute to your brand voice. This modal in-app message starts things off right with new users by welcoming them to the app. It includes a graphic with the brand's logo, uses their core colors, and has a tone that's friendly and helpful. The call-to-action button makes it clear what a user should do next, even though they've never used the app before. It also includes an X so users who may already be familiar with the app can skip the tutorial."
    tags:
      - Retail & eCommerce Industry
      - Financial Services & Insurance
- name: "Increase Referral Program Awareness with In-App Messages!"
    image: assets/img/Gett_Voucher+Refer_IAM.jpg
    description: "<a href='https://gett.com/uk/'>Gett</a> <br> <br> A great time to ask users for a referral is when they're already using your app, so in-app messages are ideal for raising awareness about referral programs or bonuses. This full-screen message includes a large friendly graphic, a details about what the user could earn, and a clear call-to-action button. It also has the X so users can dismiss the notification if they're not interested."
    tags:
      - Delivery & Transportation
- name: "Engage Users with a Coupon in a Push Notification!"
    image: assets/img/Namshi_Onboarding+Voucher_Push.jpeg
    description: "<a href='https://www.namshi.com/'>Namshi</a> <br> <br> This simple push notification uses a discount code to encourage new users to engage with the brand. Messages like this can be triggered with an action or through an [API request] (https://www.braze.com/docs/user_guide/message_building_by_channel/push/creating_a_push_message/#android-notification-options), so the timing is always right."
    tags:
      - Retail & eCommerce Industry
- name: "Add Personalization to a Welcome Email to Establish a Connection with your User!"
    image: assets/img/Wag!_Voucher+Onboarding_Email.png
...
- name: "Add Personalization to a Push to Drive Reengagement"
    image: assets/img/1800-Flowers_Alerts_Push.jpg
...
- name: "Capture Lapsing Users With a Promotional Email!"
    image: assets/img/iHeart_Voucher+Paywall_Email.png
...
- name: "Connect with Lapsed Users with Push Notifications"
    image: assets/img/UO_Alerts_Push_Personalized.jpg
...
- name: "Engage Your Users Through a Fun Push Notification with Emojis!"
    image: assets/img/Soulcycle_Push_Emoji Testing.jpg
...
- name: "Send Personalized Recommendation Push Notifications to Grab Your User's Attention!"
    image: assets/img/Yelp_ProductRec_Push_GF.png
...
- name: "Adding Simple Personalized Touches Can Make all the Difference in Your Marketing!"
    image: assets/img/Ibotta_Voucher_Push_$10 Bonus.PNG
...
- name: "Include a Fun Image in a Rich Push Notification to Share a Promotion!"
    image: assets/img/Shutterfly_Rich Push_Promotional.jpeg
...
- name: "Rich Push Notifications Are a Great Way to Capture Your User's Attention!"
    image: assets/img/1-800-Flowers.com_Rich Push_Lemonade.jpg
...
- name: "Take Your Messaging Game to the Next Level by Adding a Promotional Rich Push!"
    image: assets/img/Domino_s_Android Push_Rich Notification.png
...
- name: "Utilize Push Action Buttons to Allow Users to Choose their Notification Settings!"
    image: assets/img/Ibotta_Priming_Push.png
