...
Replace `NUM` with the corresponding column number, up to a maximum of 4 columns. If you have less than 4 columns, remove any extra `.reset-td-br-NUM` placeholders.
