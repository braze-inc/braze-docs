...
<sup>*The [Creating a Content Card]({{site.baseurl}}/user_guide/channels/content_cards/create_a_content_card/) page uses the [how-to guide]({{site.baseurl}}/contributing/content_types/#how-to-guides) and [reference]({{site.baseurl}}/contributing/content_types/#references) templates.*</sup>
