...
You can now specify a recipient by email address to trigger your [campaigns]({{site.baseurl}}/user_guide/messaging/messaging_fundamentals/target_users/) and [Canvases]({{site.baseurl}}/user_guide/messaging/canvas/create_a_canvas/create_a_canvas/?tab=target%20audience#step-2c-set-your-target-entry-audience).
