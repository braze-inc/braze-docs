...
We added [steps on how to obtain a SAML trace]({{site.baseurl}}/user_guide/administer/global/saml__single_sign_on/saml_sso_setup#obtaining-a-saml-trace), which helps you resolve issues about SAML SSO with Support more efficiently.
