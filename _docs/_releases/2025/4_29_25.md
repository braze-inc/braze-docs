...
[Troubleshooting Braze Access]({{site.baseurl}}/user_guide/administer/personal/troubleshooting/) helps you navigate issues you may have when trying to access Braze, such as getting locked out of your account or working with a Braze dashboard that won’t perform as expected.
