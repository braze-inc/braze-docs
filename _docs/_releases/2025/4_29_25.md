...
[Troubleshooting Braze Access]({{site.baseurl}}/user_guide/administer/personal/accessing_your_account/) helps you navigate issues you may have when trying to access Braze, such as getting locked out of your account or working with a Braze dashboard that won’t perform as expected.

## Data flexibility

### Currents frequently asked questions

You can find answers to some frequently asked questions about Currents on the new [Frequently asked questions]({{site.baseurl}}/user_guide/data/distribution/braze_currents/faq/) page.

### Anonymous users

The “How it works” and “Assigning user aliases” sections in [Anonymous users]({{site.baseurl}}/user_guide/data/unification/user_data/user_profile_lifecycle/anonymous_users/) have new details about how anonymous users work and why you might want to assign them user aliases.
...
Braze has launched two new [data centers]({{site.baseurl}}/user_guide/data/infrastructure/data_centers/): US-10 and ID-01. You can sign up for region-specific data centers when setting up your Braze account. 
...
Braze Canvas offers several [pre-built templates]({{site.baseurl}}/user_guide/messaging/canvas/ideas_and_strategies/ecommerce_use_cases/) tailored specifically for eCommerce marketers, making it easier to implement essential strategies. This page offers some key templates you can use to enhance your customer journeys.
