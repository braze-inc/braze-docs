...
Service Provider (SP) initiated login now has a [troubleshooting section]({{site.baseurl}}/user_guide/administer/global/saml__single_sign_on/saml_sso_setup/#troubleshooting) to help you work through issues with SAML and single-sign on issues.
