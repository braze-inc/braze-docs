...
The Canvas UI will be simplified to prevent missed tasks and resulting errors. Canvas configurations, specifically, will now be displayed in a wizard, similar to the design of the **Campaigns** wizard. For more information, check out the steps on [creating a Canvas]({{site.baseurl}}/user_guide/messaging/canvas/create_a_canvas/)!
