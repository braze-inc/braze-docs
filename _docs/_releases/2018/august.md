...
## S3 and Azure data events from anonymous users
 ...
 Customers exporting data to Amazon S3 and Microsoft Azure can now include events from anonymous users. This functionality will default to on for all newly created integrations, but will remain off for all existing integrations. If you have any questions, contact your account manager or open a [support ticket]({{site.baseurl}}/braze_support/).
