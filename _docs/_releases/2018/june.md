...
Administrators can now determine the minimum number of new, unique passwords other company users in their company must use before they can reuse a previous password. This can be controlled from the [Authentication Rules]({{site.baseurl}}/user_guide/onboarding/platform_administrative_features/#authentication-rules) panel in the **Company Settings** in the **Security Settings** tab.
