...
Create [Canvas templates]({{site.baseurl}}/user_guide/messaging/templates/canvas_templates/) to refine your messaging by creating a consistent framework that can be easily customized to fit your specific goals across your Canvases.

### Landing pages

{% multi_lang_include release_type.md release="Beta" %}

Braze [landing pages]({{site.baseurl}}/user_guide/messaging/landing_pages/) are standalone webpages that can drive your user acquisition and engagement strategy.
