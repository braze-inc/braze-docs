...
[Roles]({{site.baseurl}}/user_guide/administer/global/user_management/permissions/#creating-a-role) allow for more structure by bundling together your individual custom permissions with workspace access controls. This is especially useful if you have many brands or regional workspaces in one dashboard. With roles, you can add dashboard users to the right workspaces and directly grant them the associated permissions. 

### Security event report

We added a complete list of the [security events]({{site.baseurl}}/user_guide/administer/global/company_settings/security_settings/#downloading-a-security-event-report) that may appear in your downloaded security report event.
