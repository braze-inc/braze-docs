...
In your account, within **Manage Settings**, click the [push TTL Settings]({{site.baseurl}}/user_guide/administer/global/workspace_settings/push_settings/) tab to manage the time duration for attempted resends in the event that a device is offline.
