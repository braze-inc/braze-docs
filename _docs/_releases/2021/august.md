...
Users experiencing issues logging in via two-factor authentication can contact their company admins to [reset their two-factor authentication]({{site.baseurl}}/user_guide/administer/global/company_settings/security_settings/#user-authetication-reset).
