...
The [conversions dashboard]({{site.baseurl}}/user_guide/analytics/dashboards/conversions/) allows you to analyze conversions across campaigns, Canvases, and channels, using different attribution methods. When measuring your conversions, you can specify the time frame, conversion event, and conversion window.
