...
Before sending your WhatsApp messages, you can reference suggested [best practices]({{site.baseurl}}/user_guide/channels/whatsapp/best_practices/) to maintain a high phone quality rating, avoid blocks and reports, and opt-in and out-out users.
...
[Push Max]({{site.baseurl}}/user_guide/channels/push/platform_specific_resources/android/push_max/) amplifies Android push notifications by tracking failed push notifications and resending the push when the user is more likely to receive it. Learn about Push Max and how you can use this feature to potentially improve the deliverability of Android push notifications to [Chinese OEM devices]({{site.baseurl}}/user_guide/channels/push/best_practices/chinese_push_deliverability/).
