...
Initial single sign-on set-up instructions have been updated to recommend use of a `RelayState` API key. For more information, refer to [SAML SSO setup]({{site.baseurl}}/user_guide/administer/global/saml__single_sign_on/saml_sso_setup/) and corresponding [OneLogin]({{site.baseurl}}/user_guide/administer/global/saml__single_sign_on/onelogin/), [Okta]({{site.baseurl}}/user_guide/administer/global/saml__single_sign_on/okta/), and [Azure Active Directory]({{site.baseurl}}/user_guide/administer/global/saml__single_sign_on/entra/) articles. 
