...
The Braze and [Grouparoo]({{site.baseurl}}/help/release_notes/deprecations/grouparoo) integration syncs warehouse data to Braze. Automatic sync schedules keep customer communications current with up-to-date information.
