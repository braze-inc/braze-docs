...
{% include alerts/important_alerts.md alert='Braze Agents beta' %}
...
|---|---|
| Google Cloud account with Gemini API key | A Google Cloud account with a Gemini API key. For help, contact your admin or [Google Cloud support](https://cloud.google.com/support). |
...
2. Enter your API key from Google.
3. Select **Save**.
