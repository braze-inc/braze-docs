...
![An image of the Facebook technology page in Braze.][4]{: style="max-width:70%;"}
...
![An image of what the steps written above look like in the Canvas UI.][11]{:style="max-width:70%"}
