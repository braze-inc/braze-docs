...
If your Braze pricing includes data points, the custom event sent from VWO to Braze&#8212;including any event properties enabled for segmentation&#8212;will log data points in your Braze instance.
