...
If you enable SalesWings insights push to Braze, SalesWings updates your Braze user profiles with the following [Custom Attributes]({{site.baseurl}}/user_guide/data/activation/custom_data/data_types/):
