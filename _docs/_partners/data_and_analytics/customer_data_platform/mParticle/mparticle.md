...
{% alert note %}
Braze array attributes have a default maximum length of 500. If any of your users are members of over 500 audiences, membership information will be truncated by Braze. To work around this, contact your Braze representative to increase your maximum array length threshold.
{% endalert %}
