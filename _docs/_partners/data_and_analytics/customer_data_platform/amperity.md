...
3. Determine a list of [user profile fields]({{site.baseurl}}/api/objects_filters/user_attributes_object#braze-user-profile-fields) and [custom attributes]({{site.baseurl}}/user_guide/data/activation/attributes/custom_attributes/) that may be sent to Braze from Amperity.
...
1. [Set up a Braze Current]({{site.baseurl}}/user_guide/data/distribution/braze_currents/setting_up_currents/) to send data to an Amazon S3 bucket.
