...
{% alert note %}
Workload Identity Federation (WIF) is not currently supported as an authentication method for Currents. You must use a service account with a JSON private key.
{% endalert %}
