...
> Braze anonymizes—removes personally identifiable information (PII)—from most events data stored in Snowflake that is older than two years old. Certain events are retained until a user is deleted, as outlined later on this page. If you use Snowflake data sharing, you may choose to retain the full events data in your environment by storing a copy in your Snowflake account before the retention policy is applied. 
