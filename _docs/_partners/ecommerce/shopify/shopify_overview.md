...
| Checkout token user alias | An alias that Braze creates through the Braze SDK when the user starts the checkout process. This token is created by using the Shopify checkout token. |
