...
_This integration is maintained by Wunderkind._
...
Reach out to your WunderKind team to help set up the integration. You are asked to provide your Braze ESP or API credentials so that Wunderkind can send out email deployments and subscription statuses through the API. 
