...
Assuming you configure your integration as suggested above, Braze will map all organic and non-organic install data to segment filters as described below.
