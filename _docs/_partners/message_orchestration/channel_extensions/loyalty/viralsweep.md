...
Yes, if you run a promotion and we pass someone to Braze, then you run another promotion in the future and the same person enters, we will automatically update their information in Braze (if any new information is provided). Mainly, the referral URL will be updated with the newest URL for each promotion they enter, and the promotion ID field will contain the ID of all the promotions they have entered.
