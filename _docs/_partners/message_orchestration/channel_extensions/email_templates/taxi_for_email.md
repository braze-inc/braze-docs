...
Your connector field will turn green once details with correct permissions are provided. If this field is not green, check that your fields align with the requirements listed.
