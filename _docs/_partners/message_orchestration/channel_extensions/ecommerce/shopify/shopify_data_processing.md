...
| Purchase | [Braze Purchase Event]({{site.baseurl}}/user_guide/data_and_analytics/custom_data/purchase_events/) | An Order Created Event is received from Shopify and the products ordered are mapped to Braze Purchase Events. | Shopify webhooks |
