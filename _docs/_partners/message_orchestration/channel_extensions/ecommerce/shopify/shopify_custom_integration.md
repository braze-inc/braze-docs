...
![Setup step to manage users.][6]

{% alert note %}
As mentioned in [Shopify overview]({{site.baseurl}}/shopify_overview/), if you want to use a third-party capture form, your developers need to integrate Braze SDK code. This will let you capture the email address and global email subscription status from form submissions. Specifically, you need to implement these methods to your SDK configuration:<br><br>
...
[6]: {% image_buster /assets/img/Shopify/manage_users_setup.png %}
