...
The Braze and Survicate integration allows you to include Survicate survey links or survey snippets in your Braze campaigns and Canvases. 

Being able to embed the first survey questions into your email's body has shown to increase the response rate. After running your surveys, return to Survicate to identify and analyze the attributes of your survey responders.
