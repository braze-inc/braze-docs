...
| A DOTS.ECO Authorization Key   | The Connected Content request below requires a DOTS.ECO App Token, API Key and Allocation ID. To retrieve these, please reach out to your DOTS.ECO CSM.  |  
