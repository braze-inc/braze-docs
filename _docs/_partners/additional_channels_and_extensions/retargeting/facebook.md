...
<br><br>The new Facebook oAuth configuration will also apply to [Facebook exports via segments]({{site.baseurl}}/partners/additional_channels_and_extensions/retargeting/facebook/#prerequisites). 
{% endalert %}
