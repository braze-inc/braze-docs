...
{% alert tip %}
For the full list of Currents event schemas, [Message Engagement Events]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events/).
{% endalert %}
...
Additionally, their structure varies slightly from the flat structure found in [Message Engagement Events]({{site.baseurl}}/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events/). In particular, they contain two sub-objects:
