...
| Braze API key | A Braze REST API key with `events.list, users.export.ids, users.delete, users.track` permissions.<br><br>This can be created within the **Braze Dashboard > Developer Console > REST API Key > Create New API Key**. |
