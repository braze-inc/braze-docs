...
You can set up multiple Braze connections in your Amplitude account. This lets you configure one connection to sync User IDs for known users and another to sync Device IDs for anonymous users.
