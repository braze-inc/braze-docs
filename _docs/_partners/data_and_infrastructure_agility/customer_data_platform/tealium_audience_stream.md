...
![Track Purchases]({% image_buster /assets/img/tealium/audience_stream/track_user_purchase.png %}){: style="max-width:70%"}
...
![Track Purchases]({% image_buster /assets/img/tealium/audience_stream/track_user_delete.png %}){: style="max-width:70%"}
