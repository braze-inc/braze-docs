...
| iOS Foreground Push Opened     | User received a push notification on iOS while the app was open. <br> (Please note, this event is deprecated and not supported by our [Swift SDK](https://github.com/braze-inc/braze-swift-sdk).)|
