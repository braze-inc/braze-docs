...
| Placeholder             | Description                                                                                                                                                                                     |
|-------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `BRAZE_API_ENDPOINT`    | The Braze REST endpoint URL of your current Braze instance. For more information, refer to [REST API keys]({{site.baseurl}}/user_guide/administer/global/workspace_settings/apis_and_identifiers/#rest-api-keys). |
