...
description: "OfferFit replaces manual A/B testing with AI testing. Lifecycle marketers use OfferFit’s AI testing to make the best 1:1 decision for each customer, test all variables simultaneously, detect and adapt to market changes."
page_type: partner
search_tag: OfferFit
...
> [OfferFit](https://www.offerfit.ai/) replaces manual A/B testing with AI testing. Lifecycle marketers use OfferFit’s AI testing to make the best 1:1 decision for each customer, test all variables simultaneously, detect and adapt to market changes. 
...
| [POST /canvas/trigger/send](https://www.braze.com/docs/api/endpoints/messaging/send_messages/post_send_triggered_canvases/)         | Trigger a send for a Canvas that is configured for API-triggered delivery. |
