...
| Da Vinci app instance in Braze | Create a dedicated Da Vinci app instance in Braze. A new app can be created in the Braze dashboard by going to **Settings** > **App Settings** > **+ Add App**. Name the app "**Movable Ink - Da Vinci**" and select any platform (a platform selection is required but the type does not impact functionality). Learn more about [how to add a new app]({{site.baseurl}}/user_guide/administer/global/create_and_manage_workspaces/#step-3-add-your-app-instances). |
