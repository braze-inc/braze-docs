...
{% alert important %}
As of April 7, 2022, Transifex has deprecated their API versions 2 and 2.5 to make way for version 3. v2 and v2.5 are no longer be operational, and relevant requests will fail. <br><br>The following integration instructions reflect the version 3 update. Please update your Connected Content calls accordingly.
{% endalert %}
