...
1. [Deploy the SalesWings tracking Javascript][11] on the websites where you want to track and identify leads.
...
1. Generate a new Braze API key for SalesWings:
  ...
  - The key should become visible in the the Rest API Keys section ![Create braze API key for SalesWings][12]
2. Go to the [SalesWings Settings page][13]
3. Expand the **Braze Integration** section ![SalesWings braze integration settings][14]
...
![braze API key in SalesWings braze settings][14]
5. Find your Braze API endpoint as described at the [SDK Endpoints page][15] and enter it in the Braze API endpoint field. To find out your endpoint, locate the URL of your Braze dashboard in the URL column of the table and take the value of Rest Endpoint column of the corresponding row. For example, if your Braze dashboard URL is `https://dashboard-03.braze.com`, your Braze API endpoint should be `https://rest.iad-03.braze.com`.
6. Copy the value of the **REST ENDPOINT** column and enter it in the Braze API endpoint field of the SalesWings Braze Integration section ![braze API endpoint in SalesWings braze integration settings][16] 
...
Option 1: **braze_id** parameter:
  - `?braze_id=` followed by the “Personalization” variable `{{${braze_id}}}`
  - The variable here is the standard “braze ID”
  - Example of final link: `https://www.your-website.com?braze_id={{${braze_id}}}`

Option 2: **br_user_id** parameter:
  - `?br_user_id=` followed by the “Personalization” variable `{{${user_id}}}`
  - The variable here is your customizable “external ID”
  - Example of final link: `https://www.client-website.com?br_user_id={{${user_id}}}`
...
[14]: {% image_buster /assets/img/saleswings/braze_api_key_lead_scoring.png %}
[15]: https://www.braze.com/docs/user_guide/administrative/access_braze/sdk_endpoints
[16]: {% image_buster /assets/img/saleswings/braze_api_endpoint_for_lead_scoring.png %}
