...
|---|---|---|---|
| `canvas_step_id`  | Yes | String | See [Canvas Step API identifier]({{site.baseurl}}/api/identifier_types/#canvas-api-identifier). |
| `message_variation_id `  |  Yes | String | Message variant API identifier (for the Email message variant in that step). You can find this by clicking **Analyze Variants** on the Canvas details page for a Canvas. |
