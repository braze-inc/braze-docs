...
{% alert note %}
Google Audience Sync is currently in beta. Please contact your Braze account manager if you are interested in participating in the beta.
{% endalert %}
...
{% alert note %}
This feature gives brands the option to control what specific first-party data is shared with Google. At Braze, the integrations you can and cannot share your first-party data with are given the utmost consideration. To learn more about our Braze data privacy policy, please click [here](https://www.braze.com/privacy).
{% endalert %}
...
![Google Sync][2]{: style="max-width:30%;"}![Google Sync][3]{: style="max-width:28%;"}
...
Add a step in your Canvas, select the dropdown at the top of the step, and select __Google Audience Step__.
...
Select the desired Google ad account. Then you will have to option to Sync with an Existing Audience or Create a New Audience.
...
Google Customer Match will then use this information to determine who targetable within Google Search, Google Display, YouTube, and Gmail. For more details around Google Customer Match requirements, please review their documentation.

Once you've configured your Google Audience step, you can select Done.  Your Google Audience step will include details about the new audience. 
...
Please ensure that your audiences contain at least 5,000 users to ensure that ads start serving. 
